...
| omise 御店 | seller-side storefront commons — Shopify-layer for SBT-gated internal sellers; listings feed okaimono Ring 1; ZERO commission/subscription, USDC+TitheRouter via warifu, member-signed; kotoba-native (promotes legacy JSON-LD scaffold) | 🟡 R0 | 2606071400 | 06-07 |
| ainori 相乗 | pooled passenger-mobility commons (Uber inversion) — members offer seats, riders cost-share (no margin), platform cash≡0; reuses todoke route crate + SAE-L4 envelope; no-gig/no-surge/no-person-tracking; human- + autonomous-pooled | 🟡 R0 | 2606071500 | 06-07 |
| shukubo 宿坊 | pilgrim-lodging commons (Airbnb/Hotels inversion) — Ring0 covenantal/pilgrim stays · Ring1 internal SBT↔SBT (zero commission) · Ring2 external mirror (self-book, no inflow); no-surge/no-discriminatory-scoring/no-in-stay-surveillance | 🟡 R0 | 2606071600 | 06-07 |
