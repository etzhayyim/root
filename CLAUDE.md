...
| **sarutahiko truck factory R0** | the FACTORY that builds the 猿田彦 Class-8 truck (giemon-factory 4D-BIM pattern); 8 line-cells + 積込ロボット loaders; end-to-end production-line sim | 🟢 | 2606013100 / 2605252500 | 06-01 |
...
├── 30-graph/            # graph-schema, kagami, kotoba-udf, vectorization
...
- `90-docs/adr/2605262130-kotoba-storage-substrate-unification.md` — canonical storage substrate engine (kotoba); supersedes kotoba-datomic composition + projection layers; no Kotoba/Datomic
