...
mod tests {
    ...
    fn test_query_subject() {
        assert_eq!(
            ...
            "gftd.w.query.list-envelopes.org_123"
        );
    }
    ...
    fn test_federation_subjects() {
        assert_eq!(
            ...
            "gftd.w.federation.announce"
        );
        assert_eq!(
            NatsSubjects::federation_diff("did:plc:peer1"),
            "gftd.w.federation.diff.did:plc:peer1"
        );
    }
