...
| **D — TODO-PENDING** | 34 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 54 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 34 apps** (C + D = 0 + 34; Bucket C build-targets CLEARED — the 8 Tier-2 commerce apps
...
## Bucket V — CONFIRMED VENDOR-RESIDENT (54)
...
## Bucket D — TODO-PENDING (34, MIGRATION-TODO.md)
...
**Ad-pixel codemod complete (un-resolved tail)**: external-service-adapter,
facebook, game-play-uploader, github, gmail, live, mailer, media-gamers, meet,
