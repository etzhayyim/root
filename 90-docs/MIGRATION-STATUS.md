...
|--------|------:|---------|
| **A — DONE** | 70 | has a `rw-free/` on-chain reference impl |
...
| **D — TODO-PENDING** | 56 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 15 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 95 apps** (C + D = 39 + 56; the 8 Tier-2 commerce apps
...
fleamarket (mixed split — public C2C catalog front), flight-offer,
...
## Bucket D — TODO-PENDING (56, MIGRATION-TODO.md)

**TRANSFORM-pending (26)**:
ge, gftdcojp,
