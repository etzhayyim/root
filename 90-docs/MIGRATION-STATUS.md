...
| **D — TODO-PENDING** | 51 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 40 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 51 apps** (C + D = 0 + 51; Bucket C build-targets CLEARED — the 8 Tier-2 commerce apps
...
## Bucket V — CONFIRMED VENDOR-RESIDENT (40)
...
## Bucket D — TODO-PENDING (51, MIGRATION-TODO.md)
...
**TRANSFORM-pending (21)**:
kaikei, keiei, ops, resource-flow, resource-planner,
