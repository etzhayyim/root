...
|--------|------:|---------|
| **A — DONE** | 80 | has a `rw-free/` on-chain reference impl |
| **B — CLEAN** | 208 | no `rw-free`, no TODO, no prohibited imports — compliant or thin stub |
| **C — NEEDS-CODEMOD** | 20 | still imports prohibited substrate → the real active backlog |
| **D — TODO-PENDING** | 55 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 25 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 75 apps** (C + D = 20 + 55; the 8 Tier-2 commerce apps
...
kenkyusha (research-knowledge; LLM compute stays gftd),
...
## Bucket V — CONFIRMED VENDOR-RESIDENT (25)
...
## Bucket C — NEEDS-CODEMOD (20) — active backlog
...
kyber-qzzg06nh, legal-entity (RW), llm (RW), manimani,
