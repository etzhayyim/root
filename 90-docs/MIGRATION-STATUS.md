...
|--------|------:|---------|
| **A — DONE** | 77 | has a `rw-free/` on-chain reference impl |
| **B — CLEAN** | 208 | no `rw-free`, no TODO, no prohibited imports — compliant or thin stub |
| **C — NEEDS-CODEMOD** | 24 | still imports prohibited substrate → the real active backlog |
...
**Real remaining scope ≈ 79 apps** (C + D = 24 + 55; the 8 Tier-2 commerce apps
...
editor, gov (mixed split — public gov reference front), itonami,
...
## Bucket C — NEEDS-CODEMOD (24) — active backlog
...
email-service-adapter (stripe), jp-fiscal, jukyu (RW), kami,
