...
| **D — TODO-PENDING** | 23 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 62 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 23 apps** (C + D = 0 + 23; Bucket C build-targets CLEARED — the 8 Tier-2 commerce apps
...
## Bucket V — CONFIRMED VENDOR-RESIDENT (62)
...
## Bucket D — TODO-PENDING (23, MIGRATION-TODO.md)
...
microsoft, microsoft-graph, news, newsletter,
