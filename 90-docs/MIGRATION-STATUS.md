...
| **D — TODO-PENDING** | 52 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 39 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 52 apps** (C + D = 0 + 52; Bucket C build-targets CLEARED — the 8 Tier-2 commerce apps
...
## Bucket D — TODO-PENDING (52, MIGRATION-TODO.md)
...
**TRANSFORM-pending (22)**:
hub, kaikei, keiei, ops, resource-flow, resource-planner,
