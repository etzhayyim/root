...
|--------|------:|---------|
| **A — DONE** | 84 | has a `rw-free/` on-chain reference impl |
| **B — CLEAN** | 209 | no `rw-free`, no TODO, no prohibited imports — compliant or thin stub |
| **C — NEEDS-CODEMOD** | 10 | still imports prohibited substrate → the real active backlog |
...
**Real remaining scope ≈ 65 apps** (C + D = 10 + 55; the 8 Tier-2 commerce apps
...
patent (public patent registry; PII in natural-person),
...
## Bucket C — NEEDS-CODEMOD (10) — active backlog
