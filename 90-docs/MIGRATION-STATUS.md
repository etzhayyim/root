...
| **C — NEEDS-CODEMOD** | 34 | still imports prohibited substrate → the real active backlog |
| **D — TODO-PENDING** | 55 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 18 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 89 apps** (C + D = 34 + 55; the 8 Tier-2 commerce apps
...
## Bucket V — CONFIRMED VENDOR-RESIDENT (18)
...
## Bucket C — NEEDS-CODEMOD (34) — active backlog
...
cyber-drill (stripe), deai (RW), dougaka (RW), editor,
