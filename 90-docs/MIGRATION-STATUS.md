...
|--------|------:|---------|
| **A — DONE** | 79 | has a `rw-free/` on-chain reference impl |
| **B — CLEAN** | 208 | no `rw-free`, no TODO, no prohibited imports — compliant or thin stub |
| **C — NEEDS-CODEMOD** | 21 | still imports prohibited substrate → the real active backlog |
...
**Real remaining scope ≈ 76 apps** (C + D = 21 + 55; the 8 Tier-2 commerce apps
...
## Bucket C — NEEDS-CODEMOD (21) — active backlog
