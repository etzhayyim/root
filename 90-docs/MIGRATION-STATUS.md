...
| **C — NEEDS-CODEMOD** | 30 | still imports prohibited substrate → the real active backlog |
...
**Real remaining scope ≈ 85 apps** (C + D = 30 + 55; the 8 Tier-2 commerce apps
...
## Bucket C — NEEDS-CODEMOD (30) — active backlog
