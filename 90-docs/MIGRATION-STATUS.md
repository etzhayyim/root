...
|--------|------:|---------|
| **A — DONE** | 67 | has a `rw-free/` on-chain reference impl |
...
| **D — TODO-PENDING** | 62 | has `MIGRATION-TODO.md` (seed copied, codemod pending) |
| **V — VENDOR-RESIDENT** | 12 | judged correctly gftd-resident (regulated-infra axis) — no migration |

**Real remaining scope ≈ 103 apps** (C + D = 41 + 62; the 8 Tier-2 commerce apps
...
## Bucket D — TODO-PENDING (62, MIGRATION-TODO.md)

**TRANSFORM-pending (32)**:
