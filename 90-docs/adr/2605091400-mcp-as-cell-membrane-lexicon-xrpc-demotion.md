...
4 chains in `00-contracts/lexicons/ai/gftd/apps/malak/` simultaneously expose
...
- Lexicon (SSoT): `00-contracts/lexicons/ai/gftd/apps/malak/bitnestExitPursuit.json`
