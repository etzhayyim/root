---
id: adr-2606031600-ipaddress-yabai-kotoba-eavt-refactor-active-collection
title: "ADR-2606031600: ipaddress + yabai → kotoba EAVT refactor (ADR-2605301400 §T2/§T3 execution) — active SecurityTrails-class IP/DNS collection on the Datom log"
status: proposed
doc_type: adr
...
# ADR-2606031600: ipaddress + yabai → kotoba EAVT refactor (active IP/DNS collection)
