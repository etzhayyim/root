...
## §3. Sensor abstraction (`pymagatama.organism.sensors.corp.*`)

New module path: `20-actors/magatama/py/src/pymagatama/organism/sensors/corp/base.py`.
