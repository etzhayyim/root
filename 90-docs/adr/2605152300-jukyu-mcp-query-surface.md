...
|---|---|---|---|
| `ai.gftd.apps.jukyu.queryBalance` | `mv_jukyu_global_balance` | domain, countryCode, productFamily | 500 |
| `ai.gftd.apps.jukyu.querySupplyChain` | `mv_jukyu_supply_chain_trace` | domain, countryCode, productFamily, nodeCode | 1000 |
| `ai.gftd.apps.jukyu.rankCompanyExposure` | `mv_jukyu_company_exposure_rank` | domain, countryCode, minRiskScore | 250 |
| `ai.gftd.apps.jukyu.explainNode` | `vertex_jukyu_supply_node` + `mv_jukyu_supply_chain_trace` + `mv_jukyu_global_balance` | nodeCode (required), domain | node + chain (50) + balance (10) |
...
LG_JUKYU_PROXY_PREFIXES = ("ai.gftd.apps.jukyu.",)
