---
id: adr-2605172000-etzhayyim-kotoba-substrate
title: "ADR-2605172000: etzhayyim/root open apps MUST be kotoba — AT MST + IPFS + Base L2 as primary substrate"
status: proposed
doc_type: adr
topic: etzhayyim-kotoba-substrate
authoritative: true
...
# ADR-2605172000: etzhayyim/root open apps MUST be kotoba — AT MST + IPFS + Base L2 as primary substrate
...
| Old (RW-backed) | New (kotoba substrate) |
|---|---|
...
| App pattern | RW dependency today | kotoba pattern |
|---|---|---|
