---
id: adr-2606014000-kotoba-passkey-cacao-signal-secrecy
title: "ADR-2606014000: kotoba Passkey-Rooted Secrecy — WebAuthn PRF → ARK → CACAO authz + Signal messaging"
status: proposed
doc_type: adr
...
# ADR-2606014000: kotoba Passkey-Rooted Secrecy — WebAuthn PRF → ARK → CACAO authz + Signal messaging
