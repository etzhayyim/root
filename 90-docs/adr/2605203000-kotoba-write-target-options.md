...
[ADR-2605172000](./2605172000-etzhayyim-kotoba-substrate.md) requires
etzhayyim/root apps to be **kotoba** — no Kotoba/Datomic / no Hyperdrive /
...
- Not "true" kotoba per ADR-2605172000 spirit. Justify in per-actor
...
Reference impl:
- `60-apps/etzhayyim-project-open-isco/kotoba/` (seeder + query CLI)
- `60-apps/etzhayyim-project-tsukuru/kotoba/` (full app — production
  order + escrow + manufacturer registry, 13 commands)
- This PR: `60-apps/etzhayyim-project-ipaddress/kotoba/` (initial slice)
...
- **Pattern reuse**: tsukuru kotoba is the template. Subsequent
...
却下理由: violates ADR-2605172000 kotoba spirit. Etzhayyim becomes
...
- ADR-2605172000 — kotoba substrate (mandate)
...
- `60-apps/etzhayyim-project-open-isco/kotoba/` — Option B reference
  (seeder + query CLI)
- `60-apps/etzhayyim-project-tsukuru/kotoba/` — Option B reference
  (full app, 13/46 commands)
- `60-apps/etzhayyim-project-ipaddress/kotoba/` — Option B reference
