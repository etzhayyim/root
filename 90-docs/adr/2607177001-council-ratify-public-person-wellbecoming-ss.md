...
2. **fuchi implementation** on `etzhayyim/com-etzhayyim-fuchi` main @ `f47ba29e228c`  
   (`methods/public_person.cljc`, `data/public-person-dynamic.edn`, analyze public projection)
3. **Ontology v2** in this repo:  
   `00-contracts/schemas/maintainer-sustenance-ontology.kotoba.edn`  
