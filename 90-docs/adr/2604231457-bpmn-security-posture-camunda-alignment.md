...
| 3.2 | Re-run end-to-end smoke after 3.1 | `curl atproto.etzhayyim.com/xrpc/ai.gftd.apps.yabai.listFlags` → 200 with real flags payload (via dispatcher, not fallback) | — |
