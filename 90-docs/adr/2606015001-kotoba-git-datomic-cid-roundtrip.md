---
id: adr-2606015001-kotoba-git-datomic-cid-roundtrip
renumbered_from: "2606015000"
title: "ADR-2606015001: kotoba-git — git object model as CID blocks + Datom projection (round-trip)"
status: accepted
doc_type: adr
topic: kotoba-git
authoritative: true
...
# ADR-2606015001: kotoba-git — git object model as CID blocks + Datom projection (round-trip)
