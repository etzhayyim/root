...
```
40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/malak/langgraph/<name>_pursuit.py
```
...
`kotodama.malak.langgraph.pursuit_loop._smart_route(target_id,
...
- `kotodama.malak.langgraph.server` CHAINS registry extended.
...
- `40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/malak/langgraph/bitnest_exit_pursuit.py`
- `00-contracts/lexicons/com/etzhayyim/apps/malak/bitnestExitPursuit.json`
- `40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/malak/langgraph/server.py` (CHAINS registration)
