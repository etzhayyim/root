...
related:
  - 60-apps/ai-gftd-project-patent/magatama.toml
...
The Python worker in `60-apps/ai-gftd-project-patent/worker/python` is a
...
`60-apps/ai-gftd-project-patent/magatama.toml` is the local wiring manifest for
