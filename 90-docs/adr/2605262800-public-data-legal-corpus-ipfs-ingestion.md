...
authoritative_for:
  ...
  - 5 new sensor families under pymagatama.organism.sensors.legal.*
...
## §3. Sensor abstraction (5 families under `pymagatama.organism.sensors.legal.*`)
...
New module: `20-actors/magatama/py/src/pymagatama/organism/sensors/legal/judicial_party_redactor.py`.
...
- `20-actors/magatama/py/src/pymagatama/organism/sensors/` — Wave 1 sensor home
