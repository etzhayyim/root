...
authoritative_for:
  ...
  - `pymagatama.organism.sensors.gov.*` sensor family namespace
...
## §3. Sensor abstraction (`pymagatama.organism.sensors.gov.*`)

New module path: `20-actors/magatama/py/src/pymagatama/organism/sensors/gov/base.py`.
