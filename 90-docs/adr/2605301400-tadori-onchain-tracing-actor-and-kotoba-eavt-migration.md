...
|---|---|---|---|
| **T0** (this ADR, R0) | Scaffold `20-actors/tadori/` (CLAUDE.md + manifest + cells + lex) + the EAVT schema above as `00-contracts/lexicons/app/etzhayyim/apps/tadori/*.json`. No data moved. | none | schema lexicons validate; substrate-boundary linter green |
