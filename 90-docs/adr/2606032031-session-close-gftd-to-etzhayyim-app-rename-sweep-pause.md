---
id: adr-2606032031-session-close-gftd-to-etzhayyim-app-rename-sweep-pause
title: "ADR-2606032031: Session close — gftd/yatachain app rename sweep pause (etzhayyim + kotoba Datomic/EDN)"
status: active
doc_type: adr
...
# ADR-2606032031: Session close — gftd/yatachain app rename sweep pause
...
- `yatachain` is deprecated; app state/projection references should be kotoba Datomic + EDN.
- App/project naming portions `gftd` / `ai-gftd` should move to `etzhayyim`.
...
- old `60-apps/ai-gftd-project-*` file count = 0,
- no `gftd`, `GFTD`, `ai-gftd`, `.gftd.ai`, `yatachain`, or `kotoba-datomic-projection.toml` residue under the new project tree,
...
- `60-apps/ai-gftd-project-news` remaining file count: `20192`
...
- `60-apps/ai-gftd-project-browser`
- `60-apps/ai-gftd-project-cofog`
- `60-apps/ai-gftd-project-maps`
- `60-apps/ai-gftd-project-open-isic`
- `60-apps/ai-gftd-project-open-ot`
- `60-apps/ai-gftd-project-states`
- `60-apps/ai-gftd-project-yabai`
