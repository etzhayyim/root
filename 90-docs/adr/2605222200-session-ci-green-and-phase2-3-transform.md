...
Coming out of the religious-corp constitutional wave (ADRs 2605192100..2605192415, completed 2026-05-19/20) and the full gftdcojp → etzhayyim file migration (commit `0b7a49773`, 2026-05-21), the repo entered the post-cutover stabilisation phase with three open fronts:
