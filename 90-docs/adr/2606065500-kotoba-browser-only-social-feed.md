---
id: adr-2606065500-kotoba-browser-only-social-feed
title: "ADR-2606065500: etzhayyim.com browser-only kotoba social feed — browser read/write + member-signed block publish (no query node)"
status: accepted
doc_type: adr
...
# ADR-2606065500: etzhayyim.com browser-only kotoba social feed
