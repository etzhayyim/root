...
- **清書用の作画指示書**: `be-here-now-p13-artdirection.md`(構図/明度/糸/トーン/納品チェックリスト)。

### 他カットの絵起こし

**P1 扉**(`be-here-now-p1-tobira.svg`)— 入江俯瞰のたそがれ。分け前所の窓灯り、舫いの小舟が まにまに、陽の水映り。タイトル「水の上のパン / be·here·now ── いとなみ」。

![P1 扉](./be-here-now-p1-tobira.png)

**P17 大ゴマ**(`be-here-now-p17-water.svg`)— 水の上、止まった櫂(水滴)、漂うパンと同心円、岸の鳥がついばむ。陽の道がパンへ伸びる(いい感じ)。ナギは後ろ姿で小さく。

![P17 水の上](./be-here-now-p17-water.png)

### キャラ設定 ── ナギ

`be-here-now-nagi-charactersheet.svg`。三面(立つ/漕ぐ/拭く)。細身・直立(tensegrity)、顔は描き込まない、内部線は襷=薄橙(縁色)+籠のみ、急がない所作。

![ナギ 設定画](./be-here-now-nagi-charactersheet.png)
