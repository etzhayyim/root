...
| `00-contracts/lexicons/ai/gftd/cohort/listCohorts.json` | 新規 query lexicon: kind/pcfL1/locale/fissionEnabled フィルタ + limit/offset pagination |
...
| File | 変更 |
|---|---|
| `00-contracts/lexicons/ai/gftd/cohort/fissionLineage.json` | 新規 record lexicon: individualDid / derivedFrom / posteriorAtFission (>=0.95) / judgeAgreement=true / evidenceUris / fissionAt / parentSegmentHash。rkey=literal:self |
...
| `00-contracts/lexicons/ai/gftd/cohort/listCohorts.json` | `cohortDid` / `derivedFrom` パラメータ宣言追加 |
...
| File | 変更 |
|---|---|
| `00-contracts/lexicons/ai/gftd/cohort/emitEvidence.json` | 新規 procedure lexicon: cohortDid + signalKind + evidencePayload + posterior + judgeAgreement |
...
| File | 変更 |
|---|---|
| `00-contracts/lexicons/ai/gftd/cohort/lineageStats.json` | 新規 query lexicon (pcfL1 / minChildren / limit) |
...
| File | 変更 |
|---|---|
| `00-contracts/lexicons/ai/gftd/cohort/repairEdge.json` | 新規 procedure lexicon (individualDid / limit / dryRun) |
