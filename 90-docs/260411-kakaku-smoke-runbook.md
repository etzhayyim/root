...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.registerMerchant \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.registerProduct \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.upsertOffer \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.compareOffers \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.ingestOfferFromUrl \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.listMerchants \
  -d '{"q":"yodobashi","limit":20}' \
  --app k4k4kux1
```

```bash
gftd xrpc app.etzhayyim.apps.kakaku.getMerchant \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.listSelectorRevisions \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.activateSelectorRevision \
...
```bash
gftd xrpc app.etzhayyim.apps.kakaku.getPriceHistory \
