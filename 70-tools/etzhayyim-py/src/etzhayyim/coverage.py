...
def coverage_world(pds: str | None, json_out: bool, domain: str, top: int, offline: bool) -> None:
    ...
    import sys
    click.echo(
        "coverage world requires direct RisingWave access. Use: gftd coverage world",
        err=True,
    )
    sys.exit(1)
...
def coverage_infer(pds: str | None, json_out: bool, method: str, k: int) -> None:
    ...
    import sys
    click.echo(
        "coverage infer requires direct RisingWave access. Use: gftd coverage infer",
        err=True,
    )
    sys.exit(1)
...
def coverage_hospitality(pds: str | None, json_out: bool, domain: str) -> None:
    ...
    import sys
    click.echo(
        "coverage hospitality requires direct RisingWave access. Use: gftd coverage hospitality",
        err=True,
    )
    sys.exit(1)
