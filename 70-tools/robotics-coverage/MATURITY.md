...
|---|---|---|---|---|---|---|---|---|---|---|---|
| kuramori 倉守 | 倉庫 / 積み下ろし | r0 | 9 | 10 | 4 | 35 | ✓ | ✓ | 83% | ✓ | 1.00 |
| soma 杣 | 伐採 (logging) | r0 | 9 | 9 | 5 | 30 | ✓ | ✓ | 78% | ✓ | 1.00 |
| madomori 窓守 | 高所/façade window clean | r0 | 9 | 9 | 5 | 30 | ✓ | ✓ | 88% | ✓ | 1.00 |
| kudamori 管守 | 下水道/confined-space | r0 | 9 | 9 | 4 | 32 | ✓ | ✓ | 78% | ✓ | 1.00 |

**Wave**: 4 actors · 127 deftests · mean R0-maturity 1.00 · mean occupation-coverage 82% (honest; sub-tasks still GAP are the real R1 worklist).
