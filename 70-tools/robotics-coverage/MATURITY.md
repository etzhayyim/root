...
|---|---|---|---|---|---|---|---|---|---|---|---|
| kuramori 倉守 | 倉庫 / 積み下ろし | r0 | 7 | 10 | 4 | 27 | ✓ | ✓ | 67% | ✓ | 1.00 |
| soma 杣 | 伐採 (logging) | r0 | 7 | 9 | 5 | 22 | ✓ | ✓ | 56% | ✓ | 1.00 |
| madomori 窓守 | 高所/façade window clean | r0 | 7 | 9 | 5 | 22 | ✓ | ✓ | 63% | ✓ | 1.00 |
| kudamori 管守 | 下水道/confined-space | r0 | 7 | 9 | 4 | 24 | ✓ | ✓ | 56% | ✓ | 1.00 |

**Wave**: 4 actors · 95 deftests · mean R0-maturity 1.00 · mean occupation-coverage 60% (honest; sub-tasks still GAP are the real R1 worklist).
