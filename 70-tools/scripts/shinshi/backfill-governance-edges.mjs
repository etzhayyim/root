...
console.error(`driver: POSTing ${body.models.length} models → ${DISPATCHER}/xrpc/ai.gftd.apps.shinshi.backfillGovernanceEdges`);

const r = spawnSync("curl", [
  "-sS", "--max-time", "150",
  "-X", "POST", `${DISPATCHER}/xrpc/ai.gftd.apps.shinshi.backfillGovernanceEdges`,
