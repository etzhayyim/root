#!/usr/bin/env python3
"""Wave 139: more multilateral (G7 Sherpa/G7 Foreign Ministers/Munich Security/Aspen/Doha)
+ jpMlit JR新幹線 / jpMext 大学設置 / jpMhlw 介護報酬改定 / cnStateCouncil 戸籍 / TCO sanctions. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind139.sql"), "w") as f:
