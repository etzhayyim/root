#!/usr/bin/env python3
"""Wave 107: Eastern EU (UA/PL/RO/HU/CZ) + G7/G20 + NEDO + JP rail + SY sanction
...
ENTRIES_NEW = [
    ("open-us-state-dept", "usStateDept", "coordinateUaRelations",
     "vertex_open_us_state_dept", "bureau", "european",
     "action_kind", "uaDiplomacy", "action_id", "issued_at",
     "US State: ウクライナ (MFA-UA) 戦時支援 / 復興調整"),
    ("open-us-state-dept", "usStateDept", "coordinatePlRelations",
     "vertex_open_us_state_dept", "bureau", "european",
     "action_kind", "plDiplomacy", "action_id", "issued_at",
     "US State: ポーランド (MSZ PL) 二国間 (NATO 東部flank)"),
    ("open-us-state-dept", "usStateDept", "coordinateRoRelations",
     "vertex_open_us_state_dept", "bureau", "european",
     "action_kind", "roDiplomacy", "action_id", "issued_at",
     "US State: ルーマニア (MAE RO) 二国間関係調整"),
    ("open-us-state-dept", "usStateDept", "coordinateHuRelations",
     "vertex_open_us_state_dept", "bureau", "european",
     "action_kind", "huDiplomacy", "action_id", "issued_at",
     "US State: ハンガリー (MFA HU) 二国間関係調整"),
    ("open-us-state-dept", "usStateDept", "coordinateCzRelations",
     "vertex_open_us_state_dept", "bureau", "european",
     "action_kind", "czDiplomacy", "action_id", "issued_at",
     "US State: チェコ (MFA CZ) 二国間関係調整"),
    ("open-jp-mofa", "jpMofa", "coordinateG7",
     "vertex_open_jp_mofa", "bureau", "international",
     "action_kind", "g7Summit", "action_id", "issued_at",
     "外務省: G7 首脳・外相会合"),
    ("open-jp-mofa", "jpMofa", "coordinateG20",
     "vertex_open_jp_mofa", "bureau", "international",
     "action_kind", "g20Summit", "action_id", "issued_at",
     "外務省: G20 首脳・財相会合"),
    ("open-jp-meti", "jpMeti", "fundNedoResearch",
     "vertex_open_jp_meti", "bureau", "manufacturing",
     "action_kind", "nedoResearch", "action_id", "issued_at",
     "経産省: NEDO (新エネルギー・産業技術総合開発機構) R&D 助成"),
    ("open-jp-mlit", "jpMlit", "regulateRailway",
     "vertex_open_jp_mlit", "bureau", "rail",
     "action_kind", "railwayBureauOversight", "action_id", "issued_at",
     "国土交通省: 鉄道局 (新幹線・JR・私鉄・地下鉄) 監督"),
    ("open-us-treasury-dept", "usTreasuryDept", "sanctionSyEntity",
     "vertex_open_us_treasury_dept", "sub_agency", "ofac",
     "action_kind", "sySanction", "action_id", "issued_at",
     "US Treasury OFAC: シリア entity 制裁 (Caesar Act)"),
]
ENTRIES = ENTRIES_NEW
...
with open("/tmp/wave13/bind107.sql", "w") as f:
