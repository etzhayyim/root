#!/usr/bin/env python3
"""Wave 138: NATO sec/EU EEAS/OSCE/CoE/OECD MAI + 国家公務員 + 高大連携
+ NHI + 国家民族 SEAC + Houthi maritime. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind138.sql"), "w") as f:
