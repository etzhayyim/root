#!/usr/bin/env python3
"""Wave 140: regional forums (APEC/ASEM/AUKUS/CICA/SCO sec) + 港湾国際hub
+ 学校保健 + 食品衛生 + NDRC + 北朝鮮 missile. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind140.sql"), "w") as f:
