#!/usr/bin/env python3
"""Wave 133: G20 working groups (Sherpa/Finance/B20/C20/W20) + 防災
+ 教員養成 + 介護福祉士 + 公務員 + Xinjiang/Tibet sanctions. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind133.sql"), "w") as f:
