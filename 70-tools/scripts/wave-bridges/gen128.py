#!/usr/bin/env python3
"""Wave 128: jpMofa multilateral institutions (ICC/WTO/WIPO/WMO/UPU)
+ カーボンニュートラル + DX + 商務部 + cartel + Geneva. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind128.sql"), "w") as f:
