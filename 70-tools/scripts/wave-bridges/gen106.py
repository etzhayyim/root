#!/usr/bin/env python3
"""Wave 106: Central Asia (KZ/UZ/TM/KG/TJ) + Quad/IPEF + cn territorial + JP shipping
+ extended OFAC sanctions on existing tables. NO DDL.
"""
...
with open("/tmp/wave13/bind106.sql", "w") as f:
