#!/usr/bin/env python3
"""Wave 135: regional banks (NDB BRICS/AIIB/JBIC/EXIM/IsDB) + 気象庁
+ 大学院 + 妊婦健診 + 国家档案局 + SDGT-NK foreign agent. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind135.sql"), "w") as f:
