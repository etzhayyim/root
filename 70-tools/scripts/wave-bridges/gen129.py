#!/usr/bin/env python3
"""Wave 129: financial multilaterals (FATF/MAI/Basel/IOSCO/IAIS) + BIM + 教科書
+ 感染症 + NMPA + ransomware EO. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind129.sql"), "w") as f:
