#!/usr/bin/env python3
"""Wave 130: UN agencies (UNESCO/UNIDO/IFAD/UNCTAD/IMO) + JAXA space + STEAM
+ 麻薬対策 + 退役 + Magnitsky. NO DDL.
"""
...
with open(str(pathlib.Path(__file__).parent / "bind130.sql"), "w") as f:
