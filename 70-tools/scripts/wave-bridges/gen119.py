#!/usr/bin/env python3
"""Wave 119: Africa rest (CG/MZ/MG/MW/ZM) + FOIP + 学習指導要領 + 医療提供
+ MOE-CN + IL settler sanction. NO DDL.
"""
...
ENTRIES_NEW = [
    ("open-us-state-dept", "usStateDept", "coordinateCgRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "cgDiplomacy", "action_id", "issued_at",
     "US State: コンゴ共和国 (MAEC CG) 二国間"),
    ("open-us-state-dept", "usStateDept", "coordinateMzRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "mzDiplomacy", "action_id", "issued_at",
     "US State: モザンビーク (MNEC MZ) 二国間 (Cabo Delgado / LNG)"),
    ("open-us-state-dept", "usStateDept", "coordinateMgRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "mgDiplomacy", "action_id", "issued_at",
     "US State: マダガスカル (MAE MG) 二国間"),
    ("open-us-state-dept", "usStateDept", "coordinateMwRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "mwDiplomacy", "action_id", "issued_at",
     "US State: マラウイ (MoFA MW) 二国間"),
    ("open-us-state-dept", "usStateDept", "coordinateZmRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "zmDiplomacy", "action_id", "issued_at",
     "US State: ザンビア (MoFA ZM) 二国間 (Cu / debt)"),
    ("open-jp-mofa", "jpMofa", "coordinateFoip",
     "vertex_open_jp_mofa", "bureau", "asianOceanian",
     "action_kind", "foipStrategy", "action_id", "issued_at",
     "外務省: FOIP (Free and Open Indo-Pacific) 戦略"),
    ("open-jp-mext", "jpMext", "updateCurriculum",
     "vertex_open_jp_mext", "bureau", "highered",
     "action_kind", "curriculumStandard", "action_id", "issued_at",
     "文科省: 学習指導要領 (小中高 / アクティブラーニング)"),
    ("open-jp-mhlw", "jpMhlw", "regulateHospital",
     "vertex_open_jp_mhlw", "bureau", "longTermCare",
     "action_kind", "hospitalRegulation", "action_id", "issued_at",
     "厚労省: 医療提供体制 (病床数規制 / 地域医療構想)"),
    ("open-cn-state-council", "cnStateCouncil", "regulateMoeCn",
     "vertex_open_cn_state_council", "organ_kind", "ministry",
     "topic", "moeEducation", "action_id", "issued_at",
     "国务院: 教育部 (双減 / 高考 / 大学評価)"),
    ("open-us-treasury-dept", "usTreasuryDept", "sanctionIlSettlerEntity",
     "vertex_open_us_treasury_dept", "sub_agency", "ofac",
     "action_kind", "ilSettlerSanction", "action_id", "issued_at",
     "US Treasury OFAC: イスラエル入植者 (West Bank settler) entity 制裁"),
]
ENTRIES = ENTRIES_NEW
