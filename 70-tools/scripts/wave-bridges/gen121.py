#!/usr/bin/env python3
"""Wave 121: West Africa (BJ/TG/SL/LR/GM) + ATCM + 海上保安庁 + 義務教育
+ China-CELAC + RU oligarch. NO DDL.
"""
...
ENTRIES_NEW = [
    ("open-us-state-dept", "usStateDept", "coordinateBjRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "bjDiplomacy", "action_id", "issued_at",
     "US State: ベナン (MAE BJ) 二国間"),
    ("open-us-state-dept", "usStateDept", "coordinateTgRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "tgDiplomacy", "action_id", "issued_at",
     "US State: トーゴ (MAE TG) 二国間"),
    ("open-us-state-dept", "usStateDept", "coordinateSlRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "slDiplomacy", "action_id", "issued_at",
     "US State: シエラレオネ (MoFAIC SL) 二国間"),
    ("open-us-state-dept", "usStateDept", "coordinateLrRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "lrDiplomacy", "action_id", "issued_at",
     "US State: リベリア (MFA LR) 二国間 (船籍)"),
    ("open-us-state-dept", "usStateDept", "coordinateGmRelations",
     "vertex_open_us_state_dept", "bureau", "africa",
     "action_kind", "gmDiplomacy", "action_id", "issued_at",
     "US State: ガンビア (MoFA GM) 二国間"),
    ("open-jp-mofa", "jpMofa", "coordinateAtcm",
     "vertex_open_jp_mofa", "bureau", "international",
     "action_kind", "atcmRegular", "action_id", "issued_at",
     "外務省: ATCM 南極条約協議国会議 定例"),
    ("open-jp-mlit", "jpMlit", "regulateCoastGuard",
     "vertex_open_jp_mlit", "bureau", "mlit_kaijou_jcg_jcga",
     "action_kind", "jcgOversight", "action_id", "issued_at",
     "国土交通省: 海上保安庁 (JCG) 法執行 / 領海警備"),
    ("open-jp-mext", "jpMext", "regulateCompulsoryEd",
     "vertex_open_jp_mext", "bureau", "highered",
     "action_kind", "compulsoryEd", "action_id", "issued_at",
     "文科省: 義務教育 (小中校 / 9年制)"),
    ("open-cn-mofa", "cnMofa", "coordinateCelac",
     "vertex_open_cn_mofa", "department_kind", "treaty",
     "action_kind", "celacChina", "action_id", "issued_at",
     "中国外交部: 中国-CELAC ラテンアメリカ協力フォーラム"),
    ("open-us-treasury-dept", "usTreasuryDept", "sanctionRuOligarch",
     "vertex_open_us_treasury_dept", "sub_agency", "ofac",
     "action_kind", "ruOligarch", "action_id", "issued_at",
     "US Treasury OFAC: ロシア新興財閥 (oligarch SDN) entity 制裁"),
]
ENTRIES = ENTRIES_NEW
...
with open("/tmp/wave13/bind121.sql", "w") as f:
