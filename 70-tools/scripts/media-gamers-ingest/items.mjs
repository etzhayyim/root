#!/usr/bin/env node
// items.mjs — Serebii items DB → ai.gftd.apps.media_gamers.knowledge.publishGameItem
//
// Usage:
//   GFTD_TOKEN=$(gftd agent-token --lxm ai.gftd.apps.media_gamers.knowledge.publishGameItem) \
...
const NSID = "ai.gftd.apps.media_gamers.knowledge.publishGameItem";
