;; ported from 70-tools/scripts/kotoba-migration-bakeoff/runs/elv-body-shred/gemma/original_cell.py (unit_refactor stage 0)
;; ElvBodyShredCell — hodoki R0 Pregel cell (L4).
(ns runs.elv-body-shred.gemma.original-cell
  (:require [clojure.string] [clojure.set] [clojure.edn]))

(declare elv-body-shred-cell all)

;; TODO: port-failed unit ElvBodyShredCell (/var/folders/px/b63lssbx5056kq_1t6pvc1f80000gn/T/tmpf6tdi_9i/scratch.clj:3:12: w)
...
;;         )
(defn elv-body-shred-cell [& _]
  (throw (ex-info "TODO: port-failed" {:from "ElvBodyShredCell"})))

(def __all__ ["elv-body-shred-cell"])
