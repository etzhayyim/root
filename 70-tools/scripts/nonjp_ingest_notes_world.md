...
Existing repo seed baseline is only 10 high-value treaty authority seeds in `70-tools/gftd/gftd/seed_domains.go` (`un_charter`, `udhr`, `geneva_1949`, `iccpr`, `icescr`, `vienna_treaties`, `unclos`, `paris_climate`, `rome_statute`, `wto_marrakesh`). Treat this as authority seed, not corpus coverage.
