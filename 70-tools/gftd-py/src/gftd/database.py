...
_RW_PROD_URL = "postgres://root@45.32.79.245:4566/dev"
...
def db_status(pds: str | None, json_out: bool) -> None:
    ...
    try:
        resp = httpx.get(
            f"{pds_url}/xrpc/ai.gftd.database.getStatus",
...
def db_tables(pds: str | None, schema: str, json_out: bool) -> None:
    ...
    try:
        resp = httpx.get(
            f"{pds_url}/xrpc/ai.gftd.database.listTables",
...
def db_query(sql: str, pds: str | None, json_out: bool) -> None:
    ...
    try:
        resp = httpx.post(
            f"{pds_url}/xrpc/ai.gftd.database.query",
