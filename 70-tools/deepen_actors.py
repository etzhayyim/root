...
PLATFORM_OVERRIDES = {
    # ---- Wave 11 — Compute & Photonics Frontier (scaffold_wave11_compute_photonics.py) ----
    # Kept in sync with that generator's COHORT so register/deepen regeneration
    # reproduces the same entities (no generic-model clobber). CPU + 光電融合 emphasis.
    "nvidia_cosmos": {
        "WorldModel": E(name="string", modelType="string", parameters="integer", checkpoint="string", license="string"),
        "Tokenizer": E(name="string", kind="string", compressionRatio="float", modality="string"),
        "SimRun": E(worldModelId="string", prompt="string", frames="integer", status="string"),
        "Embodiment": E(name="string", dof="integer", robotType="string", urdf="string"),
        "Prompt": E(text="string", modality="string", conditioning="string"),
        "GuardrailCheck": E(simRunId="string", policy="string", verdict="string", score="float"),
    },
    "hbm_memory": {
        "MemoryStack": E(partNumber="string", generation="string", heightDie="integer", capacityGb="integer", bandwidthGbps="float"),
        "DramDie": E(stackId="string", processNode="string", capacityGb="integer", knownGoodDie="boolean"),
        "ThroughSiliconVia": E(stackId="string", count="integer", pitchUm="float", aspectRatio="float"),
        "MemoryChannel": E(stackId="string", width="integer", pseudoChannels="integer", dataRateGbps="float"),
        "RefreshPolicy": E(stackId="string", mode="string", intervalNs="float", temperatureC="float"),
        "TestBin": E(stackId="string", binCode="string", **{"yield": "float"}, status="string"),
    },
    "dram_design": {
        "DramDevice": E(partNumber="string", generation="string", densityGb="integer", dataRateMtps="integer"),
        "CellArray": E(deviceId="string", rows="integer", columns="integer", capacitorType="string"),
        "Bank": E(deviceId="string", bankGroup="integer", index="integer", pageSizeKb="float"),
        "TimingProfile": E(deviceId="string", casLatency="integer", tRCD="integer", tRP="integer"),
        "SpeedBin": E(deviceId="string", grade="string", voltage="float", dataRateMtps="integer"),
        "JedecSpec": E(deviceId="string", standard="string", revision="string", compliant="boolean"),
    },
    "gddr_memory": {
        "GddrDevice": E(partNumber="string", generation="string", capacityGb="integer", dataRateGbps="float"),
        "MemoryChannel": E(deviceId="string", width="integer", prefetch="integer", dataRateGbps="float"),
        "SignalingMode": E(deviceId="string", scheme="string", levels="integer", eyeHeightMv="float"),
        "ThermalProfile": E(deviceId="string", tjMaxC="float", powerW="float", throttle="boolean"),
        "SpeedGrade": E(deviceId="string", grade="string", voltage="float", dataRateGbps="float"),
        "TestBin": E(deviceId="string", binCode="string", **{"yield": "float"}, status="string"),
    },
    "groq_lpu": {
        "LpuChip": E(name="string", generation="string", sramMb="integer", tflops="float"),
        "TensorStream": E(chipId="string", direction="string", widthBytes="integer", throughputGbps="float"),
        "ScheduleSlot": E(chipId="string", cycle="integer", instruction="string", unit="string"),
        "Model": E(name="string", parameters="integer", quantization="string", tokensPerSec="float"),
        "InterconnectLink": E(chipId="string", peerId="string", bandwidthGbps="float", topology="string"),
        "InferenceJob": E(modelId="string", chipId="string", batchSize="integer", status="string"),
    },
    "riscv_cpu": {
        "CpuCore": E(name="string", isa="string", microarch="string", frequencyGhz="float", issueWidth="integer"),
        "Pipeline": E(coreId="string", stages="integer", type="string", branchPredictor="string"),
        "RegisterFile": E(coreId="string", kind="string", count="integer", widthBits="integer"),
        "CacheLevel": E(coreId="string", level="string", sizeKb="integer", associativity="integer", latencyCycles="integer"),
        "IsaExtension": E(coreId="string", name="string", version="string", ratified="boolean"),
        "Microbench": E(coreId="string", name="string", ipc="float", scoreType="string"),
    },
    "silicon_photonics": {
        "PhotonicDie": E(name="string", platform="string", processNode="string", areaMm2="float"),
        "OpticalWaveguide": E(dieId="string", material="string", widthNm="float", lossDbCm="float"),
        "Modulator": E(dieId="string", type="string", bandwidthGhz="float", vpiV="float"),
        "Photodetector": E(dieId="string", material="string", responsivityAW="float", bandwidthGhz="float"),
        "LaserSource": E(dieId="string", type="string", wavelengthNm="float", powerMw="float"),
        "WavelengthChannel": E(dieId="string", lambdaNm="float", spacingGhz="float", dataRateGbps="float"),
    },
    "copackaged_optics": {
        "OpticalEngine": E(name="string", generation="string", lanes="integer", aggregateTbps="float"),
        "ElectroOpticTile": E(engineId="string", tileType="string", channels="integer", powerPjPerBit="float"),
        "FiberLink": E(engineId="string", fiberType="string", reachM="float", dataRateGbps="float"),
        "SerdesLane": E(engineId="string", index="integer", modulation="string", dataRateGbps="float"),
        "OpticalSwitch": E(engineId="string", radix="integer", technology="string", insertionLossDb="float"),
        "LinkBudget": E(engineId="string", txPowerDbm="float", rxSensitivityDbm="float", marginDb="float"),
    },
    "fab_lithography": {
        "Wafer": E(lotId="string", diameterMm="integer", processNode="string", status="string"),
        "ProcessStep": E(waferId="string", name="string", tool="string", stepType="string"),
        "Reticle": E(name="string", layer="string", euv="boolean", numericalAperture="float"),
        "ProcessRecipe": E(stepId="string", name="string", doseMjCm2="float", focusNm="float"),
        "DefectScan": E(waferId="string", defectCount="integer", defectDensity="float", classification="string"),
        "Yield": E(waferId="string", dieTotal="integer", dieGood="integer", yieldPct="float"),
    },
    "semicon_robotics": {
        "WaferRobot": E(name="string", vendor="string", axes="integer", payloadKg="float", cleanClass="string"),
        "EfemModule": E(robotId="string", ports="integer", ffuFlowM3h="float", status="string"),
        "TransferJob": E(robotId="string", source="string", destination="string", status="string"),
        "LoadPort": E(moduleId="string", standard="string", slots="integer", occupied="boolean"),
        "MotionProgram": E(robotId="string", name="string", waypoints="integer", cycleTimeS="float"),
        "Interlock": E(robotId="string", kind="string", triggered="boolean", severity="string"),
    },
    # ---- Wave 11c — accelerator + optics + interconnect fill (CPU + 光電融合 emphasis) ----
    "gpu_accelerator": {
        "Gpu": E(name="string", architecture="string", smCount="integer", vramGb="integer", tflops="float"),
        "StreamingMultiprocessor": E(gpuId="string", index="integer", cudaCores="integer", sharedMemKb="integer"),
        "TensorCore": E(smId="string", generation="string", precision="string", tops="float"),
        "MemoryHierarchy": E(gpuId="string", level="string", sizeMb="float", bandwidthGbps="float"),
        "Warp": E(smId="string", threads="integer", scheduler="string", occupancy="float"),
        "KernelLaunch": E(gpuId="string", name="string", gridDim="integer", blockDim="integer", status="string"),
    },
    "npu_accelerator": {
        "Npu": E(name="string", vendor="string", topsInt8="float", sramMb="integer"),
        "SystolicArray": E(npuId="string", rows="integer", columns="integer", dataType="string"),
        "MacUnit": E(arrayId="string", precision="string", count="integer"),
        "Sram": E(npuId="string", sizeMb="float", banks="integer", bandwidthGbps="float"),
        "Dataflow": E(npuId="string", kind="string", reuse="string"),
        "InferenceTask": E(npuId="string", model="string", batchSize="integer", status="string"),
    },
    "dpu_smartnic": {
        "Dpu": E(name="string", vendor="string", portsGbps="integer", cores="integer"),
        "PacketPipeline": E(dpuId="string", stages="integer", throughputMpps="float"),
        "RdmaEngine": E(dpuId="string", protocol="string", queues="integer", latencyUs="float"),
        "ArmComplex": E(dpuId="string", cores="integer", frequencyGhz="float", isa="string"),
        "FlowTable": E(dpuId="string", entries="integer", matchFields="integer"),
        "Offload": E(dpuId="string", kind="string", status="string"),
    },
    "optical_transceiver": {
        "Transceiver": E(partNumber="string", formFactor="string", dataRateGbps="float", reachM="float"),
        "OpticalLane": E(transceiverId="string", index="integer", lambdaNm="float", modulation="string"),
        "Dsp": E(transceiverId="string", vendor="string", fecType="string", powerW="float"),
        "LaserDie": E(transceiverId="string", type="string", wavelengthNm="float", powerMw="float"),
        "Photodiode": E(transceiverId="string", material="string", responsivityAW="float", bandwidthGhz="float"),
        "DomTelemetry": E(transceiverId="string", txPowerDbm="float", rxPowerDbm="float", tempC="float"),
    },
    "dwdm_system": {
        "DwdmSystem": E(name="string", bandPlan="string", channels="integer", capacityTbps="float"),
        "OpticalChannel": E(systemId="string", lambdaNm="float", dataRateGbps="float", status="string"),
        "Amplifier": E(systemId="string", type="string", gainDb="float", noiseFigureDb="float"),
        "Roadm": E(systemId="string", degree="integer", technology="string", addDropPorts="integer"),
        "Span": E(systemId="string", lengthKm="float", fiberType="string", lossDb="float"),
        "SupervisoryChannel": E(systemId="string", lambdaNm="float", protocol="string", status="string"),
    },
    "serdes_phy": {
        "SerdesPhy": E(name="string", modulation="string", dataRateGbps="float", process="string"),
        "Lane": E(phyId="string", index="integer", direction="string", dataRateGbps="float"),
        "Equalizer": E(phyId="string", type="string", taps="integer", gainDb="float"),
        "Pll": E(phyId="string", refClockMhz="float", jitterPs="float", lockTimeUs="float"),
        "EyeDiagram": E(laneId="string", eyeHeightMv="float", eyeWidthPs="float", ber="float"),
        "BertRun": E(phyId="string", patternType="string", bitsTested="integer", errors="integer"),
    },
    "lpddr_mobile": {
        "LpddrDevice": E(partNumber="string", generation="string", densityGb="integer", dataRateMtps="integer"),
        "Channel": E(deviceId="string", width="integer", index="integer", dataRateMtps="integer"),
        "PowerMode": E(deviceId="string", name="string", currentMa="float", voltageV="float"),
        "TimingProfile": E(deviceId="string", casLatency="integer", tRCD="integer", tRP="integer"),
        "SpeedBin": E(deviceId="string", grade="string", voltageV="float", dataRateMtps="integer"),
        "JedecSpec": E(deviceId="string", standard="string", revision="string", compliant="boolean"),
    },
    "cobot_assembly": {
        "Cobot": E(name="string", vendor="string", payloadKg="float", reachMm="float", axes="integer"),
        "Joint": E(cobotId="string", index="integer", type="string", rangeDeg="float"),
        "EndEffector": E(cobotId="string", kind="string", gripForceN="float", status="string"),
        "AssemblyTask": E(cobotId="string", name="string", cycleTimeS="float", status="string"),
        "SafetyZone": E(cobotId="string", kind="string", radiusMm="float", speedLimitMmS="float"),
        "ForceProfile": E(cobotId="string", axis="string", maxForceN="float", complianceNm="float"),
    },
    # ---- Wave 11b — adjacency fill (CPU + 光電融合 emphasis) ----
    "optical_compute": {
        "PhotonicProcessor": E(name="string", platform="string", topsPerWatt="float", wavelengths="integer"),
        "MziMesh": E(processorId="string", rows="integer", columns="integer", phaseShifter="string"),
        "OpticalCore": E(processorId="string", macsPerCycle="integer", precisionBits="integer", clockGhz="float"),
        "NonlinearUnit": E(coreId="string", activation="string", thresholdMw="float"),
        "WdmBus": E(processorId="string", channels="integer", spacingGhz="float", aggregateTbps="float"),
        "ComputeTile": E(processorId="string", index="integer", utilization="float", status="string"),
    },
    "photonic_switch": {
        "SwitchFabric": E(name="string", radix="integer", technology="string", switchingTimeNs="float"),
        "OpticalPort": E(fabricId="string", index="integer", direction="string", lambdaNm="float"),
        "WaveguideCross": E(fabricId="string", row="integer", column="integer", state="string"),
        "MemsMirror": E(fabricId="string", tiltDeg="float", settleTimeMs="float", status="string"),
        "RoutePath": E(fabricId="string", ingressPort="string", egressPort="string", hops="integer"),
        "LossBudget": E(fabricId="string", insertionLossDb="float", crosstalkDb="float", marginDb="float"),
    },
    "arm_cpu": {
        "ArmCore": E(name="string", isa="string", microarch="string", frequencyGhz="float", issueWidth="integer"),
        "Cluster": E(coreId="string", coreCount="integer", topology="string", sharedCacheKb="integer"),
        "NeonUnit": E(coreId="string", kind="string", widthBits="integer", lanes="integer"),
        "CacheLevel": E(coreId="string", level="string", sizeKb="integer", associativity="integer", latencyCycles="integer"),
        "Interrupt": E(coreId="string", controller="string", vectors="integer", priorityBits="integer"),
        "PowerState": E(coreId="string", name="string", voltageV="float", powerMw="float"),
    },
    "x86_cpu": {
        "X86Core": E(name="string", isa="string", microarch="string", frequencyGhz="float", issueWidth="integer"),
        "ExecPort": E(coreId="string", index="integer", units="string", throughput="integer"),
        "MicroOp": E(coreId="string", mnemonic="string", fusedDomain="string", latency="integer"),
        "CacheLevel": E(coreId="string", level="string", sizeKb="integer", associativity="integer", latencyCycles="integer"),
        "TlbLevel": E(coreId="string", level="string", entries="integer", pageSizeKb="integer"),
        "PowerState": E(coreId="string", name="string", voltageV="float", tdpW="float"),
    },
    "cxl_memory": {
        "CxlDevice": E(name="string", cxlVersion="string", type="string", capacityGb="integer"),
        "MemoryRegion": E(deviceId="string", sizeGb="integer", interleave="string", volatile="boolean"),
        "FlitChannel": E(deviceId="string", lanes="integer", flitMode="string", dataRateGtps="float"),
        "CoherenceDomain": E(deviceId="string", hostCount="integer", protocol="string", biasMode="string"),
        "QosClass": E(deviceId="string", name="string", bandwidthGbps="float", latencyNs="float"),
        "HotplugEvent": E(deviceId="string", kind="string", slot="integer", status="string"),
    },
    "ucie_chiplet": {
        "Chiplet": E(name="string", function="string", processNode="string", areaMm2="float"),
        "UcieLink": E(chipletId="string", mode="string", lanes="integer", dataRateGtps="float"),
        "BumpArray": E(chipletId="string", pitchUm="float", count="integer", bumpType="string"),
        "Sideband": E(linkId="string", function="string", frequencyMhz="float"),
        "ProtocolLayer": E(linkId="string", protocol="string", flitFormat="string", retimer="boolean"),
        "Package": E(name="string", substrate="string", chipletCount="integer", interposer="string"),
    },
    "nvidia_isaac": {
        "SimRobot": E(name="string", embodiment="string", dof="integer", urdf="string"),
        "Skill": E(robotId="string", name="string", policyType="string", successRate="float"),
        "SimScene": E(name="string", assets="integer", domainRandomized="boolean", physicsDt="float"),
        "Policy": E(skillId="string", algorithm="string", checkpoint="string", reward="float"),
        "Sensor": E(robotId="string", modality="string", rateHz="float", resolution="string"),
        "Trajectory": E(robotId="string", waypoints="integer", durationS="float", status="string"),
    },
    "cerebras_wafer": {
        "WaferEngine": E(name="string", generation="string", coreCount="integer", sramGb="integer"),
        "ProcessingElement": E(engineId="string", dataflow="string", flops="float", localSramKb="integer"),
        "Fabric": E(engineId="string", topology="string", bisectionBwTbps="float", latencyNs="float"),
        "MemoryBank": E(engineId="string", sizeGb="integer", bandwidthTbps="float", kind="string"),
        "Kernel": E(engineId="string", name="string", tiles="integer", occupancy="float"),
        "WaferJob": E(engineId="string", model="string", tokensPerSec="float", status="string"),
    },
    "stripe": {
