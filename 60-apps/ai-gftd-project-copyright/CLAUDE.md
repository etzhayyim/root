# ai-gftd-project-copyright — Copyright Registry
...
| 軸 | Source Project |
|---|---|
| author | `ai-gftd-project-natural-person` (ORCID) |
| publisher | `ai-gftd-project-legal-entity` (LEI) |
| 楽曲 metadata | `ai-gftd-project-music` (existing) |
| 書籍 metadata | `ai-gftd-project-book` (if exists) |
...
| Component | nanoid |
|---|---|
| `ai-gftd-wasm-copyright-c0pyr1g7` | `c0pyr1g7` |
