...
Coverage: **21 of 31** hanrei XRPC commands ported.
...
Remaining 10 commands (`collectCases / collectCaseDetail / collectEgovLaws / collectGazette / collectLegislation / searchDecisions / extractCasePersons / createInformationHunt / coverageStats / huntCoverageStats / compareJurisdictions / etc.`) follow same Option B pattern; subsequent slices.
