// completer.gftd.ai — DID Compliance Actor
...
const NSID_PREFIX = "ai.gftd.apps.completer.";
const ACTOR_DID = "did:web:completer.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-completer/bpmn",
        methods: [
