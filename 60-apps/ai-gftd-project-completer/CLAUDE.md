# ai-gftd-project-completer — DID Compliance Actor
...
|---|---|
| **nanoid** | `ktugb754` |
| **domain** | `completer.gftd.ai` |
| **performer_id** | `ktugb754` |
| **AT bot DID** | `did:web:completer-ktugb754.gftd.ai` |
| **World** | `gftd-actor-agent` (LLM agent for compliance reasoning) |
