// kiyome.etzhayyim.com — Purification & Compliance Clearing Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: submitClearance / listClearances / approveClearance / rejectClearance /
//            createAuditLog / listAuditLogs / getComplianceStatus / runPurification
...
const NSID_PREFIX = "com.etzhayyim.apps.kiyome.";
const ACTOR_DID = "did:web:kiyome.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "j6x1brhm",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-kiyome/bpmn",
        methods: [
          "submitClearance", "listClearances", "approveClearance", "rejectClearance",
          "createAuditLog", "listAuditLogs", "getComplianceStatus", "runPurification",
        ],
      });
    }
