// ge.etzhayyim.com — Global Expansion & Organizational Intelligence Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: createOrg / listOrgs / createProject / listProjects /
//            assignResource / listResources / getOrgMetrics / planWorkforce
...
const NSID_PREFIX = "com.etzhayyim.apps.ge.";
const ACTOR_DID = "did:web:ge.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "zbikcidk",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-ge/bpmn",
        methods: [
          "createOrg", "listOrgs", "createProject", "listProjects",
          "assignResource", "listResources", "getOrgMetrics", "planWorkforce",
        ],
      });
    }
