#!/usr/bin/env python3
"""magatama-inference MLX wrapper — drop-in replacement for models unsupported by native binary.

Accepts same CLI interface as magatama-inference (--model, --prompt, --temperature, --max-tokens)
