...
AI Agent Gateway (`agentgateway`) is the application-level MCP (Model Context Protocol) router built on top of the AT Protocol. It serves as the primary entry point for AI Agents to discover and call tools across the GFTD ecosystem.

## Architecture

* **Runtime:** Cloudflare Worker
* **Protocol:** AT Protocol (XRPC), JSON-RPC 2.0 (MCP)
* **Target Interface:** `ai.gftd.mcp.message`
