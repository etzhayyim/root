// air-ops.etzhayyim.com — airline flight operations and dispatch layer
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: fileFlightPlan / createDispatchBrief / fetchNotam / fetchWeatherBrief / recordTechLog / orderFuel / submitPirep / monitorFlight
...
const NSID_PREFIX = "com.etzhayyim.apps.airOps.";
const ACTOR_DID = "did:web:air-ops.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "a1r0ps01",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/air-ops",
        methods: ["fileFlightPlan", "createDispatchBrief", "fetchNotam", "fetchWeatherBrief", "recordTechLog", "orderFuel", "submitPirep", "monitorFlight"],
      });
    }
