// air-dcs.etzhayyim.com — airline departure control system layer
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: processCheckIn / processBoardingPass / acceptBaggage / reconcileBaggage / computeLoadSheet / transmitApis / trackTurnaround / issueDepartureControl
...
const NSID_PREFIX = "com.etzhayyim.apps.airDcs.";
const ACTOR_DID = "did:web:air-dcs.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "a1rd3cs0",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/air-dcs",
        methods: ["processCheckIn", "processBoardingPass", "acceptBaggage", "reconcileBaggage", "computeLoadSheet", "transmitApis", "trackTurnaround", "issueDepartureControl"],
      });
    }
