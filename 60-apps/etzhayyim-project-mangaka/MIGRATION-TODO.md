...
This seed was copied verbatim from `etzhayyim-root/60-apps/etzhayyim-project-mangaka`.
...
**Status (Stripe layer)**: ✅ verified — zero Stripe SDK references in mangaka source code.
