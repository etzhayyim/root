...
const EPISODE_SLUG = process.env.GH_EPISODE_SLUG ?? "arc0-1-origin";
const MANIFEST_PATH = `${REPO}/resources/episodes/${EPISODE_SLUG}/image-gen-manifest.json`;
const EPISODE_PATH = `${REPO}/resources/episodes/${EPISODE_SLUG}/episode.jsonld`;
