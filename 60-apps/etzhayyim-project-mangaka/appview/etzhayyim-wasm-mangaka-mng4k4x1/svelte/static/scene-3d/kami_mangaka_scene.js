/* @ts-self-types="./kami_mangaka_scene.d.ts" */
...
export class ScenePreview {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ScenePreview.prototype);
        obj.__wbg_ptr = ptr;
        ScenePreviewFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ScenePreviewFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_scenepreview_free(ptr, 0);
    }
    /**
     ...
     * @returns {Promise<ScenePreview>}
     */
    static create(canvas_id) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.scenepreview_create(ptr0, len0);
        return ret;
    }
    /**
     ...
     * @param {string} jsonld
     */
    load_scene_jsonld(jsonld) {
        const ptr0 = passStringToWasm0(jsonld, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.scenepreview_load_scene_jsonld(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    render_frame() {
        const ret = wasm.scenepreview_render_frame(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    resize(css_w, css_h, dpr) {
        wasm.scenepreview_resize(this.__wbg_ptr, css_w, css_h, dpr);
    }
    /**
     * Orbit camera helper: yaw + pitch (radians) at `distance` metres from
     * (0, 1.4, 0). For interactive mouse-drag in the editor.
     * @param {number} yaw_rad
     * @param {number} pitch_rad
     * @param {number} distance_m
     */
    set_orbit_camera(yaw_rad, pitch_rad, distance_m) {
        wasm.scenepreview_set_orbit_camera(this.__wbg_ptr, yaw_rad, pitch_rad, distance_m);
    }
    /**
    ...
    to_scene_jsonld() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.scenepreview_to_scene_jsonld(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) ScenePreview.prototype[Symbol.dispose] = ScenePreview.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_scenepreview_new: function(arg0) {
            const ret = ScenePreview.__wrap(arg0);
            return ret;
        },
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 93, function: Function { arguments: [Externref], shim_idx: 94, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./kami_mangaka_scene_bg.js": import0,
    };
}
...
const ScenePreviewFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_scenepreview_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kami_mangaka_scene_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
