...
DEFAULT_CALLER_DID = "did:web:telecom.gftd.ai"
...
def onboard_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    vertex_id = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.subscriber/{subscriber_id}"
...
def activate_sim_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    subscriber_vid = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.subscriber/{subscriber_id}"
    vertex_id = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.sim/{sim_id}"
    row = {
        "vertex_id": vertex_id,
        "owner_did": caller_did(payload),
        "sim_id": sim_id,
...
def provision_service_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    subscriber_vid = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.subscriber/{subscriber_id}"
    vertex_id = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.service/{service_id}"
    row = {
        "vertex_id": vertex_id,
        "owner_did": caller_did(payload),
        ...
        "subscriber_vid": subscriber_vid,
        "sim_vid": (
            f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.sim/{payload['simId']}"
...
def record_usage_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    vertex_id = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.cdr/{cdr_id}"
    row = {
        "vertex_id": vertex_id,
        "owner_did": caller_did(payload),
        "cdr_id": cdr_id,
        "subscriber_vid": f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.subscriber/{subscriber_id}",
        "service_vid": f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.service/{service_id}",
...
def billing_cycle_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    vertex_id = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.invoice/{invoice_id}"
...
def sla_escalate_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    vertex_id = f"at://did:web:telecom.gftd.ai/ai.gftd.apps.telecom.slaBreach/{breach_id}"
