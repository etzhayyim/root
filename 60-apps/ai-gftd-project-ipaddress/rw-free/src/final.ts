/**
 * ipaddress rw-free — final tier (slice 12, +4 → 37/37, 100%).
 *
 ...
 *
 * Slice 12 closes ipaddress rw-free Option B reference impl at 37/37.
 *
...
const RIR_COLLECTION = "ai.gftd.apps.ipaddress.rir";
const NIR_COLLECTION = "ai.gftd.apps.ipaddress.nir";
