...
Coverage: **19 of 37** ipaddress XRPC commands ported.
...
Remaining 18 commands (`collectGeoip / collectWhois / batchIngestRir / analyzeIp / etc.`) follow the same Option B pattern and ship in follow-up slices.
