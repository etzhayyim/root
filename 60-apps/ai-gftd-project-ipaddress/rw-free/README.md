...
Coverage: **14 of 37** ipaddress XRPC commands ported.
...
Remaining 23 commands (`collectGeoip / collectWhois / batchIngestRir / getAbuseContact / analyzeIp / getDelegationChain / getIpTopology / getPeering / getGeolocation / etc.`) follow the same Option B pattern and ship in follow-up slices.
