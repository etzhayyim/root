...
## WIT Interfaces (gftd:yakiniku@0.1.0)

| Interface | Description |
|---|---|
| `gftd:yakiniku/vision` | カメラフレーム解析 — 部位認識、焼き加減判定、アクション推奨 |
| `gftd:yakiniku/recipe` | 部位別焼きレシピ — 時間、温度、裏返しタイミング、熱源別調整 |
| `gftd:yakiniku/condiment` | 薬味マッピング — 部位×熱源ごとの最適薬味・タレ |
| `gftd:yakiniku/print` | 印刷用 meat card 生成 — SVG/PDF テンプレート、ISCO-7323 連携 |
