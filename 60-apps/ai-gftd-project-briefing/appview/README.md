# ai-gftd-project-briefing App migration

このディレクトリは `legacy-runtime` 実装を残したまま、App 版を段階移行するための配置先です。

## 対象 App services

- `ai-gftd-performer-sys-gftd-app-briefing-bis87j5v`
- `briefing-2aqx6noz`
...
- `sys-briefing-mcp-component` (`ai-gftd-performer-sys-gftd-app-briefing-bis87j5v` 対応)
