...
_NSID_PUBLISH = "/xrpc/ai.gftd.apps.kenkyusha.publishFrontier"
_NSID_GET     = "/xrpc/ai.gftd.apps.kenkyusha.getFrontier"
_NSID_LIST    = "/xrpc/ai.gftd.apps.kenkyusha.listFrontiers"
