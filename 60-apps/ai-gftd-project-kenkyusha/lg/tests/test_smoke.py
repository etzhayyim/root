...
Run from `60-apps/ai-gftd-project-kenkyusha/lg/`:
...
touching `60-apps/ai-gftd-project-kenkyusha/lg/**`.
"""
...
def test_unknown_nsid_xrpc_404(client):
    r = client.post("/xrpc/ai.gftd.apps.kenkyusha.unknownMethod", json={})
    assert r.status_code == 404
