// kabi.gftd.ai — mycelium network layer (kabi = カビ)
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 5 methods: extendHypha / pruneHypha / fusionProbe / getNetwork / getNutrientFlow
...
const NSID_PREFIX = "ai.gftd.apps.kabi.";
const ACTOR_DID = "did:web:kabi.gftd.ai";
