...
**Required Files List**
- `deploy/magatama/org-gov-rou-dst-36487680-nasturelu.app.yaml` – App spec (namespace `magatama-runtime`, image pulled from `ghcr.io/etzhayyim/org-gov-rou-dst-36487680-nasturelu`, endpoint `https://<nanoid>.etzhayyim.com/api/grpc`).
