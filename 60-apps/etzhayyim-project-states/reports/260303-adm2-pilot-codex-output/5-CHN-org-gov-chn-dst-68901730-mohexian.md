...
**Required Files List**
- `deploy/org-gov-chn-dst-68901730-mohexian/app.yaml` – App spec with `metadata.name` = slug, namespace `magatama-runtime`, image `ghcr.io/etzhayyim/org-gov-chn-dst-68901730-mohexian:ADM2-pilot`.
