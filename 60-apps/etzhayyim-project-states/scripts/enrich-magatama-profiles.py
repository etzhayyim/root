...
Usage:
    python3 enrich-magatama-profiles.py                      # all found
    python3 enrich-magatama-profiles.py --iso jpn,usa,fra    # subset
    python3 enrich-magatama-profiles.py --records-dir /tmp/state-records/profile
    python3 enrich-magatama-profiles.py --dry-run
"""
