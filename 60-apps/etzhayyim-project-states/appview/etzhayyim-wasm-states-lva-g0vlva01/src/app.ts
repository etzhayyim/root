// govLva state app thin facade. Domain logic runs in AgentGateway MCP + pod-side LangServer gov primitives.
...
const ACTOR_DID = "did:web:lva-state.etzhayyim.com";
const NSID_PREFIX = "com.etzhayyim.govLva.";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/healthz" || url.pathname === "/readyz" || url.pathname === "/_app/meta") {
      return json({
        ...
        businessLogic: "40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/primitives/gov_lva.py",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/govLva",
      });
    }
