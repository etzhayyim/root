// robot.etzhayyim.com — Robotics Control & Dropshipping Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: workflowStart / workflowPlan / missionPlan / missionStatus /
//            missionSimulate / telemetryIngest / processCatalog / fulfillmentClose
...
const NSID_PREFIX = "com.etzhayyim.apps.robotics.";
const ACTOR_DID = "did:web:robot.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "k7m2p4x9",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-robot/bpmn",
        methods: [
          "workflowStart", "workflowPlan", "missionPlan", "missionStatus",
          "missionSimulate", "telemetryIngest", "processCatalog", "fulfillmentClose",
        ],
      });
    }
