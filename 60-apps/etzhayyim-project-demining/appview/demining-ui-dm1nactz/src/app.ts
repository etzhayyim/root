// Demining thin edge facade. HMA domain rules run in AgentGateway MCP + pod-side LangServer.
...
const APP = "demining";
const NSID_PREFIX = "com.etzhayyim.apps.demining.";
...
export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: "did:web:dm1nactz.etzhayyim.com",
        nanoid: env.APP_NANOID ?? "dm1nactz",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        businessLogic: "40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/ingest/demining.py",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/demining",
        policy: "APM manufacture/stockpile/transfer/deploy remain prohibited in Python worker.",
      });
    }
