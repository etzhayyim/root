...
@app.post("/xrpc/ai.etzhayyim.apps.docs.documentsCreate")
...
@app.post("/xrpc/ai.etzhayyim.apps.docs.documentsBatchUpdate")
...
@app.get("/xrpc/ai.etzhayyim.apps.docs.documentsGet")
