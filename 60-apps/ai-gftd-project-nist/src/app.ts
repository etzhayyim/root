// NIST CSF thin edge fallback. Main actor is logical; fallback XRPC runs in AgentGateway MCP + pod-side LangServer.
...
export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    return json({ error: "NotFound", message: "nist not found" }, 404);
  },
