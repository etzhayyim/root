...
const routes: Record<string, RouteConfig> = {
  [`${NSID_BASE}.fixSignal`]: { method: "POST", handler: (e, input) => rwFree.fixSignal(e, input as any) },
  [`${NSID_BASE}.getFixation`]: { method: "GET", handler: (e, input) => rwFree.getFixation(e, input as any) },
  [`${NSID_BASE}.listFixations`]: { method: "GET", handler: (e, input) => rwFree.listFixations(e, input as any) },
  [`${NSID_BASE}.releaseCarbon`]: { method: "POST", handler: (e, input) => rwFree.releaseCarbon(e, input as any) },
