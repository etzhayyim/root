// hub.gftd.ai — Integration Hub & API Gateway Platform
...
const NSID_PREFIX = "ai.gftd.apps.hub.";
const ACTOR_DID = "did:web:hub.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-hub/bpmn",
        methods: [
