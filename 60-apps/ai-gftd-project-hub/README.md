...
- Public UI: `https://hub.gftd.ai/`
- UI source: `cdn/hub-ui-m9x2k4qp`
- CDN prefix: `hub-ui`

Current implementation lives at:

- `/Users/junkawasaki/.codex/worktrees/3707/ai-gftd-apps-gftdcojp/60-apps/ai-gftd-project-hub/legacy-runtime/project-hub-qk6cjn0l`
...
## Supported GitHub REST Subset (via `hubgftdai`)
