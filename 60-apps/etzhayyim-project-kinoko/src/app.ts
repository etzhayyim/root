// kinoko.etzhayyim.com — fruiting body / PoNF consensus layer (kinoko = きのこ)
// Thin-edge dispatcher: BPMN ponf-fruiting.bpmn runs on R/PT15M timer in LangServer.
// 3 methods: checkFlowThreshold / formBlock / getBlock
...
const NSID_PREFIX = "com.etzhayyim.apps.kinoko.";
const ACTOR_DID = "did:web:kinoko.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "k1n0k001",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/kinoko",
        methods: ["checkFlowThreshold", "formBlock", "getBlock"],
      });
    }
