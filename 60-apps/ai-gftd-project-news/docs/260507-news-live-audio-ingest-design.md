...
- XRPC/BPMN NSID: `ai.gftd.apps.news.liveAudioIngest`
...
- Record collection: `ai.gftd.apps.news.liveAudioSource`
- Write command: `ai.gftd.apps.news.registerLiveAudioSource`
- Read query: `ai.gftd.apps.news.listLiveAudioSources`
- Policy audit query: `ai.gftd.apps.news.auditLiveAudioPolicies`
- Scheduler command: `ai.gftd.apps.news.scheduleLiveAudioIngest`
- Scheduler state collection: `ai.gftd.apps.news.liveAudioScheduleState`
...
3. `xrpc.ai.gftd.apps.news.analyzeIntel`
   - Write an attributed `ai.gftd.apps.intel.report`.
