// scheduler.etzhayyim.com — Job Scheduling Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: createJob / getJob / updateJob / deleteJob /
//            listJobs / pauseJob / resumeJob / jobStatus
...
const NSID_PREFIX = "com.etzhayyim.apps.scheduler.";
const ACTOR_DID = "did:web:scheduler.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "sc3dul3r",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-scheduler/bpmn",
        methods: [
