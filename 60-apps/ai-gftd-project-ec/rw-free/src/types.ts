...
export const PRODUCT_COLLECTION = "app.etzhayyim.apps.ec.product";
export const ORDER_COLLECTION = "app.etzhayyim.apps.ec.order";
export const PAYMENT_COLLECTION = "app.etzhayyim.apps.ec.payment";
