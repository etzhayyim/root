# ai-gftd-project-cpc — Central Product Classification Platform
...
→ `gftd dodaf tv1 query --id ai-gftd-project-cpc-script-based-bulk-generation-禁止` / MCP `gftd.dodaf.tv1.query`
...
CPC 製品は ISIC 産業の産出物。`gftd:isic-resource-flow/products@1.0.0` の `product-code` フィールドが CPC コードを使用。
...
`gftd:isic-resource-flow@1.0.0` の `material-flow` と `product-flow` で CPC コードを使用:
...
**CPC division performers (div-43/45/47/49/54) が `gftd:tsukuru-process-registry/process-registry@1.0.0` を import し、製品コードから製造プロセスを magatama linker で解決する。**

| CPC Division | CPC Code | Tsukuru Process | Linker Requires |
|---|---|---|---|
| 45 (Office/computing) | 45220 | `computer-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 47 (Radio/TV/comm) | 47210 | `smartphone-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 43 (General-purpose machinery) | 43131 | `aircraft-engine-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 43 (General-purpose machinery) | 43132 | `jet-engine-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 49 (Transport eq.) | 49113 | `automobile-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 49 (Transport eq.) | 49622 / 49623 | `aircraft-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 49 (Transport eq.) | 49640 | `aircraft-parts-manufacturing` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
| 54 (Construction) | 54111 | `building-construction` | `gftd:tsukuru-process-registry/process-registry@1.0.0` |
...
| Package | Path | 内容 |
|---|---|---|
| `gftd:cpc-product-classification@1.0.0` | `wit/cpc-product-classification/` | Core types, classification query, trade flow, quality standards |
| `gftd:cpc-0@1.0.0` | `wit/cpc-0/` | Section 0: Agriculture products capability |
| `gftd:cpc-1@1.0.0` | `wit/cpc-1/` | Section 1: Ores, minerals, utilities capability |
| `gftd:cpc-2@1.0.0` | `wit/cpc-2/` | Section 2: Food, textiles capability |
| `gftd:cpc-3@1.0.0` | `wit/cpc-3/` | Section 3: Other transportable goods capability |
| `gftd:cpc-4@1.0.0` | `wit/cpc-4/` | Section 4: Metal, machinery capability |
| `gftd:cpc-5@1.0.0` | `wit/cpc-5/` | Section 5: Construction capability |
| `gftd:cpc-6@1.0.0` | `wit/cpc-6/` | Section 6: Trade, transport services capability |
| `gftd:cpc-7@1.0.0` | `wit/cpc-7/` | Section 7: Financial, real estate services capability |
| `gftd:cpc-8@1.0.0` | `wit/cpc-8/` | Section 8: Business services capability |
| `gftd:cpc-9@1.0.0` | `wit/cpc-9/` | Section 9: Community, social services capability |
