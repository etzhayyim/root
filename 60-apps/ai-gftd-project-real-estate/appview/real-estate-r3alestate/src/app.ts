// Real Estate thin edge facade. Read/write logic runs in AgentGateway MCP + pod-side LangServer/generic tasks.
...
const NSID_PREFIX = "ai.gftd.apps.realEstate.";
