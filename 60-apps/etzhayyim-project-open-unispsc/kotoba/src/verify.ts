/**
 * Verification: Merkle proof of a UNSPSC segment record against the
 * Base L2 anchor. Any client (no creds) can take an AT URI, fetch the
 * record from PDS, traverse upward to the MST root, look up which L2
