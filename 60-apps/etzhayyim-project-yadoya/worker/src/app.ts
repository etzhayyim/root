// yadoya.etzhayyim.com thin facade. Domain logic runs in AgentGateway MCP + pod-side LangServer workers.
...
const ACTOR_DID = "did:web:yadoya.etzhayyim.com";
const NSID_PREFIX = "com.etzhayyim.apps.yadoya.";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/healthz" || url.pathname === "/readyz" || url.pathname === "/_app/meta") {
      return json({
        ...
        businessLogic: "40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/primitives/yadoya.py",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/yadoya",
      });
    }
