...
Ported from _archive/migrated-to-etzhayyim-2026-05-21/40-engine/kotoba/crates/kotoba-kotodama/
py/src/kotodama/primitives/chat.py (2026-05-23).
"""
...
_B2_BUCKET = os.environ.get("CHAT_B2_BUCKET", "etzhayyim-chat-artifacts")
...
def tool_file_save(args: dict[str, Any], *, conv_id: str = "", owner_did: str = "") -> dict[str, Any]:
    ...
    cdn_url = f"https://cdn.etzhayyim.com/{key}"
...
def tool_schedule_report(args: dict[str, Any], *, conv_id: str = "", msg_id: str = "",
    ...
    url = f"{_DISPATCHER_URL}/xrpc/ai.etzhayyim.apps.chat.scheduleReport"
    try:
