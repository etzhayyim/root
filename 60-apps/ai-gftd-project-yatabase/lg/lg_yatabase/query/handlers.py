...
'com.etzhayyim.apps.yata.deployedQuery', results cached on IPFS. Update after schema finalized.
"""
...
@router.post("/xrpc/com.etzhayyim.apps.yata.deployQuery")
...
@router.post("/xrpc/com.etzhayyim.apps.yata.executeDeployedQuery")
...
@router.get("/xrpc/com.etzhayyim.apps.yata.listDeployedQueries")
...
@router.post("/xrpc/com.etzhayyim.apps.yata.deleteDeployedQuery")
