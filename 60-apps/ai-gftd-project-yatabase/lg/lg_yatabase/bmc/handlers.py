...
existing `com.etzhayyim.apps.yata.*` surface — see
`00-contracts/lexicons/com/etzhayyim/apps/yata/bmc*.json`.
"""
...
@router.get("/xrpc/com.etzhayyim.apps.yata.bmcGetState")
...
@router.get("/xrpc/com.etzhayyim.apps.yata.bmcListHypotheses")
...
@router.get("/xrpc/com.etzhayyim.apps.yata.bmcListIterations")
...
@router.get("/xrpc/com.etzhayyim.apps.yata.bmcListDecisions")
