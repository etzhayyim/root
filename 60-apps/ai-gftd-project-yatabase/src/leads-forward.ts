...
export async function forwardLeadIngest(
  ...
  return forwardBmc(env, "POST", "ai.gftd.apps.yata.leadIngest", body, withTrace(traceId), { timeoutMs: 20_000 });
}
...
export async function forwardLeadList(
  ...
  return forwardBmc(env, "GET", "ai.gftd.apps.yata.leadList", query as Record<string, unknown>, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadGet(
  ...
  return forwardBmc(env, "GET", "ai.gftd.apps.yata.leadGet", { vertex_id }, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadSetOutreachStatus(
  ...
  return forwardBmc(env, "POST", "ai.gftd.apps.yata.leadSetOutreachStatus", body as Record<string, unknown>, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadSetContactEmail(
  ...
  return forwardBmc(env, "POST", "ai.gftd.apps.yata.leadSetContactEmail", body as Record<string, unknown>, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadSetEnrichment(
  ...
  return forwardBmc(env, "POST", "ai.gftd.apps.yata.leadSetEnrichment", body as Record<string, unknown>, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadMarkDrafted(
  ...
  return forwardBmc(env, "POST", "ai.gftd.apps.yata.leadMarkDrafted", body as Record<string, unknown>, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadReady(
  ...
  return forwardBmc(env, "GET", "ai.gftd.apps.yata.leadReady", { limit }, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadSendable(
  ...
  return forwardBmc(env, "GET", "ai.gftd.apps.yata.leadSendable", { limit }, withTrace(traceId), { timeoutMs: 10_000 });
}
...
export async function forwardLeadNeedsEnrichment(
  ...
  return forwardBmc(env, "GET", "ai.gftd.apps.yata.leadNeedsEnrichment", { limit }, withTrace(traceId), { timeoutMs: 10_000 });
}
