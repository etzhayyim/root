...
async function cmdRegisterPeer(
  ...
  await getDb().insertInto("vertex_watashi_peer" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.peer/${rkey}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdSaveLayout(
  ...
  await getDb().insertInto("vertex_watashi_layout" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.layout/${localPeerId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdCreateSession(
  ...
  await getDb().insertInto("vertex_watashi_session" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.session/${sessionId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdSyncClipboard(
  ...
  await getDb().insertInto("vertex_watashi_clipboard_sync" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.clipboardSync/${syncId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdInitiateTransfer(
  ...
  await getDb().insertInto("vertex_watashi_file_transfer" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.fileTransfer/${transferId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdRecordAudit(
  ...
  await getDb().insertInto("vertex_watashi_audit_log" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.auditLog/${auditId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdPublishRelease(
  ...
  await getDb().insertInto("vertex_watashi_release" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.release/${releaseId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdInitiatePairing(
  ...
  await getDb().insertInto("vertex_watashi_pairing" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.pairing/${pairingId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
...
async function cmdIssueRelaySession(
  ...
  await getDb().insertInto("vertex_watashi_session" as any).values({
    vertex_id: `at://${actorDID}/ai.gftd.apps.watashi.session/${relaySessionId}`,
    sensitivity_ord: 2,
    owner_did: actorDID,
    org_id: "anon",
    user_id: "anon",
