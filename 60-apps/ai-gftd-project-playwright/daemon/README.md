...
```bash
cd 60-apps/ai-gftd-project-playwright/daemon
npm install
...
| `keychain:` | `keychain:gftd.shiharai.tokyo-waterworks/primary.password` | `security find-generic-password` + JSON key extract |
...
security add-generic-password \
  -s gftd.shiharai.tokyo-waterworks \
  -a primary \
...
PLAYWRIGHT_DAEMON_TOKEN="$(gftd agent-token --lxm com.etzhayyim.apps.playwright.dequeueAction)" \
npm run dev
```
...
<dict>
  ...
  <array>
    ...
    <string>/Users/YOU/path/to/60-apps/ai-gftd-project-playwright/daemon/dist/index.js</string>
  </array>
...
| `authorization: Bearer` 401 | Re-mint `gftd agent-token --lxm com.etzhayyim.apps.playwright.dequeueAction` |
