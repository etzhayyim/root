...
13 files of `wasm/etzhayyim-wasm-legal-entity-le9k4x2m/` (Svelte appview + worker + Magatama JSON-LD descriptor) were dropped during the 2026-05-21 batch migration. The `lg/` LangGraph server portion was already migrated cleanly.
