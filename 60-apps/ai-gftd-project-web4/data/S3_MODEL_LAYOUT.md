...
(`gftd-static-sites`) and resolves them through control-plane manifests.

## Model prefixes

- `gftd/gftd-distributed-moe-260222` (Qwen)
  - experts: `models/qwen3-30b-a3b/experts/set-XXX.bin`
  - host: `models/qwen3-30b-a3b/host/*`
- `gftd/gftd-distributed-ti2v-moe-260222` (Wan2.2 TI2V)
