# ai-gftd-project-web4 (GCC Token & Minter)
...
- Contracts dir: `60-apps/ai-gftd-project-web4/contracts/usdc-test-t0k3n8x/`
...
- Linode token in macOS Keychain: `security find-generic-password -s "gftd.ai/pulumi" -a "LINODE_TOKEN" -w`
...
- Bucket: `gftd-static-sites` (cluster: `jp-osa-1`)
- Qwen model id: `gftd/gftd-distributed-moe-260222`
  - experts: `models/qwen3-30b-a3b/experts/set-000.bin` ... `set-031.bin`
  - manifest: `models/qwen3-30b-a3b/manifests/latest.json`
- Wan model id: `gftd/gftd-distributed-ti2v-moe-260222`
...
- After control-plane deploy, verify:
  - `/api/manifests`
  - `/api/manifest?model_id=gftd/gftd-distributed-moe-260222`
  - `/api/manifest?model_id=gftd/gftd-distributed-ti2v-moe-260222`

## blobstore-s3 Example

`60-apps/ai-gftd-project-web4/wasm/control-plane-25primzm/`:
```yaml
- name: blobstore-s3
  type: capability
  properties:
