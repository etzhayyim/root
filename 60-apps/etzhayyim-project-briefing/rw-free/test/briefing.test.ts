...
describe("briefing rw-free (kotoba-E2E split)", () => {
  let e: any;
  beforeEach(() => {
  ...
  describe("actionItem (E2E-ENCRYPTED assignee PII)", () => {
    it("seals, validates, lists/filters by room", async () => {
      expect((await recordActionItem(e, { actionItemId: "ai1", roomId: "r1", assigneeDid: "did:web:carol", text: "ship rw-free" })).status).toBe("recorded");
