// fleamarket.gftd.ai — C2C flea market platform — listings, bids, transactions, shipping
...
const ACTOR_DID = "did:web:fleamarket.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-fleamarket/bpmn",
        methods: [
