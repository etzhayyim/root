...
//
// Uses @gftd/signal field-level AES-256-GCM. Identity is generated locally
// via generateIdentity() — no registerPreKeys(), no transport required.
// Encrypted turns are kept in IndexedDB "gftd-chat-ephemeral-v1".
...
const DB_NAME = "gftd-chat-ephemeral-v1";
