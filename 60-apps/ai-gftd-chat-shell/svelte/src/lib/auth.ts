...
// verification via a service binding to ai-gftd-auth — this client just
...
// Truncate a DID for display: `did:web:authn.gftd.ai:user:abc12345` →
// `authn.gftd.ai/abc12345`. Falls back to the full handle when the DID
// is not the gftd authn shape.
