// webpage.etzhayyim.com — Web Page Creation & Publishing Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: createPage / listPages / getPage / updatePage /
//            publishPage / listPublished / getPageStats / searchPages
...
const NSID_PREFIX = "com.etzhayyim.apps.webpage.";
const ACTOR_DID = "did:web:webpage.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "n9j2qp89",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-webpage/bpmn",
        methods: [
          "createPage", "listPages", "getPage", "updatePage",
          "publishPage", "listPublished", "getPageStats", "searchPages",
        ],
      });
    }
