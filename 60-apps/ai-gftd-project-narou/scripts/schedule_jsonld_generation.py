...
if __name__ == "__main__":
    ...
    parser.add_argument("--source-dir", default="projects/ai-gftd-project-narou/content/sources")
    parser.add_argument("--output", default="projects/ai-gftd-project-narou/content/generated/content.bundle.jsonld")
    parser.add_argument("--base-url", default="https://narou.gftd.ai/content")
    parser.add_argument(
        "--generator-script",
        default="projects/ai-gftd-project-narou/scripts/generate_content_jsonld.py",
    )
