// games.etzhayyim.com — Game platform — titles, scores, achievements, leaderboards, sessions
...
const NSID_PREFIX = "com.etzhayyim.apps.games.";
const ACTOR_DID = "did:web:games.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "t9nt3w5u",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-games/bpmn",
        methods: [
