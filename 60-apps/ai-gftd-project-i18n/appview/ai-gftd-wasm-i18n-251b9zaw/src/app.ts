// i18n thin edge facade. Translation/TM/project logic runs in AgentGateway MCP + pod-side LangServer.
...
const APP = "i18n";
const NSID_PREFIX = "ai.gftd.apps.i18n.";
