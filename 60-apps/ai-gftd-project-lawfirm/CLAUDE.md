...
旧 `deploy config` (App CRD 時代) および `magatama/k8s/deployment.yaml` は除去済み。deploy は `gftd deploy` を使用する。
...
cd 60-apps/ai-gftd-project-lawfirm/wasm/lawfirm-lawyer-static-component/svelte
