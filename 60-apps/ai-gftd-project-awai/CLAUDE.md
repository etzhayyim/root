...
**Source of Truth**: `60-apps/ai-gftd-project-awai/wit/gaussian-splat/package.wit`

```
gftd:gaussian-splat@0.1.0
...
`proto/gftd/awai/v1/awai.proto` — synced from WIT.
...
| gftd:store/store | Object store (bucket: awai-splat-data) |
| gftd:cdn/cdn | CDN provider (legacy, retired) |

## Build & Deploy

```bash
# Build Svelte frontend
cd 60-apps/ai-gftd-project-awai/wasm/ai-gftd-wasm-awai-ku9ndz8y/svelte
