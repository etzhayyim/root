...
|---|---|---|---|
| collector (unified) | `ai-gftd-wasm-collector-c0ll3ct1` | c0ll3ct1 | apps-mt manifest |

## App

- Runtime: Single Worker (TS Native + SvelteKit SSR)
- Deploy: `gftd build && gftd deploy --from .`
...
```bash
cd 60-apps/ai-gftd-project-collector/wasm/ai-gftd-wasm-collector-c0ll3ct1
gftd deploy   # gftd build は不要 (TS Native)
```
