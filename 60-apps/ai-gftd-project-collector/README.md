...
`ai-gftd-project-collector` は、IP アドレス / DNS / RDAP を中心に、グローバルなネットワーク情報を収集する App プロジェクトです。
...
このプロジェクトでは、既存の類似 collector 実装を `60-apps/ai-gftd-project-collector/wasm/` へ集約します。
