# ai-gftd-project-testing App migration

このディレクトリは `legacy-runtime` 実装を残したまま、App 版を段階移行するための配置先です。

## 対象 App services

- `ai-gftd-performer-svc-fixture-manager-t7b6v8m1`
...
- `fixture-manager-mcp-component` (`ai-gftd-performer-svc-fixture-manager-t7b6v8m1` 対応)
