// provider-pod.gftd.ai — Provider Pod Registry & Health Management Platform
...
const NSID_PREFIX = "ai.gftd.apps.providerPod.";
const ACTOR_DID = "did:web:provider-pod.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-provider-pod/bpmn",
        methods: [
