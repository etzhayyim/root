# Migration TODO — ai-gftd-project-provider-pod

**Status**: 🔄 TRANSFORM — thin-edge appview migrated from gftdcojp archive 2026-06-02.
...
- Confirm `DISPATCHER_URL` targets an etzhayyim-substrate dispatcher (RW-free).
- Any settlement path → USDC + ERC-4337 (no Stripe/fiat).
- appview wiring + `rw-free/` reference slice TBD.
