...
Different shape from taxonomy actors ([open-isco](../../etzhayyim-project-open-isco/rw-free/) / [open-isic](../../etzhayyim-project-open-isic/rw-free/) / [open-unispsc](../../etzhayyim-project-open-unispsc/rw-free/) / [open-apqc](../../etzhayyim-project-open-apqc/rw-free/)): not a publish-once catalog but an interaction surface (create + list + verify).
...
- [`60-apps/etzhayyim-project-open-isco/rw-free/`](../../etzhayyim-project-open-isco/rw-free/) etc. — taxonomy-actor pattern (different shape)
