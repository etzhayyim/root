// Game Play Uploader thin edge facade. Campaign/upload/reward logic runs in AgentGateway MCP + pod-side LangServer.
...
const NSID_PREFIX = "ai.gftd.apps.gamePlayUploader.";
...
export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    return json({ error: "NotFound", message: "game-play-uploader not found" }, 404);
  },
