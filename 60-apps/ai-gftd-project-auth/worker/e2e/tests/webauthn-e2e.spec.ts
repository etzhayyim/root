 ...
 *   2. POST /xrpc/ai.gftd.auth.passkeyBeginRegister → get challenge
 *   3. navigator.credentials.create → virtual authenticator signs
 *   4. POST /xrpc/ai.gftd.auth.passkeyVerifyRegister → get DID + session
 *   5. POST /xrpc/ai.gftd.auth.passkeyBeginAuth + VerifyAuth (sign-in)
