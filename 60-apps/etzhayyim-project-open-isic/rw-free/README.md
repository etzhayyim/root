# open-isic — RW-free reference implementation

RW-free port of the UN ISIC Rev.4 industrial classification under the
substrate rules of [ADR-2605172000](../../../90-docs/adr/2605172000-etzhayyim-rw-free-substrate.md):
...
```typescript
import { queryByPrefix } from "@etzhayyim/open-isic-rw-free";
...
import { getByCode } from "@etzhayyim/open-isic-rw-free";
