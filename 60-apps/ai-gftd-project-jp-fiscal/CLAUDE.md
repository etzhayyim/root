...
|---|---|---|
| jpfiscal-ingest | `appview/ai-gftd-wasm-jpfiscal-jpf15c4l/` | 10-source ingest + dispatch |
...
- 14 lexicon `00-contracts/lexicons/ai/gftd/apps/jpFiscal/`
