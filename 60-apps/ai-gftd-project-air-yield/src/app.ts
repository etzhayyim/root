// air-yield.gftd.ai — airline revenue management and pricing layer
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: publishFareClass / adjustInventory / fileFare / setOverbooking / processGroupBooking / applyDynamicPrice / generateRevenueReport / forecastDemand
...
const NSID_PREFIX = "ai.gftd.apps.airYield.";
const ACTOR_DID = "did:web:air-yield.gftd.ai";
