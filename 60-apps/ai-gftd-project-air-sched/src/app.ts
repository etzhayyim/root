// air-sched.gftd.ai — airline schedule management layer
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: registerSchedule / requestSlot / allocateSlot / assignFleet / publishSchedule / assignGate / changeFrequency / registerCodeshare
...
const NSID_PREFIX = "ai.gftd.apps.airSched.";
const ACTOR_DID = "did:web:air-sched.gftd.ai";
