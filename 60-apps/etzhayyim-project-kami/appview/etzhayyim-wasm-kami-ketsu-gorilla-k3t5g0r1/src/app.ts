// Goriketsu Dash thin edge facade. Score/leaderboard logic runs in AgentGateway MCP + pod-side LangServer.
...
const NSID_PREFIX = "com.etzhayyim.apps.kami.ketsuGorilla.";
...
export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: "did:web:k3t5g0r1.etzhayyim.com",
        nanoid: env.APP_NANOID ?? "k3t5g0r1",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        businessLogic: "40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/ingest/kami_ketsu_gorilla.py",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/kamiKetsuGorilla",
      });
    }
