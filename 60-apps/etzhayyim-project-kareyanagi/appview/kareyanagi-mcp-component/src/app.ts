// kareyanagi.etzhayyim.com — Dry Goods & Wholesale Trade Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: createListing / listListings / createOrder / listOrders /
//            updateInventory / getInventory / processTrade / getTradeHistory
...
const NSID_PREFIX = "com.etzhayyim.apps.kareyanagi.";
const ACTOR_DID = "did:web:kareyanagi.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "w8p4dsvf",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-kareyanagi/bpmn",
        methods: [
          "createListing", "listListings", "createOrder", "listOrders",
          "updateInventory", "getInventory", "processTrade", "getTradeHistory",
        ],
      });
    }
