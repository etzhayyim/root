# ai-gftd-project-osekkai — お節介 Coordinator
  ...
  "triggers": {
    "subscribeRepos": {
      "collections": [
        ...
        "ai.gftd.wellbeing.score"   // well-becoming score 変動
      ]
    }
  }
}
...
| `auth` | per-nudge Service Auth JWT (`lxm=ai.gftd.apps.osekkai.nudge`) |
...
|---|---|
| Nanoid | `os3kk41x` |
| Folder | `wasm/ai-gftd-wasm-osekkai-os3kk41x/` (T1/T2 Logical Actor として scout/retractor/apologizer を migrate) |
