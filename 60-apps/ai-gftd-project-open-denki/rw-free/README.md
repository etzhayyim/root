...
Coverage: **5 of 12** canonical open-denki commands ported (topology tier).

| Tier | Commands | Slice |
|---|---|---|
| Topology | defineGenerationNode, defineSubstation, defineFeeder, registerSmartMeter, getNode | **1** |

Remaining 7 canonical commands (`recordMeterReading / reportFault / recordDemandResponse / recordRenewableOutput / listFeeders / listFaults / listReadings`) ship in follow-up slices.
