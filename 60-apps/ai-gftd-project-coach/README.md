# ai-gftd-project-coach

`ai-gftd-project-coach` は、coaching を目的とした AI-agent chat app です。
...
```bash
kubectl apply -f 60-apps/ai-gftd-project-coach/wasm/coach-chat-mcp-component/<repo-deploy-config>
kubectl apply -f 60-apps/ai-gftd-project-coach/wasm/coach-chat-mcp-component/k8s/http-routes.yaml
kubectl apply -f 60-apps/ai-gftd-project-coach/wasm/coach-ui-component/<repo-deploy-config>
kubectl apply -f 60-apps/ai-gftd-project-coach/wasm/coach-ui-component/k8s/http-routes.yaml
```
