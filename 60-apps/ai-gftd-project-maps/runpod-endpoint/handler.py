  ...
  Request:
    {
      "input": {
        ...
        "sceneUri":      "at://did:web:maps.etzhayyim.com/app.etzhayyim.apps.maps.satelliteScene/…",
    ...
    if runpod is None:
        ...
        sample = {
            "input": {
                ...
                "sceneUri": "at://did:web:maps.etzhayyim.com/app.etzhayyim.apps.maps.satelliteScene/scn-s-20260427-deadbeef",
