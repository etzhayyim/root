...
wrangler login
cd 60-apps/ai-gftd-project-flight-offer/appview/ai-gftd-wasm-flight-offer-fl1ghts1
gftd deploy
...
security add-generic-password -s gftd.flightoffer -a AMADEUS_CLIENT_ID -w '...' -U
security add-generic-password -s gftd.flightoffer -a AMADEUS_CLIENT_SECRET -w '...' -U
