...
XRPC: ai.gftd.animeka.publishEpisode
Input:
        ...
        try:
            if episode_rkey:
                rows = await db.fetch(
                    ...
                    FROM vertex_animeka
                    WHERE collection = 'ai.gftd.animeka.episode' AND rkey = $1
                ...
                rows = await db.fetch(
                    ...
                    SELECT rkey, output_cid, status, _seq
                    FROM vertex_animeka
                    WHERE collection = 'ai.gftd.animeka.episode'
            ...
            work_rows = await db.fetch(
                ...
                WHERE collection = 'ai.gftd.animeka.work'
    ...
    try:
        ...
        try:
            await conn.execute(
                ...
                " WHERE collection = 'ai.gftd.animeka.episode' AND rkey = %s",
                [episode_rkey],
            )
