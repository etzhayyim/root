...
`ai-gftd-project-well-becoming` に子どもの成長を保護し育む capability agent 群を設計する。
...
全対話は Matrix room/thread 上で実行。Cross-project 設計の権威ソースは `60-apps/ai-gftd-project-public-fund/90-docs/260315-cross-project-matrix-conversation-design.md`。
...
| Component | Folder | 役割 |
|---|---|---|
| `ai-gftd-wasm-becoming-guardian-{nanoid}` | `wasm/` | Growth Guardian (守) |
| `ai-gftd-wasm-becoming-nurturer-{nanoid}` | `wasm/` | Capability Nurturer (育) |
| `ai-gftd-wasm-becoming-protector-{nanoid}` | `wasm/` | Safety Protector (盾) |
| `ai-gftd-wasm-becoming-play-{nanoid}` | `wasm/` | Play & Wellbeing Facilitator (遊) |
| `ai-gftd-wasm-becoming-family-{nanoid}` | `wasm/` | Family Bond Strengthener (和) |
...
権威ソース: `60-apps/ai-gftd-project-public-fund/90-docs/260315-cross-project-matrix-conversation-design.md`
