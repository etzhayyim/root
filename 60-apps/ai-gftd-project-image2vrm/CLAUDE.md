...
ls /tmp/avatar-parts/*.glb | xargs -P 8 -I{} sh -c \
  'npx wrangler r2 object put "murakumo-gftd-ai/avatar/parts/$(basename {})" \
...
```
60-apps/ai-gftd-project-image2vrm/
  CLAUDE.md
  docs/character-maker-design.md
  wasm/ai-gftd-wasm-image2vrm-img2vrm1/
...
cd 60-apps/ai-gftd-project-image2vrm/wasm/ai-gftd-wasm-image2vrm-img2vrm1
gftd deploy

# KAMI WASM rebuild + CDN deploy
cd 40-engine/kami-engine
RUSTC_WRAPPER="" wasm-pack build --target web kami-web
npx wrangler r2 object put "ai-gftd-cdn/kami-web/vrm2122/kami_web_bg.wasm" --file="kami-web/pkg/kami_web_bg.wasm" --content-type="application/wasm" --remote
npx wrangler r2 object put "ai-gftd-cdn/kami-web/vrm2122/kami_web.js" --file="kami-web/pkg/kami_web.js" --content-type="application/javascript" --remote
```
