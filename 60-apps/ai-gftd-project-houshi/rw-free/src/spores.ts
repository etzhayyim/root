/**
 * houshi rw-free — sporulation system (3/3 canonical lexicons).
 *
...
const SPORE_COLLECTION = "ai.gftd.houshi.spore";
const GERMINATE_COLLECTION = "ai.gftd.houshi.germinate";
