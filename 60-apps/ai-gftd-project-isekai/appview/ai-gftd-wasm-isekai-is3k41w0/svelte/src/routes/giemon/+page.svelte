<script lang="ts">
  // GIEMON viewer as a first-class Svelte route. Loads the kami-app-giemon WASM
  // bundle (served from static/giemon/) on the client and runs the selected
  // model — default = Kabitori 黴取り mold-removal sim. The .htm harness in
  // static/ is retained; this is the SvelteKit-native surface.
