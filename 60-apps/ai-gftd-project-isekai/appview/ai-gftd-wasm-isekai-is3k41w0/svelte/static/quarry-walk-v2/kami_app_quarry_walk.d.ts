...
export function run_quarry_walk_v2(canvas_id: string): Promise<void>;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly run_quarry_walk_v2: (a: number, b: number) => any;
    readonly wasm_bindgen__closure__destroy__h2999ab7c8b76f609: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__ha9938b45731c5938: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h8aeffaeb74254bf7: (a: number, b: number) => void;
