# ai-gftd-project-threat-intelligence
...
```bash
cd 60-apps/ai-gftd-project-threat-intelligence/legacy-runtime/ti-collector-m7t8k2p1
go test ./...
...
- `60-apps/ai-gftd-project-resources/content/ti/**`
...
```bash
cd 60-apps/ai-gftd-project-threat-intelligence/wasm/ti-ui-n3q6v8s4/svelte
pnpm i
