// wire.gftd.ai — Wire Transfer & Messaging Platform
...
const NSID_PREFIX = "ai.gftd.apps.wire.";
const ACTOR_DID = "did:web:wire.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-wire/bpmn",
        methods: [
