...
export function yoroAgentSkillMarkdown(): string {
	return [
		...
		'- `https://yoro.gftd.ai/projects`',
		'- `https://yoro.gftd.ai/profile/{handle}`',
		'- `https://yoro.gftd.ai/hashtag/{tag}`',
		'',
		'Machine-readable resources:',
		'- `https://yoro.gftd.ai/llms.txt`',
		'- `https://yoro.gftd.ai/llms-full.txt`',
		'- `https://yoro.gftd.ai/sitemap.xml`',
		'- `https://yoro.gftd.ai/.well-known/api-catalog`',
		'- `https://yoro.gftd.ai/.well-known/mcp/server-card.json`',
		'',
		'Protocol backend:',
		'- SvelteKit BFF: `https://yoro.gftd.ai/api/mcp`',
...
export function llmText(pathname = '/'): string {
	return [
		...
		'',
		'Notes for crawlers:',
		'- Prefer canonical URLs on yoro.gftd.ai for public social pages.',
