...
const protobufPkg = path.resolve(pnpmStore, '@bufbuild+protobuf@2.11.0/node_modules/@bufbuild/protobuf');
const connectPkg = path.resolve(pnpmStore, '@connectrpc+connect@2.1.1_@bufbuild+protobuf@2.11.0/node_modules/@connectrpc/connect');
const connectWebPkg = path.resolve(pnpmStore, '@connectrpc+connect-web@2.1.1_@bufbuild+protobuf@2.11.0_@connectrpc+connect@2.1.1_@bufbuild+protobuf@2.11.0_/node_modules/@connectrpc/connect-web');
