...
| Path | Description |
|------|-------------|
| `wasm/ai-gftd-wasm-wellness-w3lln3sx/` | App with API + static fileserver ownership |
| `wasm/ai-gftd-wasm-wellness-w3lln3sx/<repo-deploy-config>` | App manifest |
