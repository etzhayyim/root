# ai-gftd-project-immutizer Design

## 1. Goal

`ai-gftd-project-immutizer` に登録されている SaaS / mailing list / vendor account に対して、
...
既存のアンチウイルス用途 `ai-gftd-wasm-immutizer-i8m2t9zr` は維持し、本機能は別 component として追加する。

## 2. Proposed Component

- component folder
  - `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/`
- app role
...
- `gftd.immutizer.retirement.case.create`
  - service account と request type を投入
- `gftd.immutizer.retirement.case.dispatch`
  - policy 判定後の実行開始
- `gftd.immutizer.retirement.case.retry`
  - 失敗案件の再送
- `gftd.immutizer.retirement.case.complete`
  - 完了通知
- `gftd.immutizer.retirement.case.escalate`
  - 手動対応へ移行
...
- `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/main.go`
- `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/db_schema.go`
- `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/policy.go`
- `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/executor.go`
- `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/svelte/src/routes/+page.svelte`
- `60-apps/ai-gftd-project-immutizer/wasm/ai-gftd-wasm-immutizer-retirement-<nanoid>/<repo-deploy-config>`
