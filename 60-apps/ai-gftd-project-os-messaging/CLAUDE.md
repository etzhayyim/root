# ai-gftd-project-os-messaging — Multi-Platform Messaging Bridge
...
- BPMN: `etzhayyim-root/00-contracts/bpmn/ai/gftd/os-messaging/crawlOpenChannels.bpmn` (`os_messaging_crawl_open_channels`, timer `R/PT6H`)
