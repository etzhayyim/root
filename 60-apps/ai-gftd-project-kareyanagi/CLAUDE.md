...
|---|---|---|---|
| kareyanagi-api | `ai-gftd-wasm-kareyanagi-mcr736od` | mcr736od | カビセンサーデータ収集 + リスク分析 + XRPC API |
| kareyanagi-ui | `ai-gftd-wasm-kareyanagi-ui-kpat4bp7` | kpat4bp7 | ダッシュボード UI + maps.etzhayyim.com 空間連携ビュー |
...
|---|---|---|
| `kareyanagi-state` | ai-gftd-wasm-kareyanagi-mcr736od | `default` |
| `kareyanagi-ui-state` | ai-gftd-wasm-kareyanagi-ui-kpat4bp7 | `default` |

## MCP Tools

### kareyanagi-api (mcr736od) — `/gftd.kareyanagi.v1.KareyangiService`
...
curl -X POST https://mcr736od.etzhayyim.com/xrpc/gftd.kareyanagi.v1.KareyangiService/ListSensors \
  -H "Content-Type: application/json" -d '{"offset":0,"limit":10}'
curl -X POST https://mcr736od.etzhayyim.com/xrpc/gftd.kareyanagi.v1.KareyangiService/ListDistributions \
  -H "Content-Type: application/json" -d '{"offset":0,"limit":10}'
```
