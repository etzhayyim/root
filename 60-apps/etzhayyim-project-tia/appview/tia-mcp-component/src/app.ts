// tia.etzhayyim.com — Threat Intelligence & Analytics Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: analyzeIntent / classifySignal / extractEntities / scoreRisk /
//            generateSummary / lookupProfile / submitFeedback / getInsights
...
const NSID_PREFIX = "com.etzhayyim.apps.tia.";
const ACTOR_DID = "did:web:tia.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "t1aag3nt",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-tia/bpmn",
        methods: [
          "analyzeIntent", "classifySignal", "extractEntities", "scoreRisk",
          "generateSummary", "lookupProfile", "submitFeedback", "getInsights",
        ],
      });
    }
