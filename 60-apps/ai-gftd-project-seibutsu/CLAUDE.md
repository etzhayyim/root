...
## Lexicons (`00-contracts/lexicons/ai/gftd/apps/seibutsu/`)
...
```bash
# preview
gftd actors migrate-to-plc --actor seibutsu --offline

# real (PDS signs genesis op with rotation key from D1, ADR-0010)
gftd actors migrate-to-plc --actor seibutsu --apply

# verify
gftd identifier-audit --deps deps.toml | grep seibutsu
```
