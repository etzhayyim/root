...
Per [ADR-2605203000](../../../90-docs/adr/2605203000-kotoba-write-target-options.md), hakkou migrates from vendor's `createKyselyDb` + BPMN ferment-pipeline.bpmn to **Option B** — PDS XRPC writes via `@etzhayyim/sdk e.write()`.
