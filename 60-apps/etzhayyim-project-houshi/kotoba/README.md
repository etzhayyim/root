...
Per [ADR-2605203000](../../../90-docs/adr/2605203000-kotoba-write-target-options.md), houshi migrates from vendor's `createKyselyDb` pattern (RW direct write via dispatcher proxy) to **Option B** — PDS XRPC writes via `@etzhayyim/sdk e.write()`.
...
import { storeSpore, listSpores, germinate } from "@etzhayyim/houshi-kotoba";
...
- [ki kotoba](../../etzhayyim-project-ki/kotoba/) — Option B reference (4/4 ✓)
