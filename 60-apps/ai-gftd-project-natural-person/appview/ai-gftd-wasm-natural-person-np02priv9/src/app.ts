// natural-person.gftd.ai thin edge facade. Natural person workflows run in AgentGateway MCP + pod-side LangServer.
...
const APP = "natural-person";
const NSID_PREFIX = "ai.gftd.apps.naturalPerson.";
