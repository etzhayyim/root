// natural-person.etzhayyim.com thin edge facade. Natural person workflows run in AgentGateway MCP + pod-side LangServer.
...
const NSID_PREFIX = "app.etzhayyim.apps.naturalPerson.";
