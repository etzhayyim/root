# ai-gftd-project-color-by-number
...
| Component | nanoid | 役割 |
|---|---|---|
| `ai-gftd-wasm-color-by-number-cbn8gf7x` | `cbn8gf7x` | Magatama ランタイム WASM — AT + Signal + SQL 統合 |
...
- `gftd.coloring.v1.ColoringCommandService` — PaintCell, CreateCanvas, InitSignalSession
- `gftd.coloring.v1.ColoringQueryService` — GetCanvas, ListCanvases, GetCanvasGraph
...
```bash
cd 60-apps/ai-gftd-project-color-by-number/wasm/ai-gftd-wasm-color-by-number-cbn8gf7x
gftd build        # TS Native → esbuild bundle
gftd deploy --smoke-url https://cbn8gf7x.etzhayyim.com/health
```
