...
**Target Endpoint:**
```
ai-gftd-performer-sys-gftd-actors-pba7d22f-svc-apqc-12-4-5-kyc-v2:8080
```
...
### 7. ai-gftd-project-amlctf (AML/CTF Integration)

**Plan:**
- Create new project: `60-apps/ai-gftd-project-amlctf/`
- Services:
...
5. Plan and create `ai-gftd-project-amlctf`
