...
- **APQC 12.4.5 KYC performer** — MCP integration target (`ai-gftd-performer-sys-gftd-actors-pba7d22f-svc-apqc-12-4-5-kyc-v2`)
...
```bash
cd 60-apps/ai-gftd-project-ekyc/legacy-runtime/ekyc-service-ephj2jf6/
...
```bash
cd 60-apps/ai-gftd-project-ekyc/wasm/ekyc-ui-hzaooy0f/svelte/
