"""Local smoke tests for lg-karma OSS server.

Run from `60-apps/etzhayyim-project-karma/lg/`:
...
touching `60-apps/etzhayyim-project-karma/lg/**`.
"""
...
_HEALTH_NSID = "com.etzhayyim.apps.karma.health"


def test_server_module_imports():
    from lg_karma.server import GRAPHS, _NSID_TO_ASSISTANT, app
...
def test_nsid_map_references_known_graphs():
    from lg_karma.server import GRAPHS, _NSID_TO_ASSISTANT
...
@pytest.fixture
def client():
    from lg_karma.server import app
...
def test_unknown_nsid_xrpc_404(client):
    r = client.post("/xrpc/com.etzhayyim.apps.karma.unknownMethod", json={})
    assert r.status_code == 404
