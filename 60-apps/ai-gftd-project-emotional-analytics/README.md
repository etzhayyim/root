# ai-gftd-project-emotional-analytics

`ai-gftd-project-emotional-analytics` provides standardized emotion signals for
conversation systems, including `ai-gftd-project-communicator`.
