# ai-gftd-project-obebe — Project Runbook
...
**Component**: `wasm/ai-gftd-wasm-obebe-sq42sjsd/`
**nanoid**: `sq42sjsd`
...
| App | Integration | 用途 |
|---|---|---|
| `anima.etzhayyim.com` | `gftd:anima/breed@1.0.0` | ペット種/品種情報 |
...
- **依存**: `magatama:contract/agreement@1.0.0`, `gftd:anima/breed@1.0.0`

## Build & Deploy

```bash
cd 60-apps/ai-gftd-project-obebe/wasm/ai-gftd-wasm-obebe-sq42sjsd
gftd deploy --no-svelte --smoke-url https://obebe.etzhayyim.com/health
```
