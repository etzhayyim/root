...
|-------|--------|---------|
| matrix-mcp | br8bojxp | ai-gftd-project-matrix |
| scheduler-mcp | 5dcfvsbd | ai-gftd-project-scheduler |
| scheduler-cron-mcp | 2w9k6q1m | ai-gftd-project-scheduler |
| projection-operator-mcp | po1x9k2m | ai-gftd-project-projection-operator |
| hub-mcp | qk6cjn0l | ai-gftd-project-hub |
| credits-mcp | z8l65qxz | ai-gftd-project-credits |
...
**Note**: Use `go vet ./...` to verify Go code compiles correctly if `gftd build` is unavailable locally.
