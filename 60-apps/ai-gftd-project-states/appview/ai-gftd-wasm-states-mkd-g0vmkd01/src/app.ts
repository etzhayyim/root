...
const ACTOR_DID = "did:web:mkd-state.gftd.ai";
const NSID_PREFIX = "ai.gftd.govMkd.";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/healthz" || url.pathname === "/readyz" || url.pathname === "/_app/meta") {
      return json({
        ...
        businessLogic: "20-actors/magatama/py/src/pymagatama/primitives/gov_mkd.py",
        bpmn: "etzhayyim-root/00-contracts/bpmn/ai/gftd/govMkd",
      });
    }
