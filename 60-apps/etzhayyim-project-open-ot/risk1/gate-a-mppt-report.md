...
**Cell**: `mppt_perturb_observe`

**Wasm artefact**: `../../cells/target/wasm32-unknown-unknown/release/mppt_perturb_observe.wasm`

**Iterations**: 10000

**Cycle period**: 1 ms

**Layout**: params=32 B  internal=24 B  data_in=12 B  data_out=24 B
