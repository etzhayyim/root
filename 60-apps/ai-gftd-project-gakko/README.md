...
```bash
kubectl apply -f 60-apps/ai-gftd-project-gakko/wasm/gakko-lms-mcp-component/<repo-deploy-config>
kubectl apply -f 60-apps/ai-gftd-project-gakko/wasm/gakko-lms-mcp-component/k8s/http-routes.yaml
```
