# ai-gftd-project-tia App migration

このディレクトリは `legacy-runtime` 実装を残したまま、App 版を段階移行するための配置先です。

## 対象 App services

- `ai-gftd-performer-sys-gftd-app-tia-seeker-r5k2m8a3`
...
- `https://tia.gftd.ai/api/mcp` (`tia-mcp-component`)
- `https://seeker.tia.gftd.ai/api/mcp` (`tia-seeker-component`)
