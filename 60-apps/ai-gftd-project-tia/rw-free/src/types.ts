/**
 * tia rw-free — Internet Account Protection (TIA) front, kotoba-E2E split.
 *
 ...
 *
 *   STAYS gftd (consumed via consent-capability, NOT a collection) — Gemini 2.5
 ...
 *   inference + enforcement execution stays gftd.
 *
