...
const SPEC_COLLECTION = "ai.gftd.gameka.spec";
const ARTIFACT_COLLECTION = "ai.gftd.gameka.buildArtifact";
const QA_COLLECTION = "ai.gftd.gameka.gameQa";
const TITLE_COLLECTION = "ai.gftd.gameka.gameTitle";
