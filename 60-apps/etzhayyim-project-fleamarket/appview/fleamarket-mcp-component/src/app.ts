// fleamarket.etzhayyim.com — C2C flea market platform — listings, bids, transactions, shipping
...
const NSID_PREFIX = "com.etzhayyim.apps.fleamarket.";
const ACTOR_DID = "did:web:fleamarket.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "fmdd4v30",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-fleamarket/bpmn",
        methods: [
          "createListing", "listListings", "getListing", "createBid",
          "listBids", "closeListing", "createTransaction", "listTransactions",
        ],
      });
    }
