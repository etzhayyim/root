// worlds.gftd.ai — Worlds Scene & Asset Management Platform
...
const NSID_PREFIX = "ai.gftd.apps.worlds.";
const ACTOR_DID = "did:web:worlds.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-worlds/bpmn",
        methods: [
