// oshiete.etzhayyim.com — Q&A Knowledge Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: submitQuestion / listQuestions / getQuestion / submitAnswer /
//            listAnswers / voteAnswer / listTopics / getExpert
...
const NSID_PREFIX = "com.etzhayyim.apps.oshiete.";
const ACTOR_DID = "did:web:oshiete.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "sg65kxvf",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-oshiete/bpmn",
        methods: [
          "submitQuestion", "listQuestions", "getQuestion", "submitAnswer",
          "listAnswers", "voteAnswer", "listTopics", "getExpert",
        ],
      });
    }
