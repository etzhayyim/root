# ai-gftd-project-hikyaku — Transport Agent (飛脚)
...
| Service | Path |
|---|---|
| HikyakuCommandService | `/xrpc/gftd.hikyaku.v1.HikyakuCommandService/*` |
| HikyakuQueryService | `/xrpc/gftd.hikyaku.v1.HikyakuQueryService/*` |
...
```bash
cd wasm/ai-gftd-wasm-hikyaku-hk7ky4ku/svelte
