...
この手順で `ai-gftd-project-ohanashi` の Amazon Connect 通話を AI 会話に接続する。
...
60-apps/ai-gftd-project-ohanashi/70-tools/70-tools/70-tools/scripts/260225-deploy-connect-lex-ai.sh
```
