...
LAMBDA_ROLE_ARN="${LAMBDA_ROLE_ARN:-arn:aws:iam::808985145984:role/ai-gftd-lambda-exec}"
...
cp projects/ai-gftd-project-ohanashi/aws/connect/lex-lambda/lambda_function.py "$WORKDIR/"
(
  cd "$WORKDIR"
