...
NSID: ai.gftd.apps.media_gamers.autopilot
...
_REPO_DID = os.environ.get("MEDIA_GAMERS_REPO_DID", "did:web:a7m8oocs.gftd.ai")
...
SEED_GAMES = [
    ...
    {"slug": "pokoa-world", "name": "Pokoa World", "genre": "creature-rpg", "releaseYear": 2026, "developer": "gftd-studio", "publisher": "gftd", "platforms": ["PC", "Mobile"]},
...
async def _node_post(state: _State) -> dict[str, Any]:
    ...
    guide_url = f"https://media-gamers.gftd.ai/en/game/{slug}/{guide_type}"
