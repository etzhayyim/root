...
Run from `60-apps/ai-gftd-project-media-gamers/lg/`:
...
touching `60-apps/ai-gftd-project-media-gamers/lg/**`.
"""
...
def test_unknown_nsid_xrpc_404(client):
    r = client.post("/xrpc/ai.gftd.apps.media_gamers.unknownMethod", json={})
