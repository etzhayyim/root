...
(\texttt{gftd-static-sites} bucket, \texttt{jp-osa-1} region) and
...
The host-side inference pipeline integrates with the GFTD OS Tauri
desktop application (\texttt{projects/ai-gftd-project-os/}). The
