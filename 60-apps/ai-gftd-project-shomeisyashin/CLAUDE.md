...
|---|---|---|
| shomeisyashin-api | `wasm/ai-gftd-wasm-shomeisyashin-f901c7i4/` | XRPC API + SSR |
...
```bash
cd 60-apps/ai-gftd-project-shomeisyashin/wasm/ai-gftd-wasm-shomeisyashin-f901c7i4/svelte
