/**
 * shinkansen (新幹線) rw-free — public rail reference: lines + timetables +
 ...
 *
 *   REGULATED (STAYS gftd, NOT in this package) — `reserveSeat` +
 ...
 *   Remain a gftd regulated function consumed via consent-capability.
 *
