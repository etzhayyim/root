// narou.etzhayyim.com — Web Novel Publishing Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 11 methods: createNovel / createChapter / generateChapter / publishChapter /
//             createCharacter / createWorldSetting / getNovel / listNovels /
//             getChapter / listChapters / searchNovels
...
const ACTOR_DID = "did:web:narou.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "nr0uxk2p",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-narou/bpmn",
        methods: [
          "createNovel", "createChapter", "generateChapter", "publishChapter",
          "createCharacter", "createWorldSetting",
          "getNovel", "listNovels", "getChapter", "listChapters", "searchNovels",
        ],
      });
    }
