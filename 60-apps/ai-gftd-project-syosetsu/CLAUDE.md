...
| Component | nanoid | 役割 |
|---|---|---|
| `ai-gftd-wasm-syosetsu-sy3w9p4m` | `sy3w9p4m` | Main control plane + リーダー UI |
...
|---|---|---|
| `ai.gftd.apps.syosetsu.series` | `series` | `:Series` |
| `ai.gftd.apps.syosetsu.episode` | `episode` | `:Episode` |
| `ai.gftd.apps.syosetsu.bookmark` | `bookmark` | `:Bookmark` |
| `ai.gftd.apps.syosetsu.review` | `review` | `:Review` |
| `ai.gftd.apps.syosetsu.tag` | `tag` | `:Tag` |
...
- `gftd:syosetsu/reader@1.0.0` — publish-chapter, bookmark, review
- `gftd:syosetsu/catalog@1.0.0` — get/list/search series+episodes
...
curl -X POST https://sy3w9p4m.etzhayyim.com/xrpc/gftd.syosetsu.v1.SyosetsuQueryService/ListNovels \
