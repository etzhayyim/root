...
- `games/<slug>/gftd-discovery.yaml`
...
metadata:
  ...
  namespace: ai-gftd-performers
data:
  framework: godot-web
  slug: <slug>
  entry: /play/<slug>/
  mcp: gftd:platform/gftd-mcp@0.1.0
```
...
4. `games/<slug>/gftd-discovery.yaml` を追加
5. `WADM_MANIFEST=60-apps/ai-gftd-project-umu/wasm/umu-godot-hub/wadm/umu-godot-hub.wadm.yaml mage Deploy`
