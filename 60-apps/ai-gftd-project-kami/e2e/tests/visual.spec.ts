...
const YORO = process.env.YORO_BASE_URL ?? 'https://yoro.gftd.ai';

test.describe('Visual Tests', () => {
  test('kami.gftd.ai landing page screenshot', async ({ page }) => {
  ...
  test('yoro apps/snake page screenshot', async ({ page }) => {
    await page.goto(`${YORO}/apps/did:web:kami.gftd.ai:island:snake`, { waitUntil: 'domcontentloaded' });
  ...
  test('yoro apps/colorbynumber page screenshot', async ({ page }) => {
    await page.goto(`${YORO}/apps/did:web:kami.gftd.ai:island:colorbynumber`, { waitUntil: 'domcontentloaded' });
    await page.waitForTimeout(3000);
  ...
  test('yoro profile/snake DID screenshot', async ({ page }) => {
    await page.goto(`${YORO}/profile/did:web:kami.gftd.ai:island:snake`, { waitUntil: 'domcontentloaded' });
    await page.waitForTimeout(3000);
  ...
  test('yoro profile/colorbynumber DID screenshot', async ({ page }) => {
    await page.goto(`${YORO}/profile/did:web:kami.gftd.ai:island:colorbynumber`, { waitUntil: 'domcontentloaded' });
    await page.waitForTimeout(3000);
