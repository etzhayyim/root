...
Browser / CLI / yoro code-editor
  ...
  → this Worker (ai-gftd-wasm-repository-r3p0s1t0)
     ...
     │                                             ↓ sdk.pds.dispatch({type: "ai.gftd.repository.refUpdate"})
     │                                             → firehose broadcast
...
|---|---|---|
| repository-api | `appview/ai-gftd-wasm-repository-r3p0s1t0/` | XRPC API + static SPA (minimal UI shell; authoring surface is yoro/code-editor) |
