...
pipethrough forwards to (``calendar.etzhayyim.com/xrpc/... → lg-calendar:8000/xrpc/...``):
...
@app.post("/xrpc/ai.etzhayyim.apps.calendar.createEvent")
...
@app.post("/xrpc/ai.etzhayyim.apps.calendar.updateEvent")
...
@app.post("/xrpc/ai.etzhayyim.apps.calendar.deleteEvent")
...
@app.post("/xrpc/ai.etzhayyim.apps.calendar.rsvp")
...
@app.get("/xrpc/ai.etzhayyim.apps.calendar.getEvent")
...
@app.get("/xrpc/ai.etzhayyim.apps.calendar.listEvents")
...
@app.get("/xrpc/ai.etzhayyim.apps.calendar.listCalendars")
