# ai-gftd-project-communicator

`ai-gftd-project-communicator` is a communication control plane that orchestrates
...
It integrates with:
- `ai-gftd-project-mailer` for message/thread abstractions and mailbox context
- `ai-gftd-project-external-service-adapter` for provider-native execution
- `ai-gftd-project-emotional-analytics` for emotion-aware strategy adaptation
...
2. Agent fetches recent thread from `ai-gftd-project-mailer`
3. Agent requests emotional signals from `ai-gftd-project-emotional-analytics`
...
### With ai-gftd-project-external-service-adapter
...
### With ai-gftd-project-emotional-analytics
