# ai-gftd-project-social-contract
...
`ai.gftd.apps.social_contract.*`: contract_type, cohort, cohort_stat, contract_instance, party, obligation, lifecycle_event, legal_entity, officer, subsidiary_rel
...
|---|---|
| nanoid | `sc01cntr7` |
| wasm dir | `wasm/ai-gftd-wasm-social-contract-sc01cntr7/` |
