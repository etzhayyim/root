...
forwards to (``drive.gftd.ai/xrpc/... → lg-drive:8000/xrpc/...``):

  GET  /health /ok
  POST /xrpc/ai.gftd.apps.drive.filesCreate
  GET  /xrpc/ai.gftd.apps.drive.filesGet
  GET  /xrpc/ai.gftd.apps.drive.filesList
  POST /xrpc/ai.gftd.apps.drive.filesUpdate
  POST /xrpc/ai.gftd.apps.drive.filesDelete
  GET  /xrpc/ai.gftd.apps.drive.about
  GET  /xrpc/ai.gftd.apps.drive.changes
...
@app.post("/xrpc/ai.gftd.apps.drive.filesCreate")
...
@app.post("/xrpc/ai.gftd.apps.drive.filesUpdate")
...
@app.post("/xrpc/ai.gftd.apps.drive.filesDelete")
...
@app.get("/xrpc/ai.gftd.apps.drive.filesGet")
...
@app.get("/xrpc/ai.gftd.apps.drive.filesList")
...
@app.get("/xrpc/ai.gftd.apps.drive.about")
...
@app.get("/xrpc/ai.gftd.apps.drive.changes")
