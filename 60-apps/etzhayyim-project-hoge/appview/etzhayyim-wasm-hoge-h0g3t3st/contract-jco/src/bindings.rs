    ...
    pub mod etzhayyim {
        pub mod hoge_compute {
            ...
            pub mod compute {
                ...
                pub unsafe fn _export_shannon_score_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    ...
                    let result1 = T::shannon_score(_rt::string_lift(bytes0));
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_shannon_score<T: Guest>(arg0: *mut u8) {
                ...
                pub trait Guest {
                    /// Compute Shannon entropy of input text.
                    /// params: raw text string
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_compute_world_impl {
    ($ty:ident) => {
