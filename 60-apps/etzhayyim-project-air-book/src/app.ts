// air-book.etzhayyim.com — airline reservations and ticketing layer
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: createPnr / confirmBooking / issueTicket / assignSeat / addAncillary / cancelBooking / reprotectPassenger / settleBsp
...
const NSID_PREFIX = "com.etzhayyim.apps.airBook.";
const ACTOR_DID = "did:web:air-book.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "a1rb00k1",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/air-book",
        methods: ["createPnr", "confirmBooking", "issueTicket", "assignSeat", "addAncillary", "cancelBooking", "reprotectPassenger", "settleBsp"],
      });
    }
