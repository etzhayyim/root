// resources.gftd.ai — Resource Management Platform
...
const NSID_PREFIX = "ai.gftd.apps.resources.";
const ACTOR_DID = "did:web:resources.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-resources/bpmn",
        methods: [
