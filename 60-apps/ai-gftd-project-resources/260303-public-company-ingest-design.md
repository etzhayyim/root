...
Date: 2026-03-03
Scope: `ai-gftd-project-resources` first increment for one public company (`vale-sa`).
...
- Signal entities (generated):
  ...
  - Each entity is a normalized `NewsArticle` with `additionalType=gftd:PublicCompanySignal`.
