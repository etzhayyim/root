# ai-gftd-project-resource-planner
...
### resource-planner-component (`ai-gftd-wasm-resource-planner-rp7n3st2`)
...
ai-gftd-project-resources の resourceModel に準拠:
...
```go
performer.NewAdapter("/gftd.resourceplanner.v1.ResourcePlannerService")
...
`proto/gftd/resourceplanner/v1/resourceplanner.proto`
- WIT が正 (source of truth)。Proto は XRPC client 生成用。
- `buf generate` → Connect-ES TypeScript client (Svelte UI 用)

## WIT Interface

- Source: `60-apps/ai-gftd-project-resource-planner/wit/resource-planner/package.wit`
- Package: `gftd:resource-planner@0.1.0`
- Interface: `planner` (ingest/inventory/planning/events)
- Worlds: `gftd-resource-planner-provider` / `gftd-resource-planner-consumer`
