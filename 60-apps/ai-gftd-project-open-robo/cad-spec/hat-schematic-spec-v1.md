...
4. tsukuru.etzhayyim.com `app.etzhayyim.apps.tsukuru.pcbProject.create` でプロジェクト登録
5. `app.etzhayyim.apps.tsukuru.pban.requestQuote` → 見積り取得 → 発注承認 (48h human_review)
