/**
 * tsukuru rw-free — supplierExchange (slice 6).
 *
 ...
 * heavy-lift work lives in pod-side LangServer. This rw-free
...
export function normalizePackage(
  ...
  return {
    status: "ok",
    schema: "app.etzhayyim.apps.tsukuru.supplierExchange.v1",
