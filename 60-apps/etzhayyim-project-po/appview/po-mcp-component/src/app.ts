// po.etzhayyim.com — Purchase Order & Supply Chain Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: createPo / listPos / getPo / approvePo /
//            listSuppliers / createSupplier / recordReceipt / listReceipts
...
const NSID_PREFIX = "com.etzhayyim.apps.po.";
const ACTOR_DID = "did:web:po.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "c11ertj5",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-po/bpmn",
        methods: [
          "createPo", "listPos", "getPo", "approvePo",
          "listSuppliers", "createSupplier", "recordReceipt", "listReceipts",
        ],
      });
    }
