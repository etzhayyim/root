// 6ir.etzhayyim.com — 6-figure IR (investor relations) intelligence
...
const NSID_PREFIX = "com.etzhayyim.apps.sixir.";
const ACTOR_DID = "did:web:6ir.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "xaji0y6d",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-6ir/bpmn",
        methods: [
          "listCompanies", "getCompany", "listFilings", "getFiling",
          "listEarnings", "submitAnalysis", "listAlerts", "searchCompanies",
        ],
      });
    }
