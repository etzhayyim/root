...
**Wasm artefact**: `../../cells/target/wasm32-unknown-unknown/release/vv_curve.wasm`

**Iterations**: 10000

**Cycle period**: 1 ms

**Layout**: params=20 B  internal=8 B  data_in=12 B  data_out=12 B
...
- Memory pages: initial=17 final=32 delta=0 (1 page = 64 KB)
