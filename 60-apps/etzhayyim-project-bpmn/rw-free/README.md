...
Per [ADR-2605203000](../../../90-docs/adr/2605203000-rw-free-write-target-options.md), bpmn migrates from vendor's `createKyselyDb` pattern (RW direct write) to **Option B** — PDS XRPC writes via `@etzhayyim/sdk e.write()`.
...
All 13 canonical bpmn lexicons now have rw-free reference impl. Wire-up to a Worker / LangServer pod XRPC handler is the next operator task per ADR-2605203000.
...
- [anime rw-free](../../etzhayyim-project-anime/rw-free/) — sibling Option B reference (10/10 ✓)
- [kiyo rw-free](../../etzhayyim-project-kiyo/rw-free/) — Option B reference (12/12 ✓)
- [sbom rw-free](../../etzhayyim-project-sbom/rw-free/) — Option B reference (17/N)
