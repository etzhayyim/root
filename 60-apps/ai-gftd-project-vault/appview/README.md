# ai-gftd-project-vault App migration

このディレクトリは `legacy-runtime` 実装を残したまま、App 版を段階移行するための配置先です。

## 対象 App services

- `ai-gftd-performer-sys-gftd-app-vault-chrome-extension-awh4ueht` -> `vault-extension-mcp-component`
- `ai-gftd-performer-sys-gftd-app-vault-t33wiylr` -> `vault-mcp-component`
