...
Per [ADR-2605203000](../../../90-docs/adr/2605203000-rw-free-write-target-options.md), manga migrates from vendor's `createKyselyDb` pattern (RW direct write) to **Option B** — PDS XRPC writes via `@etzhayyim/sdk e.write()`.
...
All 12 canonical manga lexicons now have rw-free reference impl. Wire-up
...
|---|---|---|
| ai.gftd.manga.title | Title | title-{titleId-slug} |
| ai.gftd.manga.chapter | Chapter | chapter-{chapterId-slug} |
| ai.gftd.manga.reading | Reader | reading-{progressId-slug} |
