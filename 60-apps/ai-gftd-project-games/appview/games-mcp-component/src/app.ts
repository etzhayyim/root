// games.gftd.ai — Game platform — titles, scores, achievements, leaderboards, sessions
...
const ACTOR_DID = "did:web:games.gftd.ai";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ...
        bpmn: "60-apps/ai-gftd-project-games/bpmn",
        methods: [
