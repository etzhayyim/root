/**
 * sanctions rw-free — public consolidated sanctions-LIST reference record types.
 *
 ...
 *
 *   SCREENING (STAYS gftd, NOT in this package) — `screenEntity` + the
 ...
 *   compliance liability (Liability axis), so it remains a gftd regulated
