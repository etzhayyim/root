...
app = Starlette(routes=[
    ...
    Route("/xrpc/gftd.murakumo.v1.MurakumoQueryService/GetClusterStatus", xrpc_cluster_status, methods=["POST"]),
    Route("/xrpc/gftd.murakumo.v1.MurakumoQueryService/ListWorkers", xrpc_list_workers, methods=["POST"]),
])
