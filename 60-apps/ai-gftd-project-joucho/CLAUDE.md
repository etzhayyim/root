> **DEPRECATED**: Actor migrated to `20-actors/joucho/actor-manifest.jsonld` (T1 MCP-Compose). This project wasm/*/src/app.ts is retained as T3 fallback only.
...
`ai.gftd.joucho.{review,score,meal_score,restaurant_score,spot_score,product_score,building_score,score_history}`
