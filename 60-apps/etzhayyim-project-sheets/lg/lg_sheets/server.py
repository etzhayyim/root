...
@app.post("/xrpc/ai.etzhayyim.apps.sheets.spreadsheetsCreate")
...
@app.post("/xrpc/ai.etzhayyim.apps.sheets.valuesUpdate")
...
@app.post("/xrpc/ai.etzhayyim.apps.sheets.valuesBatchUpdate")
...
@app.get("/xrpc/ai.etzhayyim.apps.sheets.spreadsheetsGet")
...
@app.get("/xrpc/ai.etzhayyim.apps.sheets.valuesGet")
