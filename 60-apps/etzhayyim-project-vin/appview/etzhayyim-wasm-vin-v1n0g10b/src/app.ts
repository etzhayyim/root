// VIN / Vehicle Registration thin edge. Business logic runs in AgentGateway MCP + pod-side LangServer.
...
const NSID_PREFIX = "com.etzhayyim.apps.vin.";
...
export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: "did:web:vin.etzhayyim.com",
        nanoid: env.APP_NANOID ?? "v1n0g10b",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        businessLogic: "40-engine/kotoba/crates/kotoba-kotodama/py/src/kotodama/ingest/vin.py",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/vin",
      });
    }
    ...
    return json({ error: "NotFound", message: "vin not found" }, 404);
  },
