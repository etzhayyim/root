...
| Component | Folder | 役割 |
|---|---|---|
| `ai-gftd-wasm-pb-edu-mgr-{nanoid}` | `wasm/` | Education Fund Manager (学) |
| `ai-gftd-wasm-pb-ece-{nanoid}` | `wasm/` | Early Childhood Specialist (芽) |
| `ai-gftd-wasm-pb-fam-mgr-{nanoid}` | `wasm/` | Family Welfare Manager (結) |
| `ai-gftd-wasm-pb-sw-{nanoid}` | `wasm/` | Social Worker (心) |
