/* @ts-self-types="./kami_map.d.ts" */

export class KamiMap {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KamiMap.prototype);
        obj.__wbg_ptr = ptr;
        KamiMapFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KamiMapFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kamimap_free(ptr, 0);
    }
    /**
     ...
     * @param {number} radius
     */
    add_circle_layer(id, points_json, color_hex, radius) {
        ...
        const ret = wasm.kamimap_add_circle_layer(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, radius);
        if (ret[1]) {
     ...
     * @param {string} id
     * @param {string} rings_json
     * @param {string} heights_json
     * @param {string} color_hex
     * @param {number} opacity
     */
    add_extrude_layer(id, rings_json, heights_json, color_hex, opacity) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(rings_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(heights_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(color_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.kamimap_add_extrude_layer(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, opacity);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} opacity
     */
    add_fill_layer(id, rings_json, color_hex, opacity) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(rings_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(color_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.kamimap_add_fill_layer(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, opacity);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} width
     */
    add_line_layer(id, lines_json, color_hex, width) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ptr2 = passStringToWasm0(color_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.kamimap_add_line_layer(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, width);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {Uint8Array} pbf
     * @returns {string}
     */
    decode_mvt_layer(z, x, y, layer_name, pbf) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(layer_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(pbf, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.kamimap_decode_mvt_layer(this.__wbg_ptr, z, x, y, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
     ...
     * @returns {string}
     */
    decode_mvt_layer_features(z, x, y, layer_name, pbf) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(layer_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const ptr1 = passArray8ToWasm0(pbf, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.kamimap_decode_mvt_layer_features(this.__wbg_ptr, z, x, y, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    fit_bounds(min_lng, min_lat, max_lng, max_lat, padding_px) {
        wasm.kamimap_fit_bounds(this.__wbg_ptr, min_lng, min_lat, max_lng, max_lat, padding_px);
    }
    /**
     * @param {number} lng
     * @param {number} lat
     ...
     */
    fly_to(lng, lat, zoom, duration_ms) {
        wasm.kamimap_fly_to(this.__wbg_ptr, lng, lat, zoom, duration_ms);
    }
    /**
     ...
     */
    frame(dt_ms) {
        wasm.kamimap_frame(this.__wbg_ptr, dt_ms);
    }
    /**
     * @param {number} z
     * @param {number} x
     ...
     * @returns {string}
     */
    get_dem_tile_url(z, x, y) {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.kamimap_get_dem_tile_url(this.__wbg_ptr, z, x, y);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_viewport() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.kamimap_get_viewport(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get_zoom() {
        const ret = wasm.kamimap_get_zoom(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    has_layer(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.kamimap_has_layer(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    invalidate_layers() {
        wasm.kamimap_invalidate_layers(this.__wbg_ptr);
    }
    /**
    ...
    list_layers() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.kamimap_list_layers(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {number} button
     */
    on_pointer_down(x, y, button) {
        wasm.kamimap_on_pointer_down(this.__wbg_ptr, x, y, button);
    }
    /**
     * @param {number} _x
     * @param {number} _y
     ...
     * @param {number} dy
     */
    on_pointer_move(_x, _y, dx, dy) {
        wasm.kamimap_on_pointer_move(this.__wbg_ptr, _x, _y, dx, dy);
    }
    /**
     * @param {number} _x
     * @param {number} _y
     */
    on_pointer_up(_x, _y) {
        wasm.kamimap_on_pointer_up(this.__wbg_ptr, _x, _y);
    }
    /**
     * @param {number} delta
     */
    on_wheel(delta) {
        wasm.kamimap_on_wheel(this.__wbg_ptr, delta);
    }
    /**
    ...
    project(lng, lat) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.kamimap_project(this.__wbg_ptr, lng, lat);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    remove_layer(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.kamimap_remove_layer(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} width
     * @param {number} height
     */
    resize(width, height) {
        wasm.kamimap_resize(this.__wbg_ptr, width, height);
    }
    /**
     * @param {number} degrees
     */
    set_bearing(degrees) {
        wasm.kamimap_set_bearing(this.__wbg_ptr, degrees);
    }
    /**
     * @param {number} lng
     * @param {number} lat
     */
    set_center(lng, lat) {
        wasm.kamimap_set_center(this.__wbg_ptr, lng, lat);
    }
    /**
    ...
    set_layer_visibility(id, visible) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.kamimap_set_layer_visibility(this.__wbg_ptr, ptr0, len0, visible);
    }
    /**
     ...
     */
    set_layer_zoom_range(id, min_zoom, max_zoom) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.kamimap_set_layer_zoom_range(this.__wbg_ptr, ptr0, len0, min_zoom, max_zoom);
    }
    /**
     * @param {number} degrees
     */
    set_pitch(degrees) {
        wasm.kamimap_set_pitch(this.__wbg_ptr, degrees);
    }
    /**
     ...
     * @param {number} width
     */
    set_route(coords_json, color_hex, width) {
        const ptr0 = passStringToWasm0(coords_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(color_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.kamimap_set_route(this.__wbg_ptr, ptr0, len0, ptr1, len1, width);
    }
    /**
     * @param {number} zoom
     */
    set_zoom(zoom) {
        wasm.kamimap_set_zoom(this.__wbg_ptr, zoom);
    }
    /**
    ...
    tiles_to_fetch() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.kamimap_tiles_to_fetch(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    unproject(screen_x, screen_y) {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.kamimap_unproject(this.__wbg_ptr, screen_x, screen_y);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {number} x
     * @param {number} y
     * @param {Float32Array} heights_m
     * @param {number} width
     * @param {number} height
     */
    upload_dem_tile(z, x, y, heights_m, width, height) {
        const ptr0 = passArrayF32ToWasm0(heights_m, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.kamimap_upload_dem_tile(this.__wbg_ptr, z, x, y, ptr0, len0, width, height);
    }
    /**
     ...
     */
    upload_tile(z, x, y, rgba_data, img_width, img_height) {
        const ptr0 = passArray8ToWasm0(rgba_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.kamimap_upload_tile(this.__wbg_ptr, z, x, y, ptr0, len0, img_width, img_height);
    }
}
if (Symbol.dispose) KamiMap.prototype[Symbol.dispose] = KamiMap.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_kamimap_new: function(arg0) {
            const ret = KamiMap.__wrap(arg0);
            return ret;
        },
...
const KamiMapFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kamimap_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kami_map_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
