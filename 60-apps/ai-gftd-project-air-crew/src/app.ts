// air-crew.etzhayyim.com — airline crew management and scheduling layer
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: publishRoster / buildPairing / trackQualification / assessFatigue / assignCrew / bookCrewTravel / recordDutyTime / notifyCrew
...
const NSID_PREFIX = "com.etzhayyim.apps.airCrew.";
const ACTOR_DID = "did:web:air-crew.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "a1rcr3w0",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "etzhayyim-root/00-contracts/bpmn/com/etzhayyim/air-crew",
        methods: ["publishRoster", "buildPairing", "trackQualification", "assessFatigue", "assignCrew", "bookCrewTravel", "recordDutyTime", "notifyCrew"],
      });
    }
