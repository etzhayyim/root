...
describe("voxelforge rw-free (kotoba-E2E split)", () => {
  let e: any;
  beforeEach(() => {
  ...
  describe("artifact (PLAINTEXT content-addressed catalog)", () => {
    it("registers under an existing run (FK), dedups, validates, lists/filters", async () => {
      ...
      const ok = await registerArtifact(e, { artifactId: "a1", designId: "d1", runId: "r1", format: "glb", b2Bucket: "ai-gftd-nats", b2Key: "voxelforge/v1/d1/model.glb", sha256Hex: "abc", byteSize: 2048, polygonCount: 1200, generatedBy: "trellis" });
      ...
      await registerArtifact(e, { artifactId: "a2", designId: "d1", runId: "r1", format: "vox", b2Bucket: "ai-gftd-nats", b2Key: "voxelforge/v1/d1/model.vox", sha256Hex: "def", byteSize: 4096, voxelDim: 64, generatedBy: "cadquery" });
