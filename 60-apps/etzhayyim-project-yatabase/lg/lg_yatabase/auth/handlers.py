...
NSIDs:
    ...
    com.etzhayyim.apps.yata.invite    (member key under caller org)
    com.etzhayyim.apps.yata.revoke    (revoke a key the caller owns)
...
@router.post("/xrpc/com.etzhayyim.apps.yata.signup")
...
@router.post("/xrpc/com.etzhayyim.apps.yata.invite")
...
@router.post("/xrpc/com.etzhayyim.apps.yata.authResolveApiKey")
...
@router.post("/xrpc/com.etzhayyim.apps.yata.revoke")
