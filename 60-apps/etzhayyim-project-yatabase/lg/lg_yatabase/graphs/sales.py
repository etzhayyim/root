...
with e.read/e.write per ADR-2605172000. Billing events: 'com.etzhayyim.apps.yata.billing.events',
rkey=timestamp_event_id. Audit log: 'com.etzhayyim.apps.yata.audit.log', rkey=timestamp_request_id.
"""
