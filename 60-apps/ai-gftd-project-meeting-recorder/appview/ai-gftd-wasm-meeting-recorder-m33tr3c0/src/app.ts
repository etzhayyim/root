...
function extractDidKey(doc: DidDocument): string {
  // Prefer multibase (atproto native, did:plc / did:gftd / modern did:web).
 ...
 * Handles did:web / did:plc / did:gftd via resolveDid + @atproto/crypto's
 ...
 * Secret comes from RECORDER_TUNNEL_SECRET (shared via gftd Vault with the
 * Vultr container).
 */
