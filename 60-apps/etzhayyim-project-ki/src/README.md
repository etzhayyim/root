...
Vendor `60-apps/etzhayyim-project-ki/src/app.ts` is the production source that uses `createKyselyDb()` (RW direct write, forbidden on etzhayyim per [ADR-2605172000](../../../../90-docs/adr/2605172000-etzhayyim-kotoba-substrate.md)).

Per [ADR-2605203000](../../../../90-docs/adr/2605203000-kotoba-write-target-options.md) Phase E, **Option B** (PDS XRPC) was picked for ki. Rewrite follows the pattern established by:
...
- Lexicons: 5 files migrated to `00-contracts/lexicons/com/etzhayyim/ki/`
