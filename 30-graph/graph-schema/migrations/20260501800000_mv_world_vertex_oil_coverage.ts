...
/**
 * Add oil-coverage vertex tables to mv_world_vertex_per_host.
 *
 * 9 tables added under the 'oil-coverage' app_host:
 *   vertex_oil_company, vertex_oil_field, vertex_oil_basin,
 *   vertex_oil_pipeline, vertex_oil_terminal, vertex_crude_grade,
 *   vertex_pricing_benchmark, vertex_oil_trade, vertex_oil_cargo
 *
 * Note: vertex_oil_refinery does not exist; refinery records are stored
 * in vertex_oil_company with company_type='refinery'.
 */
