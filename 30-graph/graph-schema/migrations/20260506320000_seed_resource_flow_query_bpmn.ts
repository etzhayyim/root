...
const createdAt = "2026-05-06T23:00:00Z";
const ownerDid = "did:web:resource-flow.etzhayyim.com";
const actorTag = "sys.bpmn.seed.resource-flow-query";
const project = "resource-flow";

const seeds: Seed[] = [
  { proc: "getSankey", bpmnProcessId: "resource_flow_get_sankey", nsid: "com.etzhayyim.apps.resourceFlow.getSankey", resultTimeoutMs: 30000 },
  { proc: "getActorLabels", bpmnProcessId: "resource_flow_get_actor_labels", nsid: "com.etzhayyim.apps.resourceFlow.getActorLabels", resultTimeoutMs: 30000 },
  { proc: "listFlows", bpmnProcessId: "resource_flow_list_flows", nsid: "com.etzhayyim.apps.resourceFlow.listFlows", resultTimeoutMs: 30000 },
  { proc: "listAnomalies", bpmnProcessId: "resource_flow_list_anomalies", nsid: "com.etzhayyim.apps.resourceFlow.listAnomalies", resultTimeoutMs: 30000 },
];
