...
/**
 * isbn.etzhayyim.com BPMN v2 — pure autonomous timer-start, no CF Worker.
 *
 ...
 * required a CF Worker (atproto.etzhayyim.com) entry point.
 *
 * v2 redesign:
...
const refreshDailyVertexId =
  "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/isbn-refresh-daily-v1";
...
const v2ProcessSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/isbn-ingest-open-library-v2",
    bpmnProcessId: "isbn_ingest_open_library",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/isbn/ingestOpenLibrary.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/isbn-ingest-aozora-v2",
    bpmnProcessId: "isbn_ingest_aozora",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/isbn/ingestAozora.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/isbn-ingest-gutenberg-v2",
    bpmnProcessId: "isbn_ingest_gutenberg",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/isbn/ingestGutenberg.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/isbn-ingest-ndl-v2",
    bpmnProcessId: "isbn_ingest_ndl",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/isbn/ingestNdl.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/isbn-ingest-hathitrust-v2",
