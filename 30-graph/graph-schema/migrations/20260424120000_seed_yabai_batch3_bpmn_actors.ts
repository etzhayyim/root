 ...
 * XRPC endpoints (`POST dispatcher.etzhayyim.com:8080/xrpc/com.etzhayyim.apps.yabai.*`)
...
function readBpmn(fileName: string): string {
  return readFileSync(
    path.resolve(repoRoot, "00-contracts/bpmn/com/etzhayyim/yabai", fileName),
    "utf8",
  );
}
...
const pivots: Array<{
  ...
  { slug: "yabai-crtsh-fuzzy-search-v1",    bpmnProcessId: "yabai_crtsh_fuzzy_search",    file: "crtshFuzzySearch.bpmn",    nsid: "com.etzhayyim.apps.yabai.crtshFuzzySearch",    bindingSlug: "yabai-crtshFuzzySearch-v1",    resultTimeoutMs: 20000 },
  { slug: "yabai-reverse-ip-lookup-v1",     bpmnProcessId: "yabai_reverse_ip_lookup",     file: "reverseIpLookup.bpmn",     nsid: "com.etzhayyim.apps.yabai.reverseIpLookup",     bindingSlug: "yabai-reverseIpLookup-v1",     resultTimeoutMs: 20000 },
  { slug: "yabai-enrich-legal-entity-v1",   bpmnProcessId: "yabai_enrich_legal_entity",   file: "enrichLegalEntity.bpmn",   nsid: "com.etzhayyim.apps.yabai.enrichLegalEntity",   bindingSlug: "yabai-enrichLegalEntity-v1",   resultTimeoutMs: 30000 },
];

const processSeeds: ProcessSeed[] = pivots.map((p) => ({
  vertexId: `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/${p.slug}`,
  bpmnProcessId: p.bpmnProcessId,
  sourcePath: `00-contracts/bpmn/com/etzhayyim/yabai/${p.file}`,
}));

const bindingSeeds: BindingSeed[] = pivots.map((p) => ({
  vertexId: `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/${p.bindingSlug}`,
  nsid: p.nsid,
  bpmnProcessId: p.bpmnProcessId,
