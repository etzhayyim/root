...
const seeds: Seed[] = [
  { proc: "onboardSubscriber", bpmnProcessId: "telecom_onboard_subscriber",
    nsid: "ai.gftd.apps.telecom.onboardSubscriber", resultTimeoutMs: 30000 },
  { proc: "activateSim", bpmnProcessId: "telecom_activate_sim",
    nsid: "ai.gftd.apps.telecom.activateSim", resultTimeoutMs: 30000 },
  { proc: "provisionService", bpmnProcessId: "telecom_provision_service",
    nsid: "ai.gftd.apps.telecom.provisionService", resultTimeoutMs: 30000 },
  { proc: "recordUsage", bpmnProcessId: "telecom_record_usage",
    nsid: "ai.gftd.apps.telecom.recordUsage", resultTimeoutMs: 15000 },
  { proc: "runBillingCycle", bpmnProcessId: "telecom_run_billing_cycle",
    nsid: "ai.gftd.apps.telecom.runBillingCycle", resultTimeoutMs: 60000 },
  { proc: "escalateSlaBreach", bpmnProcessId: "telecom_escalate_sla_breach",
    nsid: "ai.gftd.apps.telecom.escalateSlaBreach", resultTimeoutMs: 30000 },
];
