...
// yadoya Phase 8b — register the rest of the reservation lifecycle as
// BPMN actors (ADR-0056). Phase 5 already shipped createReservation;
// this migration adds cancelReservation + getReservation so Zeebe Operate
// has full lifecycle visibility and so external callers can drive the
// flow either via XRPC (yadoya Worker) or via direct Zeebe message.
...
const actorTag = "sys.bpmn.seed.yadoya-lifecycle";
...
const seeds: Seed[] = [
  {
    ...
    nsid: "com.etzhayyim.apps.yadoya.cancelReservation",
    resultTimeoutMs: 30000,
  },
  {
    proc: "getReservation",
    bpmnProcessId: "yadoya_get_reservation",
    nsid: "com.etzhayyim.apps.yadoya.getReservation",
