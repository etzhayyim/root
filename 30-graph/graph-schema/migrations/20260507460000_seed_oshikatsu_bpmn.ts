...
const ownerDid = "did:web:oshikatsu.gftd.ai";
...
const processVid = (s: Seed) => `at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/oshikatsu-${slug(s.proc)}-v1`;
const bindingVid = (s: Seed) => `at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/oshikatsu-${slug(s.proc)}-v1`;
