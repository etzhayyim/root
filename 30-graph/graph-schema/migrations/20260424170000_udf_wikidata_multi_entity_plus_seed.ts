...
/**
 * Extend maps_source_dispatch_kind so `did:web:maps.gftd.ai:registry:wikidata:*`
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  const seed: Array<[string, string, number, number, number]> = [
    ["did:web:maps.gftd.ai:registry:wikidata:river",      "River",      250_000, 0.6, 720.0],
    ["did:web:maps.gftd.ai:registry:wikidata:mountain",   "Mountain",   500_000, 0.6, 720.0],
    ["did:web:maps.gftd.ai:registry:wikidata:lake",       "Lake",       100_000, 0.6, 720.0],
    ["did:web:maps.gftd.ai:registry:wikidata:island",     "Spot",       100_000, 0.3, 720.0],
    ["did:web:maps.gftd.ai:registry:wikidata:airport",    "Airport",     50_000, 0.6, 720.0],
    ["did:web:maps.gftd.ai:registry:wikidata:university", "Spot",        30_000, 0.3, 720.0],
  ];
