...
const createdAt = "2026-04-29T14:41:00+09:00";
...
const nsid = "com.etzhayyim.apps.llm.answerWithKnowledge";
const sourcePath = "00-contracts/bpmn/com/etzhayyim/llm/answerWithKnowledge.bpmn";
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    SELECT
      ...
      CAST(90000 AS integer), 'active', ${createdAt}, 1,
      ${ownerDid}, ${ownerDid}, ${actorTag}, ${ownerDid}, 'anon'
    WHERE NOT EXISTS (
