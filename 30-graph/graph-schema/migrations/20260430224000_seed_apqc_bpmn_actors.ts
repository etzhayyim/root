...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/apqc-materialize-subprocesses-v1",
  ...
  { vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/apqc-emit-event-v1",
    bpmnProcessId: "apqc_emit_event",
    sourcePath: "00-contracts/bpmn/ai/gftd/apqc/emitEvent.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/apqc-coverage-snapshot-v1",
    bpmnProcessId: "apqc_coverage_snapshot",
    sourcePath: "00-contracts/bpmn/ai/gftd/apqc/coverageSnapshot.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/apqc-materializeSubprocesses-v1",
    nsid: "ai.gftd.apps.apqc.materializeSubprocesses", bpmnProcessId: "apqc_materialize_subprocesses",
    ownerDid, resultTimeoutMs: 60000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/apqc-emitEvent-v1",
    nsid: "ai.gftd.apps.apqc.emitEvent", bpmnProcessId: "apqc_emit_event",
    ownerDid, resultTimeoutMs: 60000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/apqc-coverageSnapshot-v1",
