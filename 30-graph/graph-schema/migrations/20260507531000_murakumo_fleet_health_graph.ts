...
const ownerDid = "did:web:murakumo.gftd.ai";
const createdAt = "2026-05-07T06:31:00Z";
const nsid = "ai.gftd.apps.murakumo.fleetHealthCheck";
const bpmnProcessId = "murakumo_fleet_health_check";
const sourcePath = "00-contracts/bpmn/ai/gftd/murakumo/fleetHealthCheck.bpmn";
const processVid = "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/murakumo-fleet-health-check-v1";
const bindingVid = "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/murakumo-fleet-health-check-v1";
