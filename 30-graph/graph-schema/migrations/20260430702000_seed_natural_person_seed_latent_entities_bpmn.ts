...
const seed = {
  proc: "seedLatentEntities",
  bpmnProcessId: "natural_person_seed_latent_entities_v1",
  nsid: "com.etzhayyim.apps.naturalPerson.seedLatentEntities",
  sourcePath: "00-contracts/bpmn/com/etzhayyim/natural-person/seedLatentEntities.bpmn",
  resultTimeoutMs: 300000,
};

const processVertexId = `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/${project}-seed-latent-entities-v1`;
