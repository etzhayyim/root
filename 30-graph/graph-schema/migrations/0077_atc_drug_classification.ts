 ...
 * |-----------------------------|-------|--------------------------------------------|
 * | com.etzhayyim.apps.atc.substance  | 6,440 | WHO ATC-DDD 2021-12-03 (github.com/fabkury) |
 *
 ...
 * ## New view
 *
 * - view_atc_substance: projection of com.etzhayyim.apps.atc.substance
 *
 * ## Topology integrity (post-apply)
 *
 * 0 orphan nodes in com.etzhayyim.apps.atc.substance.
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.atc.substance'`.execute(db);
