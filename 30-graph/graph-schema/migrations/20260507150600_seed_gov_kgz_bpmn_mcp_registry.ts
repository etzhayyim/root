...
const ownerDid = "did:web:kgz-state.gftd.ai";
const actorHost = "kgz-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-seed-orgs-v1",
    nsid: "ai.gftd.govKgz.seedOrgs",
    bpmnProcessId: "gov_kgz_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-register-dids-v1",
    nsid: "ai.gftd.govKgz.registerDIDs",
    bpmnProcessId: "gov_kgz_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-follow-site-deps-v1",
    nsid: "ai.gftd.govKgz.followSiteDeps",
    bpmnProcessId: "gov_kgz_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-resolve-org-path-v1",
    nsid: "ai.gftd.govKgz.resolveOrgPath",
    bpmnProcessId: "gov_kgz_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-list-orgs-v1",
    nsid: "ai.gftd.govKgz.listOrgs",
    bpmnProcessId: "gov_kgz_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-sync-wet-updates-v1",
    nsid: "ai.gftd.govKgz.syncWetUpdates",
    bpmnProcessId: "gov_kgz_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kgz-heartbeat-tick-v1",
    nsid: "ai.gftd.govKgz.heartbeatTick",
    bpmnProcessId: "gov_kgz_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKgz/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
