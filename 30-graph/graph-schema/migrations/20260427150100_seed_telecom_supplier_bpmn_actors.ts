...
const seeds: Seed[] = [
  { proc: "registerInterconnectAgreement", bpmnProcessId: "telecom_register_interconnect_agreement",
    nsid: "com.etzhayyim.apps.telecom.registerInterconnectAgreement", resultTimeoutMs: 30000 },
  { proc: "registerRoamingPartner", bpmnProcessId: "telecom_register_roaming_partner",
    nsid: "com.etzhayyim.apps.telecom.registerRoamingPartner", resultTimeoutMs: 30000 },
  { proc: "recordTapFile", bpmnProcessId: "telecom_record_tap_file",
    nsid: "com.etzhayyim.apps.telecom.recordTapFile", resultTimeoutMs: 60000 },
  { proc: "settleRoamingInvoice", bpmnProcessId: "telecom_settle_roaming_invoice",
    nsid: "com.etzhayyim.apps.telecom.settleRoamingInvoice", resultTimeoutMs: 60000 },
  { proc: "recordInterconnectCdr", bpmnProcessId: "telecom_record_interconnect_cdr",
    nsid: "com.etzhayyim.apps.telecom.recordInterconnectCdr", resultTimeoutMs: 15000 },
  { proc: "registerNumberRange", bpmnProcessId: "telecom_register_number_range",
    nsid: "com.etzhayyim.apps.telecom.registerNumberRange", resultTimeoutMs: 30000 },
  { proc: "portInRequest", bpmnProcessId: "telecom_port_in_request",
    nsid: "com.etzhayyim.apps.telecom.portInRequest", resultTimeoutMs: 30000 },
  { proc: "portOutRequest", bpmnProcessId: "telecom_port_out_request",
    nsid: "com.etzhayyim.apps.telecom.portOutRequest", resultTimeoutMs: 30000 },
];
