...
const seeds: Seed[] = [
  {
    proc: "inferCensusStats",
    bpmnProcessId: "coverage_infer_census_stats_v1",
    nsid: "com.etzhayyim.apps.coverage.inferCensusStats",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/coverage/inferCensusStats.bpmn",
