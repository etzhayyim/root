 ...
 * vertex_convo WHERE kind='com.etzhayyim.projector.reflection' — that path
 * is retired when com.etzhayyim.projector.reflection AT records stop being
 ...
 * Drives com.etzhayyim.projector.addReflection response field
