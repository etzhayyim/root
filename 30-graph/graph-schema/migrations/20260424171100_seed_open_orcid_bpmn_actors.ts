...
const ownerDid = "did:web:open-orcid.etzhayyim.com";
const actorTag = "sys.bpmn.seed.open-orcid";

const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-orcid-register-researcher-v1",
    bpmnProcessId: "open_orcid_register_researcher",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-orcid/registerResearcher.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-orcid-record-affiliation-v1",
    bpmnProcessId: "open_orcid_record_affiliation",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-orcid/recordAffiliation.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-orcid-registerResearcher-v1",
    nsid: "com.etzhayyim.apps.openOrcid.registerResearcher", bpmnProcessId: "open_orcid_register_researcher",
    ownerDid, resultTimeoutMs: 30000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-orcid-recordAffiliation-v1",
    nsid: "com.etzhayyim.apps.openOrcid.recordAffiliation", bpmnProcessId: "open_orcid_record_affiliation",
