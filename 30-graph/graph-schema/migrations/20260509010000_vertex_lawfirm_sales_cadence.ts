...
const PROCESSES = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-sales-cadence-tick-v1",
    bpmnProcessId: "lawfirm_sales_cadence_tick",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/lawfirm/salesCadenceTick.bpmn",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-pipeline-stage-transition-v1",
    bpmnProcessId: "lawfirm_pipeline_stage_transition",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/lawfirm/pipelineStageTransition.bpmn",
  },
];
const BINDING = {
  vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-pipeline-stage-transition-xrpc-v1",
  nsid: "com.etzhayyim.apps.lawfirm.pipelineTransition",
  bpmnProcessId: "lawfirm_pipeline_stage_transition",
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    VALUES
      (
        'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.lawfirm.lead/nishith-desai-2026',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.lawfirm.lead/trilegal-2026',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.lawfirm.lead/induslaw-2026',
