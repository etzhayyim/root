...
const ownerDid = "did:web:est-state.gftd.ai";
const actorHost = "est-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-seed-orgs-v1",
    nsid: "ai.gftd.govEst.seedOrgs",
    bpmnProcessId: "gov_est_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-register-dids-v1",
    nsid: "ai.gftd.govEst.registerDIDs",
    bpmnProcessId: "gov_est_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-follow-site-deps-v1",
    nsid: "ai.gftd.govEst.followSiteDeps",
    bpmnProcessId: "gov_est_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-resolve-org-path-v1",
    nsid: "ai.gftd.govEst.resolveOrgPath",
    bpmnProcessId: "gov_est_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-list-orgs-v1",
    nsid: "ai.gftd.govEst.listOrgs",
    bpmnProcessId: "gov_est_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-sync-wet-updates-v1",
    nsid: "ai.gftd.govEst.syncWetUpdates",
    bpmnProcessId: "gov_est_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-est-heartbeat-tick-v1",
    nsid: "ai.gftd.govEst.heartbeatTick",
    bpmnProcessId: "gov_est_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEst/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
