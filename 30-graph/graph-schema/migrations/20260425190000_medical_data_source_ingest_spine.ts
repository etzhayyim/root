...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    VALUES
      ('medical-data-source:cms-pos-clinical-labs', 'cms-pos-clinical-labs', 'iryo_shisetsu', 'app.etzhayyim.apps.iryo.shisetsu', 'cms', 'CMS POS Clinical Laboratories', 'CMS Provider of Services - Clinical Laboratories', 'cms-data-api', 'json-page', 'https://data.cms.gov/data-api/v1/dataset/d3eb38ac-d8e9-40d3-b7b7-6205d3d1dc16/data', 'US-PD', 'monthly', 676051, 'ai-gftd-nats', 'medical-sources/iryo-shisetsu', 'active', 100, '{"datasetId":"d3eb38ac-d8e9-40d3-b7b7-6205d3d1dc16"}', NOW()::VARCHAR, NOW()::VARCHAR),
      ('medical-data-source:cms-pos-iqies', 'cms-pos-iqies', 'iryo_shisetsu', 'app.etzhayyim.apps.iryo.shisetsu', 'cms', 'CMS POS IQIES', 'CMS Provider of Services - Internet Quality Improvement and Evaluation System', 'cms-data-api', 'json-page', 'https://data.cms.gov/data-api/v1/dataset/086e48c4-87a6-4be1-8823-29e8da8f225b/data', 'US-PD', 'monthly', 77283, 'ai-gftd-nats', 'medical-sources/iryo-shisetsu', 'active', 90, '{"datasetId":"086e48c4-87a6-4be1-8823-29e8da8f225b"}', NOW()::VARCHAR, NOW()::VARCHAR),
      ('medical-data-source:cms-pos-qies', 'cms-pos-qies', 'iryo_shisetsu', 'app.etzhayyim.apps.iryo.shisetsu', 'cms', 'CMS POS QIES', 'CMS Provider of Services - Quality Improvement and Evaluation System', 'cms-data-api', 'json-page', 'https://data.cms.gov/data-api/v1/dataset/8ba0f9b4-9493-4aa0-9f82-44ea9468d1b5/data', 'US-PD', 'monthly', 44429, 'ai-gftd-nats', 'medical-sources/iryo-shisetsu', 'active', 80, '{"datasetId":"8ba0f9b4-9493-4aa0-9f82-44ea9468d1b5"}', NOW()::VARCHAR, NOW()::VARCHAR)
  `.execute(db);
  ...
  await sql`
    ...
    VALUES
      ('medical-source-target:cms-pos-clinical-labs:iryo-shisetsu', 'cms-pos-clinical-labs', 'iryo_shisetsu', 'app.etzhayyim.apps.iryo.shisetsu', 'fillsCoverageGap', 'active', NOW()::VARCHAR, NOW()::VARCHAR),
      ('medical-source-target:cms-pos-iqies:iryo-shisetsu', 'cms-pos-iqies', 'iryo_shisetsu', 'app.etzhayyim.apps.iryo.shisetsu', 'fillsCoverageGap', 'active', NOW()::VARCHAR, NOW()::VARCHAR),
      ('medical-source-target:cms-pos-qies:iryo-shisetsu', 'cms-pos-qies', 'iryo_shisetsu', 'app.etzhayyim.apps.iryo.shisetsu', 'fillsCoverageGap', 'active', NOW()::VARCHAR, NOW()::VARCHAR)
  `.execute(db);
}
