...
const BPMN_PATH   = "00-contracts/bpmn/com/etzhayyim/common-crawl/extractEntities.bpmn";
const PROCESS_VID = `at://${actorId}/com.etzhayyim.apps.bpmn.processDef/common-crawl-extract-entities-v1`;
const BINDING_VID = `at://${actorId}/com.etzhayyim.apps.bpmn.binding/common-crawl-extract-entities-v1`;
