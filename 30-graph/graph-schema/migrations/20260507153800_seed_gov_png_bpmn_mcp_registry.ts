...
const ownerDid = "did:web:png-state.gftd.ai";
const actorHost = "png-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-seed-orgs-v1",
    nsid: "ai.gftd.govPng.seedOrgs",
    bpmnProcessId: "gov_png_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-register-dids-v1",
    nsid: "ai.gftd.govPng.registerDIDs",
    bpmnProcessId: "gov_png_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-follow-site-deps-v1",
    nsid: "ai.gftd.govPng.followSiteDeps",
    bpmnProcessId: "gov_png_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-resolve-org-path-v1",
    nsid: "ai.gftd.govPng.resolveOrgPath",
    bpmnProcessId: "gov_png_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-list-orgs-v1",
    nsid: "ai.gftd.govPng.listOrgs",
    bpmnProcessId: "gov_png_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-sync-wet-updates-v1",
    nsid: "ai.gftd.govPng.syncWetUpdates",
    bpmnProcessId: "gov_png_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-png-heartbeat-tick-v1",
    nsid: "ai.gftd.govPng.heartbeatTick",
    bpmnProcessId: "gov_png_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govPng/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
