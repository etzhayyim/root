...
const createdAt = "2026-04-29T09:06:00Z";
const ownerDid = "did:web:natural-person.etzhayyim.com";
const actorTag = "sys.bpmn.seed.natural-person";
// bpmn-coverage gate marker: project: "natural-person"
const project = "natural-person";

const seeds: Seed[] = [
  {
    proc: "generateCohortBatch",
    bpmnProcessId: "natural_person_generate_cohort_batch_v1",
    nsid: "com.etzhayyim.apps.naturalPerson.generateCohortBatch",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/natural-person/generateCohortBatch.bpmn",
