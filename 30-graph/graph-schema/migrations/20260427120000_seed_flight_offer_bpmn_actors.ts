...
const sourcePath = "00-contracts/bpmn/com/etzhayyim/flight-offer/searchOffers.bpmn";
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    SELECT ${processVertexId}, ${ownerDid}, 'flight_offer_search_offers',
  ...
  await sql`
    ...
    SELECT ${bindingVertexId}, ${ownerDid}, 'com.etzhayyim.apps.flightOffer.searchOffers',
