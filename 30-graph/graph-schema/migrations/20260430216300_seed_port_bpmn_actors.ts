...
const ownerDid = "did:web:p0rt7890.gftd.ai";
...
const seeds: Seed[] = [
  ...
  },
  {
    ...
    "nsid": "ai.gftd.apps.port.infrastructure.registerTerminal",
  ...
  },
  {
    ...
    "nsid": "ai.gftd.apps.port.portCallTracking.listPortCallEvents",
    "writeTableAllowlist": ""
  },
  {
    "file": "portCallTracking/getVesselsAtPort",
    "processId": "port_portCallTracking_getVesselsAtPort",
    "nsid": "ai.gftd.apps.port.portCallTracking.getVesselsAtPort",
    "writeTableAllowlist": ""
  },
  {
    "file": "portCallTracking/getPortOccupancy",
    "processId": "port_portCallTracking_getPortOccupancy",
    "nsid": "ai.gftd.apps.port.portCallTracking.getPortOccupancy",
    "writeTableAllowlist": ""
  },
  {
    "file": "seedPorts",
    "processId": "port_seedPorts",
    "nsid": "ai.gftd.apps.port.seedPorts",
  ...
  },
  {
    ...
    "nsid": "ai.gftd.apps.port.getDashboard",
    "writeTableAllowlist": ""
  }
];
...
const processVertexId = (s: Seed) => `at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-${slug(s)}-v1`;
const bindingVertexId = (s: Seed) => `at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-${slug(s)}-v1`;
