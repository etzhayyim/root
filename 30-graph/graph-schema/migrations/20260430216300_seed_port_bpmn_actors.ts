...
const seeds: Seed[] = [
  ...
  },
  {
    ...
    "nsid": "com.etzhayyim.apps.port.infrastructure.registerTerminal",
  ...
  },
  {
    ...
    "nsid": "com.etzhayyim.apps.port.portCallTracking.receivePortCallEvent",
  ...
  },
  {
    ...
    "nsid": "com.etzhayyim.apps.port.portCallTracking.listPortCallEvents",
    "writeTableAllowlist": ""
  },
  {
  ...
  },
  {
    ...
    "nsid": "com.etzhayyim.apps.port.seedPorts",
...
const sourcePath = (s: Seed) => `00-contracts/bpmn/com/etzhayyim/port/${s.file}.bpmn`;
const slug = (s: Seed) => s.file.replace(/\//g, "-").replace(/[A-Z]/g, (m) => `-${m.toLowerCase()}`);
const processVertexId = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/port-${slug(s)}-v1`;
const bindingVertexId = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/port-${slug(s)}-v1`;
