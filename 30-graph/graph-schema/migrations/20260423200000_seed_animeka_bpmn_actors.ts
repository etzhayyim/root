...
const stages: Array<{
  ...
  { slug: "animeka-generate-script-v1",      bpmnProcessId: "animeka_generate_script",      file: "generateScript.bpmn",      nsid: "ai.gftd.apps.animeka.generateScript",     bindingSlug: "animeka-generateScript-v1" },
  { slug: "animeka-breakdown-scene-v1",      bpmnProcessId: "animeka_breakdown_scene",      file: "breakdownScene.bpmn",      nsid: "ai.gftd.apps.animeka.breakdownScene",     bindingSlug: "animeka-breakdownScene-v1" },
  { slug: "animeka-generate-storyboard-v1",  bpmnProcessId: "animeka_generate_storyboard",  file: "generateStoryboard.bpmn",  nsid: "ai.gftd.apps.animeka.generateStoryboard", bindingSlug: "animeka-generateStoryboard-v1" },
  { slug: "animeka-generate-layout-v1",      bpmnProcessId: "animeka_generate_layout",      file: "generateLayout.bpmn",      nsid: "ai.gftd.apps.animeka.generateLayout",     bindingSlug: "animeka-generateLayout-v1" },
  { slug: "animeka-generate-keyframe-v1",    bpmnProcessId: "animeka_generate_keyframe",    file: "generateKeyframe.bpmn",    nsid: "ai.gftd.apps.animeka.generateKeyframe",   bindingSlug: "animeka-generateKeyframe-v1" },
  { slug: "animeka-generate-inbetween-v1",   bpmnProcessId: "animeka_generate_inbetween",   file: "generateInbetween.bpmn",   nsid: "ai.gftd.apps.animeka.generateInbetween",  bindingSlug: "animeka-generateInbetween-v1" },
  { slug: "animeka-design-color-model-v1",   bpmnProcessId: "animeka_design_color_model",   file: "designColorModel.bpmn",    nsid: "ai.gftd.apps.animeka.designColorModel",   bindingSlug: "animeka-designColorModel-v1" },
  { slug: "animeka-auto-trace-cut-v1",       bpmnProcessId: "animeka_auto_trace_cut",       file: "autoTraceCut.bpmn",        nsid: "ai.gftd.apps.animeka.autoTrace",          bindingSlug: "animeka-autoTrace-v1" },
  { slug: "animeka-generate-background-v1",  bpmnProcessId: "animeka_generate_background",  file: "generateBackground.bpmn",  nsid: "ai.gftd.apps.animeka.generateBackground", bindingSlug: "animeka-generateBackground-v1" },
  { slug: "animeka-render-composite-v1",     bpmnProcessId: "animeka_render_composite",     file: "renderComposite.bpmn",     nsid: "ai.gftd.apps.animeka.renderComposite",    bindingSlug: "animeka-renderComposite-v1" },
  { slug: "animeka-generate-sound-cue-v1",   bpmnProcessId: "animeka_generate_sound_cue",   file: "generateSoundCue.bpmn",    nsid: "ai.gftd.apps.animeka.generateSoundCue",   bindingSlug: "animeka-generateSoundCue-v1" },
  { slug: "animeka-publish-episode-v1",      bpmnProcessId: "animeka_publish_episode",      file: "publishEpisode.bpmn",      nsid: "ai.gftd.apps.animeka.publishEpisode",     bindingSlug: "animeka-publishEpisode-v1" },
  { slug: "animeka-chat-v1",                 bpmnProcessId: "animeka_chat",                 file: "chat.bpmn",                nsid: "ai.gftd.apps.animeka.chat",               bindingSlug: "animeka-chat-v1" },
];
