...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-patent-register-patent-v1",
    bpmnProcessId: "open_patent_register_patent",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-patent/registerPatent.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-patent-record-citation-v1",
    bpmnProcessId: "open_patent_record_citation",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-patent/recordCitation.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-patent-registerPatent-v1",
    nsid: "com.etzhayyim.apps.openPatent.registerPatent", bpmnProcessId: "open_patent_register_patent",
    ownerDid, resultTimeoutMs: 30000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-patent-recordCitation-v1",
    nsid: "com.etzhayyim.apps.openPatent.recordCitation", bpmnProcessId: "open_patent_record_citation",
