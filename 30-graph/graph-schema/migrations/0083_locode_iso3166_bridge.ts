 ...
 * LOCODE collection: com.etzhayyim.apps.locode.location (116,067 rows)
 * ISO 3166-1 collection: com.etzhayyim.apps.iso3166.country (296 rows)
...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  //   WHERE locode.collection = 'com.etzhayyim.apps.locode.location'
  //     AND iso3166.collection = 'com.etzhayyim.apps.iso3166.country'
