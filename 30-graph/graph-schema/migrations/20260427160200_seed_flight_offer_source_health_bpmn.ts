...
const sourcePath = "00-contracts/bpmn/com/etzhayyim/flight-offer/sourceHealth.bpmn";
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    SELECT ${processVertexId}, ${ownerDid}, 'flight_offer_source_health',
  ...
  await sql`
    ...
    SELECT ${bindingVertexId}, ${ownerDid}, 'com.etzhayyim.apps.flightOffer.sourceHealth',
