...
const ENTRIES: BpmnEntry[] = [
  {
    ...
    processVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/kobo-budding-v1",
    bindingVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/kobo-budding-v1",
    nsid: "app.etzhayyim.apps.kobo.budAgent",
  },
  {
    processId: "kobo_germination",
    bpmnPath: "00-contracts/bpmn/ai/gftd/kobo/germination.bpmn",
    processVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/kobo-germination-v1",
    bindingVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/kobo-germination-v1",
    nsid: "app.etzhayyim.apps.kobo.spawnAgent",
  },
  {
    processId: "kobo_sporulation",
    bpmnPath: "00-contracts/bpmn/ai/gftd/kobo/sporulation.bpmn",
    processVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/kobo-sporulation-v1",
    bindingVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/kobo-sporulation-v1",
    nsid: "app.etzhayyim.apps.kobo.sporulate",
  },
  {
    processId: "kabi_anastomosis_gate",
    bpmnPath: "00-contracts/bpmn/ai/gftd/kabi/anastomosis-gate.bpmn",
    processVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/kabi-anastomosis-gate-v1",
    bindingVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/kabi-anastomosis-gate-v1",
    nsid: "app.etzhayyim.apps.kabi.fusionProbe",
  },
  {
    processId: "kinoko_ponf_fruiting",
    bpmnPath: "00-contracts/bpmn/ai/gftd/kinoko/ponf-fruiting.bpmn",
    processVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/kinoko-ponf-fruiting-v1",
    bindingVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/kinoko-ponf-fruiting-v1",
    nsid: "app.etzhayyim.apps.kinoko.formBlock",
  },
  {
    processId: "hakkou_ferment_pipeline",
    bpmnPath: "00-contracts/bpmn/ai/gftd/hakkou/ferment-pipeline.bpmn",
    processVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/hakkou-ferment-pipeline-v1",
    bindingVid: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/hakkou-ferment-pipeline-v1",
    nsid: "app.etzhayyim.apps.hakkou.startFerment",
  },
];
