...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-invoice-register-issuer-v1",
    bpmnProcessId: "jpn_invoice_register_issuer",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/jpn-invoice/registerInvoiceIssuer.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-invoice-record-corporate-tax-filing-v1",
    bpmnProcessId: "jpn_invoice_record_corporate_tax_filing",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/jpn-invoice/recordCorporateTaxFiling.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-invoice-registerInvoiceIssuer-v1",
    nsid: "com.etzhayyim.apps.jpnInvoice.registerInvoiceIssuer", bpmnProcessId: "jpn_invoice_register_issuer",
    ownerDid, resultTimeoutMs: 15000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-invoice-recordCorporateTaxFiling-v1",
    nsid: "com.etzhayyim.apps.jpnInvoice.recordCorporateTaxFiling", bpmnProcessId: "jpn_invoice_record_corporate_tax_filing",
