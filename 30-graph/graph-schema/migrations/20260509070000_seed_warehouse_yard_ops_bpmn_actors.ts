...
const processSeeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/warehouse-register-sku-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/warehouse-putaway-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/warehouse-pick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/warehouse-get-inventory-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/yard-ops-check-in-trailer-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/yard-ops-assign-door-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/yard-ops-complete-dock-job-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/yard-ops-get-dock-schedule-v1",
...
const bindingSeeds: BindingSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/warehouse-registerSku-v1",
    nsid: "app.etzhayyim.apps.warehouse.registerSku",
    bpmnProcessId: "warehouse_register_sku",
    ownerDid: warehouseDid,
    actorTag: warehouseTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/warehouse-putaway-v1",
    nsid: "app.etzhayyim.apps.warehouse.putaway",
    bpmnProcessId: "warehouse_putaway",
    ownerDid: warehouseDid,
    actorTag: warehouseTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/warehouse-pick-v1",
    nsid: "app.etzhayyim.apps.warehouse.pick",
    bpmnProcessId: "warehouse_pick",
    ownerDid: warehouseDid,
    actorTag: warehouseTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/warehouse-getInventory-v1",
    nsid: "app.etzhayyim.apps.warehouse.getInventory",
    bpmnProcessId: "warehouse_get_inventory",
    ownerDid: warehouseDid,
    actorTag: warehouseTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/yardOps-checkInTrailer-v1",
    nsid: "app.etzhayyim.apps.yardOps.checkInTrailer",
    bpmnProcessId: "yard_ops_check_in_trailer",
    ownerDid: yardOpsDid,
    actorTag: yardOpsTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/yardOps-assignDoor-v1",
    nsid: "app.etzhayyim.apps.yardOps.assignDoor",
    bpmnProcessId: "yard_ops_assign_door",
    ownerDid: yardOpsDid,
    actorTag: yardOpsTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/yardOps-completeDockJob-v1",
    nsid: "app.etzhayyim.apps.yardOps.completeDockJob",
    bpmnProcessId: "yard_ops_complete_dock_job",
    ownerDid: yardOpsDid,
    actorTag: yardOpsTag,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/yardOps-getDockSchedule-v1",
    nsid: "app.etzhayyim.apps.yardOps.getDockSchedule",
    bpmnProcessId: "yard_ops_get_dock_schedule",
    ownerDid: yardOpsDid,
    actorTag: yardOpsTag,
  },
