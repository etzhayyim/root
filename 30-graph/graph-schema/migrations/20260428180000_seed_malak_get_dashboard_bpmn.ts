// ADR-0056 — malak getDashboard BPMN seed.
//
// Registers malak.getDashboard in vertex_bpmn_process_def +
// vertex_bpmn_lexicon_binding so the F5 watcher deploys it to Zeebe.
//
// Requires 20260428170000_mv_malak_dashboard_counts_v2 (4-metric MV).
...
const seeds: Seed[] = [
  {
    proc: "getDashboard",
    bpmnProcessId: "malak_get_dashboard",
