...
const ownerDid = "did:web:zmb-state.gftd.ai";
const actorHost = "zmb-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-seed-orgs-v1",
    nsid: "ai.gftd.govZmb.seedOrgs",
    bpmnProcessId: "gov_zmb_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-register-dids-v1",
    nsid: "ai.gftd.govZmb.registerDIDs",
    bpmnProcessId: "gov_zmb_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-follow-site-deps-v1",
    nsid: "ai.gftd.govZmb.followSiteDeps",
    bpmnProcessId: "gov_zmb_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-resolve-org-path-v1",
    nsid: "ai.gftd.govZmb.resolveOrgPath",
    bpmnProcessId: "gov_zmb_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-list-orgs-v1",
    nsid: "ai.gftd.govZmb.listOrgs",
    bpmnProcessId: "gov_zmb_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-sync-wet-updates-v1",
    nsid: "ai.gftd.govZmb.syncWetUpdates",
    bpmnProcessId: "gov_zmb_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zmb-heartbeat-tick-v1",
    nsid: "ai.gftd.govZmb.heartbeatTick",
    bpmnProcessId: "gov_zmb_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govZmb/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
