...
const seeds: Seed[] = [
  { proc: "onboardNetworkServiceDescriptor", bpmnProcessId: "telecom_onboard_network_service_descriptor",
    nsid: "com.etzhayyim.apps.telecom.onboardNetworkServiceDescriptor", resultTimeoutMs: 30000 },
  { proc: "onboardVnfDescriptor", bpmnProcessId: "telecom_onboard_vnf_descriptor",
    nsid: "com.etzhayyim.apps.telecom.onboardVnfDescriptor", resultTimeoutMs: 30000 },
  { proc: "instantiateNetworkService", bpmnProcessId: "telecom_instantiate_network_service",
    nsid: "com.etzhayyim.apps.telecom.instantiateNetworkService", resultTimeoutMs: 60000 },
  { proc: "instantiateVnf", bpmnProcessId: "telecom_instantiate_vnf",
    nsid: "com.etzhayyim.apps.telecom.instantiateVnf", resultTimeoutMs: 60000 },
  { proc: "scaleVnf", bpmnProcessId: "telecom_scale_vnf",
    nsid: "com.etzhayyim.apps.telecom.scaleVnf", resultTimeoutMs: 30000 },
  { proc: "healVnf", bpmnProcessId: "telecom_heal_vnf",
    nsid: "com.etzhayyim.apps.telecom.healVnf", resultTimeoutMs: 60000 },
  { proc: "provisionSdnFlow", bpmnProcessId: "telecom_provision_sdn_flow",
    nsid: "com.etzhayyim.apps.telecom.provisionSdnFlow", resultTimeoutMs: 15000 },
  { proc: "terminateNetworkService", bpmnProcessId: "telecom_terminate_network_service",
    nsid: "com.etzhayyim.apps.telecom.terminateNetworkService", resultTimeoutMs: 30000 },
];
