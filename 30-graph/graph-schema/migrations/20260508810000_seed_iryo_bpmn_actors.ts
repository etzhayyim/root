...
/**
 * iryo.etzhayyim.com BPMN-as-actor seeding (ADR-2605080800 + ADR-0056 + ADR-2604282300).
 *
 ...
 * `http://dispatcher.etzhayyim.com:8080/xrpc/com.etzhayyim.apps.iryo.*`.
 *
 ...
 *  iryo_admission_discharge_cycle com.etzhayyim.apps.iryo.submitEncounter
 *                                 com.etzhayyim.apps.iryo.dischargeEncounter
 *                                                     (action-routed)
 *  iryo_drg_claim_cycle           com.etzhayyim.apps.iryo.submitDrgClaim
 *  iryo_agent_loop                com.etzhayyim.apps.iryo.agentLoop
 */
...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/iryo-admission-discharge-cycle-v1",
    bpmnProcessId: "iryo_admission_discharge_cycle",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/iryo/admissionDischargeCycle.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/iryo-drg-claim-cycle-v1",
    bpmnProcessId: "iryo_drg_claim_cycle",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/iryo/drgClaimCycle.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/iryo-bed-occupancy-and-shift-v1",
    bpmnProcessId: "iryo_bed_occupancy_and_shift",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/iryo/bedOccupancyAndShift.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/iryo-agent-loop-v1",
    bpmnProcessId: "iryo_agent_loop",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/iryo/agentLoop.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/iryo-synthetic-event-tick-v1",
    bpmnProcessId: "iryo_synthetic_event_tick",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/iryo/syntheticEventTick.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/iryo-submitEncounter-v1",
    nsid: "com.etzhayyim.apps.iryo.submitEncounter",
    bpmnProcessId: "iryo_admission_discharge_cycle", ownerDid, resultTimeoutMs: 30_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/iryo-dischargeEncounter-v1",
    nsid: "com.etzhayyim.apps.iryo.dischargeEncounter",
    bpmnProcessId: "iryo_admission_discharge_cycle", ownerDid, resultTimeoutMs: 30_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/iryo-submitDrgClaim-v1",
    nsid: "com.etzhayyim.apps.iryo.submitDrgClaim",
    bpmnProcessId: "iryo_drg_claim_cycle", ownerDid, resultTimeoutMs: 30_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/iryo-agentLoop-v1",
    nsid: "com.etzhayyim.apps.iryo.agentLoop",
