...
const entries: Entry[] = [
  {
    ...
    nsid: "com.etzhayyim.apps.flightOffer.removeWatch",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/flight-offer/removeWatch.bpmn",
    resultTimeoutMs: 15000,
    slug: "flight-offer-remove-watch-v1",
  },
  {
    bpmnProcessId: "flight_offer_list_watch",
    nsid: "com.etzhayyim.apps.flightOffer.listWatch",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/flight-offer/listWatch.bpmn",
    resultTimeoutMs: 15000,
    slug: "flight-offer-list-watch-v1",
  },
  {
    bpmnProcessId: "flight_offer_get_cheapest",
    nsid: "com.etzhayyim.apps.flightOffer.getCheapest",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/flight-offer/getCheapest.bpmn",
