...
const seeds: BpmnSeed[] = [
  {
    processVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/maps-liveTrackAircraft-v1",
    bindingVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/maps-liveTrackAircraft-v1",
    processId: "maps_live_track_aircraft",
    nsid: "app.etzhayyim.apps.maps.liveTrackAircraft",
  ...
  {
    processVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/maps-computeAircraftTrack-v1",
    bindingVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/maps-computeAircraftTrack-v1",
    processId: "maps_compute_aircraft_track",
    nsid: "app.etzhayyim.apps.maps.computeAircraftTrack",
  ...
  {
    processVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/maps-refreshTleCatalog-v1",
    bindingVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/maps-refreshTleCatalog-v1",
    processId: "maps_refresh_tle_catalog",
    nsid: "app.etzhayyim.apps.maps.refreshTleCatalog",
  ...
  {
    processVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/maps-precomputeSatellitePasses-v1",
    bindingVertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.lexiconBinding/maps-precomputeSatellitePasses-v1",
    processId: "maps_precompute_satellite_passes",
    nsid: "app.etzhayyim.apps.maps.precomputeSatellitePasses",
