...
const seeds: Seed[] = [
  { slug: "submit-score", op: "submitScore", nsid: "com.etzhayyim.apps.kami.ketsuGorilla.submitScore", processId: "kami_ketsu_gorilla_submit_score", timeoutMs: 30000, writeTableAllowlist: "vertex_atrecord_kami_ketsu_gorilla_score" },
  { slug: "get-leaderboard", op: "getLeaderboard", nsid: "com.etzhayyim.apps.kami.ketsuGorilla.getLeaderboard", processId: "kami_ketsu_gorilla_get_leaderboard", timeoutMs: 30000, writeTableAllowlist: "" },
];

const sourcePath = (s: Seed) => `00-contracts/bpmn/com/etzhayyim/kamiKetsuGorilla/${s.op}.bpmn`;
const processVertexId = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kami-ketsu-gorilla-${s.slug}-v1`;
const bindingVertexId = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kami-ketsu-gorilla-${s.op}-v1`;
