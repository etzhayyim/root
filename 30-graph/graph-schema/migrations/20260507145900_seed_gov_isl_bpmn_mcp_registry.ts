...
const ownerDid = "did:web:isl-state.gftd.ai";
const actorHost = "isl-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-seed-orgs-v1",
    nsid: "ai.gftd.govIsl.seedOrgs",
    bpmnProcessId: "gov_isl_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-register-dids-v1",
    nsid: "ai.gftd.govIsl.registerDIDs",
    bpmnProcessId: "gov_isl_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-follow-site-deps-v1",
    nsid: "ai.gftd.govIsl.followSiteDeps",
    bpmnProcessId: "gov_isl_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-resolve-org-path-v1",
    nsid: "ai.gftd.govIsl.resolveOrgPath",
    bpmnProcessId: "gov_isl_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-list-orgs-v1",
    nsid: "ai.gftd.govIsl.listOrgs",
    bpmnProcessId: "gov_isl_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-sync-wet-updates-v1",
    nsid: "ai.gftd.govIsl.syncWetUpdates",
    bpmnProcessId: "gov_isl_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-isl-heartbeat-tick-v1",
    nsid: "ai.gftd.govIsl.heartbeatTick",
    bpmnProcessId: "gov_isl_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIsl/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
