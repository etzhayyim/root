...
// sekkei BPMN-as-actor seed (ADR-0056)
// 3 processes: dailyPulse / reviewDrawing / approveRevision
...
const createdAt = "2026-04-28T22:05:00Z";
const ownerDid = "did:web:sekkei.etzhayyim.com";
const actorTag = "sys.bpmn.seed.sekkei";
const project = "sekkei";

const seeds: Seed[] = [
  {
    proc: "dailyPulse",
    bpmnProcessId: "sekkei_daily_pulse",
    nsid: "com.etzhayyim.apps.sekkei.dailyPulse",
    resultTimeoutMs: 30000,
  },
  {
    proc: "reviewDrawing",
    bpmnProcessId: "sekkei_review_drawing",
    nsid: "com.etzhayyim.apps.sekkei.reviewDrawing",
    resultTimeoutMs: 300000,
  },
  {
    proc: "approveRevision",
    bpmnProcessId: "sekkei_approve_revision",
    nsid: "com.etzhayyim.apps.sekkei.approveRevision",
