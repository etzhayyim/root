...
// kogu BPMN-as-actor seed (ADR-0056)
// 3 processes: dailyPulse / scheduleCalibration / checkoutTool
...
const createdAt = "2026-04-28T22:04:00Z";
const ownerDid = "did:web:kogu.etzhayyim.com";
const actorTag = "sys.bpmn.seed.kogu";
const project = "kogu";
...
const seeds: Seed[] = [
  {
    ...
    nsid: "com.etzhayyim.apps.kogu.dailyPulse",
    resultTimeoutMs: 30000,
  },
  {
    proc: "scheduleCalibration",
    bpmnProcessId: "kogu_schedule_calibration",
    nsid: "com.etzhayyim.apps.kogu.scheduleCalibration",
    resultTimeoutMs: 30000,
  },
  {
    proc: "checkoutTool",
    bpmnProcessId: "kogu_checkout_tool",
    nsid: "com.etzhayyim.apps.kogu.checkoutTool",
    resultTimeoutMs: 30000,
  },
];
