...
const createdAt = "2026-04-29T10:01:00Z";
const ownerDid = "did:web:hanrei.etzhayyim.com";
const actorTag = "sys.bpmn.seed.hanrei";
const project = "hanrei";
...
const seeds: Seed[] = [
  {
    ...
    sourcePath: "00-contracts/bpmn/com/etzhayyim/hanrei/hanreiIngest.bpmn",
