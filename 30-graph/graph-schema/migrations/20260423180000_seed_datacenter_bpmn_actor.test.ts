...
const bpmnSource = readFileSync(resolve(__dirname, "../../../00-contracts/bpmn/com/etzhayyim/datacenter/operateFacility.bpmn"), "utf-8");
...
describe("Seed Datacenter BPMN Actor Migration", () => {
  it("seeds the datacenter BPMN process definition", () => {
    ...
    expect(migrationSource).toContain('sourcePath: "00-contracts/bpmn/com/etzhayyim/datacenter/operateFacility.bpmn"');
  ...
  it("seeds the startOperation lexicon binding", () => {
    ...
    expect(migrationSource).toContain('nsid: "com.etzhayyim.apps.datacenter.startOperation"');
    expect(migrationSource).toContain("resultTimeoutMs: 0");
    expect(migrationSource).toContain('nsid: "com.etzhayyim.apps.datacenter.requestAccess"');
    expect(migrationSource).toContain('nsid: "com.etzhayyim.apps.datacenter.reserveCapacity"');
    expect(migrationSource).toContain('nsid: "com.etzhayyim.apps.datacenter.purgeAccessPii"');
  });
