...
const ownerDid = "did:web:omise.etzhayyim.com";
...
const seeds: Seed[] = procs.map((proc) => ({
  ...
  nsid: `com.etzhayyim.apps.omise.${proc}`,
  resultTimeoutMs: 30000,
  writeTableAllowlist: writeTables[proc] ?? "",
}));

const bpmnPath = (s: Seed) => `00-contracts/bpmn/com/etzhayyim/omise/${s.proc}.bpmn`;
const processVid = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/omise-${slug(s.proc)}-v1`;
const bindingVid = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/omise-${slug(s.proc)}-v1`;
