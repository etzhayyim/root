...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-seedOrgs-v1",
    nsid: "app.etzhayyim.govEth.seedOrgs",
    bpmnProcessId: "gov_eth_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-registerDIDs-v1",
    nsid: "app.etzhayyim.govEth.registerDIDs",
    bpmnProcessId: "gov_eth_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-followSiteDeps-v1",
    nsid: "app.etzhayyim.govEth.followSiteDeps",
    bpmnProcessId: "gov_eth_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-resolveOrgPath-v1",
    nsid: "app.etzhayyim.govEth.resolveOrgPath",
    bpmnProcessId: "gov_eth_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-listOrgs-v1",
    nsid: "app.etzhayyim.govEth.listOrgs",
    bpmnProcessId: "gov_eth_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-syncWetUpdates-v1",
    nsid: "app.etzhayyim.govEth.syncWetUpdates",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-shinka-v1",
    nsid: "app.etzhayyim.govEth.shinka",
    bpmnProcessId: "gov_eth_shinka",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/shinka.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-heartbeatTick-v1",
    nsid: "app.etzhayyim.govEth.heartbeatTick",
    bpmnProcessId: "gov_eth_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-seed-orgs-v1",
    nsid: "app.etzhayyim.govEth.seedOrgs",
    bpmnProcessId: "gov_eth_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-register-dids-v1",
    nsid: "app.etzhayyim.govEth.registerDIDs",
    bpmnProcessId: "gov_eth_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-follow-site-deps-v1",
    nsid: "app.etzhayyim.govEth.followSiteDeps",
    bpmnProcessId: "gov_eth_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-resolve-org-path-v1",
    nsid: "app.etzhayyim.govEth.resolveOrgPath",
    bpmnProcessId: "gov_eth_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-list-orgs-v1",
    nsid: "app.etzhayyim.govEth.listOrgs",
    bpmnProcessId: "gov_eth_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-sync-wet-updates-v1",
    nsid: "app.etzhayyim.govEth.syncWetUpdates",
    bpmnProcessId: "gov_eth_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/gov-eth-heartbeat-tick-v1",
    nsid: "app.etzhayyim.govEth.heartbeatTick",
    bpmnProcessId: "gov_eth_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govEth/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
