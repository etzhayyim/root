 ...
 * `http://dispatcher.etzhayyim.com:8080/xrpc/app.etzhayyim.apps.shosha.*`.
 *
 ...
 *  shosha_submit_trade                app.etzhayyim.apps.shosha.submitTrade
 *  shosha_propose_hedge               app.etzhayyim.apps.shosha.proposeHedge
 *  shosha_comply_check                app.etzhayyim.apps.shosha.complyCheck
 *  shosha_agent_loop                  app.etzhayyim.apps.shosha.agentLoop
 */
...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-market-intelligence-ingest-v1",
  ...
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-trade-book-recompute-v1",
    bpmnProcessId: "shosha_trade_book_recompute",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/tradeBookRecompute.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-trade-idea-synthesize-v1",
    bpmnProcessId: "shosha_trade_idea_synthesize",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/tradeIdeaSynthesize.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-daily-report-v1",
    bpmnProcessId: "shosha_daily_report",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/dailyShoshaReport.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-submit-trade-v1",
    bpmnProcessId: "shosha_submit_trade",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/submitTrade.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-propose-hedge-v1",
    bpmnProcessId: "shosha_propose_hedge",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/proposeHedge.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-comply-check-v1",
    bpmnProcessId: "shosha_comply_check",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/complyCheck.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/shosha-agent-loop-v1",
    bpmnProcessId: "shosha_agent_loop",
    sourcePath: "00-contracts/bpmn/ai/gftd/shosha/agentLoop.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/shosha-submitTrade-v1",
    nsid: "app.etzhayyim.apps.shosha.submitTrade",
    bpmnProcessId: "shosha_submit_trade", ownerDid, resultTimeoutMs: 60_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/shosha-proposeHedge-v1",
    nsid: "app.etzhayyim.apps.shosha.proposeHedge",
    bpmnProcessId: "shosha_propose_hedge", ownerDid, resultTimeoutMs: 30_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/shosha-complyCheck-v1",
    nsid: "app.etzhayyim.apps.shosha.complyCheck",
    bpmnProcessId: "shosha_comply_check", ownerDid, resultTimeoutMs: 30_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/shosha-agentLoop-v1",
