 ...
 *  shosha_submit_trade                ai.gftd.apps.shosha.submitTrade
 *  shosha_propose_hedge               ai.gftd.apps.shosha.proposeHedge
 *  shosha_comply_check                ai.gftd.apps.shosha.complyCheck
 *  shosha_agent_loop                  ai.gftd.apps.shosha.agentLoop
 */
