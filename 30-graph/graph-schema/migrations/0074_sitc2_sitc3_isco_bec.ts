 ...
 * |------------------------------------------|------|-------------------------------|
 * | com.etzhayyim.apps.sitc.commodity_rev3         | 5,690 | UN Comtrade S3.json (SITC R.3)|
 * | com.etzhayyim.apps.sitc.commodity_rev2         | 3,723 | UN Comtrade S2.json (SITC R.2)|
 * | com.etzhayyim.apps.isco.occupation             |   393 | ILO ISCO-08 (2012 edition)    |
 * | com.etzhayyim.apps.bec.category                |    31 | UN BEC Rev.5 (2016)           |
 *
 ...
 * ## New views
 *
 * - view_sitc3_commodity: projection of com.etzhayyim.apps.sitc.commodity_rev3
 * - view_sitc2_commodity: projection of com.etzhayyim.apps.sitc.commodity_rev2
 * - view_isco_occupation: projection of com.etzhayyim.apps.isco.occupation
 * - view_bec_category: projection of com.etzhayyim.apps.bec.category
 *
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.sitc.commodity_rev3'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.sitc.commodity_rev2'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.isco.occupation'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.bec.category'`.execute(db);
