...
const timerProcesses: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-observeActor-v1",
    bpmnProcessId: "open_ossekai_observe_actor",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/observeActor.bpmn",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-matchArbitrage-v1",
    bpmnProcessId: "open_ossekai_match_arbitrage",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/matchArbitrage.bpmn",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-trackKyuDanProgress-v1",
    bpmnProcessId: "open_ossekai_track_kyu_dan_progress",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/trackKyuDanProgress.bpmn",
  },
];
...
const xrpcProcesses: XrpcSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-generateIntelBrief-v1",
    bpmnProcessId: "open_ossekai_generate_intel_brief",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/generateIntelBrief.bpmn",
    nsid: "app.etzhayyim.apps.openOssekai.generateIntelBrief",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-proposeArbitrageBrief-v1",
    bpmnProcessId: "open_ossekai_propose_arbitrage_brief",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/proposeArbitrageBrief.bpmn",
    nsid: "app.etzhayyim.apps.openOssekai.proposeArbitrageBrief",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-requestOssekaiConsent-v1",
    bpmnProcessId: "open_ossekai_request_ossekai_consent",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/requestOssekaiConsent.bpmn",
    nsid: "app.etzhayyim.apps.openOssekai.requestOssekaiConsent",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-scoreJocho-v1",
    bpmnProcessId: "open_ossekai_score_jocho",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/scoreJocho.bpmn",
    nsid: "app.etzhayyim.apps.openOssekai.scoreJocho",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ossekai-generateWellBecomingPlan-v1",
    bpmnProcessId: "open_ossekai_generate_wellbecoming_plan",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ossekai/generateWellBecomingPlan.bpmn",
...
async function insertBinding(db: Kysely<unknown>, s: XrpcSeed): Promise<void> {
  const bindingVertexId = `at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/${s.nsid.replace(/\./g, "-")}-v1`;
  await sql`
