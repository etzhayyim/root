...
const createdAt = "2026-04-29T11:01:00Z";
const ownerDid = "did:web:isin.etzhayyim.com";
const actorTag = "sys.bpmn.seed.isin";
const project = "isin";

const seeds: Seed[] = [
  {
    proc: "collect",
    bpmnProcessId: "isin_collect",
    nsid: "com.etzhayyim.apps.isin.isinCollect",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/isin/isinCollect.bpmn",
