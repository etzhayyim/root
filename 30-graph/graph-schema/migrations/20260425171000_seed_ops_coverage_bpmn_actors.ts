...
const entries: Entry[] = [
  {
    ...
    nsid: "app.etzhayyim.apps.openLogisticsLastmile.dispatchLeg",
  ...
  },
  {
    ...
    nsid: "app.etzhayyim.apps.openLogisticsLastmile.confirmDelivery",
    ownerDid: "did:web:open-logistics-lastmile.etzhayyim.com",
    timeoutMs: 30000,
  },
  {
    ...
    nsid: "app.etzhayyim.apps.openMachineryMaintenance.recordMaintenancePlan",
  ...
  },
  {
    ...
    nsid: "app.etzhayyim.apps.openMachineryMaintenance.flagDowntime",
    ownerDid: "did:web:open-machinery-maintenance.etzhayyim.com",
    timeoutMs: 30000,
  },
  {
    ...
    nsid: "app.etzhayyim.apps.industrialSafety.recordSafetyAssessment",
  ...
  },
  {
    ...
    nsid: "app.etzhayyim.apps.industrialSafety.flagMajorAccident",
    ownerDid: "did:web:open-industrial-safety.etzhayyim.com",
    timeoutMs: 30000,
  },
];
...
const processSeeds: ProcessSeed[] = entries.map((entry) => ({
  vertexId: `at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/${entry.project}-${procSlug(entry.proc)}-v1`,
...
const bindingSeeds: BindingSeed[] = entries.map((entry) => ({
  vertexId: `at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/${entry.project}-${entry.proc}-v1`,
  nsid: entry.nsid,
  bpmnProcessId: entry.bpmnProcessId,
  ownerDid: entry.ownerDid,
