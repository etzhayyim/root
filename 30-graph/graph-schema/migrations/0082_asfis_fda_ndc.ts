 ...
 * |-------------------------------|---------|---------------------------------------------|
 * | com.etzhayyim.apps.asfis.species    | 13,761  | FAO ASFIS 2025 (fish species + ISSCAAP groups) |
 * | com.etzhayyim.apps.fda.ndc          | 131,664 | FDA NDC bulk download 2025 (drug products)  |
 *
 ...
 * ## New views
 *
 * - view_asfis_species: projection of com.etzhayyim.apps.asfis.species
 * - view_fda_ndc: projection of com.etzhayyim.apps.fda.ndc
 *
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.asfis.species'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.fda.ndc'`.execute(db);
