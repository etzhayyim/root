...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    VALUES
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.assignment/chikada-lawfirm-2026',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.assignment/tanaka-lawfirm-2026',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.assignment/nishino-lawfirm-2026',
        'did:web:y-nishino.etzhayyim.com', 'eng-infra', 'lawfirm-india-program',
        25, '2026-05-08', 'active', now()::varchar, 'did:web:etzhayyim.etzhayyim.com'
      ),
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.assignment/kbakshi-lawfirm-2026',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.assignment/anakamura-lawfirm-2026',
  ...
  await sql`
    ...
    VALUES
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/tanaka-bpmn-review',
        'app.etzhayyim.apps.lawfirm.engagementClose',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/tanaka-stripe-review',
        'app.etzhayyim.apps.lawfirm.stripeWebhook',
        'did:web:f-tanaka.etzhayyim.com', 'R',
        'Stripe webhook signature verify + idempotency review; PCI scope none (Stripe hosted)',
        '2026-05-08', now()::varchar, 'did:web:etzhayyim.etzhayyim.com'
      ),
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/tanaka-esign-review',
        'app.etzhayyim.apps.lawfirm.eSignRequest',
        'did:web:f-tanaka.etzhayyim.com', 'R',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/nishino-mv-revenue',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/nishino-consent-ui',
        'app.etzhayyim.apps.lawfirm.dpdpConsent',
        'did:web:y-nishino.etzhayyim.com', 'R',
        'DPDP Act 2023 consent UI infra; cascade-purge wiring',
        '2026-05-08', now()::varchar, 'did:web:etzhayyim.etzhayyim.com'
      ),
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/nishino-tenant-scope',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/chikada-demo-tenant',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/chikada-msgraph-webhook',
        'app.etzhayyim.apps.lawfirm.mailReplyWebhook',
        'did:web:t-chikada.etzhayyim.com', 'R',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/kbakshi-engagement-close-A',
        'app.etzhayyim.apps.lawfirm.engagementClose',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/kbakshi-pwc-A',
        'app.etzhayyim.apps.lawfirm.pwcClearanceRequest',
        'did:web:k-bakshi.etzhayyim.com', 'A',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/anakamura-pipeline-A',
        'app.etzhayyim.apps.lawfirm.pipelineTransition',
        'did:web:a-nakamura.etzhayyim.com', 'A',
        'Pipeline stage transition authority + weekly KPI reporting',
        '2026-05-08', now()::varchar, 'did:web:etzhayyim.etzhayyim.com'
      ),
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/anakamura-marketing-A',
        'app.etzhayyim.apps.lawfirm.marketingDispatch',
        'did:web:a-nakamura.etzhayyim.com', 'A',
      ...
      (
        'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.etzhayyim.raci/jkawasaki-pwc-final-A',
        'app.etzhayyim.apps.lawfirm.pwcClearanceRequest',
