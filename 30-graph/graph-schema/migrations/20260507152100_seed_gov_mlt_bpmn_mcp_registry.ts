...
const ownerDid = "did:web:mlt-state.gftd.ai";
const actorHost = "mlt-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-seed-orgs-v1",
    nsid: "ai.gftd.govMlt.seedOrgs",
    bpmnProcessId: "gov_mlt_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-register-dids-v1",
    nsid: "ai.gftd.govMlt.registerDIDs",
    bpmnProcessId: "gov_mlt_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-follow-site-deps-v1",
    nsid: "ai.gftd.govMlt.followSiteDeps",
    bpmnProcessId: "gov_mlt_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-resolve-org-path-v1",
    nsid: "ai.gftd.govMlt.resolveOrgPath",
    bpmnProcessId: "gov_mlt_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-list-orgs-v1",
    nsid: "ai.gftd.govMlt.listOrgs",
    bpmnProcessId: "gov_mlt_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-sync-wet-updates-v1",
    nsid: "ai.gftd.govMlt.syncWetUpdates",
    bpmnProcessId: "gov_mlt_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mlt-heartbeat-tick-v1",
    nsid: "ai.gftd.govMlt.heartbeatTick",
    bpmnProcessId: "gov_mlt_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMlt/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
