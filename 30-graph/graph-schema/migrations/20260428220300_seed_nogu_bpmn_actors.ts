...
// nogu BPMN-as-actor seed (ADR-0056)
// 3 processes: dailyPulse / scheduleInspection / recordLease
...
const createdAt = "2026-04-28T22:03:00Z";
const ownerDid = "did:web:nogu.etzhayyim.com";
const actorTag = "sys.bpmn.seed.nogu";
const project = "nogu";
...
const seeds: Seed[] = [
  {
    ...
    nsid: "ai.gftd.apps.nogu.dailyPulse",
    resultTimeoutMs: 30000,
  },
  {
    proc: "scheduleInspection",
    bpmnProcessId: "nogu_schedule_inspection",
    nsid: "ai.gftd.apps.nogu.scheduleInspection",
    resultTimeoutMs: 30000,
  },
  {
    proc: "recordLease",
    bpmnProcessId: "nogu_record_lease",
    nsid: "ai.gftd.apps.nogu.recordLease",
    resultTimeoutMs: 30000,
  },
];
