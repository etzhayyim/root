 ...
 * |-----------------------------------|---------|----------------------------------------------|
 * | com.etzhayyim.apps.locode.location      | 116,067 | UNECE UN/LOCODE 2024-1 (via GitHub/datasets) |
 * | com.etzhayyim.apps.iso3166.country      |     296 | World Bank API (ISO 3166-1 alpha-3)          |
 *
 ...
 * ## New views
 *
 * - view_locode_location: projection of com.etzhayyim.apps.locode.location
 * - view_iso3166_country: projection of com.etzhayyim.apps.iso3166.country
 *
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.locode.location'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.iso3166.country'`.execute(db);
