...
const createdAt = "2026-04-29T09:02:00Z";
const ownerDid = "did:web:media-gamers.etzhayyim.com";
const actorTag = "sys.bpmn.seed.media-gamers";
// bpmn-coverage gate marker: project: "media-gamers"
const project = "media-gamers";

const seeds: Seed[] = [
  {
    proc: "guideGenerate",
    bpmnProcessId: "media_gamers_guide_generate",
    nsid: "ai.gftd.apps.media_gamers.guide.guideGenerate",
  ...
  },
  {
    ...
    nsid: "ai.gftd.apps.media_gamers.knowledge.knowledgeGuideGenerate",
  ...
  },
  {
    ...
    nsid: "ai.gftd.apps.media_gamers.evalModelsProcess",
