...
const ownerDid = "did:web:fin-state.gftd.ai";
const actorHost = "fin-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-seed-orgs-v1",
    nsid: "ai.gftd.govFin.seedOrgs",
    bpmnProcessId: "gov_fin_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-register-dids-v1",
    nsid: "ai.gftd.govFin.registerDIDs",
    bpmnProcessId: "gov_fin_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-follow-site-deps-v1",
    nsid: "ai.gftd.govFin.followSiteDeps",
    bpmnProcessId: "gov_fin_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-resolve-org-path-v1",
    nsid: "ai.gftd.govFin.resolveOrgPath",
    bpmnProcessId: "gov_fin_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-list-orgs-v1",
    nsid: "ai.gftd.govFin.listOrgs",
    bpmnProcessId: "gov_fin_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-sync-wet-updates-v1",
    nsid: "ai.gftd.govFin.syncWetUpdates",
    bpmnProcessId: "gov_fin_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-fin-heartbeat-tick-v1",
    nsid: "ai.gftd.govFin.heartbeatTick",
    bpmnProcessId: "gov_fin_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govFin/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
