...
const ownerDid = "did:web:irn-state.gftd.ai";
const actorHost = "irn-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-seed-orgs-v1",
    nsid: "ai.gftd.govIrn.seedOrgs",
    bpmnProcessId: "gov_irn_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-register-dids-v1",
    nsid: "ai.gftd.govIrn.registerDIDs",
    bpmnProcessId: "gov_irn_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-follow-site-deps-v1",
    nsid: "ai.gftd.govIrn.followSiteDeps",
    bpmnProcessId: "gov_irn_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-resolve-org-path-v1",
    nsid: "ai.gftd.govIrn.resolveOrgPath",
    bpmnProcessId: "gov_irn_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-list-orgs-v1",
    nsid: "ai.gftd.govIrn.listOrgs",
    bpmnProcessId: "gov_irn_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-sync-wet-updates-v1",
    nsid: "ai.gftd.govIrn.syncWetUpdates",
    bpmnProcessId: "gov_irn_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-irn-heartbeat-tick-v1",
    nsid: "ai.gftd.govIrn.heartbeatTick",
    bpmnProcessId: "gov_irn_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govIrn/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
