...
/**
 * Rebuild mv_world_vertex_per_host adding vertex_fund (public-fund / securities split by fund_kind)
 * and vertex_rare_earth_coverage (mine) branches.
 * Tables created in migration 20260501100000_vertex_fund_rare_earth.ts.
 * Also recreates mv_world_coverage_live and view_world_coverage_live views which were
 * dropped during the MV rebuild (applied out-of-band 2026-05-01).
 */
