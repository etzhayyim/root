...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/jpn-jpo-file-application-v1",
    bpmnProcessId: "jpn_jpo_file_application",
    sourcePath: "00-contracts/bpmn/ai/gftd/jpn-jpo/fileApplication.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/jpn-jpo-record-examination-v1",
    bpmnProcessId: "jpn_jpo_record_examination",
    sourcePath: "00-contracts/bpmn/ai/gftd/jpn-jpo/recordExamination.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/jpn-jpo-fileApplication-v1",
    nsid: "app.etzhayyim.apps.jpnJpo.fileApplication", bpmnProcessId: "jpn_jpo_file_application",
    ownerDid, resultTimeoutMs: 15000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/jpn-jpo-recordExamination-v1",
    nsid: "app.etzhayyim.apps.jpnJpo.recordExamination", bpmnProcessId: "jpn_jpo_record_examination",
    ownerDid, resultTimeoutMs: 15000 },
];
