 ...
 * ``bpmn-dispatcher`` routes ``com.etzhayyim.apps.manimani.*`` to the
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  const rows: Array<{ nsid: string; processId: string; timeoutMs: number }> = [
    { nsid: "com.etzhayyim.apps.manimani.ingest",        processId: "manimani_ingest",         timeoutMs: 30_000 },
    { nsid: "com.etzhayyim.apps.manimani.classify",      processId: "manimani_classify",       timeoutMs: 10_000 },
    { nsid: "com.etzhayyim.apps.manimani.process",       processId: "manimani_process",        timeoutMs: 30_000 },
    { nsid: "com.etzhayyim.apps.manimani.getProject",    processId: "manimani_get_project",    timeoutMs: 5_000 },
    { nsid: "com.etzhayyim.apps.manimani.listProjects",  processId: "manimani_list_projects",  timeoutMs: 5_000 },
    { nsid: "com.etzhayyim.apps.manimani.coverage",      processId: "manimani_coverage",       timeoutMs: 5_000 },
  ];
  for (const r of rows) {
...
export async function down(db: Kysely<unknown>): Promise<void> {
  await sql`
    ...
    WHERE nsid IN (
      'com.etzhayyim.apps.manimani.ingest',
      'com.etzhayyim.apps.manimani.classify',
      'com.etzhayyim.apps.manimani.process',
      'com.etzhayyim.apps.manimani.getProject',
      'com.etzhayyim.apps.manimani.listProjects',
      'com.etzhayyim.apps.manimani.coverage'
    )
  `.execute(db);
}
