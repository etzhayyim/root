...
const processSeeds: ProcessSeed[] = [
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/oshinobi-unsubscribe-v1",
    bpmnProcessId: "oshinobi_unsubscribe",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/oshinobi/unsubscribe.bpmn",
    ownerDid,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/oshinobi-publish-post-v1",
    bpmnProcessId: "oshinobi_publish_post",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/oshinobi/publishPost.bpmn",
    ownerDid,
  },
  {
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/oshinobi-report-content-v1",
    bpmnProcessId: "oshinobi_report_content",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/oshinobi/reportContent.bpmn",
    ownerDid,
  },
];
...
const bindingSeeds: BindingSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/oshinobi-subscribe-v1",
    nsid: "com.etzhayyim.apps.oshinobi.subscribe",
    bpmnProcessId: "oshinobi_subscribe",
    ownerDid,
    resultTimeoutMs: 15000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/oshinobi-cancelSubscription-v1",
    nsid: "com.etzhayyim.apps.oshinobi.cancelSubscription",
    bpmnProcessId: "oshinobi_unsubscribe",
    ownerDid,
    resultTimeoutMs: 5000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/oshinobi-publishPost-v1",
    nsid: "com.etzhayyim.apps.oshinobi.publishPost",
    bpmnProcessId: "oshinobi_publish_post",
    ownerDid,
    resultTimeoutMs: 10000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/oshinobi-tipCreator-v1",
    nsid: "com.etzhayyim.apps.oshinobi.tipCreator",
    bpmnProcessId: "oshinobi_tip_creator",
    ownerDid,
    resultTimeoutMs: 15000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/oshinobi-reportContent-v1",
    nsid: "com.etzhayyim.apps.oshinobi.reportContent",
    bpmnProcessId: "oshinobi_report_content",
    ownerDid,
    resultTimeoutMs: 15000,
  },
