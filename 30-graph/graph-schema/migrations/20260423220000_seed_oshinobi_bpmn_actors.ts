...
const processSeeds: ProcessSeed[] = [
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/oshinobi-unsubscribe-v1",
    bpmnProcessId: "oshinobi_unsubscribe",
    sourcePath: "00-contracts/bpmn/ai/gftd/oshinobi/unsubscribe.bpmn",
    ownerDid,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/oshinobi-publish-post-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/oshinobi-report-content-v1",
...
const bindingSeeds: BindingSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/oshinobi-subscribe-v1",
    nsid: "app.etzhayyim.apps.oshinobi.subscribe",
    bpmnProcessId: "oshinobi_subscribe",
    ownerDid,
    resultTimeoutMs: 15000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/oshinobi-cancelSubscription-v1",
    nsid: "app.etzhayyim.apps.oshinobi.cancelSubscription",
    bpmnProcessId: "oshinobi_unsubscribe",
    ownerDid,
    resultTimeoutMs: 5000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/oshinobi-publishPost-v1",
    nsid: "app.etzhayyim.apps.oshinobi.publishPost",
    bpmnProcessId: "oshinobi_publish_post",
    ownerDid,
    resultTimeoutMs: 10000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/oshinobi-tipCreator-v1",
    nsid: "app.etzhayyim.apps.oshinobi.tipCreator",
    bpmnProcessId: "oshinobi_tip_creator",
    ownerDid,
    resultTimeoutMs: 15000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/oshinobi-reportContent-v1",
    nsid: "app.etzhayyim.apps.oshinobi.reportContent",
    bpmnProcessId: "oshinobi_report_content",
    ownerDid,
    resultTimeoutMs: 15000,
  },
