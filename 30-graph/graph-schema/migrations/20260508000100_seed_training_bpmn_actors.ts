 ...
 * `http://dispatcher.etzhayyim.com:8080/xrpc/com.etzhayyim.apps.training.*`.
 *
...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/training-run-sft-v1",
    bpmnProcessId: "training_run_sft",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/training/runSft.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/training-run-lora-v1",
    bpmnProcessId: "training_run_lora",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/training/runLora.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/training-run-distill-v1",
    bpmnProcessId: "training_run_distill",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/training/runDistill.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/training-run-eval-v1",
    bpmnProcessId: "training_run_eval",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/training/runEval.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/training-promote-v1",
    bpmnProcessId: "training_promote",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/training/promote.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/training-runSft-v1",
    nsid: "com.etzhayyim.apps.training.runSft",
    bpmnProcessId: "training_run_sft", ownerDid, resultTimeoutMs: 1_800_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/training-runLora-v1",
    nsid: "com.etzhayyim.apps.training.runLora",
    bpmnProcessId: "training_run_lora", ownerDid, resultTimeoutMs: 1_800_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/training-runDistill-v1",
    nsid: "com.etzhayyim.apps.training.runDistill",
    bpmnProcessId: "training_run_distill", ownerDid, resultTimeoutMs: 3_600_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/training-runEval-v1",
    nsid: "com.etzhayyim.apps.training.runEval",
    bpmnProcessId: "training_run_eval", ownerDid, resultTimeoutMs: 600_000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/training-promote-v1",
    nsid: "com.etzhayyim.apps.training.promote",
