...
const createdAt = "2026-04-28T14:01:00Z";
const ownerDid = "did:web:telecom.etzhayyim.com";
const actorTag = "sys.bpmn.seed.telecom-wlan";
...
const seeds: Seed[] = [
  { proc: "registerWlanRcoi", bpmnProcessId: "telecom_register_wlan_rcoi",
    nsid: "ai.gftd.apps.telecom.registerWlanRcoi", resultTimeoutMs: 30000 },
  { proc: "registerHotspotVenue", bpmnProcessId: "telecom_register_hotspot_venue",
    nsid: "ai.gftd.apps.telecom.registerHotspotVenue", resultTimeoutMs: 30000 },
  { proc: "provisionPasspointPpsMo", bpmnProcessId: "telecom_provision_passpoint_pps_mo",
    nsid: "ai.gftd.apps.telecom.provisionPasspointPpsMo", resultTimeoutMs: 30000 },
  { proc: "recordAnqpQuery", bpmnProcessId: "telecom_record_anqp_query",
    nsid: "ai.gftd.apps.telecom.recordAnqpQuery", resultTimeoutMs: 15000 },
  { proc: "attachWlanSession", bpmnProcessId: "telecom_attach_wlan_session",
    nsid: "ai.gftd.apps.telecom.attachWlanSession", resultTimeoutMs: 15000 },
  { proc: "recordWlanRoamingExchange", bpmnProcessId: "telecom_record_wlan_roaming_exchange",
    nsid: "ai.gftd.apps.telecom.recordWlanRoamingExchange", resultTimeoutMs: 15000 },
  { proc: "bridgeAndspToCellular", bpmnProcessId: "telecom_bridge_andsp_to_cellular",
    nsid: "ai.gftd.apps.telecom.bridgeAndspToCellular", resultTimeoutMs: 15000 },
  { proc: "settleWlanRoamingInvoice", bpmnProcessId: "telecom_settle_wlan_roaming_invoice",
    nsid: "ai.gftd.apps.telecom.settleWlanRoamingInvoice", resultTimeoutMs: 60000 },
];
