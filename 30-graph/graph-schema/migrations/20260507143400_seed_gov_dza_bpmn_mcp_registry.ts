...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-seedOrgs-v1",
    nsid: "ai.gftd.govDza.seedOrgs",
    bpmnProcessId: "gov_dza_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-registerDIDs-v1",
    nsid: "ai.gftd.govDza.registerDIDs",
    bpmnProcessId: "gov_dza_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-followSiteDeps-v1",
    nsid: "ai.gftd.govDza.followSiteDeps",
    bpmnProcessId: "gov_dza_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-resolveOrgPath-v1",
    nsid: "ai.gftd.govDza.resolveOrgPath",
    bpmnProcessId: "gov_dza_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-listOrgs-v1",
    nsid: "ai.gftd.govDza.listOrgs",
    bpmnProcessId: "gov_dza_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-syncWetUpdates-v1",
    nsid: "ai.gftd.govDza.syncWetUpdates",
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-shinka-v1",
    nsid: "ai.gftd.govDza.shinka",
    bpmnProcessId: "gov_dza_shinka",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/shinka.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-heartbeatTick-v1",
    nsid: "ai.gftd.govDza.heartbeatTick",
    bpmnProcessId: "gov_dza_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-seed-orgs-v1",
    nsid: "ai.gftd.govDza.seedOrgs",
    bpmnProcessId: "gov_dza_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-register-dids-v1",
    nsid: "ai.gftd.govDza.registerDIDs",
    bpmnProcessId: "gov_dza_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-follow-site-deps-v1",
    nsid: "ai.gftd.govDza.followSiteDeps",
    bpmnProcessId: "gov_dza_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-resolve-org-path-v1",
    nsid: "ai.gftd.govDza.resolveOrgPath",
    bpmnProcessId: "gov_dza_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-list-orgs-v1",
    nsid: "ai.gftd.govDza.listOrgs",
    bpmnProcessId: "gov_dza_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-sync-wet-updates-v1",
    nsid: "ai.gftd.govDza.syncWetUpdates",
    bpmnProcessId: "gov_dza_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/gov-dza-heartbeat-tick-v1",
    nsid: "ai.gftd.govDza.heartbeatTick",
    bpmnProcessId: "gov_dza_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govDza/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
