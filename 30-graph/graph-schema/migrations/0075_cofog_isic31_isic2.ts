 ...
 * |-----------------------------------------------------|------|-------------------------------------------|
 * | com.etzhayyim.apps.cofog.function                         |  188 | UN COFOG (Classification of GFCE, 1999)   |
 * | com.etzhayyim.apps.open_isic.economic_activity_rev31      |  538 | UNSD ISIC Rev.3.1 (2002 revision)         |
 * | com.etzhayyim.apps.open_isic.economic_activity_rev2       |  277 | UNSD ISIC Rev.2 (1968, incl. 2 synthetic) |
 *
 ...
 * ## New views
 *
 * - view_cofog_function: projection of com.etzhayyim.apps.cofog.function
 * - view_isic31_activity: projection of com.etzhayyim.apps.open_isic.economic_activity_rev31
 * - view_isic2_activity: projection of com.etzhayyim.apps.open_isic.economic_activity_rev2
 *
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.cofog.function'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.open_isic.economic_activity_rev31'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.open_isic.economic_activity_rev2'`.execute(db);
