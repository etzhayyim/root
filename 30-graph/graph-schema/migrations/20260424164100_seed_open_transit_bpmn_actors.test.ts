...
const bpmn1 = readFileSync(
  resolve(__dirname, "../../../00-contracts/bpmn/ai/gftd/open-transit/defineRoute.bpmn"),
  "utf-8",
);
const bpmn2 = readFileSync(
  resolve(__dirname, "../../../00-contracts/bpmn/ai/gftd/open-transit/reportDelay.bpmn"),
  "utf-8",
);
...
describe("Seed open-transit BPMN actors migration", () => {
  it("seeds both process definitions", () => {
    ...
    expect(migrationSource).toContain('sourcePath: "00-contracts/bpmn/ai/gftd/open-transit/defineRoute.bpmn"');
