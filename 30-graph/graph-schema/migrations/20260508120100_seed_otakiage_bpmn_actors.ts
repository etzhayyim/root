 ...
 *
 *  XRPC binding NSIDs:
 *    ai.gftd.apps.otakiage.submitItem        → otakiage_submit_item (この migration では process_def 不要、handler 直接実装)
 *    ai.gftd.apps.otakiage.requestReuse      → otakiage_request_reuse
 *    ai.gftd.apps.otakiage.confirmHandover   → otakiage_confirm_handover
 *    ai.gftd.apps.otakiage.requestRitual     → otakiage_request_ritual
 *    ai.gftd.apps.otakiage.scheduleMatsuri   → otakiage_schedule_matsuri
 *    ai.gftd.apps.otakiage.issueCertificate  → otakiage_issue_certificate
 *
