...
const ownerDid = "did:web:kwt-state.gftd.ai";
const actorHost = "kwt-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-seed-orgs-v1",
    nsid: "ai.gftd.govKwt.seedOrgs",
    bpmnProcessId: "gov_kwt_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-register-dids-v1",
    nsid: "ai.gftd.govKwt.registerDIDs",
    bpmnProcessId: "gov_kwt_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-follow-site-deps-v1",
    nsid: "ai.gftd.govKwt.followSiteDeps",
    bpmnProcessId: "gov_kwt_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-resolve-org-path-v1",
    nsid: "ai.gftd.govKwt.resolveOrgPath",
    bpmnProcessId: "gov_kwt_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-list-orgs-v1",
    nsid: "ai.gftd.govKwt.listOrgs",
    bpmnProcessId: "gov_kwt_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-sync-wet-updates-v1",
    nsid: "ai.gftd.govKwt.syncWetUpdates",
    bpmnProcessId: "gov_kwt_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-kwt-heartbeat-tick-v1",
    nsid: "ai.gftd.govKwt.heartbeatTick",
    bpmnProcessId: "gov_kwt_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govKwt/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
