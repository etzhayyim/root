 ...
 * |-------------------------------------|------|-------------------------------------|
 * | com.etzhayyim.apps.hs.commodity2007       | 6,373 | UN Comtrade H3.json (HS 2007)      |
 * | com.etzhayyim.apps.hs.commodity2002       | 6,569 | UN Comtrade H2.json (HS 2002)      |
 * | com.etzhayyim.apps.hs.commodity1996       | 6,474 | UN Comtrade H1.json (HS 1996)      |
 * | com.etzhayyim.apps.sitc.commodity_rev1    | 2,784 | UN Comtrade S1.json (SITC Rev.1)   |
 *
 ...
 * ## New views
 *
 * - view_hs2007_commodity: projection of com.etzhayyim.apps.hs.commodity2007
 * - view_hs2002_commodity: projection of com.etzhayyim.apps.hs.commodity2002
 * - view_hs1996_commodity: projection of com.etzhayyim.apps.hs.commodity1996
 * - view_sitc1_commodity: projection of com.etzhayyim.apps.sitc.commodity_rev1
 *
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.hs.commodity2007'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.hs.commodity2002'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.hs.commodity1996'`.execute(db);
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.sitc.commodity_rev1'`.execute(db);
