...
const createdAt = "2026-04-24T12:10:00Z";
const ownerDid = "did:web:open-water.etzhayyim.com:network";
const actorTag = "sys.bpmn.seed.open-water";

const processSeeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-water-define-main-v1",
    bpmnProcessId: "open_water_define_main",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-water/defineMain.bpmn",
    ownerDid,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-water-report-leak-v1",
    bpmnProcessId: "open_water_report_leak",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-water/reportLeak.bpmn",
    ownerDid,
  },
];
...
const bindingSeeds: BindingSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-water-defineMain-v1",
    nsid: "com.etzhayyim.apps.openWater.defineMain",
    bpmnProcessId: "open_water_define_main",
    ownerDid,
    resultTimeoutMs: 15000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-water-reportLeak-v1",
    nsid: "com.etzhayyim.apps.openWater.reportLeak",
    bpmnProcessId: "open_water_report_leak",
    ownerDid,
