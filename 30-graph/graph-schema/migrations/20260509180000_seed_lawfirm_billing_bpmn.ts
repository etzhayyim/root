...
const PROCESSES = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-subscription-start-v1",
    bpmnProcessId: "lawfirm_subscription_start",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/lawfirm/subscriptionStart.bpmn",
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-connect-onboard-v1",
    bpmnProcessId: "lawfirm_connect_onboard",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/lawfirm/connectOnboard.bpmn",
  },
];

const BINDINGS = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-subscription-start-xrpc-v1",
    nsid: "com.etzhayyim.apps.lawfirm.subscriptionStart",
    bpmnProcessId: "lawfirm_subscription_start",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-connect-onboard-xrpc-v1",
    nsid: "com.etzhayyim.apps.lawfirm.connectOnboard",
    bpmnProcessId: "lawfirm_connect_onboard",
    resultTimeoutMs: 60_000,
  },
];
 ...
 *
 *   com.etzhayyim.apps.lawfirm.subscriptionStart  (lexicon)
 ...
 *
 *   com.etzhayyim.apps.lawfirm.connectOnboard     (lexicon)
 *     → ... lawfirm.billing.modeBOnboardConnect
 *       → vertex_lawfirm_tenant.{stripe_connect_account_id, billing_mode='rev_share_y1'}
 *
 * The existing com.etzhayyim.apps.lawfirm.stripeWebhook lexicon + paymentIntake
