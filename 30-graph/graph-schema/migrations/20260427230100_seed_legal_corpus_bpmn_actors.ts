...
const seeds: Seed[] = [
  { proc: "ingestDocument",          bpmnProcessId: "legal_corpus_ingest_document",
    nsid: "ai.gftd.apps.legal-corpus.ingestDocument", resultTimeoutMs: 30000 },
  { proc: "embedDocument",           bpmnProcessId: "legal_corpus_embed_document",
    nsid: "ai.gftd.apps.legal-corpus.embedDocument", resultTimeoutMs: 60000 },
  { proc: "registerSource",          bpmnProcessId: "legal_corpus_register_source",
    nsid: "ai.gftd.apps.legal-corpus.registerSource", resultTimeoutMs: 15000 },
  { proc: "fetchCourtListenerDelta", bpmnProcessId: "legal_corpus_fetch_courtlistener_delta",
    nsid: "ai.gftd.apps.legal-corpus.fetchCourtListenerDelta", resultTimeoutMs: 600000 },
  { proc: "fetchEurLexDelta",        bpmnProcessId: "legal_corpus_fetch_eur_lex_delta",
    nsid: "ai.gftd.apps.legal-corpus.fetchEurLexDelta", resultTimeoutMs: 600000 },
  { proc: "fetchBailiiDelta",        bpmnProcessId: "legal_corpus_fetch_bailii_delta",
    nsid: "ai.gftd.apps.legal-corpus.fetchBailiiDelta", resultTimeoutMs: 600000 },
  { proc: "fetchWorldLiiDelta",      bpmnProcessId: "legal_corpus_fetch_worldlii_delta",
    nsid: "ai.gftd.apps.legal-corpus.fetchWorldLiiDelta", resultTimeoutMs: 600000 },
  { proc: "fetchCanLiiDelta",        bpmnProcessId: "legal_corpus_fetch_canlii_delta",
    nsid: "ai.gftd.apps.legal-corpus.fetchCanLiiDelta", resultTimeoutMs: 600000 },
];
