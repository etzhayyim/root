 ...
 * → B2 shard → HF Hub `gftdcojp/gftd-corpus`, ADR Phase D 2026-05-01).
 *
 ...
 *   run         = at://did:web:training.gftd.ai/ai.gftd.training.run/{run_id}
 *   checkpoint  = at://did:web:training.gftd.ai/ai.gftd.training.checkpoint/{run_id}-step-{NNNNNN}
 *   eval        = at://did:web:training.gftd.ai/ai.gftd.training.eval/{checkpoint_id}-{bench_name}
 *   dataset     = at://did:web:training.gftd.ai/ai.gftd.training.datasetSnapshot/{dataset_name}-{content_hash[:12]}
 */
