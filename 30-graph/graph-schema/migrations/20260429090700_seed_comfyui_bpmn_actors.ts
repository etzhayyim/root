...
const createdAt = "2026-04-29T09:07:00Z";
const ownerDid = "did:web:comfyui.etzhayyim.com";
const actorTag = "sys.bpmn.seed.comfyui";
// bpmn-coverage gate marker: project: "comfyui"
const project = "comfyui";

const seeds: Seed[] = [
  {
    proc: "generateImage",
    bpmnProcessId: "comfyui_openai_image_generation",
    nsid: "ai.gftd.apps.comfyui.generateImage",
  ...
  },
  {
    ...
    nsid: "ai.gftd.apps.comfyui.editImage",
