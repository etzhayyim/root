...
const seeds: Seed[] = [
  { proc: "searchDocument",     bpmnProcessId: "legal_corpus_search_document",
    nsid: "com.etzhayyim.apps.legal-corpus.searchDocument",     resultTimeoutMs: 30000 },
  { proc: "getDocument",        bpmnProcessId: "legal_corpus_get_document",
    nsid: "com.etzhayyim.apps.legal-corpus.getDocument",        resultTimeoutMs: 10000 },
  { proc: "listJurisdictions",  bpmnProcessId: "legal_corpus_list_jurisdictions",
    nsid: "com.etzhayyim.apps.legal-corpus.listJurisdictions",  resultTimeoutMs: 10000 },
];
