...
const processVertexId = "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/business-person-collectPublicRoles-v1";
const bindingVertexId = "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/businessPerson-collectPublicRoles-v1";
