 ...
 *
 * XRPC com.etzhayyim.apps.kaisya.memberChat → kaisya_member_chat BPMN →
...
const PROCESS = {
  vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kaisya-member-chat-v1",
  bpmnProcessId: "kaisya_member_chat",
  sourcePath: "00-contracts/bpmn/com/etzhayyim/kaisya/memberChat.bpmn",
};
const BINDING = {
  vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kaisya-member-chat-xrpc-v1",
  nsid: "com.etzhayyim.apps.kaisya.memberChat",
  bpmnProcessId: "kaisya_member_chat",
