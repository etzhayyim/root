...
const ownerDid = "did:web:mkd-state.gftd.ai";
const actorHost = "mkd-state.gftd.ai";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-seedOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-registerDIDs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-followSiteDeps-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-resolveOrgPath-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-listOrgs-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-syncWetUpdates-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-shinka-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-heartbeatTick-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-seed-orgs-v1",
    nsid: "ai.gftd.govMkd.seedOrgs",
    bpmnProcessId: "gov_mkd_seed_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-register-dids-v1",
    nsid: "ai.gftd.govMkd.registerDIDs",
    bpmnProcessId: "gov_mkd_register_dids",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-follow-site-deps-v1",
    nsid: "ai.gftd.govMkd.followSiteDeps",
    bpmnProcessId: "gov_mkd_follow_site_deps",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-resolve-org-path-v1",
    nsid: "ai.gftd.govMkd.resolveOrgPath",
    bpmnProcessId: "gov_mkd_resolve_org_path",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-list-orgs-v1",
    nsid: "ai.gftd.govMkd.listOrgs",
    bpmnProcessId: "gov_mkd_list_orgs",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-sync-wet-updates-v1",
    nsid: "ai.gftd.govMkd.syncWetUpdates",
    bpmnProcessId: "gov_mkd_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-mkd-heartbeat-tick-v1",
    nsid: "ai.gftd.govMkd.heartbeatTick",
    bpmnProcessId: "gov_mkd_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/ai/gftd/govMkd/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
