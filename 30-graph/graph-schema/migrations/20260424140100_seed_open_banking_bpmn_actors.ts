...
const ownerDid = "did:web:open-banking.etzhayyim.com:core";
const actorTag = "sys.bpmn.seed.open-banking";

const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-banking-create-account-v1",
    bpmnProcessId: "open_banking_create_account",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-banking/createAccount.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-banking-transfer-v1",
    bpmnProcessId: "open_banking_transfer",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-banking/transfer.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-banking-createAccount-v1",
    nsid: "com.etzhayyim.apps.openBanking.createAccount", bpmnProcessId: "open_banking_create_account",
    ownerDid, resultTimeoutMs: 15000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-banking-transfer-v1",
    nsid: "com.etzhayyim.apps.openBanking.transfer", bpmnProcessId: "open_banking_transfer",
