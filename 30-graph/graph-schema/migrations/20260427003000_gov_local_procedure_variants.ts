...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    SELECT
      CONCAT('at://', actor_did, '/app.etzhayyim.apps.gov.procedureVariant/', format_key),
  ...
  await sql`
    ...
    SELECT
      CONCAT('at://', actor_did, '/app.etzhayyim.apps.gov.formLanguageVariant/', form_key, '-en'),
  ...
  await sql`
    ...
    SELECT
      CONCAT('at://did:web:gov.etzhayyim.com/app.etzhayyim.apps.gov.localVariationGap/ind-', municipality_code),
