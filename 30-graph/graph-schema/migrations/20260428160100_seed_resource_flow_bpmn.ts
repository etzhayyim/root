...
// Phase 10 — register the resource-flow registerEmitter BPMN actor
// (ADR-0056 + ADR-0028). The Worker can drive Follow registration
// directly via sdk.pds.dispatch, but the BPMN actor gives Operate-side
// visibility so we can review/replay registrations during cluster
// onboarding.
...
const actorTag = "sys.bpmn.seed.resource-flow";
// bpmn-coverage gate marker: project: "resource-flow"
const project = "resource-flow";

const seeds: Seed[] = [
  {
    proc: "registerEmitter",
    bpmnProcessId: "resource_flow_register_emitter",
    nsid: "com.etzhayyim.apps.resourceFlow.registerEmitter",
