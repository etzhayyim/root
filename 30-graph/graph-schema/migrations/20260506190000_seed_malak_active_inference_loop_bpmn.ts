...
const CREATED_AT = "2026-05-06T19:00:00Z";
const OWNER_DID = "did:web:malak.gftd.ai";
const ACTOR_ID = "sys.bpmn.seed.malak-active-inference";
...
const ENTRY = {
  ...
  bpmnProcessId: "malak_run_investigation_tick",
  nsid: "ai.gftd.apps.malak.runInvestigationTick",
  sourcePath: "00-contracts/bpmn/ai/gftd/malak/runInvestigationTick.bpmn",
  writeTableAllowlist: "vertex_malak_investigation_tick",
};
