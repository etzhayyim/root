...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  const seed: Array<[string, string, number, number, number]> = [
    ...
    ["did:web:maps.gftd.ai:wikipedia:de", "Spot",    1_500_000, 0.6, 168.0],
    ["did:web:maps.gftd.ai:wikipedia:fr", "Spot",    1_200_000, 0.6, 168.0],
    ["did:web:maps.gftd.ai:wikipedia:it", "Spot",      700_000, 0.6, 168.0],
    ["did:web:maps.gftd.ai:wikipedia:zh", "Spot",      800_000, 0.6, 168.0],
    ["did:web:maps.gftd.ai:wikipedia:ru", "Spot",      900_000, 0.6, 168.0],
    ["did:web:maps.gftd.ai:wikipedia:ar", "Spot",      300_000, 0.6, 168.0],
    ["did:web:maps.gftd.ai:wikipedia:pt", "Spot",      600_000, 0.6, 168.0],
    // 4 seismic variants
    ["did:web:maps.gftd.ai:seismic:week",      "SpatialEvent", 20_000, 0.3, 1.0],
    ["did:web:maps.gftd.ai:seismic:month",     "SpatialEvent", 100_000, 0.3, 24.0],
    ["did:web:maps.gftd.ai:seismic:sig_month", "SpatialEvent",    100, 0.6, 24.0],
    ["did:web:maps.gftd.ai:seismic:m6",        "SpatialEvent",    500, 0.6, 24.0],
  ];
