...
/**
 * Extend maps_source_dispatch_kind to route `did:web:maps.etzhayyim.com:wikipedia`
 * and `did:web:maps.etzhayyim.com:wikipedia:*` (per-language sub-DIDs) to 'wikipedia'.
...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  const seed: Array<[string, string, number, number, number]> = [
    ["did:web:maps.etzhayyim.com:wikipedia",    "Spot", 7_000_000, 0.6, 168.0],  // en
    ["did:web:maps.etzhayyim.com:wikipedia:ja", "Spot", 1_500_000, 0.6, 168.0],
    ["did:web:maps.etzhayyim.com:wikipedia:es", "Spot", 1_800_000, 0.6, 168.0],
  ];
