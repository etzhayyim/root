...
const createdAt = "2026-05-07T01:00:00Z";
const ownerDid = "did:web:hkg-state.etzhayyim.com";
const actorHost = "hkg-state.etzhayyim.com";
const actorTag = "sys.bpmn.seed.gov-hkg";
...
const seeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-seedOrgs-v1",
    nsid: "com.etzhayyim.govHkg.seedOrgs",
    bpmnProcessId: "gov_hkg_seed_orgs",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/seedOrgs.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-registerDIDs-v1",
    nsid: "com.etzhayyim.govHkg.registerDIDs",
    bpmnProcessId: "gov_hkg_register_dids",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/registerDIDs.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-followSiteDeps-v1",
    nsid: "com.etzhayyim.govHkg.followSiteDeps",
    bpmnProcessId: "gov_hkg_follow_site_deps",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/followSiteDeps.bpmn",
    resultTimeoutMs: 90_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-ingestOfficialSources-v1",
    nsid: "com.etzhayyim.govHkg.ingestOfficialSources",
    bpmnProcessId: "gov_hkg_ingest_official_sources",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/ingestOfficialSources.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-resolveOrgPath-v1",
    nsid: "com.etzhayyim.govHkg.resolveOrgPath",
    bpmnProcessId: "gov_hkg_resolve_org_path",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/resolveOrgPath.bpmn",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-listOrgs-v1",
    nsid: "com.etzhayyim.govHkg.listOrgs",
    bpmnProcessId: "gov_hkg_list_orgs",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/listOrgs.bpmn",
    resultTimeoutMs: 60_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-syncWetUpdates-v1",
    nsid: "com.etzhayyim.govHkg.syncWetUpdates",
    bpmnProcessId: "gov_hkg_sync_wet_updates",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/syncWetUpdates.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-shinka-v1",
    nsid: "com.etzhayyim.govHkg.shinka",
    bpmnProcessId: "gov_hkg_shinka",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/shinka.bpmn",
    resultTimeoutMs: 180_000,
  },
  {
    vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/gov-hkg-heartbeatTick-v1",
    nsid: "com.etzhayyim.govHkg.heartbeatTick",
    bpmnProcessId: "gov_hkg_heartbeat_tick",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/govHkg/heartbeatTick.bpmn",
    resultTimeoutMs: 180_000,
  },
];
