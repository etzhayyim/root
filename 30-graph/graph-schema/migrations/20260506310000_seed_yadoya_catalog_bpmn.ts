...
const createdAt = "2026-05-06T22:00:00Z";
const ownerDid = "did:web:yadoya.gftd.ai";
const actorTag = "sys.bpmn.seed.yadoya-catalog";
...
const seeds: Seed[] = [
  {
    ...
    nsid: "ai.gftd.apps.yadoya.searchHotels",
    resultTimeoutMs: 30000,
  },
  {
    proc: "listHotels",
    bpmnProcessId: "yadoya_list_hotels",
    nsid: "ai.gftd.apps.yadoya.listHotels",
    resultTimeoutMs: 30000,
  },
];
