 ...
 * |----------------------------------|---------|---------------------------------------------------|
 * | com.etzhayyim.apps.icd10.disease       | 90,168  | WHO ICD-10-CM 2019 (via github.com/k4m1113/ICD-10-CSV) |
 *
 ...
 * ## New views
 *
 * - view_icd10_disease: projection of com.etzhayyim.apps.icd10.disease
 *
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.icd10.disease'`.execute(db);
