...
/**
 * vertex_projector_task — dedicated table for com.etzhayyim.projector.addConvoTask
 * / completeConvoTask / listConvoTasks (ADR-0036 Phase 2).
 *
 * Previously the handler wrote an com.etzhayyim.projectorTask AT record that
