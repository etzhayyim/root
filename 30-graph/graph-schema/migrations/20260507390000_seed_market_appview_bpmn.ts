...
const createdAt = "2026-05-07T01:05:00Z";
...
const writeTables: Record<string, string> = {
  observeDemand: "vertex_market_demand_signal",
  publishOffer: "vertex_market_listing",
  settleInvoice: "vertex_market_settlement",
};
...
const seeds: Seed[] = [
  ...
  proc,
  bpmnProcessId: `market_${snake(proc)}`,
  nsid: `com.etzhayyim.market.${proc}`,
  resultTimeoutMs: 30000,
  writeTableAllowlist: writeTables[proc] ?? "",
}));

const bpmnPath = (s: Seed) => `00-contracts/bpmn/com/etzhayyim/market/${s.proc}.bpmn`;
const processVid = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/market-${slug(s.proc)}-v1`;
const bindingVid = (s: Seed) => `at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/market-${slug(s.proc)}-v1`;
