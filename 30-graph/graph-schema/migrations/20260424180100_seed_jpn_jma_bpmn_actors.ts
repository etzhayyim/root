...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-jma-report-earthquake-v1",
    bpmnProcessId: "jpn_jma_report_earthquake",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/jpn-jma/reportEarthquake.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-jma-issue-weather-warning-v1",
    bpmnProcessId: "jpn_jma_issue_weather_warning",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/jpn-jma/issueWeatherWarning.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-jma-reportEarthquake-v1",
    nsid: "com.etzhayyim.apps.jpnJma.reportEarthquake", bpmnProcessId: "jpn_jma_report_earthquake",
    ownerDid, resultTimeoutMs: 30000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-jma-issueWeatherWarning-v1",
    nsid: "com.etzhayyim.apps.jpnJma.issueWeatherWarning", bpmnProcessId: "jpn_jma_issue_weather_warning",
    ownerDid, resultTimeoutMs: 30000 },
];
