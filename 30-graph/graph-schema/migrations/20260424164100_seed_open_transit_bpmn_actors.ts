...
const ownerDid = "did:web:open-transit.etzhayyim.com";
const actorTag = "sys.bpmn.seed.open-transit";

const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-transit-define-route-v1",
    bpmnProcessId: "open_transit_define_route",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-transit/defineRoute.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-transit-report-delay-v1",
    bpmnProcessId: "open_transit_report_delay",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-transit/reportDelay.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-transit-defineRoute-v1",
    nsid: "com.etzhayyim.apps.openTransit.defineRoute", bpmnProcessId: "open_transit_define_route",
    ownerDid, resultTimeoutMs: 15000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-transit-reportDelay-v1",
    nsid: "com.etzhayyim.apps.openTransit.reportDelay", bpmnProcessId: "open_transit_report_delay",
