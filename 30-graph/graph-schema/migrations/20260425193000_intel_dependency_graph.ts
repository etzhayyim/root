...
const processSeeds: ProcessSeed[] = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/intel-infer-dependencies-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/intel-resolve-entity-v1",
    bpmnProcessId: "intel_resolve_entity",
    sourcePath: "00-contracts/bpmn/ai/gftd/intel/resolveEntity.bpmn",
    resultTimeoutMs: 60000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/intel-explain-dependency-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/intel-list-dependency-candidates-v1",
    bpmnProcessId: "intel_list_dependency_candidates",
    sourcePath: "00-contracts/bpmn/ai/gftd/intel/listDependencyCandidates.bpmn",
    resultTimeoutMs: 15000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/intel-get-building-ownership-graph-v1",
  ...
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/intel-get-counterparty-graph-v1",
...
const bindingSeeds = [
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/intel-inferDependencies-v1",
    nsid: "ai.gftd.apps.intel.inferDependencies",
    bpmnProcessId: "intel_infer_dependencies",
    resultTimeoutMs: 180000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/intel-resolveEntity-v1",
    nsid: "ai.gftd.apps.intel.resolveEntity",
    bpmnProcessId: "intel_resolve_entity",
    resultTimeoutMs: 60000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/intel-explainDependency-v1",
    nsid: "ai.gftd.apps.intel.explainDependency",
    bpmnProcessId: "intel_explain_dependency",
    resultTimeoutMs: 15000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/intel-listDependencyCandidates-v1",
    nsid: "ai.gftd.apps.intel.listDependencyCandidates",
    bpmnProcessId: "intel_list_dependency_candidates",
    resultTimeoutMs: 15000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/intel-getBuildingOwnershipGraph-v1",
    nsid: "ai.gftd.apps.intel.getBuildingOwnershipGraph",
    bpmnProcessId: "intel_get_building_ownership_graph",
    resultTimeoutMs: 20000
  },
  {
    vertexId: "at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/intel-getCounterpartyGraph-v1",
