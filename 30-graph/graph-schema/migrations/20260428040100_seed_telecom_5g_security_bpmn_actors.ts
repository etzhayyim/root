...
const seeds: Seed[] = [
  { proc: "subscribeNwdafAnalytics", bpmnProcessId: "telecom_subscribe_nwdaf_analytics",
    nsid: "ai.gftd.apps.telecom.subscribeNwdafAnalytics", resultTimeoutMs: 30000 },
  { proc: "emitNwdafAnalyticsResult", bpmnProcessId: "telecom_emit_nwdaf_analytics_result",
    nsid: "ai.gftd.apps.telecom.emitNwdafAnalyticsResult", resultTimeoutMs: 15000 },
  { proc: "routeServiceRequest", bpmnProcessId: "telecom_route_service_request",
    nsid: "ai.gftd.apps.telecom.routeServiceRequest", resultTimeoutMs: 15000 },
  { proc: "delegateNfDiscovery", bpmnProcessId: "telecom_delegate_nf_discovery",
    nsid: "ai.gftd.apps.telecom.delegateNfDiscovery", resultTimeoutMs: 15000 },
  { proc: "establishSeppContext", bpmnProcessId: "telecom_establish_sepp_context",
    nsid: "ai.gftd.apps.telecom.establishSeppContext", resultTimeoutMs: 30000 },
  { proc: "recordSeppMessage", bpmnProcessId: "telecom_record_sepp_message",
    nsid: "ai.gftd.apps.telecom.recordSeppMessage", resultTimeoutMs: 15000 },
  { proc: "rotateSeppKey", bpmnProcessId: "telecom_rotate_sepp_key",
    nsid: "ai.gftd.apps.telecom.rotateSeppKey", resultTimeoutMs: 30000 },
  { proc: "recordTrustNegotiation", bpmnProcessId: "telecom_record_trust_negotiation",
    nsid: "ai.gftd.apps.telecom.recordTrustNegotiation", resultTimeoutMs: 30000 },
];
