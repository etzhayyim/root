...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ports-schedule-vessel-call-v1",
  ...
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-ports-report-incident-v1",
    bpmnProcessId: "open_ports_report_incident",
    sourcePath: "00-contracts/bpmn/ai/gftd/open-ports/reportIncident.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/open-ports-scheduleVesselCall-v1",
    nsid: "app.etzhayyim.apps.openPorts.scheduleVesselCall", bpmnProcessId: "open_ports_schedule_vessel_call",
    ownerDid, resultTimeoutMs: 15000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/open-ports-reportIncident-v1",
    nsid: "app.etzhayyim.apps.openPorts.reportIncident", bpmnProcessId: "open_ports_report_incident",
