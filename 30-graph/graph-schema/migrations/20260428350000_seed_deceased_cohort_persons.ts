...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  for (const c of cohorts) {
    ...
    const vertex_id = `${REPO}/com.etzhayyim.apps.naturalPerson.cohortPerson/${rkey}`;
    ...
    const popVid = `${REPO}/com.etzhayyim.apps.naturalPerson.populationCohort/${popRkey}`;
    const edgeId = `${REPO}/com.etzhayyim.apps.naturalPerson.cohortDerived/derv-${c.era}-${c.icdCluster}`;
    ...
    const actorVid = `${REPO}/com.etzhayyim.apps.naturalPerson.cohortActor/${rkey}`;
    await sql`
