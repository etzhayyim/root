...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  for (const c of CASES) {
    const vid = `at://did:web:hanrei.etzhayyim.com/com.etzhayyim.apps.hanrei.caseRecord/${c.rkey}`;
    await sql`
  ...
  for (const cite of CITES) {
    ...
    const dstVid = `at://did:web:hanrei.etzhayyim.com/com.etzhayyim.apps.hanrei.caseRecord/${cite.caseRkey}`;
