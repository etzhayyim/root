...
const ownerDid = "did:web:open-gas.etzhayyim.com:network";
const actorTag = "sys.bpmn.seed.open-gas";

const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-gas-define-pipe-segment-v1",
    bpmnProcessId: "open_gas_define_pipe_segment",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-gas/definePipeSegment.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-gas-report-leak-v1",
    bpmnProcessId: "open_gas_report_leak",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-gas/reportLeak.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-gas-definePipeSegment-v1",
    nsid: "com.etzhayyim.apps.openGas.definePipeSegment", bpmnProcessId: "open_gas_define_pipe_segment",
    ownerDid, resultTimeoutMs: 15000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-gas-reportLeak-v1",
    nsid: "com.etzhayyim.apps.openGas.reportLeak", bpmnProcessId: "open_gas_report_leak",
