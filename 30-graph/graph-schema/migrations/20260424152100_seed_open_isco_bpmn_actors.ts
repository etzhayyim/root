...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-isco-classify-worker-v1",
    bpmnProcessId: "open_isco_classify_worker",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-isco/classifyWorker.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-isco-record-concordance-v1",
    bpmnProcessId: "open_isco_record_concordance",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-isco/recordConcordance.bpmn", ownerDid },
];
const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-isco-classifyWorker-v1",
    nsid: "com.etzhayyim.apps.openIsco.classifyWorker", bpmnProcessId: "open_isco_classify_worker",
    ownerDid, resultTimeoutMs: 30000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-isco-recordConcordance-v1",
    nsid: "com.etzhayyim.apps.openIsco.recordConcordance", bpmnProcessId: "open_isco_record_concordance",
