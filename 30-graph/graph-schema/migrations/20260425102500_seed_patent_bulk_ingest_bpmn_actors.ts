...
/**
 * ADR 2604251024 — seed BPMN process + binding for patent bulk ingest
 * (USPTO PatentsView weekly + EPO OPS citation fill + PDF/webp blob
 * conversion). Follows the pattern in 20260424170100_seed_open_patent_*.
 */
...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/patent-ingest-uspto-weekly-v1",
    bpmnProcessId: "patent_ingest_uspto_weekly",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/patent/ingestUsptoWeekly.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/patent-ingest-epo-citation-fill-v1",
    bpmnProcessId: "patent_ingest_epo_citation_fill",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/patent/ingestEpoCitationFill.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/patent-blob-convert-v1",
    bpmnProcessId: "patent_blob_convert",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/patent/patentBlobConvert.bpmn", ownerDid },
];

const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/patent-ingestUsptoWeekly-v1",
    nsid: "com.etzhayyim.apps.patent.ingestUsptoWeekly",
    bpmnProcessId: "patent_ingest_uspto_weekly", ownerDid, resultTimeoutMs: 600000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/patent-ingestEpoCitationFill-v1",
    nsid: "com.etzhayyim.apps.patent.ingestEpoCitationFill",
    bpmnProcessId: "patent_ingest_epo_citation_fill", ownerDid, resultTimeoutMs: 300000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/patent-blobConvert-v1",
    nsid: "com.etzhayyim.apps.patent.blobConvert",
