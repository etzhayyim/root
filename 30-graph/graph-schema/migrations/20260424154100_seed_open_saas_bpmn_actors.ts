...
const processSeeds: P[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-saas-register-product-v1",
    bpmnProcessId: "open_saas_register_product",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-saas/registerProduct.bpmn", ownerDid },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-saas-map-to-unspsc-v1",
    bpmnProcessId: "open_saas_map_to_unspsc",
    sourcePath: "00-contracts/bpmn/com/etzhayyim/open-saas/mapToUnspsc.bpmn", ownerDid },
];
const bindingSeeds: B[] = [
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-saas-registerProduct-v1",
    nsid: "com.etzhayyim.apps.openSaas.registerProduct", bpmnProcessId: "open_saas_register_product",
    ownerDid, resultTimeoutMs: 30000 },
  { vertexId: "at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-saas-mapToUnspsc-v1",
    nsid: "com.etzhayyim.apps.openSaas.mapToUnspsc", bpmnProcessId: "open_saas_map_to_unspsc",
