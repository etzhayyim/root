...
DELETE FROM vertex_repo_record WHERE collection = 'ai.gftd.apps.cofog.function';

DELETE FROM vertex_repo_record WHERE collection = 'ai.gftd.apps.open_isic.economic_activity_rev31';

DELETE FROM vertex_repo_record WHERE collection = 'ai.gftd.apps.open_isic.economic_activity_rev2';
