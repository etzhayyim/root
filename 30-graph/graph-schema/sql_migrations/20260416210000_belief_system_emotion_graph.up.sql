CREATE TABLE IF NOT EXISTS vertex_belief_system (
...
ALTER TABLE edge_constrained_by ADD COLUMN constraint_type VARCHAR;

ALTER TABLE edge_constrained_by ADD COLUMN binding_strength DOUBLE PRECISION;

ALTER TABLE edge_constrained_by ADD COLUMN epoch VARCHAR;

ALTER TABLE edge_constrained_by ADD COLUMN source_did VARCHAR;

CREATE TABLE IF NOT EXISTS edge_seeks_recognition_from (
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_recognition_deficit AS
    SELECT
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_belief_constraint_profile AS
    SELECT
...
INSERT INTO vertex_belief_system (
