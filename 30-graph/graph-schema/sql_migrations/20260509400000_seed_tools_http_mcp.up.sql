-- ADR-2605082000 follow-up — register ai.gftd.tools.http.fetch primitive.
--
...
VALUES
  ('at://did:web:copyright.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-tools-http-fetch',
   0, 0, 'ai.gftd.tools.http.fetch', 'did:web:copyright.gftd.ai', 'copyright.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/tools/http/fetch.json',
