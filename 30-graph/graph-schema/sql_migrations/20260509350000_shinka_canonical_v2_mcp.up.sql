...
VALUES
  ('at://did:web:shinka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shinka-tick',
   0, 0, 'ai.gftd.apps.shinka.tick', 'did:web:shinka.gftd.ai', 'shinka.gftd.ai', 'procedure',
  ...
  ('at://did:web:shinka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shinka-loadAndResolve',
   0, 0, 'ai.gftd.apps.shinka.loadAndResolve', 'did:web:shinka.gftd.ai', 'shinka.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shinka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shinka-compose',
   0, 0, 'ai.gftd.apps.shinka.compose', 'did:web:shinka.gftd.ai', 'shinka.gftd.ai', 'procedure',
   'shinka compose actor mood / action plan (shelf-stocked).',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/shinka/compose.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shinka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shinka-writeHeartbeat',
   0, 0, 'ai.gftd.apps.shinka.writeHeartbeat', 'did:web:shinka.gftd.ai', 'shinka.gftd.ai', 'procedure',
   'shinka write heartbeat (shelf-stocked).',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/shinka/writeHeartbeat.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shinka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shinka-emitEvolution',
   0, 0, 'ai.gftd.apps.shinka.emitEvolution', 'did:web:shinka.gftd.ai', 'shinka.gftd.ai', 'procedure',
...
VALUES
  ('shinka_cron_tick.v2', 0, 0, 'shinka_cron_tick.v2', 2, 'topology', NULL,
   ...
   'rw_vertex', 'did:web:agent.shinka.gftd.ai');
