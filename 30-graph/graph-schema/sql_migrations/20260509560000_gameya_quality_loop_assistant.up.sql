...
VALUES
  ('gameya_quality_loop', 0, 0, 'did:web:gameya.etzhayyim.com',
   'gameya_quality_loop', 1, 'py_factory',
   'pymagatama.langgraph_graphs.gameya_quality_loop:build_graph',
   NULL,
   'gameya.etzhayyim.com deterministic playtest quality loop: observe, score, propose, package release gate.',
...
VALUES
  ('langgraph.builtin.gameya_quality_loop', 0, 0, 'did:web:gameya.etzhayyim.com',
