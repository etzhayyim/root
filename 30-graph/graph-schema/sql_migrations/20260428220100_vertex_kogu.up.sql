...
CREATE INDEX IF NOT EXISTS idx_kogu_item_custodian   ON vertex_kogu_item (custodian_did);

CREATE INDEX IF NOT EXISTS idx_kogu_item_status      ON vertex_kogu_item (status);

CREATE INDEX IF NOT EXISTS idx_kogu_item_calibration ON vertex_kogu_item (calibration_required, next_calibration_date);
...
CREATE INDEX IF NOT EXISTS idx_kogu_calibration_tool ON vertex_kogu_calibration (tool_id);
...
CREATE INDEX IF NOT EXISTS idx_kogu_checkout_tool     ON vertex_kogu_checkout (tool_id);

CREATE INDEX IF NOT EXISTS idx_kogu_checkout_borrower ON vertex_kogu_checkout (borrower_did);

CREATE INDEX IF NOT EXISTS idx_kogu_checkout_status   ON vertex_kogu_checkout (status);
...
CREATE INDEX IF NOT EXISTS idx_kogu_inspection_tool ON vertex_kogu_inspection (tool_id);
