-- Register ai.gftd.apps.openIsic.getTaxonomy MCP primitive.
...
VALUES
  ('at://did:web:tsukuru.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-openisic-gettaxonomy',
   0, 0, 'ai.gftd.apps.openIsic.getTaxonomy', 'did:web:open-isic.gftd.ai', 'tsukuru.gftd.ai', 'procedure',
   ...
   '{"type":"object"}',
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/openisic/getTaxonomy.json',
