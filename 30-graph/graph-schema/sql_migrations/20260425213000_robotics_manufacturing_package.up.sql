...
CREATE INDEX IF NOT EXISTS idx_robotics_pkg_package_id ON vertex_robotics_product_package (package_id);

CREATE INDEX IF NOT EXISTS idx_robotics_pkg_asset_kind ON vertex_robotics_product_package (asset_kind);

CREATE INDEX IF NOT EXISTS idx_robotics_pkg_readiness ON vertex_robotics_product_package (readiness_status, validation_status);
...
CREATE INDEX IF NOT EXISTS idx_robotics_file_package ON vertex_robotics_product_file (package_id);

CREATE INDEX IF NOT EXISTS idx_robotics_file_folder_role ON vertex_robotics_product_file (folder, role);

CREATE INDEX IF NOT EXISTS idx_robotics_file_sha256 ON vertex_robotics_product_file (sha256);

CREATE INDEX IF NOT EXISTS idx_robotics_file_required_status ON vertex_robotics_product_file (required, present, file_status);
...
CREATE INDEX IF NOT EXISTS idx_robotics_process_package ON vertex_robotics_manufacturing_process (package_id);

CREATE INDEX IF NOT EXISTS idx_robotics_process_kind ON vertex_robotics_manufacturing_process (process_kind);

CREATE INDEX IF NOT EXISTS idx_robotics_process_sequence ON vertex_robotics_manufacturing_process (package_id, sequence_no);
...
CREATE INDEX IF NOT EXISTS idx_robotics_gate_package ON vertex_robotics_quality_gate (package_id);

CREATE INDEX IF NOT EXISTS idx_robotics_gate_process ON vertex_robotics_quality_gate (process_id);

CREATE INDEX IF NOT EXISTS idx_robotics_gate_status ON vertex_robotics_quality_gate (gate_status, gate_kind);
...
CREATE INDEX IF NOT EXISTS idx_robotics_rfq_package ON vertex_robotics_rfq (package_id);

CREATE INDEX IF NOT EXISTS idx_robotics_rfq_region_status ON vertex_robotics_rfq (supplier_region, rfq_status);
...
CREATE INDEX IF NOT EXISTS idx_robotics_adapter_package ON vertex_robotics_control_adapter_spec (package_id);

CREATE INDEX IF NOT EXISTS idx_robotics_adapter_asset_standard ON vertex_robotics_control_adapter_spec (asset_kind, control_standard);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_pkg_file_src ON edge_robotics_package_has_file (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_pkg_file_dst ON edge_robotics_package_has_file (dst_vid);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_pkg_process_src ON edge_robotics_package_has_process (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_pkg_process_dst ON edge_robotics_package_has_process (dst_vid);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_consumes_process ON edge_robotics_process_consumes_file (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_consumes_file ON edge_robotics_process_consumes_file (dst_vid);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_produces_process ON edge_robotics_process_produces_file (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_produces_file ON edge_robotics_process_produces_file (dst_vid);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_process_gate_src ON edge_robotics_process_has_quality_gate (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_process_gate_dst ON edge_robotics_process_has_quality_gate (dst_vid);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_package_rfq_src ON edge_robotics_package_rfq (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_package_rfq_dst ON edge_robotics_package_rfq (dst_vid);
...
CREATE INDEX IF NOT EXISTS idx_edge_robotics_package_adapter_src ON edge_robotics_package_uses_control_adapter (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_robotics_package_adapter_dst ON edge_robotics_package_uses_control_adapter (dst_vid);
