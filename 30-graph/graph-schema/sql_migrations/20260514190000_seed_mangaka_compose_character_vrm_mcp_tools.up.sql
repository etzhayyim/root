...
-- descriptions is on `ghcr.io/gftdcojp/*` and runs open-weight / OSS
...
VALUES
  ...
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-loadCharacterProfile',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/loadCharacterProfile.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z'),

  -- 2. generateMultiviewAnime (GPU — pod_pool vke-render-pool)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-generateMultiviewAnime',
   0, 0,
   'ai.gftd.apps.mangaka.tools.generateMultiviewAnime',
   'did:web:mangaka.gftd.ai', 'mangaka.gftd.ai', 'procedure',
   'P16 step 3: CharacterGen anime-tuned multi-view (MIT, self-hosted on ghcr.io/gftdcojp/character-gen:0.1).',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/generateMultiviewAnime.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z'),

  -- 3. reconstructMesh (GPU — pod_pool vke-render-pool)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-reconstructMesh',
   0, 0,
   'ai.gftd.apps.mangaka.tools.reconstructMesh',
   'did:web:mangaka.gftd.ai', 'mangaka.gftd.ai', 'procedure',
   'P16 step 4: Hunyuan3D-2 multi-view -> textured glb (OSS, self-hosted on ghcr.io/gftdcojp/hunyuan3d-2:0.2).',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/reconstructMesh.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z'),

  -- 4. extractFacialBlendshapes (CPU — pod_pool vke-cpu-pool)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-extractFacialBlendshapes',
   0, 0,
   'ai.gftd.apps.mangaka.tools.extractFacialBlendshapes',
   'did:web:mangaka.gftd.ai', 'mangaka.gftd.ai', 'procedure',
   'P16 step 5: MediaPipe Face Landmarker (Apache-2.0, self-hosted on ghcr.io/gftdcojp/mediapipe-face:1). 52 ARKit weights + 478 landmarks.',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/extractFacialBlendshapes.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z'),

  -- 5. autoRigHumanoid (CPU — Blender Rigify primary + in-house RigNet fallback, self-hosted only)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-autoRigHumanoid',
   0, 0,
   'ai.gftd.apps.mangaka.tools.autoRigHumanoid',
   'did:web:mangaka.gftd.ai', 'mangaka.gftd.ai', 'procedure',
   'P16 step 6: Blender Rigify template-fit + in-house RigNet distill fallback (ghcr.io/gftdcojp/blender-rigify-rignet:0.1). No external rigging API — train-only teacher signals.',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/autoRigHumanoid.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z'),

  -- 6. bindVrm (CPU — Blender headless + saturday06 VRM Add-on)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-bindVrm',
   0, 0,
   'ai.gftd.apps.mangaka.tools.bindVrm',
   'did:web:mangaka.gftd.ai', 'mangaka.gftd.ai', 'procedure',
   'P16 step 7: Blender + saturday06 VRM Add-on -> VRM 1.0 binary (self-hosted on ghcr.io/gftdcojp/blender-vrm:4.1).',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/bindVrm.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z'),

  -- 7. validateVrm (CPU — kami_vrm::parse_vrm in-repo)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-validateVrm',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/validateVrm.json',
   'anon', 'anon', '', '2026-05-14T19:00:00Z');
