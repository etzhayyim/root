...
INSERT INTO vertex_medical_data_source (
    ...
    VALUES
      ('medical-data-source:cms-pos-clinical-labs', 'cms-pos-clinical-labs', 'iryo_shisetsu', 'com.etzhayyim.apps.iryo.shisetsu', 'cms', 'CMS POS Clinical Laboratories', 'CMS Provider of Services - Clinical Laboratories', 'cms-data-api', 'json-page', 'https://data.cms.gov/data-api/v1/dataset/d3eb38ac-d8e9-40d3-b7b7-6205d3d1dc16/data', 'US-PD', 'monthly', 676051, 'ai-gftd-nats', 'medical-sources/iryo-shisetsu', 'active', 100, '{"datasetId":"d3eb38ac-d8e9-40d3-b7b7-6205d3d1dc16"}', NOW()::VARCHAR, NOW()::VARCHAR),
