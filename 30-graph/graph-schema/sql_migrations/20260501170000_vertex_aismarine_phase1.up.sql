...
CREATE INDEX idx_vessel_position_mmsi_ts ON vertex_vessel_position(mmsi, ts_ms);

CREATE INDEX idx_vessel_voyage_mmsi ON vertex_vessel_voyage(mmsi);

CREATE INDEX idx_vessel_visited_port_locode ON edge_vessel_visited_port(port_locode, arrival_ms);

CREATE INDEX idx_vessel_name ON vertex_vessel(name);
