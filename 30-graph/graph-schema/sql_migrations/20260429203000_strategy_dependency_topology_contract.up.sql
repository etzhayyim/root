...
CREATE INDEX IF NOT EXISTS idx_dep_topology_order_scope_reverse ON vertex_dependency_topology_order (graph_scope, reverse_topo_rank);

CREATE INDEX IF NOT EXISTS idx_dep_topology_order_scope_topo ON vertex_dependency_topology_order (graph_scope, topo_rank);

CREATE INDEX IF NOT EXISTS idx_dep_topology_order_cycle ON vertex_dependency_topology_order (graph_scope, cycle_status);
