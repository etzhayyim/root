...
DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.asfis.species';

DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.fda.ndc';
