...
CREATE INDEX idx_fukkou_legislation_status ON vertex_fukkou_legislation (status, established_at);

CREATE INDEX idx_fukkou_committee_chamber ON vertex_fukkou_committee (chamber, kind);

CREATE INDEX idx_fukkou_politician_party ON vertex_fukkou_politician (party, chamber);

CREATE INDEX idx_fukkou_politician_role ON vertex_fukkou_politician (fukkou_role);

CREATE INDEX idx_fukkou_bureaucrat_ministry ON vertex_fukkou_bureaucrat (home_ministry, rank);

CREATE INDEX idx_fukkou_recipient_kind ON vertex_fukkou_recipient_org (kind, status);

CREATE INDEX idx_fukkou_recipient_houjin ON vertex_fukkou_recipient_org (houjin_bango);

CREATE INDEX idx_fukkou_ubo_leaf ON vertex_fukkou_ubo (leaf_org_id);

CREATE INDEX idx_fukkou_ubo_beneficial ON vertex_fukkou_ubo (beneficial_did);
