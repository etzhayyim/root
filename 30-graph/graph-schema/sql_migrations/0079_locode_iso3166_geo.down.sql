...
DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.locode.location';

DELETE FROM vertex_repo_record WHERE collection = 'com.etzhayyim.apps.iso3166.country';
