...
VALUES
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-agentLoop',
   0, 0, 'ai.gftd.apps.wellbecoming.agentLoop', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Wellbecoming agent loop (shelf-stocking).', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/agentLoop.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-bottleneckDetect',
   0, 0, 'ai.gftd.apps.wellbecoming.bottleneckDetect', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Detect bottlenecks in wellbecoming flows.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/bottleneckDetect.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-proactiveConnect',
   0, 0, 'ai.gftd.apps.wellbecoming.proactiveConnect', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Proactively connect wellbecoming peers.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/proactiveConnect.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-floorCheck',
   0, 0, 'ai.gftd.apps.wellbecoming.floorCheck', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Check wellbecoming floor violations in a time window.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/floorCheck.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-floorAlert',
   0, 0, 'ai.gftd.apps.wellbecoming.floorAlert', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Emit wellbecoming floor-violation alert.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/floorAlert.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-minimaxSweep',
   0, 0, 'ai.gftd.apps.wellbecoming.minimaxSweep', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Wellbecoming minimax sweep.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/minimaxSweep.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-beliefInfluencePropagate',
   0, 0, 'ai.gftd.apps.wellbecoming.beliefInfluencePropagate', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Propagate belief influence in the wellbecoming graph.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/beliefInfluencePropagate.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-beliefNoiseInject',
   0, 0, 'ai.gftd.apps.wellbecoming.beliefNoiseInject', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Inject belief noise (perturbation experiment).', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/beliefNoiseInject.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-beliefRestoringCapture',
   0, 0, 'ai.gftd.apps.wellbecoming.beliefRestoringCapture', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Capture wellbecoming belief restoring events.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/beliefRestoringCapture.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-trustWeightUpdate',
   0, 0, 'ai.gftd.apps.wellbecoming.trustWeightUpdate', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Update wellbecoming trust weights.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/trustWeightUpdate.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:wellbecoming.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-wellbecoming-processMiningAnalyze',
   0, 0, 'ai.gftd.apps.wellbecoming.processMiningAnalyze', 'did:web:wellbecoming.etzhayyim.com', 'wellbecoming.etzhayyim.com', 'procedure',
   'Wellbecoming process-mining analyze.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/wellbecoming/processMiningAnalyze.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z');
...
VALUES
  ('wellbecoming_belief_influence_propagate.v2:influence_propagate', 0, 0, 'wellbecoming_belief_influence_propagate.v2', 'influence_propagate',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.beliefInfluencePropagate',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.beliefInfluencePropagate"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_belief_noise_inject.v2:noise_inject', 0, 0, 'wellbecoming_belief_noise_inject.v2', 'noise_inject',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.beliefNoiseInject',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.beliefNoiseInject"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_belief_restoring_capture.v2:restoring_capture', 0, 0, 'wellbecoming_belief_restoring_capture.v2', 'restoring_capture',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.beliefRestoringCapture',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.beliefRestoringCapture"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_detect_bottleneck.v2:detect_bottleneck', 0, 0, 'wellbecoming_detect_bottleneck.v2', 'detect_bottleneck',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.bottleneckDetect',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.bottleneckDetect"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_floor_violation_alert.v2:floor_check', 0, 0, 'wellbecoming_floor_violation_alert.v2', 'floor_check',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.floorCheck',
   '{"input_keys":["window_minutes"],"result_key":"floor_violation_count","args":{"name":"ai.gftd.apps.wellbecoming.floorCheck"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_floor_violation_alert.v2:floor_alert', 0, 0, 'wellbecoming_floor_violation_alert.v2', 'floor_alert',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.floorAlert',
   '{"input_keys":["violation_ids"],"result_key":"alert_emitted","args":{"name":"ai.gftd.apps.wellbecoming.floorAlert"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_minimax_sweep.v2:minimax_sweep', 0, 0, 'wellbecoming_minimax_sweep.v2', 'minimax_sweep',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.minimaxSweep',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.minimaxSweep"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_proactive_connect.v2:proactive_connect', 0, 0, 'wellbecoming_proactive_connect.v2', 'proactive_connect',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.proactiveConnect',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.proactiveConnect"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_process_mining.v2:process_mining', 0, 0, 'wellbecoming_process_mining.v2', 'process_mining',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.processMiningAnalyze',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.processMiningAnalyze"}}',
   '2026-05-09T00:00:00Z'),
  ('wellbecoming_trust_weight_update.v2:trust_weight_update', 0, 0, 'wellbecoming_trust_weight_update.v2', 'trust_weight_update',
   'mcp_tool', 'mcp://ai.gftd.apps.wellbecoming.trustWeightUpdate',
   '{"input_keys":[],"result_key":"out","args":{"name":"ai.gftd.apps.wellbecoming.trustWeightUpdate"}}',
   '2026-05-09T00:00:00Z');
