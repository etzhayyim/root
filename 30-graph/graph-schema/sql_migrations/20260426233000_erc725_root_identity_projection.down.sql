...
DROP INDEX IF EXISTS idx_vertex_gftd_identity_root_hash;
...
ALTER TABLE vertex_gftd_identity DROP COLUMN migration_status;

ALTER TABLE vertex_gftd_identity DROP COLUMN identity_method;

ALTER TABLE vertex_gftd_identity DROP COLUMN facade_did_hash;

ALTER TABLE vertex_gftd_identity DROP COLUMN facade_did;

ALTER TABLE vertex_gftd_identity DROP COLUMN root_identity_addr;

ALTER TABLE vertex_gftd_identity DROP COLUMN root_did_hash;
