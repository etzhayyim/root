DELETE FROM edge_feature_replaces
  WHERE src_vid IN (
    ...
    WHERE analysis_vertex_id = 'at://did:web:amanomibashira.gftd.ai/ai.gftd.analysis.codebase/langchain-langgraph-pregel-20260509'
  );

DELETE FROM edge_analysis_covers_feature
  WHERE src_vid = 'at://did:web:amanomibashira.gftd.ai/ai.gftd.analysis.codebase/langchain-langgraph-pregel-20260509';
...
DELETE FROM vertex_codebase_analysis
  WHERE vertex_id = 'at://did:web:amanomibashira.gftd.ai/ai.gftd.analysis.codebase/langchain-langgraph-pregel-20260509';
