...
CREATE INDEX IF NOT EXISTS idx_vertex_celestial_catalog_catalog_id ON vertex_celestial_catalog (catalog_id);

CREATE INDEX IF NOT EXISTS idx_vertex_celestial_object_object_id ON vertex_celestial_object (object_id);

CREATE INDEX IF NOT EXISTS idx_vertex_celestial_object_catalog_id ON vertex_celestial_object (catalog_id);

CREATE INDEX IF NOT EXISTS idx_vertex_celestial_object_parent_object_id ON vertex_celestial_object (parent_object_id);

CREATE INDEX IF NOT EXISTS idx_vertex_celestial_object_object_kind ON vertex_celestial_object (object_kind);
