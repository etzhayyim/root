...
CREATE INDEX IF NOT EXISTS idx_vertex_terrain_source_source_id ON vertex_terrain_source (source_id);

CREATE INDEX IF NOT EXISTS idx_vertex_terrain_source_slug ON vertex_terrain_source (slug);

CREATE INDEX IF NOT EXISTS idx_vertex_terrain_source_default_priority ON vertex_terrain_source (is_default, priority);

CREATE INDEX IF NOT EXISTS idx_vertex_raster_asset_source_id ON vertex_raster_asset (source_id);

CREATE INDEX IF NOT EXISTS idx_vertex_raster_asset_role ON vertex_raster_asset (asset_role);
