...
--   emit_audit                  mcp_tool      RETIRED → com.etzhayyim.tools.audit.emit
--
...
INSERT INTO vertex_langgraph_assistant_node (vertex_id, _seq, sensitivity_ord, assistant_id, node_id, kind, ref, config, created_at) VALUES ('animeka_autopilot.v2:emit_audit', 0, 0, 'animeka_autopilot.v2', 'emit_audit', 'mcp_tool', 'mcp://com.etzhayyim.tools.audit.emit', '{"input_paths":{"cutId":"cutId","sbCid":"sbCid","lyCid":"lyCid","kfCid":"kfCid","bgCid":"bgCid","postStatus":"postStatus","ok":"ok"},"result_key":"emitAuditOut","args":{"name":"com.etzhayyim.tools.audit.emit","actor":"did:web:animeka.etzhayyim.com","action":"animeka.autopilot"}}', '2026-05-09T09:00:00Z');
