...
GRANT SELECT, INSERT, UPDATE ON vertex_shosha_intel              TO root;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_intel              TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_market_view        TO root;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_market_view        TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_counterparty       TO root;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_counterparty       TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_trade              TO root;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_trade              TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_exposure_snapshot  TO root;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_exposure_snapshot  TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_hedge              TO root;

GRANT SELECT, INSERT, UPDATE ON vertex_shosha_hedge              TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON edge_shosha_trade_counterparty   TO root;

GRANT SELECT, INSERT, UPDATE ON edge_shosha_trade_counterparty   TO kaisya_app;

GRANT SELECT, INSERT, UPDATE ON edge_shosha_trade_hedge          TO root;

GRANT SELECT, INSERT, UPDATE ON edge_shosha_trade_hedge          TO kaisya_app;
