...
CREATE INDEX IF NOT EXISTS idx_ki_absorb_status ON vertex_ki_absorb (status);

CREATE INDEX IF NOT EXISTS idx_ki_absorb_hash ON vertex_ki_absorb (content_hash);
...
CREATE INDEX IF NOT EXISTS idx_ki_artifact_status ON vertex_ki_artifact (status);

CREATE INDEX IF NOT EXISTS idx_ki_artifact_kind ON vertex_ki_artifact (artifact_kind);
...
CREATE INDEX IF NOT EXISTS idx_ki_ring_at ON vertex_ki_ring (ring_at);
...
CREATE INDEX IF NOT EXISTS idx_ki_vascular_src ON edge_ki_vascular (src_vid);

CREATE INDEX IF NOT EXISTS idx_ki_vascular_kind ON edge_ki_vascular (flow_kind);
