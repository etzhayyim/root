...
VALUES
  ('at://did:web:shosha.gftd.ai/com.etzhayyim.mcp.toolDef/ai-gftd-tools-audit-emit',
   0, 0, 'com.etzhayyim.tools.audit.emit', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
