-- ADR-2605082000 follow-up — register ai.gftd.tools.audit.emit primitive.
--
...
--
--   kind=mcp_tool
--   ref=mcp://ai.gftd.tools.audit.emit
--   config={"input_keys":[],"result_key":"auditOut",
--           "args":{"name":"ai.gftd.tools.audit.emit",
--                   "repo":"did:web:<actor>.gftd.ai",
--                   "collection":"ai.gftd.apps.<actor>.audit",
--                   "action":"<verb>"}}
--
-- actor_host follows the const.echo convention: the first heavy consumer
-- (shosha) hosts the primitive at shosha.gftd.ai. Future move to a
...
VALUES
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-tools-audit-emit',
   0, 0, 'ai.gftd.tools.audit.emit', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/tools/audit/emit.json',
