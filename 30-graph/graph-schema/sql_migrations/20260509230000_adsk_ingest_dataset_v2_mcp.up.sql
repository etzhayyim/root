...
--   ai.gftd.apps.adsk.datasetIngestAll   →   pymagatama.primitives.adsk:task_adsk_dataset_ingest_all
...
VALUES
  ('at://did:web:adsk.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-adsk-datasetIngestAll',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/adsk/datasetIngestAll.json',
...
VALUES
  ('adsk_ingest_dataset.v2:ingest_all', 0, 0,
   ...
   'mcp_tool', 'mcp://ai.gftd.apps.adsk.datasetIngestAll',
   '{"input_keys":["staleSeconds","perDatasetLimit"],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.adsk.datasetIngestAll"}}',
   '2026-05-09T00:00:00Z');
