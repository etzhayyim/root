...
-- `SELECT actor_host FROM vertex_mcp_tool_def WHERE nsid = 'ai.gftd.apps.mangaka.tools.<m>'`,
-- and a topology assistant node bound as kind=mcp_tool ref=mcp://...
-- resolves to https://mangaka.gftd.ai/xrpc/ai.gftd.mcp.message at runtime.
--
...
VALUES
  -- 1. loadPanelPlan
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-loadPanelPlan',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/loadPanelPlan.json',
   'anon', 'anon', '', '2026-05-14T14:00:00Z'),

  -- 2. resolveAssets
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-resolveAssets',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/resolveAssets.json',
   'anon', 'anon', '', '2026-05-14T14:00:00Z'),

  -- 3. placeScene
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-placeScene',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/placeScene.json',
   'anon', 'anon', '', '2026-05-14T14:00:00Z'),

  -- 4. simulateCharacter (per-character Send fan-out)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-simulateCharacter',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/simulateCharacter.json',
   'anon', 'anon', '', '2026-05-14T14:00:00Z'),

  -- 5. renderKeyframes (GPU-bound — pod selector vke-render-pool)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-renderKeyframes',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/renderKeyframes.json',
   'anon', 'anon', '', '2026-05-14T14:00:00Z'),

  -- 6. persistScene3d (terminal — INSERT vertex_mangaka_scene_3d on pod, ADR-2605111200)
  ('at://did:web:mangaka.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-mangaka-tools-persistScene3d',
   0, 0,
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/mangaka/tools/persistScene3d.json',
   'anon', 'anon', '', '2026-05-14T14:00:00Z');
