...
CREATE INDEX IF NOT EXISTS idx_nogu_item_owner     ON vertex_nogu_item (owner_did_item);

CREATE INDEX IF NOT EXISTS idx_nogu_item_status    ON vertex_nogu_item (status);

CREATE INDEX IF NOT EXISTS idx_nogu_item_inspection ON vertex_nogu_item (next_inspection_date);
...
CREATE INDEX IF NOT EXISTS idx_nogu_inspection_item ON vertex_nogu_inspection (item_id);
...
CREATE INDEX IF NOT EXISTS idx_nogu_maintenance_item   ON vertex_nogu_maintenance (item_id);

CREATE INDEX IF NOT EXISTS idx_nogu_maintenance_status ON vertex_nogu_maintenance (status);
...
CREATE INDEX IF NOT EXISTS idx_nogu_lease_item    ON vertex_nogu_lease (item_id);

CREATE INDEX IF NOT EXISTS idx_nogu_lease_lessee  ON vertex_nogu_lease (lessee_did_or_member_id);

CREATE INDEX IF NOT EXISTS idx_nogu_lease_status  ON vertex_nogu_lease (status);
...
CREATE INDEX IF NOT EXISTS idx_nogu_disposal_item ON vertex_nogu_disposal (item_id);
