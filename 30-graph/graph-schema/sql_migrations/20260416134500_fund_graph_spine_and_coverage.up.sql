...
INSERT INTO dim_world_domain_collection (domain, app_host, collection, world_total, unit, sector)
    VALUES
      ('government_fund', 'fund', 'ai.gftd.apps.fund.fund', 25000, 'government / policy funds', 'finance'),
      ('government_fund', 'fund', 'ai.gftd.apps.fund.manager', 25000, 'government / policy funds', 'finance'),
      ('government_fund', 'fund', 'ai.gftd.apps.fund.investee', 25000, 'government / policy funds', 'finance'),
      ('government_fund', 'fund', 'ai.gftd.apps.fund.metric', 25000, 'government / policy funds', 'finance'),
      ('investor_fund', 'fund', 'ai.gftd.apps.fund.fund', 500000, 'fund investors / LP entities', 'finance'),
      ('investor_fund', 'fund', 'ai.gftd.apps.fund.investor', 500000, 'fund investors / LP entities', 'finance'),
      ('investor_fund', 'fund', 'ai.gftd.apps.fund.commitment', 500000, 'fund investors / LP entities', 'finance'),
      ('mutual_fund', 'fund', 'ai.gftd.apps.fund.fund', 150000, 'mutual funds / UCITS', 'finance'),
      ('mutual_fund', 'fund', 'ai.gftd.apps.fund.manager', 150000, 'mutual funds / UCITS', 'finance'),
      ('mutual_fund', 'fund', 'ai.gftd.apps.fund.investee', 150000, 'mutual funds / UCITS', 'finance'),
      ('mutual_fund', 'fund', 'ai.gftd.apps.fund.metric', 150000, 'mutual funds / UCITS', 'finance'),
      ('pension_fund', 'fund', 'ai.gftd.apps.fund.fund', 350000, 'pension funds', 'finance'),
      ('pension_fund', 'fund', 'ai.gftd.apps.fund.investor', 350000, 'pension funds', 'finance'),
      ('pension_fund', 'fund', 'ai.gftd.apps.fund.manager', 350000, 'pension funds', 'finance'),
      ('pension_fund', 'fund', 'ai.gftd.apps.fund.commitment', 350000, 'pension funds', 'finance'),
      ('pension_fund', 'fund', 'ai.gftd.apps.fund.metric', 350000, 'pension funds', 'finance'),
      ('private_fund', 'fund', 'ai.gftd.apps.fund.fund', 300000, 'private funds', 'finance'),
      ('private_fund', 'fund', 'ai.gftd.apps.fund.investor', 300000, 'private funds', 'finance'),
      ('private_fund', 'fund', 'ai.gftd.apps.fund.manager', 300000, 'private funds', 'finance'),
      ('private_fund', 'fund', 'ai.gftd.apps.fund.investee', 300000, 'private funds', 'finance'),
      ('private_fund', 'fund', 'ai.gftd.apps.fund.commitment', 300000, 'private funds', 'finance'),
      ('private_fund', 'fund', 'ai.gftd.apps.fund.metric', 300000, 'private funds', 'finance'),
      ('sovereign_fund', 'fund', 'ai.gftd.apps.fund.fund', 250, 'sovereign wealth / strategic funds', 'finance'),
      ('sovereign_fund', 'fund', 'ai.gftd.apps.fund.manager', 250, 'sovereign wealth / strategic funds', 'finance'),
      ('sovereign_fund', 'fund', 'ai.gftd.apps.fund.investee', 250, 'sovereign wealth / strategic funds', 'finance'),
      ('sovereign_fund', 'fund', 'ai.gftd.apps.fund.metric', 250, 'sovereign wealth / strategic funds', 'finance');
