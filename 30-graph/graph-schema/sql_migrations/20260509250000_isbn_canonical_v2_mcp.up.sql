...
-- This migration:
--   1. Seeds vertex_mcp_tool_def with 6 ai.gftd.apps.isbn.* rows pointing at
...
VALUES
  ('at://did:web:isbn.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-aozoraIngest',
   0, 0, 'ai.gftd.apps.isbn.aozoraIngest', 'did:web:isbn.etzhayyim.com', 'isbn.etzhayyim.com', 'procedure',
   'isbn aozora ingest (Aozora Bunko library catalogue mirror).',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/aozoraIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-gutenbergIngest',
   0, 0, 'ai.gftd.apps.isbn.gutenbergIngest', 'did:web:isbn.etzhayyim.com', 'isbn.etzhayyim.com', 'procedure',
   'isbn Project Gutenberg ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/gutenbergIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-hathitrustIngest',
   0, 0, 'ai.gftd.apps.isbn.hathitrustIngest', 'did:web:isbn.etzhayyim.com', 'isbn.etzhayyim.com', 'procedure',
   'isbn HathiTrust ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/hathitrustIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-internetArchiveIngest',
   0, 0, 'ai.gftd.apps.isbn.internetArchiveIngest', 'did:web:isbn.etzhayyim.com', 'isbn.etzhayyim.com', 'procedure',
   'isbn Internet Archive ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/internetArchiveIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-ndlIngest',
   0, 0, 'ai.gftd.apps.isbn.ndlIngest', 'did:web:isbn.etzhayyim.com', 'isbn.etzhayyim.com', 'procedure',
   'isbn NDL (国立国会図書館) ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/ndlIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.etzhayyim.com/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-openLibraryIngest',
   0, 0, 'ai.gftd.apps.isbn.openLibraryIngest', 'did:web:isbn.etzhayyim.com', 'isbn.etzhayyim.com', 'procedure',
   'isbn Open Library ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/openLibraryIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z');
...
VALUES
  ('isbn_ingest_aozora.v2:ingest_aozora', 0, 0, 'isbn_ingest_aozora.v2', 'ingest_aozora',
   'mcp_tool', 'mcp://ai.gftd.apps.isbn.aozoraIngest',
   '{"input_keys":[],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.isbn.aozoraIngest"}}',
   '2026-05-09T00:00:00Z'),
  ('isbn_ingest_gutenberg.v2:ingest_gutenberg', 0, 0, 'isbn_ingest_gutenberg.v2', 'ingest_gutenberg',
   'mcp_tool', 'mcp://ai.gftd.apps.isbn.gutenbergIngest',
   '{"input_keys":[],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.isbn.gutenbergIngest"}}',
   '2026-05-09T00:00:00Z'),
  ('isbn_ingest_hathitrust.v2:ingest_hathitrust', 0, 0, 'isbn_ingest_hathitrust.v2', 'ingest_hathitrust',
   'mcp_tool', 'mcp://ai.gftd.apps.isbn.hathitrustIngest',
   '{"input_keys":[],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.isbn.hathitrustIngest"}}',
   '2026-05-09T00:00:00Z'),
  ('isbn_ingest_internet_archive.v2:ingest_internet_archive', 0, 0, 'isbn_ingest_internet_archive.v2', 'ingest_internet_archive',
   'mcp_tool', 'mcp://ai.gftd.apps.isbn.internetArchiveIngest',
   '{"input_keys":[],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.isbn.internetArchiveIngest"}}',
   '2026-05-09T00:00:00Z'),
  ('isbn_ingest_ndl.v2:ingest_ndl', 0, 0, 'isbn_ingest_ndl.v2', 'ingest_ndl',
   'mcp_tool', 'mcp://ai.gftd.apps.isbn.ndlIngest',
   '{"input_keys":[],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.isbn.ndlIngest"}}',
   '2026-05-09T00:00:00Z'),
  ('isbn_ingest_open_library.v2:ingest_open_library', 0, 0, 'isbn_ingest_open_library.v2', 'ingest_open_library',
   'mcp_tool', 'mcp://ai.gftd.apps.isbn.openLibraryIngest',
   '{"input_keys":[],"result_key":"ingestOut","args":{"name":"ai.gftd.apps.isbn.openLibraryIngest"}}',
   '2026-05-09T00:00:00Z');
