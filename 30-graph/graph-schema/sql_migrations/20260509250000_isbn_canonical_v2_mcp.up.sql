...
--
-- RUNTIME CAVEAT: isbn.gftd.ai Worker does NOT exist yet. Same operator
...
VALUES
  ('at://did:web:isbn.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-aozoraIngest',
   0, 0, 'ai.gftd.apps.isbn.aozoraIngest', 'did:web:isbn.gftd.ai', 'isbn.gftd.ai', 'procedure',
  ...
  ('at://did:web:isbn.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-gutenbergIngest',
   0, 0, 'ai.gftd.apps.isbn.gutenbergIngest', 'did:web:isbn.gftd.ai', 'isbn.gftd.ai', 'procedure',
   'isbn Project Gutenberg ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/gutenbergIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-hathitrustIngest',
   0, 0, 'ai.gftd.apps.isbn.hathitrustIngest', 'did:web:isbn.gftd.ai', 'isbn.gftd.ai', 'procedure',
   'isbn HathiTrust ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/hathitrustIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-internetArchiveIngest',
   0, 0, 'ai.gftd.apps.isbn.internetArchiveIngest', 'did:web:isbn.gftd.ai', 'isbn.gftd.ai', 'procedure',
   'isbn Internet Archive ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/internetArchiveIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-ndlIngest',
   0, 0, 'ai.gftd.apps.isbn.ndlIngest', 'did:web:isbn.gftd.ai', 'isbn.gftd.ai', 'procedure',
   'isbn NDL (国立国会図書館) ingest.',
   '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/isbn/ndlIngest.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:isbn.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-isbn-openLibraryIngest',
   0, 0, 'ai.gftd.apps.isbn.openLibraryIngest', 'did:web:isbn.gftd.ai', 'isbn.gftd.ai', 'procedure',
...
VALUES
  ('isbn_ingest_aozora.v2', 0, 0, 'isbn_ingest_aozora.v2', 2, 'topology', NULL,
   ...
   'rw_vertex', 'did:web:agent.isbn.gftd.ai'),
