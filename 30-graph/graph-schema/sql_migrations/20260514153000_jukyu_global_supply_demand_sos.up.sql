...
CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_supply_node_domain_country
  ON vertex_jukyu_supply_node (domain, country_code, product_family);

CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_supply_node_operator
  ON vertex_jukyu_supply_node (operator_did, domain);

CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_balance_domain_time
  ON vertex_jukyu_balance_observation (domain, observed_at);

CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_balance_country_product
  ON vertex_jukyu_balance_observation (country_code, product_code, product_family);

CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_exposure_company
  ON vertex_jukyu_company_exposure (company_did, domain);

CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_exposure_rank
  ON vertex_jukyu_company_exposure (domain, country_code, risk_score);

CREATE INDEX IF NOT EXISTS idx_vertex_jukyu_notification_target
  ON vertex_jukyu_notification_signal (target_company_did, notification_status);

CREATE INDEX IF NOT EXISTS idx_edge_jukyu_supply_src
  ON edge_jukyu_supply_dependency (src_vid);

CREATE INDEX IF NOT EXISTS idx_edge_jukyu_supply_dst
  ON edge_jukyu_supply_dependency (dst_vid);

CREATE INDEX IF NOT EXISTS idx_edge_jukyu_operates_company
  ON edge_jukyu_company_operates_node (src_vid);
