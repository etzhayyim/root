-- ADR-2605082000 follow-up — register ai.gftd.tools.json.extract primitive.
--
...
VALUES
  ('at://did:web:copyright.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-tools-json-extract',
   0, 0, 'ai.gftd.tools.json.extract', 'did:web:copyright.gftd.ai', 'copyright.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/tools/json/extract.json',
