-- ADR-2605082000 follow-up — register ai.gftd.tools.sql.query primitive.
--
...
-- copyright_*, gftdcojp_company_ops legal/finance agents, kaisya_member_assistant,
...
VALUES
  ('at://did:web:tsukuru.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-tools-sql-query',
   0, 0, 'ai.gftd.tools.sql.query', 'did:web:tsukuru.gftd.ai', 'tsukuru.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/tools/sql/query.json',
