...
VALUES
  ('at://did:web:tsukuru.gftd.ai/com.etzhayyim.mcp.toolDef/ai-gftd-tools-sql-query',
   0, 0, 'com.etzhayyim.tools.sql.query', 'did:web:tsukuru.gftd.ai', 'tsukuru.gftd.ai', 'procedure',
