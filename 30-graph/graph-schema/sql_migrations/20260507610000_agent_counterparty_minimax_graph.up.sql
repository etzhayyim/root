...
CREATE INDEX IF NOT EXISTS idx_agent_counterparty_model_agent ON vertex_agent_counterparty_model (agent_did, counterparty_ref);

CREATE INDEX IF NOT EXISTS idx_agent_protected_asset_counterparty ON vertex_agent_protected_asset (agent_did, counterparty_ref);

CREATE INDEX IF NOT EXISTS idx_agent_counterparty_asset_src ON edge_agent_counterparty_protects_asset (src_vid);

CREATE INDEX IF NOT EXISTS idx_agent_minimax_agent_time ON vertex_agent_minimax_evaluation (agent_did, created_at);

CREATE INDEX IF NOT EXISTS idx_agent_minimax_counterparty ON vertex_agent_minimax_evaluation (counterparty_ref, evaluation_state);
