...
-- exist, a topology node bound as `kind=mcp_tool` `ref=mcp://ai.gftd.apps.saikin.<m>`
-- resolves to https://saikin.gftd.ai/xrpc/ai.gftd.mcp.message at runtime.
--
...
-- (`00-contracts/lexicons/ai/gftd/apps/saikin/*.json`); kept compact here
...
-- Python dispatcher (60-apps/ai-gftd-project-saikin/src/app.ts → DISPATCHER_URL).
-- The dispatcher does NOT yet handle ai.gftd.mcp.message envelopes — that
...
VALUES
  ('at://did:web:saikin.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-saikin-probeEnvironment',
   0, 0,
   'ai.gftd.apps.saikin.probeEnvironment', 'did:web:saikin.gftd.ai', 'saikin.gftd.ai', 'query',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/saikin/probeEnvironment.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),

  ('at://did:web:saikin.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-saikin-transferSignal',
   0, 0,
   'ai.gftd.apps.saikin.transferSignal', 'did:web:saikin.gftd.ai', 'saikin.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/saikin/transferSignal.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),

  ('at://did:web:saikin.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-saikin-formColony',
   0, 0,
   'ai.gftd.apps.saikin.formColony', 'did:web:saikin.gftd.ai', 'saikin.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/saikin/formColony.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),

  ('at://did:web:saikin.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-saikin-handoffToKi',
   0, 0,
   'ai.gftd.apps.saikin.handoffToKi', 'did:web:saikin.gftd.ai', 'saikin.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/saikin/handoffToKi.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),

  ('at://did:web:saikin.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-saikin-lyse',
   0, 0,
   'ai.gftd.apps.saikin.lyse', 'did:web:saikin.gftd.ai', 'saikin.gftd.ai', 'procedure',
   ...
   'public', 1, TRUE,
   '00-contracts/lexicons/ai/gftd/apps/saikin/lyse.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z');
