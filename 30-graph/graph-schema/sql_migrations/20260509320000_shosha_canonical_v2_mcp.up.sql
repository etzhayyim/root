...
VALUES
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-intelIngestPrices',
   0, 0, 'ai.gftd.apps.shosha.intelIngestPrices', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
  ...
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-intelIngestFreight',
   0, 0, 'ai.gftd.apps.shosha.intelIngestFreight', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-marketViewSynth',
   0, 0, 'ai.gftd.apps.shosha.marketViewSynth', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-sanctionsRefreshOfac',
   0, 0, 'ai.gftd.apps.shosha.sanctionsRefreshOfac', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-sanctionsRefreshUn',
   0, 0, 'ai.gftd.apps.shosha.sanctionsRefreshUn', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-exposureRecompute',
   0, 0, 'ai.gftd.apps.shosha.exposureRecompute', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-pnlDailyRecompute',
   0, 0, 'ai.gftd.apps.shosha.pnlDailyRecompute', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-tradeSynth',
   0, 0, 'ai.gftd.apps.shosha.tradeSynth', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   'shosha trade idea synth.', '{"type":"object"}', '{"type":"object"}',
   'public', 1, TRUE, '00-contracts/lexicons/ai/gftd/apps/shosha/tradeSynth.json',
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-dailyReportCompose',
   0, 0, 'ai.gftd.apps.shosha.dailyReportCompose', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-09T00:00:00Z'),
  ('at://did:web:shosha.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-apps-shosha-reactiveScanUpstream',
   0, 0, 'ai.gftd.apps.shosha.reactiveScanUpstream', 'did:web:shosha.gftd.ai', 'shosha.gftd.ai', 'procedure',
...
VALUES
  ('shosha_daily_report.v2', 0, 0, 'shosha_daily_report.v2', 2, 'topology', NULL,
   ...
   'rw_vertex', 'did:web:agent.shosha.gftd.ai'),
...
VALUES
  ...
  ('shosha_daily_report.v2:emit_audit', 0, 0, 'shosha_daily_report.v2', 'emit_audit',
   ...
   '{"input_keys":[],"result_key":"auditOut","args":{"name":"ai.gftd.tools.audit.emit","repo":"did:web:shosha.gftd.ai","collection":"ai.gftd.apps.shosha.audit","action":"daily_report"}}',
   '2026-05-09T00:00:00Z'),
  -- market_intelligence
  ...
  ('shosha_market_intelligence.v2:emit_audit', 0, 0, 'shosha_market_intelligence.v2', 'emit_audit',
   'mcp_tool', 'mcp://ai.gftd.tools.audit.emit',
   '{"input_keys":[],"result_key":"auditOut","args":{"name":"ai.gftd.tools.audit.emit","repo":"did:web:shosha.gftd.ai","collection":"ai.gftd.apps.shosha.audit","action":"market_intelligence"}}',
   '2026-05-09T00:00:00Z'),
  -- react_upstream
  ...
  ('shosha_react_upstream.v2:emit_audit', 0, 0, 'shosha_react_upstream.v2', 'emit_audit',
   'mcp_tool', 'mcp://ai.gftd.tools.audit.emit',
   '{"input_keys":[],"result_key":"auditOut","args":{"name":"ai.gftd.tools.audit.emit","repo":"did:web:shosha.gftd.ai","collection":"ai.gftd.apps.shosha.audit","action":"react_upstream"}}',
   '2026-05-09T00:00:00Z'),
  ...
  ('shosha_trade_book_recompute.v2:emit_audit', 0, 0, 'shosha_trade_book_recompute.v2', 'emit_audit',
   'mcp_tool', 'mcp://ai.gftd.tools.audit.emit',
   '{"input_keys":[],"result_key":"auditOut","args":{"name":"ai.gftd.tools.audit.emit","repo":"did:web:shosha.gftd.ai","collection":"ai.gftd.apps.shosha.audit","action":"trade_book_recompute"}}',
   '2026-05-09T00:00:00Z'),
  ...
  ('shosha_trade_idea_synthesize.v2:emit_audit', 0, 0, 'shosha_trade_idea_synthesize.v2', 'emit_audit',
   'mcp_tool', 'mcp://ai.gftd.tools.audit.emit',
   '{"input_keys":[],"result_key":"auditOut","args":{"name":"ai.gftd.tools.audit.emit","repo":"did:web:shosha.gftd.ai","collection":"ai.gftd.apps.shosha.audit","action":"trade_idea_synthesize"}}',
   '2026-05-09T00:00:00Z');
