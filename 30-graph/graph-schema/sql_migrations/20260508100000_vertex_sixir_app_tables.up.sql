...
CREATE INDEX IF NOT EXISTS idx_sixir_company_exchange ON vertex_sixir_company (exchange);
...
CREATE INDEX IF NOT EXISTS idx_sixir_filing_type ON vertex_sixir_filing (filing_type);
