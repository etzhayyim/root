...
CREATE INDEX IF NOT EXISTS idx_smishing_geo_url_id ON vertex_smishing_geo_intel (url_id);

CREATE INDEX IF NOT EXISTS idx_smishing_geo_analysis_id ON vertex_smishing_geo_intel (analysis_id);

CREATE INDEX IF NOT EXISTS idx_smishing_geo_domain ON vertex_smishing_geo_intel (domain);

CREATE INDEX IF NOT EXISTS idx_smishing_geo_country ON vertex_smishing_geo_intel (country);

CREATE INDEX IF NOT EXISTS idx_smishing_ioc_value ON vertex_smishing_ioc_indicator (value);

CREATE INDEX IF NOT EXISTS idx_smishing_ioc_type ON vertex_smishing_ioc_indicator (ioc_type);

CREATE INDEX IF NOT EXISTS idx_smishing_ioc_domain ON vertex_smishing_ioc_indicator (domain);

CREATE INDEX IF NOT EXISTS idx_smishing_ioc_source ON vertex_smishing_ioc_indicator (source_collection, source_rkey);
