GRANT SELECT ON TABLE vertex_crypto_asset_freeze_incident TO root;

GRANT SELECT ON TABLE vertex_crypto_asset_freeze_incident TO kaisya_app;
...
GRANT SELECT ON MATERIALIZED VIEW mv_world_vertex_per_host TO root;

GRANT SELECT ON MATERIALIZED VIEW mv_world_vertex_per_host TO kaisya_app;
