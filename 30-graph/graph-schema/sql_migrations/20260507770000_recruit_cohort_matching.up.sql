...
CREATE INDEX IF NOT EXISTS idx_recruit_match_proposal_posting ON vertex_recruit_match_proposal (posting_id);

CREATE INDEX IF NOT EXISTS idx_recruit_match_proposal_state ON vertex_recruit_match_proposal (proposal_state, match_score);

CREATE INDEX IF NOT EXISTS idx_recruit_match_proposal_cohort ON vertex_recruit_match_proposal (isco_code, country);
...
CREATE INDEX IF NOT EXISTS idx_recruit_match_decision_event_proposal ON vertex_recruit_match_decision_event (proposal_id, decided_at);
...
CREATE INDEX IF NOT EXISTS idx_edge_recruit_match_for_posting ON edge_recruit_match_for_posting (proposal_id, posting_id);
...
CREATE INDEX IF NOT EXISTS idx_edge_recruit_match_for_cohort ON edge_recruit_match_for_cohort (proposal_id, isco_code, country);
...
CREATE INDEX IF NOT EXISTS idx_mv_recruit_cohort_match_posting ON mv_recruit_cohort_match_candidate (posting_id);

CREATE INDEX IF NOT EXISTS idx_mv_recruit_cohort_match_filter ON mv_recruit_cohort_match_candidate (isco_code, country, match_score);
