...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/rl-aif-attribute-outcomes-v1',
                 ...
                 '\n'
                 '  NSID: ai.gftd.apps.rl.aifAttributeOutcomes\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/rl-aif-attribute-outcomes-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.apps.rl.aifAttributeOutcomes", "version": 1, '
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.lexiconBinding/rl-aif-attribute-outcomes-v1',
                 'did:web:bpmn.gftd.ai',
                 '2026-05-07T23:00:00Z',
                 'did:web:bpmn.gftd.ai',
                 'did:web:bpmn.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.lexiconBinding/rl-aif-attribute-outcomes-v1']}]
