...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/apqc-materialize-subprocesses-v1',
                 ...
                 '</bpmn:definitions>\n',
                 1594,
                 '00-contracts/bpmn/com/etzhayyim/apqc/materializeSubprocesses.bpmn',
                 '2026-04-30T22:40:00Z',
                 'did:web:kyber-projector.etzhayyim.com',
                 'did:web:kyber-projector.etzhayyim.com',
                 'sys.bpmn.seed.apqc',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/apqc-materialize-subprocesses-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/apqc-emit-event-v1',
                 'did:web:kyber-projector.etzhayyim.com',
                 'apqc_emit_event',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions\n'
                 ...
                 '</bpmn:definitions>\n',
                 2021,
                 '00-contracts/bpmn/com/etzhayyim/apqc/emitEvent.bpmn',
                 '2026-04-30T22:40:00Z',
                 'did:web:kyber-projector.etzhayyim.com',
                 'did:web:kyber-projector.etzhayyim.com',
                 'sys.bpmn.seed.apqc',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/apqc-emit-event-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/apqc-coverage-snapshot-v1',
                 'did:web:kyber-projector.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 1076,
                 '00-contracts/bpmn/com/etzhayyim/apqc/coverageSnapshot.bpmn',
                 '2026-04-30T22:40:00Z',
                 'did:web:kyber-projector.etzhayyim.com',
                 'did:web:kyber-projector.etzhayyim.com',
                 'sys.bpmn.seed.apqc',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/apqc-coverage-snapshot-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/apqc-materializeSubprocesses-v1',
                 'did:web:kyber-projector.etzhayyim.com',
                 'com.etzhayyim.apps.apqc.materializeSubprocesses',
                 'apqc_materialize_subprocesses',
                 60000,
                 '2026-04-30T22:40:00Z',
                 'did:web:kyber-projector.etzhayyim.com',
                 'did:web:kyber-projector.etzhayyim.com',
                 'sys.bpmn.seed.apqc',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/apqc-materializeSubprocesses-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/apqc-emitEvent-v1',
                 'did:web:kyber-projector.etzhayyim.com',
                 'com.etzhayyim.apps.apqc.emitEvent',
                 'apqc_emit_event',
                 60000,
                 '2026-04-30T22:40:00Z',
                 'did:web:kyber-projector.etzhayyim.com',
                 'did:web:kyber-projector.etzhayyim.com',
                 'sys.bpmn.seed.apqc',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/apqc-emitEvent-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/apqc-coverageSnapshot-v1',
                 'did:web:kyber-projector.etzhayyim.com',
                 'com.etzhayyim.apps.apqc.coverageSnapshot',
                 'apqc_coverage_snapshot',
                 30000,
                 '2026-04-30T22:40:00Z',
                 'did:web:kyber-projector.etzhayyim.com',
                 'did:web:kyber-projector.etzhayyim.com',
                 'sys.bpmn.seed.apqc',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/apqc-coverageSnapshot-v1']}]
