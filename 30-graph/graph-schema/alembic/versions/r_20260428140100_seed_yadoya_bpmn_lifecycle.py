...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-cancel-reservation-v1',
                 ...
                 '</bpmn:definitions>\n',
                 4260,
                 '00-contracts/bpmn/com/etzhayyim/yadoya/cancelReservation.bpmn',
                 '2026-04-28T14:01:00Z',
                 'did:web:yadoya.etzhayyim.com',
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-lifecycle',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-cancel-reservation-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-get-reservation-v1',
                 'did:web:yadoya.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2697,
                 '00-contracts/bpmn/com/etzhayyim/yadoya/getReservation.bpmn',
                 '2026-04-28T14:01:00Z',
                 'did:web:yadoya.etzhayyim.com',
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-lifecycle',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-get-reservation-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-cancelReservation-v1',
                 'did:web:yadoya.etzhayyim.com',
                 ...
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-lifecycle',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-cancelReservation-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-getReservation-v1',
                 'did:web:yadoya.etzhayyim.com',
                 ...
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-lifecycle',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-getReservation-v1']}]
