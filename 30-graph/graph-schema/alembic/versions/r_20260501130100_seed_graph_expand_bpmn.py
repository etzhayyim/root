...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/graph-expand-tick-v1',
                 ...
                 '\n'
                 '  NSID:      com.etzhayyim.apps.graph.expandTick\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/graph-expandTick-v1\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.graph.expandTick", "version": 1, '
                 ...
                 '\'anon\')&quot;" target="sql"/>\n'
                 '          <zeebe:input source="=[ '
                 '&quot;at://did:web:graph.etzhayyim.com/com.etzhayyim.apps.graph.expandProposal/&quot; + (if '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;com.etzhayyim.apps.graph.expand.proposal&quot;" '
                 'target="eventType"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 7830,
                 '00-contracts/bpmn/com/etzhayyim/graph/expandTick.bpmn',
                 '2026-05-01T13:00:00Z',
                 'did:web:graph.etzhayyim.com',
                 'did:web:graph.etzhayyim.com',
                 'sys.bpmn.seed.graph',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/graph-expand-tick-v1']},
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/graph-expandTick-v1',
                 'did:web:graph.etzhayyim.com',
                 'com.etzhayyim.apps.graph.expandTick',
                 'graph_expand_tick',
                 60000,
                 'vertex_graph_expand_proposal',
                 '2026-05-01T13:00:00Z',
                 ...
                 'sys.bpmn.seed.graph',
                 'did:web:graph.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/graph-expandTick-v1']}]
