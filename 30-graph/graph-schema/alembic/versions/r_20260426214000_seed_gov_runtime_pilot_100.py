"""Captured from Kysely migration 20260426214000_seed_gov_runtime_pilot_100."""
...
revision = "r_20260426214000_seed_gov_runtime_pilot_100"
down_revision = 'r_20260426210000_seed_gov_afg_bpmn_mcp_registry'
branch_labels = None
depends_on = None
...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['2026-04-26T21:40:00Z']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['2026-04-26T21:40:00Z', 'sys.gov.runtime.pilot-100']},
 {'sql': '\n'
 ...
 {'sql': '\n'
         ...
         "      WHERE m.vertex_id = CONCAT('at://', t.actor_did, '/ai.gftd.mcp.toolDef/', "
         "REPLACE(t.nsid, '.', '-'))\n"
         '    )\n'
         '  ',
  'parameters': ['sys.gov.runtime.pilot-100', '2026-04-26T21:40:00Z']}]

DOWN = [{'sql': 'DELETE FROM vertex_mcp_tool_def WHERE actor_id = $1',
  'parameters': ['sys.gov.runtime.pilot-100']},
 ...
 {'sql': '\n'
         ...
         '    WHERE did IN (SELECT actor_did FROM mv_gov_org_runtime ORDER BY gov_org_key LIMIT '
         '100)\n'
