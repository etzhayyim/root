...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-seedOrgs-v1',
                 ...
                 '    targetNamespace="https://gftd.ai/bpmn/govZaf"\n'
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-registerDIDs-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-followSiteDeps-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-ingestOfficialSources-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-ingestOfficialSources-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-resolveOrgPath-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-listOrgs-v1',
                 'did:web:zaf-state.gftd.ai',
                 'gov_zaf_list_orgs',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions\n'
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-syncWetUpdates-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-shinka-v1',
                 'did:web:zaf-state.gftd.ai',
                 'gov_zaf_shinka',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions\n'
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-heartbeatTick-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'did:web:zaf-state.gftd.ai',
                 'sys.bpmn.seed.gov-zaf',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/gov-zaf-heartbeatTick-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-seedOrgs-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-registerDIDs-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-followSiteDeps-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-ingestOfficialSources-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-ingestOfficialSources-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-resolveOrgPath-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-listOrgs-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-syncWetUpdates-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-shinka-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-heartbeatTick-v1',
                 'did:web:zaf-state.gftd.ai',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ai-gftd-govZaf-heartbeatTick-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-seedOrgs',
                 'ai.gftd.govZaf.seedOrgs',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-registerDIDs',
                 'ai.gftd.govZaf.registerDIDs',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-followSiteDeps',
                 'ai.gftd.govZaf.followSiteDeps',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-ingestOfficialSources',
                 'ai.gftd.govZaf.ingestOfficialSources',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 'Queue official South Africa government sources through site.gftd.ai for '
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-ingestOfficialSources']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-resolveOrgPath',
                 'ai.gftd.govZaf.resolveOrgPath',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-listOrgs',
                 'ai.gftd.govZaf.listOrgs',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-syncWetUpdates',
                 'ai.gftd.govZaf.syncWetUpdates',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-shinka',
                 'ai.gftd.govZaf.shinka',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-heartbeatTick',
                 'ai.gftd.govZaf.heartbeatTick',
                 'did:web:zaf-state.gftd.ai',
                 'zaf-state.gftd.ai',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zaf',
                 '2026-04-26T23:00:00Z',
                 'at://did:web:zaf-state.gftd.ai/ai.gftd.mcp.toolDef/ai-gftd-govZaf-heartbeatTick']}]
