...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-network-define-link-v1',
                 'did:web:open-network.etzhayyim.com:core',
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:open-network.etzhayyim.com:core&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 5053,
                 '00-contracts/bpmn/com/etzhayyim/open-network/defineLink.bpmn',
                 '2026-04-24T13:30:00Z',
                 'did:web:open-network.etzhayyim.com:core',
                 'did:web:open-network.etzhayyim.com:core',
                 'sys.bpmn.seed.open-network',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-network-define-link-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-network-request-change-v1',
                 'did:web:open-network.etzhayyim.com:core',
                 ...
                 '</bpmn:definitions>\n',
                 5753,
                 '00-contracts/bpmn/com/etzhayyim/open-network/requestChange.bpmn',
                 '2026-04-24T13:30:00Z',
                 'did:web:open-network.etzhayyim.com:core',
                 'did:web:open-network.etzhayyim.com:core',
                 'sys.bpmn.seed.open-network',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-network-request-change-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-network-defineLink-v1',
                 'did:web:open-network.etzhayyim.com:core',
                 ...
                 'did:web:open-network.etzhayyim.com:core',
                 'sys.bpmn.seed.open-network',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-network-defineLink-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-network-requestChange-v1',
                 'did:web:open-network.etzhayyim.com:core',
                 ...
                 'did:web:open-network.etzhayyim.com:core',
                 'sys.bpmn.seed.open-network',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-network-requestChange-v1']}]
