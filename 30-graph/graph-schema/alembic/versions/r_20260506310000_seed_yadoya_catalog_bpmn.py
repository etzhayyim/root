...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-search-hotels-v1',
                 ...
                 'type="xrpc.com.etzhayyim.apps.yadoya.searchHotels"/>\n'
                 '        <zeebe:ioMapping>\n'
                 ...
                 '</bpmn:definitions>\n',
                 1224,
                 '00-contracts/bpmn/com/etzhayyim/yadoya/searchHotels.bpmn',
                 '2026-05-06T22:00:00Z',
                 'did:web:yadoya.etzhayyim.com',
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-catalog',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-search-hotels-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-list-hotels-v1',
                 'did:web:yadoya.etzhayyim.com',
                 'yadoya_list_hotels',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 '      <bpmn:extensionElements><zeebe:taskDefinition '
                 'type="xrpc.com.etzhayyim.apps.yadoya.listHotels"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:output source="=hotels" target="hotels"/>\n'
                 '          <zeebe:output source="=total" target="total"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 1324,
                 '00-contracts/bpmn/com/etzhayyim/yadoya/listHotels.bpmn',
                 '2026-05-06T22:00:00Z',
                 'did:web:yadoya.etzhayyim.com',
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-catalog',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/yadoya-list-hotels-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-searchHotels-v1',
                 'did:web:yadoya.etzhayyim.com',
                 ...
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-catalog',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-searchHotels-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-listHotels-v1',
                 'did:web:yadoya.etzhayyim.com',
                 ...
                 'did:web:yadoya.etzhayyim.com',
                 'sys.bpmn.seed.yadoya-catalog',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/yadoya-listHotels-v1']}]
