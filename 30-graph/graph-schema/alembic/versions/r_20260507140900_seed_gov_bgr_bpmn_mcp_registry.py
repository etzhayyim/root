...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-seedOrgs-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-registerDIDs-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-followSiteDeps-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-resolveOrgPath-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-listOrgs-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-syncWetUpdates-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-shinka-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-heartbeatTick-v1',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBgr-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-seedOrgs',
                 'com.etzhayyim.govBgr.seedOrgs',
                 'did:web:bgr-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-registerDIDs',
                 'com.etzhayyim.govBgr.registerDIDs',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-followSiteDeps',
                 'com.etzhayyim.govBgr.followSiteDeps',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-resolveOrgPath',
                 'com.etzhayyim.govBgr.resolveOrgPath',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-listOrgs',
                 'com.etzhayyim.govBgr.listOrgs',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-syncWetUpdates',
                 'com.etzhayyim.govBgr.syncWetUpdates',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-shinka',
                 'com.etzhayyim.govBgr.shinka',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-heartbeatTick',
                 'com.etzhayyim.govBgr.heartbeatTick',
                 'did:web:bgr-state.etzhayyim.com',
                 'bgr-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bgr',
                 '2026-05-07T14:09:00Z',
                 'at://did:web:bgr-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBgr-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
