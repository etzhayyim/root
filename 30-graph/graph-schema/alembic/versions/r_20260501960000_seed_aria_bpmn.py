...
UP = [{'sql': '\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/aria-attention-ingest-v1',
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.apps.aria.attentionIngest", "version": 1, "tier": "T2" '
                 '}\n'
                 '    </bpmn:documentation>\n'
                 '\n'
 ...
 {'sql': '\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/aria-request-ingest-v1',
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.apps.aria.requestIngest", "version": 1, "tier": "T2" }\n'
                 '    </bpmn:documentation>\n'
                 '\n'
 ...
 {'sql': '\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/aria-money-flow-ingest-v1',
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.apps.aria.moneyFlowIngest", "version": 1, "tier": "T2" '
                 '}\n'
                 '    </bpmn:documentation>\n'
                 '\n'
 ...
 {'sql': '\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/aria-minimax-sweep-v1',
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.apps.aria.minimaxSweep", "version": 1, "tier": "T2" }\n'
                 '    </bpmn:documentation>\n'
                 '\n'
                 '    <!-- R/PT5M: fires every 5 minutes indefinitely -->\n'
                 '    <bpmn:startEvent id="Start_Timer" name="R/PT5M">\n'
