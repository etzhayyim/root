...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-seedOrgs-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-registerDIDs-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-followSiteDeps-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-resolveOrgPath-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-listOrgs-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-syncWetUpdates-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-shinka-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-heartbeatTick-v1',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govTur-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-seedOrgs',
                 'com.etzhayyim.govTur.seedOrgs',
                 'did:web:tur-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-registerDIDs',
                 'com.etzhayyim.govTur.registerDIDs',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-followSiteDeps',
                 'com.etzhayyim.govTur.followSiteDeps',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-resolveOrgPath',
                 'com.etzhayyim.govTur.resolveOrgPath',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-listOrgs',
                 'com.etzhayyim.govTur.listOrgs',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-syncWetUpdates',
                 'com.etzhayyim.govTur.syncWetUpdates',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-shinka',
                 'com.etzhayyim.govTur.shinka',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-heartbeatTick',
                 'com.etzhayyim.govTur.heartbeatTick',
                 'did:web:tur-state.etzhayyim.com',
                 'tur-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-tur',
                 '2026-05-07T16:01:00Z',
                 'at://did:web:tur-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govTur-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
