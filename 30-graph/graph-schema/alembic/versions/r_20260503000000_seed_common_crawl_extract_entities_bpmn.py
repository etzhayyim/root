...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/common-crawl-extract-entities-v1',
                 ...
                 'name="ai.gftd.apps.commonCrawl.extractEntities" isExecutable="true">\n'
                 '\n'
                 ...
                 'target="subject_id" />\n'
                 '          <zeebe:input source="=&quot;ai.gftd.apps.commonCrawl&quot;"        '
                 'target="actor" />\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/common-crawl-extractEntities-v1',
                 'did:web:bpmn.etzhayyim.com',
...
DOWN = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    WHERE nsid = $1\n'
         '  ',
  'parameters': ['ai.gftd.apps.commonCrawl.extractEntities']}]
