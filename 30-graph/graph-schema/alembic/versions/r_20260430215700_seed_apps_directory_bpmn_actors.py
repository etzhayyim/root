...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-register-app-listing-v1',
                 ...
                 '"app.etzhayyim.apps.apps.registerAppListing", "version": 1, "resultTimeoutMs": 30000 '
                 ...
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-register-app-listing-v1']},
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-register-app-listing-v1',
                 'did:web:apps.etzhayyim.com',
                 'app.etzhayyim.apps.apps.registerAppListing',
                 'apps_directory_register_app_listing',
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-register-app-listing-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-update-app-listing-v1',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'isExecutable="true"><bpmn:documentation>{ "nsid": '
                 '"app.etzhayyim.apps.apps.updateAppListing", "version": 1, "resultTimeoutMs": 30000 '
                 '}</bpmn:documentation><bpmn:startEvent '
                 'id="Start"><bpmn:outgoing>F1</bpmn:outgoing></bpmn:startEvent><bpmn:sequenceFlow '
                 'id="F1" sourceRef="Start" targetRef="Task"/><bpmn:serviceTask id="Task" '
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-update-app-listing-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-update-app-listing-v1',
                 'did:web:apps.etzhayyim.com',
                 'app.etzhayyim.apps.apps.updateAppListing',
                 'apps_directory_update_app_listing',
                 'vertex_apps_directory_listing,vertex_apps_directory_feature,vertex_apps_directory_install_intent,edge_apps_directory_listing_feature,edge_apps_directory_listing_install_intent',
                 '2026-04-30T21:57:00+09:00',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-update-app-listing-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-list-apps-v1',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'isExecutable="true"><bpmn:documentation>{ "nsid": "app.etzhayyim.apps.apps.listApps", '
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-list-apps-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-list-apps-v1',
                 'did:web:apps.etzhayyim.com',
                 'app.etzhayyim.apps.apps.listApps',
                 'apps_directory_list_apps',
                 '',
                 '2026-04-30T21:57:00+09:00',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-list-apps-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-get-app-listing-v1',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'isExecutable="true"><bpmn:documentation>{ "nsid": '
                 '"app.etzhayyim.apps.apps.getAppListing", "version": 1, "resultTimeoutMs": 30000 '
                 '}</bpmn:documentation><bpmn:startEvent '
                 'id="Start"><bpmn:outgoing>F1</bpmn:outgoing></bpmn:startEvent><bpmn:sequenceFlow '
                 'id="F1" sourceRef="Start" targetRef="Task"/><bpmn:serviceTask id="Task" '
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-get-app-listing-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-get-app-listing-v1',
                 'did:web:apps.etzhayyim.com',
                 'app.etzhayyim.apps.apps.getAppListing',
                 'apps_directory_get_app_listing',
                 '',
                 '2026-04-30T21:57:00+09:00',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-get-app-listing-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-feature-app-v1',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'isExecutable="true"><bpmn:documentation>{ "nsid": '
                 '"app.etzhayyim.apps.apps.featureApp", "version": 1, "resultTimeoutMs": 30000 '
                 '}</bpmn:documentation><bpmn:startEvent '
                 'id="Start"><bpmn:outgoing>F1</bpmn:outgoing></bpmn:startEvent><bpmn:sequenceFlow '
                 'id="F1" sourceRef="Start" targetRef="Task"/><bpmn:serviceTask id="Task" '
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-feature-app-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-feature-app-v1',
                 'did:web:apps.etzhayyim.com',
                 'app.etzhayyim.apps.apps.featureApp',
                 'apps_directory_feature_app',
                 'vertex_apps_directory_listing,vertex_apps_directory_feature,vertex_apps_directory_install_intent,edge_apps_directory_listing_feature,edge_apps_directory_listing_install_intent',
                 '2026-04-30T21:57:00+09:00',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-feature-app-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-record-install-intent-v1',
                 'did:web:apps.etzhayyim.com',
                 ...
                 '"app.etzhayyim.apps.apps.recordInstallIntent", "version": 1, "resultTimeoutMs": 30000 '
                 '}</bpmn:documentation><bpmn:startEvent '
                 'id="Start"><bpmn:outgoing>F1</bpmn:outgoing></bpmn:startEvent><bpmn:sequenceFlow '
                 'id="F1" sourceRef="Start" targetRef="Task"/><bpmn:serviceTask id="Task" '
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/apps-directory-record-install-intent-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-record-install-intent-v1',
                 'did:web:apps.etzhayyim.com',
                 'app.etzhayyim.apps.apps.recordInstallIntent',
                 'apps_directory_record_install_intent',
                 'vertex_apps_directory_listing,vertex_apps_directory_feature,vertex_apps_directory_install_intent,edge_apps_directory_listing_feature,edge_apps_directory_listing_install_intent',
                 '2026-04-30T21:57:00+09:00',
                 'did:web:apps.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.apps-directory',
                 'did:web:apps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/apps-directory-record-install-intent-v1']}]
