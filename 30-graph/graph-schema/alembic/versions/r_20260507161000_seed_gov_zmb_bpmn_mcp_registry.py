...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-seedOrgs-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-registerDIDs-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-followSiteDeps-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-resolveOrgPath-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-listOrgs-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-syncWetUpdates-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-shinka-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-heartbeatTick-v1',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govZmb-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-seedOrgs',
                 'com.etzhayyim.govZmb.seedOrgs',
                 'did:web:zmb-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-registerDIDs',
                 'com.etzhayyim.govZmb.registerDIDs',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-followSiteDeps',
                 'com.etzhayyim.govZmb.followSiteDeps',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-resolveOrgPath',
                 'com.etzhayyim.govZmb.resolveOrgPath',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-listOrgs',
                 'com.etzhayyim.govZmb.listOrgs',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-syncWetUpdates',
                 'com.etzhayyim.govZmb.syncWetUpdates',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-shinka',
                 'com.etzhayyim.govZmb.shinka',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-heartbeatTick',
                 'com.etzhayyim.govZmb.heartbeatTick',
                 'did:web:zmb-state.etzhayyim.com',
                 'zmb-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-zmb',
                 '2026-05-07T16:10:00Z',
                 'at://did:web:zmb-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govZmb-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
