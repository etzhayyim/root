...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kouza-sync-due-connections-v1',
                 ...
                 '        <zeebe:taskDefinition type="com.etzhayyim.kouza.syncDueConnections"/>\n'
                 '        <zeebe:ioMapping>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3253,
                 '00-contracts/bpmn/com/etzhayyim/kouza/syncDueConnections.bpmn',
                 '2026-04-25T16:50:00Z',
                 'did:web:kouza.etzhayyim.com',
                 'did:web:kouza.etzhayyim.com',
                 'sys.bpmn.seed.kouza',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kouza-sync-due-connections-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kouza-syncDueConnections-v1',
                 'did:web:kouza.etzhayyim.com',
                 'com.etzhayyim.apps.kouza.syncDueConnections',
                 'kouza_sync_due_connections',
                 120000,
                 '2026-04-25T16:50:00Z',
                 'did:web:kouza.etzhayyim.com',
                 'did:web:kouza.etzhayyim.com',
                 'sys.bpmn.seed.kouza',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kouza-syncDueConnections-v1']}]
