...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-seed-allergen-catalog-v1',
                 'did:web:mold-allergy.gftd.ai',
                 'mold_allergy_seed_allergen_catalog',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 'xmlns:zeebe="http://camunda.org/schema/zeebe/1.0" '
                 'id="Definitions_mold_allergy_seed_allergen_catalog" '
                 'targetNamespace="https://gftd.ai/bpmn/moldAllergy"><bpmn:process '
                 ...
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-seed-allergen-catalog-v1']},
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-seedAllergenCatalog-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-seedAllergenCatalog-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-record-air-sampling-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-record-air-sampling-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-recordAirSampling-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-recordAirSampling-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-propose-slit-candidate-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-propose-slit-candidate-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-proposeSlitCandidate-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-proposeSlitCandidate-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-list-allergens-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-list-allergens-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-listAllergens-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-listAllergens-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-list-slit-candidates-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/mold-allergy-list-slit-candidates-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-listSlitCandidates-v1',
                 'did:web:mold-allergy.gftd.ai',
                 ...
                 'sys.bpmn.seed.mold-allergy',
                 'did:web:mold-allergy.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/mold-allergy-listSlitCandidates-v1']}]
