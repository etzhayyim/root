...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jp-fiscal-edinet-daily-v1',
                 ...
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jp-fiscal-edinet-daily-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.jpFiscal.fiscalEdinetDaily", "version": 1, '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input '
                 'source="=&quot;com.etzhayyim.apps.jpFiscal.fiscalEdinetDaily&quot;"  '
                 'target="event_type"/>\n'
                 '          <zeebe:input '
                 ...
                 '</bpmn:definitions>\n',
                 3435,
                 '00-contracts/bpmn/com/etzhayyim/jp-fiscal/fiscalEdinetDaily.bpmn',
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jp-fiscal-edinet-daily-v1',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'com.etzhayyim.apps.jpFiscal.fiscalEdinetDaily',
                 'jp_fiscal_edinet_daily',
                 300000,
                 '2026-04-29T13:01:00Z',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'sys.bpmn.seed.jp-fiscal',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jp-fiscal-edinet-daily-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jp-fiscal-contract-weekly-v1',
                 'did:web:jp-fiscal.etzhayyim.com',
                 ...
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jp-fiscal-contract-weekly-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 '    xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"\n'
                 '    xmlns:zeebe="http://camunda.org/schema/zeebe/1.0"\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.jpFiscal.fiscalContractWeekly", "version": 1, '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input '
                 'source="=&quot;com.etzhayyim.apps.jpFiscal.fiscalContractWeekly&quot;"  '
                 'target="event_type"/>\n'
                 '          <zeebe:input '
                 'source="=&quot;did:web:jp-fiscal.etzhayyim.com&quot;"                    '
                 'target="actor_did"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3473,
                 '00-contracts/bpmn/com/etzhayyim/jp-fiscal/fiscalContractWeekly.bpmn',
                 '2026-04-29T13:01:00Z',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'sys.bpmn.seed.jp-fiscal',
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jp-fiscal-contract-weekly-v1',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'com.etzhayyim.apps.jpFiscal.fiscalContractWeekly',
                 'jp_fiscal_contract_weekly',
                 600000,
                 '2026-04-29T13:01:00Z',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'did:web:jp-fiscal.etzhayyim.com',
                 'sys.bpmn.seed.jp-fiscal',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jp-fiscal-contract-weekly-v1']}]
