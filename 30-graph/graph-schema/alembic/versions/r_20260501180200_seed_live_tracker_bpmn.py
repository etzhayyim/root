...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-liveTrackAircraft-v1',
                 ...
                 '\n'
                 '  com.etzhayyim.apps.maps.liveTrackAircraft.\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-liveTrackAircraft-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.maps.liveTrackAircraft", "version": 1, '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;com.etzhayyim.apps.maps.liveTrackAircraft&quot;" '
                 'target="eventType"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 4322,
                 '00-contracts/bpmn/com/etzhayyim/maps/liveTrackAircraft.bpmn',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-liveTrackAircraft-v1',
                 'did:web:maps.etzhayyim.com',
                 'com.etzhayyim.apps.maps.liveTrackAircraft',
                 'maps_live_track_aircraft',
                 30000,
                 ...
                 'sys.bpmn.seed.maps-live-tracker',
                 'did:web:maps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-liveTrackAircraft-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-computeAircraftTrack-v1',
                 'did:web:maps.etzhayyim.com',
                 ...
                 '\n'
                 '  com.etzhayyim.apps.maps.computeAircraftTrack.\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-computeAircraftTrack-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 '    xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"\n'
                 '    xmlns:zeebe="http://camunda.org/schema/zeebe/1.0"\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.maps.computeAircraftTrack", "version": 1, '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input '
                 'source="=&quot;com.etzhayyim.apps.maps.computeAircraftTrack&quot;" '
                 'target="eventType"/>\n'
                 '          <zeebe:input source="={ &quot;runId&quot;: runId, '
                 ...
                 '</bpmn:definitions>\n',
                 3320,
                 '00-contracts/bpmn/com/etzhayyim/maps/computeAircraftTrack.bpmn',
                 '2026-05-01T17:00:00Z',
                 'did:web:maps.etzhayyim.com',
                 'did:web:maps.etzhayyim.com',
                 'sys.bpmn.seed.maps-live-tracker',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-computeAircraftTrack-v1',
                 'did:web:maps.etzhayyim.com',
                 'com.etzhayyim.apps.maps.computeAircraftTrack',
                 'maps_compute_aircraft_track',
                 120000,
                 ...
                 'sys.bpmn.seed.maps-live-tracker',
                 'did:web:maps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-computeAircraftTrack-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-refreshTleCatalog-v1',
                 'did:web:maps.etzhayyim.com',
                 ...
                 '\n'
                 '  com.etzhayyim.apps.maps.refreshTleCatalog.\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-refreshTleCatalog-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 '    xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"\n'
                 '    xmlns:zeebe="http://camunda.org/schema/zeebe/1.0"\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.maps.refreshTleCatalog", "version": 1, '
                 ...
                 '        <zeebe:taskDefinition type="generic.audit.emit"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;com.etzhayyim.apps.maps.refreshTleCatalog&quot;" '
                 'target="eventType"/>\n'
                 '          <zeebe:input source="={ &quot;runId&quot;: runId, '
                 ...
                 '</bpmn:definitions>\n',
                 3390,
                 '00-contracts/bpmn/com/etzhayyim/maps/refreshTleCatalog.bpmn',
                 '2026-05-01T17:00:00Z',
                 'did:web:maps.etzhayyim.com',
                 'did:web:maps.etzhayyim.com',
                 'sys.bpmn.seed.maps-live-tracker',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-refreshTleCatalog-v1',
                 'did:web:maps.etzhayyim.com',
                 'com.etzhayyim.apps.maps.refreshTleCatalog',
                 'maps_refresh_tle_catalog',
                 300000,
                 ...
                 'sys.bpmn.seed.maps-live-tracker',
                 'did:web:maps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-refreshTleCatalog-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-precomputeSatellitePasses-v1',
                 'did:web:maps.etzhayyim.com',
                 ...
                 '\n'
                 '  com.etzhayyim.apps.maps.precomputeSatellitePasses.\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/maps-precomputeSatellitePasses-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 '    xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL"\n'
                 '    xmlns:zeebe="http://camunda.org/schema/zeebe/1.0"\n'
                 ...
                 '\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.maps.precomputeSatellitePasses", "version": 1, '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input '
                 'source="=&quot;com.etzhayyim.apps.maps.precomputeSatellitePasses&quot;" '
                 'target="eventType"/>\n'
                 '          <zeebe:input source="={ &quot;runId&quot;: runId, '
                 ...
                 '</bpmn:definitions>\n',
                 3888,
                 '00-contracts/bpmn/com/etzhayyim/maps/precomputeSatellitePasses.bpmn',
                 '2026-05-01T17:00:00Z',
                 'did:web:maps.etzhayyim.com',
                 'did:web:maps.etzhayyim.com',
                 'sys.bpmn.seed.maps-live-tracker',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-precomputeSatellitePasses-v1',
                 'did:web:maps.etzhayyim.com',
                 'com.etzhayyim.apps.maps.precomputeSatellitePasses',
                 'maps_precompute_satellite_passes',
                 600000,
                 ...
                 'sys.bpmn.seed.maps-live-tracker',
                 'did:web:maps.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/maps-precomputeSatellitePasses-v1']}]
