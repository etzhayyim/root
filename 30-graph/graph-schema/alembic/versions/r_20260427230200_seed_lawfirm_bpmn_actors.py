...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-run-conflict-check-v1',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-run-conflict-check-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-submit-filing-v1',
                 'did:web:lawfirm.etzhayyim.com',
                 ...
                 '+ &quot;/com.etzhayyim.apps.lawfirm.filing/&quot; + filingId, matter_uri: matterUri, '
                 ...
                 'source="=&quot;did:web:lawfirm.etzhayyim.com&quot;" target="actor"/><zeebe:input '
                 ...
                 '</bpmn:definitions>\n',
                 3759,
                 '00-contracts/bpmn/com/etzhayyim/lawfirm/submitFiling.bpmn',
                 '2026-04-27T23:02:00Z',
                 'did:web:lawfirm.etzhayyim.com',
                 'did:web:lawfirm.etzhayyim.com',
                 'sys.bpmn.seed.lawfirm',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-submit-filing-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-issue-invoice-v1',
                 'did:web:lawfirm.etzhayyim.com',
                 ...
                 '&quot;/com.etzhayyim.apps.lawfirm.invoice/&quot; + invoiceId, matter_uri: matterUri, '
                 ...
                 '</bpmn:definitions>\n',
                 4173,
                 '00-contracts/bpmn/com/etzhayyim/lawfirm/issueInvoice.bpmn',
                 '2026-04-27T23:02:00Z',
                 'did:web:lawfirm.etzhayyim.com',
                 'did:web:lawfirm.etzhayyim.com',
                 'sys.bpmn.seed.lawfirm',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/lawfirm-issue-invoice-v1']},
 {'sql': '\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-runConflictCheck-v1',
                 ...
                 'did:web:lawfirm.etzhayyim.com',
                 'sys.bpmn.seed.lawfirm',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-runConflictCheck-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-submitFiling-v1',
                 'did:web:lawfirm.etzhayyim.com',
                 'com.etzhayyim.apps.lawfirm.submitFiling',
                 'lawfirm_submit_filing',
                 60000,
                 '2026-04-27T23:02:00Z',
                 'did:web:lawfirm.etzhayyim.com',
                 'did:web:lawfirm.etzhayyim.com',
                 'sys.bpmn.seed.lawfirm',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-submitFiling-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-issueInvoice-v1',
                 'did:web:lawfirm.etzhayyim.com',
                 'com.etzhayyim.apps.lawfirm.issueInvoice',
                 'lawfirm_issue_invoice',
                 60000,
                 '2026-04-27T23:02:00Z',
                 'did:web:lawfirm.etzhayyim.com',
                 'did:web:lawfirm.etzhayyim.com',
                 'sys.bpmn.seed.lawfirm',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/lawfirm-issueInvoice-v1']}]
