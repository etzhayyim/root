...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/blockchain-bitcoin-head-delta-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3918,
                 '00-contracts/bpmn/com/etzhayyim/ingest/blockchainBitcoinHeadDelta.bpmn',
                 '2026-04-25T17:30:00Z',
                 'did:web:blockchain.etzhayyim.com',
                 'did:web:blockchain.etzhayyim.com',
                 'sys.bpmn.seed.blockchain-ingest',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/blockchain-bitcoin-head-delta-v1']},
 {'sql': '\n'
         ...
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ingest-start-blockchain-bitcoin-head-delta-v1',
                 ...
                 'did:web:ingest.etzhayyim.com',
                 'sys.bpmn.seed.blockchain-ingest',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ingest-start-blockchain-bitcoin-head-delta-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/blockchain-ethereum-head-delta-v1',
                 'did:web:blockchain.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 3925,
                 '00-contracts/bpmn/com/etzhayyim/ingest/blockchainEthereumHeadDelta.bpmn',
                 '2026-04-25T17:30:00Z',
                 'did:web:blockchain.etzhayyim.com',
                 'did:web:blockchain.etzhayyim.com',
                 'sys.bpmn.seed.blockchain-ingest',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/blockchain-ethereum-head-delta-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $8)\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ingest-start-blockchain-ethereum-head-delta-v1',
                 'did:web:ingest.etzhayyim.com',
                 'blockchain_ethereum_head_delta',
                 '2026-04-25T17:30:00Z',
                 'did:web:ingest.etzhayyim.com',
                 'did:web:ingest.etzhayyim.com',
                 'sys.bpmn.seed.blockchain-ingest',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ingest-start-blockchain-ethereum-head-delta-v1']}]
