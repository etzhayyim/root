...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/shosha-approve-trade-v1',
                 'did:web:shosha.gftd.ai',
                 'shosha_approve_trade',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<!--\n'
                 '  shosha.gftd.ai — approveTrade workflow (XRPC '
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/shosha-approve-trade-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/shosha-reject-trade-v1',
                 'did:web:shosha.gftd.ai',
                 'shosha_reject_trade',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<!--\n'
                 '  shosha.gftd.ai — rejectTrade workflow (XRPC ai.gftd.apps.shosha.rejectTrade).\n'
                 '\n'
                 '  Pipeline:\n'
                 ...
                 'did:web:shosha.gftd.ai',
                 'sys.bpmn.seed.shosha.phase2d',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/shosha-reject-trade-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/shosha-approveTrade-v1',
                 'did:web:shosha.gftd.ai',
                 'ai.gftd.apps.shosha.approveTrade',
                 'shosha_approve_trade',
                 30000,
                 ...
                 'did:web:shosha.gftd.ai',
                 'sys.bpmn.seed.shosha.phase2d',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/shosha-approveTrade-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/shosha-rejectTrade-v1',
                 'did:web:shosha.gftd.ai',
                 ...
                 'did:web:shosha.gftd.ai',
                 'sys.bpmn.seed.shosha.phase2d',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/shosha-rejectTrade-v1']}]
