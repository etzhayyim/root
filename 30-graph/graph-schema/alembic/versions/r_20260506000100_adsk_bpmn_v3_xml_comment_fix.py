"""Captured from Kysely migration 20260506000100_adsk_bpmn_v3_xml_comment_fix."""
...
revision = "r_20260506000100_adsk_bpmn_v3_xml_comment_fix"
down_revision = 'r_20260506000000_adsk_bpmn_v2_cron_timer'
branch_labels = None
depends_on = None
...
UP = [{'sql': 'DELETE FROM vertex_bpmn_process_def WHERE vertex_id = $1',
 ...
 {'sql': '\n'
         ...
         'actor_id)\n'
         "    SELECT $1, $2, $3, CAST(3 AS int), $4, CAST($5 AS integer), $6, 'active', $7, CAST(1 "
         'AS int), $8, $9, $10\n'
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/adsk-ingest-dataset-v3',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/adsk-ingest-dataset-v3']}]
