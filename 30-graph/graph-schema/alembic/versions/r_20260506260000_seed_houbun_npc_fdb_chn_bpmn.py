"""Captured from Kysely migration 20260506260000_seed_houbun_npc_fdb_chn_bpmn."""
...
revision = "r_20260506260000_seed_houbun_npc_fdb_chn_bpmn"
down_revision = 'r_20260506250000_seed_hf_model_bpmn'
branch_labels = None
depends_on = None
...
UP = [{'sql': '\n'
         ...
         '    )\n'
         "    SELECT $1, $2, 'ingest_houbun_npc_fdb_chn_delta',\n"
         "           1, $3, 6563, $4, 'active',\n"
         '           $5, 1, $6, $7, $8\n'
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $9)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/ingest-houbun-npc-fdb-chn-delta-v1',
                 ...
                 '    id="Definitions_ingest_houbun_npc_fdb_chn_delta"\n'
                 '    targetNamespace="https://gftd.ai/bpmn/ingest"\n'
                 '    exporter="hand-written"\n'
                 '    exporterVersion="1.0">\n'
                 '  <bpmn:process id="ingest_houbun_npc_fdb_chn_delta" name="ingest houbun NPC FDB '
                 'CHN delta" isExecutable="true">\n'
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;npc-fdb-chn&quot;" target="sourceId"/>\n'
                 '        </zeebe:ioMapping>\n'
                 '      </bpmn:extensionElements>\n'
                 ...
                 '\n'
                 '    <bpmn:serviceTask id="Task_Plan" name="plan NPC FDB CHN shard">\n'
                 '      <bpmn:extensionElements>\n'
                 '        <zeebe:taskDefinition type="houbun.npcFdbChn.plan" retries="2"/>\n'
                 '      </bpmn:extensionElements>\n'
                 ...
                 '\n'
                 '    <bpmn:serviceTask id="Task_Fetch" name="fetch NPC FDB law detail">\n'
                 '      <bpmn:extensionElements>\n'
                 '        <zeebe:taskDefinition type="houbun.npcFdbChn.fetch" retries="3"/>\n'
                 '      </bpmn:extensionElements>\n'
                 ...
                 'targetRef="Task_Audit"/>\n'
                 '\n'
                 '    <bpmn:serviceTask id="Task_Audit" name="emit houbun NPC FDB CHN delta '
                 'audit">\n'
                 '      <bpmn:extensionElements>\n'
                 ...
                 '  </bpmn:process>\n'
                 '</bpmn:definitions>\n',
                 '00-contracts/bpmn/ai/gftd/ingest/houbunNpcFdbChnDelta.bpmn',
                 '2026-05-06T26:00:00Z',
                 'did:web:ingest.gftd.ai',
                 'did:web:ingest.gftd.ai',
                 'sys.bpmn.seed.ingest-houbun-chn',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/ingest-houbun-npc-fdb-chn-delta-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ingest-start-houbun-npc-fdb-chn-delta-v1',
                 'did:web:ingest.gftd.ai',
                 '2026-05-06T26:00:00Z',
                 'did:web:ingest.gftd.ai',
                 'did:web:ingest.gftd.ai',
                 'sys.bpmn.seed.ingest-houbun-chn',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ingest-start-houbun-npc-fdb-chn-delta-v1']}]
