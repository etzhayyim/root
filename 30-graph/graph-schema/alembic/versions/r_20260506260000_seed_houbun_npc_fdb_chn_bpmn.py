...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/ingest-houbun-npc-fdb-chn-delta-v1',
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input '
                 'source="=&quot;com.etzhayyim.ingest.houbunNpcFdbChnDelta.completed&quot;" '
                 'target="eventType"/>\n'
                 ...
                 '  </bpmn:process>\n'
                 '</bpmn:definitions>\n',
                 '00-contracts/bpmn/com/etzhayyim/ingest/houbunNpcFdbChnDelta.bpmn',
 ...
 {'sql': '\n'
         ...
         '    )\n'
         "    SELECT $1, $2, 'com.etzhayyim.apps.ingest.startNpcFdbChn',\n"
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ingest-start-houbun-npc-fdb-chn-delta-v1',
                 'did:web:ingest.etzhayyim.com',
                 '2026-05-06T26:00:00Z',
                 'did:web:ingest.etzhayyim.com',
                 'did:web:ingest.etzhayyim.com',
