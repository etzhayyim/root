...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-recordBomLine-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2552,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-bom/recordBomLine.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-recordBomLine-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-assembleBom-v1',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2515,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-bom/assembleBom.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-assembleBom-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-recordAlternativeSource-v1',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2556,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-bom/recordAlternativeSource.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-recordAlternativeSource-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-computeOpenScore-v1',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 3553,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-bom/computeOpenScore.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'did:web:open-smartphone-bom.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-bom-computeOpenScore-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-registerFacility-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2667,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-ems/registerFacility.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-ems.etzhayyim.com',
                 'did:web:open-smartphone-ems.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-registerFacility-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-recordCapacityOrder-v1',
                 'did:web:open-smartphone-ems.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2573,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-ems/recordCapacityOrder.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-ems.etzhayyim.com',
                 'did:web:open-smartphone-ems.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-recordCapacityOrder-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-fetchComplianceDelta-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3439,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-ems/fetchComplianceDelta.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-ems.etzhayyim.com:ops',
                 'did:web:open-smartphone-ems.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-fetchComplianceDelta-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-dailyPulse-v1',
                 'did:web:open-smartphone-ems.etzhayyim.com:ops',
                 ...
                 '</bpmn:definitions>\n',
                 2332,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-ems/dailyPulse.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-ems.etzhayyim.com:ops',
                 'did:web:open-smartphone-ems.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-ems-dailyPulse-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-recordModemSpec-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2368,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-modem/recordModemSpec.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-recordModemSpec-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-recordTypeApproval-v1',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2565,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-modem/recordTypeApproval.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-recordTypeApproval-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-flagPatentBlocker-v1',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2529,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-modem/flagPatentBlocker.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 'did:web:open-smartphone-modem.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-flagPatentBlocker-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-fetchSepDelta-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3456,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-modem/fetchSepDelta.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-modem.etzhayyim.com:ops',
                 'did:web:open-smartphone-modem.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-modem-fetchSepDelta-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-registerOsBuild-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2550,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-os/registerOsBuild.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-registerOsBuild-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-recordHalDriver-v1',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2557,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-os/recordHalDriver.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-recordHalDriver-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-trackOtaRelease-v1',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2547,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-os/trackOtaRelease.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 'did:web:open-smartphone-os.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-trackOtaRelease-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-fetchSecurityPatchDelta-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3399,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-os/fetchSecurityPatchDelta.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-os.etzhayyim.com:ops',
                 'did:web:open-smartphone-os.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-os-fetchSecurityPatchDelta-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-recordLicensePool-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2560,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-patent/recordLicensePool.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-patent.etzhayyim.com',
                 'did:web:open-smartphone-patent.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-recordLicensePool-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-mapPatentDependency-v1',
                 'did:web:open-smartphone-patent.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2546,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-patent/mapPatentDependency.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-patent.etzhayyim.com',
                 'did:web:open-smartphone-patent.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-mapPatentDependency-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-flagExpiryGate-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2402,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-patent/flagExpiryGate.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-patent.etzhayyim.com:ops',
                 'did:web:open-smartphone-patent.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-flagExpiryGate-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-fetchSepLandscapeDelta-v1',
                 'did:web:open-smartphone-patent.etzhayyim.com:ops',
                 ...
                 '</bpmn:definitions>\n',
                 3588,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-patent/fetchSepLandscapeDelta.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-patent.etzhayyim.com:ops',
                 'did:web:open-smartphone-patent.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-patent-fetchSepLandscapeDelta-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-registerSensor-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2493,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-sensor/registerSensor.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-sensor.etzhayyim.com',
                 'did:web:open-smartphone-sensor.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-registerSensor-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-recordCalibration-v1',
                 'did:web:open-smartphone-sensor.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2482,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-sensor/recordCalibration.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-sensor.etzhayyim.com',
                 'did:web:open-smartphone-sensor.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-recordCalibration-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-fetchDriverAvailability-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3263,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-sensor/fetchDriverAvailability.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-sensor.etzhayyim.com:ops',
                 'did:web:open-smartphone-sensor.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-fetchDriverAvailability-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-dailyPulse-v1',
                 'did:web:open-smartphone-sensor.etzhayyim.com:ops',
                 ...
                 '</bpmn:definitions>\n',
                 2328,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-sensor/dailyPulse.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-sensor.etzhayyim.com:ops',
                 'did:web:open-smartphone-sensor.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-sensor-dailyPulse-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-registerChipDesign-v1',
                 ...
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.openSmartphoneSoc.registerChipDesign", "version": '
                 ...
                 '</bpmn:definitions>\n',
                 2747,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-soc/registerChipDesign.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-registerChipDesign-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-trackFabOrder-v1',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.openSmartphoneSoc.trackFabOrder", "version": 1, '
                 ...
                 '</bpmn:definitions>\n',
                 2662,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-soc/trackFabOrder.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-trackFabOrder-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-flagExportControl-v1',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2492,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-soc/flagExportControl.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 'did:web:open-smartphone-soc.etzhayyim.com',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-flagExportControl-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-fetchRiscvEcosystemDelta-v1',
                 ...
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.openSmartphoneSoc.fetchRiscvEcosystemDelta", '
                 ...
                 '</bpmn:definitions>\n',
                 4785,
                 '00-contracts/bpmn/com/etzhayyim/open-smartphone-soc/fetchRiscvEcosystemDelta.bpmn',
                 '2026-04-28T23:50:00Z',
                 'did:web:open-smartphone-soc.etzhayyim.com:ops',
                 'did:web:open-smartphone-soc.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-smartphone',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-smartphone-soc-fetchRiscvEcosystemDelta-v1']}]
