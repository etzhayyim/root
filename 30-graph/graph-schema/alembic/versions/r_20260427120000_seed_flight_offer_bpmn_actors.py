...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/flight-offer-search-offers-v1',
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/flight-offer-search-offers-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         '    )\n'
         "    SELECT $1, $2, 'ai.gftd.apps.flightOffer.searchOffers',\n"
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/flight-offer-search-offers-v1',
                 'did:web:flight-offer.gftd.ai',
                 '2026-04-27T12:00:00Z',
                 'did:web:flight-offer.gftd.ai',
                 'did:web:flight-offer.gftd.ai',
                 'sys.bpmn.seed.flight-offer',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/flight-offer-search-offers-v1']}]
