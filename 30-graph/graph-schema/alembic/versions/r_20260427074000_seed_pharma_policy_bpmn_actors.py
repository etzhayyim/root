...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-drug-price-negotiation-recordRound-v1',
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 ...
                 'targetNamespace="https://gftd.ai/bpmn/open-drug-price-negotiation" '
                 ...
                 '        <zeebe:ioMapping><zeebe:input '
                 'source="=&quot;did:web:open-drug-price-negotiation.gftd.ai&quot;" '
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-drug-price-negotiation-recordRound-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-drug-price-negotiation-flagAccessGap-v1',
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 ...
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-drug-price-negotiation-flagAccessGap-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-recordAction-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'targetNamespace="https://gftd.ai/bpmn/open-jp-mhlw" exporter="hand-written" '
                 'exporterVersion="1.0">\n'
                 ...
                 '      <bpmn:extensionElements><zeebe:taskDefinition type="generic.audit.emit"/>\n'
                 '        <zeebe:ioMapping><zeebe:input '
                 'source="=&quot;did:web:open-jp-mhlw.gftd.ai&quot;" target="actor"/><zeebe:input '
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-recordAction-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-flagPolicyConcern-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-flagPolicyConcern-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-regulateNarcotics-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-regulateNarcotics-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-administerInfluenzaVaccine-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-jp-mhlw-administerInfluenzaVaccine-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-drug-price-negotiation-recordRound-v1',
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 ...
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-drug-price-negotiation-recordRound-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-drug-price-negotiation-flagAccessGap-v1',
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 ...
                 'did:web:open-drug-price-negotiation.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-drug-price-negotiation-flagAccessGap-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-recordAction-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-recordAction-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-flagPolicyConcern-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-flagPolicyConcern-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-regulateNarcotics-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-regulateNarcotics-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id,\n'
         '      owner_did,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-administerInfluenzaVaccine-v1',
                 'did:web:open-jp-mhlw.gftd.ai',
                 ...
                 'did:web:open-jp-mhlw.gftd.ai',
                 'sys.bpmn.seed.pharma-policy',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-jp-mhlw-administerInfluenzaVaccine-v1']}]
