...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/rl-collect-trajectories-v1',
                 ...
                 '\n'
                 '  NSID: ai.gftd.apps.rl.collectTrajectories\n'
                 '  vertex_id: '
                 ...
                 'isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.apps.rl.collectTrajectories", "version": 1, '
 ...
 {'sql': '\n'
         ...
         "      'ai.gftd.apps.rl.collectTrajectories',\n"
         "      $3, 1, $4, $5, 'sys.bpmn.seed.rl'\n"
         '    WHERE NOT EXISTS (\n'
         '      SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $6\n'
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.lexiconBinding/rl-collect-trajectories-v1',
                 'did:web:bpmn.etzhayyim.com',
                 '2026-05-05T21:00:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
