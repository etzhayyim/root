...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kobo-budding-v1',
                 ...
                 'id="Definitions_kobo_budding" targetNamespace="https://etzhayyim.com/bpmn/kobo" '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:kobo.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 2260,
                 '00-contracts/bpmn/com/etzhayyim/kobo/budding.bpmn',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kobo-budding-v1']},
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kobo-budding-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kobo_budding',
                 'com.etzhayyim.apps.kobo.budAgent',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kobo-budding-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def\n'
         '        (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '         source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kobo-germination-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kobo_germination',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 'xmlns:zeebe="http://camunda.org/schema/zeebe/1.0" '
                 'xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" '
                 'id="Definitions_kobo_germination" targetNamespace="https://etzhayyim.com/bpmn/kobo" '
                 'exporter="hand-written" exporterVersion="1.0">\n'
                 ...
                 '</bpmn:definitions>\n',
                 3122,
                 '00-contracts/bpmn/com/etzhayyim/kobo/germination.bpmn',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kobo-germination-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding\n'
         '        (vertex_id, owner_did, bpmn_process_id, nsid,\n'
         '         created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kobo-germination-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kobo_germination',
                 'com.etzhayyim.apps.kobo.spawnAgent',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kobo-germination-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def\n'
         '        (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '         source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kobo-sporulation-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kobo_sporulation',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 'xmlns:zeebe="http://camunda.org/schema/zeebe/1.0" '
                 'xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" '
                 'id="Definitions_kobo_sporulation" targetNamespace="https://etzhayyim.com/bpmn/kobo" '
                 'exporter="hand-written" exporterVersion="1.0">\n'
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;com.etzhayyim.apps.houshi.storeSpore&quot;" '
                 'target="nsid"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3010,
                 '00-contracts/bpmn/com/etzhayyim/kobo/sporulation.bpmn',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kobo-sporulation-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding\n'
         '        (vertex_id, owner_did, bpmn_process_id, nsid,\n'
         '         created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kobo-sporulation-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kobo_sporulation',
                 'com.etzhayyim.apps.kobo.sporulate',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kobo-sporulation-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def\n'
         '        (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '         source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kabi-anastomosis-gate-v1',
                 'did:web:bpmn.etzhayyim.com',
                 ...
                 'targetNamespace="https://etzhayyim.com/bpmn/kabi" exporter="hand-written" '
                 'exporterVersion="1.0">\n'
                 ...
                 'type="generic.pds.dispatch"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;com.etzhayyim.apps.kabi.extendHypha&quot;" '
                 'target="nsid"/>\n'
                 ...
                 '      <bpmn:extensionElements><zeebe:taskDefinition type="generic.audit.emit"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:kabi.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3563,
                 '00-contracts/bpmn/com/etzhayyim/kabi/anastomosis-gate.bpmn',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kabi-anastomosis-gate-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding\n'
         '        (vertex_id, owner_did, bpmn_process_id, nsid,\n'
         '         created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kabi-anastomosis-gate-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kabi_anastomosis_gate',
                 'com.etzhayyim.apps.kabi.fusionProbe',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kabi-anastomosis-gate-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def\n'
         '        (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '         source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kinoko-ponf-fruiting-v1',
                 'did:web:bpmn.etzhayyim.com',
                 ...
                 'targetNamespace="https://etzhayyim.com/bpmn/kinoko" exporter="hand-written" '
                 'exporterVersion="1.0">\n'
                 ...
                 '      <bpmn:extensionElements><zeebe:taskDefinition type="generic.audit.emit"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:kinoko.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3309,
                 '00-contracts/bpmn/com/etzhayyim/kinoko/ponf-fruiting.bpmn',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kinoko-ponf-fruiting-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding\n'
         '        (vertex_id, owner_did, bpmn_process_id, nsid,\n'
         '         created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kinoko-ponf-fruiting-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'kinoko_ponf_fruiting',
                 'com.etzhayyim.apps.kinoko.formBlock',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/kinoko-ponf-fruiting-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def\n'
         '        (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '         source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/hakkou-ferment-pipeline-v1',
                 'did:web:bpmn.etzhayyim.com',
                 ...
                 'targetNamespace="https://etzhayyim.com/bpmn/hakkou" exporter="hand-written" '
                 'exporterVersion="1.0">\n'
                 ...
                 '      <bpmn:extensionElements><zeebe:taskDefinition type="generic.audit.emit"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:hakkou.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 4468,
                 '00-contracts/bpmn/com/etzhayyim/hakkou/ferment-pipeline.bpmn',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/hakkou-ferment-pipeline-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding\n'
         '        (vertex_id, owner_did, bpmn_process_id, nsid,\n'
         '         created_at, sensitivity_ord, org_id, user_id, actor_id)\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/hakkou-ferment-pipeline-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'hakkou_ferment_pipeline',
                 'com.etzhayyim.apps.hakkou.startFerment',
                 '2026-05-07T23:30:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/hakkou-ferment-pipeline-v1']}]
