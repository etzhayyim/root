...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-jma-report-earthquake-v1',
                 ...
                 '</bpmn:definitions>\n',
                 5597,
                 '00-contracts/bpmn/com/etzhayyim/jpn-jma/reportEarthquake.bpmn',
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-jma.etzhayyim.com',
                 'did:web:jpn-jma.etzhayyim.com',
                 'sys.bpmn.seed.jpn-jma',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-jma-report-earthquake-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-jma-issue-weather-warning-v1',
                 'did:web:jpn-jma.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 5100,
                 '00-contracts/bpmn/com/etzhayyim/jpn-jma/issueWeatherWarning.bpmn',
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-jma.etzhayyim.com',
                 'did:web:jpn-jma.etzhayyim.com',
                 'sys.bpmn.seed.jpn-jma',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-jma-issue-weather-warning-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-jma-reportEarthquake-v1',
                 'did:web:jpn-jma.etzhayyim.com',
                 'com.etzhayyim.apps.jpnJma.reportEarthquake',
                 'jpn_jma_report_earthquake',
                 30000,
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-jma.etzhayyim.com',
                 'did:web:jpn-jma.etzhayyim.com',
                 'sys.bpmn.seed.jpn-jma',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-jma-reportEarthquake-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-jma-issueWeatherWarning-v1',
                 'did:web:jpn-jma.etzhayyim.com',
                 'com.etzhayyim.apps.jpnJma.issueWeatherWarning',
                 'jpn_jma_issue_weather_warning',
                 30000,
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-jma.etzhayyim.com',
                 'did:web:jpn-jma.etzhayyim.com',
                 'sys.bpmn.seed.jpn-jma',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-jma-issueWeatherWarning-v1']}]
