...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kakaku-upsertOffer-v1',
                 ...
                 '        <zeebe:taskDefinition type="xrpc.com.etzhayyim.apps.kakaku.upsertOffer"/>\n'
                 '        <zeebe:ioMapping>\n'
                 ...
                 '</bpmn:definitions>\n',
                 1998,
                 '00-contracts/bpmn/com/etzhayyim/kakaku/upsertOffer.bpmn',
                 '2026-04-25T20:30:00Z',
                 'did:web:kakaku.etzhayyim.com',
                 'did:web:kakaku.etzhayyim.com',
                 'sys.bpmn.seed.kakaku',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kakaku-upsertOffer-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kakaku-ingestOfferFromUrl-v1',
                 'did:web:kakaku.etzhayyim.com',
                 ...
                 'type="xrpc.com.etzhayyim.apps.kakaku.ingestOfferFromUrl"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:output source="=status" target="status"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3026,
                 '00-contracts/bpmn/com/etzhayyim/kakaku/ingestOfferFromUrl.bpmn',
                 '2026-04-25T20:30:00Z',
                 'did:web:kakaku.etzhayyim.com',
                 'did:web:kakaku.etzhayyim.com',
                 'sys.bpmn.seed.kakaku',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kakaku-ingestOfferFromUrl-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kakaku-compareOffers-v1',
                 'did:web:kakaku.etzhayyim.com',
                 ...
                 '      <bpmn:extensionElements>\n'
                 '        <zeebe:taskDefinition type="xrpc.com.etzhayyim.apps.kakaku.compareOffers"/>\n'
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:output source="=productId" target="productId"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 1645,
                 '00-contracts/bpmn/com/etzhayyim/kakaku/compareOffers.bpmn',
                 '2026-04-25T20:30:00Z',
                 'did:web:kakaku.etzhayyim.com',
                 'did:web:kakaku.etzhayyim.com',
                 'sys.bpmn.seed.kakaku',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/kakaku-compareOffers-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kakaku-upsertOffer-v1',
                 'did:web:kakaku.etzhayyim.com',
                 'com.etzhayyim.apps.kakaku.upsertOffer',
                 'kakaku_upsert_offer',
                 90000,
                 '2026-04-25T20:30:00Z',
                 'did:web:kakaku.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kakaku-upsertOffer-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kakaku-ingestOfferFromUrl-v1',
                 'did:web:kakaku.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.kakaku',
                 'vertex_kakaku_product,vertex_kakaku_merchant,vertex_kakaku_offer,vertex_kakaku_price_history,vertex_kakaku_match_candidate',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kakaku-ingestOfferFromUrl-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kakaku-compareOffers-v1',
                 'did:web:kakaku.etzhayyim.com',
                 'com.etzhayyim.apps.kakaku.compareOffers',
                 'kakaku_compare_offers',
                 60000,
                 '2026-04-25T20:30:00Z',
                 'did:web:kakaku.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.kakaku',
                 'vertex_kakaku_product,vertex_kakaku_merchant,vertex_kakaku_offer,vertex_kakaku_price_history,vertex_kakaku_match_candidate',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/kakaku-compareOffers-v1']}]
