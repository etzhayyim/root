...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/smishing-analyzeMessage-v1',
                 ...
                 '    targetNamespace="https://etzhayyim.com/bpmn/smishing"\n'
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:smishing.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3282,
                 '00-contracts/bpmn/com/etzhayyim/smishing/analyzeMessage.bpmn',
                 '2026-04-29T09:04:00Z',
                 'did:web:smishing.etzhayyim.com',
                 'did:web:smishing.etzhayyim.com',
                 'sys.bpmn.seed.smishing',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/smishing-analyzeMessage-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/smishing-analyzeMessage-v1',
                 'did:web:smishing.etzhayyim.com',
                 'com.etzhayyim.apps.smishing.analyzeMessageProcess',
                 'smishing_analyze_message',
                 '2026-04-29T09:04:00Z',
                 'did:web:smishing.etzhayyim.com',
                 'did:web:smishing.etzhayyim.com',
                 'sys.bpmn.seed.smishing',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/smishing-analyzeMessage-v1']}]
