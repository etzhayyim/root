...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-mlit-road-register-construction-v1',
                 ...
                 '    targetNamespace="https://etzhayyim.com/bpmn/jpn-mlit-road"\n'
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:jpn-mlit-road.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 2798,
                 '00-contracts/bpmn/com/etzhayyim/jpn-mlit-road/registerConstruction.bpmn',
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'sys.bpmn.seed.jpn-mlit-road',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-mlit-road-register-construction-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-mlit-road-issue-traffic-restriction-v1',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 5340,
                 '00-contracts/bpmn/com/etzhayyim/jpn-mlit-road/issueTrafficRestriction.bpmn',
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'sys.bpmn.seed.jpn-mlit-road',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/jpn-mlit-road-issue-traffic-restriction-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-mlit-road-registerConstruction-v1',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'com.etzhayyim.apps.jpnMlitRoad.registerConstruction',
                 'jpn_mlit_road_register_construction',
                 15000,
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'sys.bpmn.seed.jpn-mlit-road',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-mlit-road-registerConstruction-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-mlit-road-issueTrafficRestriction-v1',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'com.etzhayyim.apps.jpnMlitRoad.issueTrafficRestriction',
                 'jpn_mlit_road_issue_traffic_restriction',
                 30000,
                 '2026-04-24T18:30:00Z',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'did:web:jpn-mlit-road.etzhayyim.com',
                 'sys.bpmn.seed.jpn-mlit-road',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/jpn-mlit-road-issueTrafficRestriction-v1']}]
