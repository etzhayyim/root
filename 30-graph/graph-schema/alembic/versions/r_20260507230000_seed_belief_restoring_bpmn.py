...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/wellbecoming-belief-restoring-capture-v1',
                 ...
                 '\n'
                 '  NSID: com.etzhayyim.apps.wellbecoming.beliefRestoringCapture\n'
                 '  vertex_id: '
                 ...
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.wellbecoming.beliefRestoringCapture", "version": '
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.lexiconBinding/wellbecoming-belief-restoring-capture-v1',
                 'did:web:bpmn.etzhayyim.com',
                 '2026-05-07T23:00:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
