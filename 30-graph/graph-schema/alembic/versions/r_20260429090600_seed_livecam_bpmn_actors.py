...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/livecam-analyzeCamera-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2518,
                 '00-contracts/bpmn/com/etzhayyim/livecam/analyzeCamera.bpmn',
                 '2026-04-29T09:06:00Z',
                 'did:web:livecam.etzhayyim.com',
                 'did:web:livecam.etzhayyim.com',
                 'sys.bpmn.seed.livecam',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/livecam-analyzeCamera-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/livecam-analyzeCamera-v1',
                 'did:web:livecam.etzhayyim.com',
                 'com.etzhayyim.apps.livecam.analyzeCamera',
                 'livecam_analyze_camera',
                 120000,
                 '2026-04-29T09:06:00Z',
                 'did:web:livecam.etzhayyim.com',
                 'did:web:livecam.etzhayyim.com',
                 'sys.bpmn.seed.livecam',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/livecam-analyzeCamera-v1']}]
