"""Captured from Kysely migration 20260430130500_fix_agent_runtime_lease_autopilot_manual_start."""
...
revision = "r_20260430130500_fix_agent_runtime_lease_autopilot_manual_start"
down_revision = 'r_20260430125500_fix_agent_runtime_lease_autopilot_bpmn'
branch_labels = None
depends_on = None
...
DOWN = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['agent_runtime_lease_autopilot']}]
