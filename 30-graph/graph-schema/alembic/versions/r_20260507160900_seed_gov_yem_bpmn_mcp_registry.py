...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-seedOrgs-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-registerDIDs-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-followSiteDeps-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-resolveOrgPath-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-listOrgs-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-syncWetUpdates-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-shinka-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-heartbeatTick-v1',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govYem-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-seedOrgs',
                 'com.etzhayyim.govYem.seedOrgs',
                 'did:web:yem-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-registerDIDs',
                 'com.etzhayyim.govYem.registerDIDs',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-followSiteDeps',
                 'com.etzhayyim.govYem.followSiteDeps',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-resolveOrgPath',
                 'com.etzhayyim.govYem.resolveOrgPath',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-listOrgs',
                 'com.etzhayyim.govYem.listOrgs',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-syncWetUpdates',
                 'com.etzhayyim.govYem.syncWetUpdates',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-shinka',
                 'com.etzhayyim.govYem.shinka',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-heartbeatTick',
                 'com.etzhayyim.govYem.heartbeatTick',
                 'did:web:yem-state.etzhayyim.com',
                 'yem-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-yem',
                 '2026-05-07T16:09:00Z',
                 'at://did:web:yem-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govYem-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
