...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/media-gamers-guideGenerate-v1',
                 ...
                 '\n'
                 '  Zeebe-owned guide generation pipeline for media-gamers.etzhayyim.com. Python '
                 'workers\n'
                 ...
                 '  through com.etzhayyim.apps.media_gamers.guide.commitGuide.\n'
                 '\n'
                 '  Input variables:\n'
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:media-gamers.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 3673,
                 '00-contracts/bpmn/com/etzhayyim/media-gamers/guideGenerate.bpmn',
                 '2026-04-29T09:02:00Z',
                 'did:web:media-gamers.etzhayyim.com',
                 'did:web:media-gamers.etzhayyim.com',
                 'sys.bpmn.seed.media-gamers',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/media-gamers-guideGenerate-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/media-gamers-guideGenerate-v1',
                 'did:web:media-gamers.etzhayyim.com',
                 'com.etzhayyim.apps.media_gamers.guide.guideGenerate',
                 'media_gamers_guide_generate',
                 120000,
                 '2026-04-29T09:02:00Z',
                 'did:web:media-gamers.etzhayyim.com',
                 'did:web:media-gamers.etzhayyim.com',
                 'sys.bpmn.seed.media-gamers',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/media-gamers-guideGenerate-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/media-gamers-knowledgeGuideGenerate-v1',
                 'did:web:media-gamers.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2459,
                 '00-contracts/bpmn/com/etzhayyim/media-gamers/knowledgeGuideGenerate.bpmn',
                 '2026-04-29T09:02:00Z',
                 'did:web:media-gamers.etzhayyim.com',
                 'did:web:media-gamers.etzhayyim.com',
                 'sys.bpmn.seed.media-gamers',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/media-gamers-knowledgeGuideGenerate-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/media-gamers-knowledgeGuideGenerate-v1',
                 'did:web:media-gamers.etzhayyim.com',
                 'com.etzhayyim.apps.media_gamers.knowledge.knowledgeGuideGenerate',
                 'media_gamers_knowledge_guide_generate',
                 120000,
                 '2026-04-29T09:02:00Z',
                 'did:web:media-gamers.etzhayyim.com',
                 'did:web:media-gamers.etzhayyim.com',
                 'sys.bpmn.seed.media-gamers',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/media-gamers-knowledgeGuideGenerate-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (\n'
         '      vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '      source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/media-gamers-evalModels-v1',
                 'did:web:media-gamers.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2052,
                 '00-contracts/bpmn/com/etzhayyim/media-gamers/evalModels.bpmn',
                 '2026-04-29T09:02:00Z',
                 'did:web:media-gamers.etzhayyim.com',
                 'did:web:media-gamers.etzhayyim.com',
                 'sys.bpmn.seed.media-gamers',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/media-gamers-evalModels-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/media-gamers-evalModels-v1',
                 'did:web:media-gamers.etzhayyim.com',
                 'com.etzhayyim.apps.media_gamers.evalModelsProcess',
                 'media_gamers_eval_models',
                 120000,
                 '2026-04-29T09:02:00Z',
                 'did:web:media-gamers.etzhayyim.com',
                 'did:web:media-gamers.etzhayyim.com',
                 'sys.bpmn.seed.media-gamers',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/media-gamers-evalModels-v1']}]
