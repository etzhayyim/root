...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-rail-define-line-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2490,
                 '00-contracts/bpmn/com/etzhayyim/open-rail/defineLine.bpmn',
                 '2026-04-24T14:30:00Z',
                 'did:web:open-rail.etzhayyim.com:ops',
                 'did:web:open-rail.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-rail',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-rail-define-line-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-rail-report-incident-v1',
                 'did:web:open-rail.etzhayyim.com:ops',
                 ...
                 '</bpmn:definitions>\n',
                 5425,
                 '00-contracts/bpmn/com/etzhayyim/open-rail/reportIncident.bpmn',
                 '2026-04-24T14:30:00Z',
                 'did:web:open-rail.etzhayyim.com:ops',
                 'did:web:open-rail.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-rail',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-rail-report-incident-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-rail-defineLine-v1',
                 'did:web:open-rail.etzhayyim.com:ops',
                 ...
                 'did:web:open-rail.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-rail',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-rail-defineLine-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-rail-reportIncident-v1',
                 'did:web:open-rail.etzhayyim.com:ops',
                 ...
                 'did:web:open-rail.etzhayyim.com:ops',
                 'sys.bpmn.seed.open-rail',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-rail-reportIncident-v1']}]
