...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-cofog-record-expenditure-v1',
                 ...
                 '          <zeebe:output '
                 'source="=&quot;at://did:web:open-cofog.etzhayyim.com/app.etzhayyim.apps.openCofog.class/&quot; '
                 ...
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-cofog-record-expenditure-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-cofog-record-concordance-v1',
                 'did:web:open-cofog.etzhayyim.com',
                 ...
                 'did:web:open-cofog.etzhayyim.com',
                 'sys.bpmn.seed.open-cofog',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.processDef/open-cofog-record-concordance-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/open-cofog-recordExpenditure-v1',
                 'did:web:open-cofog.etzhayyim.com',
                 'app.etzhayyim.apps.openCofog.recordExpenditure',
                 'open_cofog_record_expenditure',
                 30000,
                 '2026-04-24T15:30:00Z',
                 'did:web:open-cofog.etzhayyim.com',
                 'did:web:open-cofog.etzhayyim.com',
                 'sys.bpmn.seed.open-cofog',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/open-cofog-recordExpenditure-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/open-cofog-recordConcordance-v1',
                 'did:web:open-cofog.etzhayyim.com',
                 'app.etzhayyim.apps.openCofog.recordConcordance',
                 'open_cofog_record_concordance',
                 15000,
                 '2026-04-24T15:30:00Z',
                 'did:web:open-cofog.etzhayyim.com',
                 'did:web:open-cofog.etzhayyim.com',
                 'sys.bpmn.seed.open-cofog',
                 'at://did:web:bpmn.etzhayyim.com/app.etzhayyim.apps.bpmn.binding/open-cofog-recordConcordance-v1']}]
