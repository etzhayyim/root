...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/contribution-source-register-v1',
                 ...
                 'targetNamespace="https://gftd.ai/bpmn/contribution" exporter="hand-written" '
                 'exporterVersion="2.0">\n'
                 '  <bpmn:process id="contribution_source_register" '
                 'name="registerContributionSource" isExecutable="true">\n'
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "ai.gftd.authz.registerContributionSource", "version": 1, '
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:bpmn.gftd.ai&quot;" '
                 'target="actor"/>\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/contribution-registerSource-v1',
                 'did:web:bpmn.gftd.ai',
                 'ai.gftd.authz.registerContributionSource',
                 'contribution_source_register',
                 '2026-04-29T12:00:00Z',
                 'did:web:bpmn.gftd.ai',
                 'did:web:bpmn.gftd.ai',
