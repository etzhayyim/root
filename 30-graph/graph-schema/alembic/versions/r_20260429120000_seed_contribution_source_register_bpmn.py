...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/contribution-source-register-v1',
                 ...
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.authz.registerContributionSource", "version": 1, '
                 ...
                 '</bpmn:definitions>\n',
                 3344,
                 '00-contracts/bpmn/com/etzhayyim/contribution/contributionSourceRegister.bpmn',
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/contribution-registerSource-v1',
                 'did:web:bpmn.etzhayyim.com',
                 'com.etzhayyim.authz.registerContributionSource',
                 'contribution_source_register',
                 '2026-04-29T12:00:00Z',
                 'did:web:bpmn.etzhayyim.com',
                 'did:web:bpmn.etzhayyim.com',
