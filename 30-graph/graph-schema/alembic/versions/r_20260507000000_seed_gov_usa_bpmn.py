...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-seedOrgs-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-registerDIDs-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-followSiteDeps-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-resolveOrgPath-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-listOrgs-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-syncWetUpdates-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-shinka-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-heartbeatTick-v1',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govUsa-heartbeatTick-v1']},
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-seedOrgs',
                 'com.etzhayyim.govUsa.seedOrgs',
                 'did:web:usa-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-registerDIDs',
                 'com.etzhayyim.govUsa.registerDIDs',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-followSiteDeps',
                 'com.etzhayyim.govUsa.followSiteDeps',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-resolveOrgPath',
                 'com.etzhayyim.govUsa.resolveOrgPath',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-listOrgs',
                 'com.etzhayyim.govUsa.listOrgs',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-syncWetUpdates',
                 'com.etzhayyim.govUsa.syncWetUpdates',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-shinka',
                 'com.etzhayyim.govUsa.shinka',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-heartbeatTick',
                 'com.etzhayyim.govUsa.heartbeatTick',
                 'did:web:usa-state.etzhayyim.com',
                 'usa-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-usa',
                 '2026-05-07T00:00:00Z',
                 'at://did:web:usa-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govUsa-heartbeatTick']}]
