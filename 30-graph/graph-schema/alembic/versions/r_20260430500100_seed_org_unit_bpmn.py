...
UP = [{'sql': 'INSERT INTO vertex_bpmn_process_def\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-register-org-unit-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3938,
                 '00-contracts/bpmn/com/etzhayyim/open-lei/registerOrgUnit.bpmn',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 'did:web:open-lei.etzhayyim.com',
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-register-org-unit-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding\n'
  ...
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-register-org-unit-v1',
                 'did:web:open-lei.etzhayyim.com',
                 'com.etzhayyim.apps.openLei.registerOrgUnit',
                 'open_lei_register_org_unit',
                 ...
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-register-org-unit-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def\n'
         ...
         "             'active', $7, 100, $8, $9, $10, $11, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-dissolve-org-unit-v1',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 3257,
                 '00-contracts/bpmn/com/etzhayyim/open-lei/dissolveOrgUnit.bpmn',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 'did:web:open-lei.etzhayyim.com',
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-dissolve-org-unit-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding\n'
         '      (vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version, result_timeout_ms, '
         'write_table_allowlist, status, created_at, sensitivity_ord, org_id, user_id, actor_id, '
         'actor_did, org_did)\n'
         ...
         "             'active', $6, 100, $7, $8, $9, $10, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-dissolve-org-unit-v1',
                 'did:web:open-lei.etzhayyim.com',
                 'com.etzhayyim.apps.openLei.dissolveOrgUnit',
                 'open_lei_dissolve_org_unit',
                 'vertex_org_unit',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-dissolve-org-unit-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def\n'
         '      (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size, source_path, '
         'status, created_at, sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did)\n'
         '      SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6,\n'
         "             'active', $7, 100, $8, $9, $10, $11, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-move-org-unit-v1',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 3211,
                 '00-contracts/bpmn/com/etzhayyim/open-lei/moveOrgUnit.bpmn',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 'did:web:open-lei.etzhayyim.com',
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-move-org-unit-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding\n'
         '      (vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version, result_timeout_ms, '
         'write_table_allowlist, status, created_at, sensitivity_ord, org_id, user_id, actor_id, '
         'actor_did, org_did)\n'
         ...
         "             'active', $6, 100, $7, $8, $9, $10, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-move-org-unit-v1',
                 'did:web:open-lei.etzhayyim.com',
                 'com.etzhayyim.apps.openLei.moveOrgUnit',
                 'open_lei_move_org_unit',
                 'vertex_org_unit,edge_org_unit_parent',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-move-org-unit-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def\n'
         '      (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size, source_path, '
         'status, created_at, sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did)\n'
         '      SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6,\n'
         "             'active', $7, 100, $8, $9, $10, $11, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-add-org-member-v1',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 3212,
                 '00-contracts/bpmn/com/etzhayyim/open-lei/addOrgMember.bpmn',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 'did:web:open-lei.etzhayyim.com',
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-add-org-member-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding\n'
         '      (vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version, result_timeout_ms, '
         'write_table_allowlist, status, created_at, sensitivity_ord, org_id, user_id, actor_id, '
         'actor_did, org_did)\n'
         ...
         "             'active', $6, 100, $7, $8, $9, $10, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-add-org-member-v1',
                 'did:web:open-lei.etzhayyim.com',
                 'com.etzhayyim.apps.openLei.addOrgMember',
                 'open_lei_add_org_member',
                 ...
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-add-org-member-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def\n'
         '      (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size, source_path, '
         'status, created_at, sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did)\n'
         '      SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6,\n'
         "             'active', $7, 100, $8, $9, $10, $11, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-remove-org-member-v1',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2972,
                 '00-contracts/bpmn/com/etzhayyim/open-lei/removeOrgMember.bpmn',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 'did:web:open-lei.etzhayyim.com',
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-remove-org-member-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding\n'
         '      (vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version, result_timeout_ms, '
         'write_table_allowlist, status, created_at, sensitivity_ord, org_id, user_id, actor_id, '
         'actor_did, org_did)\n'
         ...
         "             'active', $6, 100, $7, $8, $9, $10, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-remove-org-member-v1',
                 'did:web:open-lei.etzhayyim.com',
                 'com.etzhayyim.apps.openLei.removeOrgMember',
                 'open_lei_remove_org_member',
                 'edge_org_unit_member',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-remove-org-member-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def\n'
         '      (vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size, source_path, '
         'status, created_at, sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did)\n'
         '      SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6,\n'
         "             'active', $7, 100, $8, $9, $10, $11, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-query-org-subtree-v1',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 1841,
                 '00-contracts/bpmn/com/etzhayyim/open-lei/queryOrgSubtree.bpmn',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 'did:web:open-lei.etzhayyim.com',
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-lei-query-org-subtree-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding\n'
         '      (vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version, result_timeout_ms, '
         'write_table_allowlist, status, created_at, sensitivity_ord, org_id, user_id, actor_id, '
         'actor_did, org_did)\n'
         ...
         "             'active', $6, 100, $7, $8, $9, $10, 'anon'\n"
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-query-org-subtree-v1',
                 'did:web:open-lei.etzhayyim.com',
                 'com.etzhayyim.apps.openLei.queryOrgSubtree',
                 'open_lei_query_org_subtree',
                 '',
                 '2026-04-30T12:00:00+09:00',
                 'did:web:open-lei.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.open-lei',
                 'did:web:open-lei.etzhayyim.com',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-lei-query-org-subtree-v1']}]
