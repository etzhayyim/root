...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-hs-classify-shipment-v1',
                 ...
                 '          <zeebe:output '
                 'source="=&quot;at://did:web:open-hs.etzhayyim.com/com.etzhayyim.apps.openHs.class/&quot; + '
                 ...
                 '</bpmn:definitions>\n',
                 6106,
                 '00-contracts/bpmn/com/etzhayyim/open-hs/classifyShipment.bpmn',
                 '2026-04-24T16:30:00Z',
                 'did:web:open-hs.etzhayyim.com',
                 'did:web:open-hs.etzhayyim.com',
                 'sys.bpmn.seed.open-hs',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-hs-classify-shipment-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-hs-record-concordance-v1',
                 'did:web:open-hs.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2594,
                 '00-contracts/bpmn/com/etzhayyim/open-hs/recordConcordance.bpmn',
                 '2026-04-24T16:30:00Z',
                 'did:web:open-hs.etzhayyim.com',
                 'did:web:open-hs.etzhayyim.com',
                 'sys.bpmn.seed.open-hs',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-hs-record-concordance-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-hs-classifyShipment-v1',
                 'did:web:open-hs.etzhayyim.com',
                 'com.etzhayyim.apps.openHs.classifyShipment',
                 'open_hs_classify_shipment',
                 30000,
                 '2026-04-24T16:30:00Z',
                 'did:web:open-hs.etzhayyim.com',
                 'did:web:open-hs.etzhayyim.com',
                 'sys.bpmn.seed.open-hs',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-hs-classifyShipment-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-hs-recordConcordance-v1',
                 'did:web:open-hs.etzhayyim.com',
                 'com.etzhayyim.apps.openHs.recordConcordance',
                 'open_hs_record_concordance',
                 15000,
                 '2026-04-24T16:30:00Z',
                 'did:web:open-hs.etzhayyim.com',
                 'did:web:open-hs.etzhayyim.com',
                 'sys.bpmn.seed.open-hs',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-hs-recordConcordance-v1']}]
