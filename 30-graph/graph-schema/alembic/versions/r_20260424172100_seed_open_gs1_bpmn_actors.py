...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-gs1-register-gtin-v1',
                 ...
                 '    targetNamespace="https://etzhayyim.com/bpmn/open-gs1"\n'
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:open-gs1.etzhayyim.com&quot;" '
                 'target="actor"/>\n'
                 ...
                 '</bpmn:definitions>\n',
                 2734,
                 '00-contracts/bpmn/com/etzhayyim/open-gs1/registerGtin.bpmn',
                 '2026-04-24T17:30:00Z',
                 'did:web:open-gs1.etzhayyim.com',
                 'did:web:open-gs1.etzhayyim.com',
                 'sys.bpmn.seed.open-gs1',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-gs1-register-gtin-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-gs1-map-to-unspsc-v1',
                 'did:web:open-gs1.etzhayyim.com',
                 ...
                 '</bpmn:definitions>\n',
                 2454,
                 '00-contracts/bpmn/com/etzhayyim/open-gs1/mapToUnspsc.bpmn',
                 '2026-04-24T17:30:00Z',
                 'did:web:open-gs1.etzhayyim.com',
                 'did:web:open-gs1.etzhayyim.com',
                 'sys.bpmn.seed.open-gs1',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/open-gs1-map-to-unspsc-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-gs1-registerGtin-v1',
                 'did:web:open-gs1.etzhayyim.com',
                 'com.etzhayyim.apps.openGs1.registerGtin',
                 'open_gs1_register_gtin',
                 15000,
                 '2026-04-24T17:30:00Z',
                 'did:web:open-gs1.etzhayyim.com',
                 'did:web:open-gs1.etzhayyim.com',
                 'sys.bpmn.seed.open-gs1',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-gs1-registerGtin-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-gs1-mapToUnspsc-v1',
                 'did:web:open-gs1.etzhayyim.com',
                 'com.etzhayyim.apps.openGs1.mapToUnspsc',
                 'open_gs1_map_to_unspsc',
                 15000,
                 '2026-04-24T17:30:00Z',
                 'did:web:open-gs1.etzhayyim.com',
                 'did:web:open-gs1.etzhayyim.com',
                 'sys.bpmn.seed.open-gs1',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/open-gs1-mapToUnspsc-v1']}]
