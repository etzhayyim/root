...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-seedOrgs-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-registerDIDs-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-followSiteDeps-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-resolveOrgPath-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-listOrgs-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-syncWetUpdates-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-shinka-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-heartbeatTick-v1',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govHrv-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-seedOrgs',
                 'com.etzhayyim.govHrv.seedOrgs',
                 'did:web:hrv-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-registerDIDs',
                 'com.etzhayyim.govHrv.registerDIDs',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-followSiteDeps',
                 'com.etzhayyim.govHrv.followSiteDeps',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-resolveOrgPath',
                 'com.etzhayyim.govHrv.resolveOrgPath',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-listOrgs',
                 'com.etzhayyim.govHrv.listOrgs',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-syncWetUpdates',
                 'com.etzhayyim.govHrv.syncWetUpdates',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-shinka',
                 'com.etzhayyim.govHrv.shinka',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-heartbeatTick',
                 'com.etzhayyim.govHrv.heartbeatTick',
                 'did:web:hrv-state.etzhayyim.com',
                 'hrv-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-hrv',
                 '2026-05-07T14:51:00Z',
                 'at://did:web:hrv-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govHrv-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
