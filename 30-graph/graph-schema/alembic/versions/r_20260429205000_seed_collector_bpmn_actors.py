...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-netintel-dns-v1',
                 'did:web:collector.gftd.ai',
                 'collector_collect_netintel_dns',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 'xmlns:zeebe="http://camunda.org/schema/zeebe/1.0" '
                 'id="Definitions_collector_collect_netintel_dns" '
                 'targetNamespace="https://gftd.ai/bpmn/collector" exporter="hand-written" '
                 ...
                 1146,
                 '00-contracts/bpmn/ai/gftd/collector/collectNetintelDns.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-netintel-dns-v1']},
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-netintel-dns-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-netintel-dns-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-blockchain-btc-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1158,
                 '00-contracts/bpmn/ai/gftd/collector/collectBlockchainBtc.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-blockchain-btc-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-blockchain-btc-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-blockchain-btc-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-blockchain-eth-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1158,
                 '00-contracts/bpmn/ai/gftd/collector/collectBlockchainEth.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-blockchain-eth-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-blockchain-eth-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-blockchain-eth-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-common-crawl-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1146,
                 '00-contracts/bpmn/ai/gftd/collector/collectCommonCrawl.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-common-crawl-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-common-crawl-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-common-crawl-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-archive-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1119,
                 '00-contracts/bpmn/ai/gftd/collector/collectArchive.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-collect-archive-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-archive-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-collect-archive-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-ingest-scan-result-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1133,
                 '00-contracts/bpmn/ai/gftd/collector/ingestScanResult.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-ingest-scan-result-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-ingest-scan-result-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-ingest-scan-result-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-trigger-run-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1095,
                 '00-contracts/bpmn/ai/gftd/collector/triggerRun.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-trigger-run-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-trigger-run-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-trigger-run-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-get-dashboard-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1106,
                 '00-contracts/bpmn/ai/gftd/collector/getDashboard.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-get-dashboard-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-get-dashboard-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-get-dashboard-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-list-jobs-v1',
                 'did:web:collector.gftd.ai',
                 'collector_list_jobs',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 'id="End"><bpmn:incoming>Flow_2</bpmn:incoming></bpmn:endEvent></bpmn:process></bpmn:definitions>\n',
                 1082,
                 '00-contracts/bpmn/ai/gftd/collector/listJobs.bpmn',
                 '2026-04-29T20:50:00+09:00',
                 'did:web:collector.gftd.ai',
                 'did:web:collector.gftd.ai',
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/collector-list-jobs-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '        vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '        result_timeout_ms, write_table_allowlist, status, created_at,\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-list-jobs-v1',
                 'did:web:collector.gftd.ai',
                 ...
                 'sys.bpmn.seed.collector',
                 'did:web:collector.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/collector-list-jobs-v1']}]
