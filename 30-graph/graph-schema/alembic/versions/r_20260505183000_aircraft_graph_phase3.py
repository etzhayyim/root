...
UP = [{'sql': 'ALTER TABLE vertex_aircraft_state ADD COLUMN IF NOT EXISTS aircraft_did VARCHAR',
 ...
 {'sql': '\n'
         ...
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/passenger',
                 'passenger',
                 'Passenger transport',
                 '旅客輸送',
                 'Scheduled or charter passenger flight (ICAO Annex 6 Part I)',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/passenger']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/cargo',
                 'cargo',
                 'Cargo transport',
                 '貨物輸送',
                 'Dedicated freight or mail transport',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/cargo']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/military',
                 'military',
                 'Military operation',
                 '軍用機',
                 'State aircraft per Chicago Convention Art. 3',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/military']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/medevac',
                 'medevac',
                 'Medical evacuation',
                 '救急医療搬送',
                 'Emergency or scheduled HEMS / air ambulance',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/medevac']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/training',
                 'training',
                 'Flight training',
                 '訓練',
                 'Type rating / instructional flight',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/training']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/test',
                 'test',
                 'Test / ferry',
                 '試験飛行',
                 'Production test, post-maintenance, ferry',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/test']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/private',
                 'private',
                 'Private / general aviation',
                 '一般航空',
                 'Non-commercial private operation (Part 91)',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/private']},
 {'sql': '\n'
         '      INSERT INTO vertex_flight_purpose (\n'
         '        vertex_id, purpose_code, label_en, label_ja, description, regulated_under, '
         'created_at\n'
         ...
         '      WHERE NOT EXISTS (SELECT 1 FROM vertex_flight_purpose WHERE vertex_id = $7)\n'
         '    ',
  'parameters': ['at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/government',
                 'government',
                 'Government / state',
                 '政府専用',
                 'Head-of-state, customs, law-enforcement, SAR (non-military)',
                 '2026-05-05T18:30:00Z',
                 'at://did:web:maps.etzhayyim.com/ai.gftd.apps.maps.flightPurpose/government']}]
