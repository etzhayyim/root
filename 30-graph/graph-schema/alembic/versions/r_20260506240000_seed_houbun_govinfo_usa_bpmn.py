...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/ingest-houbun-govinfo-usa-delta-v1',
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input '
                 'source="=&quot;ai.gftd.ingest.houbunGovInfoUsaDelta.completed&quot;" '
                 'target="eventType"/>\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         "    SELECT $1, $2, 'ai.gftd.apps.ingest.startGovInfoUsa',\n"
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/ingest-start-houbun-govinfo-usa-delta-v1',
                 'did:web:ingest.gftd.ai',
                 '2026-05-06T24:00:00Z',
                 'did:web:ingest.gftd.ai',
                 'did:web:ingest.gftd.ai',
