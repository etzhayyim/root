...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/ingest-houbun-govinfo-usa-delta-v1',
 ...
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/ingest-start-houbun-govinfo-usa-delta-v1',
                 'did:web:ingest.etzhayyim.com',
                 '2026-05-06T24:00:00Z',
                 'did:web:ingest.etzhayyim.com',
                 'did:web:ingest.etzhayyim.com',
