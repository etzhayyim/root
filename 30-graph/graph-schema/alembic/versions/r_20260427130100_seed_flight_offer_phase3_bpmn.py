...
UP = [{'sql': '\n'
         ...
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/flight-offer-add-watch-v1',
                 ...
                 '</bpmn:definitions>\n',
                 3101,
                 '00-contracts/bpmn/com/etzhayyim/flight-offer/addWatch.bpmn',
                 '2026-04-27T13:01:00Z',
                 'did:web:flight-offer.etzhayyim.com',
                 'did:web:flight-offer.etzhayyim.com',
                 'sys.bpmn.seed.flight-offer',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/flight-offer-add-watch-v1']},
 {'sql': '\n'
         ...
         '$10)\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/flight-offer-add-watch-v1',
                 'did:web:flight-offer.etzhayyim.com',
                 'com.etzhayyim.apps.flightOffer.addWatch',
                 'flight_offer_add_watch',
                 15000,
                 '2026-04-27T13:01:00Z',
                 'did:web:flight-offer.etzhayyim.com',
                 'did:web:flight-offer.etzhayyim.com',
                 'sys.bpmn.seed.flight-offer',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/flight-offer-add-watch-v1']},
 {'sql': '\n'
         '      INSERT INTO vertex_bpmn_process_def (\n'
         '        vertex_id, owner_did, bpmn_process_id, version, xml, xml_byte_size,\n'
         '        source_path, status, created_at, sensitivity_ord, org_id, user_id, actor_id\n'
 ...
 {'sql': '\n'
         ...
         '$10)\n'
         '    ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/flight-offer-poll-watchlist-v1',
                 'did:web:flight-offer.etzhayyim.com',
                 'com.etzhayyim.apps.flightOffer.pollWatchlist',
                 'flight_offer_poll_watchlist',
                 300000,
                 '2026-04-27T13:01:00Z',
                 'did:web:flight-offer.etzhayyim.com',
                 'did:web:flight-offer.etzhayyim.com',
                 'sys.bpmn.seed.flight-offer',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/flight-offer-poll-watchlist-v1']}]
