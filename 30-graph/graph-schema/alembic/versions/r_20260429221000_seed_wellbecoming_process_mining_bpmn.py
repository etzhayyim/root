...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/wellbecoming-process-mining-v1',
                 ...
                 '\n'
                 '  NSID: com.etzhayyim.apps.wellbecoming.processMining\n'
                 '  vertex_id: '
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.processDef/wellbecoming-process-mining-v1\n'
                 '-->\n'
                 '<bpmn:definitions\n'
                 ...
                 '    <bpmn:documentation>\n'
                 '      { "nsid": "com.etzhayyim.apps.wellbecoming.processMining", "version": 1, '
