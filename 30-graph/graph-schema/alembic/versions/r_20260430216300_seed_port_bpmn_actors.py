...
UP = [{'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
  ...
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-register-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'targetNamespace="https://gftd.ai/bpmn/port"><bpmn:process '
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-register-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
  ...
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-register-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-register-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-update-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-update-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-update-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-update-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-register-berth-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-register-berth-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-register-berth-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-register-berth-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-register-terminal-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-register-terminal-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-register-terminal-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-register-terminal-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-get-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-get-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-get-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-get-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-list-ports-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-list-ports-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-list-ports-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-list-ports-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-search-ports-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-search-ports-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-search-ports-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-search-ports-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-get-port-berths-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-get-port-berths-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-get-port-berths-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-get-port-berths-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-get-port-terminals-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-infrastructure-get-port-terminals-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-get-port-terminals-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-infrastructure-get-port-terminals-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-receive-port-call-event-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-receive-port-call-event-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-receive-port-call-event-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-receive-port-call-event-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-list-port-call-events-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-list-port-call-events-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-list-port-call-events-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-list-port-call-events-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-get-vessels-at-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-get-vessels-at-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-get-vessels-at-port-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-get-vessels-at-port-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-get-port-occupancy-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-port-call-tracking-get-port-occupancy-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-get-port-occupancy-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-port-call-tracking-get-port-occupancy-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-seed-ports-v1',
                 'did:web:p0rt7890.gftd.ai',
                 'port_seedPorts',
                 '<?xml version="1.0" encoding="UTF-8"?><bpmn:definitions '
                 'xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 'targetNamespace="https://gftd.ai/bpmn/port"><bpmn:process id="port_seedPorts" '
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-seed-ports-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-seed-ports-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-seed-ports-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id, actor_did, org_did) SELECT $1, $2, $3, 1, $4, CAST($5 AS integer), $6, '
         "'active', $7, 100, $8, $9, $10, $11, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_process_def WHERE vertex_id = $12)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-get-dashboard-v1',
                 'did:web:p0rt7890.gftd.ai',
                 'port_getDashboard',
                 '<?xml version="1.0" encoding="UTF-8"?><bpmn:definitions '
                 'xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 'targetNamespace="https://gftd.ai/bpmn/port"><bpmn:process id="port_getDashboard" '
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/port-get-dashboard-v1']},
 {'sql': 'INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, bpmn_process_id, '
         'bpmn_version, result_timeout_ms, write_table_allowlist, status, created_at, '
         'sensitivity_ord, org_id, user_id, actor_id, actor_did, org_did) SELECT $1, $2, $3, $4, '
         "1, 30000, $5, 'active', $6, 100, $7, $8, $9, $10, 'anon' WHERE NOT EXISTS (SELECT 1 FROM "
         'vertex_bpmn_lexicon_binding WHERE vertex_id = $11)',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-get-dashboard-v1',
                 'did:web:p0rt7890.gftd.ai',
                 ...
                 'sys.bpmn.seed.port',
                 'did:web:p0rt7890.gftd.ai',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/port-get-dashboard-v1']}]
