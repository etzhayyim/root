...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-seedOrgs-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-registerDIDs-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-followSiteDeps-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-resolveOrgPath-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-listOrgs-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-syncWetUpdates-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-shinka-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-heartbeatTick-v1',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govBra-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-seedOrgs',
                 'com.etzhayyim.govBra.seedOrgs',
                 'did:web:bra-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-registerDIDs',
                 'com.etzhayyim.govBra.registerDIDs',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-followSiteDeps',
                 'com.etzhayyim.govBra.followSiteDeps',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-resolveOrgPath',
                 'com.etzhayyim.govBra.resolveOrgPath',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-listOrgs',
                 'com.etzhayyim.govBra.listOrgs',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-syncWetUpdates',
                 'com.etzhayyim.govBra.syncWetUpdates',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-shinka',
                 'com.etzhayyim.govBra.shinka',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-heartbeatTick',
                 'com.etzhayyim.govBra.heartbeatTick',
                 'did:web:bra-state.etzhayyim.com',
                 'bra-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-bra',
                 '2026-05-07T14:14:00Z',
                 'at://did:web:bra-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govBra-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
