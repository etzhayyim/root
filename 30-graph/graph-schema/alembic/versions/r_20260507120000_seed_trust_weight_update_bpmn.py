...
UP = [{'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/wellbecoming-trust-weight-update-v1',
                 ...
                 '</bpmn:definitions>\n',
                 2808,
                 '00-contracts/bpmn/ai/gftd/wellbecoming/trustWeightUpdate.bpmn',
