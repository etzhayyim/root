...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/judge-register-judge-v1',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/judge-register-judge-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/judge-list-judges-v1',
                 'did:web:judge.etzhayyim.com',
                 'judge_list_judges',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 'did:web:judge.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/judge-list-judges-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/bengoshi-register-lawyer-v1',
                 ...
                 'did:web:bengoshi.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/bengoshi-register-lawyer-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/bengoshi-search-lawyers-v1',
                 'did:web:bengoshi.etzhayyim.com',
                 ...
                 'did:web:bengoshi.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/bengoshi-search-lawyers-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/adr-register-arbitrator-v1',
                 ...
                 'did:web:adr.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/adr-register-arbitrator-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/adr-create-case-v1',
                 'did:web:adr.etzhayyim.com',
                 'adr_create_case',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 'did:web:adr.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/adr-create-case-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/legal-aid-register-office-v1',
                 ...
                 'did:web:legal-aid.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/legal-aid-register-office-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/legal-aid-open-case-v1',
                 'did:web:legal-aid.etzhayyim.com',
                 'legal_aid_open_case',
                 '<?xml version="1.0" encoding="UTF-8"?>\n'
                 '<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" '
                 ...
                 'did:web:legal-aid.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.processDef/legal-aid-open-case-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/judge-registerJudge-v1',
                 'did:web:judge.etzhayyim.com',
                 ...
                 'did:web:judge.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/judge-registerJudge-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/judge-listJudges-v1',
                 'did:web:judge.etzhayyim.com',
                 ...
                 'did:web:judge.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/judge-listJudges-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/bengoshi-registerLawyer-v1',
                 'did:web:bengoshi.etzhayyim.com',
                 ...
                 'did:web:bengoshi.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/bengoshi-registerLawyer-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/bengoshi-searchLawyers-v1',
                 'did:web:bengoshi.etzhayyim.com',
                 ...
                 'did:web:bengoshi.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/bengoshi-searchLawyers-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/adr-registerArbitrator-v1',
                 'did:web:adr.etzhayyim.com',
                 ...
                 'did:web:adr.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/adr-registerArbitrator-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/adr-createCase-v1',
                 'did:web:adr.etzhayyim.com',
                 ...
                 'did:web:adr.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/adr-createCase-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/legal-aid-registerOffice-v1',
                 'did:web:legal-aid.etzhayyim.com',
                 ...
                 'did:web:legal-aid.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/legal-aid-registerOffice-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/legal-aid-openCase-v1',
                 'did:web:legal-aid.etzhayyim.com',
                 ...
                 'did:web:legal-aid.etzhayyim.com',
                 'sys.bpmn.seed.legal-logical-actors',
                 'at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.bpmn.binding/legal-aid-openCase-v1']}]
