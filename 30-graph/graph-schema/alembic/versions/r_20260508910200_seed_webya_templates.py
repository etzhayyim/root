...
UP = [{'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:webya.gftd.ai/ai.gftd.apps.webya.template/law-firm-v1',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:webya.gftd.ai/ai.gftd.apps.webya.template/accounting-firm-v1',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:webya.gftd.ai/ai.gftd.apps.webya.template/scrivener-v1',
 ...
 {'sql': '\n'
         ...
         '      )\n'
         '    ',
  'parameters': ['at://did:web:webya.gftd.ai/ai.gftd.apps.webya.template/company-v1',
                 'template_company_v1',
                 'general_company',
