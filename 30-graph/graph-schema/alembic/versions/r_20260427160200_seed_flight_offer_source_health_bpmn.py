...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/flight-offer-source-health-v1',
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/flight-offer-source-health-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/flight-offer-source-health-v1',
                 'did:web:flight-offer.gftd.ai',
                 '2026-04-27T16:02:00Z',
                 'did:web:flight-offer.gftd.ai',
                 'did:web:flight-offer.gftd.ai',
                 'sys.bpmn.seed.flight-offer',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/flight-offer-source-health-v1']}]
