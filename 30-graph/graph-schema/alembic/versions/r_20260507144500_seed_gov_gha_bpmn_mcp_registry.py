...
UP = [{'sql': '\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-seedOrgs-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-seedOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-registerDIDs-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-registerDIDs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-followSiteDeps-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-followSiteDeps-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-resolveOrgPath-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-resolveOrgPath-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-listOrgs-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-listOrgs-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-syncWetUpdates-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-syncWetUpdates-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-shinka-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-shinka-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-heartbeatTick-v1',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 'vertex_gov_org,edge_gov_org_site_dependency',
                 'at://did:web:bpmn.etzhayyim.com/com.etzhayyim.apps.bpmn.binding/ai-gftd-govGha-heartbeatTick-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (\n'
         '      vertex_id, owner_did, nsid, bpmn_process_id, bpmn_version,\n'
         '      result_timeout_ms, status, created_at, sensitivity_ord, org_id, user_id,\n'
 ...
 {'sql': '\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-seedOrgs',
                 'com.etzhayyim.govGha.seedOrgs',
                 'did:web:gha-state.etzhayyim.com',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-seedOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-registerDIDs',
                 'com.etzhayyim.govGha.registerDIDs',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-registerDIDs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-followSiteDeps',
                 'com.etzhayyim.govGha.followSiteDeps',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-followSiteDeps']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-resolveOrgPath',
                 'com.etzhayyim.govGha.resolveOrgPath',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-resolveOrgPath']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-listOrgs',
                 'com.etzhayyim.govGha.listOrgs',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'query',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-listOrgs']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-syncWetUpdates',
                 'com.etzhayyim.govGha.syncWetUpdates',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-syncWetUpdates']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-shinka',
                 'com.etzhayyim.govGha.shinka',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-shinka']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
         ...
         '    )\n'
         '  ',
  'parameters': ['at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-heartbeatTick',
                 'com.etzhayyim.govGha.heartbeatTick',
                 'did:web:gha-state.etzhayyim.com',
                 'gha-state.etzhayyim.com',
                 'procedure',
                 ...
                 'sys.bpmn.seed.gov-gha',
                 '2026-05-07T14:45:00Z',
                 'at://did:web:gha-state.etzhayyim.com/com.etzhayyim.mcp.toolDef/ai-gftd-govGha-heartbeatTick']},
 {'sql': '\n'
         '    INSERT INTO vertex_mcp_tool_def (\n'
         '      vertex_id, nsid, actor_did, actor_host, lexicon_type, description,\n'
         '      input_schema, output_schema, lxm_scope, visibility, version, enabled,\n'
