...
UP = [{'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-isic-classify-entity-v1',
                 'did:web:open-isic.gftd.ai',
                 ...
                 '        <zeebe:ioMapping>\n'
                 '          <zeebe:input source="=&quot;did:web:open-isic.gftd.ai&quot;" '
                 'target="actor"/>\n'
                 ...
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-isic-classify-entity-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_process_def (vertex_id, owner_did, bpmn_process_id, version, '
         'xml, xml_byte_size, source_path, status, created_at, sensitivity_ord, org_id, user_id, '
         'actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_process_def WHERE vertex_id = $11)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-isic-record-concordance-v1',
                 'did:web:open-isic.gftd.ai',
                 ...
                 'did:web:open-isic.gftd.ai',
                 'sys.bpmn.seed.open-isic',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.processDef/open-isic-record-concordance-v1']},
 {'sql': '\n'
         ...
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-isic-classifyEntity-v1',
                 'did:web:open-isic.gftd.ai',
                 'ai.gftd.apps.openIsic.classifyEntity',
                 'open_isic_classify_entity',
                 30000,
                 '2026-04-24T15:30:00Z',
                 'did:web:open-isic.gftd.ai',
                 'did:web:open-isic.gftd.ai',
                 'sys.bpmn.seed.open-isic',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-isic-classifyEntity-v1']},
 {'sql': '\n'
         '    INSERT INTO vertex_bpmn_lexicon_binding (vertex_id, owner_did, nsid, '
         'bpmn_process_id, bpmn_version, result_timeout_ms, status, created_at, sensitivity_ord, '
         'org_id, user_id, actor_id)\n'
         ...
         '    WHERE NOT EXISTS (SELECT 1 FROM vertex_bpmn_lexicon_binding WHERE vertex_id = $10)\n'
         '  ',
  'parameters': ['at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-isic-recordConcordance-v1',
                 'did:web:open-isic.gftd.ai',
                 'ai.gftd.apps.openIsic.recordConcordance',
                 'open_isic_record_concordance',
                 15000,
                 '2026-04-24T15:30:00Z',
                 'did:web:open-isic.gftd.ai',
                 'did:web:open-isic.gftd.ai',
                 'sys.bpmn.seed.open-isic',
                 'at://did:web:bpmn.gftd.ai/ai.gftd.apps.bpmn.binding/open-isic-recordConcordance-v1']}]
