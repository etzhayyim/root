...
VALUES
  ('at://did:web:tsukuru.etzhayyim.com/app.etzhayyim.mcp.toolDef/ai-gftd-apps-tsukuru-cadProject-create',
   0, 0, 'app.etzhayyim.apps.tsukuru.cadProject.create',
  ...
  ('at://did:web:tsukuru.etzhayyim.com/app.etzhayyim.mcp.toolDef/ai-gftd-apps-tsukuru-cadPart-upsert',
   0, 0, 'app.etzhayyim.apps.tsukuru.cadPart.upsert',
   'did:web:tsukuru.etzhayyim.com', 'tsukuru.etzhayyim.com', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-14T15:00:00Z'),
  ('at://did:web:tsukuru.etzhayyim.com/app.etzhayyim.mcp.toolDef/ai-gftd-apps-tsukuru-meviy-requestQuote',
   0, 0, 'app.etzhayyim.apps.tsukuru.meviy.requestQuote',
   'did:web:tsukuru.etzhayyim.com', 'tsukuru.etzhayyim.com', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-14T15:00:00Z'),
  ('at://did:web:tsukuru.etzhayyim.com/app.etzhayyim.mcp.toolDef/ai-gftd-apps-tsukuru-pcbProject-create',
   0, 0, 'app.etzhayyim.apps.tsukuru.pcbProject.create',
   'did:web:tsukuru.etzhayyim.com', 'tsukuru.etzhayyim.com', 'procedure',
   ...
   'anon', 'anon', '', '2026-05-14T15:00:00Z'),
  ('at://did:web:tsukuru.etzhayyim.com/app.etzhayyim.mcp.toolDef/ai-gftd-apps-tsukuru-pban-requestQuote',
   0, 0, 'app.etzhayyim.apps.tsukuru.pban.requestQuote',
   'did:web:tsukuru.etzhayyim.com', 'tsukuru.etzhayyim.com', 'procedure',
...
PHASE3_NODES_CAD = [
    ("tsukuru_cad_design_flow.v1:project_init", "tsukuru_cad_design_flow.v1", "project_init", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.cadProject.create",
     '{"input_keys":["productRef","projectName","cadTool","totalParts"],"result_key":"projectVid","args":{"name":"app.etzhayyim.apps.tsukuru.cadProject.create"}}'),
    ("tsukuru_cad_design_flow.v1:part_modeling", "tsukuru_cad_design_flow.v1", "part_modeling", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.cadPart.upsert",
     '{"input_keys":["projectVid","currentPartIdx","stepFiles"],"result_key":"partVid","args":{"name":"app.etzhayyim.apps.tsukuru.cadPart.upsert"},"loop_var":"currentPartIdx","loop_max":"totalParts"}'),
    ("tsukuru_cad_design_flow.v1:tolerance_review", "tsukuru_cad_design_flow.v1", "tolerance_review", "mcp_tool",
     "mcp://app.etzhayyim.tools.sql.query",
     '{"input_keys":["projectVid"],"result_key":"toleranceErrors","args":{"name":"app.etzhayyim.tools.sql.query","sql":"SELECT part_number, tolerance_class, fit_check_note FROM vertex_tsukuru_cad_part WHERE project_vid = %(project_vid)s AND tolerance_class NOT IN (\'standard\',\'h7\',\'h6\') LIMIT 50"}}'),
    ("tsukuru_cad_design_flow.v1:meviy_quote", "tsukuru_cad_design_flow.v1", "meviy_quote", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.meviy.requestQuote",
     '{"input_keys":["projectVid"],"result_key":"meviyQuote","args":{"name":"app.etzhayyim.apps.tsukuru.meviy.requestQuote"}}'),
    ...
    ("tsukuru_cad_design_flow.v1:order_submit", "tsukuru_cad_design_flow.v1", "order_submit", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.productionOrder.create",
     '{"input_keys":["projectVid","meviyQuote"],"result_key":"orderId","args":{"name":"app.etzhayyim.apps.tsukuru.productionOrder.create","fulfillmentMode":"mto","vendorDid":"did:web:misumi-meviy.tsukuru.etzhayyim.com"}}'),
    ("tsukuru_cad_design_flow.v1:delivery_track", "tsukuru_cad_design_flow.v1", "delivery_track", "mcp_tool",
     "mcp://app.etzhayyim.tools.sql.query",
     '{"input_keys":["orderId"],"result_key":"deliveryStatus","args":{"name":"app.etzhayyim.tools.sql.query","sql":"SELECT status FROM vertex_tsukuru_production_order WHERE vertex_id = %(order_id)s LIMIT 1"}}'),
...
PHASE3_NODES_PCB = [
    ("tsukuru_pcb_design_flow.v1:schematic_design", "tsukuru_pcb_design_flow.v1", "schematic_design", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.pcbProject.create",
     '{"input_keys":["productRef","pcbName","kicadVersion","boardSizeMm","layerCount"],"result_key":"projectVid","args":{"name":"app.etzhayyim.apps.tsukuru.pcbProject.create"}}'),
    ...
    ("tsukuru_pcb_design_flow.v1:drc_check", "tsukuru_pcb_design_flow.v1", "drc_check", "mcp_tool",
     "mcp://app.etzhayyim.tools.sql.query",
     '{"input_keys":["projectVid"],"result_key":"drcErrors","args":{"name":"app.etzhayyim.tools.sql.query","sql":"SELECT drc_errors FROM vertex_tsukuru_pcb_project WHERE vertex_id = %(project_vid)s LIMIT 1"}}'),
    ...
    ("tsukuru_pcb_design_flow.v1:pban_quote", "tsukuru_pcb_design_flow.v1", "pban_quote", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.pban.requestQuote",
     '{"input_keys":["projectVid","gerberRef"],"result_key":"pbanQuote","args":{"name":"app.etzhayyim.apps.tsukuru.pban.requestQuote","quantity":10,"needsAssembly":true}}'),
    ...
    ("tsukuru_pcb_design_flow.v1:order_submit", "tsukuru_pcb_design_flow.v1", "order_submit", "mcp_tool",
     "mcp://app.etzhayyim.apps.tsukuru.productionOrder.create",
     '{"input_keys":["projectVid","pbanQuote"],"result_key":"orderId","args":{"name":"app.etzhayyim.apps.tsukuru.productionOrder.create","fulfillmentMode":"mto","vendorDid":"did:web:pban-com.tsukuru.etzhayyim.com"}}'),
