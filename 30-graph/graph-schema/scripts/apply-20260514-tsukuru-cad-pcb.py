...
Usage:
  DATABASE_URL=postgresql://root:...@45.32.79.245:4566/dev python3 \
...
VALUES
  ('tsukuru_cad_design_flow.v1', 0, 0, 'did:web:tsukuru.gftd.ai', 'tsukuru_cad_design_flow.v1', 1, 'topology', NULL,
...
INSERT INTO vertex_langgraph_assistant
  (vertex_id, _seq, sensitivity_ord, owner_did, assistant_id, version, kind, factory_path,
   spec, description, created_at, checkpointer_mode)
VALUES
  ('tsukuru_pcb_design_flow.v1', 0, 0, 'did:web:tsukuru.gftd.ai', 'tsukuru_pcb_design_flow.v1', 1, 'topology', NULL,
...
PHASE3_NODES_CAD = [
    ("tsukuru_cad_design_flow.v1:project_init", "tsukuru_cad_design_flow.v1", "project_init", "mcp_tool",
     "mcp://ai.gftd.apps.tsukuru.cadProject.create",
    ...
    ("tsukuru_cad_design_flow.v1:part_modeling", "tsukuru_cad_design_flow.v1", "part_modeling", "mcp_tool",
     "mcp://ai.gftd.apps.tsukuru.cadPart.upsert",
    ...
    ("tsukuru_cad_design_flow.v1:tolerance_review", "tsukuru_cad_design_flow.v1", "tolerance_review", "mcp_tool",
     "mcp://ai.gftd.tools.sql.query",
     '{"input_keys":["projectVid"],"result_key":"toleranceErrors","args":{"name":"ai.gftd.tools.sql.query","sql":"SELECT part_number, tolerance_class, fit_check_note FROM vertex_tsukuru_cad_part WHERE project_vid = %(project_vid)s AND tolerance_class NOT IN (\'standard\',\'h7\',\'h6\') LIMIT 50"}}'),
    ("tsukuru_cad_design_flow.v1:meviy_quote", "tsukuru_cad_design_flow.v1", "meviy_quote", "mcp_tool",
     "mcp://ai.gftd.apps.tsukuru.meviy.requestQuote",
    ...
    ("tsukuru_cad_design_flow.v1:order_submit", "tsukuru_cad_design_flow.v1", "order_submit", "mcp_tool",
     "mcp://ai.gftd.apps.tsukuru.productionOrder.create",
    ...
    ("tsukuru_cad_design_flow.v1:delivery_track", "tsukuru_cad_design_flow.v1", "delivery_track", "mcp_tool",
     "mcp://ai.gftd.tools.sql.query",
     '{"input_keys":["orderId"],"result_key":"deliveryStatus","args":{"name":"ai.gftd.tools.sql.query","sql":"SELECT status FROM vertex_tsukuru_production_order WHERE vertex_id = %(order_id)s LIMIT 1"}}'),
...
PHASE3_NODES_PCB = [
    ("tsukuru_pcb_design_flow.v1:schematic_design", "tsukuru_pcb_design_flow.v1", "schematic_design", "mcp_tool",
     "mcp://ai.gftd.apps.tsukuru.pcbProject.create",
    ...
    ("tsukuru_pcb_design_flow.v1:pban_quote", "tsukuru_pcb_design_flow.v1", "pban_quote", "mcp_tool",
     "mcp://ai.gftd.apps.tsukuru.pban.requestQuote",
...
VALUES (%s, 0, 0, 'did:web:tsukuru.gftd.ai', %s, %s, %s, %s, %s, '2026-05-14T15:00:00Z')
"""
