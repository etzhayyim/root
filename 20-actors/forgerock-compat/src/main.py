"""
Py Kotodama WASM entrypoint for the Forgerock clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "forgerock-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
