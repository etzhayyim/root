"""
Py Kotodama WASM entrypoint for the Flyio clean-room actor.
...
def delete_service(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"flyio.Service", "id": eid})
...
def delete_deployment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"flyio.Deployment", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_secret(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"flyio.Secret", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_api_proxy(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"flyio.ApiProxy", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_database(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"flyio.Database", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_function(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"flyio.Function", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "flyio-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
