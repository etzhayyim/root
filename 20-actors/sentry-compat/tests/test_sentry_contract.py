"""
Contract test for the sentry-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "sentry.kotoba")
ENTITIES = ['Issue', 'Event', 'Project', 'Organization', 'Team', 'Release']
PLURALS = {'Issue': 'issues', 'Event': 'events', 'Project': 'projects', 'Organization': 'organizations', 'Team': 'teams', 'Release': 'releases'}


class SentryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['level', 'priority', 'status']:
