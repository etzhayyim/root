"""
Contract test for the adyen-compat L4 actor.
...
ENTITIES = ['PaymentRequest', 'PaymentResponse', 'Amount', 'PaymentRefundRequest', 'PaymentRefundResponse', 'PaymentCaptureResponse']
PLURALS = {'PaymentRequest': 'paymentrequests', 'PaymentResponse': 'paymentresponses', 'Amount': 'amounts', 'PaymentRefundRequest': 'paymentrefundrequests', 'PaymentRefundResponse': 'paymentrefundresponses', 'PaymentCaptureResponse': 'paymentcaptureresponses'}
...
class AdyenContract(unittest.TestCase):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['channel', 'merchantRefundReason', 'recurringProcessingModel', 'resultCode']:
