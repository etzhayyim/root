"""
Py Kotodama WASM entrypoint for the Adyen clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "adyen-compat", "entities": ['Customer', 'PaymentIntent', 'Charge', 'Refund', 'Payout', 'PaymentMethod']}, 200
