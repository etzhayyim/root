...
Usage:
    python3 ingest_mcp.py [--url http://127.0.0.1:8077] [--graph app.etzhayyim.hodoki] [--dry-run]
"""
...
def main() -> int:
    ...
    ap.add_argument("--graph", default="app.etzhayyim.hodoki") # Changed from tsukuru
