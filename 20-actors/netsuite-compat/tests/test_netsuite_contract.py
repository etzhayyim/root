"""
Contract test for the netsuite-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "netsuite.kotoba")
ENTITIES = ['GLAccount', 'JournalEntry', 'Invoice', 'PurchaseOrder', 'Vendor', 'CostCenter']
PLURALS = {'GLAccount': 'glaccounts', 'JournalEntry': 'journalentries', 'Invoice': 'invoices', 'PurchaseOrder': 'purchaseorders', 'Vendor': 'vendors', 'CostCenter': 'costcenters'}


class NetsuiteContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
