"""
Contract test for the bloomberg_commodities-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bloomberg_commodities.kotoba")
ENTITIES = ['Commodity', 'Price', 'Contract', 'Series', 'Inventory', 'Forecast']
PLURALS = {'Commodity': 'commodities', 'Price': 'prices', 'Contract': 'contracts', 'Series': 'serieses', 'Inventory': 'inventories', 'Forecast': 'forecasts'}


class BloombergCommoditiesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
