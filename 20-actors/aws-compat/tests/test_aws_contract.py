...
ENTITIES = ['Instance', 'Volume', 'Vpc', 'SecurityGroup']
PLURALS = {'Instance': 'instances', 'Volume': 'volumes', 'Vpc': 'vpcs', 'SecurityGroup': 'securitygroups'}
...
class AwsContract(unittest.TestCase):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['hypervisor', 'instanceTenancy', 'state']:
