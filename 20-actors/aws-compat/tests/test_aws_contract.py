"""
Contract test for the aws-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "aws.kotoba")
ENTITIES = ['Ec2Instance', 'S3Bucket', 'S3Object', 'LambdaFunction', 'DynamoTable', 'IamRole', 'RdsInstance']
PLURALS = {'Ec2Instance': 'ec2instances', 'S3Bucket': 's3buckets', 'S3Object': 's3objects', 'LambdaFunction': 'lambdafunctions', 'DynamoTable': 'dynamotables', 'IamRole': 'iamroles', 'RdsInstance': 'rdsinstances'}


class AwsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
