"""
Contract test for the globalpayments-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "globalpayments.kotoba")
...
class GlobalpaymentsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
