"""
Py Kotodama WASM entrypoint for the Cdr_australia clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "cdr_australia-compat", "entities": ['Filing', 'Corporation', 'Disclosure', 'Citizen', 'Application', 'Dataset']}, 200
