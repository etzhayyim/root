"""
Py Kotodama WASM entrypoint for the Pubmatic clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"pubmatic.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_campaign(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pubmatic.Campaign", "id": eid})
...
def delete_audience(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pubmatic.Audience", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_event(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pubmatic.Event", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_profile(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pubmatic.Profile", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_message(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pubmatic.Message", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_funnel(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pubmatic.Funnel", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "pubmatic-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
