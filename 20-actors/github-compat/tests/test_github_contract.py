"""
Contract test for the github-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "github.kotoba")
ENTITIES = ['Repository', 'Issue', 'PullRequest', 'Commit', 'Workflow', 'WorkflowRun', 'Release']
PLURALS = {'Repository': 'repositories', 'Issue': 'issues', 'PullRequest': 'pullrequests', 'Commit': 'commits', 'Workflow': 'workflows', 'WorkflowRun': 'workflowruns', 'Release': 'releases'}
