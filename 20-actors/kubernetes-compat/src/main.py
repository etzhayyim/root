"""
Py Kotodama WASM entrypoint for the Kubernetes clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "kubernetes-compat", "entities": ['Repository', 'Pipeline', 'Build', 'Artifact', 'Deployment', 'Webhook']}, 200
