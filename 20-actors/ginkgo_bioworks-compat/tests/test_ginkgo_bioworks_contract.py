"""
Contract test for the ginkgo_bioworks-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ginkgo_bioworks.kotoba")
...
class GinkgoBioworksContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
