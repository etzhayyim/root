...
ENTITIES = ['Molecule', 'Assay', 'Target', 'Activity', 'Document']
PLURALS = {'Molecule': 'molecules', 'Assay': 'assays', 'Target': 'targets', 'Activity': 'activities', 'Document': 'documents'}
...
class ChemblContract(unittest.TestCase):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['docType', 'moleculeType', 'targetType']:
