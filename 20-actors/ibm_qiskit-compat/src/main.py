"""
Py Kotodama WASM entrypoint for the Ibm_qiskit clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "ibm_qiskit-compat", "entities": ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']}, 200
