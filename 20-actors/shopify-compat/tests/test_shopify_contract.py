"""
Contract test for the shopify-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "shopify.kotoba")
ENTITIES = ['Product', 'Variant', 'Order', 'Customer', 'Collection', 'Fulfillment', 'DiscountCode']
PLURALS = {'Product': 'products', 'Variant': 'variants', 'Order': 'orders', 'Customer': 'customers', 'Collection': 'collections', 'Fulfillment': 'fulfillments', 'DiscountCode': 'discountcodes'}


class ShopifyContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['financialStatus', 'status', 'valueType']:
