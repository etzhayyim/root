"""
Contract test for the worldbank-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "worldbank.kotoba")
ENTITIES = ['Country', 'Indicator', 'Source', 'IncomeLevel', 'LendingType', 'Topic']
PLURALS = {'Country': 'countries', 'Indicator': 'indicators', 'Source': 'sources', 'IncomeLevel': 'incomelevels', 'LendingType': 'lendingtypes', 'Topic': 'topics'}


class WorldbankContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['id', 'incomeLevelId', 'lendingTypeId']:
