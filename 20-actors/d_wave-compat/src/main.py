"""
Py Kotodama WASM entrypoint for the D_wave clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "d_wave-compat", "entities": ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']}, 200
