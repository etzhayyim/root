"""
Contract test for the d_wave-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "d_wave.kotoba")
ENTITIES = ['ProblemMetadata', 'SolverConfiguration', 'StructuredProblemData', 'StructuredProblemAnswer', 'Region']
PLURALS = {'ProblemMetadata': 'problemmetadatas', 'SolverConfiguration': 'solverconfigurations', 'StructuredProblemData': 'structuredproblemdatas', 'StructuredProblemAnswer': 'structuredproblemanswers', 'Region': 'regions'}


class DWaveContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
