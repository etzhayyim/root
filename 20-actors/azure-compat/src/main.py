"""
Py Kotodama WASM entrypoint for the Azure clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "azure-compat", "entities": ['Project', 'ComputeInstance', 'Volume', 'Bucket', 'Network', 'IamRole']}, 200
