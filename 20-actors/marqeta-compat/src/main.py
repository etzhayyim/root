"""
Py Kotodama WASM entrypoint for the Marqeta clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "marqeta-compat", "entities": ['Account', 'Card', 'Transaction', 'Order', 'Wallet', 'Ledger']}, 200
