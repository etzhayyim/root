"""
Contract test for the airbus_analytx-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "airbus_analytx.kotoba")
...
class AirbusAnalytxContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
