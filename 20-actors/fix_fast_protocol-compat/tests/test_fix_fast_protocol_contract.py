"""
Contract test for the fix_fast_protocol-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "fix_fast_protocol.kotoba")
...
class FixFastProtocolContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
