"""
Contract test for the ss7_sigtran-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ss7_sigtran.kotoba")
ENTITIES = ['M3uaMessage', 'SuaMessage', 'ProtocolData', 'Mtp3Message', 'SccpMessage']
PLURALS = {'M3uaMessage': 'm3uamessages', 'SuaMessage': 'suamessages', 'ProtocolData': 'protocoldatas', 'Mtp3Message': 'mtp3messages', 'SccpMessage': 'sccpmessages'}


class Ss7SigtranContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['messageClass', 'networkIndicator', 'ni']:
