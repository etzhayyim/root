"""
Py Kotodama WASM entrypoint for the Kakao_talk clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "kakao_talk-compat", "entities": ['Channel', 'Message', 'User', 'Room', 'Stream', 'Webhook']}, 200
