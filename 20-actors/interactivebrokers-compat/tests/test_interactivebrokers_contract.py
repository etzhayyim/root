"""
Contract test for the interactivebrokers-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "interactivebrokers.kotoba")
...
class InteractivebrokersContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
