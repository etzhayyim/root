"""
Contract test for the automationanywhere-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "automationanywhere.kotoba")
ENTITIES = ['Bot', 'Process', 'Job', 'Queue', 'Asset', 'ProcessMining']
PLURALS = {'Bot': 'bots', 'Process': 'processes', 'Job': 'jobs', 'Queue': 'queues', 'Asset': 'assets', 'ProcessMining': 'processminings'}


class AutomationanywhereContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
