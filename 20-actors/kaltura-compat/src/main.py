"""
Py Kotodama WASM entrypoint for the Kaltura clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "kaltura-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
