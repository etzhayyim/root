"""
Contract test for the hs_codes_customs-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "hs_codes_customs.kotoba")
...
class HsCodesCustomsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
