"""
Py Kotodama WASM entrypoint for the Coinbaseprime clean-room actor.
...
def _persist(entity, rec):
    ...
    for k, v in rec.items():
        facts[f"coinbaseprime.{entity}/{k}"] = v
    db.transact([facts])
    return rec
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"coinbaseprime.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"coinbaseprime.Account", "id": eid})
...
def delete_card(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"coinbaseprime.Card", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_transaction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"coinbaseprime.Transaction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_order(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"coinbaseprime.Order", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_wallet(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"coinbaseprime.Wallet", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_ledger(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"coinbaseprime.Ledger", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "coinbaseprime-compat", "entities": ['Account', 'Card', 'Transaction', 'Order', 'Wallet', 'Ledger']}, 200
