...
Overall R0 maturity: **22/30**. This is a usable design scaffold, not a running
collector.

## Next R1 Work

1. Add fixture-only parser for one regulator/bulk source before any platform
   page/API adapter.
2. Add source-policy review workflow that can disable an adapter without code
   changes.
3. Add fixture-backed parser invariants for creative/delivery/landing output.
