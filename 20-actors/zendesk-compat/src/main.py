"""
Py Kotodama WASM entrypoint for the Zendesk clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "zendesk-compat", "entities": ['Ticket', 'Survey', 'Response', 'Account', 'Conversation', 'Contact']}, 200
