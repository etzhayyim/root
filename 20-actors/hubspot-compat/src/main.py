"""
Py Kotodama WASM entrypoint for the Hubspot clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "hubspot-compat", "entities": ['Account', 'Contact', 'Lead', 'Opportunity', 'Activity', 'Pipeline']}, 200
