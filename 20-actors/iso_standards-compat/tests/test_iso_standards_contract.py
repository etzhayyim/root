"""
Contract test for the iso_standards-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "iso_standards.kotoba")
ENTITIES = ['Work', 'Author', 'Citation', 'Standard', 'Record', 'Subject']
PLURALS = {'Work': 'works', 'Author': 'authors', 'Citation': 'citations', 'Standard': 'standards', 'Record': 'records', 'Subject': 'subjects'}


class IsoStandardsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
