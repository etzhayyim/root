"""
Contract test for the mitsubishi_centum-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mitsubishi_centum.kotoba")
...
class MitsubishiCentumContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
