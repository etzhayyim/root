"""
Py Kotodama WASM entrypoint for the Datarobot clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"datarobot.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_model(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"datarobot.Model", "id": eid})
...
def delete_completion(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"datarobot.Completion", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_embedding(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"datarobot.Embedding", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_fine_tune(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"datarobot.FineTune", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"datarobot.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_file(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"datarobot.File", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "datarobot-compat", "entities": ['Model', 'Completion', 'Embedding', 'FineTune', 'Dataset', 'File']}, 200
