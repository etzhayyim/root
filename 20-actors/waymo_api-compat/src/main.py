"""
Py Kotodama WASM entrypoint for the Waymo_api clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "waymo_api-compat", "entities": ['Vehicle', 'Signal', 'ChargeSession', 'Connector', 'Trip', 'Command']}, 200
