"""
Contract test for the digitalocean-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "digitalocean.kotoba")
ENTITIES = ['Droplet', 'Volume', 'DatabaseCluster', 'LoadBalancer', 'KubernetesCluster', 'Image']
PLURALS = {'Droplet': 'droplets', 'Volume': 'volumes', 'DatabaseCluster': 'databaseclusters', 'LoadBalancer': 'loadbalancers', 'KubernetesCluster': 'kubernetesclusters', 'Image': 'images'}


class DigitaloceanContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['engine', 'filesystemType', 'status', 'type']:
