"""
Contract test for the spacex_telemetry-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "spacex_telemetry.kotoba")
...
class SpacexTelemetryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
