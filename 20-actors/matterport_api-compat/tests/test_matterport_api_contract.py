"""
Contract test for the matterport_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "matterport_api.kotoba")
...
class MatterportApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
