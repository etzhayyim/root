"""
Py Kotodama WASM entrypoint for the Thegraph clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "thegraph-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
