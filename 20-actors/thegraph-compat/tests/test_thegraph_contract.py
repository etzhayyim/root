"""
Contract test for the thegraph-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "thegraph.kotoba")
ENTITIES = ['Subgraph', 'SubgraphDeployment', 'Indexer', 'Allocation', 'PublishedSubgraph']
PLURALS = {'Subgraph': 'subgraphs', 'SubgraphDeployment': 'subgraphdeployments', 'Indexer': 'indexers', 'Allocation': 'allocations', 'PublishedSubgraph': 'publishedsubgraphs'}


class ThegraphContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
