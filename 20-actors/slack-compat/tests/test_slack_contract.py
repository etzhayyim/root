"""
Contract test for the slack-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "slack.kotoba")
ENTITIES = ['Channel', 'Message', 'User', 'Conversation', 'File', 'Reaction']
PLURALS = {'Channel': 'channels', 'Message': 'messages', 'User': 'users', 'Conversation': 'conversations', 'File': 'files', 'Reaction': 'reactions'}


class SlackContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
