...
PLURALS = {'Document': 'documents', 'Metadata': 'metadatas'}
...
class EdinetContract(unittest.TestCase):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['attachDocFlag', 'csvFlag', 'disclosureStatus', 'docInfoEditStatus', 'englishDocFlag', 'legalStatus', 'pdfFlag', 'withdrawalStatus', 'xbrlFlag']:
