"""
Contract test for the honeywell_plantscape-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "honeywell_plantscape.kotoba")
ENTITIES = ['Tag', 'Device', 'Alarm', 'Trend', 'ControlLoop', 'Batch']
PLURALS = {'Tag': 'tags', 'Device': 'devices', 'Alarm': 'alarms', 'Trend': 'trends', 'ControlLoop': 'controlloops', 'Batch': 'batches'}


class HoneywellPlantscapeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
