"""
Contract test for the autogpt_forge-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "autogpt_forge.kotoba")
ENTITIES = ['Agent', 'Task', 'Message', 'Tool', 'Memory', 'Plan']
PLURALS = {'Agent': 'agents', 'Task': 'tasks', 'Message': 'messages', 'Tool': 'tools', 'Memory': 'memories', 'Plan': 'plans'}


class AutogptForgeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
