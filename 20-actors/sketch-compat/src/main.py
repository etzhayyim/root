"""
Py Kotodama WASM entrypoint for the Sketch clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sketch-compat", "entities": ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']}, 200
