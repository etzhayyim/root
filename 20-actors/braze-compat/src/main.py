"""
Py Kotodama WASM entrypoint for the Braze clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "braze-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
