"""
Contract test for the corelogic_hazard-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "corelogic_hazard.kotoba")
...
class CorelogicHazardContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
