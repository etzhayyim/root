"""
Contract test for the chips_clearing-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "chips_clearing.kotoba")
...
class ChipsClearingContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
