"""
Contract test for the stratus_clearpath-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "stratus_clearpath.kotoba")
ENTITIES = ['Job', 'Dataset', 'Region', 'Subsystem', 'Transaction', 'Queue']
PLURALS = {'Job': 'jobs', 'Dataset': 'datasets', 'Region': 'regions', 'Subsystem': 'subsystems', 'Transaction': 'transactions', 'Queue': 'queues'}


class StratusClearpathContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
