"""
Contract test for the landsat-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "landsat.kotoba")
ENTITIES = ['LandsatItemProperties', 'StacAsset', 'InstrumentProperties', 'EoBandProperties']
PLURALS = {'LandsatItemProperties': 'landsatitempropertieses', 'StacAsset': 'stacassets', 'InstrumentProperties': 'instrumentpropertieses', 'EoBandProperties': 'eobandpropertieses'}


class LandsatContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['collectionCategory', 'collectionNumber', 'correction', 'wrsType']:
