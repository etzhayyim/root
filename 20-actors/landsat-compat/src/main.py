"""
Py Kotodama WASM entrypoint for the Landsat clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "landsat-compat", "entities": ['Object', 'Position', 'Observation', 'Scene', 'Float', 'Station']}, 200
