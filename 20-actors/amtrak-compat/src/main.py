"""
Py Kotodama WASM entrypoint for the Amtrak clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"amtrak.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_stop(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"amtrak.Stop", "id": eid})
...
def delete_route(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"amtrak.Route", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_trip(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"amtrak.Trip", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_vehicle(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"amtrak.Vehicle", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_service_alert(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"amtrak.ServiceAlert", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_fare(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"amtrak.Fare", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "amtrak-compat", "entities": ['Stop', 'Route', 'Trip', 'Vehicle', 'ServiceAlert', 'Fare']}, 200
