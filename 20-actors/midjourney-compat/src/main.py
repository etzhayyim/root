"""
Py Kotodama WASM entrypoint for the Midjourney clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "midjourney-compat", "entities": ['Model', 'Completion', 'Embedding', 'FineTune', 'Dataset', 'File']}, 200
