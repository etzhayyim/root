"""
Contract test for the hike_messenger-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "hike_messenger.kotoba")
ENTITIES = ['Channel', 'Message', 'User', 'Room', 'Stream', 'Webhook']
PLURALS = {'Channel': 'channels', 'Message': 'messages', 'User': 'users', 'Room': 'rooms', 'Stream': 'streams', 'Webhook': 'webhooks'}


class HikeMessengerContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
