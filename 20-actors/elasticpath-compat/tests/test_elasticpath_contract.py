"""
Contract test for the elasticpath-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "elasticpath.kotoba")
ENTITIES = ['Catalog', 'Product', 'Requisition', 'PurchaseOrder', 'Supplier', 'Invoice']
PLURALS = {'Catalog': 'catalogs', 'Product': 'products', 'Requisition': 'requisitions', 'PurchaseOrder': 'purchaseorders', 'Supplier': 'suppliers', 'Invoice': 'invoices'}


class ElasticpathContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
