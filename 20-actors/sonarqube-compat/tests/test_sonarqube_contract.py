"""
Contract test for the sonarqube-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "sonarqube.kotoba")
ENTITIES = ['Issue', 'Hotspot', 'QualityGate', 'Condition', 'Measure']
PLURALS = {'Issue': 'issues', 'Hotspot': 'hotspots', 'QualityGate': 'qualitygates', 'Condition': 'conditions', 'Measure': 'measures'}


class SonarqubeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['resolution', 'severity', 'status', 'type']:
