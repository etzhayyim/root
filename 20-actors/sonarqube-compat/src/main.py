"""
Py Kotodama WASM entrypoint for the Sonarqube clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sonarqube-compat", "entities": ['Service', 'Error', 'Trace', 'Metric', 'Alert', 'Incident']}, 200
