"""
Contract test for the swift_iso20022-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "swift_iso20022.kotoba")
...
class SwiftIso20022Contract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
