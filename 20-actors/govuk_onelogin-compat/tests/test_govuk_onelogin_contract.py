"""
Contract test for the govuk_onelogin-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "govuk_onelogin.kotoba")
ENTITIES = ['Filing', 'Citizen', 'Service', 'Application', 'Dataset', 'Identity']
PLURALS = {'Filing': 'filings', 'Citizen': 'citizens', 'Service': 'services', 'Application': 'applications', 'Dataset': 'datasets', 'Identity': 'identities'}


class GovukOneloginContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
