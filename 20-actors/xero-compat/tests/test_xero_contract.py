"""
Contract test for the xero-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "xero.kotoba")
ENTITIES = ['Invoice', 'Contact', 'Account', 'Payment', 'BankTransaction', 'CreditNote']
PLURALS = {'Invoice': 'invoices', 'Contact': 'contacts', 'Account': 'accounts', 'Payment': 'payments', 'BankTransaction': 'banktransactions', 'CreditNote': 'creditnotes'}


class XeroContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['contactStatus', 'paymentType', 'status', 'type']:
