"""
Py Kotodama WASM entrypoint for the Xero clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "xero-compat", "entities": ['GLAccount', 'JournalEntry', 'Invoice', 'PurchaseOrder', 'Vendor', 'CostCenter']}, 200
