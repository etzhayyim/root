"""
Py Kotodama WASM entrypoint for the Mta_ny clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "mta_ny-compat", "entities": ['Stop', 'Route', 'Trip', 'Vehicle', 'ServiceAlert', 'Fare']}, 200
