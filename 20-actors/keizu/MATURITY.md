...
- **Tests**: `./run_tests.sh` green — **167 tests** across weave (47) / social (7) / ingest (17) / sources (8) / registry (7) / bridge (10) / export (6) / charter-invariants (28) / analyze (11) / lexicons (5) / consistency (6) / cells (12) / membrane-flow (3).
