...
- **Tests**: `./run_tests.sh` green — **159 tests** across weave (42) / social (7) / ingest (14) / sources (8) / registry (7) / bridge (10) / export (6) / charter-invariants (28) / analyze (11) / lexicons (5) / consistency (6) / cells (12) / membrane-flow (3).
