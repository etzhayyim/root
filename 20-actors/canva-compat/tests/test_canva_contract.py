"""
Contract test for the canva-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "canva.kotoba")
ENTITIES = ['Design', 'Asset', 'Folder', 'BrandTemplate', 'ExportJob', 'User']
PLURALS = {'Design': 'designs', 'Asset': 'assets', 'Folder': 'folders', 'BrandTemplate': 'brandtemplates', 'ExportJob': 'exportjobs', 'User': 'users'}


class CanvaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['format', 'status', 'type']:
