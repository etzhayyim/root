"""
Py Kotodama WASM entrypoint for the Canva clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "canva-compat", "entities": ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']}, 200
