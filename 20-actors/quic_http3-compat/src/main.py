"""
Py Kotodama WASM entrypoint for the Quic_http3 clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "quic_http3-compat", "entities": ['Prefix', 'Route', 'Peer', 'Zone', 'Record', 'Tunnel']}, 200
