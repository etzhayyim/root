"""
Contract test for the quic_http3-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "quic_http3.kotoba")
ENTITIES = ['QuicPacket', 'QuicFrame', 'Http3Frame', 'Http3Settings', 'QuicConnection']
PLURALS = {'QuicPacket': 'quicpackets', 'QuicFrame': 'quicframes', 'Http3Frame': 'http3frames', 'Http3Settings': 'http3settingses', 'QuicConnection': 'quicconnections'}


class QuicHttp3Contract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['frameType', 'packetType']:
