"""
Py Kotodama WASM entrypoint for the Fdic clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "fdic-compat", "entities": ['Account', 'Consent', 'Transaction', 'PaymentInitiation', 'Institution', 'Filing']}, 200
