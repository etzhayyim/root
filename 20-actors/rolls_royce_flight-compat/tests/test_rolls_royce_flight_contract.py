"""
Contract test for the rolls_royce_flight-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "rolls_royce_flight.kotoba")
ENTITIES = ['Flight', 'Booking', 'Segment', 'Property', 'Reservation', 'Fare']
PLURALS = {'Flight': 'flights', 'Booking': 'bookings', 'Segment': 'segments', 'Property': 'properties', 'Reservation': 'reservations', 'Fare': 'fares'}


class RollsRoyceFlightContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
