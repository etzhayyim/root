"""
Py Kotodama WASM entrypoint for the Alchemy clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "alchemy-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
