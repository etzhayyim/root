"""
Contract test for the alchemy-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "alchemy.kotoba")
ENTITIES = ['Block', 'BlockQuery', 'Receipt']
PLURALS = {'Block': 'blocks', 'BlockQuery': 'blockqueries', 'Receipt': 'receipts'}


class AlchemyContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
