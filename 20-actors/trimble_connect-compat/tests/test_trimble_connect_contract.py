"""
Contract test for the trimble_connect-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "trimble_connect.kotoba")
...
class TrimbleConnectContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
