"""
Contract test for the criteo_commerce-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "criteo_commerce.kotoba")
...
class CriteoCommerceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
