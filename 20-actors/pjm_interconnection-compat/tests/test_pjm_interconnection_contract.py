"""
Contract test for the pjm_interconnection-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "pjm_interconnection.kotoba")
ENTITIES = ['Meter', 'Reading', 'Node', 'LoadForecast', 'MarketBid', 'Tag']
PLURALS = {'Meter': 'meters', 'Reading': 'readings', 'Node': 'nodes', 'LoadForecast': 'loadforecasts', 'MarketBid': 'marketbids', 'Tag': 'tags'}


class PjmInterconnectionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
