"""
Contract test for the firebase-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "firebase.kotoba")
ENTITIES = ['Document', 'Value', 'Index', 'IndexField', 'Order']
PLURALS = {'Document': 'documents', 'Value': 'values', 'Index': 'indexes', 'IndexField': 'indexfields', 'Order': 'orders'}


class FirebaseContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['arrayConfig', 'direction', 'nullValue', 'order', 'state']:
