"""
Py Kotodama WASM entrypoint for the Firebase clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"firebase.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def healthz(request):
    return {"status": "ok", "actor": "firebase-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
