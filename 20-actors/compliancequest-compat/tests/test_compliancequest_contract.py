"""
Contract test for the compliancequest-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "compliancequest.kotoba")
ENTITIES = ['DataSubject', 'ConsentRecord', 'Request', 'Control', 'Evidence', 'Assessment']
PLURALS = {'DataSubject': 'datasubjects', 'ConsentRecord': 'consentrecords', 'Request': 'requests', 'Control': 'controls', 'Evidence': 'evidences', 'Assessment': 'assessments'}


class CompliancequestContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
