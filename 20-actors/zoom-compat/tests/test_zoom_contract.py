"""
Contract test for the zoom-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "zoom.kotoba")
ENTITIES = ['Meeting', 'Webinar', 'Recording', 'Registrant', 'User']
PLURALS = {'Meeting': 'meetings', 'Webinar': 'webinars', 'Recording': 'recordings', 'Registrant': 'registrants', 'User': 'users'}


class ZoomContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
