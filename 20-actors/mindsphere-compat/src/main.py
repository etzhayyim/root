"""
Py Kotodama WASM entrypoint for the Mindsphere clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "mindsphere-compat", "entities": ['Device', 'Telemetry', 'Gateway', 'Command', 'Firmware', 'Alert']}, 200
