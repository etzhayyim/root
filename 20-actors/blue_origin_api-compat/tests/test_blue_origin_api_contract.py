"""
Contract test for the blue_origin_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "blue_origin_api.kotoba")
...
class BlueOriginApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
