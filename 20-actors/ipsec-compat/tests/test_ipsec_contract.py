"""
Contract test for the ipsec-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ipsec.kotoba")
ENTITIES = ['IkeHeader', 'Payload', 'SecurityAssociation', 'Proposal', 'Transform', 'Notify']
PLURALS = {'IkeHeader': 'ikeheaders', 'Payload': 'payloads', 'SecurityAssociation': 'securityassociations', 'Proposal': 'proposals', 'Transform': 'transforms', 'Notify': 'notifies'}


class IpsecContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['exchangeType', 'payloadType', 'protocolId', 'type']:
