"""
Contract test for the rms_underwriting-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "rms_underwriting.kotoba")
...
class RmsUnderwritingContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
