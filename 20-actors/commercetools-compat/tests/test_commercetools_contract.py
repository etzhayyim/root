"""
Contract test for the commercetools-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "commercetools.kotoba")
ENTITIES = ['Order', 'Cart', 'Payment', 'Product', 'Customer', 'Transaction']
PLURALS = {'Order': 'orders', 'Cart': 'carts', 'Payment': 'payments', 'Product': 'products', 'Customer': 'customers', 'Transaction': 'transactions'}


class CommercetoolsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['cartState', 'orderState', 'paymentState', 'priceMode', 'shipmentState', 'state', 'type']:
