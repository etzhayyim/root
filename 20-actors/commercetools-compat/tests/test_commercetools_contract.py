...
ENTITIES = ['ContentEntry', 'Product', 'Shipment', 'SearchIndex', 'Webhook', 'Order']
PLURALS = {'ContentEntry': 'contententries', 'Product': 'products', 'Shipment': 'shipments', 'SearchIndex': 'searchindexes', 'Webhook': 'webhooks', 'Order': 'orders'}
