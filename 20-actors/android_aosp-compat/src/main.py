"""
Py Kotodama WASM entrypoint for the Android_aosp clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "android_aosp-compat", "entities": ['Process', 'Thread', 'FileDescriptor', 'Syscall', 'MemoryRegion', 'Signal']}, 200
