"""
Contract test for the android_aosp-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "android_aosp.kotoba")
ENTITIES = ['BatteryStatus', 'Build']
PLURALS = {'BatteryStatus': 'batterystatuses', 'Build': 'builds'}


class AndroidAospContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
