"""
Py Kotodama WASM entrypoint for the Iterable clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "iterable-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
