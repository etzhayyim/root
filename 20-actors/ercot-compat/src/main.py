"""
Py Kotodama WASM entrypoint for the Ercot clean-room actor.
...
def delete_meter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ercot.Meter", "id": eid})
...
def delete_reading(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ercot.Reading", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_node(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ercot.Node", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_load_forecast(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ercot.LoadForecast", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_market_bid(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ercot.MarketBid", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_tag(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ercot.Tag", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "ercot-compat", "entities": ['Meter', 'Reading', 'Node', 'LoadForecast', 'MarketBid', 'Tag']}, 200
