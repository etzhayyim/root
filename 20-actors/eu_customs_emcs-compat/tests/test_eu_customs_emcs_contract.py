"""
Contract test for the eu_customs_emcs-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "eu_customs_emcs.kotoba")
...
class EuCustomsEmcsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
