"""
Py Kotodama WASM entrypoint for the Gusto clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "gusto-compat", "entities": ['Employee', 'Candidate', 'JobReq', 'PayrollRun', 'TimeOff', 'Review']}, 200
