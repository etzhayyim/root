"""
Contract test for the segment-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "segment.kotoba")
ENTITIES = ['TrackEvent', 'IdentifyEvent', 'PageEvent', 'GroupEvent', 'Source', 'Destination']
PLURALS = {'TrackEvent': 'trackevents', 'IdentifyEvent': 'identifyevents', 'PageEvent': 'pageevents', 'GroupEvent': 'groupevents', 'Source': 'sources', 'Destination': 'destinations'}
