"""
Py Kotodama WASM entrypoint for the Spatial_os clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "spatial_os-compat", "entities": ['Player', 'Session', 'Match', 'Leaderboard', 'Inventory', 'Achievement']}, 200
