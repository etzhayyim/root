"""
Contract test for the mightynetworks-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mightynetworks.kotoba")
ENTITIES = ['Event', 'Ticket', 'Attendee', 'Donor', 'Donation', 'Membership']
PLURALS = {'Event': 'events', 'Ticket': 'tickets', 'Attendee': 'attendees', 'Donor': 'donors', 'Donation': 'donations', 'Membership': 'memberships'}


class MightynetworksContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
