"""
Contract test for the supabase-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "supabase.kotoba")
ENTITIES = ['Project', 'Organization', 'EdgeFunction', 'ApiKey', 'Branch', 'Backup']
PLURALS = {'Project': 'projects', 'Organization': 'organizations', 'EdgeFunction': 'edgefunctions', 'ApiKey': 'apikeys', 'Branch': 'branches', 'Backup': 'backups'}


class SupabaseContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['previewProjectStatus', 'region', 'status', 'type']:
