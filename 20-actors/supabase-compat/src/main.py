"""
Py Kotodama WASM entrypoint for the Supabase clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "supabase-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
