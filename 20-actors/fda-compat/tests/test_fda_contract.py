"""
Contract test for the fda-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "fda.kotoba")
ENTITIES = ['DrugEvent', 'EnforcementReport', 'DrugLabel', 'DeviceEvent']
PLURALS = {'DrugEvent': 'drugevents', 'EnforcementReport': 'enforcementreports', 'DrugLabel': 'druglabels', 'DeviceEvent': 'deviceevents'}


class FdaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['adverseEventFlag', 'classification', 'eventType', 'fulfillexpeditecriteria', 'productType', 'reporttype', 'serious', 'status']:
