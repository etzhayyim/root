"""
Py Kotodama WASM entrypoint for the Fda clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "fda-compat", "entities": ['Filing', 'Entity', 'Dataset', 'Application', 'PublicRecord', 'Notice']}, 200
