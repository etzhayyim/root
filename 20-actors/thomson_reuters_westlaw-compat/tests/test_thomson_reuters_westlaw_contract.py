"""
Contract test for the thomson_reuters_westlaw-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "thomson_reuters_westlaw.kotoba")
ENTITIES = ['Matter', 'Document', 'Custodian', 'Review', 'ProductionSet', 'LegalHold']
PLURALS = {'Matter': 'matters', 'Document': 'documents', 'Custodian': 'custodians', 'Review': 'reviews', 'ProductionSet': 'productionsets', 'LegalHold': 'legalholds'}


class ThomsonReutersWestlawContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
