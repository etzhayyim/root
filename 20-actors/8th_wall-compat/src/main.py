"""
Py Kotodama WASM entrypoint for the 8th_wall clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"8th_wall.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_anchor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"8th_wall.Anchor", "id": eid})
...
def delete_scene(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"8th_wall.Scene", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_mesh(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"8th_wall.Mesh", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_session(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"8th_wall.Session", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_asset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"8th_wall.Asset", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_device(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"8th_wall.Device", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "8th_wall-compat", "entities": ['Anchor', 'Scene', 'Mesh', 'Session', 'Asset', 'Device']}, 200
