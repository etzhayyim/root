"""
Contract test for the twist_bioscience-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "twist_bioscience.kotoba")
...
class TwistBioscienceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
