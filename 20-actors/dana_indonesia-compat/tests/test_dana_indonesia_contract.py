"""
Contract test for the dana_indonesia-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "dana_indonesia.kotoba")
...
class DanaIndonesiaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
