"""
Contract test for the hapag_lloyd_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "hapag_lloyd_api.kotoba")
...
class HapagLloydApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
