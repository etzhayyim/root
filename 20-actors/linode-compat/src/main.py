...
def delete_project(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"linode.Project", "id": eid})
...
def delete_compute_instance(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"linode.ComputeInstance", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_bucket(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"linode.Bucket", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_network(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"linode.Network", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_iam_role(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"linode.IamRole", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "linode-compat", "entities": ['Project', 'ComputeInstance', 'Volume', 'Bucket', 'Network', 'IamRole']}, 200
