"""
Contract test for the iso_claimsearch-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "iso_claimsearch.kotoba")
...
class IsoClaimsearchContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
