"""
Contract test for the anduril_lattice-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "anduril_lattice.kotoba")
...
class AndurilLatticeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
