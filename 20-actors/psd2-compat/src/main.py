"""
Py Kotodama WASM entrypoint for the Psd2 clean-room actor.
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"psd2.Account", "id": eid})
...
def delete_consent(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"psd2.Consent", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_transaction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"psd2.Transaction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_payment_initiation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"psd2.PaymentInitiation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_institution(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"psd2.Institution", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"psd2.Filing", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "psd2-compat", "entities": ['Account', 'Consent', 'Transaction', 'PaymentInitiation', 'Institution', 'Filing']}, 200
