...
def delete_workspace(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"miro.Workspace", "id": eid})
...
def delete_document(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"miro.Document", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_folder(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"miro.Folder", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_comment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"miro.Comment", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_permission(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"miro.Permission", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_user(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"miro.User", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "miro-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
