"""
Py Kotodama WASM entrypoint for the Aave clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "aave-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
