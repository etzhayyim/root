"""
Contract test for the aave-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "aave.kotoba")
ENTITIES = ['ReserveData', 'EModeCategory', 'UserConfigurationMap', 'ExecuteBorrowParams']
PLURALS = {'ReserveData': 'reservedatas', 'EModeCategory': 'emodecategories', 'UserConfigurationMap': 'userconfigurationmaps', 'ExecuteBorrowParams': 'executeborrowparamses'}


class AaveContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
