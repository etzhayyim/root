"""
Py Kotodama WASM entrypoint for the Hologram clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "hologram-compat", "entities": ['Device', 'Telemetry', 'Gateway', 'Command', 'Firmware', 'Alert']}, 200
