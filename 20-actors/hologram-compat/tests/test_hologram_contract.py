"""
Contract test for the hologram-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "hologram.kotoba")
ENTITIES = ['Device', 'CellularLink', 'DataPlan', 'SmsRecord', 'Tag']
PLURALS = {'Device': 'devices', 'CellularLink': 'cellularlinks', 'DataPlan': 'dataplans', 'SmsRecord': 'smsrecords', 'Tag': 'tags'}


class HologramContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['euiccState', 'euiccType']:
