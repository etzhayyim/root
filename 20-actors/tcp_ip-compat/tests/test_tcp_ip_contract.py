"""
Contract test for the tcp_ip-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "tcp_ip.kotoba")
ENTITIES = ['TcpSegment', 'TcpConnection', 'IpPacket', 'IcmpMessage']
PLURALS = {'TcpSegment': 'tcpsegments', 'TcpConnection': 'tcpconnections', 'IpPacket': 'ippackets', 'IcmpMessage': 'icmpmessages'}
