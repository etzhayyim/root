"""
Contract test for the quintessencelabs-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "quintessencelabs.kotoba")
...
class QuintessencelabsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
