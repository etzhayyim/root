"""
Contract test for the twilio-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "twilio.kotoba")
ENTITIES = ['Message', 'Call', 'PhoneNumber', 'Verification', 'Recording', 'Conference']
PLURALS = {'Message': 'messages', 'Call': 'calls', 'PhoneNumber': 'phonenumbers', 'Verification': 'verifications', 'Recording': 'recordings', 'Conference': 'conferences'}


class TwilioContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
