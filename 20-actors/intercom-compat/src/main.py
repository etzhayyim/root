"""
Py Kotodama WASM entrypoint for the Intercom clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "intercom-compat", "entities": ['Ticket', 'Survey', 'Response', 'Account', 'Conversation', 'Contact']}, 200
