"""
Contract test for the openxr-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "openxr.kotoba")
ENTITIES = ['Instance', 'System', 'Session', 'ViewConfiguration', 'Swapchain']
PLURALS = {'Instance': 'instances', 'System': 'systems', 'Session': 'sessions', 'ViewConfiguration': 'viewconfigurations', 'Swapchain': 'swapchains'}


class OpenxrContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['environmentBlendMode', 'formFactor', 'state']:
