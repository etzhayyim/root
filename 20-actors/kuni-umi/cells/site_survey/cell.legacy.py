...
Trigger:    MST listener on `ai.gftd.apps.etzhayyim.kuniUmi.defineDeploymentSite`
...
def emit_survey(state: SiteSurveyState, deps: CellDeps) -> SiteSurveyState:
    ...
    raise NotImplementedError(
        ...
        "Writes ai.gftd.apps.etzhayyim.kuniUmi.submitSiteSurvey to MST."
    )
...
def healthz_extra(deps: CellDeps) -> dict:
    ...
    return {
        ...
        "trigger_nsid": "ai.gftd.apps.etzhayyim.kuniUmi.defineDeploymentSite",
    }
