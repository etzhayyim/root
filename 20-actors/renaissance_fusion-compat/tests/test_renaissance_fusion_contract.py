"""
Contract test for the renaissance_fusion-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "renaissance_fusion.kotoba")
...
class RenaissanceFusionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
