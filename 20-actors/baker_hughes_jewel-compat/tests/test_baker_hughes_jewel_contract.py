"""
Contract test for the baker_hughes_jewel-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "baker_hughes_jewel.kotoba")
...
class BakerHughesJewelContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
