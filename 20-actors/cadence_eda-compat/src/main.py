"""
Py Kotodama WASM entrypoint for the Cadence_eda clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "cadence_eda-compat", "entities": ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']}, 200
