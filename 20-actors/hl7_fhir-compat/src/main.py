"""
Py Kotodama WASM entrypoint for the Hl7_fhir clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"hl7_fhir.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_patient(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hl7_fhir.Patient", "id": eid})
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hl7_fhir.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_condition(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hl7_fhir.Condition", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_diagnostic_report(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hl7_fhir.DiagnosticReport", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_sequence(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hl7_fhir.Sequence", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_specimen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hl7_fhir.Specimen", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "hl7_fhir-compat", "entities": ['Patient', 'Observation', 'Condition', 'DiagnosticReport', 'Sequence', 'Specimen']}, 200
