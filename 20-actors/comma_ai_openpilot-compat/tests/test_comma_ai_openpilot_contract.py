...
ENTITIES = ['Event', 'CarState', 'CarControl', 'CarParams']
PLURALS = {'Event': 'events', 'CarState': 'carstates', 'CarControl': 'carcontrols', 'CarParams': 'carparamses'}
