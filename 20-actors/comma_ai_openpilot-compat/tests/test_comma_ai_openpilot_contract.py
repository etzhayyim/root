"""
Contract test for the comma_ai_openpilot-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "comma_ai_openpilot.kotoba")
ENTITIES = ['Vehicle', 'Signal', 'ChargeSession', 'Connector', 'Trip', 'Command']
PLURALS = {'Vehicle': 'vehicles', 'Signal': 'signals', 'ChargeSession': 'chargesessions', 'Connector': 'connectors', 'Trip': 'trips', 'Command': 'commands'}


class CommaAiOpenpilotContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
