"""
Py Kotodama WASM entrypoint for the Comma_ai_openpilot clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "comma_ai_openpilot-compat", "entities": ['Vehicle', 'Signal', 'ChargeSession', 'Connector', 'Trip', 'Command']}, 200
