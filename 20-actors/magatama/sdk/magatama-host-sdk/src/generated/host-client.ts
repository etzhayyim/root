...
export const HOST_NSID = {
	accessLogRecord: 'ai.gftd.host.accessLog.record' as const,
	activityAwaitAll: 'ai.gftd.host.activity.awaitAll' as const,
	activitySpawnParallel: 'ai.gftd.host.activity.spawnParallel' as const,
	authnVerifyToken: 'ai.gftd.host.authn.verifyToken' as const,
	authzEnforce: 'ai.gftd.host.authz.enforce' as const,
	capabilityDiscover: 'ai.gftd.host.capability.discover' as const,
	capabilityListOwn: 'ai.gftd.host.capability.listOwn' as const,
	cdnPublicUrl: 'ai.gftd.host.cdn.publicUrl' as const,
	cdnUpload: 'ai.gftd.host.cdn.upload' as const,
	conversationCreateSession: 'ai.gftd.host.conversation.createSession' as const,
	conversationSendMessage: 'ai.gftd.host.conversation.sendMessage' as const,
	coreConfigGet: 'ai.gftd.host.core.configGet' as const,
	coreLogAppend: 'ai.gftd.host.core.logAppend' as const,
	governanceCheckPolicy: 'ai.gftd.host.governance.checkPolicy' as const,
	governanceRegisterManifest: 'ai.gftd.host.governance.registerManifest' as const,
	identityListActors: 'ai.gftd.host.identity.listActors' as const,
	identityResolve: 'ai.gftd.host.identity.resolve' as const,
	invokeCall: 'ai.gftd.host.invoke.call' as const,
	ipfsPublish: 'ai.gftd.host.ipfs.publish' as const,
	llmChat: 'ai.gftd.host.llm.chat' as const,
	llmConverse: 'ai.gftd.host.llm.converse' as const,
	llmReact: 'ai.gftd.host.llm.react' as const,
	llmRoute: 'ai.gftd.host.llm.route' as const,
	lockTryLock: 'ai.gftd.host.lock.tryLock' as const,
	lockUnlock: 'ai.gftd.host.lock.unlock' as const,
	m365AcquireAppToken: 'ai.gftd.host.m365.acquireAppToken' as const,
	m365BatchMoveMessages: 'ai.gftd.host.m365.batchMoveMessages' as const,
	m365CreateDraft: 'ai.gftd.host.m365.createDraft' as const,
	m365EnumerateUsers: 'ai.gftd.host.m365.enumerateUsers' as const,
	m365FetchMailFolders: 'ai.gftd.host.m365.fetchMailFolders' as const,
	m365FetchMessagesPage: 'ai.gftd.host.m365.fetchMessagesPage' as const,
	m365ListDrafts: 'ai.gftd.host.m365.listDrafts' as const,
	m365SendDraft: 'ai.gftd.host.m365.sendDraft' as const,
	m365SendMail: 'ai.gftd.host.m365.sendMail' as const,
	ocelEmitEvent: 'ai.gftd.host.ocel.emitEvent' as const,
	pubsubPublish: 'ai.gftd.host.pubsub.publish' as const,
	pubsubPull: 'ai.gftd.host.pubsub.pull' as const,
	secretsDelete: 'ai.gftd.host.secrets.delete' as const,
	secretsGet: 'ai.gftd.host.secrets.get' as const,
	secretsSet: 'ai.gftd.host.secrets.set' as const,
	storageGetObject: 'ai.gftd.host.storage.getObject' as const,
	storagePutObject: 'ai.gftd.host.storage.putObject' as const,
	telemetryEmitMetric: 'ai.gftd.host.telemetry.emitMetric' as const,
	telemetryLog: 'ai.gftd.host.telemetry.log' as const,
	virtualActorInvoke: 'ai.gftd.host.virtualActor.invoke' as const,
} as const;
...
/** Send an email via Graph POST /users/{fromUpn}/sendMail. Requires Azure app-only Mail.Send. This host capability is unconditional — policy routing (internal direct / external draft_only) is enforced by the caller (e.g. ai.gftd.apps.microsoft.sendMail). For Teams channel posting, pass the channel email address as a recipient (channel_email_via_mail_send pattern). */
