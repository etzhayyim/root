...
// the TS mirror of `pymagatama.kotoba_datomic` — identical NSIDs, identical
...
export const DEFAULT_KOTOBA_GRAPH = "etzhayyim/magatama/graph";
 ...
 *  `KOTOBA_SESSION_POP` / `MAGATAMA_KOTOBA_GRAPH` from the env bag. */
