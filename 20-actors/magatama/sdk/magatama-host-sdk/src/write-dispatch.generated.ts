...
export async function dispatchWriteEntry(
  ...
  switch (entry.type) {
    ...
    case "d1-accept-websocket":
      return xrpc("app.etzhayyim.cloudflare.acceptWebsocket", entry.payload);
    // magatama:cloudflare/d1@1.0.0#block-concurrency-while
    case "d1-block-concurrency-while":
      return xrpc("app.etzhayyim.cloudflare.blockConcurrencyWhile", entry.payload);
    // magatama:cloudflare/d1@1.0.0#close
    case "d1-close":
      return xrpc("app.etzhayyim.cloudflare.close", entry.payload);
    // magatama:cloudflare/d1@1.0.0#connect
    case "d1-connect":
      return xrpc("app.etzhayyim.cloudflare.connect", entry.payload);
    // magatama:cloudflare/d1@1.0.0#database-size
    case "d1-database-size":
      return xrpc("app.etzhayyim.cloudflare.databaseSize", entry.payload);
    // magatama:cloudflare/d1@1.0.0#delete
    case "d1-delete":
      return xrpc("app.etzhayyim.cloudflare.delete", entry.payload);
    // magatama:cloudflare/d1@1.0.0#delete-alarm
    case "d1-delete-alarm":
      return xrpc("app.etzhayyim.cloudflare.deleteAlarm", entry.payload);
    // magatama:cloudflare/d1@1.0.0#delete-all
    case "d1-delete-all":
      return xrpc("app.etzhayyim.cloudflare.deleteAll", entry.payload);
    // magatama:cloudflare/d1@1.0.0#delete-multiple
    case "d1-delete-multiple":
      return xrpc("app.etzhayyim.cloudflare.deleteMultiple", entry.payload);
    // magatama:cloudflare/d1@1.0.0#dump
    case "d1-dump":
      return xrpc("app.etzhayyim.cloudflare.dump", entry.payload);
    // magatama:cloudflare/d1@1.0.0#exec
    case "d1-exec":
      return xrpc("app.etzhayyim.cloudflare.exec", entry.payload);
    // magatama:cloudflare/d1@1.0.0#fetch
    case "d1-fetch":
      return xrpc("app.etzhayyim.cloudflare.fetch", entry.payload);
    // magatama:cloudflare/d1@1.0.0#get
    case "d1-get":
      return xrpc("app.etzhayyim.cloudflare.get", entry.payload);
    // magatama:cloudflare/d1@1.0.0#id-from-name
    case "d1-id-from-name":
      return xrpc("app.etzhayyim.cloudflare.idFromName", entry.payload);
    // magatama:cloudflare/d1@1.0.0#new-unique-id
    case "d1-new-unique-id":
      return xrpc("app.etzhayyim.cloudflare.newUniqueId", entry.payload);
    // magatama:cloudflare/d1@1.0.0#put
    case "d1-put":
      return xrpc("app.etzhayyim.cloudflare.put", entry.payload);
    // magatama:cloudflare/d1@1.0.0#put-multiple
    case "d1-put-multiple":
      return xrpc("app.etzhayyim.cloudflare.putMultiple", entry.payload);
    // magatama:cloudflare/d1@1.0.0#send-binary
    case "d1-send-binary":
      return xrpc("app.etzhayyim.cloudflare.sendBinary", entry.payload);
    // magatama:cloudflare/d1@1.0.0#send-text
    case "d1-send-text":
      return xrpc("app.etzhayyim.cloudflare.sendText", entry.payload);
    // magatama:cloudflare/d1@1.0.0#set-alarm
    case "d1-set-alarm":
      return xrpc("app.etzhayyim.cloudflare.setAlarm", entry.payload);
    // magatama:cloudflare/d1@1.0.0#set-auto-response
    case "d1-set-auto-response":
      return xrpc("app.etzhayyim.cloudflare.setAutoResponse", entry.payload);
    // magatama:cloudflare/d1@1.0.0#sync
    case "d1-sync":
      return xrpc("app.etzhayyim.cloudflare.sync", entry.payload);
    // magatama:cloudflare/d1@1.0.0#transaction
    case "d1-transaction":
      return xrpc("app.etzhayyim.cloudflare.transaction", entry.payload);
    // magatama:cloudflare/d1@1.0.0#wait-until
    case "d1-wait-until":
      return xrpc("app.etzhayyim.cloudflare.waitUntil", entry.payload);
    ...
    case "hosting-ozone-get-account-history":
      return xrpc("app.etzhayyim.apps.hosting.ozoneGetAccountHistory", entry.payload);

    // ── com-atproto:identity/identity@1.0.0 ──
    // com-atproto:identity/identity@1.0.0#create
    case "identity-create":
      return xrpc("app.etzhayyim.apps.identity.create", entry.payload);
    // com-atproto:identity/identity@1.0.0#create-record
    case "identity-create-record":
      return xrpc("app.etzhayyim.apps.identity.createRecord", entry.payload);
    // com-atproto:identity/identity@1.0.0#deactivate
    case "identity-deactivate":
      return xrpc("app.etzhayyim.apps.identity.deactivate", entry.payload);
    // com-atproto:identity/identity@1.0.0#delete-record
    case "identity-delete-record":
      return xrpc("app.etzhayyim.apps.identity.deleteRecord", entry.payload);
    // com-atproto:identity/identity@1.0.0#refresh-identity
    case "identity-refresh-identity":
      return xrpc("app.etzhayyim.apps.identity.refreshIdentity", entry.payload);
    ...
    case "identity-request-plc-operation-signature":
      return xrpc("app.etzhayyim.apps.identity.requestPlcOperationSignature", entry.payload);
    ...
    case "notification-put-activity-subscription":
      return xrpc("app.etzhayyim.apps.notification.putActivitySubscription", entry.payload);
    // app-bsky:notification/notification@1.0.0#put-notification-preferences
    case "notification-put-notification-preferences":
      return xrpc("app.etzhayyim.apps.notification.putNotificationPreferences", entry.payload);
    ...
    case "notification-put-notification-preferences-v2":
      return xrpc("app.etzhayyim.apps.notification.putNotificationPreferencesV2", entry.payload);
    // app-bsky:notification/notification@1.0.0#register-push
    case "notification-register-push":
      return xrpc("app.etzhayyim.apps.notification.registerPush", entry.payload);
    // app-bsky:notification/notification@1.0.0#unregister-push
    case "notification-unregister-push":
      return xrpc("app.etzhayyim.apps.notification.unregisterPush", entry.payload);
    // app-bsky:notification/notification@1.0.0#update-seen
    case "notification-update-seen":
      return xrpc("app.etzhayyim.apps.notification.updateSeen", entry.payload);
    ...
    case "signature-ozone-signature-find-correlation":
      return xrpc("app.etzhayyim.apps.signature.ozoneSignatureFindCorrelation", entry.payload);
    ...
    case "signature-ozone-signature-find-related-accounts":
      return xrpc("app.etzhayyim.apps.signature.ozoneSignatureFindRelatedAccounts", entry.payload);
    // tools-ozone:signature/signature@1.0.0#ozone-signature-search-accounts
    case "signature-ozone-signature-search-accounts":
      return xrpc("app.etzhayyim.apps.signature.ozoneSignatureSearchAccounts", entry.payload);

    // ── magatama:identity/source@1.0.0 ──
    // magatama:identity/source@1.0.0#deactivate
    case "source-deactivate":
      return xrpc("app.etzhayyim.identity.deactivate", entry.payload);
    // magatama:identity/source@1.0.0#get
    case "source-get":
      return xrpc("app.etzhayyim.identity.get", entry.payload);
    // magatama:identity/source@1.0.0#list
    case "source-list":
      return xrpc("app.etzhayyim.identity.list", entry.payload);
    // magatama:identity/source@1.0.0#register
    case "source-register":
      return xrpc("app.etzhayyim.identity.register", entry.payload);
    // magatama:identity/source@1.0.0#update
    case "source-update":
      return xrpc("app.etzhayyim.identity.update", entry.payload);

    // ── ai-gftd:wrpc/stream@1.0.0 ──
    // ai-gftd:wrpc/stream@1.0.0#close
    case "stream-close":
      return xrpc("app.etzhayyim.apps.wrpc.close", entry.payload);
