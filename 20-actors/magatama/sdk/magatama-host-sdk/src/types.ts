// types.ts — Canonical type definitions for magatama host SDK.
...
// Host functions covering every WIT import from magatama:runtime world.
...
export interface HostImports {
  ...
  // ── magatama:telemetry/access-log ──
  accessLogRecord(entryJson: string): void;

  // ── magatama:audit/audit-trail ──
