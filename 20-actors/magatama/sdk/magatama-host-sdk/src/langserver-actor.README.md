...
Magatama actor wrapper around a per-taxonomy LangGraph Pregel langserver,
...
```
$ vitest run 20-actors/magatama/sdk/magatama-host-sdk/test/langserver-actor.test.ts
