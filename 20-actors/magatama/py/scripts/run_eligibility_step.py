...
CLI args into ``pymagatama.eligibility.web3_ports.build_production_ports``,
...
def main(argv: list[str] | None = None) -> int:
    ...
    from pymagatama.eligibility import EligibilityCell
    from pymagatama.eligibility.web3_ports import (
        Web3Config,
