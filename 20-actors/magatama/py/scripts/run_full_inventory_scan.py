...
from pymagatama.lan_topology import run_lan_topology, persist_topology
from pymagatama.host_inventory import (
    run_host_inventory,
    persist_host_inventory,
    persist_sharemouse_config,
    persist_sharemouse_screenshots,
)
from pymagatama.host_inventory.run import _link_device_to_interfaces
