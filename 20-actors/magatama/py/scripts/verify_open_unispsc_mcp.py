...
async def verify() -> dict[str, Any]:
    from pymagatama.mcp_dispatch import build_actor_handlers
    ...
    checks = {
        ...
        "segmentImportTransform": segment_import["result"].get("importPlan", {}).get("transformTool") == "ai.gftd.apps.openUnispsc.syncCatalogItem",
        ...
        "purchasePlanInvocation": purchase_plan["result"].get("procurementInvocation", {}).get("mcpTool") == "ai.gftd.apps.openUnispsc.itemGetSpec",
