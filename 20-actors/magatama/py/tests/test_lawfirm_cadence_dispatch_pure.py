...
class _Stub:
    ...
    def install(self):
        import pymagatama.primitives.lawfirm_cadence_dispatch as p
...
class TestOutreachPathExtraction(unittest.TestCase):
    def test_extracts_outbox_path(self):
        from pymagatama.primitives.lawfirm_cadence_dispatch import _outreach_path_from_notes
...
class TestDispatchHappyPath(unittest.TestCase):
    def test_dispatches_due_lead_and_bumps_stage(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_cadence_dispatch import task_cadence_dispatch_due_mails
...
class TestFollowUpT5d(unittest.TestCase):
    def test_drafts_followup_when_no_reply(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_cadence_dispatch import task_cadence_dispatch_follow_ups
