...
class _Stub:
    ...
    def install(self):
        import pymagatama.primitives.lawfirm_msgraph as p
...
class TestRenewNoSubscriptions(unittest.TestCase):
    def test_returns_zero_when_no_active_subs(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_msgraph import (
    ...
    def test_handles_empty_upn_gracefully(self):
        ...
        try:
            ...
            out = asyncio.run(task_lawfirm_msgraph_subscription_ensure(
                ...
                folder="Inbox",
                notification_url="https://lawfirm.etzhayyim.com/xrpc/ai.gftd.apps.lawfirm.mailReplyWebhook",
