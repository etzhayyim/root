"""Tests for pymagatama.yatachain attestation primitives.

Pairs with 20-actors/etzhayyim-sdk/test/yatachain-witnessed-write.test.ts
...
from pymagatama.yatachain import (
    Attestation,
    LayerVerdict,
    MembraneLayerRef,
    MembraneRule,
...
def _mock_rule(nsid: str = "test.example.foo") -> MembraneRule:
    return MembraneRule(
        ...
        cell_ref=MembraneLayerRef(path="20-actors/magatama/cells/test/", content_hash="c" * 64, version="abcdef0"),
        quorum_size=5,
        quorum_threshold=3,
