"""Pure-helper tests for pymagatama.kenkyusha.graph (Phase 2A — co-scientist Pregel).
...
# ── Stub heavy imports before pymagatama.kenkyusha.graph is loaded ───────────
...
from pymagatama.kenkyusha.graph import (   # noqa: E402  (post-stub import)
