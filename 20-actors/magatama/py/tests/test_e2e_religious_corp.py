...
_SM_MODULE = "pymagatama.primitives.shinka_murakumo"
_JM_MODULE = "pymagatama.primitives.joucho_murakumo"
_YS_MODULE = "pymagatama.primitives.yoro_social_murakumo"
...
async def test_e2e_religious_corp_full_cycle(mock_sdk: dict[str, MagicMock]) -> None:
    ...
    """
    import pymagatama.primitives.yoro_social_murakumo as ys
    import pymagatama.primitives.joucho_murakumo as jm
    import pymagatama.primitives.shinka_murakumo as sm
