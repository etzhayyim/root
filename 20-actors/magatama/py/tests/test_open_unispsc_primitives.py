...
async def test_open_unispsc_commodity_runs_hierarchy_business_logic():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_commodity
...
async def test_open_unispsc_segment_is_own_business_boundary():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_segment
...
async def test_open_unispsc_family_rejects_wrong_grain():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_family
...
async def test_mcp_dispatch_registers_open_unispsc_hierarchy_tools():
    from pymagatama.mcp_dispatch import build_actor_handlers, build_default_handlers, handle_envelope
...
async def test_open_unispsc_design_item_uses_bpmn_and_langchain_contract():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_design_item
...
async def test_open_unispsc_item_get_spec_is_executable_contract():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_item_get_spec
...
async def test_open_unispsc_item_screen_supplier_follows_supplier_bpmn_rules():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_item_screen_supplier
...
async def test_open_unispsc_item_plan_procurement_follows_procurement_bpmn_rules():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_item_plan_procurement
...
async def test_open_unispsc_item_flag_compliance_uses_arms_and_dualuse_bpmn():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_item_flag_compliance
...
async def test_open_unispsc_sync_catalog_item_maps_to_okaimono_catalog_contract():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_sync_catalog_item
...
async def test_open_unispsc_plan_catalog_purchase_invokes_segment_item_spec():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_plan_catalog_purchase
...
async def test_open_unispsc_sync_all_commodity_dids_plans_segment_fanout():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_sync_all_commodity_dids
...
async def test_open_unispsc_import_segment_catalog_plans_bulk_okaimono_import():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_import_segment_catalog
...
async def test_open_unispsc_supplier_matches_bpmn_lexicon_tool():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_supplier
...
async def test_open_unispsc_procurement_matches_bpmn_lexicon_tool():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_procurement
...
async def test_open_unispsc_direct_flag_tools_match_bpmn_lexicons():
    from pymagatama.primitives.open_unispsc import (
...
async def test_open_unispsc_apply_graph_write_plan_rejects_unknown_table():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_apply_graph_write_plan
...
async def test_open_unispsc_run_item_workflow_blocks_sanctioned_supplier():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_run_item_workflow
...
async def test_open_unispsc_coverage_snapshot_reports_complete_contract_surface():
    from pymagatama.primitives.open_unispsc import task_open_unispsc_coverage_snapshot
