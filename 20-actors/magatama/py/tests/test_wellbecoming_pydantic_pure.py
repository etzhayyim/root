...
class TestTrustWeightInput:
    def test_defaults(self):
        from pymagatama.primitives.wellbecoming_trust import (
    ...
    def test_from_job_uses_variables(self):
        from pymagatama.primitives.wellbecoming_trust import _TrustWeightInput
    ...
    def test_register_function_exists(self):
        from pymagatama.primitives.wellbecoming_trust import register
        import inspect
...
class TestNoiseInput:
    def test_defaults(self):
        from pymagatama.primitives.wellbecoming_noise import (
    ...
    def test_from_job_uses_variables(self):
        from pymagatama.primitives.wellbecoming_noise import _NoiseInput
        from unittest.mock import MagicMock
        job = MagicMock()
    ...
    def test_from_job_partial_override(self):
        from pymagatama.primitives.wellbecoming_noise import _NoiseInput, _SIGMA, _OU_THETA
        from unittest.mock import MagicMock
        job = MagicMock()
    ...
    def test_register_function_exists(self):
        from pymagatama.primitives.wellbecoming_noise import register
        import inspect
        assert inspect.isfunction(register)
...
class TestRestoringInput:
    def test_defaults(self):
        from pymagatama.primitives.wellbecoming_restoring import (
    ...
    def test_from_job_uses_variables(self):
        from pymagatama.primitives.wellbecoming_restoring import _RestoringInput
        from unittest.mock import MagicMock
        job = MagicMock()
    ...
    def test_register_function_exists(self):
        from pymagatama.primitives.wellbecoming_restoring import register
        import inspect
        assert inspect.isfunction(register)
...
class TestInfluenceInput:
    def test_defaults(self):
        from pymagatama.primitives.wellbecoming_influence import (
    ...
    def test_from_job_uses_variables(self):
        from pymagatama.primitives.wellbecoming_influence import _InfluenceInput
        from unittest.mock import MagicMock
        job = MagicMock()
    ...
    def test_register_function_exists(self):
        from pymagatama.primitives.wellbecoming_influence import register
        import inspect
        assert inspect.isfunction(register)
