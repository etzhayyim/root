...
class _Stub:
    def install(self):
        import pymagatama.primitives.lawfirm_intake as p
...
class TestIntakeSubmit(unittest.TestCase):
    ...
    def test_happy_path_english(self):
        from pymagatama.primitives.lawfirm_intake import task_lawfirm_intake_submit
...
class TestEncryptionField(unittest.TestCase):
    def test_signal_v1_prefix(self):
        from pymagatama.primitives.lawfirm_intake import _enc_field
        self.assertEqual(_enc_field("hello"), "signal:v1:hello")
        self.assertEqual(_enc_field(""), "")

    def test_localization_table(self):
        from pymagatama.primitives.lawfirm_intake import _NEXT_STEPS_MESSAGES
