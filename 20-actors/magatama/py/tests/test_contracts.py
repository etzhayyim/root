"""
Unit tests for pymagatama.handlers.contracts (ADR-0049 contracts pilot).
...
_src = _P(__file__).resolve().parents[1] / "src/pymagatama/handlers/contracts.py"
...
def stub_pool(monkeypatch: pytest.MonkeyPatch) -> _StubPool:
    ...
    import pymagatama.context as _ctx_mod
