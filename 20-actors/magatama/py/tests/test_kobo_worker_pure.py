...
def test_uid_prefix():
    from pymagatama.kobo_worker_main import _uid
...
def test_bud_agent_success():
    ...
    with patch("pymagatama.kobo_worker_main.sync_cursor", return_value=mock_cm):
        from pymagatama.kobo_worker_main import task_bud_agent
...
def test_germinate_no_spore_vertex():
    from pymagatama.kobo_worker_main import task_germinate
...
def test_germinate_spore_not_found():
    with patch("pymagatama.kobo_worker_main.fetch_one", return_value=None):
        from pymagatama.kobo_worker_main import task_germinate
