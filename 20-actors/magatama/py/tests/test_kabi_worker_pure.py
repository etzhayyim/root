...
def test_uid_prefix():
    from pymagatama.kabi_worker_main import _uid
...
def test_now_iso():
    from pymagatama.kabi_worker_main import _now
...
def test_anastomosis_probe_no_actor_rows():
    ...
    with (
        patch("pymagatama.kabi_worker_main.fetch_one", return_value=None),
        patch("pymagatama.kabi_worker_main.sync_cursor", return_value=mock_cm),
    ):
        from pymagatama.kabi_worker_main import task_anastomosis_probe
...
def test_anastomosis_probe_high_eta_diff():
    ...
    with patch("pymagatama.kabi_worker_main.fetch_one", side_effect=side):
        from pymagatama.kabi_worker_main import task_anastomosis_probe
...
def test_anastomosis_probe_prion_conflict():
    ...
    with patch("pymagatama.kabi_worker_main.fetch_one", side_effect=_mock_fetch):
        from pymagatama.kabi_worker_main import task_anastomosis_probe
...
def test_anastomosis_probe_accept_inserts_edge():
    ...
    with (
        patch("pymagatama.kabi_worker_main.fetch_one", side_effect=_mock_fetch),
        patch("pymagatama.kabi_worker_main.sync_cursor", return_value=mock_cm),
    ):
        from pymagatama.kabi_worker_main import task_anastomosis_probe
