...
from pymagatama.primitives import telecom_5gcore as TC5
from pymagatama.primitives import telecom_resource as TR
from pymagatama.primitives import telecom_oss as TOSS
