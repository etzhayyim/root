...
class TestLawfirmE2EMock(unittest.TestCase):
    def setUp(self):
        ...
        for name in ("lawfirm_pwc", "lawfirm_marketing", "lawfirm_esign_kpi", "lawfirm_sales"):
            mod = __import__(f"pymagatama.primitives.{name}", fromlist=[name])
        ...
        from pymagatama import db_alchemy
    ...
    def test_full_pipeline(self):
        ...
        from pymagatama.primitives.lawfirm_pwc import task_lawfirm_pwc_persist_request
        ...
        from pymagatama.primitives.lawfirm_pwc import task_lawfirm_pwc_apply_decision
        ...
        from pymagatama.primitives.lawfirm_sales import task_lawfirm_mail_reply_webhook
        ...
        from pymagatama.primitives.lawfirm_sales import task_lawfirm_pipeline_transition
        ...
        from pymagatama.primitives.lawfirm_esign_kpi import task_lawfirm_esign_request
        ...
        from pymagatama.primitives.lawfirm_marketing import task_lawfirm_payment_stripe_webhook
