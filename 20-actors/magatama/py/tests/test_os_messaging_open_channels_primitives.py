...
import pytest
from pymagatama.primitives import os_messaging_open_channels as OM  # noqa: E402


@pytest.fixture(autouse=True)
def _stub_db():
    with patch("pymagatama.primitives.os_messaging_open_channels.sync_cursor") as m:
        cur = MagicMock()
