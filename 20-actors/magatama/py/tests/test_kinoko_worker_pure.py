...
def test_uid_prefix():
    from pymagatama.kinoko_worker_main import _uid
...
def test_now_iso():
    from pymagatama.kinoko_worker_main import _now
...
def test_threshold_not_met_low_flow():
    ...
    with patch(
        "pymagatama.kinoko_worker_main.fetch_one",
...
def test_threshold_not_met_no_rows():
    ...
    with patch("pymagatama.kinoko_worker_main.fetch_one", return_value=None):
        from pymagatama.kinoko_worker_main import task_check_flow_threshold
...
def test_threshold_met_forms_block():
    ...
    with (
        ...
        patch("pymagatama.kinoko_worker_main.sync_cursor", return_value=mock_cm),
    ):
        from pymagatama.kinoko_worker_main import task_check_flow_threshold
