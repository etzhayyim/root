...
def test_ki_confidence_gate():
    from pymagatama.langgraph_graphs.ki_cycle import _confidence_gate
...
def test_saikin_signals_gate():
    from pymagatama.langgraph_graphs.saikin_cycle import _has_signals_gate
...
def test_saikin_transfer_gate():
    from pymagatama.langgraph_graphs.saikin_cycle import _transfer_outcome_gate
