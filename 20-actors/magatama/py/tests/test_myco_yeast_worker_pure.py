...
def test_uid_prefix():
    from pymagatama.myco_yeast_worker_main import _uid
...
def test_now_iso():
    from pymagatama.myco_yeast_worker_main import _now
...
def test_anastomosis_no_networks():
    ...
    with (
        patch(
            "pymagatama.myco_yeast_worker_main.fetch_one",
            side_effect=[None, None, (None,), (None,), (0,), (0,)],
        ),
        patch("pymagatama.myco_yeast_worker_main.sync_cursor", return_value=mock_cm),
    ):
...
def test_bud_agent_success():
    ...
    with (
        patch("pymagatama.myco_yeast_worker_main.fetch_one", return_value=parent_row),
        patch("pymagatama.myco_yeast_worker_main.fetch_all", return_value=prions),
        patch("pymagatama.myco_yeast_worker_main.sync_cursor", return_value=mock_cm),
    ):
        from pymagatama.myco_yeast_worker_main import task_kobo_bud_agent
...
def test_sporulate_success():
    ...
    with (
        patch("pymagatama.myco_yeast_worker_main.fetch_one", return_value=agent),
        patch("pymagatama.myco_yeast_worker_main.fetch_all", return_value=prions),
        patch("pymagatama.myco_yeast_worker_main.sync_cursor", return_value=mock_cm),
    ):
        from pymagatama.myco_yeast_worker_main import task_kobo_sporulate
...
def test_germinate_no_spore_id():
    from pymagatama.myco_yeast_worker_main import task_kobo_germinate
...
def test_create_ferment_no_input_ref():
    from pymagatama.myco_yeast_worker_main import task_hakkou_create_ferment_record
...
def test_create_ferment_success():
    ...
    with patch("pymagatama.myco_yeast_worker_main.sync_cursor", return_value=mock_cm):
        from pymagatama.myco_yeast_worker_main import task_hakkou_create_ferment_record
...
def test_llm_transform_no_input_ref():
    from pymagatama.myco_yeast_worker_main import task_hakkou_llm_transform
...
def test_finalize_no_ferment_id():
    from pymagatama.myco_yeast_worker_main import task_hakkou_finalize_ferment
