...
def test_uid_prefix():
    from pymagatama.hakkou_worker_main import _uid
...
def test_now_iso():
    from pymagatama.hakkou_worker_main import _now
...
def test_llm_transform_valid():
    ...
    with patch("pymagatama.llm.call_tier", mock_llm):
        from pymagatama.hakkou_worker_main import task_llm_transform
