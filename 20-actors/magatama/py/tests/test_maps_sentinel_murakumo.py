...
from pymagatama.primitives import maps_sentinel_murakumo as MSM  # noqa: E402
...
@patch("pymagatama.primitives.maps_sentinel_murakumo._lazy_import_llm")
async def test_t2_semantic_segment_land_cover_dispatches_to_llm(mock_lazy_import):
    ...
    with patch(
        "pymagatama.primitives.maps_sentinel_murakumo._scene_to_thumbnail_png",
...
def test_t2_no_sdk_raises_import_error():
    ...
    with patch(
        "pymagatama.primitives.maps_sentinel_murakumo._lazy_import_llm",
        return_value=None,
    ):
        scene = _sentinel2_scene()
