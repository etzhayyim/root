...
from pymagatama.organism.junkan import EavtSink
from pymagatama.organism.sensors.charter_rider import is_clean
from pymagatama.organism.sensors.legal.base import LegalTreatyObservation
...
def test_content_gate_and_tier_gate_compose(monkeypatch):
    ...
    from pymagatama.organism.junkan import SinkClass
    from pymagatama.organism.sensors.base import SensorObservation
