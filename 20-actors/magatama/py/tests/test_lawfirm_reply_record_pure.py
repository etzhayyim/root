...
class _Stub:
    ...
    def install(self):
        import pymagatama.primitives.lawfirm_reply_record as p
...
class TestSentimentClassifier(unittest.TestCase):
    def test_positive_keyword(self):
        from pymagatama.primitives.lawfirm_reply_record import _classify_sentiment
...
class TestSubjectStripping(unittest.TestCase):
    def test_strips_re_prefix(self):
        from pymagatama.primitives.lawfirm_reply_record import _strip_subject_prefix
...
class TestRecordReplyHappyPath(unittest.TestCase):
    def test_match_by_email_advances_stage(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_reply_record import task_lawfirm_record_reply
