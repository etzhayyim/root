...
FP = _load("_ingest_fingerprint", "pymagatama/ingest/fingerprint.py")
SB = _load("_ingest_scan_banner", "pymagatama/ingest/scan_banner.py")
WR = _load("_ingest_whois_rdap", "pymagatama/ingest/whois_rdap.py")
