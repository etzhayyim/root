...
# Stub pymagatama.llm and pymagatama.db_sync before importing projector
...
# Ensure pymagatama package stub exists
...
if _MOD_NAME not in sys.modules:
    _src = _py_src / "pymagatama" / "primitives" / "projector.py"
