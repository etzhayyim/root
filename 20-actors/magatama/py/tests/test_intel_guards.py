...
intel.py imports pymagatama.llm — stub it before loading.
...
# ensure pymagatama.llm is accessible as attribute of pymagatama
_pyma = sys.modules["pymagatama"]
...
if _MOD_NAME not in sys.modules:
    _src = _py_src / "pymagatama" / "primitives" / "intel.py"
