...
async def test_karma_hegemon_observation_cell_raises_import_error_without_sdk():
    ...
    module_name = "pymagatama.primitives.shinka_murakumo"
    original = sys.modules.pop(module_name, None)

    # Patch the _pds_mod and _mst_mod to None to simulate missing SDK
    import pymagatama.primitives.shinka_murakumo as SM_reloaded  # noqa: F401
...
_MODULE = "pymagatama.primitives.shinka_murakumo"
