...
from pymagatama.primitives import gov_esp as ESP
from pymagatama.primitives import gov_ita as ITA
from pymagatama.primitives import gov_pol as POL
from pymagatama.primitives import gov_kor as KOR
from pymagatama.primitives import gov_idn as IDN
from pymagatama.primitives import gov_zaf as ZAF
from pymagatama.primitives import gov_mex as MEX
from pymagatama.primitives import gov_tur as TUR
from pymagatama.primitives import gov_nld as NLD
from pymagatama.primitives import gov_swe as SWE
...
def test_esp_vertex_id() -> None:
    ...
    assert "at://" in vid and "ai.gftd.apps.states.govOrg" in vid
