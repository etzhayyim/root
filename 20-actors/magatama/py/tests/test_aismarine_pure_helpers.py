...
from pymagatama.primitives import aismarine as A
...
def test_batch_insert_drops_missing_required_fields():
    with patch("pymagatama.primitives.aismarine.sync_cursor"):
...
def test_master_refresh_clamps_limit_high():
    ...
    with patch("pymagatama.primitives.aismarine.sync_cursor", return_value=_CM()):
