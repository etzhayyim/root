...
from pymagatama.primitives import maps_building_3d as MB
from pymagatama.primitives import telecom_li as LI
from pymagatama.primitives import yoro_social as YS
from pymagatama.primitives import shinshi_video as SV
...
def test_mb_collection_building_3d_is_nsid():
    assert "ai.gftd.apps.maps" in MB.COLLECTION_BUILDING_3D
