...
from pymagatama.primitives import vector_embedding as VE
from pymagatama.primitives import pds_domain_coverage as DC
...
_vstub("pymagatama.ingest.zeebe", start_process_if_configured=lambda *a, **kw: None)

_VEO_MOD = "_veo_ops"
if _VEO_MOD not in sys.modules:
    _spec = importlib.util.spec_from_file_location(
        _VEO_MOD, _py_src / "pymagatama" / "vector_embedding_ops.py"
    )
    _m = types.ModuleType(_VEO_MOD)
    _m.__file__ = str(_py_src / "pymagatama" / "vector_embedding_ops.py")
