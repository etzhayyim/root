...
def test_extract_facts_prefers_jsonld_gtin_and_brand():
    from pymagatama.langgraph_graphs.global_product_enrich_one import _extract_facts
...
def test_seed_requires_scope():
    from pymagatama.langgraph_graphs.global_product_enrich_one import seed
...
def test_quality_gate_accepts_official_brand_model_without_gtin():
    from pymagatama.langgraph_graphs.global_product_enrich_one import quality_gate
...
def test_build_graph_compiles():
    from pymagatama.langgraph_graphs.global_product_enrich_one import build_graph
