...
from pymagatama.agents.outlook_triage import (
    _has_gray,
    _node_t1,
...
def test_outlook_graph_independent_from_gmail():
    ...
    from pymagatama.agents.gmail_triage import gmail_triage_graph
    from pymagatama.primitives import langgraph_registry
...
def test_outlook_shares_yabai_chain_with_gmail():
    ...
    automatically.
    """
    from pymagatama.agents import gmail_triage as g
    from pymagatama.agents import outlook_triage as o
