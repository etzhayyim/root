"""
Pure (no DB, no LLM) tests for gftdcojp_company_ops LangGraph graph.
...
def _make_state(**kw):
    from pymagatama.langgraph_graphs.gftdcojp_company_ops import CompanyOpsState
...
class TestSupervisorPrefixRouting(unittest.TestCase):
    def _call(self, task_type: str, payload: dict | None = None) -> dict:
        from pymagatama.langgraph_graphs.gftdcojp_company_ops import supervisor
...
class TestRouterFunction(unittest.TestCase):
    def test_routes_all_domains(self):
        from pymagatama.langgraph_graphs.gftdcojp_company_ops import _route_domain
...
class TestGraphStructure(unittest.TestCase):
    def setUp(self):
        ...
        import pymagatama.langgraph_graphs.gftdcojp_company_ops as mod
...
class TestHelpers(unittest.TestCase):
    ...
    def test_llm_structured_error_fallback(self):
        ...
        import pymagatama.llm as llm_mod
...
class TestGftdcojpOpsPrimitive(unittest.TestCase):
    def test_module_importable(self):
        import pymagatama.primitives.gftdcojp_ops as ops
        self.assertTrue(callable(ops.task_gftdcojp_ops_submit))
...
class TestGftdcojpPersonnelPrimitive(unittest.TestCase):
    def test_module_importable(self):
        import pymagatama.primitives.gftdcojp_personnel as p
        for fn in (
            p.task_gftdcojp_personnel_load_profile,
            p.task_gftdcojp_personnel_minimax_score,
            p.task_gftdcojp_personnel_notify_deny,
            p.task_gftdcojp_personnel_write_assignment,
        ):
