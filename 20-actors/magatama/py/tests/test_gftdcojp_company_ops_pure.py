...
def _make_state(**kw):
    from pymagatama.langgraph_graphs.etzhayyim_company_ops import CompanyOpsState
...
class TestSupervisorPrefixRouting(unittest.TestCase):
    def _call(self, task_type: str, payload: dict | None = None) -> dict:
        from pymagatama.langgraph_graphs.etzhayyim_company_ops import supervisor
...
class TestRouterFunction(unittest.TestCase):
    def test_routes_all_domains(self):
        from pymagatama.langgraph_graphs.etzhayyim_company_ops import _route_domain
...
class TestGraphStructure(unittest.TestCase):
    def setUp(self):
        ...
        import pymagatama.langgraph_graphs.etzhayyim_company_ops as mod
...
class TestHelpers(unittest.TestCase):
    def test_vid_format(self):
        ...
        v = _vid("test")
        self.assertTrue(v.startswith("at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.etzhayyim.test/"))
...
class TestGftdcojpOpsPrimitive(unittest.TestCase):
    def test_module_importable(self):
        import pymagatama.primitives.etzhayyim_ops as ops
...
class TestGftdcojpPersonnelPrimitive(unittest.TestCase):
    ...
    def test_vid_format(self):
        ...
        self.assertTrue(
            v.startswith("at://did:web:bpmn.etzhayyim.com/ai.gftd.apps.etzhayyim.personMinimax/")
        )
