...
from pymagatama.primitives import gov_jpn as JPN
from pymagatama.primitives import gov_usa as USA
from pymagatama.primitives import gov_deu as DEU
from pymagatama.primitives import gov_gbr as GBR
from pymagatama.primitives import gov_fra as FRA
from pymagatama.primitives import gov_chn as CHN
from pymagatama.primitives import gov_ind as IND
from pymagatama.primitives import gov_bra as BRA
...
def test_mint_pds_service_auth_returns_empty_when_no_url(monkeypatch) -> None:
    ...
    import importlib, pymagatama.primitives.gov_jpn as _m
    ...
    try:
        result = _m._mint_pds_service_auth("ai.gftd.apps.gov.jpn.someMethod")
        assert result == ""
    finally:
...
def test_mint_pds_service_auth_returns_str(monkeypatch) -> None:
    import pymagatama.primitives.gov_usa as _m
    orig_url = _m.PDS_SERVICE_AUTH_MINT_URL
    orig_sec = _m.PDS_SERVICE_AUTH_MINT_SECRET
    _m.PDS_SERVICE_AUTH_MINT_URL = ""
    _m.PDS_SERVICE_AUTH_MINT_SECRET = ""
    try:
        result = _m._mint_pds_service_auth("ai.gftd.apps.gov.usa.someMethod")
...
def test_mint_pds_service_auth_cache_returns_cached_token() -> None:
    ...
    lxm = "ai.gftd.apps.gov.gbr.cached"
