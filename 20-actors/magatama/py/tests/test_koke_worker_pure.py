...
def test_uid_prefix():
    from pymagatama.koke_worker_main import _uid
...
def test_now_iso():
    from pymagatama.koke_worker_main import _now
...
def test_scan_empty():
    with patch("pymagatama.koke_worker_main.fetch_all", return_value=[]):
...
def test_fix_signal_no_input():
    from pymagatama.koke_worker_main import task_fix_signal
...
def test_fix_signal_new_record():
    ...
    with patch("pymagatama.koke_worker_main.sync_cursor", return_value=mock_cm):
        from pymagatama.koke_worker_main import task_fix_signal
...
def test_classify_no_fixation_or_ref():
    from pymagatama.koke_worker_main import task_classify_fixation
...
def test_classify_valid_llm_response():
    ...
    with (
        patch("pymagatama.llm.call_tier", mock_llm),
        patch("pymagatama.koke_worker_main.sync_cursor", return_value=mock_cm),
    ):
        from pymagatama.koke_worker_main import task_classify_fixation
...
def test_handoff_no_fixation_id():
    from pymagatama.koke_worker_main import task_handoff_to_hakkou
...
def test_handoff_fixation_not_found():
    with patch("pymagatama.koke_worker_main.fetch_one", return_value=None):
        from pymagatama.koke_worker_main import task_handoff_to_hakkou
...
def test_handoff_to_saikin_no_fixation_id():
    from pymagatama.koke_worker_main import task_handoff_to_saikin
