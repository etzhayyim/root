# 20-actors/magatama/py/tests/organism/test_embodiment_wadachi.py
import time
import pytest
from pydantic import TypeAdapter

from pymagatama.organism.embodiment import (
    Pose,
    TelemetryObservation,
    telemetry_joucho_delta,
    E7mSimTelemetrySource,
)
from pymagatama.organism.observation import Observation
