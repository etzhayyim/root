...
def test_sense_normalizes_dict_signals_to_json() -> None:
    from pymagatama.langgraph_graphs._subgraphs import judge as j
...
def test_compintel_judge_node_uses_subgraph(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from pymagatama import compintel_worker_main as m
    ...
    import pymagatama.langgraph_graphs._subgraphs.judge as j_mod
