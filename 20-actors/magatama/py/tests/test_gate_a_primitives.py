...
def test_p1_import_substrate_smoke():
    ...
    from pymagatama.primitives.active_inference_substrate import (
        BeliefStore,
        ObservationRecord,
        select_belief_store,
    )
...
def test_p1_no_rw_imports_in_module():
    ...
    from pymagatama.primitives import active_inference_substrate as mod
...
def test_p1_default_backend_is_at_ipfs_local():
    ...
    from pymagatama.primitives.active_inference_substrate import _build_single_backend_store
...
async def test_p3_watchdog_clean_exit():
    ...
    from pymagatama.worker_runtime import watchdog
...
async def test_p3_activation_monitor_bogus_url():
    ...
    from pymagatama.worker_runtime import activation_monitor
...
async def test_p3_degraded_stub_kwarg_passthrough():
    ...
    from pymagatama.worker_runtime import make_degraded_ingest_stub
...
def test_p4_ingest_core_round_trip(tmp_path, monkeypatch):
    ...
    from pymagatama.ingest import core
