"""Pure helper tests for magatama_organizer primitive.
...
def test_register_registers_organizer_run_task():
    ...
    assert "magatama.organizer.run" in registered
...
def test_magatama_did_is_string() -> None:
    assert isinstance(MO.MAGATAMA_DID, str)


def test_magatama_did_starts_with_did() -> None:
