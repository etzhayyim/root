...
from pymagatama.primitives import graph_consumer as G  # noqa: E402
...
def test_task_writes_consume_tick(monkeypatch):
    ...
    assert row["repo"] == "did:web:graph.gftd.ai"
    assert row["collection"] == "ai.gftd.apps.graph.consumeTick"
