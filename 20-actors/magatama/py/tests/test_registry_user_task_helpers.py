...
from pymagatama import registry

# Load user_task_sink directly (bypass pymagatama.handlers __init__ which
...
_uts_path = _py_src / "pymagatama" / "handlers" / "user_task_sink.py"
