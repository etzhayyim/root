...
# Stub pymagatama.db_sync — the sync_cursor will be called by tasks that
...
sys.modules.setdefault("pymagatama", types.ModuleType("pymagatama"))

_MOD_NAME = "_flight_offer_early"
if _MOD_NAME not in sys.modules:
    _src = _py_src / "pymagatama" / "ingest" / "flight_offer.py"
