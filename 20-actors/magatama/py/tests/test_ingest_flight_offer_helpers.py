...
from pymagatama.ingest import flight_offer as FO
...
def test_fo_vertex_id_format() -> None:
    ...
    assert "ai.gftd.apps.flightOffer.offer" in vid
...
def _sample_offer_row() -> dict:
    return {
        "vertex_id": "at://did:web:test/ai.gftd.apps.flightOffer.offer/abc123",
        "offer_id": "abc123",
        "provider": "stub",
        "airline": "NH",
        "flight_number": "NH001",
...
def _sample_alert() -> dict:
    return {
        "vertex_id": "at://did:web:test/ai.gftd.apps.flightOffer.alert/aa-bb-2026-01",
        "origin_iata": "TYO",
        "destination_iata": "LAX",
        "outbound_date": "2026-06-01",
        "currency": "USD",
