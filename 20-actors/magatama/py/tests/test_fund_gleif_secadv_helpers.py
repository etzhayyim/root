...
from pymagatama.ingest.fund import gleif as GL
from pymagatama.ingest.fund import sec_adv as SA
...
def test_lei_did_format() -> None:
    ...
    assert "app.etzhayyim.apps.legalEntity.legalEntity" in vid
