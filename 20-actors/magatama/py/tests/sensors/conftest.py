...
The top-level pymagatama package's ``__init__`` imports a langchain /
...
def _stub_parent_packages() -> None:
    ...
    for pkg in (
        "pymagatama",
        "pymagatama.organism",
        "pymagatama.organism.sensors",
        "pymagatama.organism.sensors.corp",
        "pymagatama.organism.sensors.gov",
    ):
    ...
    sys.modules["pymagatama"].__path__ = [str(SENSORS_ROOT.parent.parent)]
    sys.modules["pymagatama.organism"].__path__ = [str(SENSORS_ROOT.parent)]
    sys.modules["pymagatama.organism.sensors"].__path__ = [str(SENSORS_ROOT)]
    sys.modules["pymagatama.organism.sensors.corp"].__path__ = [
        str(SENSORS_ROOT / "corp")
    ]
    sys.modules["pymagatama.organism.sensors.gov"].__path__ = [
...
def base_module():
    """Load pymagatama.organism.sensors.base in isolation."""
    _stub_parent_packages()
    return _load(
        "pymagatama.organism.sensors.base",
...
def corp_base_module(base_module):
    """Load pymagatama.organism.sensors.corp.base."""
    return _load(
        "pymagatama.organism.sensors.corp.base",
...
def gov_base_module(base_module):
    """Load pymagatama.organism.sensors.gov.base."""
    return _load(
        "pymagatama.organism.sensors.gov.base",
...
def load_sensor(base_module, corp_base_module, gov_base_module) -> Callable:
    ...
    def _loader(dotted: str):
        ...
        full = f"pymagatama.organism.sensors.{ns}.{leaf}"
