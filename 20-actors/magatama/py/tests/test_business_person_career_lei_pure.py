...
sys.modules["pymagatama.llm"] = _llm_stub
...
if _MOD_NAME not in sys.modules:
    _src = _py_src / "pymagatama" / "primitives" / "business_person.py"
    _prev_db = sys.modules.get("pymagatama.db_sync")
    ...
    try:
        ...
        if _prev_db is not None:
            sys.modules["pymagatama.db_sync"] = _prev_db
