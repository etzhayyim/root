...
from pymagatama.organism.followers import (
    file_follower_score_provider,
    follower_score_provider,
)
from pymagatama.organism.fleet_cell_main import (
    SHARD_RANGES,
    FleetState,
    OrganismCache,
    _owns,
)
from pymagatama.organism.inbox import FollowerSnapshot, detect_follower_rewards
from pymagatama.organism.joucho import JouchoScores
from pymagatama.organism.personality import (
    _code_from_did,
    joucho_for_code,
...
async def test_fleet_cell_serve_starts_and_shuts_down(monkeypatch: pytest.MonkeyPatch):
    ...
    from pymagatama.organism import fleet_cell_main
