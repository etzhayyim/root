...
def test_parse_empty_content():
    from pymagatama.primitives.ki_synthesis_graph import _parse_node
...
def test_synthesize_skips_on_error():
    from pymagatama.primitives.ki_synthesis_graph import _synthesize_node
...
def test_synthesize_valid_json_response():
    ...
    with patch("pymagatama.primitives.ki_synthesis_graph.llm.call_tier", mock_llm):
        from pymagatama.primitives.ki_synthesis_graph import _synthesize_node
...
def test_synthesize_llm_error_propagates():
    ...
    with patch("pymagatama.primitives.ki_synthesis_graph.llm.call_tier", side_effect=llm.LlmError("timeout")):
...
def test_refine_skips_on_error():
    from pymagatama.primitives.ki_synthesis_graph import _refine_node
...
def test_refine_llm_error_returns_unrefined():
    ...
    with patch("pymagatama.primitives.ki_synthesis_graph.llm.call_tier", side_effect=llm.LlmError("err")):
...
def test_should_refine_routes_to_refine():
    from pymagatama.primitives.ki_synthesis_graph import _should_refine, CONFIDENCE_CUTOFF, REFINE_THRESHOLD
...
def test_should_refine_high_confidence_goes_to_end():
    from pymagatama.primitives.ki_synthesis_graph import _should_refine, REFINE_THRESHOLD, END
...
def test_should_refine_low_confidence_goes_to_end():
    from pymagatama.primitives.ki_synthesis_graph import _should_refine, CONFIDENCE_CUTOFF, END
...
def test_should_refine_error_state_goes_to_end():
    from pymagatama.primitives.ki_synthesis_graph import _should_refine, END
...
def test_synthesize_pipeline_returns_fields():
    ...
    with patch("pymagatama.primitives.ki_synthesis_graph.llm.call_tier", mock_llm):
        from pymagatama.primitives.ki_synthesis_graph import synthesize
