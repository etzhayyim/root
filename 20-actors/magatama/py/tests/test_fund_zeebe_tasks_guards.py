...
for _pkg_key, _pkg_path in [
    ("pymagatama.ingest", _py_src / "pymagatama" / "ingest"),
    ("pymagatama.ingest.fund", _py_src / "pymagatama" / "ingest" / "fund"),
]:
...
_fund_dir = _py_src / "pymagatama" / "ingest" / "fund"

for _sub in ["ids", "types", "gleif", "sec_adv"]:
    _key = f"pymagatama.ingest.fund.{_sub}"
    if _key not in sys.modules:
        ...
        _m2.__package__ = "pymagatama.ingest.fund"
...
_writer_key = "pymagatama.ingest.fund.writer"
if _writer_key not in sys.modules:
    ...
    try:
        ...
        _m3.__package__ = "pymagatama.ingest.fund"
...
if _MOD_NAME not in sys.modules:
    ...
    try:
        ...
        _mod.__package__ = "pymagatama.ingest.fund"
