...
def test_frontier_id_prefers_normalized_url():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import _frontier_id
...
def test_frontier_row_normalizes_urls_and_defaults():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import _frontier_row
...
def test_enrich_input_maps_frontier_to_enrich_one_shape():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import _enrich_input
...
def test_run_status_decision_maps_terminal_statuses():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import _run_status_decision
...
def test_sanitize_seed_item_normalizes_and_rejects_empty():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import _sanitize_seed_item
...
def test_fallback_seed_items_are_usable():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import _fallback_seed_items, _sanitize_seed_item
...
def test_build_graph_compiles():
    from pymagatama.langgraph_graphs.global_product_ingest_resident import build_graph
