"""Tests for pymagatama.organism.junkan (ADR-2605290927).
...
from pymagatama.organism import junkan
from pymagatama.organism.junkan import (
    DatomStore,
    FindingBundle,
    LoopSpec,
    StockObservation,
...
from pymagatama.organism.junkan.flows import FlowEdge
