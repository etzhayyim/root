...
Covers:
  ...
  task_kouza_sync_due_connections — needs pymagatama.handlers.kouza stub
"""
...
# ── pymagatama.handlers.kouza stub ───────────────────────────────────────────
_handlers_stub = types.ModuleType("pymagatama.handlers")
_kouza_stub = types.ModuleType("pymagatama.handlers.kouza")
...
sys.modules.setdefault("pymagatama.handlers", _handlers_stub)
sys.modules.setdefault("pymagatama.handlers.kouza", _kouza_stub)

# ── standard stubs ───────────────────────────────────────────────────────────
_db_stub = types.ModuleType("pymagatama.db_sync")
...
sys.modules.setdefault("pymagatama.db_sync", _db_stub)
...
_llm_stub = types.ModuleType("pymagatama.llm")
...
sys.modules.setdefault("pymagatama.llm", _llm_stub)

_pkg_stub = types.ModuleType("pymagatama")
_pkg_stub.__path__ = [str(_py_src / "pymagatama")]  # type: ignore[attr-defined]
_pkg_stub.__package__ = "pymagatama"
sys.modules.setdefault("pymagatama", _pkg_stub)

# ── load zeebe_worker_main with unique key ────────────────────────────────────
_MOD_NAME = "_zeebe_worker_stub_ext"
if _MOD_NAME not in sys.modules:
    _src = _py_src / "pymagatama" / "zeebe_worker_main.py"
    real_db = sys.modules.get("pymagatama.db_sync")
    sys.modules["pymagatama.db_sync"] = _db_stub
    try:
        ...
        if real_db is not None:
            sys.modules["pymagatama.db_sync"] = real_db
