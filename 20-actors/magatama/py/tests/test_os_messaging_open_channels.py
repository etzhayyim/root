...
from pymagatama.primitives import os_messaging_open_channels as M  # noqa: E402
...
def test_process_queue_writes_channel_and_messages(monkeypatch):
    run = (
        "at://did:web:os-messaging.gftd.ai/ai.gftd.apps.osMessaging.openScraperRun/run-1",
        "telegram",
        "gftd",
        "https://t.me/s/gftd",
        "JP",
