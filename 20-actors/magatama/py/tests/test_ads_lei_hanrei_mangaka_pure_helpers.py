...
from pymagatama.primitives import public_malak_ads as PMA
from pymagatama.primitives import open_lei as OL
from pymagatama.primitives import hanrei as HR
from pymagatama.primitives import mangaka as MG
