...
class _Stub:
    def install(self):
        import pymagatama.primitives.lawfirm_checkout as p
...
class TestAccountRouting(unittest.TestCase):
    def test_inr_routes_india(self):
        from pymagatama.primitives.lawfirm_checkout import _select_stripe_account
...
class TestCheckoutCreate(unittest.TestCase):
    ...
    def test_dry_run_when_no_api_key(self):
        from pymagatama.primitives.lawfirm_checkout import task_lawfirm_checkout_create
