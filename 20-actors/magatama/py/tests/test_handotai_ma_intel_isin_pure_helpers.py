...
from pymagatama.primitives import handotai as HD
from pymagatama.primitives import ma as MA
from pymagatama.primitives import intel as IN
from pymagatama.primitives import isin as IS
