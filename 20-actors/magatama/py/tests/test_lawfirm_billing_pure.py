...
class _Stub:
    ...
    def install(self):
        import pymagatama.primitives.lawfirm_billing as p
...
class TestModeAStartSubscription(unittest.TestCase):
    def test_happy_path(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_billing import task_billing_mode_a_start_subscription
...
class TestModeBOnboardConnect(unittest.TestCase):
    def test_happy_path(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_billing import task_billing_mode_b_onboard_connect
...
class TestModeBSubTenantSubscription(unittest.TestCase):
    def test_y1_application_fee_85(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_billing import task_billing_mode_b_start_subscription
...
class TestWebhookInvoicePaid(unittest.TestCase):
    def test_happy_path(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_billing import task_billing_process_webhook_invoice_paid
