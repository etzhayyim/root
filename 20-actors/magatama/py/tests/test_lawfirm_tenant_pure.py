...
class _Stub:
    ...
    def install(self):
        import pymagatama.primitives.lawfirm_tenant as p
...
class TestBootstrapHappyPath(unittest.TestCase):
    ...
    def test_sandbox_provision(self):
        from pymagatama.primitives.lawfirm_tenant import task_lawfirm_tenant_bootstrap
...
class TestSuspend(unittest.TestCase):
    def test_suspend_active_tenant(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_tenant import task_lawfirm_tenant_suspend
...
class TestPromote(unittest.TestCase):
    def test_promote_sandbox_to_prod(self):
        ...
        stub.install()
        try:
            from pymagatama.primitives.lawfirm_tenant import task_lawfirm_tenant_promote
