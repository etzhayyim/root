...
from pymagatama.cell_runner_main import cells_for_node, load_cell_registry
...
CELLS_TOML_CONTENT = textwrap.dedent("""\
    ...
    [[cell]]
    name = "WildcardCell"
    module = "pymagatama.primitives.demo_echo_chain"
    entry = "echo_cell"
    node = "*"
