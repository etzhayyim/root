...
from pymagatama.organism.junkan import DatomStore, EavtSink, IngestReceipt
...
from pymagatama.organism.sensors.legal.treaty_corpus_sensor import TreatyCorpusSensor
