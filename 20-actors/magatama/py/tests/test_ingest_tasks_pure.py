...
from pymagatama.ingest import flight_offer as FO  # noqa: E402
from pymagatama.ingest import houbun as HB  # noqa: E402
from pymagatama.ingest import site_common_crawl as SC  # noqa: E402
from pymagatama.ingest.fund import zeebe_tasks as FT  # noqa: E402
...
def test_houbun_create_run_patched_ok() -> None:
    ...
    import pymagatama.ingest.houbun as _hb_mod
