...
MODEL (
  name dev.mv_gftdcojp_omega_daily,
  kind FULL,
  dialect postgres,
  description 'Per day: avg/min/max omega score and floor violation flag from vertex_gftdcojp_governance_event.',
  grain [day],
  tags [gftdcojp, omega, governance, daily]
);
