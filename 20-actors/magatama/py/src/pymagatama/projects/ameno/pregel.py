...
Authoritative ADR: 90-docs/adr/2605191257-ameno-daemon-path-b-pymagatama-python.md
"""
...
def _maybe_mst_checkpointer() -> BaseCheckpointSaver | None:
    ...
    keeps `pymagatama.projects.ameno` runnable both on a developer
    ...
    # Lazy import — pymagatama.checkpointer pulls msgpack, an optional
...
# langgraph CLI and pymagatama.projects.ameno.server both pick this up
