...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.providerPod.list.providers")
    ...
    @worker.task(task_type="ai.gftd.apps.providerPod.get.provider")
    ...
    @worker.task(task_type="ai.gftd.apps.providerPod.update.health")
    ...
    @worker.task(task_type="ai.gftd.apps.providerPod.list.capabilities")
    ...
    @worker.task(task_type="ai.gftd.apps.providerPod.list.pods")
    ...
    @worker.task(task_type="ai.gftd.apps.providerPod.get.pod.status")
