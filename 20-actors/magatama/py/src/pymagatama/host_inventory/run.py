...
from pymagatama import db_sync
...
async def run_and_persist_all(
    *,
    ...
    """
    from pymagatama.lan_topology import run_lan_topology
    from pymagatama.lan_topology.persist import persist_topology
    from pymagatama.host_inventory.graph import run_host_inventory
    from pymagatama.host_inventory.persist import persist_host_inventory
