"""ops.gftd.ai — LangServer worker (BPMN service task handlers)."""
...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.ops.createProcessRun")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.updateProcessRun")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.listProcessRuns")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.getProcessRun")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.createAutomation")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.updateAutomation")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.listAutomations")
    ...
    @worker.task(task_type="ai.gftd.apps.ops.getAutomation")
