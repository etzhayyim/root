...
:mod:`pymagatama.eligibility.scoring` and is unit-tested independently.
...
from pymagatama.eligibility.cell import CellPorts, EligibilityCellConfig
from pymagatama.eligibility.scoring import AttestationEvent
...
def build_production_ports(cfg: Web3Config) -> CellPorts:
    ...
    try:
        ...
        raise RuntimeError(
            "pymagatama.eligibility.web3_ports requires the `eligibility` extra: "
