...
Run:
  python -m pymagatama.ki_worker_main
...
async def task_synthesize(
    ...
    **_: Any,
    ...
    Graph: ki.synthesize.v1 (pymagatama.primitives.ki_synthesis_graph)
    ...
    from pymagatama.primitives import ki_synthesis_graph  # noqa: E402
