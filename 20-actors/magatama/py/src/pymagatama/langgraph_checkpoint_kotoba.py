...
``pymagatama.kotoba_datomic.KotobaDatomicClient`` — no psycopg, no RisingWave.
...
from pymagatama.kotoba_datomic import (
    KotobaDatomicClient,
    edn_str,
    get_kotoba_client,
    to_tx_edn,
...
CHECKPOINT_GRAPH = os.environ.get("MAGATAMA_KOTOBA_LG_GRAPH", "etzhayyim/magatama/langgraph")
