...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.casino.listCasinos")
    ...
    @worker.task(task_type="ai.gftd.apps.casino.getCasino")
    ...
    @worker.task(task_type="ai.gftd.apps.casino.listReviews")
    ...
    @worker.task(task_type="ai.gftd.apps.casino.listJurisdictions")
    ...
    @worker.task(task_type="ai.gftd.apps.casino.getJurisdiction")
    ...
    @worker.task(task_type="ai.gftd.apps.casino.searchCasinos")
    ...
    @worker.task(task_type="ai.gftd.apps.casino.listCities")
