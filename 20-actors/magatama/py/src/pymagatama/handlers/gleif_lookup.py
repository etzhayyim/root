...
-------
    ...
    ai.gftd.apps.gleif.lookup(name, countryHint)     VARCHAR, VARCHAR → VARCHAR
...
Behaviour (mirrors the BPMN `ai.gftd.apps.yabai.enrichLegalEntity` flow
...
@udf(
    nsid="ai.gftd.apps.gleif.lookup",
    io_threads=100,
