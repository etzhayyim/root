...
uses `pymagatama.primitives.open_isic` for graph writes.
"""
...
from pymagatama.primitives.open_isic import verification_for_confidence


@udf(
    nsid="ai.gftd.apps.openIsic.verificationForConfidence",
    io_threads=32,
    input_types=["FLOAT64"],
    result_type="VARCHAR",
...
@udf(
    nsid="ai.gftd.apps.openIsic.classificationVertexId",
    io_threads=32,
