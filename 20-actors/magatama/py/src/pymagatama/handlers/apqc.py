...
from pymagatama.primitives.apqc import APQC_L1, L1_BY_CODE, apqc_did


@udf(
    nsid="ai.gftd.apps.apqc.materializeSubprocessDid",
    io_threads=32,
...
@udf(
    nsid="ai.gftd.apps.apqc.coverageSnapshot",
    io_threads=32,
    input_types=["VARCHAR"],
    result_type="VARCHAR",
