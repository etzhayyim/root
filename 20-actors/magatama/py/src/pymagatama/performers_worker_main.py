...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.performers.list.profiles")
    ...
    @worker.task(task_type="ai.gftd.apps.performers.get.profile")
    ...
    @worker.task(task_type="ai.gftd.apps.performers.list.bookings")
    ...
    @worker.task(task_type="ai.gftd.apps.performers.list.performances")
