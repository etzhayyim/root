...
logger = logging.getLogger("pymagatama.transport.libp2p")
...
# This file lives at:
#   <repo>/20-actors/magatama/py/src/pymagatama/transport/libp2p.py
# parents[0]=transport, [1]=pymagatama, [2]=src, [3]=py,
# [4]=magatama, [5]=20-actors, [6]=<repo-root>.
