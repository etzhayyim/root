...
from pymagatama.kotoba_datomic import KotobaDatomicClient, edn_str, get_kotoba_client, to_tx_edn
...
STORE_GRAPH = os.environ.get("MAGATAMA_KOTOBA_LG_GRAPH", "etzhayyim/magatama/langgraph")
NS_STORE = "lg.store"
