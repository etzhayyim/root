"""lo.gftd.ai — LangServer worker (BPMN service task handlers)."""
...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.lo.createShipment")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.updateShipment")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.listShipments")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.getShipment")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.createRoute")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.updateRoute")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.listRoutes")
    ...
    @worker.task(task_type="ai.gftd.apps.lo.getRoute")
