"""videos.gftd.ai — LangServer worker (BPMN service task handlers)."""
...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.videos.uploadVideo")
    async def task_upload_video(**kwargs):
        title = kwargs.get("title", "")
        owner_did = kwargs.get("ownerDid", "did:web:videos.gftd.ai")
        ...
        try:
            await db.execute(
                ...
                "did:web:videos.gftd.ai", "did:web:videos.gftd.ai", now, now,
            )
        finally:
            await db.close()
    ...
    @worker.task(task_type="ai.gftd.apps.videos.getVideo")
    ...
    @worker.task(task_type="ai.gftd.apps.videos.updateVideo")
    ...
    @worker.task(task_type="ai.gftd.apps.videos.deleteVideo")
    ...
    @worker.task(task_type="ai.gftd.apps.videos.listVideos")
    ...
    @worker.task(task_type="ai.gftd.apps.videos.transcodeVideo")
    ...
    @worker.task(task_type="ai.gftd.apps.videos.publishVideo")
    ...
    @worker.task(task_type="ai.gftd.apps.videos.videoStats")
