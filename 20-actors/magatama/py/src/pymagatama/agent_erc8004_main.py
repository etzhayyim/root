...
from pymagatama.agent_daemon_main import _now_iso
from pymagatama.agent_status_main import load_status_report
from pymagatama.local_agent_env import load_env_file, load_keychain_secret
from pymagatama.primitives.active_inference import stable_hash
...
def upsert_economy_profile_direct(
    *,
    ...
    if not os.environ.get("RW_URL"):
        return None
    from pymagatama.agent_daemon_main import insert_direct_row
