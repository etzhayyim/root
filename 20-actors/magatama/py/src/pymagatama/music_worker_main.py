"""music.gftd.ai — LangServer worker (BPMN service task handlers)."""
...
ACTOR_DID = "did:web:music.gftd.ai"
...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.music.createTrack")
    ...
    @worker.task(task_type="ai.gftd.apps.music.updateTrack")
    ...
    @worker.task(task_type="ai.gftd.apps.music.listTracks")
    ...
    @worker.task(task_type="ai.gftd.apps.music.getTrack")
    ...
    @worker.task(task_type="ai.gftd.apps.music.createArtist")
    ...
    @worker.task(task_type="ai.gftd.apps.music.updateArtist")
    ...
    @worker.task(task_type="ai.gftd.apps.music.listArtists")
    ...
    @worker.task(task_type="ai.gftd.apps.music.getArtist")
