"""Generic-primitive worker for ai.gftd.tools.transform.* (ADR-2605082000 §2 follow-up).
...
async def task_transform_map(
    ...
    **_ignored: Any,
    ...
    if input is None or mapping is None:
        return {"error": "ai.gftd.tools.transform.map: 'input' and 'mapping' are required"}
