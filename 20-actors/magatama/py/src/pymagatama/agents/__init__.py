"""
pymagatama.agents — LangGraph-driven planning agents invoked from BPMN
service tasks (ADR-0049 Phase D / arc 1+2 hybrid).

Each agent is a LangGraph StateGraph exposed as a LangServer task type
named `ai.gftd.agent.<name>`. The zeebe-worker activates the job,
...
Design points:
  ...
  - LLM calls reuse `pymagatama.llm.call_tier_json` so the same Vultr /
...
from pymagatama.agents.plan import plan_graph, task_agent_plan  # noqa: F401
from pymagatama.agents.gameka_studio import (  # noqa: F401
    studio_graph as gameka_studio_graph,
    task_agent_gameka_studio,
)
from pymagatama.agents.gameka_visual_critic import (  # noqa: F401
    visual_critic_graph as gameka_visual_critic_graph,
    task_agent_gameka_visual_critic,
)
from pymagatama.agents.hume_emotion import (  # noqa: F401
    hume_emotion_graph,
    task_agent_hume_emotion,
)
from pymagatama.agents.sbom_register import (  # noqa: F401
    sbom_register_graph,
    task_agent_sbom_register,
)
from pymagatama.agents.gmail_triage import (  # noqa: F401
    gmail_triage_graph,
)
from pymagatama.agents.outlook_triage import (  # noqa: F401
