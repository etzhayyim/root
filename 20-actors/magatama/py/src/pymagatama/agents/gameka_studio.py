"""
ai.gftd.agent.gameka.studio — LangGraph game-spec deliberation agent
...
Why a dedicated task type and not generic.langgraph.run:
  ...
  ai.gftd.agent.gameka.studio mirrors ai.gftd.agent.plan's shape so we can
...
from pymagatama.primitives import langgraph_registry as _lr  # noqa: E402
...
async def task_agent_gameka_studio(
    ...
    """Entry point registered as `ai.gftd.agent.gameka.studio` in
