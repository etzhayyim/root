...
Provides LangServer task handlers behind `ai.gftd.apps.flightOffer.*` BPMN
...
ALERT_COLLECTION = "ai.gftd.apps.flightOffer.alert"
WATCH_COLLECTION = "ai.gftd.apps.flightOffer.watch"
SOURCE_RUN_COLLECTION = "ai.gftd.apps.flightOffer.sourceRun"
...
def _vertex_id(provider: str, offer_id: str) -> str:
    return f"at://{FLIGHT_OFFER_DID}/ai.gftd.apps.flightOffer.offer/{provider}-{offer_id}"
