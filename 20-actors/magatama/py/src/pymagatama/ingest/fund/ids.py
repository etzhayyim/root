...
def manager_vertex_id(value: str) -> str:
    return f"at://{FUND_DID}/ai.gftd.apps.fund.manager/{slug(value)}"


def fund_vertex_id(value: str) -> str:
    return f"at://{FUND_DID}/ai.gftd.apps.fund.fund/{slug(value)}"


def investor_vertex_id(value: str) -> str:
    return f"at://{FUND_DID}/ai.gftd.apps.fund.investor/{slug(value)}"


def investee_vertex_id(value: str) -> str:
    return f"at://{FUND_DID}/ai.gftd.apps.fund.investee/{slug(value)}"
