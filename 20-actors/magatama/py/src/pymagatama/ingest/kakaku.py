...
`ai.gftd.apps.kakaku.*` BPMN/XRPC bindings. It keeps deterministic entity
...
PRICE_HISTORY_COLLECTION = "ai.gftd.apps.kakaku.priceHistory"
MATCH_COLLECTION = "ai.gftd.apps.kakaku.matchCandidate"
