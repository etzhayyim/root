...
COLLECTION_TABLES = {
    ...
    "ai.gftd.apps.apps.installIntent": "vertex_apps_directory_install_intent",
}
...
def _write_related_edges(cur: Any, collection: str, kind: str, record_id: str, payload: dict[str, Any], created_at: str) -> None:
    ...
    if not listing_id:
        return
    listing_vid = _vertex_id("ai.gftd.apps.apps.appListing", listing_id)
...
def _latest_listing(listing_id: str = "", app_did: str = "") -> dict[str, Any] | None:
    for item in _list("ai.gftd.apps.apps.appListing"):
...
def register_app_listing(appDid: Any = None, name: Any = None, displayName: Any = None, description: Any = None, category: Any = None, icon: Any = None, embedUrl: Any = None, capabilities: Any = None, **_: Any) -> dict[str, Any]:
    ...
    _record("ai.gftd.apps.apps.appListing", "appListing", listing, listing_id)
...
def update_app_listing(listingId: Any = None, **kwargs: Any) -> dict[str, Any]:
    ...
    _record("ai.gftd.apps.apps.appListing", "appListing", next_listing, listing_id)
...
def list_apps(category: Any = None, search: Any = None, limit: Any = 50, offset: Any = 0, **_: Any) -> dict[str, Any]:
    ...
    for item in reversed(_list("ai.gftd.apps.apps.appListing", 1000)):
...
def feature_app(listingId: Any = None, rail: Any = "featured", rank: Any = 100, reason: Any = None, approvedByDid: Any = None, **_: Any) -> dict[str, Any]:
    ...
    try:
        ...
        rank_i = 100
    _record("ai.gftd.apps.apps.feature", "feature", {"featureId": feature_id, "listingId": listing_id, "rail": _s(rail, "featured"), "rank": rank_i, "reason": _s(reason), "approvedByDid": _s(approvedByDid), "status": "active"}, feature_id)
...
def record_install_intent(listingId: Any = None, userDid: Any = None, source: Any = None, client: Any = None, **_: Any) -> dict[str, Any]:
    ...
    _record("ai.gftd.apps.apps.installIntent", "installIntent", {"intentId": intent_id, "listingId": listing_id, "userDid": _s(userDid), "source": _s(source), "client": _s(client), "status": "recorded"}, intent_id)
