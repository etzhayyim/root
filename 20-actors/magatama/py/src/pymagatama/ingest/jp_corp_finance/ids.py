...
def disclosure_vid(source_id: str, source_record_id: str) -> str:
    return (
        f"at://{ACTOR_DID}/ai.gftd.apps.jpCorpFinance.disclosure/"
...
def fact_vid(
    ...
    return f"at://{ACTOR_DID}/ai.gftd.apps.jpCorpFinance.financialFact/{digest}"


def coverage_vid(jcn: str) -> str:
    return f"at://{ACTOR_DID}/ai.gftd.apps.jpCorpFinance.coverage/jcn-{slug(jcn)}"
