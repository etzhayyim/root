...
def disclosure_vid(source_id: str, source_record_id: str) -> str:
    return (
        f"at://{ACTOR_DID}/app.etzhayyim.apps.jpCorpFinance.disclosure/"
...
def fact_vid(
    ...
    return f"at://{ACTOR_DID}/app.etzhayyim.apps.jpCorpFinance.financialFact/{digest}"


def coverage_vid(jcn: str) -> str:
    return f"at://{ACTOR_DID}/app.etzhayyim.apps.jpCorpFinance.coverage/jcn-{slug(jcn)}"
