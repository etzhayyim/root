...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.create.scene")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.list.scenes")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.get.scene")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.publish.scene")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.create.asset")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.list.assets")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.create.portal")
    ...
    @worker.task(task_type="ai.gftd.apps.worlds.list.portals")
