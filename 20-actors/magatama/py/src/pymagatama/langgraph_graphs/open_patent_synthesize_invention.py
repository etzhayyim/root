...
def gather_trends(state: OpenPatentSynthesizeState) -> dict:
    from pymagatama.primitives.open_patent_generate import task_open_patent_gather_tech_trends
...
def synthesize_seeds(state: OpenPatentSynthesizeState) -> dict:
    from pymagatama.primitives.open_patent_generate import task_open_patent_generate_invention_seeds
...
def search_prior_art(state: OpenPatentSynthesizeState) -> dict:
    from pymagatama.primitives.open_patent_generate import task_open_patent_search_prior_art
...
def assess_novelty(state: OpenPatentSynthesizeState) -> dict:
    from pymagatama.primitives.open_patent_generate import task_open_patent_assess_novelty
...
def flag_for_review(state: OpenPatentSynthesizeState) -> dict:
    ...
    """
    from pymagatama.primitives.open_patent_generate import (
