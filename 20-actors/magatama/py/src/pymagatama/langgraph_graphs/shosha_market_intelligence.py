...
def ingest_prices(state: ShoshaMarketIntelligenceState) -> dict:
    ...
    from pymagatama.primitives.shosha import task_shosha_intel_ingest_prices
...
def ingest_freight(state: ShoshaMarketIntelligenceState) -> dict:
    ...
    from pymagatama.primitives.shosha import task_shosha_intel_ingest_freight
...
def synth_market_views(state: ShoshaMarketIntelligenceState) -> dict:
    ...
    from pymagatama.primitives.shosha import task_shosha_market_view_synth
        ...
        with sync_cursor() as cur:
            cur.execute(
                ...
                (
                    ...
                    "app.etzhayyim.apps.shosha.marketIntelligenceIngest",
