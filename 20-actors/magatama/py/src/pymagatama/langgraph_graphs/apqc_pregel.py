...
BPMN_CATALOG: list[dict[str, Any]] = [
    ...
    # 3.0 Market & Sell
    {"taskId": "bpmn-3-sales-order-intake",  "apqcCode": "3.0",  "taskType": "receiveTask",      "name": "Intake sales order",                  "ocelEventType": "sales.ordered",       "kyberCollection": "ai.gftd.apps.kyber.salesOrder"},
    {"taskId": "bpmn-3-order-confirm",       "apqcCode": "3.0",  "taskType": "serviceTask",      "name": "Confirm sales order",                 "ocelEventType": "sales.confirmed"},
    # 4.0 Supply Chain
    {"taskId": "bpmn-4-po-create",           "apqcCode": "4.0",  "taskType": "receiveTask",      "name": "Create purchase order",               "ocelEventType": "po.created",          "kyberCollection": "ai.gftd.apps.kyber.purchaseOrder"},
    ...
    # 7.0 Human Capital
    {"taskId": "bpmn-7-employee-onboard",    "apqcCode": "7.0",  "taskType": "receiveTask",      "name": "Onboard employee",                    "ocelEventType": "employee.onboarded",  "kyberCollection": "ai.gftd.apps.kyber.employee"},
    ...
    {"taskId": "bpmn-9-journal-post",        "apqcCode": "9.0",  "taskType": "receiveTask",      "name": "Post GL journal",                     "ocelEventType": "journal.posted",      "kyberCollection": "ai.gftd.apps.kyber.journalEntry"},
    {"taskId": "bpmn-9-coa-seed",            "apqcCode": "9.0",  "taskType": "serviceTask",      "name": "Seed chart of accounts",              "ocelEventType": "coa.seeded",          "kyberCollection": "ai.gftd.apps.kyber.account"},
    {"taskId": "bpmn-9-invoice-issue",       "apqcCode": "9.0",  "taskType": "receiveTask",      "name": "Issue invoice",                       "ocelEventType": "invoice.issued",      "kyberCollection": "ai.gftd.apps.kyber.invoice"},
    ...
    {"taskId": "bpmn-10-inventory-register", "apqcCode": "10.0", "taskType": "receiveTask",      "name": "Register inventory item",             "ocelEventType": "inventory.registered", "kyberCollection": "ai.gftd.apps.kyber.inventoryItem"},
...
def _emit_ocel(
    ...
    vertex_id = f"at://{actor_did}/ai.gftd.apps.apqc.apqcEvent/{event_id}"
    ts = _now_iso()
    if not dry_run:
...
# Maps ai.gftd.kyber.projector.* NSID suffixes → internal mode
...
def _catalog_query(state: ApqcOrchestratorState) -> dict[str, Any]:
    """Serve ai.gftd.kyber.projector.list*/get*/register* + emitApqcEvent without L1 fan-out."""
    nsid_val = state.get("_nsid", "")
    suffix = nsid_val.split(".")[-1] if nsid_val else ""
