...
Each node delegates to a sync primitive in pymagatama.primitives.coverage_gap.
"""
...
def stats_sync_node(state: CoverageGapBridgeState) -> dict:
    from pymagatama.primitives.coverage_gap import task_coverage_gap_stats_sync
...
def scan_node(state: CoverageGapBridgeState) -> dict:
    from pymagatama.primitives.coverage_gap import task_coverage_gap_scan
...
def ingest_node(state: CoverageGapBridgeState) -> dict:
    from pymagatama.primitives.coverage_gap import task_coverage_gap_ingest
    out = _safe(
...
def infer_node(state: CoverageGapBridgeState) -> dict:
    from pymagatama.primitives.coverage_gap import task_coverage_gap_infer
    out = _safe(
...
def generate_node(state: CoverageGapBridgeState) -> dict:
    from pymagatama.primitives.coverage_gap import task_coverage_gap_generate
