...
def floor_check(state: WellbecomingFloorViolationAlertState) -> dict:
    from pymagatama.primitives.wellbecoming_agent import task_wellbecoming_floor_check
...
def floor_alert(state: WellbecomingFloorViolationAlertState) -> dict:
    from pymagatama.primitives.wellbecoming_agent import task_wellbecoming_floor_alert
