...
def ingest_patent(state: PatentIngestUsptoWeeklyState) -> dict:
    from pymagatama.primitives.patent_ingest import task_patent_uspto_patentsview_ingest_patent
...
def ingest_citation(state: PatentIngestUsptoWeeklyState) -> dict:
    from pymagatama.primitives.patent_ingest import task_patent_uspto_patentsview_ingest_citation
...
def ingest_epo_citations(state: PatentIngestUsptoWeeklyState) -> dict:
    from pymagatama.primitives.patent_ingest import task_patent_epo_ops_fill_citations
