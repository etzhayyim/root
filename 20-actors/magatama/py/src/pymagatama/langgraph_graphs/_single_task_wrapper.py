...
# `pymagatama.langgraph_graphs._single_task_wrapper:build_graph_<name>`.
...
build_graph_kobo_budAgent       = _factory("pymagatama.kobo_worker_main:task_bud_agent")
build_graph_kobo_sporulate      = _factory("pymagatama.kobo_worker_main:task_sporulate")
build_graph_kobo_germinate      = _factory("pymagatama.kobo_worker_main:task_germinate")
build_graph_kabi_fusionProbe    = _factory("pymagatama.kabi_worker_main:task_anastomosis_probe")
build_graph_kinoko_formBlock    = _factory("pymagatama.kinoko_worker_main:task_check_flow_threshold")
build_graph_hakkou_createFerment   = _factory("pymagatama.hakkou_worker_main:task_create_ferment_record")
build_graph_hakkou_llmTransform    = _factory("pymagatama.hakkou_worker_main:task_llm_transform")
build_graph_hakkou_finalizeFerment = _factory("pymagatama.hakkou_worker_main:task_finalize_ferment")
