...
::
    ...
    from pymagatama.db_alchemy import sa_metadata, sa_execute, sa_query
...
def sa_executemany(
    ...
    Example::
        ...
        from pymagatama.db_alchemy import sa_metadata, sa_executemany
...
# sa_executemany in pymagatama LoRA worker primitives.
...
def t_vertex_lora_adapter() -> Any:
    ...
    Example (insert)::
        ...
        from pymagatama.db_alchemy import sa_executemany, t_vertex_lora_adapter
        sa_executemany(t_vertex_lora_adapter().insert(), rows)

    Example (select by owner_did)::

        from sqlalchemy import select
        from pymagatama.db_alchemy import sa_query, t_vertex_lora_adapter
