...
from pymagatama.ingest.zeebe import _run_process_async
from pymagatama.local_agent_env import load_env_file, load_keychain_secret
from pymagatama.local_llm import LocalLlmConfig, chat_json
from pymagatama.primitives.active_inference import (
...
def execute_real_world_action_direct(variables: dict[str, Any]) -> dict[str, Any]:
    ...
    from pymagatama.agent_authority_policy import load_delegated_authority_policy
