...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govGeo.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
