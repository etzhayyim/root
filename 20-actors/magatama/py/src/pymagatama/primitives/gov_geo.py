...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_geo_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGeo.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
