...
This module moves the `did:web:fra-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:fra-state.gftd.ai"
DOMAIN_CODE = "fra"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govFra.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fra_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govFra.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
