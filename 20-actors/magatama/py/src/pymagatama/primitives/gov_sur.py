"""SUR Government states actor primitives.

This module moves the `did:web:sur-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:sur-state.etzhayyim.com"
DOMAIN_CODE = "sur"
...
_MINISTRY_NDJSON = """\
{"path": "president", "name": "Presidentieel Kabinet", "nameEn": "Presidential Cabinet", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 88-101", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defensie", "name": "Ministerie van Defensie", "nameEn": "Ministry of Defence", "website": "https://www.defensie.sr/", "contract": "Grondwet 1987", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "financien", "name": "Ministerie van Financiën en Planning", "nameEn": "Ministry of Finance and Planning", "website": "https://www.mof.sr/", "contract": "Grondwet 1987", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "buitenlandse", "name": "Ministerie van Buitenlandse Zaken", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.gov.sr/buitenlandse-zaken", "contract": "Grondwet 1987", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "justitie", "name": "Ministerie van Justitie en Politie", "nameEn": "Ministry of Justice and Police", "website": "https://www.gov.sr/justitie", "contract": "Grondwet 1987", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "binnenlandse", "name": "Ministerie van Binnenlandse Zaken", "nameEn": "Ministry of Interior", "website": "https://www.gov.sr/binnenlandse-zaken", "contract": "Grondwet 1987", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "onderwijs", "name": "Ministerie van Onderwijs, Wetenschap en Cultuur", "nameEn": "Ministry of Education, Science and Culture", "website": "https://www.gov.sr/onderwijs", "contract": "Grondwet 1987", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "volksgezondheid", "name": "Ministerie van Volksgezondheid", "nameEn": "Ministry of Public Health", "website": "https://www.gov.sr/volksgezondheid", "contract": "Grondwet 1987", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "landbouw", "name": "Ministerie van Landbouw, Veeteelt en Visserij", "nameEn": "Ministry of Agriculture, Animal Husbandry and Fisheries", "website": "https://www.gov.sr/landbouw", "contract": "Grondwet 1987", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "handel", "name": "Ministerie van Handel, Industrie en Toerisme", "nameEn": "Ministry of Trade, Industry and Tourism", "website": "https://www.gov.sr/handel", "contract": "Grondwet 1987", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "arbeid", "name": "Ministerie van Arbeid", "nameEn": "Ministry of Labour", "website": "https://www.gov.sr/arbeid", "contract": "Grondwet 1987", "tags": ["cofog:10", "labour"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "district:brokopondo", "name": "District Brokopondo", "nameEn": "Brokopondo District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:commewijne", "name": "District Commewijne", "nameEn": "Commewijne District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:coronie", "name": "District Coronie", "nameEn": "Coronie District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:marowijne", "name": "District Marowijne", "nameEn": "Marowijne District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:nickerie", "name": "District Nickerie", "nameEn": "Nickerie District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:para", "name": "District Para", "nameEn": "Para District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:paramaribo", "name": "District Paramaribo", "nameEn": "Paramaribo District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:saramacca", "name": "District Saramacca", "nameEn": "Saramacca District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:sipaliwini", "name": "District Sipaliwini", "nameEn": "Sipaliwini District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "district:wanica", "name": "District Wanica", "nameEn": "Wanica District", "website": "https://www.gov.sr/", "contract": "Grondwet 1987 Art. 160-166", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_sur_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_sur_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_sur_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_sur_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_sur_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_sur_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit_val = max(1, min(int(limit or 10), 50))
...
async def task_gov_sur_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_sur_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_sur_seed_orgs, seedLimit)
    register = await task_gov_sur_register_dids(registerLimit)
    follow = await task_gov_sur_follow_site_deps(followLimit)
    ingest = await task_gov_sur_sync_wet_updates(ingestLimit)
    shinka = await task_gov_sur_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSur.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sur_heartbeat_tick)
