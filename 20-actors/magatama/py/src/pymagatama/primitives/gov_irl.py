...
This module moves the `did:web:irl-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:irl-state.gftd.ai"
DOMAIN_CODE = "irl"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irl_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govIrl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
