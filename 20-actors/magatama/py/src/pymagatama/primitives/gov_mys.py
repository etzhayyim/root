"""MYS Government states actor primitives.

This module moves the `did:web:mys-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:mys-state.etzhayyim.com"
DOMAIN_CODE = "mys"
...
_MINISTRY_NDJSON = """\
{"path":"pm-office","name":"Jabatan Perdana Menteri","nameEn":"Prime Minister's Office","website":"https://www.pmo.gov.my/","contract":"Federal Constitution Art. 39","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"kln","name":"Kementerian Luar Negeri","nameEn":"Ministry of Foreign Affairs","website":"https://www.kln.gov.my/","contract":"Federal Constitution","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Kementerian Pertahanan","nameEn":"Ministry of Defence","website":"https://www.mod.gov.my/","contract":"Federal Constitution Art. 137","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Kementerian Kewangan","nameEn":"Ministry of Finance","website":"https://www.mof.gov.my/","contract":"Federal Constitution","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"kln-hal-ehwal-dalam","name":"Kementerian Hal Ehwal Dalam Negeri","nameEn":"Ministry of Home Affairs","website":"https://www.moha.gov.my/","contract":"Federal Constitution","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"kkm","name":"Kementerian Kesihatan Malaysia","nameEn":"Ministry of Health Malaysia","website":"https://www.moh.gov.my/","contract":"Federal Constitution","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"kpm","name":"Kementerian Pendidikan Malaysia","nameEn":"Ministry of Education Malaysia","website":"https://www.moe.gov.my/","contract":"Federal Constitution","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"ksm","name":"Kementerian Sumber Manusia","nameEn":"Ministry of Human Resources","website":"https://www.mohr.gov.my/","contract":"Federal Constitution","tags":["cofog:04","labour"],"orgTier":"ministry"}
{"path":"miti","name":"Kementerian Perdagangan Antarabangsa dan Industri","nameEn":"Ministry of International Trade and Industry","website":"https://www.miti.gov.my/","contract":"Federal Constitution","tags":["cofog:04","trade","industry"],"orgTier":"ministry"}
{"path":"motac","name":"Kementerian Pelancongan, Seni dan Budaya","nameEn":"Ministry of Tourism, Arts and Culture","website":"https://www.motac.gov.my/","contract":"Federal Constitution","tags":["cofog:08","tourism","culture"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"state:johor","name":"Johor","nameEn":"Johor","website":"https://www.johor.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:kedah","name":"Kedah","nameEn":"Kedah","website":"https://www.kedah.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:kelantan","name":"Kelantan","nameEn":"Kelantan","website":"https://www.kelantan.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:melaka","name":"Melaka","nameEn":"Melaka","website":"https://www.melaka.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:negeri-sembilan","name":"Negeri Sembilan","nameEn":"Negeri Sembilan","website":"https://www.ns.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:pahang","name":"Pahang","nameEn":"Pahang","website":"https://www.pahang.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:perak","name":"Perak","nameEn":"Perak","website":"https://www.perak.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:perlis","name":"Perlis","nameEn":"Perlis","website":"https://www.perlis.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:pulau-pinang","name":"Pulau Pinang","nameEn":"Penang","website":"https://www.penang.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:sabah","name":"Sabah","nameEn":"Sabah","website":"https://www.sabah.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state","east-malaysia"],"orgTier":"state"}
{"path":"state:sarawak","name":"Sarawak","nameEn":"Sarawak","website":"https://www.sarawak.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state","east-malaysia"],"orgTier":"state"}
{"path":"state:selangor","name":"Selangor","nameEn":"Selangor","website":"https://www.selangor.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:terengganu","name":"Terengganu","nameEn":"Terengganu","website":"https://www.terengganu.gov.my/","contract":"Federal Constitution Art. 71","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:kuala-lumpur","name":"Wilayah Persekutuan Kuala Lumpur","nameEn":"Federal Territory of Kuala Lumpur","website":"https://www.dbkl.gov.my/","contract":"Federal Constitution Art. 152","tags":["cofog:01","federal-territory","capital"],"orgTier":"state"}
{"path":"state:labuan","name":"Wilayah Persekutuan Labuan","nameEn":"Federal Territory of Labuan","website":"https://www.labuan.gov.my/","contract":"Federal Constitution Art. 152","tags":["cofog:01","federal-territory"],"orgTier":"state"}
{"path":"state:putrajaya","name":"Wilayah Persekutuan Putrajaya","nameEn":"Federal Territory of Putrajaya","website":"https://www.putrajaya.gov.my/","contract":"Federal Constitution Art. 152","tags":["cofog:01","federal-territory","administrative-capital"],"orgTier":"state"}
"""
...
def task_gov_mys_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_mys_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_mys_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    ...
    # R0: in-Python filter, order, count, and offset/limit
    filtered = [
        r for r in all_rows
...
async def task_gov_mys_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_mys_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_mys_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    # R0: in-Python filter, order, and limit for wet updates
    filtered = [
        r for r in all_rows
        if r.get("owner_did") == PRIMARY_DID
        and r.get("site_domain_slug")
    ...
    for r in rows:
        ...
        # R0: in-Python order and limit 1
...
async def task_gov_mys_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 1), 5))
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
        columns=["path", "name_en", "last_shinka_at", "did_registered", "owner_did"],
        limit=2000
    )
    # R0: in-Python filter, order, and limit for shinka
    filtered = [
        r for r in all_rows
...
async def task_gov_mys_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_mys_seed_orgs, seedLimit)
    register = await task_gov_mys_register_dids(registerLimit)
    follow = await task_gov_mys_follow_site_deps(followLimit)
    ingest = await task_gov_mys_sync_wet_updates(ingestLimit)
    shinka = await task_gov_mys_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMys.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mys_heartbeat_tick)
