"""ZWE Government states actor primitives.

This module moves the `did:web:zwe-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:zwe-state.etzhayyim.com"
DOMAIN_CODE = "zwe"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Office of the President and Cabinet","nameEn":"Office of the President and Cabinet","website":"https://www.opc.gov.zw/","contract":"Constitution 2013","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defence","name":"Ministry of Defence and War Veterans Affairs","nameEn":"Ministry of Defence","website":"https://www.mod.gov.zw/","contract":"Constitution 2013","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"finance","name":"Ministry of Finance, Economic Development and Investment Promotion","nameEn":"Ministry of Finance","website":"https://www.mof.gov.zw/","contract":"Constitution 2013","tags":["cofog:01.1","finance","economy"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs and International Trade","nameEn":"Ministry of Foreign Affairs","website":"https://www.zimfa.gov.zw/","contract":"Constitution 2013","tags":["cofog:01.2","foreign-affairs","trade"],"orgTier":"ministry"}
{"path":"justice","name":"Ministry of Justice, Legal and Parliamentary Affairs","nameEn":"Ministry of Justice","website":"https://www.justice.gov.zw/","contract":"Constitution 2013","tags":["cofog:03","justice","legal"],"orgTier":"ministry"}
{"path":"home-affairs","name":"Ministry of Home Affairs and Cultural Heritage","nameEn":"Ministry of Home Affairs","website":"https://www.mohcc.gov.zw/","contract":"Constitution 2013","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Primary and Secondary Education","nameEn":"Ministry of Education","website":"https://www.mopse.co.zw/","contract":"Constitution 2013","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Ministry of Health and Child Care","nameEn":"Ministry of Health","website":"https://www.mohcc.gov.zw/","contract":"Constitution 2013","tags":["cofog:07","health","child-care"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Lands, Agriculture, Fisheries, Water and Rural Development","nameEn":"Ministry of Agriculture","website":"https://www.mlafwr.co.zw/","contract":"Constitution 2013","tags":["cofog:04.2","agriculture","land","water"],"orgTier":"ministry"}
{"path":"mines","name":"Ministry of Mines and Mining Development","nameEn":"Ministry of Mines","website":"https://www.mines.gov.zw/","contract":"Constitution 2013","tags":["cofog:04","mining"],"orgTier":"ministry"}
{"path":"energy","name":"Ministry of Energy and Power Development","nameEn":"Ministry of Energy","website":"https://www.energy.gov.zw/","contract":"Constitution 2013","tags":["cofog:04","energy","power"],"orgTier":"ministry"}
{"path":"ict","name":"Ministry of Information Communication Technology, Postal and Courier Services","nameEn":"Ministry of ICT","website":"https://www.ictministry.gov.zw/","contract":"Constitution 2013","tags":["cofog:04","ict","digital","communications"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:bulawayo","name":"Bulawayo Metropolitan Province","nameEn":"Bulawayo Metropolitan Province","website":"https://www.bulawayo.gov.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province","metropolitan"],"orgTier":"state"}
{"path":"prov:harare","name":"Harare Metropolitan Province","nameEn":"Harare Metropolitan Province","website":"https://www.hararecity.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province","metropolitan","capital"],"orgTier":"state"}
{"path":"prov:manicaland","name":"Manicaland Province","nameEn":"Manicaland Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:mashonaland-central","name":"Mashonaland Central Province","nameEn":"Mashonaland Central Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:mashonaland-east","name":"Mashonaland East Province","nameEn":"Mashonaland East Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:mashonaland-west","name":"Mashonaland West Province","nameEn":"Mashonaland West Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:masvingo","name":"Masvingo Province","nameEn":"Masvingo Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:matabeleland-north","name":"Matabeleland North Province","nameEn":"Matabeleland North Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:matabeleland-south","name":"Matabeleland South Province","nameEn":"Matabeleland South Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:midlands","name":"Midlands Province","nameEn":"Midlands Province","website":"https://www.zimstat.co.zw/","contract":"Constitution 2013 Ch.14","tags":["cofog:01","province"],"orgTier":"state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str]) -> None:
    ...
    if not path or not updates:
        return
    # R0: Fetch existing row to apply partial updates since we only have upsert.
    vertex_id = _vertex_id(path)
    row = get_kotoba_client().select_first_where("vertex_gov_org", "vertex_id", vertex_id)
    if row:
        row.update(updates)
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: Filter by domain_code and owner_did in Python
...
def task_gov_zwe_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: Filter owner_did and name_en != '' in Python
...
def task_gov_zwe_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_zwe_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))

    # R0: Multi-predicate count, sort, and pagination in Python
...
async def task_gov_zwe_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))

    # R0: Multi-predicate filter and sort in Python
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = []
    for r in all_rows:
        if r.get("owner_did") != PRIMARY_DID:
        ...
        if not r.get("name_en"):
            continue
        if str(r.get("did_registered") or "") == "true":
            continue
        filtered.append(r)
...
async def task_gov_zwe_follow_site_deps(limit: int = 15) -> dict[str, Any]:
    ...
    for r in all_rows:
        if r.get("owner_did") != PRIMARY_DID:
            continue
        if str(r.get("site_followed") or "") == "true":
            continue
...
async def task_gov_zwe_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    cutoff = (_dt.datetime.now(tz=_dt.UTC) - _dt.timedelta(days=7)).replace(microsecond=0)
    cutoff_iso = cutoff.isoformat().replace("+00:00", "Z")

    # R0: Multi-predicate filter, epoch-time math, and sort in Python
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = []
    for r in all_rows:
        if r.get("owner_did") != PRIMARY_DID:
    ...
    for r in rows:
        ...
        # R0: Filter by domain, sort in Python
...
async def task_gov_zwe_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_zwe_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_zwe_seed_orgs, seedLimit)
    register = await task_gov_zwe_register_dids(registerLimit)
    follow = await task_gov_zwe_follow_site_deps(followLimit)
    ingest = await task_gov_zwe_sync_wet_updates(ingestLimit)
    shinka = await task_gov_zwe_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZwe.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zwe_heartbeat_tick)
