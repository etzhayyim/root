"""BOL Government states actor primitives.

This module moves the `did:web:bol-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:bol-state.etzhayyim.com"
DOMAIN_CODE = "bol"
...
_MINISTRY_NDJSON = """\
{"path":"presidencia","name":"Presidencia del Estado Plurinacional","nameEn":"Presidency of the Plurinational State","website":"https://www.presidencia.gob.bo/","contract":"Constitución Política 2009 Art. 165-172","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defensa","name":"Ministerio de Defensa","nameEn":"Ministry of Defense","website":"https://www.mindef.gob.bo/","contract":"Constitución Política 2009 Art. 244-251","tags":["cofog:02","defense"],"orgTier":"ministry"}
{"path":"economia","name":"Ministerio de Economía y Finanzas Públicas","nameEn":"Ministry of Economy and Public Finance","website":"https://www.economiayfinanzas.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:01","finance"],"orgTier":"ministry"}
{"path":"rree","name":"Ministerio de Relaciones Exteriores","nameEn":"Ministry of Foreign Affairs","website":"https://www.cancilleria.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justicia","name":"Ministerio de Justicia y Transparencia Institucional","nameEn":"Ministry of Justice and Institutional Transparency","website":"https://www.justicia.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Ministerio de Gobierno","nameEn":"Ministry of Government (Interior)","website":"https://www.mingobierno.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:01","interior","public-order"],"orgTier":"ministry"}
{"path":"educacion","name":"Ministerio de Educación","nameEn":"Ministry of Education","website":"https://www.minedu.gob.bo/","contract":"Constitución Política 2009 Art. 77-99","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"salud","name":"Ministerio de Salud y Deportes","nameEn":"Ministry of Health and Sports","website":"https://www.minsalud.gob.bo/","contract":"Constitución Política 2009 Art. 35-45","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agricultura","name":"Ministerio de Desarrollo Rural y Tierras","nameEn":"Ministry of Rural Development and Lands","website":"https://www.mdrt.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:04","agriculture"],"orgTier":"ministry"}
{"path":"obras","name":"Ministerio de Obras Públicas, Servicios y Vivienda","nameEn":"Ministry of Public Works, Services and Housing","website":"https://www.oopp.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:04","infrastructure"],"orgTier":"ministry"}
{"path":"trabajo","name":"Ministerio de Trabajo, Empleo y Previsión Social","nameEn":"Ministry of Labour, Employment and Social Welfare","website":"https://www.mintrabajo.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:10","labour"],"orgTier":"ministry"}
{"path":"mineria","name":"Ministerio de Minería y Metalurgia","nameEn":"Ministry of Mining and Metallurgy","website":"https://www.mineria.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:04","mining"],"orgTier":"ministry"}
{"path":"hidrocarburos","name":"Ministerio de Hidrocarburos y Energías","nameEn":"Ministry of Hydrocarbons and Energy","website":"https://www.hidrocarburos.gob.bo/","contract":"Constitución Política 2009","tags":["cofog:04","energy"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"dept:la-paz","name":"Gobierno Autónomo Departamental de La Paz","nameEn":"Autonomous Departmental Government of La Paz","website":"https://www.gobernacionlapaz.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","la-paz"],"orgTier":"state"}
{"path":"dept:cochabamba","name":"Gobierno Autónomo Departamental de Cochabamba","nameEn":"Autonomous Departmental Government of Cochabamba","website":"https://www.gobernacion.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","cochabamba"],"orgTier":"state"}
{"path":"dept:santa-cruz","name":"Gobierno Autónomo Departamental de Santa Cruz","nameEn":"Autonomous Departmental Government of Santa Cruz","website":"https://www.santacruz.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","santa-cruz"],"orgTier":"state"}
{"path":"dept:oruro","name":"Gobierno Autónomo Departamental de Oruro","nameEn":"Autonomous Departmental Government of Oruro","website":"https://www.gobernacionoruro.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","oruro"],"orgTier":"state"}
{"path":"dept:potosi","name":"Gobierno Autónomo Departamental de Potosí","nameEn":"Autonomous Departmental Government of Potosí","website":"https://www.gobernacionpotosi.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","potosi"],"orgTier":"state"}
{"path":"dept:chuquisaca","name":"Gobierno Autónomo Departamental de Chuquisaca","nameEn":"Autonomous Departmental Government of Chuquisaca","website":"https://www.chuquisaca.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","chuquisaca"],"orgTier":"state"}
{"path":"dept:tarija","name":"Gobierno Autónomo Departamental de Tarija","nameEn":"Autonomous Departmental Government of Tarija","website":"https://www.gobernaciontarija.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","tarija"],"orgTier":"state"}
{"path":"dept:beni","name":"Gobierno Autónomo Departamental del Beni","nameEn":"Autonomous Departmental Government of Beni","website":"https://www.beni.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","beni"],"orgTier":"state"}
{"path":"dept:pando","name":"Gobierno Autónomo Departamental de Pando","nameEn":"Autonomous Departmental Government of Pando","website":"https://www.pando.gob.bo/","contract":"Constitución Política 2009 Art. 269-276","tags":["cofog:01","department","pando"],"orgTier":"state"}
"""
...
def task_gov_bol_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: Multi-predicate select for existing orgs
...
def task_gov_bol_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_bol_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: Multi-predicate select, count, and offset/limit
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=5000)
    filtered = [
        r for r in all_rows
...
async def task_gov_bol_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    # R0: Multi-predicate select, order, limit
...
async def task_gov_bol_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_bol_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    cutoff = (_dt.datetime.now(tz=_dt.UTC) - _dt.timedelta(days=7)).replace(microsecond=0)
    cutoff_iso = cutoff.isoformat().replace("+00:00", "Z")
    # R0: Multi-predicate select, date logic, order, limit
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = []
    for r in all_rows:
    ...
    for r in rows:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: Multi-predicate select, order, limit 1
...
async def task_gov_bol_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_bol_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_bol_seed_orgs, seedLimit)
    register = await task_gov_bol_register_dids(registerLimit)
    follow = await task_gov_bol_follow_site_deps(followLimit)
    ingest = await task_gov_bol_sync_wet_updates(ingestLimit)
    shinka = await task_gov_bol_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bol_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bol_register_dids)
    worker.task(
    ...
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bol_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bol_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bol_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bol_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBol.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
