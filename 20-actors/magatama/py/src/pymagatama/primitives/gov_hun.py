...
This module moves the `did:web:hun-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:hun-state.gftd.ai"
DOMAIN_CODE = "hun"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govHun.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govHun.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
