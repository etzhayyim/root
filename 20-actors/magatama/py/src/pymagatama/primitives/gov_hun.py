...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hun_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govHun.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
