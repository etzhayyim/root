"""TJK Government states actor primitives.

This module moves the `did:web:tjk-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:tjk-state.etzhayyim.com"
DOMAIN_CODE = "tjk"
...
_MINISTRY_NDJSON = """\
{"path":"president","name":"Раёсати Ҷумҳурии Тоҷикистон","nameEn":"Presidential Executive Office","website":"https://president.tj","contract":"Constitution 1994","tags":["executive","presidency"],"orgTier":"central"}
{"path":"mod","name":"Вазорати мудофиа","nameEn":"Ministry of Defence","website":"https://mod.tj","contract":"Constitution 1994","tags":["defence","military"],"orgTier":"central"}
{"path":"mof","name":"Вазорати молия","nameEn":"Ministry of Finance","website":"https://minfin.tj","contract":"Constitution 1994","tags":["finance","budget"],"orgTier":"central"}
{"path":"mofa","name":"Вазорати корҳои хориҷӣ","nameEn":"Ministry of Foreign Affairs","website":"https://mfa.tj","contract":"Constitution 1994","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"moj","name":"Вазорати адлия","nameEn":"Ministry of Justice","website":"https://adlia.tj","contract":"Constitution 1994","tags":["justice","law"],"orgTier":"central"}
{"path":"moi","name":"Вазорати корҳои дохилӣ","nameEn":"Ministry of Interior","website":"https://mvd.tj","contract":"Constitution 1994","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"Вазорати маориф ва илм","nameEn":"Ministry of Education and Science","website":"https://maorif.tj","contract":"Constitution 1994","tags":["education"],"orgTier":"central"}
{"path":"moh","name":"Вазорати тандурустӣ ва ҳифзи иҷтимоии аҳолӣ","nameEn":"Ministry of Health","website":"https://moh.tj","contract":"Constitution 1994","tags":["health","public-health"],"orgTier":"central"}
{"path":"moa","name":"Вазорати кишоварзӣ","nameEn":"Ministry of Agriculture","website":"https://moa.tj","contract":"Constitution 1994","tags":["agriculture"],"orgTier":"central"}
{"path":"moedt","name":"Вазорати рушди иқтисод ва савдо","nameEn":"Ministry of Economic Development and Trade","website":"https://mert.tj","contract":"Constitution 1994","tags":["economy","trade"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"sughd","name":"Вилояти Суғд","nameEn":"Sughd Region","website":"https://sughd.tj","contract":"Constitution 1994","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"khatlon","name":"Вилояти Хатлон","nameEn":"Khatlon Region","website":"https://khatlon.tj","contract":"Constitution 1994","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"dushanbe-city","name":"Шаҳри Душанбе","nameEn":"Dushanbe City (Capital)","website":"https://dushanbe.tj","contract":"Constitution 1994","tags":["city","capital"],"orgTier":"subnational"}
{"path":"regions-of-republican-subordination","name":"Ноҳияҳои тобеи ҷумҳурӣ","nameEn":"Districts of Republican Subordination","website":"https://hukumat.tj","contract":"Constitution 1994","tags":["districts","republican-subordination"],"orgTier":"subnational"}
{"path":"gorno-badakhshan","name":"Вилояти Мухтори Кӯҳистони Бадахшон","nameEn":"Gorno-Badakhshan Autonomous Region","website":"https://gbao.tj","contract":"Constitution 1994","tags":["autonomous-region","badakhshan"],"orgTier":"subnational"}
"""
...
def task_gov_tjk_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_tjk_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_tjk_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_tjk_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_tjk_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_tjk_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_tjk_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_tjk_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_tjk_seed_orgs, seedLimit)
    register = await task_gov_tjk_register_dids(registerLimit)
    follow = await task_gov_tjk_follow_site_deps(followLimit)
    ingest = await task_gov_tjk_sync_wet_updates(ingestLimit)
    shinka = await task_gov_tjk_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTjk.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tjk_heartbeat_tick)
