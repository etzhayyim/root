...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIta.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
