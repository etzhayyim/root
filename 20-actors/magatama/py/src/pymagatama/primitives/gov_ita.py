...
This module moves the `did:web:ita-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:ita-state.gftd.ai"
DOMAIN_CODE = "ita"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govIta.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ita_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govIta.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
