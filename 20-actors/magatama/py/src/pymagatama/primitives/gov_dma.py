...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govDma.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govDma.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
