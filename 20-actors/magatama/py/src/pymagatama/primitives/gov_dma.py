"""DMA Government states actor primitives.

This module moves the `did:web:dma-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:dma-state.etzhayyim.com"
DOMAIN_CODE = "dma"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Office of the Prime Minister","nameEn":"Office of the Prime Minister","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","executive","prime-minister","oecs"],"orgTier":"ministry"}
{"path":"national-security-immigration","name":"Ministry of National Security and Immigration","nameEn":"Ministry of National Security and Immigration","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:02","security","immigration"],"orgTier":"ministry"}
{"path":"finance-economic-development","name":"Ministry of Finance and Economic Development","nameEn":"Ministry of Finance and Economic Development","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs","nameEn":"Ministry of Foreign Affairs","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01.2","foreign-affairs","caricom"],"orgTier":"ministry"}
{"path":"justice-attorney-general","name":"Office of the Attorney General","nameEn":"Office of the Attorney General","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health-social-services","name":"Ministry of Health and Social Services","nameEn":"Ministry of Health and Social Services","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture and Forestry","nameEn":"Ministry of Agriculture and Forestry","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:04.2","agriculture","forestry"],"orgTier":"ministry"}
{"path":"tourism-industry","name":"Ministry of Tourism and Industry","nameEn":"Ministry of Tourism and Industry","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:04","tourism","industry"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment","nameEn":"Ministry of Environment","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
{"path":"housing","name":"Ministry of Housing and Lands","nameEn":"Ministry of Housing and Lands","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:06","housing","land"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"parish:saint-andrew","name":"Saint Andrew Parish","nameEn":"Saint Andrew Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-david","name":"Saint David Parish","nameEn":"Saint David Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-george","name":"Saint George Parish","nameEn":"Saint George Parish (Roseau capital)","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish","capital"],"orgTier":"state"}
{"path":"parish:saint-john","name":"Saint John Parish","nameEn":"Saint John Parish (Portsmouth)","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish","portsmouth"],"orgTier":"state"}
{"path":"parish:saint-joseph","name":"Saint Joseph Parish","nameEn":"Saint Joseph Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-luke","name":"Saint Luke Parish","nameEn":"Saint Luke Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-mark","name":"Saint Mark Parish","nameEn":"Saint Mark Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-patrick","name":"Saint Patrick Parish","nameEn":"Saint Patrick Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-paul","name":"Saint Paul Parish","nameEn":"Saint Paul Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-peter","name":"Saint Peter Parish","nameEn":"Saint Peter Parish","website":"https://www.dominica.gov.dm/","contract":"Constitution of Dominica 1978","tags":["cofog:01","parish"],"orgTier":"state"}
"""
...
def task_gov_dma_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_dma_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_dma_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_dma_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_dma_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_dma_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_dma_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_dma_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_dma_seed_orgs, seedLimit)
    register = await task_gov_dma_register_dids(registerLimit)
    follow = await task_gov_dma_follow_site_deps(followLimit)
    ingest = await task_gov_dma_sync_wet_updates(ingestLimit)
    shinka = await task_gov_dma_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDma.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dma_heartbeat_tick)
