...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nld_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNld.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
