...
This module moves the `did:web:jor-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:jor-state.gftd.ai"
DOMAIN_CODE = "jor"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govJor.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jor_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govJor.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
