"""UZB Government states actor primitives.

This module moves the `did:web:uzb-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:uzb-state.etzhayyim.com"
DOMAIN_CODE = "uzb"
...
_MINISTRY_NDJSON = """\
{"path":"president","name":"O'zbekiston Respublikasi Prezidentining Administratsiyasi","nameEn":"Presidential Administration","website":"https://president.uz","contract":"Constitution 1992","tags":["executive","presidency"],"orgTier":"central"}
{"path":"mod","name":"Mudofaa vazirligi","nameEn":"Ministry of Defence","website":"https://mod.uz","contract":"Constitution 1992","tags":["defence","military"],"orgTier":"central"}
{"path":"minfin","name":"Moliya vazirligi","nameEn":"Ministry of Finance","website":"https://mf.uz","contract":"Constitution 1992","tags":["finance","budget"],"orgTier":"central"}
{"path":"mfa","name":"Tashqi ishlar vazirligi","nameEn":"Ministry of Foreign Affairs","website":"https://mfa.uz","contract":"Constitution 1992","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"minjust","name":"Adliya vazirligi","nameEn":"Ministry of Justice","website":"https://minjust.uz","contract":"Constitution 1992","tags":["justice","law"],"orgTier":"central"}
{"path":"mia","name":"Ichki ishlar vazirligi","nameEn":"Ministry of Internal Affairs","website":"https://mvd.uz","contract":"Constitution 1992","tags":["interior","police"],"orgTier":"central"}
{"path":"mohe","name":"Oliy ta'lim, fan va innovatsiyalar vazirligi","nameEn":"Ministry of Higher Education, Science and Innovation","website":"https://edu.uz","contract":"Constitution 1992","tags":["higher-education","science"],"orgTier":"central"}
{"path":"moh","name":"Sog'liqni saqlash vazirligi","nameEn":"Ministry of Health","website":"https://ssv.uz","contract":"Constitution 1992","tags":["health","public-health"],"orgTier":"central"}
{"path":"moa","name":"Qishloq xo'jaligi vazirligi","nameEn":"Ministry of Agriculture","website":"https://agro.uz","contract":"Constitution 1992","tags":["agriculture"],"orgTier":"central"}
{"path":"mii","name":"Investitsiyalar, sanoat va savdo vazirligi","nameEn":"Ministry of Investments, Industry and Trade","website":"https://mift.uz","contract":"Constitution 1992","tags":["investments","industry","trade"],"orgTier":"central"}
{"path":"mdt","name":"Raqamli texnologiyalar vazirligi","nameEn":"Ministry of Digital Technologies","website":"https://mict.uz","contract":"Constitution 1992","tags":["digital","technology"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"andijan","name":"Andijon viloyati","nameEn":"Andijan Region","website":"https://andijan.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"bukhara","name":"Buxoro viloyati","nameEn":"Bukhara Region","website":"https://buxoro.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"fergana","name":"Farg'ona viloyati","nameEn":"Fergana Region","website":"https://fargona.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"jizzakh","name":"Jizzax viloyati","nameEn":"Jizzakh Region","website":"https://jizzax.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"kashkadarya","name":"Qashqadaryo viloyati","nameEn":"Kashkadarya Region","website":"https://qashqadaryo.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"khorezm","name":"Xorazm viloyati","nameEn":"Khorezm Region","website":"https://xorazm.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"namangan","name":"Namangan viloyati","nameEn":"Namangan Region","website":"https://namangan.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"navoiy","name":"Navoiy viloyati","nameEn":"Navoiy Region","website":"https://navoiy.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"samarkand","name":"Samarqand viloyati","nameEn":"Samarkand Region","website":"https://samarkand.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"sirdaryo","name":"Sirdaryo viloyati","nameEn":"Sirdaryo Region","website":"https://sirdaryo.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"surkhandarya","name":"Surxondaryo viloyati","nameEn":"Surkhandarya Region","website":"https://surxondaryo.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"tashkent","name":"Toshkent viloyati","nameEn":"Tashkent Region","website":"https://toshkent.uz","contract":"Constitution 1992","tags":["region","viloyat"],"orgTier":"subnational"}
{"path":"tashkent-city","name":"Toshkent shahri","nameEn":"Tashkent City (Capital)","website":"https://toshkent.uz","contract":"Constitution 1992","tags":["city","capital"],"orgTier":"subnational"}
{"path":"karakalpakstan","name":"Qoraqalpog'iston Respublikasi","nameEn":"Republic of Karakalpakstan (Autonomous)","website":"https://karakalpakstan.uz","contract":"Constitution 1992","tags":["autonomous-republic","karakalpakstan"],"orgTier":"subnational"}
"""
...
def task_gov_uzb_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_uzb_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_uzb_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_uzb_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_uzb_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_uzb_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_uzb_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_uzb_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_uzb_seed_orgs, seedLimit)
    register = await task_gov_uzb_register_dids(registerLimit)
    follow = await task_gov_uzb_follow_site_deps(followLimit)
    ingest = await task_gov_uzb_sync_wet_updates(ingestLimit)
    shinka = await task_gov_uzb_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUzb.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uzb_heartbeat_tick)
