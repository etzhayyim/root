"""PSE Government states actor primitives.

This module moves the `did:web:pse-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:pse-state.etzhayyim.com"
DOMAIN_CODE = "pse"
...
_MINISTRY_NDJSON = """\
{"path":"president","name":"رئاسة السلطة الوطنية الفلسطينية","nameEn":"Palestinian Authority Presidency","website":"https://president.ps","contract":"Basic Law 2003","tags":["executive","presidency"],"orgTier":"central"}
{"path":"mof","name":"وزارة المالية","nameEn":"PA Ministry of Finance","website":"https://www.mof.gov.ps","contract":"Basic Law 2003","tags":["finance","budget"],"orgTier":"central"}
{"path":"mofa","name":"وزارة الخارجية والمغتربين","nameEn":"PA Ministry of Foreign Affairs","website":"https://www.mofa.pna.ps","contract":"Basic Law 2003","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"moj","name":"وزارة العدل","nameEn":"PA Ministry of Justice","website":"https://www.moj.gov.ps","contract":"Basic Law 2003","tags":["justice","law"],"orgTier":"central"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"PA Ministry of Interior","website":"https://www.moi.gov.ps","contract":"Basic Law 2003","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"وزارة التربية والتعليم","nameEn":"PA Ministry of Education","website":"https://www.moehe.gov.ps","contract":"Basic Law 2003","tags":["education"],"orgTier":"central"}
{"path":"moh","name":"وزارة الصحة","nameEn":"PA Ministry of Health","website":"https://www.moh.gov.ps","contract":"Basic Law 2003","tags":["health","public-health"],"orgTier":"central"}
{"path":"moa","name":"وزارة الزراعة","nameEn":"PA Ministry of Agriculture","website":"https://www.moa.gov.ps","contract":"Basic Law 2003","tags":["agriculture"],"orgTier":"central"}
{"path":"plc","name":"المجلس التشريعي الفلسطيني","nameEn":"Palestinian Legislative Council","website":"https://www.pal-plc.org","contract":"Basic Law 2003","tags":["legislature","parliament"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"jenin","name":"محافظة جنين","nameEn":"Jenin Governorate","website":"https://www.jenin.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"tubas","name":"محافظة طوباس","nameEn":"Tubas Governorate","website":"https://www.tubas.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"tulkarm","name":"محافظة طولكرم","nameEn":"Tulkarm Governorate","website":"https://www.tulkarm.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"nablus","name":"محافظة نابلس","nameEn":"Nablus Governorate","website":"https://www.nablus.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"qalqilya","name":"محافظة قلقيلية","nameEn":"Qalqilya Governorate","website":"https://www.qalqilya.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"salfit","name":"محافظة سلفيت","nameEn":"Salfit Governorate","website":"https://www.salfit.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"ramallah","name":"محافظة رام الله والبيرة","nameEn":"Ramallah and Al-Bireh Governorate","website":"https://www.ramallah.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"jericho","name":"محافظة أريحا والأغوار","nameEn":"Jericho and Al-Aghwar Governorate","website":"https://www.jericho.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"jerusalem","name":"محافظة القدس","nameEn":"Jerusalem Governorate","website":"https://www.jerusalem.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank","jerusalem"],"orgTier":"subnational"}
{"path":"bethlehem","name":"محافظة بيت لحم","nameEn":"Bethlehem Governorate","website":"https://www.bethlehem.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"hebron","name":"محافظة الخليل","nameEn":"Hebron Governorate","website":"https://www.hebron.gov.ps","contract":"Basic Law 2003","tags":["governorate","west-bank"],"orgTier":"subnational"}
{"path":"north-gaza","name":"محافظة شمال غزة","nameEn":"North Gaza Governorate","website":"https://northgaza.gov.ps","contract":"Basic Law 2003","tags":["governorate","gaza"],"orgTier":"subnational"}
{"path":"gaza-city","name":"محافظة غزة","nameEn":"Gaza City Governorate","website":"https://gaza.gov.ps","contract":"Basic Law 2003","tags":["governorate","gaza"],"orgTier":"subnational"}
{"path":"deir-el-balah","name":"محافظة دير البلح","nameEn":"Deir el-Balah Governorate","website":"https://deiralbalah.gov.ps","contract":"Basic Law 2003","tags":["governorate","gaza"],"orgTier":"subnational"}
{"path":"khan-yunis","name":"محافظة خان يونس","nameEn":"Khan Yunis Governorate","website":"https://khanyunis.gov.ps","contract":"Basic Law 2003","tags":["governorate","gaza"],"orgTier":"subnational"}
{"path":"rafah","name":"محافظة رفح","nameEn":"Rafah Governorate","website":"https://rafah.gov.ps","contract":"Basic Law 2003","tags":["governorate","gaza"],"orgTier":"subnational"}
"""
...
def task_gov_pse_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_pse_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_pse_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_pse_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_pse_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_pse_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_pse_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_pse_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_pse_seed_orgs, seedLimit)
    register = await task_gov_pse_register_dids(registerLimit)
    follow = await task_gov_pse_follow_site_deps(followLimit)
    ingest = await task_gov_pse_sync_wet_updates(ingestLimit)
    shinka = await task_gov_pse_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPse.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pse_heartbeat_tick)
