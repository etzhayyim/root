...
This module moves the `did:web:ltu-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:ltu-state.gftd.ai"
DOMAIN_CODE = "ltu"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ltu_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govLtu.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
