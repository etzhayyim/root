"""CRI Government states actor primitives.

This module moves the `did:web:cri-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:cri-state.etzhayyim.com"
DOMAIN_CODE = "cri"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.go.cr/", "contract": "Constitución Política 1949 Art. 130-165", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "hacienda", "name": "Ministerio de Hacienda", "nameEn": "Ministry of Finance", "website": "https://www.hacienda.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores y Culto", "nameEn": "Ministry of Foreign Affairs and Worship", "website": "https://www.rree.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "justicia", "name": "Ministerio de Justicia y Paz", "nameEn": "Ministry of Justice and Peace", "website": "https://www.mjp.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "gobernacion", "name": "Ministerio de Gobernación, Policía y Seguridad Pública", "nameEn": "Ministry of Governance, Police and Public Security", "website": "https://www.mgsps.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación Pública", "nameEn": "Ministry of Public Education", "website": "https://www.mep.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud", "nameEn": "Ministry of Health", "website": "https://www.ministeriodesalud.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio de Agricultura y Ganadería", "nameEn": "Ministry of Agriculture and Livestock", "website": "https://www.mag.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "economia", "name": "Ministerio de Economía, Industria y Comercio", "nameEn": "Ministry of Economy, Industry and Commerce", "website": "https://www.meic.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "ciencia", "name": "Ministerio de Ciencia, Innovación, Tecnología y Telecomunicaciones", "nameEn": "Ministry of Science, Innovation, Technology and Telecommunications", "website": "https://www.micitt.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "obras", "name": "Ministerio de Obras Públicas y Transportes", "nameEn": "Ministry of Public Works and Transport", "website": "https://www.mopt.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "ambiente", "name": "Ministerio de Ambiente y Energía", "nameEn": "Ministry of Environment and Energy", "website": "https://www.minae.go.cr/", "contract": "Constitución Política 1949", "tags": ["cofog:01"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "prov:san-jose", "name": "Provincia de San José", "nameEn": "Province of San José", "website": "https://www.muni-sanjose.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:alajuela", "name": "Provincia de Alajuela", "nameEn": "Province of Alajuela", "website": "https://www.alajuela.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:cartago", "name": "Provincia de Cartago", "nameEn": "Province of Cartago", "website": "https://www.cartago.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:heredia", "name": "Provincia de Heredia", "nameEn": "Province of Heredia", "website": "https://www.heredia.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:guanacaste", "name": "Provincia de Guanacaste", "nameEn": "Province of Guanacaste", "website": "https://www.guanacaste.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:puntarenas", "name": "Provincia de Puntarenas", "nameEn": "Province of Puntarenas", "website": "https://www.puntarenas.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:limon", "name": "Provincia de Limón", "nameEn": "Province of Limón", "website": "https://www.limon.go.cr/", "contract": "Constitución Política 1949 Art. 168-175", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_cri_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_cri_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_cri_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_cri_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_cri_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_cri_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_cri_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_cri_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_cri_seed_orgs, seedLimit)
    register = await task_gov_cri_register_dids(registerLimit)
    follow = await task_gov_cri_follow_site_deps(followLimit)
    ingest = await task_gov_cri_sync_wet_updates(ingestLimit)
    shinka = await task_gov_cri_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCri.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cri_heartbeat_tick)
