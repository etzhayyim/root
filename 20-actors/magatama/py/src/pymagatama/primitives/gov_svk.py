"""SVK Government states actor primitives.

This module moves the `did:web:svk-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:svk-state.etzhayyim.com"
DOMAIN_CODE = "svk"
...
_MINISTRY_NDJSON = """\
{"path":"uv","name":"Úrad vlády Slovenskej republiky","nameEn":"Office of the Government of the Slovak Republic","website":"https://www.vlada.gov.sk/","contract":"Ústava Art. 108","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mzv","name":"Ministerstvo zahraničných vecí a európskych záležitostí","nameEn":"Ministry of Foreign and European Affairs","website":"https://www.mzv.sk/","contract":"Ústava Art. 108","tags":["cofog:01.2","foreign-affairs","diplomacy","eu"],"orgTier":"ministry"}
{"path":"mo","name":"Ministerstvo obrany","nameEn":"Ministry of Defence","website":"https://www.mosr.sk/","contract":"Ústava Art. 119","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mf","name":"Ministerstvo financií","nameEn":"Ministry of Finance","website":"https://www.mfsr.sk/","contract":"Ústava Art. 55","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"ms","name":"Ministerstvo spravodlivosti","nameEn":"Ministry of Justice","website":"https://www.justice.gov.sk/","contract":"Ústava Art. 141","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mv","name":"Ministerstvo vnútra","nameEn":"Ministry of the Interior","website":"https://www.minv.sk/","contract":"Ústava Art. 119","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"msvvs","name":"Ministerstvo školstva, vedy, výskumu a športu","nameEn":"Ministry of Education, Science, Research and Sport","website":"https://www.msvvs.sk/","contract":"Ústava Art. 42","tags":["cofog:09","education","science","sport"],"orgTier":"ministry"}
{"path":"mz","name":"Ministerstvo zdravotníctva","nameEn":"Ministry of Health","website":"https://www.health.gov.sk/","contract":"Ústava Art. 40","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mpsv","name":"Ministerstvo práce, sociálnych vecí a rodiny","nameEn":"Ministry of Labour, Social Affairs and Family","website":"https://www.employment.gov.sk/","contract":"Ústava Art. 36","tags":["cofog:04","labour","social","family"],"orgTier":"ministry"}
{"path":"mprvsr","name":"Ministerstvo pôdohospodárstva a rozvoja vidieka","nameEn":"Ministry of Agriculture and Rural Development","website":"https://www.mpsr.sk/","contract":"Ústava Art. 44","tags":["cofog:04.2","agriculture","rural"],"orgTier":"ministry"}
{"path":"mdv","name":"Ministerstvo dopravy a výstavby","nameEn":"Ministry of Transport and Construction","website":"https://www.mindop.sk/","contract":"Ústava Art. 44","tags":["cofog:04.5","transport","construction","infrastructure"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"kraj:bratislava","name":"Bratislavský samosprávny kraj","nameEn":"Bratislava Self-Governing Region","website":"https://www.bratislavskykraj.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region","capital"],"orgTier":"state"}
{"path":"kraj:trnava","name":"Trnavský samosprávny kraj","nameEn":"Trnava Self-Governing Region","website":"https://www.trnava-vuc.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"kraj:trencin","name":"Trenčiansky samosprávny kraj","nameEn":"Trenčín Self-Governing Region","website":"https://www.trencinskvuc.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"kraj:nitra","name":"Nitriansky samosprávny kraj","nameEn":"Nitra Self-Governing Region","website":"https://www.unsk.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"kraj:zilina","name":"Žilinský samosprávny kraj","nameEn":"Žilina Self-Governing Region","website":"https://www.zilinskvuc.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region","mountains"],"orgTier":"state"}
{"path":"kraj:banskabyistrica","name":"Banskobystrický samosprávny kraj","nameEn":"Banská Bystrica Self-Governing Region","website":"https://www.bbsk.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region","central"],"orgTier":"state"}
{"path":"kraj:presov","name":"Prešovský samosprávny kraj","nameEn":"Prešov Self-Governing Region","website":"https://www.po-kraj.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region","east","tatra"],"orgTier":"state"}
{"path":"kraj:kosice","name":"Košický samosprávny kraj","nameEn":"Košice Self-Governing Region","website":"https://www.vucke.sk/","contract":"Ústava Art. 64a","tags":["cofog:01","region","east","second-city"],"orgTier":"state"}
"""
...
def task_gov_svk_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_svk_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_svk_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_svk_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_svk_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_svk_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit_val = max(1, min(int(limit or 10), 50))
...
async def task_gov_svk_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_svk_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_svk_seed_orgs, seedLimit)
    register = await task_gov_svk_register_dids(registerLimit)
    follow = await task_gov_svk_follow_site_deps(followLimit)
    ingest = await task_gov_svk_sync_wet_updates(ingestLimit)
    shinka = await task_gov_svk_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvk.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svk_heartbeat_tick)
