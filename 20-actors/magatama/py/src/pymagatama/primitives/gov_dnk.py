"""DNK Government states actor primitives.

This module moves the `did:web:dnk-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:dnk-state.etzhayyim.com"
DOMAIN_CODE = "dnk"
...
_MINISTRY_NDJSON = """\
{"path":"statsministeriet","name":"Statsministeriet","nameEn":"Prime Minister's Office","website":"https://www.stm.dk/","contract":"Grundloven §3","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"udenrigsministeriet","name":"Udenrigsministeriet","nameEn":"Ministry of Foreign Affairs","website":"https://um.dk/","contract":"Grundloven §3","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"forsvarsministeriet","name":"Forsvarsministeriet","nameEn":"Ministry of Defence","website":"https://www.fmn.dk/","contract":"Grundloven §3","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"finansministeriet","name":"Finansministeriet","nameEn":"Ministry of Finance","website":"https://www.fm.dk/","contract":"Grundloven §3","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"justitsministeriet","name":"Justitsministeriet","nameEn":"Ministry of Justice","website":"https://www.justitsministeriet.dk/","contract":"Grundloven §3","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"sundhedsministeriet","name":"Sundhedsministeriet","nameEn":"Ministry of Health","website":"https://www.sum.dk/","contract":"Grundloven §3","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"uddannelsesministeriet","name":"Uddannelses- og Forskningsministeriet","nameEn":"Ministry of Higher Education and Science","website":"https://www.ufm.dk/","contract":"Grundloven §3","tags":["cofog:09","education","research"],"orgTier":"ministry"}
{"path":"borneministeriet","name":"Børne- og Undervisningsministeriet","nameEn":"Ministry of Children and Education","website":"https://www.uvm.dk/","contract":"Grundloven §3","tags":["cofog:09","children","schools"],"orgTier":"ministry"}
{"path":"erhvervsministeriet","name":"Erhvervsministeriet","nameEn":"Ministry of Business","website":"https://em.dk/","contract":"Grundloven §3","tags":["cofog:04","business","economy"],"orgTier":"ministry"}
{"path":"klimaministeriet","name":"Klima-, Energi- og Forsyningsministeriet","nameEn":"Ministry of Climate, Energy and Utilities","website":"https://www.kefm.dk/","contract":"Grundloven §3","tags":["cofog:04","climate","energy"],"orgTier":"ministry"}
{"path":"transportministeriet","name":"Transportministeriet","nameEn":"Ministry of Transport","website":"https://www.trm.dk/","contract":"Grundloven §3","tags":["cofog:04.5","transport"],"orgTier":"ministry"}
{"path":"foedevareministeriet","name":"Ministeriet for Fødevarer, Landbrug og Fiskeri","nameEn":"Ministry of Food, Agriculture and Fisheries","website":"https://www.fvm.dk/","contract":"Grundloven §3","tags":["cofog:04.2","agriculture","fisheries"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:hovedstaden","name":"Region Hovedstaden","nameEn":"Capital Region of Denmark","website":"https://www.regionh.dk/","contract":"Regionsloven","tags":["cofog:01","region","l5"],"orgTier":"state"}
{"path":"region:midtjylland","name":"Region Midtjylland","nameEn":"Central Denmark Region","website":"https://www.rm.dk/","contract":"Regionsloven","tags":["cofog:01","region","l5"],"orgTier":"state"}
{"path":"region:nordjylland","name":"Region Nordjylland","nameEn":"North Denmark Region","website":"https://www.rn.dk/","contract":"Regionsloven","tags":["cofog:01","region","l5"],"orgTier":"state"}
{"path":"region:sjaelland","name":"Region Sjælland","nameEn":"Region Zealand","website":"https://www.regionsjaelland.dk/","contract":"Regionsloven","tags":["cofog:01","region","l5"],"orgTier":"state"}
{"path":"region:syddanmark","name":"Region Syddanmark","nameEn":"Region of Southern Denmark","website":"https://www.rsyd.dk/","contract":"Regionsloven","tags":["cofog:01","region","l5"],"orgTier":"state"}
"""
...
def task_gov_dnk_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_dnk_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_dnk_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_dnk_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_dnk_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_dnk_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_dnk_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_dnk_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_dnk_seed_orgs, seedLimit)
    register = await task_gov_dnk_register_dids(registerLimit)
    follow = await task_gov_dnk_follow_site_deps(followLimit)
    ingest = await task_gov_dnk_sync_wet_updates(ingestLimit)
    shinka = await task_gov_dnk_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDnk.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dnk_heartbeat_tick)
