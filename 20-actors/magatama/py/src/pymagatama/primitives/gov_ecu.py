"""ECU Government states actor primitives.

This module moves the `did:web:ecu-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:ecu-state.etzhayyim.com"
DOMAIN_CODE = "ecu"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gob.ec/", "contract": "Constitución 2008 Art. 141-166", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "defensa", "name": "Ministerio de Defensa Nacional", "nameEn": "Ministry of National Defence", "website": "https://www.defensa.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "finanzas", "name": "Ministerio de Finanzas", "nameEn": "Ministry of Finance", "website": "https://www.finanzas.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores y Movilidad Humana", "nameEn": "Ministry of Foreign Affairs and Human Mobility", "website": "https://www.cancilleria.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "justicia", "name": "Ministerio de Justicia y Derechos Humanos", "nameEn": "Ministry of Justice and Human Rights", "website": "https://www.justicia.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "interior", "name": "Ministerio del Interior", "nameEn": "Ministry of Interior", "website": "https://www.ministeriointerior.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación", "nameEn": "Ministry of Education", "website": "https://educacion.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud Pública", "nameEn": "Ministry of Public Health", "website": "https://www.salud.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio de Agricultura y Ganadería", "nameEn": "Ministry of Agriculture and Livestock", "website": "https://www.agricultura.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "produccion", "name": "Ministerio de Producción, Comercio Exterior, Inversiones y Pesca", "nameEn": "Ministry of Production, Foreign Trade, Investment and Fishing", "website": "https://www.produccion.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "energia", "name": "Ministerio de Energía y Minas", "nameEn": "Ministry of Energy and Mines", "website": "https://www.recursosyenergia.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "ambiente", "name": "Ministerio del Ambiente, Agua y Transición Ecológica", "nameEn": "Ministry of the Environment, Water and Ecological Transition", "website": "https://www.ambiente.gob.ec/", "contract": "Constitución 2008", "tags": ["cofog:01"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "prov:azuay", "name": "Provincia del Azuay", "nameEn": "Province of Azuay", "website": "https://www.azuay.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:bolivar", "name": "Provincia de Bolívar", "nameEn": "Province of Bolívar", "website": "https://www.bolivar.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:canar", "name": "Provincia del Cañar", "nameEn": "Province of Cañar", "website": "https://www.canar.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:carchi", "name": "Provincia del Carchi", "nameEn": "Province of Carchi", "website": "https://www.carchi.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:chimborazo", "name": "Provincia de Chimborazo", "nameEn": "Province of Chimborazo", "website": "https://www.chimborazo.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:cotopaxi", "name": "Provincia de Cotopaxi", "nameEn": "Province of Cotopaxi", "website": "https://www.cotopaxi.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:el-oro", "name": "Provincia de El Oro", "nameEn": "Province of El Oro", "website": "https://www.eloro.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:esmeraldas", "name": "Provincia de Esmeraldas", "nameEn": "Province of Esmeraldas", "website": "https://www.esmeraldas.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:galapagos", "name": "Provincia de Galápagos", "nameEn": "Province of Galápagos", "website": "https://www.galapagos.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:guayas", "name": "Provincia del Guayas", "nameEn": "Province of Guayas", "website": "https://www.guayas.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:imbabura", "name": "Provincia de Imbabura", "nameEn": "Province of Imbabura", "website": "https://www.imbabura.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:loja", "name": "Provincia de Loja", "nameEn": "Province of Loja", "website": "https://www.loja.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:los-rios", "name": "Provincia de Los Ríos", "nameEn": "Province of Los Ríos", "website": "https://www.losrios.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:manabi", "name": "Provincia de Manabí", "nameEn": "Province of Manabí", "website": "https://www.manabi.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:napo", "name": "Provincia de Napo", "nameEn": "Province of Napo", "website": "https://www.napo.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:orellana", "name": "Provincia de Orellana", "nameEn": "Province of Orellana", "website": "https://www.orellana.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:pastaza", "name": "Provincia de Pastaza", "nameEn": "Province of Pastaza", "website": "https://www.pastaza.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:pichincha", "name": "Provincia de Pichincha", "nameEn": "Province of Pichincha", "website": "https://www.pichincha.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:santa-elena", "name": "Provincia de Santa Elena", "nameEn": "Province of Santa Elena", "website": "https://www.santaelena.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:santo-domingo", "name": "Provincia de Santo Domingo de los Tsáchilas", "nameEn": "Province of Santo Domingo de los Tsáchilas", "website": "https://www.santodomingo.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:sucumbios", "name": "Provincia de Sucumbíos", "nameEn": "Province of Sucumbíos", "website": "https://www.sucumbios.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:tungurahua", "name": "Provincia de Tungurahua", "nameEn": "Province of Tungurahua", "website": "https://www.tungurahua.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:zamora-chinchipe", "name": "Provincia de Zamora Chinchipe", "nameEn": "Province of Zamora Chinchipe", "website": "https://www.zamora.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:morona-santiago", "name": "Provincia de Morona Santiago", "nameEn": "Province of Morona Santiago", "website": "https://www.moronasantiago.gob.ec/", "contract": "Constitución 2008 Art. 252-258", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_ecu_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_ecu_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_ecu_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_ecu_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_ecu_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_ecu_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_ecu_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_ecu_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_ecu_seed_orgs, seedLimit)
    register = await task_gov_ecu_register_dids(registerLimit)
    follow = await task_gov_ecu_follow_site_deps(followLimit)
    ingest = await task_gov_ecu_sync_wet_updates(ingestLimit)
    shinka = await task_gov_ecu_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEcu.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_heartbeat_tick)
