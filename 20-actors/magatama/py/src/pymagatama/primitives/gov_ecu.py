...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ecu_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govEcu.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
