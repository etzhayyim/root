...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_omn_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govOmn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
