"""MKD Government states actor primitives.

This module moves the `did:web:mkd-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:mkd-state.etzhayyim.com"
DOMAIN_CODE = "mkd"
...
_MINISTRY_NDJSON = """\
{"path":"presidential-cabinet","name":"Кабинет на Претседателот на Република Северна Македонија","nameEn":"Cabinet of the President of North Macedonia","website":"https://www.president.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defence","name":"Министерство за одбрана","nameEn":"Ministry of Defence","website":"https://www.mod.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:02","defence","nato"],"orgTier":"ministry"}
{"path":"finance","name":"Министерство за финансии","nameEn":"Ministry of Finance","website":"https://finance.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:01.1","finance","budget","taxation"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Министерство за надворешни работи","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"justice","name":"Министерство за правда","nameEn":"Ministry of Justice","website":"https://www.pravda.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Министерство за внатрешни работи","nameEn":"Ministry of Interior","website":"https://www.mvr.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"education","name":"Министерство за образование и наука","nameEn":"Ministry of Education and Science","website":"https://mon.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:09","education","science"],"orgTier":"ministry"}
{"path":"health","name":"Министерство за здравство","nameEn":"Ministry of Health","website":"https://www.zdravstvo.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Министерство за земјоделство, шумарство и водостопанство","nameEn":"Ministry of Agriculture, Forestry and Water Economy","website":"https://www.mzsv.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:04.2","agriculture","forestry","water"],"orgTier":"ministry"}
{"path":"economy","name":"Министерство за економија","nameEn":"Ministry of Economy","website":"https://economy.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:04","economy","industry"],"orgTier":"ministry"}
{"path":"transport","name":"Министерство за транспорт и врски","nameEn":"Ministry of Transport and Communications","website":"https://mtc.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:04.5","transport","communications"],"orgTier":"ministry"}
{"path":"environment","name":"Министерство за животна средина и просторно планирање","nameEn":"Ministry of Environment and Physical Planning","website":"https://www.moepp.gov.mk/","contract":"Constitution 1991 (amended Ohrid Framework 2001)","tags":["cofog:05","environment","planning"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"reg:vardar","name":"Вардарски регион","nameEn":"Vardar Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:east","name":"Источен регион","nameEn":"East Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:southwest","name":"Југозападен регион","nameEn":"Southwest Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:southeast","name":"Југоисточен регион","nameEn":"Southeast Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:pelagonia","name":"Пелагониски регион","nameEn":"Pelagonia Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:polog","name":"Полошки регион","nameEn":"Polog Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:northeast","name":"Североисточен регион","nameEn":"Northeast Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"reg:skopje","name":"Скопски регион","nameEn":"Skopje Statistical Region","website":"https://www.stat.gov.mk/","contract":"Constitution 1991 Art. 114-117","tags":["cofog:01","statistical-region","capital"],"orgTier":"state"}
"""
...
def task_gov_mkd_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_mkd_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_mkd_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_mkd_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_mkd_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_mkd_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_mkd_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_mkd_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_mkd_seed_orgs, seedLimit)
    register = await task_gov_mkd_register_dids(registerLimit)
    follow = await task_gov_mkd_follow_site_deps(followLimit)
    ingest = await task_gov_mkd_sync_wet_updates(ingestLimit)
    shinka = await task_gov_mkd_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMkd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mkd_heartbeat_tick)
