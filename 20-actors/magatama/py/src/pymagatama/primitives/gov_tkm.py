...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govTkm.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
