"""TKM Government states actor primitives.

This module moves the `did:web:tkm-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:tkm-state.etzhayyim.com"
DOMAIN_CODE = "tkm"
...
_MINISTRY_NDJSON = """\
{"path":"president","name":"Türkmenistanyň Prezidentiniň Administrasiýasy","nameEn":"Presidential Administration","website":"https://president.gov.tm","contract":"Constitution 2008","tags":["executive","presidency"],"orgTier":"central"}
{"path":"mod","name":"Türkmenistanyň Goranmak ministrligi","nameEn":"Ministry of Defence","website":"https://mod.gov.tm","contract":"Constitution 2008","tags":["defence","military"],"orgTier":"central"}
{"path":"mof","name":"Türkmenistanyň Maliýe we ykdysadyýet ministrligi","nameEn":"Ministry of Finance and Economy","website":"https://minfin.gov.tm","contract":"Constitution 2008","tags":["finance","economy"],"orgTier":"central"}
{"path":"mfa","name":"Türkmenistanyň Daşary işler ministrligi","nameEn":"Ministry of Foreign Affairs","website":"https://mfa.gov.tm","contract":"Constitution 2008","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"moj","name":"Türkmenistanyň Adalat ministrligi","nameEn":"Ministry of Justice","website":"https://justice.gov.tm","contract":"Constitution 2008","tags":["justice","law"],"orgTier":"central"}
{"path":"mia","name":"Türkmenistanyň Içeri işler ministrligi","nameEn":"Ministry of Internal Affairs","website":"https://police.gov.tm","contract":"Constitution 2008","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"Türkmenistanyň Bilim ministrligi","nameEn":"Ministry of Education","website":"https://education.gov.tm","contract":"Constitution 2008","tags":["education"],"orgTier":"central"}
{"path":"moh","name":"Türkmenistanyň Saglygy goraýyş we derman senagaty ministrligi","nameEn":"Ministry of Health","website":"https://saglyk.gov.tm","contract":"Constitution 2008","tags":["health","public-health"],"orgTier":"central"}
{"path":"moa","name":"Türkmenistanyň Oba hojalyk we daşky gurşawy goramak ministrligi","nameEn":"Ministry of Agriculture","website":"https://agro.gov.tm","contract":"Constitution 2008","tags":["agriculture","environment"],"orgTier":"central"}
{"path":"moe2","name":"Türkmenistanyň Energetika ministrligi","nameEn":"Ministry of Energy","website":"https://energetika.gov.tm","contract":"Constitution 2008","tags":["energy","electricity"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"ahal","name":"Ahal welaýaty","nameEn":"Ahal Region","website":"https://ahal.gov.tm","contract":"Constitution 2008","tags":["region","welayat"],"orgTier":"subnational"}
{"path":"balkan","name":"Balkan welaýaty","nameEn":"Balkan Region","website":"https://balkan.gov.tm","contract":"Constitution 2008","tags":["region","welayat"],"orgTier":"subnational"}
{"path":"dashoguz","name":"Daşoguz welaýaty","nameEn":"Dashoguz Region","website":"https://dashoguz.gov.tm","contract":"Constitution 2008","tags":["region","welayat"],"orgTier":"subnational"}
{"path":"lebap","name":"Lebap welaýaty","nameEn":"Lebap Region","website":"https://lebap.gov.tm","contract":"Constitution 2008","tags":["region","welayat"],"orgTier":"subnational"}
{"path":"mary","name":"Mary welaýaty","nameEn":"Mary Region","website":"https://mary.gov.tm","contract":"Constitution 2008","tags":["region","welayat"],"orgTier":"subnational"}
{"path":"ashgabat-city","name":"Aşgabat şäheri","nameEn":"Ashgabat City (Capital)","website":"https://ashgabat.gov.tm","contract":"Constitution 2008","tags":["city","capital"],"orgTier":"subnational"}
"""
...
def task_gov_tkm_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_tkm_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_tkm_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_tkm_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_tkm_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_tkm_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_tkm_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_tkm_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_tkm_seed_orgs, seedLimit)
    register = await task_gov_tkm_register_dids(registerLimit)
    follow = await task_gov_tkm_follow_site_deps(followLimit)
    ingest = await task_gov_tkm_sync_wet_updates(ingestLimit)
    shinka = await task_gov_tkm_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTkm.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tkm_heartbeat_tick)
