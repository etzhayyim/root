"""DZA Government states actor primitives.

This module moves the `did:web:dza-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:dza-state.etzhayyim.com"
DOMAIN_CODE = "dza"
...
_MINISTRY_NDJSON = """\
{"path":"premier-ministere","name":"رئاسة الحكومة","nameEn":"Prime Minister's Office","website":"https://www.premier-ministre.gov.dz/","contract":"الدستور الجزائري 2020 Art. 99","tags":["cofog:01","executive","premier"],"orgTier":"ministry"}
{"path":"maee","name":"وزارة الشؤون الخارجية والجالية الوطنية","nameEn":"Ministry of Foreign Affairs and National Community Abroad","website":"https://www.mae.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mdn","name":"وزارة الدفاع الوطني","nameEn":"Ministry of National Defence","website":"https://www.mdn.dz/","contract":"الدستور الجزائري 2020 Art. 29","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mf","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mf.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"mj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.mjustice.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mint","name":"وزارة الداخلية والجماعات المحلية","nameEn":"Ministry of Interior and Local Communities","website":"https://www.interieur.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:03","interior","local-gov"],"orgTier":"ministry"}
{"path":"men","name":"وزارة التربية الوطنية","nameEn":"Ministry of National Education","website":"https://www.education.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"mesrs","name":"وزارة التعليم العالي والبحث العلمي","nameEn":"Ministry of Higher Education and Scientific Research","website":"https://www.mesrs.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:09","higher-education","research"],"orgTier":"ministry"}
{"path":"msp","name":"وزارة الصحة","nameEn":"Ministry of Health","website":"https://www.sante.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mtess","name":"وزارة العمل والتشغيل والضمان الاجتماعي","nameEn":"Ministry of Labour, Employment and Social Security","website":"https://www.mtss.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:04","labour","employment","social"],"orgTier":"ministry"}
{"path":"mi","name":"وزارة الصناعة","nameEn":"Ministry of Industry","website":"https://www.industrie.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:04","industry"],"orgTier":"ministry"}
{"path":"men-energie","name":"وزارة الطاقة والمناجم","nameEn":"Ministry of Energy and Mines","website":"https://www.energy.gov.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:04","energy","mines"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"wilaya:alger","name":"ولاية الجزائر","nameEn":"Algiers Wilaya","website":"https://www.wilaya-alger.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya","capital"],"orgTier":"state"}
{"path":"wilaya:oran","name":"ولاية وهران","nameEn":"Oran Wilaya","website":"https://www.wilaya-oran.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:constantine","name":"ولاية قسنطينة","nameEn":"Constantine Wilaya","website":"https://www.wilaya-constantine.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:annaba","name":"ولاية عنابة","nameEn":"Annaba Wilaya","website":"https://www.wilaya-annaba.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:blida","name":"ولاية البليدة","nameEn":"Blida Wilaya","website":"https://www.wilaya-blida.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:batna","name":"ولاية باتنة","nameEn":"Batna Wilaya","website":"https://www.wilaya-batna.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:setif","name":"ولاية سطيف","nameEn":"Sétif Wilaya","website":"https://www.wilaya-setif.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:sidi-bel-abbes","name":"ولاية سيدي بلعباس","nameEn":"Sidi Bel Abbès Wilaya","website":"https://www.wilaya-sba.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:biskra","name":"ولاية بسكرة","nameEn":"Biskra Wilaya","website":"https://www.wilaya-biskra.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya"],"orgTier":"state"}
{"path":"wilaya:tizi-ouzou","name":"ولاية تيزي وزو","nameEn":"Tizi Ouzou Wilaya","website":"https://www.wilaya-tiziouzou.dz/","contract":"الدستور الجزائري 2020","tags":["cofog:01","wilaya","kabyle"],"orgTier":"state"}
"""
...
def task_gov_dza_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_dza_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_dza_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_dza_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_dza_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_dza_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_dza_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_dza_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_dza_seed_orgs, seedLimit)
    register = await task_gov_dza_register_dids(registerLimit)
    follow = await task_gov_dza_follow_site_deps(followLimit)
    ingest = await task_gov_dza_sync_wet_updates(ingestLimit)
    shinka = await task_gov_dza_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDza.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dza_heartbeat_tick)
