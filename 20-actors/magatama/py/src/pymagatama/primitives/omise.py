...
def register(worker: Any, *, timeout_ms: int = 60_000) -> None:
    tasks = {
        "xrpc.ai.gftd.apps.omise.acceptOrder": task_omise_accept_order,
        "xrpc.ai.gftd.apps.omise.addToCart": task_omise_add_to_cart,
        "xrpc.ai.gftd.apps.omise.applyCoupon": task_omise_apply_coupon,
        "xrpc.ai.gftd.apps.omise.approveSeller": task_omise_approve_seller,
        "xrpc.ai.gftd.apps.omise.archiveProduct": task_omise_archive_product,
        "xrpc.ai.gftd.apps.omise.cardHome": task_omise_card_home,
        "xrpc.ai.gftd.apps.omise.clearCart": task_omise_clear_cart,
        "xrpc.ai.gftd.apps.omise.createCoupon": task_omise_create_coupon,
        "xrpc.ai.gftd.apps.omise.createOrder": task_omise_create_order,
        "xrpc.ai.gftd.apps.omise.createProduct": task_omise_create_product,
        "xrpc.ai.gftd.apps.omise.createShipment": task_omise_create_shipment,
        "xrpc.ai.gftd.apps.omise.deactivateCoupon": task_omise_deactivate_coupon,
        "xrpc.ai.gftd.apps.omise.getCart": task_omise_get_cart,
        "xrpc.ai.gftd.apps.omise.getOrder": task_omise_get_order,
        "xrpc.ai.gftd.apps.omise.getProduct": task_omise_get_product,
        "xrpc.ai.gftd.apps.omise.getSellerBalance": task_omise_get_seller_balance,
        "xrpc.ai.gftd.apps.omise.getSellerProfile": task_omise_get_seller_profile,
        "xrpc.ai.gftd.apps.omise.getSellerRevenue": task_omise_get_seller_revenue,
        "xrpc.ai.gftd.apps.omise.getShipment": task_omise_get_shipment,
        "xrpc.ai.gftd.apps.omise.listCoupons": task_omise_list_coupons,
        "xrpc.ai.gftd.apps.omise.listOrders": task_omise_list_orders,
        "xrpc.ai.gftd.apps.omise.listPendingSellers": task_omise_list_pending_sellers,
        "xrpc.ai.gftd.apps.omise.listReviews": task_omise_list_reviews,
        "xrpc.ai.gftd.apps.omise.listSellerOrders": task_omise_list_seller_orders,
        "xrpc.ai.gftd.apps.omise.listSellerProducts": task_omise_list_seller_products,
        "xrpc.ai.gftd.apps.omise.listSellers": task_omise_list_sellers,
        "xrpc.ai.gftd.apps.omise.listSettlements": task_omise_list_settlements,
        "xrpc.ai.gftd.apps.omise.listShipments": task_omise_list_shipments,
        "xrpc.ai.gftd.apps.omise.markReadyToShip": task_omise_mark_ready_to_ship,
        "xrpc.ai.gftd.apps.omise.platformAnalytics": task_omise_platform_analytics,
        "xrpc.ai.gftd.apps.omise.registerSeller": task_omise_register_seller,
        "xrpc.ai.gftd.apps.omise.rejectOrder": task_omise_reject_order,
        "xrpc.ai.gftd.apps.omise.removeFromCart": task_omise_remove_from_cart,
        "xrpc.ai.gftd.apps.omise.requestPayout": task_omise_request_payout,
        "xrpc.ai.gftd.apps.omise.requestPickup": task_omise_request_pickup,
        "xrpc.ai.gftd.apps.omise.resolveDispute": task_omise_resolve_dispute,
        "xrpc.ai.gftd.apps.omise.searchProducts": task_omise_search_products,
        "xrpc.ai.gftd.apps.omise.submitReview": task_omise_submit_review,
        "xrpc.ai.gftd.apps.omise.suspendSeller": task_omise_suspend_seller,
        "xrpc.ai.gftd.apps.omise.updateInventory": task_omise_update_inventory,
        "xrpc.ai.gftd.apps.omise.updateProduct": task_omise_update_product,
        "xrpc.ai.gftd.apps.omise.updateSellerProfile": task_omise_update_seller_profile,
        "xrpc.ai.gftd.apps.omise.updateShipmentStatus": task_omise_update_shipment_status,
    }
