...
def register(worker: Any, *, timeout_ms: int = 60_000) -> None:
    tasks = {
        "xrpc.app.etzhayyim.apps.omise.acceptOrder": task_omise_accept_order,
        "xrpc.app.etzhayyim.apps.omise.addToCart": task_omise_add_to_cart,
        "xrpc.app.etzhayyim.apps.omise.applyCoupon": task_omise_apply_coupon,
        "xrpc.app.etzhayyim.apps.omise.approveSeller": task_omise_approve_seller,
        "xrpc.app.etzhayyim.apps.omise.archiveProduct": task_omise_archive_product,
        "xrpc.app.etzhayyim.apps.omise.cardHome": task_omise_card_home,
        "xrpc.app.etzhayyim.apps.omise.clearCart": task_omise_clear_cart,
        "xrpc.app.etzhayyim.apps.omise.createCoupon": task_omise_create_coupon,
        "xrpc.app.etzhayyim.apps.omise.createOrder": task_omise_create_order,
        "xrpc.app.etzhayyim.apps.omise.createProduct": task_omise_create_product,
        "xrpc.app.etzhayyim.apps.omise.createShipment": task_omise_create_shipment,
        "xrpc.app.etzhayyim.apps.omise.deactivateCoupon": task_omise_deactivate_coupon,
        "xrpc.app.etzhayyim.apps.omise.getCart": task_omise_get_cart,
        "xrpc.app.etzhayyim.apps.omise.getOrder": task_omise_get_order,
        "xrpc.app.etzhayyim.apps.omise.getProduct": task_omise_get_product,
        "xrpc.app.etzhayyim.apps.omise.getSellerBalance": task_omise_get_seller_balance,
        "xrpc.app.etzhayyim.apps.omise.getSellerProfile": task_omise_get_seller_profile,
        "xrpc.app.etzhayyim.apps.omise.getSellerRevenue": task_omise_get_seller_revenue,
        "xrpc.app.etzhayyim.apps.omise.getShipment": task_omise_get_shipment,
        "xrpc.app.etzhayyim.apps.omise.listCoupons": task_omise_list_coupons,
        "xrpc.app.etzhayyim.apps.omise.listOrders": task_omise_list_orders,
        "xrpc.app.etzhayyim.apps.omise.listPendingSellers": task_omise_list_pending_sellers,
        "xrpc.app.etzhayyim.apps.omise.listReviews": task_omise_list_reviews,
        "xrpc.app.etzhayyim.apps.omise.listSellerOrders": task_omise_list_seller_orders,
        "xrpc.app.etzhayyim.apps.omise.listSellerProducts": task_omise_list_seller_products,
        "xrpc.app.etzhayyim.apps.omise.listSellers": task_omise_list_sellers,
        "xrpc.app.etzhayyim.apps.omise.listSettlements": task_omise_list_settlements,
        "xrpc.app.etzhayyim.apps.omise.listShipments": task_omise_list_shipments,
        "xrpc.app.etzhayyim.apps.omise.markReadyToShip": task_omise_mark_ready_to_ship,
        "xrpc.app.etzhayyim.apps.omise.platformAnalytics": task_omise_platform_analytics,
        "xrpc.app.etzhayyim.apps.omise.registerSeller": task_omise_register_seller,
        "xrpc.app.etzhayyim.apps.omise.rejectOrder": task_omise_reject_order,
        "xrpc.app.etzhayyim.apps.omise.removeFromCart": task_omise_remove_from_cart,
        "xrpc.app.etzhayyim.apps.omise.requestPayout": task_omise_request_payout,
        "xrpc.app.etzhayyim.apps.omise.requestPickup": task_omise_request_pickup,
        "xrpc.app.etzhayyim.apps.omise.resolveDispute": task_omise_resolve_dispute,
        "xrpc.app.etzhayyim.apps.omise.searchProducts": task_omise_search_products,
        "xrpc.app.etzhayyim.apps.omise.submitReview": task_omise_submit_review,
        "xrpc.app.etzhayyim.apps.omise.suspendSeller": task_omise_suspend_seller,
        "xrpc.app.etzhayyim.apps.omise.updateInventory": task_omise_update_inventory,
        "xrpc.app.etzhayyim.apps.omise.updateProduct": task_omise_update_product,
        "xrpc.app.etzhayyim.apps.omise.updateSellerProfile": task_omise_update_seller_profile,
        "xrpc.app.etzhayyim.apps.omise.updateShipmentStatus": task_omise_update_shipment_status,
    }
