"""BRN Government states actor primitives.

This module moves the `did:web:brn-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:brn-state.etzhayyim.com"
DOMAIN_CODE = "brn"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Jabatan Perdana Menteri","nameEn":"Prime Minister's Office","website":"https://www.pmo.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"defence","name":"Kementerian Pertahanan","nameEn":"Ministry of Defence","website":"https://www.mindef.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"finance","name":"Kementerian Kewangan","nameEn":"Ministry of Finance","website":"https://www.finance.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Kementerian Hal Ehwal Luar Negeri","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"home-affairs","name":"Kementerian Hal Ehwal Dalam Negeri","nameEn":"Ministry of Home Affairs","website":"https://www.home-affairs.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"education","name":"Kementerian Pendidikan","nameEn":"Ministry of Education","website":"https://www.moe.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Kementerian Kesihatan","nameEn":"Ministry of Health","website":"https://www.moh.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"development","name":"Kementerian Pembangunan","nameEn":"Ministry of Development","website":"https://www.mod.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:04.5","infrastructure","development"],"orgTier":"ministry"}
{"path":"culture-youth-sports","name":"Kementerian Kebudayaan, Belia dan Sukan","nameEn":"Ministry of Culture, Youth and Sports","website":"https://www.mcys.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:08","culture","youth","sports"],"orgTier":"ministry"}
{"path":"energy","name":"Kementerian Tenaga","nameEn":"Ministry of Energy","website":"https://www.energy.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:04.4","energy","natural-resources"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"dist:brunei-muara","name":"Daerah Brunei dan Muara","nameEn":"Brunei-Muara District","website":"https://www.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01","district","capital-district"],"orgTier":"state"}
{"path":"dist:belait","name":"Daerah Belait","nameEn":"Belait District","website":"https://www.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01","district","oil-region"],"orgTier":"state"}
{"path":"dist:tutong","name":"Daerah Tutong","nameEn":"Tutong District","website":"https://www.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:temburong","name":"Daerah Temburong","nameEn":"Temburong District","website":"https://www.gov.bn/","contract":"Constitution of Brunei 1959","tags":["cofog:01","district","exclave"],"orgTier":"state"}
"""
...
def task_gov_brn_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_brn_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_brn_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_brn_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_brn_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_brn_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_brn_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_brn_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_brn_seed_orgs, seedLimit)
    register = await task_gov_brn_register_dids(registerLimit)
    follow = await task_gov_brn_follow_site_deps(followLimit)
    ingest = await task_gov_brn_sync_wet_updates(ingestLimit)
    shinka = await task_gov_brn_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brn_heartbeat_tick)
