...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govCan.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govCan.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
