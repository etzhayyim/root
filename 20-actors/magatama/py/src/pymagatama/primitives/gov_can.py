"""CAN Government states actor primitives.

This module moves the `did:web:can-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:can-state.etzhayyim.com"
DOMAIN_CODE = "can"
...
_MINISTRY_NDJSON = """\
{"path":"pco","name":"Privy Council Office","nameEn":"Privy Council Office / Prime Minister's Office","website":"https://www.canada.ca/en/privy-council/","contract":"Constitution Act 1867","tags":["cofog:01","executive","prime-minister","pmo"],"orgTier":"ministry"}
{"path":"dnd","name":"Department of National Defence","nameEn":"Department of National Defence","website":"https://www.canada.ca/en/department-national-defence/","contract":"National Defence Act RSC 1985","tags":["cofog:02","defence","military","caf"],"orgTier":"ministry"}
{"path":"gac","name":"Global Affairs Canada","nameEn":"Global Affairs Canada","website":"https://www.international.gc.ca/","contract":"Department of Foreign Affairs Act RSC 1985","tags":["cofog:01.2","foreign-affairs","diplomacy","trade"],"orgTier":"ministry"}
{"path":"fin","name":"Department of Finance Canada","nameEn":"Department of Finance Canada","website":"https://www.canada.ca/en/department-finance/","contract":"Financial Administration Act RSC 1985","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"jus","name":"Department of Justice Canada","nameEn":"Department of Justice Canada","website":"https://www.justice.gc.ca/","contract":"Department of Justice Act RSC 1985","tags":["cofog:03","justice","law","courts"],"orgTier":"ministry"}
{"path":"ps","name":"Public Safety Canada","nameEn":"Public Safety Canada","website":"https://www.publicsafety.gc.ca/","contract":"Department of Public Safety Act 2005","tags":["cofog:03","public-safety","police","rcmp"],"orgTier":"ministry"}
{"path":"hc","name":"Health Canada","nameEn":"Health Canada","website":"https://www.canada.ca/en/health-canada/","contract":"Department of Health Act 1996","tags":["cofog:07","health","pharmaceuticals"],"orgTier":"ministry"}
{"path":"esdc","name":"Employment and Social Development Canada","nameEn":"Employment and Social Development Canada","website":"https://www.canada.ca/en/employment-social-development/","contract":"Department of Employment Act 1996","tags":["cofog:04","employment","social","labour"],"orgTier":"ministry"}
{"path":"eccc","name":"Environment and Climate Change Canada","nameEn":"Environment and Climate Change Canada","website":"https://www.canada.ca/en/environment-climate-change/","contract":"Department of the Environment Act RSC 1985","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
{"path":"aafc","name":"Agriculture and Agri-Food Canada","nameEn":"Agriculture and Agri-Food Canada","website":"https://agriculture.canada.ca/","contract":"Department of Agriculture Act RSC 1985","tags":["cofog:04.2","agriculture","food"],"orgTier":"ministry"}
{"path":"ised","name":"Innovation, Science and Economic Development Canada","nameEn":"Innovation, Science and Economic Development Canada","website":"https://ised-isde.canada.ca/","contract":"Department of Industry Act 1995","tags":["cofog:04","innovation","science","industry","digital"],"orgTier":"ministry"}
{"path":"tc","name":"Transport Canada","nameEn":"Transport Canada","website":"https://tc.canada.ca/","contract":"Department of Transport Act RSC 1985","tags":["cofog:04.5","transport","aviation","infrastructure"],"orgTier":"ministry"}
{"path":"hoc","name":"House of Commons","nameEn":"House of Commons of Canada","website":"https://www.ourcommons.ca/","contract":"Constitution Act 1867 s.37","tags":["cofog:01","legislature","lower-house"],"orgTier":"agency"}
{"path":"sen","name":"Senate of Canada","nameEn":"Senate of Canada","website":"https://sencanada.ca/","contract":"Constitution Act 1867 s.21","tags":["cofog:01","legislature","upper-house"],"orgTier":"agency"}
{"path":"scc","name":"Supreme Court of Canada","nameEn":"Supreme Court of Canada","website":"https://www.scc-csc.ca/","contract":"Supreme Court Act RSC 1985","tags":["cofog:03","judiciary","supreme-court"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"province:ab","name":"Alberta","nameEn":"Alberta","website":"https://www.alberta.ca/","contract":"Constitution Act 1867 s.92","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"province:bc","name":"British Columbia","nameEn":"British Columbia","website":"https://www2.gov.bc.ca/","contract":"Constitution Act 1867 s.92","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"province:mb","name":"Manitoba","nameEn":"Manitoba","website":"https://www.gov.mb.ca/","contract":"Manitoba Act 1870","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"province:nb","name":"New Brunswick / Nouveau-Brunswick","nameEn":"New Brunswick","website":"https://www2.gnb.ca/","contract":"Constitution Act 1867 s.92","tags":["cofog:01","province","l5","bilingual"],"orgTier":"state"}
{"path":"province:nl","name":"Newfoundland and Labrador","nameEn":"Newfoundland and Labrador","website":"https://www.gov.nl.ca/","contract":"Terms of Union 1949","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"province:ns","name":"Nova Scotia","nameEn":"Nova Scotia","website":"https://novascotia.ca/","contract":"Constitution Act 1867 s.92","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"province:on","name":"Ontario","nameEn":"Ontario","website":"https://www.ontario.ca/","contract":"Constitution Act 1867 s.92","tags":["cofog:01","province","l5","largest"],"orgTier":"state"}
{"path":"province:pe","name":"Prince Edward Island","nameEn":"Prince Edward Island","website":"https://www.princeedwardisland.ca/","contract":"PEI Terms of Union 1873","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"province:qc","name":"Québec","nameEn":"Quebec","website":"https://www.quebec.ca/","contract":"Constitution Act 1867 s.92","tags":["cofog:01","province","l5","french"],"orgTier":"state"}
{"path":"province:sk","name":"Saskatchewan","nameEn":"Saskatchewan","website":"https://www.saskatchewan.ca/","contract":"Saskatchewan Act 1905","tags":["cofog:01","province","l5"],"orgTier":"state"}
{"path":"territory:nt","name":"Northwest Territories","nameEn":"Northwest Territories","website":"https://www.gov.nt.ca/","contract":"Northwest Territories Act RSC 1985","tags":["cofog:01","territory","l5","north"],"orgTier":"state"}
{"path":"territory:nu","name":"Nunavut","nameEn":"Nunavut","website":"https://www.gov.nu.ca/","contract":"Nunavut Act 1993","tags":["cofog:01","territory","l5","inuit","north"],"orgTier":"state"}
{"path":"territory:yt","name":"Yukon","nameEn":"Yukon","website":"https://yukon.ca/","contract":"Yukon Act 2002","tags":["cofog:01","territory","l5","north"],"orgTier":"state"}
"""
...
def task_gov_can_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_can_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_can_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_can_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_can_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_can_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_can_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_can_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_can_seed_orgs, seedLimit)
    register = await task_gov_can_register_dids(registerLimit)
    follow = await task_gov_can_follow_site_deps(followLimit)
    ingest = await task_gov_can_sync_wet_updates(ingestLimit)
    shinka = await task_gov_can_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCan.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_can_heartbeat_tick)
