"""URY Government states actor primitives.

This module moves the `did:web:ury-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:ury-state.etzhayyim.com"
DOMAIN_CODE = "ury"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gub.uy/", "contract": "Constitución 1967 Art. 149-172", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defensa", "name": "Ministerio de Defensa Nacional", "nameEn": "Ministry of National Defence", "website": "https://www.mdn.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "economia", "name": "Ministerio de Economía y Finanzas", "nameEn": "Ministry of Economy and Finance", "website": "https://www.mef.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.gub.uy/ministerio-relaciones-exteriores/", "contract": "Constitución 1967", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "interior", "name": "Ministerio del Interior", "nameEn": "Ministry of Interior", "website": "https://www.minterior.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "justicia", "name": "Ministerio de Justicia", "nameEn": "Ministry of Justice", "website": "https://www.gub.uy/ministerio-justicia/", "contract": "Constitución 1967", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación y Cultura", "nameEn": "Ministry of Education and Culture", "website": "https://www.mec.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud Pública", "nameEn": "Ministry of Public Health", "website": "https://www.gub.uy/ministerio-salud-publica/", "contract": "Constitución 1967", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio de Ganadería, Agricultura y Pesca", "nameEn": "Ministry of Livestock, Agriculture and Fisheries", "website": "https://www.mgap.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "industria", "name": "Ministerio de Industria, Energía y Minería", "nameEn": "Ministry of Industry, Energy and Mining", "website": "https://www.miem.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Ministerio de Trabajo y Seguridad Social", "nameEn": "Ministry of Labour and Social Security", "website": "https://www.mtss.gub.uy/", "contract": "Constitución 1967", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "dept:artigas", "name": "Departamento de Artigas", "nameEn": "Department of Artigas", "website": "https://www.artigas.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:canelones", "name": "Departamento de Canelones", "nameEn": "Department of Canelones", "website": "https://www.canelones.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:cerro-largo", "name": "Departamento de Cerro Largo", "nameEn": "Department of Cerro Largo", "website": "https://www.cerrolargo.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:colonia", "name": "Departamento de Colonia", "nameEn": "Department of Colonia", "website": "https://www.colonia.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:durazno", "name": "Departamento de Durazno", "nameEn": "Department of Durazno", "website": "https://www.durazno.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:flores", "name": "Departamento de Flores", "nameEn": "Department of Flores", "website": "https://www.flores.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:florida", "name": "Departamento de Florida", "nameEn": "Department of Florida", "website": "https://www.florida.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:lavalleja", "name": "Departamento de Lavalleja", "nameEn": "Department of Lavalleja", "website": "https://www.lavalleja.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:maldonado", "name": "Departamento de Maldonado", "nameEn": "Department of Maldonado", "website": "https://www.maldonado.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:montevideo", "name": "Departamento de Montevideo", "nameEn": "Department of Montevideo", "website": "https://www.montevideo.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:paysandu", "name": "Departamento de Paysandú", "nameEn": "Department of Paysandú", "website": "https://www.paysandu.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:rio-negro", "name": "Departamento de Río Negro", "nameEn": "Department of Río Negro", "website": "https://www.rionegro.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:rivera", "name": "Departamento de Rivera", "nameEn": "Department of Rivera", "website": "https://www.rivera.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:rocha", "name": "Departamento de Rocha", "nameEn": "Department of Rocha", "website": "https://www.rocha.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:salto", "name": "Departamento de Salto", "nameEn": "Department of Salto", "website": "https://www.salto.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:san-jose", "name": "Departamento de San José", "nameEn": "Department of San José", "website": "https://www.sanjose.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:soriano", "name": "Departamento de Soriano", "nameEn": "Department of Soriano", "website": "https://www.soriano.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:tacuarembo", "name": "Departamento de Tacuarembó", "nameEn": "Department of Tacuarembó", "website": "https://www.tacuarembo.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:treinta-y-tres", "name": "Departamento de Treinta y Tres", "nameEn": "Department of Treinta y Tres", "website": "https://www.treintaytres.gub.uy/", "contract": "Constitución 1967 Art. 262-288", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_ury_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_ury_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_ury_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_ury_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_ury_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_ury_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_ury_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_ury_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_ury_seed_orgs, seedLimit)
    register = await task_gov_ury_register_dids(registerLimit)
    follow = await task_gov_ury_follow_site_deps(followLimit)
    ingest = await task_gov_ury_sync_wet_updates(ingestLimit)
    shinka = await task_gov_ury_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUry.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ury_heartbeat_tick)
