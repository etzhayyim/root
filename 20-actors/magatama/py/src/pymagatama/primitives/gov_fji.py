"""FJI Government states actor primitives.

This module moves the `did:web:fji-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:fji-state.etzhayyim.com"
DOMAIN_CODE = "fji"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Office of the Prime Minister","nameEn":"Office of the Prime Minister","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"defence-policing","name":"Ministry for Defence, Policing and National Security","nameEn":"Ministry for Defence, Policing and National Security","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:02","defence","police"],"orgTier":"ministry"}
{"path":"economy","name":"Ministry of Finance and Economy","nameEn":"Ministry of Finance and Economy","website":"https://www.fiji.gov.fj/economy","contract":"Constitution of Fiji 2013","tags":["cofog:01.1","finance","economy"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry for Foreign Affairs and International Cooperation","nameEn":"Ministry for Foreign Affairs and International Cooperation","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justice","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"home-affairs","name":"Ministry for Home Affairs and Immigration","nameEn":"Ministry for Home Affairs and Immigration","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:03","interior","immigration"],"orgTier":"ministry"}
{"path":"education","name":"Ministry for Education, Heritage and Arts","nameEn":"Ministry for Education, Heritage and Arts","website":"https://www.education.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:09","education","heritage"],"orgTier":"ministry"}
{"path":"health","name":"Ministry for Health and Medical Services","nameEn":"Ministry for Health and Medical Services","website":"https://www.health.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry for Agriculture and Waterways","nameEn":"Ministry for Agriculture and Waterways","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"infrastructure","name":"Ministry for Infrastructure and Meteorological Services","nameEn":"Ministry for Infrastructure and Meteorological Services","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:04.5","infrastructure","transport"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry for Environment and Climate Change","nameEn":"Ministry for Environment and Climate Change","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
{"path":"itlottery","name":"Ministry for iTaukei Affairs and Multi-Ethnic Affairs","nameEn":"Ministry for iTaukei Affairs and Multi-Ethnic Affairs","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","indigenous-affairs","multi-ethnic"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"div:central","name":"Central Division","nameEn":"Central Division","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","division","suva"],"orgTier":"state"}
{"path":"div:eastern","name":"Eastern Division","nameEn":"Eastern Division","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","division","islands"],"orgTier":"state"}
{"path":"div:northern","name":"Northern Division","nameEn":"Northern Division","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","division"],"orgTier":"state"}
{"path":"div:western","name":"Western Division","nameEn":"Western Division","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","division","lautoka"],"orgTier":"state"}
{"path":"div:rotuma","name":"Rotuma Island Council","nameEn":"Rotuma Island Council","website":"https://www.fiji.gov.fj/","contract":"Constitution of Fiji 2013","tags":["cofog:01","island","special-administration"],"orgTier":"state"}
"""
...
def task_gov_fji_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_fji_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_fji_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_fji_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_fji_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_fji_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_fji_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_fji_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_fji_seed_orgs, seedLimit)
    register = await task_gov_fji_register_dids(registerLimit)
    follow = await task_gov_fji_follow_site_deps(followLimit)
    ingest = await task_gov_fji_sync_wet_updates(ingestLimit)
    shinka = await task_gov_fji_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFji.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fji_heartbeat_tick)
