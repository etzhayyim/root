...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govCub.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cub_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govCub.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
