...
def _collection(name: str) -> str:
    return f"ai.gftd.apps.kenkyusha.{name}"
...
def register(worker: Any, *, timeout_ms: int = 60_000) -> None:
    tasks = {
        "xrpc.ai.gftd.apps.kenkyusha.collectEvidence": task_kenkyusha_collect_evidence,
        "xrpc.ai.gftd.apps.kenkyusha.coverageMap": task_kenkyusha_coverage_map,
        "xrpc.ai.gftd.apps.kenkyusha.detectFrontiers": task_kenkyusha_detect_frontiers,
        "xrpc.ai.gftd.apps.kenkyusha.evaluateHypothesis": task_kenkyusha_evaluate_hypothesis,
        "xrpc.ai.gftd.apps.kenkyusha.generateHypothesis": task_kenkyusha_generate_hypothesis,
        "xrpc.ai.gftd.apps.kenkyusha.getFrontier": task_kenkyusha_get_frontier,
        "xrpc.ai.gftd.apps.kenkyusha.listDisciplines": task_kenkyusha_list_disciplines,
        "xrpc.ai.gftd.apps.kenkyusha.listFrontiers": task_kenkyusha_list_frontiers,
        "xrpc.ai.gftd.apps.kenkyusha.registerDids": task_kenkyusha_register_dids,
        "xrpc.ai.gftd.apps.kenkyusha.searchEvidence": task_kenkyusha_search_evidence,
        "xrpc.ai.gftd.apps.kenkyusha.seedDisciplines": task_kenkyusha_seed_disciplines,
        "xrpc.ai.gftd.apps.kenkyusha.stats": task_kenkyusha_stats,
    }
