"""ATG Government states actor primitives.

This module moves the `did:web:atg-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:atg-state.etzhayyim.com"
DOMAIN_CODE = "atg"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Office of the Prime Minister","nameEn":"Office of the Prime Minister","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:01","executive","prime-minister","caricom"],"orgTier":"ministry"}
{"path":"national-security-labour","name":"Ministry of National Security, Labour and Immigration","nameEn":"Ministry of National Security, Labour and Immigration","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:02","defence","security","labour"],"orgTier":"ministry"}
{"path":"finance","name":"Ministry of Finance and Corporate Governance","nameEn":"Ministry of Finance and Corporate Governance","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs and International Trade","nameEn":"Ministry of Foreign Affairs and International Trade","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:01.2","foreign-affairs","trade"],"orgTier":"ministry"}
{"path":"justice-legal-affairs","name":"Ministry of Justice and Legal Affairs","nameEn":"Ministry of Justice and Legal Affairs","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Education, Science and Technology","nameEn":"Ministry of Education","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Ministry of Health, Wellness and the Environment","nameEn":"Ministry of Health","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture, Fisheries and Barbuda Affairs","nameEn":"Ministry of Agriculture","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:04.2","agriculture","fisheries"],"orgTier":"ministry"}
{"path":"tourism","name":"Ministry of Tourism, Aviation and Transportation","nameEn":"Ministry of Tourism","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:04","tourism","aviation"],"orgTier":"ministry"}
{"path":"public-utilities","name":"Ministry of Public Utilities","nameEn":"Ministry of Public Utilities","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:04.4","utilities","energy"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment","nameEn":"Ministry of Environment","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:05","environment"],"orgTier":"ministry"}
{"path":"social-transformation","name":"Ministry of Social Transformation","nameEn":"Ministry of Social Transformation","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:01","social"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"island:antigua","name":"Antigua","nameEn":"Antigua Island","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:01","island","main-island"],"orgTier":"state"}
{"path":"island:barbuda","name":"Barbuda","nameEn":"Barbuda Island","website":"https://www.ab.gov.ag/","contract":"Constitution of Antigua and Barbuda 1981","tags":["cofog:01","island","coral-island"],"orgTier":"state"}
"""
...
def task_gov_atg_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_atg_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_atg_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_atg_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_atg_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_atg_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_atg_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_atg_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_atg_seed_orgs, seedLimit)
    register = await task_gov_atg_register_dids(registerLimit)
    follow = await task_gov_atg_follow_site_deps(followLimit)
    ingest = await task_gov_atg_sync_wet_updates(ingestLimit)
    shinka = await task_gov_atg_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAtg.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_heartbeat_tick)
