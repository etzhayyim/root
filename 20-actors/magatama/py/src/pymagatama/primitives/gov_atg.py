...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_atg_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govAtg.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
