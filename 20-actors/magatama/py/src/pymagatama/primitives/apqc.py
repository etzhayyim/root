...
Pregel implementation: pymagatama.langgraph_graphs.apqc_pregel (build_graph())
...
from pymagatama.langgraph_graphs.apqc_pregel import (
...
async def task_apqc_emit_event(
    ...
    vertex_id = f"at://{PROJECTOR_DID}/ai.gftd.apps.apqc.apqcEvent/{event_id}"
