...
This module moves the `did:web:esp-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:esp-state.gftd.ai"
DOMAIN_CODE = "esp"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govEsp.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
