...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_esp_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEsp.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
