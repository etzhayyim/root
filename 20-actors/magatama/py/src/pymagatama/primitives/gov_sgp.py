"""SGP Government states actor primitives.

This module moves the `did:web:sgp-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:sgp-state.etzhayyim.com"
DOMAIN_CODE = "sgp"
...
_MINISTRY_NDJSON = """\
{"path":"pmo","name":"Prime Minister's Office","nameEn":"Prime Minister's Office","website":"https://www.pmo.gov.sg/","contract":"Constitution of Singapore 1965 Art. 24","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mfa","name":"Ministry of Foreign Affairs","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mindef","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://www.mindef.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Ministry of Finance","nameEn":"Ministry of Finance","website":"https://www.mof.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"minlaw","name":"Ministry of Law","nameEn":"Ministry of Law","website":"https://www.mlaw.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:03","justice","law"],"orgTier":"ministry"}
{"path":"mha","name":"Ministry of Home Affairs","nameEn":"Ministry of Home Affairs","website":"https://www.mha.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://www.moe.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.moh.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mom","name":"Ministry of Manpower","nameEn":"Ministry of Manpower","website":"https://www.mom.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:04","labour","manpower"],"orgTier":"ministry"}
{"path":"mti","name":"Ministry of Trade and Industry","nameEn":"Ministry of Trade and Industry","website":"https://www.mti.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:04","trade","industry"],"orgTier":"ministry"}
{"path":"mewr","name":"Ministry of Sustainability and the Environment","nameEn":"Ministry of Sustainability and the Environment","website":"https://www.mse.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:05","environment","sustainability"],"orgTier":"ministry"}
{"path":"mccy","name":"Ministry of Culture, Community and Youth","nameEn":"Ministry of Culture, Community and Youth","website":"https://www.mccy.gov.sg/","contract":"Constitution of Singapore 1965","tags":["cofog:08","culture","community","youth"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"cdc:central-singapore","name":"Central Singapore Community Development Council","nameEn":"Central Singapore CDC","website":"https://www.cdc.org.sg/central/","contract":"Community Development Councils Act","tags":["cofog:01","cdc","community"],"orgTier":"state"}
{"path":"cdc:northwest","name":"North West Community Development Council","nameEn":"North West CDC","website":"https://www.cdc.org.sg/northwest/","contract":"Community Development Councils Act","tags":["cofog:01","cdc","community"],"orgTier":"state"}
{"path":"cdc:northeast","name":"North East Community Development Council","nameEn":"North East CDC","website":"https://www.cdc.org.sg/northeast/","contract":"Community Development Councils Act","tags":["cofog:01","cdc","community"],"orgTier":"state"}
{"path":"cdc:southeast","name":"South East Community Development Council","nameEn":"South East CDC","website":"https://www.cdc.org.sg/southeast/","contract":"Community Development Councils Act","tags":["cofog:01","cdc","community"],"orgTier":"state"}
{"path":"cdc:southwest","name":"South West Community Development Council","nameEn":"South West Community Development Council","website":"https://www.cdc.org.sg/southwest/","contract":"Community Development Councils Act","tags":["cofog:01","cdc","community"],"orgTier":"state"}
"""
...
def task_gov_sgp_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_sgp_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_sgp_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_sgp_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_sgp_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_sgp_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_sgp_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_sgp_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_sgp_seed_orgs, seedLimit)
    register = await task_gov_sgp_register_dids(registerLimit)
    follow = await task_gov_sgp_follow_site_deps(followLimit)
    ingest = await task_gov_sgp_sync_wet_updates(ingestLimit)
    shinka = await task_gov_sgp_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSgp.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sgp_heartbeat_tick)
