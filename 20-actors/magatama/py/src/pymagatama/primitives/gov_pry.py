...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPry.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
