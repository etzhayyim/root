...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govPry.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govPry.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
