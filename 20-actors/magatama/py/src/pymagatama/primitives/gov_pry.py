"""PRY Government states actor primitives.

This module moves the `did:web:pry-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:pry-state.etzhayyim.com"
DOMAIN_CODE = "pry"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gov.py/", "contract": "Constitución 1992 Art. 226-238", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defensa", "name": "Ministerio de Defensa Nacional", "nameEn": "Ministry of National Defence", "website": "https://www.mdn.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "hacienda", "name": "Ministerio de Hacienda", "nameEn": "Ministry of Finance", "website": "https://www.hacienda.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.mre.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "justicia", "name": "Ministerio de Justicia", "nameEn": "Ministry of Justice", "website": "https://www.mj.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "interior", "name": "Ministerio del Interior", "nameEn": "Ministry of Interior", "website": "https://www.mdi.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación y Ciencias", "nameEn": "Ministry of Education and Science", "website": "https://www.mec.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud Pública y Bienestar Social", "nameEn": "Ministry of Public Health and Social Welfare", "website": "https://www.mspbs.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio de Agricultura y Ganadería", "nameEn": "Ministry of Agriculture and Livestock", "website": "https://www.mag.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "industria", "name": "Ministerio de Industria y Comercio", "nameEn": "Ministry of Industry and Commerce", "website": "https://www.mic.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Ministerio de Trabajo, Empleo y Seguridad Social", "nameEn": "Ministry of Labour, Employment and Social Security", "website": "https://www.mtess.gov.py/", "contract": "Constitución 1992", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "dept:alto-paraguay", "name": "Departamento de Alto Paraguay", "nameEn": "Department of Alto Paraguay", "website": "https://www.altoparaguay.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:alto-parana", "name": "Departamento de Alto Paraná", "nameEn": "Department of Alto Paraná", "website": "https://www.altoparana.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:amambay", "name": "Departamento de Amambay", "nameEn": "Department of Amambay", "website": "https://www.amambay.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:boqueron", "name": "Departamento de Boquerón", "nameEn": "Department of Boquerón", "website": "https://www.boqueron.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:caaguazu", "name": "Departamento de Caaguazú", "nameEn": "Department of Caaguazú", "website": "https://www.caaguazu.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:caazapa", "name": "Departamento de Caazapá", "nameEn": "Department of Caazapá", "website": "https://www.caazapa.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:canindeyu", "name": "Departamento de Canindeyú", "nameEn": "Department of Canindeyú", "website": "https://www.canindeyu.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:central", "name": "Departamento Central", "nameEn": "Central Department", "website": "https://www.central.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:concepcion", "name": "Departamento de Concepción", "nameEn": "Department of Concepción", "website": "https://www.concepcion.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:cordillera", "name": "Departamento de Cordillera", "nameEn": "Department of Cordillera", "website": "https://www.cordillera.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:guaira", "name": "Departamento de Guairá", "nameEn": "Department of Guairá", "website": "https://www.guaira.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:itapua", "name": "Departamento de Itapúa", "nameEn": "Department of Itapúa", "website": "https://www.itapua.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:misiones", "name": "Departamento de Misiones", "nameEn": "Department of Misiones", "website": "https://www.misiones.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:neembucu", "name": "Departamento de Ñeembucú", "nameEn": "Department of Ñeembucú", "website": "https://www.neembucu.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:paraguari", "name": "Departamento de Paraguarí", "nameEn": "Department of Paraguarí", "website": "https://www.paraguari.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:presidente-hayes", "name": "Departamento de Presidente Hayes", "nameEn": "Department of Presidente Hayes", "website": "https://www.presidentehayes.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:san-pedro", "name": "Departamento de San Pedro", "nameEn": "Department of San Pedro", "website": "https://www.sanpedro.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "capital:asuncion", "name": "Capital Asunción", "nameEn": "Capital Asunción", "website": "https://www.asuncion.gov.py/", "contract": "Constitución 1992 Art. 161-171", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: Multi-predicate fetch translated to single predicate fetch
...
def task_gov_pry_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: Multi-predicate fetch replaced by single predicate domain_code and in-memory filter
...
def task_gov_pry_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_pry_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: Multi-predicate fetch replaced by single predicate domain_code and in-memory filter/sort
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [
        r for r in all_rows
        if r.get("owner_did") == PRIMARY_DID and r.get("name_en") and (not org_tier or r.get("org_tier") == org_tier)
    ]
...
async def task_gov_pry_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_pry_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_pry_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    filtered = [
        r for r in all_rows
        if r.get("owner_did") == PRIMARY_DID and r.get("site_domain_slug") and (not r.get("last_ingested_at") or str(r.get("last_ingested_at")) < cutoff_iso)
    ]
    ...
    for r in rows:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: Single predicate fetch, in-memory sort
...
async def task_gov_pry_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_pry_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_pry_seed_orgs, seedLimit)
    register = await task_gov_pry_register_dids(registerLimit)
    follow = await task_gov_pry_follow_site_deps(followLimit)
    ingest = await task_gov_pry_sync_wet_updates(ingestLimit)
    shinka = await task_gov_pry_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPry.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pry_heartbeat_tick)
