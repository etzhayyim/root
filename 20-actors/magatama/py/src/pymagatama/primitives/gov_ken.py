"""KEN Government states actor primitives.

This module moves the `did:web:ken-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:ken-state.etzhayyim.com"
DOMAIN_CODE = "ken"
...
_MINISTRY_NDJSON = """\
{"path":"state-house","name":"State House","nameEn":"Office of the President","website":"https://www.president.go.ke/","contract":"Constitution of Kenya 2010 Art. 131","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"mfa","name":"Ministry of Foreign Affairs","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://www.mod.go.ke/","contract":"Constitution of Kenya 2010 Art. 241","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"nattreasury","name":"National Treasury and Planning","nameEn":"National Treasury and Planning","website":"https://www.treasury.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:01.1","finance","planning","budget"],"orgTier":"ministry"}
{"path":"moj","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.justice.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Ministry of Interior and National Administration","nameEn":"Ministry of Interior and National Administration","website":"https://www.interior.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:03","interior","national-administration"],"orgTier":"ministry"}
{"path":"moe","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://www.education.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.health.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"labour","name":"Ministry of Labour and Social Protection","nameEn":"Ministry of Labour and Social Protection","website":"https://www.labour.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:04","labour","social-protection"],"orgTier":"ministry"}
{"path":"trade","name":"Ministry of Trade, Investments and Industry","nameEn":"Ministry of Trade, Investments and Industry","website":"https://www.trade.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:04","trade","investment","industry"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture and Livestock Development","nameEn":"Ministry of Agriculture and Livestock Development","website":"https://www.kilimo.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:04.2","agriculture","livestock"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment, Climate Change and Forestry","nameEn":"Ministry of Environment, Climate Change and Forestry","website":"https://www.environment.go.ke/","contract":"Constitution of Kenya 2010","tags":["cofog:05","environment","climate","forestry"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"county:nairobi","name":"Nairobi City County","nameEn":"Nairobi City County","website":"https://nairobi.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county","capital"],"orgTier":"state"}
{"path":"county:mombasa","name":"Mombasa County","nameEn":"Mombasa County","website":"https://mombasa.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county","port"],"orgTier":"state"}
{"path":"county:kisumu","name":"Kisumu County","nameEn":"Kisumu County","website":"https://kisumu.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:nakuru","name":"Nakuru County","nameEn":"Nakuru County","website":"https://nakuru.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:uasin-gishu","name":"Uasin Gishu County","nameEn":"Uasin Gishu County","website":"https://uasinguishu.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:kiambu","name":"Kiambu County","nameEn":"Kiambu County","website":"https://kiambu.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:nyeri","name":"Nyeri County","nameEn":"Nyeri County","website":"https://nyeri.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:machakos","name":"Machakos County","nameEn":"Machakos County","website":"https://machakos.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:kisii","name":"Kisii County","nameEn":"Kisii County","website":"https://kisii.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
{"path":"county:garissa","name":"Garissa County","nameEn":"Garissa County","website":"https://garissa.go.ke/","contract":"Constitution of Kenya 2010 Ch.11","tags":["cofog:01","county"],"orgTier":"state"}
"""
...
def task_gov_ken_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_ken_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_ken_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_ken_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_ken_follow_site_deps(limit: int = 15) -> dict[str, Any]:
    ...
    for r in rows:
        ...
        _insert_repo_record(
            ...
            _repo_rkey("follow", slug),
            {"$type": "app.bsky.graph.follow", "subject": f"did:web:site.etzhayyim.com:{slug}", "createdAt": _utc_now_iso()},
        )
        row = {
            "path": path,
            "name": str(r.get("name") or ""),
...
async def task_gov_ken_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_ken_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_ken_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_ken_seed_orgs, seedLimit)
    register = await task_gov_ken_register_dids(registerLimit)
    follow = await task_gov_ken_follow_site_deps(followLimit)
    ingest = await task_gov_ken_sync_wet_updates(ingestLimit)
    shinka = await task_gov_ken_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKen.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ken_heartbeat_tick)
