"""BLR Government states actor primitives.

This module moves the `did:web:blr-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:blr-state.etzhayyim.com"
DOMAIN_CODE = "blr"
...
_MINISTRY_NDJSON = """\
{"path":"presidential-administration","name":"Администрация Президента Республики Беларусь","nameEn":"Presidential Administration of the Republic of Belarus","website":"https://president.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defence","name":"Министерство обороны Республики Беларусь","nameEn":"Ministry of Defence of the Republic of Belarus","website":"https://www.mil.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"finance","name":"Министерство финансов Республики Беларусь","nameEn":"Ministry of Finance of the Republic of Belarus","website":"https://www.minfin.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Министерство иностранных дел Республики Беларусь","nameEn":"Ministry of Foreign Affairs of the Republic of Belarus","website":"https://mfa.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"justice","name":"Министерство юстиции Республики Беларусь","nameEn":"Ministry of Justice of the Republic of Belarus","website":"https://minjust.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Министерство внутренних дел Республики Беларусь","nameEn":"Ministry of Internal Affairs of the Republic of Belarus","website":"https://mvd.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"education","name":"Министерство образования Республики Беларусь","nameEn":"Ministry of Education of the Republic of Belarus","website":"https://edu.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Министерство здравоохранения Республики Беларусь","nameEn":"Ministry of Health of the Republic of Belarus","website":"https://minzdrav.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Министерство сельского хозяйства и продовольствия Республики Беларусь","nameEn":"Ministry of Agriculture and Food of the Republic of Belarus","website":"https://mshp.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:04.2","agriculture","food"],"orgTier":"ministry"}
{"path":"economy","name":"Министерство экономики Республики Беларусь","nameEn":"Ministry of Economy of the Republic of Belarus","website":"https://www.economy.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:04","economy"],"orgTier":"ministry"}
{"path":"energy","name":"Министерство энергетики Республики Беларусь","nameEn":"Ministry of Energy of the Republic of Belarus","website":"https://minenergo.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:04","energy"],"orgTier":"ministry"}
{"path":"transport","name":"Министерство транспорта и коммуникаций Республики Беларусь","nameEn":"Ministry of Transport and Communications of the Republic of Belarus","website":"https://mintrans.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:04.5","transport","communications"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"obl:brest","name":"Брестская область","nameEn":"Brest Oblast","website":"https://brest-region.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","oblast"],"orgTier":"state"}
{"path":"obl:gomel","name":"Гомельская область","nameEn":"Gomel Oblast","website":"https://www.gomel-region.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","oblast"],"orgTier":"state"}
{"path":"obl:grodno","name":"Гродненская область","nameEn":"Grodno Oblast","website":"https://www.region.grodno.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","oblast"],"orgTier":"state"}
{"path":"obl:minsk","name":"Минская область","nameEn":"Minsk Oblast","website":"https://minsk-region.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","oblast"],"orgTier":"state"}
{"path":"obl:mogilev","name":"Могилёвская область","nameEn":"Mogilev Oblast","website":"https://mogilev-region.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","oblast"],"orgTier":"state"}
{"path":"obl:vitebsk","name":"Витебская область","nameEn":"Vitebsk Oblast","website":"https://www.vitebsk-region.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","oblast"],"orgTier":"state"}
{"path":"obl:minsk-city","name":"г. Минск","nameEn":"Minsk City","website":"https://minsk.gov.by/","contract":"Constitution 1994 (amended 2022)","tags":["cofog:01","city","capital"],"orgTier":"state"}
"""
...
def task_gov_blr_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_blr_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_blr_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_blr_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_blr_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_blr_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_blr_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_blr_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_blr_seed_orgs, seedLimit)
    register = await task_gov_blr_register_dids(registerLimit)
    follow = await task_gov_blr_follow_site_deps(followLimit)
    ingest = await task_gov_blr_sync_wet_updates(ingestLimit)
    shinka = await task_gov_blr_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBlr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_blr_heartbeat_tick)
