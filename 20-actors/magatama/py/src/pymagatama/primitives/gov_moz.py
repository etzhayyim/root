...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govMoz.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
