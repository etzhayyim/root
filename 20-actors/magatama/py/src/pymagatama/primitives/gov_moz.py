"""MOZ Government states actor primitives.

This module moves the `did:web:moz-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:moz-state.etzhayyim.com"
DOMAIN_CODE = "moz"
...
_MINISTRY_NDJSON = """\
{"path":"presidencia","name":"Presidência da República","nameEn":"Presidency of the Republic","website":"https://www.presidencia.gov.mz/","contract":"Constituição 2004","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defesa","name":"Ministério da Defesa Nacional","nameEn":"Ministry of National Defence","website":"https://www.governo.gov.mz/","contract":"Constituição 2004","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"financas","name":"Ministério da Economia e Finanças","nameEn":"Ministry of Economy and Finance","website":"https://www.mef.gov.mz/","contract":"Constituição 2004","tags":["cofog:01.1","finance","economy","budget"],"orgTier":"ministry"}
{"path":"relacoes-exteriores","name":"Ministério dos Negócios Estrangeiros e Cooperação","nameEn":"Ministry of Foreign Affairs","website":"https://www.minec.gov.mz/","contract":"Constituição 2004","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justica","name":"Ministério da Justiça, Assuntos Constitucionais e Religiosos","nameEn":"Ministry of Justice","website":"https://www.minjus.gov.mz/","contract":"Constituição 2004","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Ministério do Interior","nameEn":"Ministry of the Interior","website":"https://www.mint.gov.mz/","contract":"Constituição 2004","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"educacao","name":"Ministério da Educação e Desenvolvimento Humano","nameEn":"Ministry of Education","website":"https://www.mined.gov.mz/","contract":"Constituição 2004","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"saude","name":"Ministério da Saúde","nameEn":"Ministry of Health","website":"https://www.misau.gov.mz/","contract":"Constituição 2004","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agricultura","name":"Ministério da Agricultura e Desenvolvimento Rural","nameEn":"Ministry of Agriculture","website":"https://www.masa.gov.mz/","contract":"Constituição 2004","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"mineral-resources","name":"Ministério dos Recursos Minerais e Energia","nameEn":"Ministry of Mineral Resources and Energy","website":"https://www.mireme.gov.mz/","contract":"Constituição 2004","tags":["cofog:04","mining","energy"],"orgTier":"ministry"}
{"path":"industria","name":"Ministério da Indústria e Comércio","nameEn":"Ministry of Industry and Commerce","website":"https://www.mic.gov.mz/","contract":"Constituição 2004","tags":["cofog:04","industry","commerce"],"orgTier":"ministry"}
{"path":"transportes","name":"Ministério dos Transportes e Comunicações","nameEn":"Ministry of Transport and Communications","website":"https://www.mtc.gov.mz/","contract":"Constituição 2004","tags":["cofog:04.5","transport","communications"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:cabo-delgado","name":"Cabo Delgado","nameEn":"Cabo Delgado Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:gaza","name":"Gaza","nameEn":"Gaza Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:inhambane","name":"Inhambane","nameEn":"Inhambane Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:manica","name":"Manica","nameEn":"Manica Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:maputo","name":"Maputo","nameEn":"Maputo Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:nampula","name":"Nampula","nameEn":"Nampula Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:niassa","name":"Niassa","nameEn":"Niassa Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:sofala","name":"Sofala","nameEn":"Sofala Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:tete","name":"Tete","nameEn":"Tete Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:zambezia","name":"Zambézia","nameEn":"Zambézia Province","website":"https://www.governo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:maputo-cidade","name":"Maputo Cidade","nameEn":"Maputo City Province","website":"https://www.cm-maputo.gov.mz/","contract":"Constituição 2004 Title XIV","tags":["cofog:01","province","capital"],"orgTier":"state"}
"""
...
def task_gov_moz_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_moz_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_moz_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_moz_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_moz_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_moz_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_moz_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_moz_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_moz_seed_orgs, seedLimit)
    register = await task_gov_moz_register_dids(registerLimit)
    follow = await task_gov_moz_follow_site_deps(followLimit)
    ingest = await task_gov_moz_sync_wet_updates(ingestLimit)
    shinka = await task_gov_moz_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMoz.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_moz_heartbeat_tick)
