...
This module moves the `did:web:tur-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:tur-state.gftd.ai"
DOMAIN_CODE = "tur"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govTur.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tur_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govTur.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
