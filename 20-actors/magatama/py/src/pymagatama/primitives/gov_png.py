...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govPng.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govPng.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
