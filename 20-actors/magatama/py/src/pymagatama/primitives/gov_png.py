"""PNG Government states actor primitives.

This module moves the `did:web:png-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:png-state.etzhayyim.com"
DOMAIN_CODE = "png"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Department of Prime Minister and NEC","nameEn":"Office of the Prime Minister","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"defence","name":"Department of Defence","nameEn":"Ministry of Defence","website":"https://www.defence.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:02","defence","pngdf"],"orgTier":"ministry"}
{"path":"treasury","name":"Department of Treasury","nameEn":"Department of Treasury","website":"https://www.treasury.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01.1","finance","treasury"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Department of Foreign Affairs","nameEn":"Department of Foreign Affairs","website":"https://www.foreignaffairs.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justice-attorney-general","name":"Department of Justice and Attorney General","nameEn":"Department of Justice and Attorney General","website":"https://www.justice.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"internal-security","name":"Department of Police","nameEn":"Department of Police","website":"https://www.police.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:03","police"],"orgTier":"ministry"}
{"path":"education","name":"Department of Education","nameEn":"Department of Education","website":"https://www.education.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Department of Health","nameEn":"Department of Health","website":"https://www.health.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture-livestock","name":"Department of Agriculture and Livestock","nameEn":"Department of Agriculture and Livestock","website":"https://www.agriculture.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:04.2","agriculture","livestock"],"orgTier":"ministry"}
{"path":"petroleum-energy","name":"Department of Petroleum and Energy","nameEn":"Department of Petroleum and Energy","website":"https://www.petroleum.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:04.4","energy","petroleum","lng"],"orgTier":"ministry"}
{"path":"mining","name":"Department of Mining","nameEn":"Department of Mining","website":"https://www.mining.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:04","mining","gold"],"orgTier":"ministry"}
{"path":"transport-infrastructure","name":"Department of Works and Implementation","nameEn":"Department of Works and Implementation","website":"https://www.works.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:04.5","transport","infrastructure"],"orgTier":"ministry"}
{"path":"environment-conservation","name":"Conservation and Environment Protection Authority","nameEn":"Conservation and Environment Protection Authority","website":"https://www.cepa.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:05","environment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:bougainville","name":"Autonomous Region of Bougainville","nameEn":"Autonomous Region of Bougainville","website":"https://www.abg.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","autonomous"],"orgTier":"state"}
{"path":"prov:central","name":"Central Province","nameEn":"Central Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:chimbu","name":"Chimbu Province","nameEn":"Chimbu Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands"],"orgTier":"state"}
{"path":"prov:east-new-britain","name":"East New Britain Province","nameEn":"East New Britain Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","island"],"orgTier":"state"}
{"path":"prov:east-sepik","name":"East Sepik Province","nameEn":"East Sepik Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:eastern-highlands","name":"Eastern Highlands Province","nameEn":"Eastern Highlands Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands"],"orgTier":"state"}
{"path":"prov:enga","name":"Enga Province","nameEn":"Enga Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands"],"orgTier":"state"}
{"path":"prov:gulf","name":"Gulf Province","nameEn":"Gulf Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:hela","name":"Hela Province","nameEn":"Hela Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands","lng"],"orgTier":"state"}
{"path":"prov:jiwaka","name":"Jiwaka Province","nameEn":"Jiwaka Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands"],"orgTier":"state"}
{"path":"prov:madang","name":"Madang Province","nameEn":"Madang Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:manus","name":"Manus Province","nameEn":"Manus Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","island"],"orgTier":"state"}
{"path":"prov:milne-bay","name":"Milne Bay Province","nameEn":"Milne Bay Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","island"],"orgTier":"state"}
{"path":"prov:morobe","name":"Morobe Province","nameEn":"Morobe Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","lae"],"orgTier":"state"}
{"path":"prov:ncd","name":"National Capital District","nameEn":"National Capital District (Port Moresby)","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","capital"],"orgTier":"state"}
{"path":"prov:new-ireland","name":"New Ireland Province","nameEn":"New Ireland Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","island"],"orgTier":"state"}
{"path":"prov:northern","name":"Northern Province","nameEn":"Northern Province (Oro)","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:sandaun","name":"Sandaun Province","nameEn":"Sandaun Province (West Sepik)","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:southern-highlands","name":"Southern Highlands Province","nameEn":"Southern Highlands Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands"],"orgTier":"state"}
{"path":"prov:western","name":"Western Province","nameEn":"Western Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:western-highlands","name":"Western Highlands Province","nameEn":"Western Highlands Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","highlands"],"orgTier":"state"}
{"path":"prov:west-new-britain","name":"West New Britain Province","nameEn":"West New Britain Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province","island"],"orgTier":"state"}
{"path":"prov:west-sepik","name":"West Sepik Province","nameEn":"West Sepik Province","website":"https://www.pm.gov.pg/","contract":"Constitution of Papua New Guinea 1975","tags":["cofog:01","province"],"orgTier":"state"}
"""
...
def task_gov_png_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_png_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_png_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_png_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_png_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_png_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_png_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_png_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_png_seed_orgs, seedLimit)
    register = await task_gov_png_register_dids(registerLimit)
    follow = await task_gov_png_follow_site_deps(followLimit)
    ingest = await task_gov_png_sync_wet_updates(ingestLimit)
    shinka = await task_gov_png_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPng.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_heartbeat_tick)
