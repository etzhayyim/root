...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_png_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPng.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
