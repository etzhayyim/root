"""LVA Government states actor primitives.

This module moves the `did:web:lva-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:lva-state.etzhayyim.com"
DOMAIN_CODE = "lva"
...
_MINISTRY_NDJSON = """\
{"path":"mk","name":"Ministru kabinets","nameEn":"Cabinet of Ministers","website":"https://www.mk.gov.lv/","contract":"Satversme Art. 56-59","tags":["cofog:01","executive","cabinet"],"orgTier":"ministry"}
{"path":"am","name":"Ārlietu ministrija","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.lv/","contract":"Satversme Art. 68","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"aizsm","name":"Aizsardzības ministrija","nameEn":"Ministry of Defence","website":"https://www.mod.gov.lv/","contract":"Satversme Art. 85","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"fm","name":"Finanšu ministrija","nameEn":"Ministry of Finance","website":"https://www.fm.gov.lv/","contract":"Satversme Art. 66","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"tm","name":"Tieslietu ministrija","nameEn":"Ministry of Justice","website":"https://www.tm.gov.lv/","contract":"Satversme Art. 83","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"iem","name":"Iekšlietu ministrija","nameEn":"Ministry of the Interior","website":"https://www.iem.gov.lv/","contract":"Satversme Art. 73","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"em","name":"Ekonomikas ministrija","nameEn":"Ministry of Economics","website":"https://www.em.gov.lv/","contract":"Satversme Art. 105","tags":["cofog:04","economy","industry","energy"],"orgTier":"ministry"}
{"path":"izm","name":"Izglītības un zinātnes ministrija","nameEn":"Ministry of Education and Science","website":"https://www.izm.gov.lv/","contract":"Satversme Art. 112","tags":["cofog:09","education","science","research"],"orgTier":"ministry"}
{"path":"vm","name":"Veselības ministrija","nameEn":"Ministry of Health","website":"https://www.vm.gov.lv/","contract":"Satversme Art. 111","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"lm","name":"Labklājības ministrija","nameEn":"Ministry of Welfare","website":"https://www.lm.gov.lv/","contract":"Satversme Art. 109","tags":["cofog:04","labour","social","welfare"],"orgTier":"ministry"}
{"path":"zm","name":"Zemkopības ministrija","nameEn":"Ministry of Agriculture","website":"https://www.zm.gov.lv/","contract":"Satversme Art. 104","tags":["cofog:04.2","agriculture","rural"],"orgTier":"ministry"}
{"path":"sam","name":"Satiksmes ministrija","nameEn":"Ministry of Transport","website":"https://www.sam.gov.lv/","contract":"Satversme Art. 74","tags":["cofog:04.5","transport","infrastructure"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:riga","name":"Rīgas plānošanas reģions","nameEn":"Riga Planning Region","website":"https://www.rpr.gov.lv/","contract":"Satversme Art. 101","tags":["cofog:01","planning-region"],"orgTier":"state"}
{"path":"region:vidzeme","name":"Vidzemes plānošanas reģions","nameEn":"Vidzeme Planning Region","website":"https://www.vidzeme.lv/","contract":"Satversme Art. 101","tags":["cofog:01","planning-region"],"orgTier":"state"}
{"path":"region:kurzeme","name":"Kurzemes plānošanas reģions","nameEn":"Kurzeme Planning Region","website":"https://www.kurzemesregions.lv/","contract":"Satversme Art. 101","tags":["cofog:01","planning-region"],"orgTier":"state"}
{"path":"region:zemgale","name":"Zemgales plānošanas reģions","nameEn":"Zemgale Planning Region","website":"https://www.zemgale.lv/","contract":"Satversme Art. 101","tags":["cofog:01","planning-region"],"orgTier":"state"}
{"path":"region:latgale","name":"Latgales plānošanas reģions","nameEn":"Latgale Planning Region","website":"https://www.latgale.lv/","contract":"Satversme Art. 101","tags":["cofog:01","planning-region","border-region"],"orgTier":"state"}
{"path":"novads:riga","name":"Rīgas valstspilsēta","nameEn":"Riga City","website":"https://www.riga.lv/","contract":"Satversme Art. 101","tags":["cofog:01","capital","city"],"orgTier":"state"}
{"path":"novads:daugavpils","name":"Daugavpils valstspilsēta","nameEn":"Daugavpils City","website":"https://www.daugavpils.lv/","contract":"Satversme Art. 101","tags":["cofog:01","city","latgale"],"orgTier":"state"}
{"path":"novads:jelgava","name":"Jelgavas valstspilsēta","nameEn":"Jelgava City","website":"https://www.jelgava.lv/","contract":"Satversme Art. 101","tags":["cofog:01","city","zemgale"],"orgTier":"state"}
{"path":"novads:jurmala","name":"Jūrmalas valstspilsēta","nameEn":"Jūrmala City","website":"https://www.jurmala.lv/","contract":"Satversme Art. 101","tags":["cofog:01","city","resort"],"orgTier":"state"}
"""
...
def task_gov_lva_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_lva_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_lva_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_lva_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_lva_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_lva_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_lva_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_lva_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_lva_seed_orgs, seedLimit)
    register = await task_gov_lva_register_dids(registerLimit)
    follow = await task_gov_lva_follow_site_deps(followLimit)
    ingest = await task_gov_lva_sync_wet_updates(ingestLimit)
    shinka = await task_gov_lva_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLva.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lva_heartbeat_tick)
