...
_DOMAINS: dict[str, dict[str, Any]] = {
    "kuruma": {
        ...
        "collection": "app.etzhayyim.apps.kuruma.model",
    ...
    "media_anime": {
        ...
        "collection": "app.etzhayyim.apps.media_anime.title",
    ...
    "media_gamers": {
        ...
        "collection": "app.etzhayyim.apps.media_gamers.title",
    ...
    "handotai": {
        ...
        "collection": "app.etzhayyim.apps.handotai.chip",
