"""TLS Government states actor primitives.

This module moves the `did:web:tls-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:tls-state.etzhayyim.com"
DOMAIN_CODE = "tls"
...
_MINISTRY_NDJSON = """\
{"path":"presidencia","name":"Presidência da República","nameEn":"Presidency of the Republic","website":"https://www.presidencia.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defesa","name":"Ministério da Defesa","nameEn":"Ministry of Defence","website":"https://www.mdn.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:02","defence","f-fdtl"],"orgTier":"ministry"}
{"path":"financas","name":"Ministério das Finanças","nameEn":"Ministry of Finance","website":"https://www.mof.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01.1","finance","petroleum-fund"],"orgTier":"ministry"}
{"path":"relacoes-exteriores","name":"Ministério dos Negócios Estrangeiros e Cooperação","nameEn":"Ministry of Foreign Affairs and Cooperation","website":"https://www.mnec.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justica","name":"Ministério da Justiça","nameEn":"Ministry of Justice","website":"https://www.mj.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Ministério do Interior","nameEn":"Ministry of Interior","website":"https://www.interior.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:03","interior","pntl"],"orgTier":"ministry"}
{"path":"educacao","name":"Ministério da Educação","nameEn":"Ministry of Education","website":"https://www.moe.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"saude","name":"Ministério da Saúde","nameEn":"Ministry of Health","website":"https://www.moh.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agricultura","name":"Ministério da Agricultura e Pescas","nameEn":"Ministry of Agriculture and Fisheries","website":"https://www.maf.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:04.2","agriculture","fisheries"],"orgTier":"ministry"}
{"path":"obras-publicas","name":"Ministério das Obras Públicas","nameEn":"Ministry of Public Works","website":"https://www.mop.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:04.5","infrastructure","public-works"],"orgTier":"ministry"}
{"path":"comercio-industria","name":"Ministério do Comércio, Indústria e Ambiente","nameEn":"Ministry of Commerce, Industry and Environment","website":"https://www.mcia.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:04","commerce","industry","environment"],"orgTier":"ministry"}
{"path":"planeamento","name":"Ministério do Planeamento e Investimento Estratégico","nameEn":"Ministry of Planning and Strategic Investment","website":"https://www.mopie.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01.1","planning","investment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"mun:aileu","name":"Aileu","nameEn":"Aileu Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
{"path":"mun:ainaro","name":"Ainaro","nameEn":"Ainaro Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
{"path":"mun:baucau","name":"Baucau","nameEn":"Baucau Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality","second-city"],"orgTier":"state"}
{"path":"mun:bobonaro","name":"Bobonaro","nameEn":"Bobonaro Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality","border"],"orgTier":"state"}
{"path":"mun:covalima","name":"Covalima","nameEn":"Covalima Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality","border"],"orgTier":"state"}
{"path":"mun:dili","name":"Díli","nameEn":"Dili Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality","capital"],"orgTier":"state"}
{"path":"mun:ermera","name":"Ermera","nameEn":"Ermera Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality","coffee"],"orgTier":"state"}
{"path":"mun:lautem","name":"Lautém","nameEn":"Lautem Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
{"path":"mun:liquica","name":"Liquiçá","nameEn":"Liquica Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
{"path":"mun:manatuto","name":"Manatuto","nameEn":"Manatuto Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
{"path":"mun:manufahi","name":"Manufahi","nameEn":"Manufahi Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
{"path":"mun:oecusse","name":"Oe-Cusse Ambeno","nameEn":"Oe-Cusse Ambeno Special Administrative Region","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality","special-region","exclave"],"orgTier":"state"}
{"path":"mun:viqueque","name":"Viqueque","nameEn":"Viqueque Municipality","website":"https://www.timor-leste.gov.tl/","contract":"Constituição da RDTL 2002","tags":["cofog:01","municipality"],"orgTier":"state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str]) -> None:
    ...
    if not path or not updates:
        return
    # R0: fetch existing row, merge fields, then upsert
    vid = _vertex_id(path)
    existing = get_kotoba_client().select_first_where("vertex_gov_org", "vertex_id", vid)
    if existing and existing.get("domain_code") == DOMAIN_CODE and existing.get("owner_did") == PRIMARY_DID:
...
def task_gov_tls_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: broad select and filter in Python
...
def task_gov_tls_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_tls_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: fetch limit=2000, sort/filter in Python
...
async def task_gov_tls_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_tls_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_tls_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in filtered:
        ...
        if not lia or lia < cutoff_iso:
            final_rows.append(r)
    final_rows.sort(key=lambda x: str(x.get("last_ingested_at") or ""))
    ...
    for r in rows:
        ...
        # R0: fetch limit 2000, sort by crawled_at DESC in Python
...
async def task_gov_tls_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_tls_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_tls_seed_orgs, seedLimit)
    register = await task_gov_tls_register_dids(registerLimit)
    follow = await task_gov_tls_follow_site_deps(followLimit)
    ingest = await task_gov_tls_sync_wet_updates(ingestLimit)
    shinka = await task_gov_tls_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govTls.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_tls_heartbeat_tick)
