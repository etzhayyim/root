"""LBN Government states actor primitives.

This module moves the `did:web:lbn-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:lbn-state.etzhayyim.com"
DOMAIN_CODE = "lbn"
...
_MINISTRY_NDJSON = """\
{"path":"rئاسة-jumhuriyya","name":"رئاسة الجمهورية","nameEn":"Presidency of the Republic","website":"https://www.presidency.gov.lb/","contract":"الدستور اللبناني المادة 49","tags":["cofog:01","executive","president","maronite"],"orgTier":"ministry"}
{"path":"rئاسة-hukuma","name":"رئاسة مجلس الوزراء","nameEn":"Office of the Prime Minister","website":"https://www.pcm.gov.lb/","contract":"الدستور المادة 54 + اتفاق الطائف 1989","tags":["cofog:01","executive","prime-minister","sunni"],"orgTier":"ministry"}
{"path":"mfa","name":"وزارة الخارجية والمغتربين","nameEn":"Ministry of Foreign Affairs and Emigrants","website":"https://www.foreign.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:01.2","foreign-affairs","diaspora"],"orgTier":"ministry"}
{"path":"mod","name":"وزارة الدفاع الوطني","nameEn":"Ministry of National Defence","website":"https://www.lebarmy.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"moi","name":"وزارة الداخلية والبلديات","nameEn":"Ministry of Interior and Municipalities","website":"https://www.interior.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:03","interior","municipalities"],"orgTier":"ministry"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.finance.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.justice.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:03","justice","judiciary"],"orgTier":"ministry"}
{"path":"moe","name":"وزارة التربية والتعليم العالي","nameEn":"Ministry of Education and Higher Education","website":"https://www.mehe.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:09","education","higher-education"],"orgTier":"ministry"}
{"path":"moh","name":"وزارة الصحة العامة","nameEn":"Ministry of Public Health","website":"https://www.moph.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mol","name":"وزارة العمل","nameEn":"Ministry of Labour","website":"https://www.labor.gov.lb/","contract":"الدستور المادة 66","tags":["cofog:04","labour","workers"],"orgTier":"ministry"}
{"path":"majlis-nuwwab","name":"مجلس النواب","nameEn":"Parliament of Lebanon","website":"https://www.lp.gov.lb/","contract":"الدستور المادة 16","tags":["cofog:01","legislature","parliament","shia-speaker"],"orgTier":"agency"}
{"path":"bank-lubnan","name":"مصرف لبنان","nameEn":"Banque du Liban (Central Bank)","website":"https://www.bdl.gov.lb/","contract":"قانون النقد والتسليف المادة 13","tags":["cofog:01","central-bank","monetary-policy"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"muhafaza:beirut","name":"محافظة بيروت","nameEn":"Beirut Governorate","website":"https://www.beirut.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","capital","urban"],"orgTier":"state"}
{"path":"muhafaza:mount-lebanon","name":"محافظة جبل لبنان","nameEn":"Mount Lebanon Governorate","website":"https://www.mountlebanon.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","most-populated","christian-heartland"],"orgTier":"state"}
{"path":"muhafaza:north","name":"محافظة الشمال","nameEn":"North Governorate","website":"https://www.north.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","tripoli","northern"],"orgTier":"state"}
{"path":"muhafaza:south","name":"محافظة الجنوب","nameEn":"South Governorate","website":"https://www.south.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","sidon","tyre"],"orgTier":"state"}
{"path":"muhafaza:nabatieh","name":"محافظة النبطية","nameEn":"Nabatieh Governorate","website":"https://www.nabatieh.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","shia-majority","south"],"orgTier":"state"}
{"path":"muhafaza:bekaa","name":"محافظة البقاع","nameEn":"Bekaa Governorate","website":"https://www.bekaa.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","zahleh","agriculture"],"orgTier":"state"}
{"path":"muhafaza:baalbek-hermel","name":"محافظة بعلبك-الهرمل","nameEn":"Baalbek-Hermel Governorate","website":"https://www.baalebek-hermel.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","bekaa-north","archaeological"],"orgTier":"state"}
{"path":"muhafaza:akkar","name":"محافظة عكار","nameEn":"Akkar Governorate","website":"https://www.akkar.gov.lb/","contract":"قانون تنظيم المحافظات 116/1959","tags":["cofog:01","muhafaza","far-north","rural"],"orgTier":"state"}
"""
...
def task_gov_lbn_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_lbn_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_lbn_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_lbn_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_lbn_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_lbn_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_lbn_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_lbn_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_lbn_seed_orgs, seedLimit)
    register = await task_gov_lbn_register_dids(registerLimit)
    follow = await task_gov_lbn_follow_site_deps(followLimit)
    ingest = await task_gov_lbn_sync_wet_updates(ingestLimit)
    shinka = await task_gov_lbn_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLbn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lbn_heartbeat_tick)
