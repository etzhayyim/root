"""BHR Government states actor primitives.

This module moves the `did:web:bhr-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:bhr-state.etzhayyim.com"
DOMAIN_CODE = "bhr"
...
_MINISTRY_NDJSON = """\
{"path":"royal-diwan","name":"الديوان الملكي","nameEn":"Royal Diwan","website":"https://www.rda.gov.bh","contract":"Constitution 2002","tags":["executive","royal"],"orgTier":"central"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defence","website":"https://www.mod.gov.bh","contract":"Constitution 2002","tags":["defence","military"],"orgTier":"central"}
{"path":"mof","name":"وزارة المالية والاقتصاد الوطني","nameEn":"Ministry of Finance and National Economy","website":"https://www.mof.gov.bh","contract":"Constitution 2002","tags":["finance","economy"],"orgTier":"central"}
{"path":"mofa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mofa.gov.bh","contract":"Constitution 2002","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"moj","name":"وزارة العدل والشؤون الإسلامية والأوقاف","nameEn":"Ministry of Justice, Islamic Affairs and Endowments","website":"https://www.moj.gov.bh","contract":"Constitution 2002","tags":["justice","law","islamic-affairs"],"orgTier":"central"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.bh","contract":"Constitution 2002","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"وزارة التربية والتعليم","nameEn":"Ministry of Education","website":"https://www.moe.gov.bh","contract":"Constitution 2002","tags":["education"],"orgTier":"central"}
{"path":"moh","name":"وزارة الصحة","nameEn":"Ministry of Health","website":"https://www.moh.gov.bh","contract":"Constitution 2002","tags":["health","public-health"],"orgTier":"central"}
{"path":"sce","name":"المجلس الأعلى للبيئة","nameEn":"Supreme Council for Environment","website":"https://www.sce.gov.bh","contract":"Constitution 2002","tags":["environment","sustainability"],"orgTier":"central"}
{"path":"ewa","name":"هيئة الكهرباء والماء","nameEn":"Electricity and Water Authority","website":"https://www.ewa.gov.bh","contract":"Constitution 2002","tags":["electricity","water","utilities"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"capital","name":"محافظة العاصمة","nameEn":"Capital Governorate","website":"https://www.capital.gov.bh","contract":"Constitution 2002","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"central","name":"المحافظة الوسطى","nameEn":"Central Governorate","website":"https://www.central.gov.bh","contract":"Constitution 2002","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"muharraq","name":"محافظة المحرق","nameEn":"Muharraq Governorate","website":"https://www.muharraq.gov.bh","contract":"Constitution 2002","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"northern","name":"المحافظة الشمالية","nameEn":"Northern Governorate","website":"https://www.northern.gov.bh","contract":"Constitution 2002","tags":["governorate","muhafazah"],"orgTier":"subnational"}
"""
...
def task_gov_bhr_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_bhr_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_bhr_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_bhr_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_bhr_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_bhr_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_bhr_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_bhr_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_bhr_seed_orgs, seedLimit)
    register = await task_gov_bhr_register_dids(registerLimit)
    follow = await task_gov_bhr_follow_site_deps(followLimit)
    ingest = await task_gov_bhr_sync_wet_updates(ingestLimit)
    shinka = await task_gov_bhr_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBhr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_heartbeat_tick)
