...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bhr_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govBhr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
