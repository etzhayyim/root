"""JAM Government states actor primitives.

This module moves the `did:web:jam-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:jam-state.etzhayyim.com"
DOMAIN_CODE = "jam"
...
_MINISTRY_NDJSON = """\
{"path": "prime-minister", "name": "Office of the Prime Minister", "nameEn": "Office of the Prime Minister", "website": "https://www.opm.gov.jm/", "contract": "Constitution 1962 Art. 69-75", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "national-security", "name": "Ministry of National Security", "nameEn": "Ministry of National Security", "website": "https://www.mns.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "finance", "name": "Ministry of Finance and the Public Service", "nameEn": "Ministry of Finance and the Public Service", "website": "https://www.mof.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "foreign", "name": "Ministry of Foreign Affairs and Foreign Trade", "nameEn": "Ministry of Foreign Affairs and Foreign Trade", "website": "https://www.mfaft.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "justice", "name": "Ministry of Justice", "nameEn": "Ministry of Justice", "website": "https://www.moj.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "education", "name": "Ministry of Education and Youth", "nameEn": "Ministry of Education and Youth", "website": "https://moey.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "health", "name": "Ministry of Health and Wellness", "nameEn": "Ministry of Health and Wellness", "website": "https://www.moh.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agriculture", "name": "Ministry of Agriculture and Fisheries", "nameEn": "Ministry of Agriculture and Fisheries", "website": "https://www.moa.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "labour", "name": "Ministry of Labour and Social Security", "nameEn": "Ministry of Labour and Social Security", "website": "https://www.mlss.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "industry", "name": "Ministry of Industry, Investment and Commerce", "nameEn": "Ministry of Industry, Investment and Commerce", "website": "https://www.miicom.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "energy", "name": "Ministry of Science, Energy, Telecommunications and Transport", "nameEn": "Ministry of Science, Energy, Telecommunications and Transport", "website": "https://www.msett.gov.jm/", "contract": "Constitution 1962", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "parish:clarendon", "name": "Clarendon Parish Council", "nameEn": "Clarendon Parish", "website": "https://www.clarendonpc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:hanover", "name": "Hanover Parish Council", "nameEn": "Hanover Parish", "website": "https://www.hanoverpc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:kingston", "name": "Kingston and St. Andrew Corporation", "nameEn": "Kingston Parish", "website": "https://www.ksac.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:manchester", "name": "Manchester Parish Council", "nameEn": "Manchester Parish", "website": "https://www.manchesterpc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:portland", "name": "Portland Parish Council", "nameEn": "Portland Parish", "website": "https://www.portlandpc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-andrew", "name": "Kingston and St. Andrew Corporation", "nameEn": "Saint Andrew Parish", "website": "https://www.ksac.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-ann", "name": "Saint Ann Parish Council", "nameEn": "Saint Ann Parish", "website": "https://www.saintannpc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-catherine", "name": "Saint Catherine Parish Council", "nameEn": "Saint Catherine Parish", "website": "https://www.stcatherinepc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-elizabeth", "name": "Saint Elizabeth Parish Council", "nameEn": "Saint Elizabeth Parish", "website": "https://www.stepc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-james", "name": "Saint James Parish Council", "nameEn": "Saint James Parish", "website": "https://www.stjamespc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-mary", "name": "Saint Mary Parish Council", "nameEn": "Saint Mary Parish", "website": "https://www.stmarypc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:saint-thomas", "name": "Saint Thomas Parish Council", "nameEn": "Saint Thomas Parish", "website": "https://www.stthomaspc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:trelawny", "name": "Trelawny Parish Council", "nameEn": "Trelawny Parish", "website": "https://www.trelawnypc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "parish:westmoreland", "name": "Westmoreland Parish Council", "nameEn": "Westmoreland Parish", "website": "https://www.westmorelandpc.gov.jm/", "contract": "Constitution 1962 + Parish Councils Act", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_jam_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_jam_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_jam_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_jam_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_jam_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_jam_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_jam_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_jam_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_jam_seed_orgs, seedLimit)
    register = await task_gov_jam_register_dids(registerLimit)
    follow = await task_gov_jam_follow_site_deps(followLimit)
    ingest = await task_gov_jam_sync_wet_updates(ingestLimit)
    shinka = await task_gov_jam_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govJam.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_jam_heartbeat_tick)
