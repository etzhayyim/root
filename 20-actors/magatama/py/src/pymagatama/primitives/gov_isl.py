"""ISL Government states actor primitives.

This module moves the `did:web:isl-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:isl-state.etzhayyim.com"
DOMAIN_CODE = "isl"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Forsætisráðuneytið","nameEn":"Prime Minister's Office","website":"https://www.government.is/","contract":"Constitution 1944","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"ministry-of-defence","name":"Utanríkisráðuneytið (Varnarmál)","nameEn":"Ministry of Defence (NATO, no standing army)","website":"https://www.government.is/ministries/ministry-for-foreign-affairs/","contract":"Constitution 1944","tags":["cofog:02","defence","nato"],"orgTier":"ministry"}
{"path":"ministry-of-finance","name":"Fjármála- og efnahagsráðuneytið","nameEn":"Ministry of Finance and Economic Affairs","website":"https://www.government.is/ministries/ministry-of-finance-and-economic-affairs/","contract":"Constitution 1944","tags":["cofog:01.1","finance","economy","budget"],"orgTier":"ministry"}
{"path":"ministry-of-foreign-affairs","name":"Utanríkisráðuneytið","nameEn":"Ministry of Foreign Affairs","website":"https://www.government.is/ministries/ministry-for-foreign-affairs/","contract":"Constitution 1944","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"ministry-of-justice","name":"Dómsmálaráðuneytið","nameEn":"Ministry of Justice","website":"https://www.government.is/ministries/ministry-of-justice/","contract":"Constitution 1944","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"ministry-of-interior","name":"Innviðaráðuneytið","nameEn":"Ministry of Infrastructure and Interior","website":"https://www.government.is/ministries/ministry-of-infrastructure/","contract":"Constitution 1944","tags":["cofog:03","interior","infrastructure"],"orgTier":"ministry"}
{"path":"ministry-of-education","name":"Mennta- og menningarmálaráðuneytið","nameEn":"Ministry of Education, Science and Culture","website":"https://www.government.is/ministries/ministry-of-education-science-and-culture/","contract":"Constitution 1944","tags":["cofog:09","education","culture","science"],"orgTier":"ministry"}
{"path":"ministry-of-health","name":"Heilbrigðisráðuneytið","nameEn":"Ministry of Health","website":"https://www.government.is/ministries/ministry-of-health/","contract":"Constitution 1944","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"ministry-of-fisheries","name":"Matvæla-, landbúnaðar- og sjávarútvegasráðuneytið","nameEn":"Ministry of Fisheries and Agriculture","website":"https://www.government.is/ministries/ministry-of-industries-and-innovation/","contract":"Constitution 1944","tags":["cofog:04.2","fisheries","agriculture"],"orgTier":"ministry"}
{"path":"ministry-of-industry","name":"Iðnaðarráðuneytið","nameEn":"Ministry of Industry","website":"https://www.government.is/ministries/ministry-of-industries-and-innovation/","contract":"Constitution 1944","tags":["cofog:04","industry","innovation"],"orgTier":"ministry"}
{"path":"ministry-of-environment","name":"Umhverfis-, orku- og loftslagsráðuneytið","nameEn":"Ministry of Environment, Energy and Climate","website":"https://www.government.is/ministries/ministry-for-the-environment-and-natural-resources/","contract":"Constitution 1944","tags":["cofog:05","environment","energy","climate"],"orgTier":"ministry"}
{"path":"ministry-of-tourism","name":"Ferðamála-, iðnaðar- og nýsköpunarráðuneytið","nameEn":"Ministry of Tourism","website":"https://www.government.is/ministries/ministry-of-industries-and-innovation/","contract":"Constitution 1944","tags":["cofog:04","tourism","innovation"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"reg:capital-region","name":"Höfuðborgarsvæðið","nameEn":"Capital Region","website":"https://www.reykjavik.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti","capital"],"orgTier":"state"}
{"path":"reg:reykjanes","name":"Suðurnes","nameEn":"Reykjanes Region","website":"https://www.reykjanes.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
{"path":"reg:west","name":"Vesturland","nameEn":"West Region","website":"https://www.vesturland.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
{"path":"reg:westfjords","name":"Vestfirðir","nameEn":"Westfjords Region","website":"https://www.vestfirdir.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
{"path":"reg:northwest","name":"Norðurland vestra","nameEn":"Northwest Region","website":"https://www.nordurlandvestra.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
{"path":"reg:northeast","name":"Norðurland eystra","nameEn":"Northeast Region","website":"https://www.nordurlandeystra.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
{"path":"reg:east","name":"Austurland","nameEn":"East Region","website":"https://www.austurland.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
{"path":"reg:south","name":"Suðurland","nameEn":"South Region","website":"https://www.sudurland.is/","contract":"Constitution 1944 Art. 78","tags":["cofog:01","landshluti"],"orgTier":"state"}
"""
...
def task_gov_isl_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_isl_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_isl_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_isl_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_isl_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_isl_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_isl_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_isl_seed_orgs, seedLimit)
    register = await task_gov_isl_register_dids(registerLimit)
    follow = await task_gov_isl_follow_site_deps(followLimit)
    ingest = await task_gov_isl_sync_wet_updates(ingestLimit)
    shinka = await task_gov_isl_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govIsl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_isl_heartbeat_tick)
