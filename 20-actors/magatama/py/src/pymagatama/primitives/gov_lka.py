...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govLka.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
