"""LKA Government states actor primitives.

This module moves the `did:web:lka-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:lka-state.etzhayyim.com"
DOMAIN_CODE = "lka"
...
_MINISTRY_NDJSON = """\
{"path":"president-office","name":"ජනාධිපති කාර්යාලය / அலுவலகம்","nameEn":"President's Office","website":"https://www.president.gov.lk/","contract":"Constitution of Sri Lanka 1978 Art. 30","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"mofa","name":"විදේශ කටයුතු අමාත්‍යාංශය","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"ආරක්ෂා අමාත්‍යාංශය","nameEn":"Ministry of Defence","website":"https://www.defence.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"මුදල් අමාත්‍යාංශය","nameEn":"Ministry of Finance","website":"https://www.treasury.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:01.1","finance","treasury"],"orgTier":"ministry"}
{"path":"moj","name":"යුක්ති අමාත්‍යාංශය","nameEn":"Ministry of Justice","website":"https://www.justice.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mohe","name":"ස්වදේශ කටයුතු, පළාත් සභා හා ස්ථානීය ආණ්ඩු","nameEn":"Ministry of Home Affairs","website":"https://www.moha.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:03","interior","home-affairs"],"orgTier":"ministry"}
{"path":"moe","name":"අධ්‍යාපන අමාත්‍යාංශය","nameEn":"Ministry of Education","website":"https://www.moe.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"සෞඛ්‍ය අමාත්‍යාංශය","nameEn":"Ministry of Health","website":"https://www.health.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"molabour","name":"ශ්‍රම අමාත්‍යාංශය","nameEn":"Ministry of Labour","website":"https://www.labour.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:04","labour"],"orgTier":"ministry"}
{"path":"motrade","name":"වාණිජ කටයුතු අමාත්‍යාංශය","nameEn":"Ministry of Trade","website":"https://www.trade.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:04","trade","commerce"],"orgTier":"ministry"}
{"path":"moagri","name":"කෘෂිකර්ම අමාත්‍යාංශය","nameEn":"Ministry of Agriculture","website":"https://www.agrimin.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"moenv","name":"පරිසර අමාත්‍යාංශය","nameEn":"Ministry of Environment","website":"https://www.env.gov.lk/","contract":"Constitution of Sri Lanka 1978","tags":["cofog:05","environment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:western","name":"බස්නාහිර පළාත","nameEn":"Western Province","website":"https://www.westernprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province","capital"],"orgTier":"state"}
{"path":"prov:central","name":"මධ්‍යම පළාත","nameEn":"Central Province","website":"https://www.centralprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:southern","name":"දකුණු පළාත","nameEn":"Southern Province","website":"https://www.southernprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:northern","name":"උතුරු පළාත","nameEn":"Northern Province","website":"https://www.northernprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:eastern","name":"නැගෙනහිර පළාත","nameEn":"Eastern Province","website":"https://www.easternprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:north-western","name":"වයඹ පළාත","nameEn":"North Western Province","website":"https://www.northwesternprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:north-central","name":"උතුරු මැද පළාත","nameEn":"North Central Province","website":"https://www.northcentralprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:uva","name":"ඌව පළාත","nameEn":"Uva Province","website":"https://www.uvaprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:sabaragamuwa","name":"සබරගමුව පළාත","nameEn":"Sabaragamuwa Province","website":"https://www.sabaragamuwaprovince.lk/","contract":"Constitution of Sri Lanka 1978 Ch. XVIIA","tags":["cofog:01","province"],"orgTier":"state"}
"""
...
def task_gov_lka_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_lka_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_lka_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_lka_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_lka_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_lka_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_lka_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_lka_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_lka_seed_orgs, seedLimit)
    register = await task_gov_lka_register_dids(registerLimit)
    follow = await task_gov_lka_follow_site_deps(followLimit)
    ingest = await task_gov_lka_sync_wet_updates(ingestLimit)
    shinka = await task_gov_lka_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govLka.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_lka_heartbeat_tick)
