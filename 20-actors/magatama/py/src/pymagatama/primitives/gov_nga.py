...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNga.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
