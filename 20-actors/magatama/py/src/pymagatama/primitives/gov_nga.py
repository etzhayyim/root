"""NGA Government states actor primitives.

This module moves the `did:web:nga-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:nga-state.etzhayyim.com"
DOMAIN_CODE = "nga"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Office of the President","nameEn":"Office of the President of Nigeria","website":"https://www.statehouse.gov.ng/","contract":"Constitution of Nigeria 1999 S. 130","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"mofa","name":"Ministry of Foreign Affairs","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://www.defence.gov.ng/","contract":"Constitution of Nigeria 1999 S. 217","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Ministry of Finance","nameEn":"Ministry of Finance, Budget and National Planning","website":"https://www.finance.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:01.1","finance","budget","planning"],"orgTier":"ministry"}
{"path":"mogj","name":"Ministry of Justice","nameEn":"Federal Ministry of Justice","website":"https://www.justice.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"police","name":"Nigeria Police Force","nameEn":"Nigeria Police Force","website":"https://www.npf.gov.ng/","contract":"Constitution of Nigeria 1999 S. 214","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"Ministry of Education","nameEn":"Federal Ministry of Education","website":"https://www.education.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"Ministry of Health","nameEn":"Federal Ministry of Health and Social Welfare","website":"https://www.health.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mol","name":"Ministry of Labour","nameEn":"Ministry of Labour and Employment","website":"https://www.labour.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:04","labour","employment"],"orgTier":"ministry"}
{"path":"mitdd","name":"Ministry of Industry, Trade and Investment","nameEn":"Ministry of Industry, Trade and Investment","website":"https://www.trade.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:04","trade","industry","investment"],"orgTier":"ministry"}
{"path":"moa","name":"Ministry of Agriculture","nameEn":"Federal Ministry of Agriculture and Food Security","website":"https://www.fmard.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:04.2","agriculture","food-security"],"orgTier":"ministry"}
{"path":"menv","name":"Ministry of Environment","nameEn":"Federal Ministry of Environment","website":"https://www.environment.gov.ng/","contract":"Constitution of Nigeria 1999","tags":["cofog:05","environment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"state:lagos","name":"Lagos State","nameEn":"Lagos State","website":"https://www.lagosstate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","megacity","commercial-capital"],"orgTier":"state"}
{"path":"state:kano","name":"Kano State","nameEn":"Kano State","website":"https://www.kanostate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","north"],"orgTier":"state"}
{"path":"state:rivers","name":"Rivers State","nameEn":"Rivers State","website":"https://www.riversstate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","oil","port-harcourt"],"orgTier":"state"}
{"path":"state:oyo","name":"Oyo State","nameEn":"Oyo State","website":"https://www.oyostate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","ibadan"],"orgTier":"state"}
{"path":"state:katsina","name":"Katsina State","nameEn":"Katsina State","website":"https://www.katsinastate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","north"],"orgTier":"state"}
{"path":"state:kaduna","name":"Kaduna State","nameEn":"Kaduna State","website":"https://www.kadunastate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","north"],"orgTier":"state"}
{"path":"state:abuja-fct","name":"Federal Capital Territory","nameEn":"Federal Capital Territory, Abuja","website":"https://www.fct.gov.ng/","contract":"Constitution of Nigeria 1999 S. 299","tags":["cofog:01","fct","capital"],"orgTier":"state"}
{"path":"state:anambra","name":"Anambra State","nameEn":"Anambra State","website":"https://www.anambrastate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","south-east"],"orgTier":"state"}
{"path":"state:ogun","name":"Ogun State","nameEn":"Ogun State","website":"https://www.ogunstate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","industrial"],"orgTier":"state"}
{"path":"state:borno","name":"Borno State","nameEn":"Borno State","website":"https://www.bornostate.gov.ng/","contract":"Constitution of Nigeria 1999 S. 3","tags":["cofog:01","state","north-east"],"orgTier":"state"}
"""
...
def task_gov_nga_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_nga_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_nga_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_nga_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_nga_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_nga_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_nga_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_nga_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_nga_seed_orgs, seedLimit)
    register = await task_gov_nga_register_dids(registerLimit)
    follow = await task_gov_nga_follow_site_deps(followLimit)
    ingest = await task_gov_nga_sync_wet_updates(ingestLimit)
    shinka = await task_gov_nga_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNga.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nga_heartbeat_tick)
