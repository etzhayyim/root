"""BWA Government states actor primitives.

This module moves the `did:web:bwa-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:bwa-state.etzhayyim.com"
DOMAIN_CODE = "bwa"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Office of the President","nameEn":"Office of the President","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defence","name":"Ministry of Defence and Security","nameEn":"Ministry of Defence and Security","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:02","defence","security"],"orgTier":"ministry"}
{"path":"finance","name":"Ministry of Finance","nameEn":"Ministry of Finance","website":"https://www.finance.gov.bw/","contract":"Constitution 1966","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs","nameEn":"Ministry of Foreign Affairs","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justice","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"home-affairs","name":"Ministry of Home Affairs","nameEn":"Ministry of Home Affairs","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:03","interior","immigration"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Basic Education","nameEn":"Ministry of Basic Education","website":"https://www.mobe.gov.bw/","contract":"Constitution 1966","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.moh.gov.bw/","contract":"Constitution 1966","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture","nameEn":"Ministry of Agriculture","website":"https://www.moa.gov.bw/","contract":"Constitution 1966","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"mineral-resources","name":"Ministry of Mineral Resources","nameEn":"Ministry of Mineral Resources","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:04","mining","minerals"],"orgTier":"ministry"}
{"path":"transport-communications","name":"Ministry of Transport and Communications","nameEn":"Ministry of Transport and Communications","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:04.5","transport","communications"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment and Tourism","nameEn":"Ministry of Environment and Tourism","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:05","environment","tourism"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"dist:central","name":"Central District","nameEn":"Central District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:ghanzi","name":"Ghanzi District","nameEn":"Ghanzi District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:kgalagadi","name":"Kgalagadi District","nameEn":"Kgalagadi District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:kgatleng","name":"Kgatleng District","nameEn":"Kgatleng District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:kweneng","name":"Kweneng District","nameEn":"Kweneng District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:ngamiland","name":"Ngamiland District","nameEn":"Ngamiland District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:north-east","name":"North-East District","nameEn":"North-East District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:north-west","name":"North-West District","nameEn":"North-West District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:south-east","name":"South-East District","nameEn":"South-East District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:southern","name":"Southern District","nameEn":"Southern District","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"dist:gaborone-city","name":"Gaborone City Council","nameEn":"Gaborone City Council","website":"https://www.gaborone.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","urban-council","capital"],"orgTier":"state"}
{"path":"dist:francistown","name":"Francistown City Council","nameEn":"Francistown City Council","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","urban-council"],"orgTier":"state"}
{"path":"dist:lobatse","name":"Lobatse Town Council","nameEn":"Lobatse Town Council","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","urban-council"],"orgTier":"state"}
{"path":"dist:jwaneng","name":"Jwaneng Town Council","nameEn":"Jwaneng Town Council","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","urban-council"],"orgTier":"state"}
{"path":"dist:selebi-phikwe","name":"Selebi-Phikwe Town Council","nameEn":"Selebi-Phikwe Town Council","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","urban-council"],"orgTier":"state"}
{"path":"dist:orapa","name":"Orapa Town Council","nameEn":"Orapa Town Council","website":"https://www.gov.bw/","contract":"Constitution 1966","tags":["cofog:01","urban-council"],"orgTier":"state"}
"""
...
def task_gov_bwa_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_bwa_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_bwa_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_bwa_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_bwa_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_bwa_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_bwa_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_bwa_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_bwa_seed_orgs, seedLimit)
    register = await task_gov_bwa_register_dids(registerLimit)
    follow = await task_gov_bwa_follow_site_deps(followLimit)
    ingest = await task_gov_bwa_sync_wet_updates(ingestLimit)
    shinka = await task_gov_bwa_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBwa.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bwa_heartbeat_tick)
