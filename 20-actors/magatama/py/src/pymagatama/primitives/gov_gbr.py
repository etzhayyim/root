"""GBR Government states actor primitives.

This module moves the `did:web:gbr-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:gbr-state.etzhayyim.com"
DOMAIN_CODE = "gbr"
...
_MINISTRY_NDJSON = """\
{"path":"cabinet-office","name":"Cabinet Office","nameEn":"Cabinet Office","website":"https://www.gov.uk/government/organisations/cabinet-office","contract":"Chequers Act 1782","tags":["cofog:01","executive","cabinet"],"orgTier":"ministry"}
{"path":"mod","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://www.gov.uk/government/organisations/ministry-of-defence","contract":"Defence (Transfer of Functions) Act 1964","tags":["cofog:02","defence","military"],"orgTier":"ministry"}
{"path":"fcdo","name":"Foreign, Commonwealth and Development Office","nameEn":"Foreign, Commonwealth and Development Office","website":"https://www.gov.uk/government/organisations/foreign-commonwealth-development-office","contract":"Ministers of the Crown Act 1975","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"hmt","name":"HM Treasury","nameEn":"HM Treasury","website":"https://www.gov.uk/government/organisations/hm-treasury","contract":"Exchequer and Audit Departments Act 1866","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"moj","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.gov.uk/government/organisations/ministry-of-justice","contract":"Constitutional Reform Act 2005","tags":["cofog:03","justice","courts","prisons"],"orgTier":"ministry"}
{"path":"home-office","name":"Home Office","nameEn":"Home Office","website":"https://www.gov.uk/government/organisations/home-office","contract":"Chequers Act 1782","tags":["cofog:03","interior","police","immigration"],"orgTier":"ministry"}
{"path":"dhsc","name":"Department of Health and Social Care","nameEn":"Department of Health and Social Care","website":"https://www.gov.uk/government/organisations/department-of-health-and-social-care","contract":"National Health Service Act 2006","tags":["cofog:07","health","nhs"],"orgTier":"ministry"}
{"path":"dfe","name":"Department for Education","nameEn":"Department for Education","website":"https://www.gov.uk/government/organisations/department-for-education","contract":"Education Act 1996","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"beis","name":"Department for Business and Trade","nameEn":"Department for Business and Trade","website":"https://www.gov.uk/government/organisations/department-for-business-and-trade","contract":"Ministers of the Crown Act 1975","tags":["cofog:04","business","trade","industry"],"orgTier":"ministry"}
{"path":"desnz","name":"Department for Energy Security and Net Zero","nameEn":"Department for Energy Security and Net Zero","website":"https://www.gov.uk/government/organisations/department-for-energy-security-and-net-zero","contract":"Ministers of the Crown Act 1975","tags":["cofog:04","energy","climate"],"orgTier":"ministry"}
{"path":"defra","name":"Department for Environment, Food and Rural Affairs","nameEn":"Department for Environment, Food and Rural Affairs","website":"https://www.gov.uk/government/organisations/department-for-environment-food-rural-affairs","contract":"Ministers of the Crown Act 1975","tags":["cofog:05","environment","agriculture","food"],"orgTier":"ministry"}
{"path":"dft","name":"Department for Transport","nameEn":"Department for Transport","website":"https://www.gov.uk/government/organisations/department-for-transport","contract":"Ministers of the Crown Act 1975","tags":["cofog:04.5","transport","infrastructure"],"orgTier":"ministry"}
{"path":"dcms","name":"Department for Culture, Media and Sport","nameEn":"Department for Culture, Media and Sport","website":"https://www.gov.uk/government/organisations/department-for-culture-media-and-sport","contract":"Ministers of the Crown Act 1975","tags":["cofog:08","culture","media","sport"],"orgTier":"ministry"}
{"path":"house-of-commons","name":"House of Commons","nameEn":"House of Commons","website":"https://www.parliament.uk/business/commons/","contract":"Parliament Acts 1911/1949","tags":["cofog:01","legislature","lower-house"],"orgTier":"agency"}
{"path":"house-of-lords","name":"House of Lords","nameEn":"House of Lords","website":"https://www.parliament.uk/business/lords/","contract":"House of Lords Act 1999","tags":["cofog:01","legislature","upper-house"],"orgTier":"agency"}
{"path":"supreme-court","name":"The Supreme Court","nameEn":"The Supreme Court of the United Kingdom","website":"https://www.supremecourt.uk/","contract":"Constitutional Reform Act 2005","tags":["cofog:03","judiciary","supreme-court"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"devolved:scotland","name":"Scottish Government","nameEn":"Scottish Government","website":"https://www.gov.scot/","contract":"Scotland Act 1998","tags":["cofog:01","devolved-nation","l5"],"orgTier":"state"}
{"path":"devolved:wales","name":"Welsh Government / Llywodraeth Cymru","nameEn":"Welsh Government","website":"https://www.gov.wales/","contract":"Government of Wales Act 2006","tags":["cofog:01","devolved-nation","l5"],"orgTier":"state"}
{"path":"devolved:northern-ireland","name":"Northern Ireland Executive","nameEn":"Northern Ireland Executive","website":"https://www.northernireland.gov.uk/","contract":"Northern Ireland Act 1998","tags":["cofog:01","devolved-nation","l5"],"orgTier":"state"}
{"path":"region:england","name":"England","nameEn":"England","website":"https://www.gov.uk/","contract":"UK Parliamentary Acts","tags":["cofog:01","nation","l5"],"orgTier":"state"}
{"path":"crown:jersey","name":"Jersey","nameEn":"Jersey","website":"https://www.gov.je/","contract":"Jersey Constitution","tags":["cofog:01","crown-dependency"],"orgTier":"state"}
{"path":"crown:guernsey","name":"Guernsey","nameEn":"Guernsey","website":"https://www.gov.gg/","contract":"Guernsey Constitution","tags":["cofog:01","crown-dependency"],"orgTier":"state"}
{"path":"crown:isle-of-man","name":"Isle of Man","nameEn":"Isle of Man","website":"https://www.gov.im/","contract":"Isle of Man Constitution","tags":["cofog:01","crown-dependency"],"orgTier":"state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str]) -> None:
    ...
    if not path or not updates:
        return
    # R0: partial update fetched first then inserted
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: domain_code and owner_did checked in python
...
def task_gov_gbr_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: filter by domain_code, owner_did, name_en in Python
...
def task_gov_gbr_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_gbr_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: count, filter, order, offset, limit applied in Python
...
async def task_gov_gbr_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    # R0: filter, order, limit applied in Python
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [
        r for r in all_rows
...
async def task_gov_gbr_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_gbr_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    cutoff = (_dt.datetime.now(tz=_dt.UTC) - _dt.timedelta(days=7)).replace(microsecond=0)
    cutoff_iso = cutoff.isoformat().replace("+00:00", "Z")
    # R0: filter by domain_code, owner_did, site_domain_slug, last_ingested_at cutoff and sort in Python
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = []
    for r in all_rows:
    ...
    for r in rows:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: order by crawled_at DESC in Python
...
async def task_gov_gbr_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_gbr_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_gbr_seed_orgs, seedLimit)
    register = await task_gov_gbr_register_dids(registerLimit)
    follow = await task_gov_gbr_follow_site_deps(followLimit)
    ingest = await task_gov_gbr_sync_wet_updates(ingestLimit)
    shinka = await task_gov_gbr_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGbr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gbr_heartbeat_tick)
