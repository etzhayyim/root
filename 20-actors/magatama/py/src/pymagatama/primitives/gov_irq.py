"""IRQ Government states actor primitives.

This module moves the `did:web:irq-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:irq-state.etzhayyim.com"
DOMAIN_CODE = "irq"
...
_MINISTRY_NDJSON = """\
{"path":"pmo","name":"مكتب رئيس الوزراء","nameEn":"Prime Minister's Office","website":"https://pmo.iq","contract":"Constitution 2005","tags":["executive","prime-minister"],"orgTier":"central"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defence","website":"https://www.mod.mil.iq","contract":"Constitution 2005","tags":["defence","military"],"orgTier":"central"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mof.gov.iq","contract":"Constitution 2005","tags":["finance","budget"],"orgTier":"central"}
{"path":"mofa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mofa.gov.iq","contract":"Constitution 2005","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.iq","contract":"Constitution 2005","tags":["justice","law"],"orgTier":"central"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.iq","contract":"Constitution 2005","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"وزارة التربية","nameEn":"Ministry of Education","website":"https://www.moedu.gov.iq","contract":"Constitution 2005","tags":["education"],"orgTier":"central"}
{"path":"moh","name":"وزارة الصحة","nameEn":"Ministry of Health","website":"https://www.moh.gov.iq","contract":"Constitution 2005","tags":["health","public-health"],"orgTier":"central"}
{"path":"moo","name":"وزارة النفط","nameEn":"Ministry of Oil","website":"https://www.oil.gov.iq","contract":"Constitution 2005","tags":["oil","energy"],"orgTier":"central"}
{"path":"moel","name":"وزارة الكهرباء","nameEn":"Ministry of Electricity","website":"https://www.moelc.gov.iq","contract":"Constitution 2005","tags":["electricity","utilities"],"orgTier":"central"}
{"path":"moa","name":"وزارة الزراعة","nameEn":"Ministry of Agriculture","website":"https://www.moa.gov.iq","contract":"Constitution 2005","tags":["agriculture"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"anbar","name":"محافظة الأنبار","nameEn":"Anbar Governorate","website":"https://anbar.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"babil","name":"محافظة بابل","nameEn":"Babil Governorate","website":"https://babil.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"baghdad","name":"محافظة بغداد","nameEn":"Baghdad Governorate (Capital)","website":"https://baghdad.gov.iq","contract":"Constitution 2005","tags":["governorate","capital"],"orgTier":"subnational"}
{"path":"basra","name":"محافظة البصرة","nameEn":"Basra Governorate","website":"https://basra.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"dhi-qar","name":"محافظة ذي قار","nameEn":"Dhi Qar Governorate","website":"https://dhiqar.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"diyala","name":"محافظة ديالى","nameEn":"Diyala Governorate","website":"https://diyala.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"duhok","name":"محافظة دهوك","nameEn":"Duhok Governorate (KRI)","website":"https://duhok.gov.iq","contract":"Constitution 2005","tags":["governorate","kurdistan"],"orgTier":"subnational"}
{"path":"erbil","name":"محافظة أربيل","nameEn":"Erbil Governorate (KRI)","website":"https://erbil.gov.iq","contract":"Constitution 2005","tags":["governorate","kurdistan"],"orgTier":"subnational"}
{"path":"karbala","name":"محافظة كربلاء","nameEn":"Karbala Governorate","website":"https://karbala.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"kirkuk","name":"محافظة كركوك","nameEn":"Kirkuk Governorate","website":"https://kirkuk.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"maysan","name":"محافظة ميسان","nameEn":"Maysan Governorate","website":"https://maysan.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"muthanna","name":"محافظة المثنى","nameEn":"Muthanna Governorate","website":"https://muthanna.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"najaf","name":"محافظة النجف","nameEn":"Najaf Governorate","website":"https://najaf.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"nineveh","name":"محافظة نينوى","nameEn":"Nineveh Governorate","website":"https://nineveh.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"qadisiyyah","name":"محافظة القادسية","nameEn":"Qadisiyyah Governorate","website":"https://qadisiyyah.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"saladin","name":"محافظة صلاح الدين","nameEn":"Saladin Governorate","website":"https://saladin.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
{"path":"sulaymaniyah","name":"محافظة السليمانية","nameEn":"Sulaymaniyah Governorate (KRI)","website":"https://sulaymaniyah.gov.iq","contract":"Constitution 2005","tags":["governorate","kurdistan"],"orgTier":"subnational"}
{"path":"wasit","name":"محافظة واسط","nameEn":"Wasit Governorate","website":"https://wasit.gov.iq","contract":"Constitution 2005","tags":["governorate","muhafazah"],"orgTier":"subnational"}
"""
...
def task_gov_irq_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_irq_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_irq_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_irq_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_irq_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_irq_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_irq_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_irq_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_irq_seed_orgs, seedLimit)
    register = await task_gov_irq_register_dids(registerLimit)
    follow = await task_gov_irq_follow_site_deps(followLimit)
    ingest = await task_gov_irq_sync_wet_updates(ingestLimit)
    shinka = await task_gov_irq_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irq_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govIrq.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
