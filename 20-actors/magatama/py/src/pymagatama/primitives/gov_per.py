...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_per_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPer.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
