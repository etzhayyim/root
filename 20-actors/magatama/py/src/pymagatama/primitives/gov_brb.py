"""BRB Government states actor primitives.

This module moves the `did:web:brb-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:brb-state.etzhayyim.com"
DOMAIN_CODE = "brb"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Office of the Prime Minister","nameEn":"Office of the Prime Minister","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:01","executive","prime-minister","republic"],"orgTier":"ministry"}
{"path":"defence-security","name":"Ministry of Home Affairs and Information","nameEn":"Ministry of Home Affairs and Information","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:02","defence","home-affairs"],"orgTier":"ministry"}
{"path":"finance-economic-affairs","name":"Ministry of Finance, Economic Affairs and Investment","nameEn":"Ministry of Finance, Economic Affairs and Investment","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:01.1","finance","economy"],"orgTier":"ministry"}
{"path":"foreign-affairs-foreign-trade","name":"Ministry of Foreign Affairs and Foreign Trade","nameEn":"Ministry of Foreign Affairs and Foreign Trade","website":"https://www.foreign.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:01.2","foreign-affairs","trade"],"orgTier":"ministry"}
{"path":"home-affairs","name":"Ministry of Home Affairs and Immigration","nameEn":"Ministry of Home Affairs and Immigration","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:03","interior","immigration"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Education, Technological and Vocational Training","nameEn":"Ministry of Education","website":"https://www.mes.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:09","education","vocational"],"orgTier":"ministry"}
{"path":"health-wellness","name":"Ministry of Health and Wellness","nameEn":"Ministry of Health and Wellness","website":"https://www.health.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture and Food Security","nameEn":"Ministry of Agriculture and Food Security","website":"https://www.agriculture.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"tourism-aviation","name":"Ministry of Tourism and International Transport","nameEn":"Ministry of Tourism and International Transport","website":"https://www.tourism.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:04","tourism","aviation"],"orgTier":"ministry"}
{"path":"industry-commerce","name":"Ministry of Industry, Innovation, Science and Technology","nameEn":"Ministry of Industry and Commerce","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:04","industry","innovation"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment and National Beautification","nameEn":"Ministry of Environment","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:05","environment"],"orgTier":"ministry"}
{"path":"people-empowerment","name":"Ministry of People Empowerment and Elder Affairs","nameEn":"Ministry of People Empowerment and Elder Affairs","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966 (Republic 2021)","tags":["cofog:01","social"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"parish:christ-church","name":"Christ Church","nameEn":"Christ Church Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-andrew","name":"Saint Andrew","nameEn":"Saint Andrew Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-george","name":"Saint George","nameEn":"Saint George Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-james","name":"Saint James","nameEn":"Saint James Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-john","name":"Saint John","nameEn":"Saint John Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-joseph","name":"Saint Joseph","nameEn":"Saint Joseph Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-lucy","name":"Saint Lucy","nameEn":"Saint Lucy Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-michael","name":"Saint Michael","nameEn":"Saint Michael Parish (Bridgetown capital)","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish","capital"],"orgTier":"state"}
{"path":"parish:saint-peter","name":"Saint Peter","nameEn":"Saint Peter Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-philip","name":"Saint Philip","nameEn":"Saint Philip Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-thomas","name":"Saint Thomas","nameEn":"Saint Thomas Parish","website":"https://www.gov.bb/","contract":"Constitution of Barbados 1966","tags":["cofog:01","parish"],"orgTier":"state"}
"""
...
def task_gov_brb_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_brb_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_brb_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_brb_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_brb_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_brb_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_brb_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_brb_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_brb_seed_orgs, seedLimit)
    register = await task_gov_brb_register_dids(registerLimit)
    follow = await task_gov_brb_follow_site_deps(followLimit)
    ingest = await task_gov_brb_sync_wet_updates(ingestLimit)
    shinka = await task_gov_brb_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBrb.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_brb_heartbeat_tick)
