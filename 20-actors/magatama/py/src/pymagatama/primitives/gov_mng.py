...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMng.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
