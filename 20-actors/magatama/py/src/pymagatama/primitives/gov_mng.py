...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govMng.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mng_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govMng.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
