...
LLM transport: `pymagatama.llm.call_tier` (already wires Vultr Serverless
...
async def task_projector_persist_message(
    ...
    if via_pds:
        try:
            from pymagatama.zeebe_worker_main import task_generic_pds_dispatch  # type: ignore
...
def register(worker: Any, *, timeout_ms: int) -> None:
    ...
    Called from `pymagatama.zeebe_worker_main:main()` alongside the
