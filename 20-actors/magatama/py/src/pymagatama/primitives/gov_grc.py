...
This module moves the `did:web:grc-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:grc-state.gftd.ai"
DOMAIN_CODE = "grc"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grc_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govGrc.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
