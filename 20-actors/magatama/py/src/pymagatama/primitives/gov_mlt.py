"""MLT Government states actor primitives.

This module moves the `did:web:mlt-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:mlt-state.etzhayyim.com"
DOMAIN_CODE = "mlt"
...
_MINISTRY_NDJSON = """\
{"path":"opm","name":"Uffiċċju tal-Prim Ministru","nameEn":"Office of the Prime Minister","website":"https://www.gov.mt/en/Government/OPM/Pages/default.aspx","contract":"Kostituzzjoni Art. 79","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mfa","name":"Ministeru għall-Affarijiet Barranin","nameEn":"Ministry for Foreign Affairs","website":"https://foreignaffairs.gov.mt/","contract":"Kostituzzjoni Art. 83","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"home","name":"Ministeru tal-Intern u s-Sigurtà Nazzjonali","nameEn":"Ministry for Home Affairs and National Security","website":"https://homeaffairs.gov.mt/","contract":"Kostituzzjoni Art. 73","tags":["cofog:03","interior","police","security"],"orgTier":"ministry"}
{"path":"mfin","name":"Ministeru tal-Finanzi u x-Xogħol","nameEn":"Ministry for Finance and Employment","website":"https://finance.gov.mt/","contract":"Kostituzzjoni Art. 102","tags":["cofog:01.1","finance","employment","budget"],"orgTier":"ministry"}
{"path":"mjust","name":"Ministeru tal-Ġustizzja","nameEn":"Ministry for Justice","website":"https://justice.gov.mt/","contract":"Kostituzzjoni Art. 95","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"health","name":"Ministeru għas-Saħħa","nameEn":"Ministry for Health","website":"https://health.gov.mt/","contract":"Kostituzzjoni Art. 9","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"medu","name":"Ministeru għall-Edukazzjoni","nameEn":"Ministry for Education","website":"https://education.gov.mt/","contract":"Kostituzzjoni Art. 10","tags":["cofog:09","education","research"],"orgTier":"ministry"}
{"path":"meae","name":"Ministeru għall-Ekonomija u l-Intrapriża","nameEn":"Ministry for Economy and Enterprise","website":"https://economy.gov.mt/","contract":"Kostituzzjoni Art. 9","tags":["cofog:04","economy","enterprise","trade"],"orgTier":"ministry"}
{"path":"mia","name":"Ministeru tal-Infrastruttura","nameEn":"Ministry for Infrastructure","website":"https://infrastructure.gov.mt/","contract":"Kostituzzjoni Art. 9","tags":["cofog:04.5","infrastructure","transport"],"orgTier":"ministry"}
{"path":"menv","name":"Ministeru ambjent u Tibdil fil-Klima","nameEn":"Ministry for Environment and Climate Change","website":"https://environment.gov.mt/","contract":"Kostituzzjoni Art. 9","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:malta","name":"Reġjun ta' Malta","nameEn":"Malta Region","website":"https://www.gov.mt/","contract":"Kostituzzjoni Art. 115A","tags":["cofog:01","region","mainland"],"orgTier":"state"}
{"path":"region:gozo","name":"Reġjun ta' Għawdex","nameEn":"Gozo Region","website":"https://gozo.gov.mt/","contract":"Kostituzzjoni Art. 115A","tags":["cofog:01","region","island"],"orgTier":"state"}
{"path":"region:south-eastern","name":"Reġjun tal-Lvant","nameEn":"South Eastern Region","website":"https://www.gov.mt/","contract":"Kostituzzjoni Art. 115A","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:southern","name":"Reġjun tan-Nofsinhar","nameEn":"Southern Region","website":"https://www.gov.mt/","contract":"Kostituzzjoni Art. 115A","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:northern","name":"Reġjun tat-Tramuntana","nameEn":"Northern Region","website":"https://www.gov.mt/","contract":"Kostituzzjoni Art. 115A","tags":["cofog:01","region"],"orgTier":"state"}
"""
...
def task_gov_mlt_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_mlt_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_mlt_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_mlt_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_mlt_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_mlt_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_mlt_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_mlt_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_mlt_seed_orgs, seedLimit)
    register = await task_gov_mlt_register_dids(registerLimit)
    follow = await task_gov_mlt_follow_site_deps(followLimit)
    ingest = await task_gov_mlt_sync_wet_updates(ingestLimit)
    shinka = await task_gov_mlt_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govMlt.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mlt_heartbeat_tick)
