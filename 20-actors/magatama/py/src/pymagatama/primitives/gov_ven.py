"""VEN Government states actor primitives.

This module moves the `did:web:ven-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:ven-state.etzhayyim.com"
DOMAIN_CODE = "ven"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gob.ve/", "contract": "Constitución 1999 Art. 225-244", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defensa", "name": "Ministerio del Poder Popular para la Defensa", "nameEn": "Ministry of People's Power for Defence", "website": "https://www.mindefensa.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "finanzas", "name": "Ministerio del Poder Popular de Economía, Finanzas y Comercio Exterior", "nameEn": "Ministry of People's Power for Economy, Finance and Foreign Trade", "website": "https://www.minfinanzas.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio del Poder Popular para Relaciones Exteriores", "nameEn": "Ministry of People's Power for Foreign Affairs", "website": "https://www.mppre.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "interior", "name": "Ministerio del Poder Popular para Relaciones Interiores, Justicia y Paz", "nameEn": "Ministry of People's Power for Interior, Justice and Peace", "website": "https://www.mpprij.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio del Poder Popular para la Educación", "nameEn": "Ministry of People's Power for Education", "website": "https://www.me.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio del Poder Popular para la Salud", "nameEn": "Ministry of People's Power for Health", "website": "https://www.mpps.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio del Poder Popular para la Agricultura Productiva y Tierras", "nameEn": "Ministry of People's Power for Productive Agriculture and Lands", "website": "https://www.mppat.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "industria", "name": "Ministerio del Poder Popular para Industrias", "nameEn": "Ministry of People's Power for Industries", "website": "https://www.milco.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Ministerio del Poder Popular para el Proceso Social de Trabajo", "nameEn": "Ministry of People's Power for Social Labour Process", "website": "https://www.minpptrass.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:10", "labour"], "orgTier": "ministry"}
{"path": "petroleo", "name": "Ministerio del Poder Popular para el Petróleo", "nameEn": "Ministry of People's Power for Petroleum", "website": "https://www.minpet.gob.ve/", "contract": "Constitución 1999", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "estado:amazonas", "name": "Estado Amazonas", "nameEn": "Amazonas State", "website": "https://www.amazonas.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:anzoategui", "name": "Estado Anzoátegui", "nameEn": "Anzoátegui State", "website": "https://www.anzoategui.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:apure", "name": "Estado Apure", "nameEn": "Apure State", "website": "https://www.apure.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:aragua", "name": "Estado Aragua", "nameEn": "Aragua State", "website": "https://www.aragua.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:barinas", "name": "Estado Barinas", "nameEn": "Barinas State", "website": "https://www.barinas.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:bolivar", "name": "Estado Bolívar", "nameEn": "Bolívar State", "website": "https://www.bolivar.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:carabobo", "name": "Estado Carabobo", "nameEn": "Carabobo State", "website": "https://www.carabobo.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:cojedes", "name": "Estado Cojedes", "nameEn": "Cojedes State", "website": "https://www.cojedes.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:delta-amacuro", "name": "Estado Delta Amacuro", "nameEn": "Delta Amacuro State", "website": "https://www.deltaAmacuro.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:falcon", "name": "Estado Falcón", "nameEn": "Falcón State", "website": "https://www.falcon.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:guarico", "name": "Estado Guárico", "nameEn": "Guárico State", "website": "https://www.guarico.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:lara", "name": "Estado Lara", "nameEn": "Lara State", "website": "https://www.lara.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:merida", "name": "Estado Mérida", "nameEn": "Mérida State", "website": "https://www.merida.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:miranda", "name": "Estado Miranda", "nameEn": "Miranda State", "website": "https://www.miranda.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:monagas", "name": "Estado Monagas", "nameEn": "Monagas State", "website": "https://www.monagas.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:nueva-esparta", "name": "Estado Nueva Esparta", "nameEn": "Nueva Esparta State", "website": "https://www.nuevaesparta.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:portuguesa", "name": "Estado Portuguesa", "nameEn": "Portuguesa State", "website": "https://www.portuguesa.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:sucre", "name": "Estado Sucre", "nameEn": "Sucre State", "website": "https://www.sucre.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:tachira", "name": "Estado Táchira", "nameEn": "Táchira State", "website": "https://www.tachira.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:trujillo", "name": "Estado Trujillo", "nameEn": "Trujillo State", "website": "https://www.trujillo.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:la-guaira", "name": "Estado La Guaira", "nameEn": "La Guaira State", "website": "https://www.laguaira.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:yaracuy", "name": "Estado Yaracuy", "nameEn": "Yaracuy State", "website": "https://www.yaracuy.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "estado:zulia", "name": "Estado Zulia", "nameEn": "Zulia State", "website": "https://www.zulia.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "capital:distrito-capital", "name": "Distrito Capital", "nameEn": "Capital District", "website": "https://www.distritocapital.gob.ve/", "contract": "Constitución 1999 Art. 159-167", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str]) -> None:
    ...
    if not path or not updates:
        return
    # R0: Fetch then upsert to simulate UPDATE
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: Fetch by path, then filter in Python
    row = get_kotoba_client().select_first_where("vertex_gov_org", "path", path)
...
def task_gov_ven_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: Fetch all by domain_code, filter in Python
...
def task_gov_ven_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_ven_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))

    # R0: Fetch all by domain_code, sort/filter/count/paginate in Python
...
async def task_gov_ven_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    # R0: Fetch by domain_code, filter/sort/limit in Python
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [
        r for r in all_rows
...
async def task_gov_ven_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_ven_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    filtered = []
    for r in all_rows:
        if r.get("owner_did") != PRIMARY_DID or r.get("site_domain_slug") == "":
            continue
    ...
    for r in rows:
        ...
        # R0: Fetch by domain, sort in Python to get latest
        wet_chunks = get_kotoba_client().select_where("vertex_wet_chunk", "domain", slug, limit=200)
...
async def task_gov_ven_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_ven_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_ven_seed_orgs, seedLimit)
    register = await task_gov_ven_register_dids(registerLimit)
    follow = await task_gov_ven_follow_site_deps(followLimit)
    ingest = await task_gov_ven_sync_wet_updates(ingestLimit)
    shinka = await task_gov_ven_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govVen.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_heartbeat_tick)
