...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ven_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govVen.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
