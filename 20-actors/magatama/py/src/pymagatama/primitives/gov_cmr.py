...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCmr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
