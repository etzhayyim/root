"""CMR Government states actor primitives.

This module moves the `did:web:cmr-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:cmr-state.etzhayyim.com"
DOMAIN_CODE = "cmr"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Présidence de la République","nameEn":"Presidency of the Republic","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defensenationale","name":"Ministère de la Défense","nameEn":"Ministry of National Defence","website":"https://www.mindef.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"financesetbudget","name":"Ministère des Finances","nameEn":"Ministry of Finance","website":"https://www.minfi.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"relationsexterieures","name":"Ministère des Relations Extérieures","nameEn":"Ministry of Foreign Affairs","website":"https://www.minrex.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justice","name":"Ministère de la Justice","nameEn":"Ministry of Justice","website":"https://www.minjustice.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"administration-territoriale","name":"Ministère de l'Administration Territoriale","nameEn":"Ministry of Territorial Administration","website":"https://www.minat.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:03","interior","administration"],"orgTier":"ministry"}
{"path":"education-de-base","name":"Ministère de l'Éducation de Base","nameEn":"Ministry of Basic Education","website":"https://www.minedub.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"sante-publique","name":"Ministère de la Santé Publique","nameEn":"Ministry of Public Health","website":"https://www.minsante.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministère de l'Agriculture et du Développement Rural","nameEn":"Ministry of Agriculture and Rural Development","website":"https://www.minader.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"economie","name":"Ministère de l'Économie, de la Planification et de l'Aménagement du Territoire","nameEn":"Ministry of Economy, Planning and Regional Development","website":"https://www.minepat.gov.cm/","contract":"Constitution 1972/1996","tags":["cofog:04","economy","planning"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"reg:adamawa","name":"Région de l'Adamaoua","nameEn":"Adamawa Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"reg:centre","name":"Région du Centre","nameEn":"Centre Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region","capital"],"orgTier":"state"}
{"path":"reg:east","name":"Région de l'Est","nameEn":"East Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"reg:far-north","name":"Région de l'Extrême-Nord","nameEn":"Far North Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"reg:littoral","name":"Région du Littoral","nameEn":"Littoral Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"reg:north","name":"Région du Nord","nameEn":"North Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"reg:north-west","name":"Région du Nord-Ouest","nameEn":"North West Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region","anglophone"],"orgTier":"state"}
{"path":"reg:south","name":"Région du Sud","nameEn":"South Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"reg:south-west","name":"Région du Sud-Ouest","nameEn":"South West Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region","anglophone"],"orgTier":"state"}
{"path":"reg:west","name":"Région de l'Ouest","nameEn":"West Region","website":"https://www.spm.gov.cm/","contract":"Constitution 1972/1996 Title X","tags":["cofog:01","region"],"orgTier":"state"}
"""
...
def task_gov_cmr_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_cmr_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_cmr_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_cmr_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_cmr_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_cmr_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_cmr_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_cmr_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_cmr_seed_orgs, seedLimit)
    register = await task_gov_cmr_register_dids(registerLimit)
    follow = await task_gov_cmr_follow_site_deps(followLimit)
    ingest = await task_gov_cmr_sync_wet_updates(ingestLimit)
    shinka = await task_gov_cmr_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govCmr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cmr_heartbeat_tick)
