"""POL Government states actor primitives.

This module moves the `did:web:pol-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:pol-state.etzhayyim.com"
DOMAIN_CODE = "pol"
...
_MINISTRY_NDJSON = """\
{"path":"kprm","name":"Kancelaria Prezesa Rady Ministrów","nameEn":"Chancellery of the Prime Minister","website":"https://www.gov.pl/web/premier","contract":"Konstytucja Art. 148","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"msz","name":"Ministerstwo Spraw Zagranicznych","nameEn":"Ministry of Foreign Affairs","website":"https://www.gov.pl/web/dyplomacja","contract":"Konstytucja Art. 146","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"mon","name":"Ministerstwo Obrony Narodowej","nameEn":"Ministry of National Defence","website":"https://www.gov.pl/web/obrona-narodowa","contract":"Konstytucja Art. 146","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mf","name":"Ministerstwo Finansów","nameEn":"Ministry of Finance","website":"https://www.gov.pl/web/finanse","contract":"Konstytucja Art. 217","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"ms","name":"Ministerstwo Sprawiedliwości","nameEn":"Ministry of Justice","website":"https://www.gov.pl/web/sprawiedliwosc","contract":"Konstytucja Art. 173","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mswia","name":"Ministerstwo Spraw Wewnętrznych i Administracji","nameEn":"Ministry of the Interior and Administration","website":"https://www.gov.pl/web/mswia","contract":"Konstytucja Art. 146","tags":["cofog:03","interior","police","administration"],"orgTier":"ministry"}
{"path":"men","name":"Ministerstwo Edukacji Narodowej","nameEn":"Ministry of National Education","website":"https://www.gov.pl/web/edukacja","contract":"Konstytucja Art. 70","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"mz","name":"Ministerstwo Zdrowia","nameEn":"Ministry of Health","website":"https://www.gov.pl/web/zdrowie","contract":"Konstytucja Art. 68","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mrpips","name":"Ministerstwo Rodziny i Polityki Społecznej","nameEn":"Ministry of Family and Social Policy","website":"https://www.gov.pl/web/rodzina","contract":"Konstytucja Art. 71","tags":["cofog:04","social","family","welfare"],"orgTier":"ministry"}
{"path":"mrit","name":"Ministerstwo Rolnictwa i Rozwoju Wsi","nameEn":"Ministry of Agriculture and Rural Development","website":"https://www.gov.pl/web/rolnictwo","contract":"Konstytucja Art. 23","tags":["cofog:04.2","agriculture","rural"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"woj:dolnoslaskie","name":"Województwo Dolnośląskie","nameEn":"Lower Silesian Voivodeship","website":"https://www.umwd.dolnyslask.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","wroclaw"],"orgTier":"state"}
{"path":"woj:kujawsko-pomorskie","name":"Województwo Kujawsko-Pomorskie","nameEn":"Kuyavian-Pomeranian Voivodeship","website":"https://www.kujawsko-pomorskie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship"],"orgTier":"state"}
{"path":"woj:lubelskie","name":"Województwo Lubelskie","nameEn":"Lublin Voivodeship","website":"https://www.lubelskie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship"],"orgTier":"state"}
{"path":"woj:lubuskie","name":"Województwo Lubuskie","nameEn":"Lubusz Voivodeship","website":"https://lubuskie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship"],"orgTier":"state"}
{"path":"woj:lodzkie","name":"Województwo Łódzkie","nameEn":"Łódź Voivodeship","website":"https://www.lodzkie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","lodz"],"orgTier":"state"}
{"path":"woj:malopolskie","name":"Województwo Małopolskie","nameEn":"Lesser Poland Voivodeship","website":"https://www.malopolska.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","krakow"],"orgTier":"state"}
{"path":"woj:mazowieckie","name":"Województwo Mazowieckie","nameEn":"Masovian Voivodeship","website":"https://www.mazovia.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","warsaw","largest"],"orgTier":"state"}
{"path":"woj:opolskie","name":"Województwo Opolskie","nameEn":"Opole Voivodeship","website":"https://www.opolskie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","smallest"],"orgTier":"state"}
{"path":"woj:podkarpackie","name":"Województwo Podkarpackie","nameEn":"Subcarpathian Voivodeship","website":"https://www.podkarpackie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship"],"orgTier":"state"}
{"path":"woj:podlaskie","name":"Województwo Podlaskie","nameEn":"Podlaskie Voivodeship","website":"https://www.podlaskie.eu/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship"],"orgTier":"state"}
{"path":"woj:pomorskie","name":"Województwo Pomorskie","nameEn":"Pomeranian Voivodeship","website":"https://www.pomorskie.eu/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","gdansk","port"],"orgTier":"state"}
{"path":"woj:slaskie","name":"Województwo Śląskie","nameEn":"Silesian Voivodeship","website":"https://www.slaskie.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","katowice","industrial"],"orgTier":"state"}
{"path":"woj:swietokrzyskie","name":"Województwo Świętokrzyskie","nameEn":"Świętokrzyskie Voivodeship","website":"https://www.swietokrzyskie.pro/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship"],"orgTier":"state"}
{"path":"woj:warminsko-mazurskie","name":"Województwo Warmińsko-Mazurskie","nameEn":"Warmian-Masurian Voivodeship","website":"https://www.warmia.mazury.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","lakes"],"orgTier":"state"}
{"path":"woj:wielkopolskie","name":"Województwo Wielkopolskie","nameEn":"Greater Poland Voivodeship","website":"https://www.wielkopolska.eu/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","poznan"],"orgTier":"state"}
{"path":"woj:zachodniopomorskie","name":"Województwo Zachodniopomorskie","nameEn":"West Pomeranian Voivodeship","website":"https://www.wzp.pl/","contract":"Konstytucja Art. 164","tags":["cofog:01","voivodeship","szczecin"],"orgTier":"state"}
"""
...
def task_gov_pol_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_pol_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_pol_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_pol_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_pol_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_pol_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_pol_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_pol_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_pol_seed_orgs, seedLimit)
    register = await task_gov_pol_register_dids(registerLimit)
    follow = await task_gov_pol_follow_site_deps(followLimit)
    ingest = await task_gov_pol_sync_wet_updates(ingestLimit)
    shinka = await task_gov_pol_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPol.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pol_heartbeat_tick)
