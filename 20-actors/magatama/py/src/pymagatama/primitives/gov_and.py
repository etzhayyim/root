"""AND Government states actor primitives.

This module moves the `did:web:and-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:and-state.etzhayyim.com"
DOMAIN_CODE = "and"
...
_MINISTRY_NDJSON = """\
{"path":"cap-de-govern","name":"Cap de Govern","nameEn":"Head of Government (Prime Minister)","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"portaveu-del-govern","name":"Portaveu del Govern","nameEn":"Government Spokesperson","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"finances","name":"Ministeri de Finances","nameEn":"Ministry of Finance","website":"https://www.finances.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"afers-exteriors","name":"Ministeri d Afers Exteriors","nameEn":"Ministry of Foreign Affairs","website":"https://www.exteriors.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justicia-interior","name":"Ministeri de Justicia i Interior","nameEn":"Ministry of Justice and Interior","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:03","justice","interior"],"orgTier":"ministry"}
{"path":"educacio","name":"Ministeri d Educacio","nameEn":"Ministry of Education","website":"https://www.educacio.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"salut","name":"Ministeri de Salut","nameEn":"Ministry of Health","website":"https://www.salut.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agricultura-sostenibilitat","name":"Ministeri d Agricultura i Sostenibilitat","nameEn":"Ministry of Agriculture and Sustainability","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"turisme-comerc","name":"Ministeri de Turisme i Comerc","nameEn":"Ministry of Tourism and Commerce","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:04","tourism","commerce"],"orgTier":"ministry"}
{"path":"economia-empresa","name":"Ministeri d Economia i Empresa","nameEn":"Ministry of Economy and Enterprise","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:04","economy","enterprise"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"parish:andorra-la-vella","name":"Andorra la Vella","nameEn":"Andorra la Vella Parish","website":"https://www.comuandorralavella.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish","capital"],"orgTier":"state"}
{"path":"parish:canillo","name":"Canillo","nameEn":"Canillo Parish","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:encamp","name":"Encamp","nameEn":"Encamp Parish","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:escaldes-engordany","name":"Escaldes-Engordany","nameEn":"Escaldes-Engordany Parish","website":"https://www.comuesclades.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:la-massana","name":"La Massana","nameEn":"La Massana Parish","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:ordino","name":"Ordino","nameEn":"Ordino Parish","website":"https://www.govern.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:sant-julia-de-loria","name":"Sant Julia de Loria","nameEn":"Sant Julia de Loria Parish","website":"https://www.comusantjulia.ad/","contract":"Constitucio del Principat d Andorra 1993","tags":["cofog:01","parish"],"orgTier":"state"}
"""
...
def task_gov_and_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_and_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_and_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_and_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_and_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_and_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_and_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_and_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_and_seed_orgs, seedLimit)
    register = await task_gov_and_register_dids(registerLimit)
    follow = await task_gov_and_follow_site_deps(followLimit)
    ingest = await task_gov_and_sync_wet_updates(ingestLimit)
    shinka = await task_gov_and_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAnd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_heartbeat_tick)
