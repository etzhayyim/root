...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_and_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAnd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
