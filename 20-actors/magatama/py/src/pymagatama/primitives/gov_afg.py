...
This module moves the `did:web:afg-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:afg-state.gftd.ai"
DOMAIN_CODE = "afg"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_afg_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govAfg.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
