...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mdg_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govMdg.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
