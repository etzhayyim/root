"""HND Government states actor primitives.

This module moves the `did:web:hnd-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:hnd-state.etzhayyim.com"
DOMAIN_CODE = "hnd"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gob.hn/", "contract": "Constitución 1982 Art. 235-250", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defensa", "name": "Secretaría de Estado en el Despacho de Defensa Nacional", "nameEn": "Ministry of National Defence", "website": "https://www.sedena.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "finanzas", "name": "Secretaría de Estado en el Despacho de Finanzas", "nameEn": "Ministry of Finance", "website": "https://www.sefin.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Secretaría de Estado en el Despacho de Relaciones Exteriores y Cooperación Internacional", "nameEn": "Ministry of Foreign Affairs and International Cooperation", "website": "https://www.sre.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "gobernacion", "name": "Secretaría de Estado en el Despacho de Gobernación, Justicia y Descentralización", "nameEn": "Ministry of Government, Justice and Decentralization", "website": "https://www.sgj.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "educacion", "name": "Secretaría de Estado en el Despacho de Educación", "nameEn": "Ministry of Education", "website": "https://www.se.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Secretaría de Estado en el Despacho de Salud", "nameEn": "Ministry of Health", "website": "https://www.salud.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Secretaría de Estado en el Despacho de Agricultura y Ganadería", "nameEn": "Ministry of Agriculture and Livestock", "website": "https://www.sag.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Secretaría de Estado en el Despacho de Trabajo y Seguridad Social", "nameEn": "Ministry of Labour and Social Security", "website": "https://www.trabajo.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "energia", "name": "Secretaría de Estado en el Despacho de Energía", "nameEn": "Ministry of Energy", "website": "https://www.energia.gob.hn/", "contract": "Constitución 1982", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "dept:atlantida", "name": "Departamento de Atlántida", "nameEn": "Department of Atlántida", "website": "https://www.atlantida.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:choluteca", "name": "Departamento de Choluteca", "nameEn": "Department of Choluteca", "website": "https://www.choluteca.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:colon", "name": "Departamento de Colón", "nameEn": "Department of Colón", "website": "https://www.colon.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:comayagua", "name": "Departamento de Comayagua", "nameEn": "Department of Comayagua", "website": "https://www.comayagua.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:copan", "name": "Departamento de Copán", "nameEn": "Department of Copán", "website": "https://www.copan.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:cortes", "name": "Departamento de Cortés", "nameEn": "Department of Cortés", "website": "https://www.cortes.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:el-paraiso", "name": "Departamento de El Paraíso", "nameEn": "Department of El Paraíso", "website": "https://www.elparaiso.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:francisco-morazan", "name": "Departamento de Francisco Morazán", "nameEn": "Department of Francisco Morazán", "website": "https://www.franciscomorazan.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:gracias-a-dios", "name": "Departamento de Gracias a Dios", "nameEn": "Department of Gracias a Dios", "website": "https://www.graciasdios.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:intibuca", "name": "Departamento de Intibucá", "nameEn": "Department of Intibucá", "website": "https://www.intibuca.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:islas-de-la-bahia", "name": "Departamento de Islas de la Bahía", "nameEn": "Department of Bay Islands", "website": "https://www.islasdebahia.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:la-paz", "name": "Departamento de La Paz", "nameEn": "Department of La Paz", "website": "https://www.lapaz.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:lempira", "name": "Departamento de Lempira", "nameEn": "Department of Lempira", "website": "https://www.lempira.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:ocotepeque", "name": "Departamento de Ocotepeque", "nameEn": "Department of Ocotepeque", "website": "https://www.ocotepeque.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:olancho", "name": "Departamento de Olancho", "nameEn": "Department of Olancho", "website": "https://www.olancho.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:santa-barbara", "name": "Departamento de Santa Bárbara", "nameEn": "Department of Santa Bárbara", "website": "https://www.santabarbara.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:valle", "name": "Departamento de Valle", "nameEn": "Department of Valle", "website": "https://www.valle.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:yoro", "name": "Departamento de Yoro", "nameEn": "Department of Yoro", "website": "https://www.yoro.gob.hn/", "contract": "Constitución 1982 Art. 294-302", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str], owner_did: str = PRIMARY_DID) -> None:
    ...
    if not path or not updates:
        return
    updates["vertex_id"] = f"at://{owner_did or PRIMARY_DID}/com.etzhayyim.apps.states.govOrg/{path}"
...
def task_gov_hnd_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_hnd_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_hnd_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_hnd_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_hnd_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_hnd_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in all_rows:
        if r.get("site_domain_slug"):
            ...
            if not last_content_hash or not ingested_at or ingested_at < cutoff_iso:
                filtered.append(r)
...
async def task_gov_hnd_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_hnd_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_hnd_seed_orgs, seedLimit)
    register = await task_gov_hnd_register_dids(registerLimit)
    follow = await task_gov_hnd_follow_site_deps(followLimit)
    ingest = await task_gov_hnd_sync_wet_updates(ingestLimit)
    shinka = await task_gov_hnd_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHnd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hnd_heartbeat_tick)
