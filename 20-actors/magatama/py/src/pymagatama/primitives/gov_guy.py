"""GUY Government states actor primitives.

This module moves the `did:web:guy-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:guy-state.etzhayyim.com"
DOMAIN_CODE = "guy"
...
_MINISTRY_NDJSON = """\
{"path": "president", "name": "Office of the President", "nameEn": "Office of the President", "website": "https://www.op.gov.gy/", "contract": "Constitution 1980 Art. 89-106", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defence", "name": "Ministry of Home Affairs", "nameEn": "Ministry of Home Affairs", "website": "https://www.moha.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "finance", "name": "Ministry of Finance", "nameEn": "Ministry of Finance", "website": "https://www.finance.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "foreign", "name": "Ministry of Foreign Affairs and International Cooperation", "nameEn": "Ministry of Foreign Affairs and International Cooperation", "website": "https://www.minfor.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "legal", "name": "Attorney General and Minister of Legal Affairs", "nameEn": "Ministry of Legal Affairs", "website": "https://www.agla.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "education", "name": "Ministry of Education", "nameEn": "Ministry of Education", "website": "https://www.moe.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "health", "name": "Ministry of Health", "nameEn": "Ministry of Health", "website": "https://www.health.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agriculture", "name": "Ministry of Agriculture", "nameEn": "Ministry of Agriculture", "website": "https://www.agriculture.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "labour", "name": "Ministry of Labour", "nameEn": "Ministry of Labour", "website": "https://www.labour.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:10", "labour"], "orgTier": "ministry"}
{"path": "natural-resources", "name": "Ministry of Natural Resources", "nameEn": "Ministry of Natural Resources", "website": "https://www.mnre.gov.gy/", "contract": "Constitution 1980", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "region:barima-waini", "name": "Barima-Waini Regional Democratic Council", "nameEn": "Barima-Waini Region", "website": "https://www.regionone.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:pomeroon-supenaam", "name": "Pomeroon-Supenaam Regional Democratic Council", "nameEn": "Pomeroon-Supenaam Region", "website": "https://www.regiontwo.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:essequibo-west-demerara", "name": "Essequibo Islands-West Demerara Regional Democratic Council", "nameEn": "Essequibo Islands-West Demerara Region", "website": "https://www.regionthree.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:demerara-mahaica", "name": "Demerara-Mahaica Regional Democratic Council", "nameEn": "Demerara-Mahaica Region", "website": "https://www.regionfour.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:mahaica-berbice", "name": "Mahaica-Berbice Regional Democratic Council", "nameEn": "Mahaica-Berbice Region", "website": "https://www.regionfive.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:east-berbice-corentyne", "name": "East Berbice-Corentyne Regional Democratic Council", "nameEn": "East Berbice-Corentyne Region", "website": "https://www.regionsix.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:cuyuni-mazaruni", "name": "Cuyuni-Mazaruni Regional Democratic Council", "nameEn": "Cuyuni-Mazaruni Region", "website": "https://www.regionseven.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:potaro-siparuni", "name": "Potaro-Siparuni Regional Democratic Council", "nameEn": "Potaro-Siparuni Region", "website": "https://www.regioneight.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:upper-takutu", "name": "Upper Takutu-Upper Essequibo Regional Democratic Council", "nameEn": "Upper Takutu-Upper Essequibo Region", "website": "https://www.regionnine.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:upper-demerara", "name": "Upper Demerara-Berbice Regional Democratic Council", "nameEn": "Upper Demerara-Berbice Region", "website": "https://www.regionten.gov.gy/", "contract": "Constitution 1980 Art. 72-78", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_guy_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_guy_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_guy_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_guy_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_guy_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_guy_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in all_rows:
        if r.get("site_domain_slug"):
            lch = r.get("last_content_hash")
            lia = r.get("last_ingested_at")
            if not lch or not lia or str(lia) < cutoff_iso:
                filtered.append(r)
...
async def task_gov_guy_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_guy_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_guy_seed_orgs, seedLimit)
    register = await task_gov_guy_register_dids(registerLimit)
    follow = await task_gov_guy_follow_site_deps(followLimit)
    ingest = await task_gov_guy_sync_wet_updates(ingestLimit)
    shinka = await task_gov_guy_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGuy.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_guy_heartbeat_tick)
