"""HTI Government states actor primitives.

This module moves the `did:web:hti-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:hti-state.etzhayyim.com"
DOMAIN_CODE = "hti"
...
_MINISTRY_NDJSON = """\
{"path": "presidence", "name": "Présidence de la République", "nameEn": "Presidency of the Republic", "website": "https://www.gouvernement.ht/", "contract": "Constitution 1987 Art. 133-149", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defense", "name": "Ministère de la Défense Nationale", "nameEn": "Ministry of National Defence", "website": "https://www.mdn.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "finances", "name": "Ministère de l'Économie et des Finances", "nameEn": "Ministry of Economy and Finance", "website": "https://www.mef.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministère des Affaires Étrangères", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.mae.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "justice", "name": "Ministère de la Justice et de la Sécurité Publique", "nameEn": "Ministry of Justice and Public Security", "website": "https://www.mjsp.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "interieur", "name": "Ministère de l'Intérieur et des Collectivités Territoriales", "nameEn": "Ministry of Interior and Territorial Communities", "website": "https://www.mict.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "education", "name": "Ministère de l'Éducation Nationale et de la Formation Professionnelle", "nameEn": "Ministry of National Education and Vocational Training", "website": "https://www.menfp.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "sante", "name": "Ministère de la Santé Publique et de la Population", "nameEn": "Ministry of Public Health and Population", "website": "https://www.mspp.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agriculture", "name": "Ministère de l'Agriculture, des Ressources Naturelles et du Développement Rural", "nameEn": "Ministry of Agriculture, Natural Resources and Rural Development", "website": "https://www.marndr.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "travail", "name": "Ministère des Affaires Sociales et du Travail", "nameEn": "Ministry of Social Affairs and Labour", "website": "https://www.mast.gouv.ht/", "contract": "Constitution 1987", "tags": ["cofog:10", "labour"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "dept:artibonite", "name": "Département de l'Artibonite", "nameEn": "Département of Artibonite", "website": "https://www.artibonite.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:centre", "name": "Département du Centre", "nameEn": "Département of Centre", "website": "https://www.centre.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:grand-anse", "name": "Département de la Grand'Anse", "nameEn": "Département of Grand'Anse", "website": "https://www.grandanse.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:nippes", "name": "Département des Nippes", "nameEn": "Département of Nippes", "website": "https://www.nippes.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:nord", "name": "Département du Nord", "nameEn": "Département of Nord", "website": "https://www.nord.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:nord-est", "name": "Département du Nord-Est", "nameEn": "Département of Nord-Est", "website": "https://www.nordest.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:nord-ouest", "name": "Département du Nord-Ouest", "nameEn": "Département of Nord-Ouest", "website": "https://www.nordouest.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:ouest", "name": "Département de l'Ouest", "nameEn": "Département of Ouest", "website": "https://www.ouest.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:sud", "name": "Département du Sud", "nameEn": "Département of Sud", "website": "https://www.sud.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:sud-est", "name": "Département du Sud-Est", "nameEn": "Département of Sud-Est", "website": "https://www.sudest.gouv.ht/", "contract": "Constitution 1987 Art. 75-87.5", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_hti_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_hti_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_hti_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_hti_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_hti_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_hti_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_hti_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_hti_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_hti_seed_orgs, seedLimit)
    register = await task_gov_hti_register_dids(registerLimit)
    follow = await task_gov_hti_follow_site_deps(followLimit)
    ingest = await task_gov_hti_sync_wet_updates(ingestLimit)
    shinka = await task_gov_hti_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHti.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hti_heartbeat_tick)
