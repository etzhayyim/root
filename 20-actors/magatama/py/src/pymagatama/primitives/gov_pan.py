"""PAN Government states actor primitives.

This module moves the `did:web:pan-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:pan-state.etzhayyim.com"
DOMAIN_CODE = "pan"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gob.pa/", "contract": "Constitución 1972/2004 Art. 177-200", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "seguridad", "name": "Ministerio de Seguridad Pública", "nameEn": "Ministry of Public Security", "website": "https://www.minseg.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "economia", "name": "Ministerio de Economía y Finanzas", "nameEn": "Ministry of Economy and Finance", "website": "https://www.mef.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.mire.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "gobierno", "name": "Ministerio de Gobierno", "nameEn": "Ministry of Government", "website": "https://www.mingob.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación", "nameEn": "Ministry of Education", "website": "https://www.meduca.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud", "nameEn": "Ministry of Health", "website": "https://www.minsa.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio de Desarrollo Agropecuario", "nameEn": "Ministry of Agricultural Development", "website": "https://www.mida.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Ministerio de Trabajo y Desarrollo Laboral", "nameEn": "Ministry of Labour and Workforce Development", "website": "https://www.mitradel.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "comercio", "name": "Ministerio de Comercio e Industrias", "nameEn": "Ministry of Commerce and Industries", "website": "https://www.mici.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "ambiente", "name": "Ministerio de Ambiente", "nameEn": "Ministry of the Environment", "website": "https://www.miambiente.gob.pa/", "contract": "Constitución 1972/2004", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "prov:bocas-del-toro", "name": "Provincia de Bocas del Toro", "nameEn": "Province of Bocas del Toro", "website": "https://www.bocasdeltoro.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:chiriqui", "name": "Provincia de Chiriquí", "nameEn": "Province of Chiriquí", "website": "https://www.chiriqui.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:cocle", "name": "Provincia de Coclé", "nameEn": "Province of Coclé", "website": "https://www.cocle.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:colon", "name": "Provincia de Colón", "nameEn": "Province of Colón", "website": "https://www.colon.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:darien", "name": "Provincia de Darién", "nameEn": "Province of Darién", "website": "https://www.darien.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:herrera", "name": "Provincia de Herrera", "nameEn": "Province of Herrera", "website": "https://www.herrera.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:los-santos", "name": "Provincia de Los Santos", "nameEn": "Province of Los Santos", "website": "https://www.lossantos.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:panama", "name": "Provincia de Panamá", "nameEn": "Province of Panamá", "website": "https://www.panama.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:panama-oeste", "name": "Provincia de Panamá Oeste", "nameEn": "Province of Panama Oeste", "website": "https://www.panamaeste.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:veraguas", "name": "Provincia de Veraguas", "nameEn": "Province of Veraguas", "website": "https://www.veraguas.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "comarca:kuna-yala", "name": "Comarca Kuna Yala (Guna Yala)", "nameEn": "Guna Yala Comarca", "website": "https://www.gunayala.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "comarca:embera", "name": "Comarca Emberá-Wounaan", "nameEn": "Emberá-Wounaan Comarca", "website": "https://www.embera.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "comarca:ngabe-bugle", "name": "Comarca Ngäbe-Buglé", "nameEn": "Ngäbe-Buglé Comarca", "website": "https://www.ngabebugle.gob.pa/", "contract": "Constitución 1972/2004 Art. 5 + Comarcas indígenas", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str]) -> None:
    ...
    if not path or not updates:
        return
    # R0: fetched row to apply partial update in-Python
...
def task_gov_pan_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: fetch broader set and filter in-Python
...
def task_gov_pan_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_pan_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: in-Python filter, count, sort, and pagination
...
async def task_gov_pan_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_pan_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_pan_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in page:
        ...
        # R0: fetch all wet chunks for domain, sort and get latest
        all_wets = get_kotoba_client().select_where("vertex_wet_chunk", "domain", slug, limit=100)
        wet = max(all_wets, key=lambda x: str(x.get("crawled_at") or "")) if all_wets else None
...
async def task_gov_pan_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_pan_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_pan_seed_orgs, seedLimit)
    register = await task_gov_pan_register_dids(registerLimit)
    follow = await task_gov_pan_follow_site_deps(followLimit)
    ingest = await task_gov_pan_sync_wet_updates(ingestLimit)
    shinka = await task_gov_pan_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPan.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_heartbeat_tick)
