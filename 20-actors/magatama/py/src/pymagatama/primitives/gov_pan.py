...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govPan.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pan_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govPan.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
