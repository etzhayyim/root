"""GHA Government states actor primitives.

This module moves the `did:web:gha-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:gha-state.etzhayyim.com"
DOMAIN_CODE = "gha"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Office of the President","nameEn":"Office of the President","website":"https://presidency.gov.gh/","contract":"Constitution of Ghana 1992 Art. 57","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"mfa","name":"Ministry of Foreign Affairs and Regional Integration","nameEn":"Ministry of Foreign Affairs and Regional Integration","website":"https://mfa.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://mod.gov.gh/","contract":"Constitution of Ghana 1992 Art. 210","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Ministry of Finance","nameEn":"Ministry of Finance","website":"https://www.mofep.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"ag","name":"Attorney General's Department","nameEn":"Attorney General's Department","website":"https://www.agd.gov.gh/","contract":"Constitution of Ghana 1992 Art. 88","tags":["cofog:03","justice","attorney-general"],"orgTier":"ministry"}
{"path":"moi","name":"Ministry of the Interior","nameEn":"Ministry of the Interior","website":"https://interior.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://moe.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.moh.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"melr","name":"Ministry of Employment and Labour Relations","nameEn":"Ministry of Employment and Labour Relations","website":"https://melr.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:04","labour","employment"],"orgTier":"ministry"}
{"path":"moti","name":"Ministry of Trade and Industry","nameEn":"Ministry of Trade and Industry","website":"https://moti.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:04","trade","industry"],"orgTier":"ministry"}
{"path":"mofa-agri","name":"Ministry of Food and Agriculture","nameEn":"Ministry of Food and Agriculture","website":"https://mofa.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:04.2","agriculture","food"],"orgTier":"ministry"}
{"path":"menv","name":"Ministry of Environment, Science, Technology and Innovation","nameEn":"Ministry of Environment, Science, Technology and Innovation","website":"https://mesti.gov.gh/","contract":"Constitution of Ghana 1992","tags":["cofog:05","environment","science","technology"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:greater-accra","name":"Greater Accra Region","nameEn":"Greater Accra Region","website":"https://greateraccra.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region","capital"],"orgTier":"state"}
{"path":"region:ashanti","name":"Ashanti Region","nameEn":"Ashanti Region","website":"https://ashanti.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:western","name":"Western Region","nameEn":"Western Region","website":"https://western.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:central","name":"Central Region","nameEn":"Central Region","website":"https://central.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:eastern","name":"Eastern Region","nameEn":"Eastern Region","website":"https://eastern.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:northern","name":"Northern Region","nameEn":"Northern Region","website":"https://northern.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:volta","name":"Volta Region","nameEn":"Volta Region","website":"https://volta.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:upper-east","name":"Upper East Region","nameEn":"Upper East Region","website":"https://uppereast.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:upper-west","name":"Upper West Region","nameEn":"Upper West Region","website":"https://upperwest.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:brong-ahafo","name":"Bono Region","nameEn":"Bono Region","website":"https://bono.ghregions.gov.gh/","contract":"Constitution of Ghana 1992 Ch. 20","tags":["cofog:01","region"],"orgTier":"state"}
"""
...
def task_gov_gha_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_gha_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_gha_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_gha_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_gha_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_gha_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_gha_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_gha_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_gha_seed_orgs, seedLimit)
    register = await task_gov_gha_register_dids(registerLimit)
    follow = await task_gov_gha_follow_site_deps(followLimit)
    ingest = await task_gov_gha_sync_wet_updates(ingestLimit)
    shinka = await task_gov_gha_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGha.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_gha_heartbeat_tick)
