...
def _topic_vertex_id(topic_id: str) -> str:
    return f"at://{_LIFEHACK_ACTOR}/ai.gftd.apps.lifehack.topic/{_slug(topic_id)}"


def _tip_vertex_id(tip_id: str) -> str:
    return f"at://{_LIFEHACK_ACTOR}/ai.gftd.apps.lifehack.tip/{tip_id}"


def _product_vertex_id(product_id: str) -> str:
    return f"at://{_LIFEHACK_ACTOR}/ai.gftd.apps.lifehack.product/{product_id}"


def _post_log_vertex_id(post_id: str) -> str:
    return f"at://{_LIFEHACK_ACTOR}/ai.gftd.apps.lifehack.postLog/{post_id}"


def _reading_vertex_id(reading_id: str) -> str:
    return f"at://{_LIFEHACK_ACTOR}/ai.gftd.apps.lifehack.environmentReading/{reading_id}"
