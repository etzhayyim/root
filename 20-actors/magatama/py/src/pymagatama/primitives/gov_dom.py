...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govDom.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
