"""DOM Government states actor primitives.

This module moves the `did:web:dom-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:dom-state.etzhayyim.com"
DOMAIN_CODE = "dom"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gob.do/", "contract": "Constitución 2010 Art. 128-155", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "defensa", "name": "Ministerio de las Fuerzas Armadas", "nameEn": "Ministry of Armed Forces", "website": "https://www.mide.mil.do/", "contract": "Constitución 2010", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "hacienda", "name": "Ministerio de Hacienda", "nameEn": "Ministry of Finance", "website": "https://www.hacienda.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.mirex.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "interior", "name": "Ministerio de Interior y Policía", "nameEn": "Ministry of Interior and Police", "website": "https://www.mip.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "justicia", "name": "Ministerio de Justicia", "nameEn": "Ministry of Justice", "website": "https://www.poderjudicial.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:03", "justice"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación", "nameEn": "Ministry of Education", "website": "https://www.ministeriodeeducacion.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud Pública", "nameEn": "Ministry of Public Health", "website": "https://www.msp.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio de Agricultura", "nameEn": "Ministry of Agriculture", "website": "https://www.agricultura.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "industria", "name": "Ministerio de Industria, Comercio y Mipymes", "nameEn": "Ministry of Industry, Commerce and MSMEs", "website": "https://www.micm.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:01"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Ministerio de Trabajo", "nameEn": "Ministry of Labour", "website": "https://www.mt.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:10", "labour"], "orgTier": "ministry"}
{"path": "obras", "name": "Ministerio de Obras Públicas y Comunicaciones", "nameEn": "Ministry of Public Works and Communications", "website": "https://www.mopc.gob.do/", "contract": "Constitución 2010", "tags": ["cofog:01"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "prov:azua", "name": "Provincia de Azua", "nameEn": "Province of Azua", "website": "https://www.azua.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:bahoruco", "name": "Provincia de Bahoruco", "nameEn": "Province of Bahoruco", "website": "https://www.bahoruco.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:barahona", "name": "Provincia de Barahona", "nameEn": "Province of Barahona", "website": "https://www.barahona.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:dajabon", "name": "Provincia de Dajabón", "nameEn": "Province of Dajabón", "website": "https://www.dajabon.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:duarte", "name": "Provincia de Duarte", "nameEn": "Province of Duarte", "website": "https://www.duarte.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:elias-pina", "name": "Provincia de Elías Piña", "nameEn": "Province of Elías Piña", "website": "https://www.eliaspina.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:el-seibo", "name": "Provincia de El Seibo", "nameEn": "Province of El Seibo", "website": "https://www.elseibo.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:espaillat", "name": "Provincia de Espaillat", "nameEn": "Province of Espaillat", "website": "https://www.espaillat.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:la-altagracia", "name": "Provincia de La Altagracia", "nameEn": "Province of La Altagracia", "website": "https://www.laaltagracia.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:la-romana", "name": "Provincia de La Romana", "nameEn": "Province of La Romana", "website": "https://www.laromana.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:la-vega", "name": "Provincia de La Vega", "nameEn": "Province of La Vega", "website": "https://www.lavega.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:santiago", "name": "Provincia de Santiago", "nameEn": "Province of Santiago", "website": "https://www.santiago.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:santo-domingo", "name": "Provincia de Santo Domingo", "nameEn": "Province of Santo Domingo", "website": "https://www.santodomingo.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "prov:distrito-nacional", "name": "Distrito Nacional", "nameEn": "National District", "website": "https://www.adn.gob.do/", "contract": "Constitución 2010 Art. 196-200", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str], owner_did: str = PRIMARY_DID) -> None:
    ...
    if not path or not updates:
        return
    v_id = f"at://{owner_did or PRIMARY_DID}/com.etzhayyim.apps.states.govOrg/{path}"
    params: dict[str, Any] = {
        "vertex_id": v_id,
        "domain_code": DOMAIN_CODE,
...
def task_gov_dom_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: fetch broader set, filter, order, limit in Python
    _rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=10000)
    existing = {str(r.get("path") or "") for r in _rows if r.get("owner_did") == PRIMARY_DID and r.get("name_en")}
...
def task_gov_dom_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_dom_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: fetch broader set, filter, order, and count in Python
    _rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [r for r in _rows if r.get("owner_did") == PRIMARY_DID and r.get("name_en")]
    if org_tier:
...
async def task_gov_dom_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_dom_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_dom_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    filtered = [
        ...
        and (not r.get("last_content_hash") or not r.get("last_ingested_at") or str(r.get("last_ingested_at")) < cutoff_iso)
    ]
    ...
    for r in rows:
        ...
        checked += 1
        # R0:
        _wet_rows = get_kotoba_client().select_where("vertex_wet_chunk", "domain", slug, limit=100)
        _wet_rows.sort(key=lambda rw: str(rw.get("crawled_at") or ""), reverse=True)
        wet = _wet_rows[0] if _wet_rows else None
        if not wet:
...
async def task_gov_dom_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_dom_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_dom_seed_orgs, seedLimit)
    register = await task_gov_dom_register_dids(registerLimit)
    follow = await task_gov_dom_follow_site_deps(followLimit)
    ingest = await task_gov_dom_sync_wet_updates(ingestLimit)
    shinka = await task_gov_dom_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDom.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_dom_heartbeat_tick)
