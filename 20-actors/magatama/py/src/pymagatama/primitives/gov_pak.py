...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govPak.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
