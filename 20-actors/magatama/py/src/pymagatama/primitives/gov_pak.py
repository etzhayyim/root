"""PAK Government states actor primitives.

This module moves the `did:web:pak-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:pak-state.etzhayyim.com"
DOMAIN_CODE = "pak"
...
_MINISTRY_NDJSON = """\
{"path":"pm-office","name":"وزیر اعظم آفس","nameEn":"Prime Minister's Office","website":"https://www.pmo.gov.pk/","contract":"Constitution of Pakistan 1973 Art. 90","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mofa","name":"وزارت خارجہ","nameEn":"Ministry of Foreign Affairs","website":"https://mofa.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"وزارت دفاع","nameEn":"Ministry of Defence","website":"https://www.mod.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"وزارت خزانہ","nameEn":"Ministry of Finance","website":"https://www.finance.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"mola","name":"وزارت قانون و انصاف","nameEn":"Ministry of Law and Justice","website":"https://molaw.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:03","justice","law"],"orgTier":"ministry"}
{"path":"moib","name":"وزارت داخلہ","nameEn":"Ministry of Interior","website":"https://www.interior.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"وزارت وفاقی تعلیم و پیشہ ورانہ تربیت","nameEn":"Ministry of Federal Education and Professional Training","website":"https://www.mofept.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:09","education","training"],"orgTier":"ministry"}
{"path":"nhsrc","name":"وزارت قومی صحت خدمات","nameEn":"Ministry of National Health Services, Regulations and Coordination","website":"https://www.nhsrc.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mohr","name":"وزارت سمندر پار پاکستانی و ترقی انسانی وسائل","nameEn":"Ministry of Overseas Pakistanis and Human Resource Development","website":"https://www.moophe.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:04","labour","overseas"],"orgTier":"ministry"}
{"path":"moitt","name":"وزارت انفارمیشن ٹیکنالوجی","nameEn":"Ministry of IT and Telecom","website":"https://www.moitt.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:04","digital","telecom"],"orgTier":"ministry"}
{"path":"mofsa","name":"وزارت غذائی تحفظ و تحقیق","nameEn":"Ministry of National Food Security and Research","website":"https://mnfsr.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:04.2","agriculture","food-security"],"orgTier":"ministry"}
{"path":"mocc","name":"وزارت موسمیاتی تبدیلی","nameEn":"Ministry of Climate Change","website":"https://www.mocc.gov.pk/","contract":"Constitution of Pakistan 1973","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:punjab","name":"پنجاب","nameEn":"Punjab","website":"https://punjab.gov.pk/","contract":"Constitution of Pakistan 1973 Art. 1","tags":["cofog:01","province","largest"],"orgTier":"state"}
{"path":"prov:sindh","name":"سندھ","nameEn":"Sindh","website":"https://www.sindh.gov.pk/","contract":"Constitution of Pakistan 1973 Art. 1","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:khyber-pakhtunkhwa","name":"خیبر پختونخوا","nameEn":"Khyber Pakhtunkhwa","website":"https://www.kp.gov.pk/","contract":"Constitution of Pakistan 1973 Art. 1","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:balochistan","name":"بلوچستان","nameEn":"Balochistan","website":"https://balochistan.gov.pk/","contract":"Constitution of Pakistan 1973 Art. 1","tags":["cofog:01","province","largest-area"],"orgTier":"state"}
{"path":"prov:gilgit-baltistan","name":"گلگت بلتستان","nameEn":"Gilgit-Baltistan","website":"https://www.gb.gov.pk/","contract":"Gilgit-Baltistan Order 2018","tags":["cofog:01","territory"],"orgTier":"state"}
{"path":"prov:azad-kashmir","name":"آزاد جموں و کشمیر","nameEn":"Azad Jammu and Kashmir","website":"https://ajk.gov.pk/","contract":"AJK Interim Constitution Act 1974","tags":["cofog:01","territory","autonomous"],"orgTier":"state"}
{"path":"prov:islamabad","name":"اسلام آباد","nameEn":"Islamabad Capital Territory","website":"https://www.islamabad.gov.pk/","contract":"Constitution of Pakistan 1973 Art. 1","tags":["cofog:01","territory","capital"],"orgTier":"state"}
"""
...
def task_gov_pak_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_pak_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_pak_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_pak_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_pak_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_pak_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_pak_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_pak_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_pak_seed_orgs, seedLimit)
    register = await task_gov_pak_register_dids(registerLimit)
    follow = await task_gov_pak_follow_site_deps(followLimit)
    ingest = await task_gov_pak_sync_wet_updates(ingestLimit)
    shinka = await task_gov_pak_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPak.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_pak_heartbeat_tick)
