"""ZMB Government states actor primitives.

This module moves the `did:web:zmb-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:zmb-state.etzhayyim.com"
DOMAIN_CODE = "zmb"
...
_MINISTRY_NDJSON = """\
{"path":"state-house","name":"State House","nameEn":"State House (Office of the President)","website":"https://www.statehouse.gov.zm/","contract":"Constitution of Zambia 2016 Art. 91","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"mofa","name":"Ministry of Foreign Affairs and International Cooperation","nameEn":"Ministry of Foreign Affairs and International Cooperation","website":"https://www.mfa.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01.2","foreign-affairs","international-cooperation"],"orgTier":"ministry"}
{"path":"mod","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://www.mod.gov.zm/","contract":"Constitution of Zambia 2016 Art. 200","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Ministry of Finance and National Planning","nameEn":"Ministry of Finance and National Planning","website":"https://www.mof.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01.1","finance","national-planning"],"orgTier":"ministry"}
{"path":"moj","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.moj.gov.zm/","contract":"Constitution of Zambia 2016 Art. 180","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mha","name":"Ministry of Home Affairs and Internal Security","nameEn":"Ministry of Home Affairs and Internal Security","website":"https://www.mha.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:03","home-affairs","internal-security"],"orgTier":"ministry"}
{"path":"moge","name":"Ministry of General Education","nameEn":"Ministry of General Education","website":"https://www.moge.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.moh.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mlss","name":"Ministry of Labour and Social Security","nameEn":"Ministry of Labour and Social Security","website":"https://www.mlss.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:04","labour","social-security"],"orgTier":"ministry"}
{"path":"mct","name":"Ministry of Commerce, Trade and Industry","nameEn":"Ministry of Commerce, Trade and Industry","website":"https://www.mcti.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:04","commerce","trade","industry"],"orgTier":"ministry"}
{"path":"mald","name":"Ministry of Agriculture and Livestock Development","nameEn":"Ministry of Agriculture and Livestock Development","website":"https://www.mald.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:04.2","agriculture","livestock"],"orgTier":"ministry"}
{"path":"mwnr","name":"Ministry of Water Development and Sanitation","nameEn":"Ministry of Water Development and Sanitation","website":"https://www.mwds.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:05","water","sanitation","environment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"province:lusaka","name":"Lusaka Province","nameEn":"Lusaka Province","website":"https://www.lusaka.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","capital"],"orgTier":"state"}
{"path":"province:copperbelt","name":"Copperbelt Province","nameEn":"Copperbelt Province","website":"https://www.copperbelt.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","mining","copper"],"orgTier":"state"}
{"path":"province:southern","name":"Southern Province","nameEn":"Southern Province","website":"https://www.southern.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","southern","victoria-falls"],"orgTier":"state"}
{"path":"province:eastern","name":"Eastern Province","nameEn":"Eastern Province","website":"https://www.eastern.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","eastern","agriculture"],"orgTier":"state"}
{"path":"province:northern","name":"Northern Province","nameEn":"Northern Province","website":"https://www.northern.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","northern","tanganyika"],"orgTier":"state"}
{"path":"province:central","name":"Central Province","nameEn":"Central Province","website":"https://www.central.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","central"],"orgTier":"state"}
{"path":"province:western","name":"Western Province","nameEn":"Western Province","website":"https://www.western.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","western","barotseland"],"orgTier":"state"}
{"path":"province:north-western","name":"North-Western Province","nameEn":"North-Western Province","website":"https://www.northwestern.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","north-western","copper"],"orgTier":"state"}
{"path":"province:luapula","name":"Luapula Province","nameEn":"Luapula Province","website":"https://www.luapula.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","luapula","fishing"],"orgTier":"state"}
{"path":"province:muchinga","name":"Muchinga Province","nameEn":"Muchinga Province","website":"https://www.muchinga.gov.zm/","contract":"Constitution of Zambia 2016","tags":["cofog:01","province","muchinga","north-eastern"],"orgTier":"state"}
"""
...
def task_gov_zmb_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_zmb_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_zmb_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_zmb_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_zmb_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_zmb_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_zmb_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_zmb_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_zmb_seed_orgs, seedLimit)
    register = await task_gov_zmb_register_dids(registerLimit)
    follow = await task_gov_zmb_follow_site_deps(followLimit)
    ingest = await task_gov_zmb_sync_wet_updates(ingestLimit)
    shinka = await task_gov_zmb_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govZmb.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_zmb_heartbeat_tick)
