"""SVN Government states actor primitives.

This module moves the `did:web:svn-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:svn-state.etzhayyim.com"
DOMAIN_CODE = "svn"
...
_MINISTRY_NDJSON = """\
{"path":"uv","name":"Urad Vlade Republike Slovenije","nameEn":"Government Office of the Republic of Slovenia","website":"https://www.gov.si/","contract":"Ustava Art. 110","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mzz","name":"Ministrstvo za zunanje zadeve","nameEn":"Ministry of Foreign Affairs","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-zunanje-zadeve/","contract":"Ustava Art. 8","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"mors","name":"Ministrstvo za obrambo","nameEn":"Ministry of Defence","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-obrambo/","contract":"Ustava Art. 123","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mf","name":"Ministrstvo za finance","nameEn":"Ministry of Finance","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-finance/","contract":"Ustava Art. 147","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"mp","name":"Ministrstvo za pravosodje","nameEn":"Ministry of Justice","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-pravosodje/","contract":"Ustava Art. 23","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mnz","name":"Ministrstvo za notranje zadeve","nameEn":"Ministry of the Interior","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-notranje-zadeve/","contract":"Ustava Art. 5","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"mizs","name":"Ministrstvo za izobraževanje, znanost in šport","nameEn":"Ministry of Education, Science and Sport","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-izobrazevanje-in-sport/","contract":"Ustava Art. 57","tags":["cofog:09","education","science","sport"],"orgTier":"ministry"}
{"path":"mz","name":"Ministrstvo za zdravje","nameEn":"Ministry of Health","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-zdravje/","contract":"Ustava Art. 51","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mddsz","name":"Ministrstvo za delo, družino, socialne zadeve in enake možnosti","nameEn":"Ministry of Labour, Family, Social Affairs and Equal Opportunities","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-delo-druzino-socialne-zadeve-in-enake-moznosti/","contract":"Ustava Art. 50","tags":["cofog:04","labour","social","family"],"orgTier":"ministry"}
{"path":"mkgp","name":"Ministrstvo za kmetijstvo, gozdarstvo in prehrano","nameEn":"Ministry of Agriculture, Forestry and Food","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-kmetijstvo-gozdarstvo-in-prehrano/","contract":"Ustava Art. 73","tags":["cofog:04.2","agriculture","forestry","food"],"orgTier":"ministry"}
{"path":"mzi","name":"Ministrstvo za infrastrukturo","nameEn":"Ministry of Infrastructure","website":"https://www.gov.si/drzavni-organi/ministrstva/ministrstvo-za-infrastrukturo/","contract":"Ustava Art. 43","tags":["cofog:04.5","infrastructure","transport","energy"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"regija:pomurska","name":"Pomurska statistična regija","nameEn":"Pomurje Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","northeast"],"orgTier":"state"}
{"path":"regija:podravska","name":"Podravska statistična regija","nameEn":"Drava Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","maribor"],"orgTier":"state"}
{"path":"regija:koroska","name":"Koroška statistična regija","nameEn":"Carinthia Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"regija:savinjska","name":"Savinjska statistična regija","nameEn":"Savinja Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","celje"],"orgTier":"state"}
{"path":"regija:zasavska","name":"Zasavska statistična regija","nameEn":"Central Sava Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","industrial"],"orgTier":"state"}
{"path":"regija:posavska","name":"Posavska statistična regija","nameEn":"Lower Sava Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"regija:jugovzhodna","name":"Jugovzhodna Slovenija statistična regija","nameEn":"Southeast Slovenia Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","novo-mesto"],"orgTier":"state"}
{"path":"regija:primorsko-notranjska","name":"Primorsko-notranjska statistična regija","nameEn":"Littoral-Inner Carniola Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region"],"orgTier":"state"}
{"path":"regija:gorenska","name":"Gorenjska statistična regija","nameEn":"Upper Carniola Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","alps","kranj"],"orgTier":"state"}
{"path":"regija:goriska","name":"Goriška statistična regija","nameEn":"Gorizia Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","nova-gorica"],"orgTier":"state"}
{"path":"regija:obalno-kraska","name":"Obalno-kraška statistična regija","nameEn":"Coastal-Karst Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","coast","koper"],"orgTier":"state"}
{"path":"regija:osrednjeslovenska","name":"Osrednjeslovenska statistična regija","nameEn":"Central Slovenia Statistical Region","website":"https://www.gov.si/","contract":"Ustava Art. 143","tags":["cofog:01","statistical-region","capital","ljubljana"],"orgTier":"state"}
"""
...
def task_gov_svn_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_svn_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_svn_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_svn_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_svn_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_svn_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_svn_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_svn_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_svn_seed_orgs, seedLimit)
    register = await task_gov_svn_register_dids(registerLimit)
    follow = await task_gov_svn_follow_site_deps(followLimit)
    ingest = await task_gov_svn_sync_wet_updates(ingestLimit)
    shinka = await task_gov_svn_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSvn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_svn_heartbeat_tick)
