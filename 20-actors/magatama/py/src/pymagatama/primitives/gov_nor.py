...
This module moves the `did:web:nor-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:nor-state.gftd.ai"
DOMAIN_CODE = "nor"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govNor.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nor_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govNor.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
