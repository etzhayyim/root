...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govUkr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
