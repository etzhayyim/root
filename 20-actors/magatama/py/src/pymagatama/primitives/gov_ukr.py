"""UKR Government states actor primitives.

This module moves the `did:web:ukr-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:ukr-state.etzhayyim.com"
DOMAIN_CODE = "ukr"
...
_MINISTRY_NDJSON = """\
{"path":"kmu","name":"Кабінет Міністрів України","nameEn":"Cabinet of Ministers of Ukraine","website":"https://www.kmu.gov.ua/","contract":"Конституція України ст. 113","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"mfa","name":"Міністерство закордонних справ","nameEn":"Ministry of Foreign Affairs","website":"https://mfa.gov.ua/","contract":"Конституція ст. 116","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Міністерство оборони","nameEn":"Ministry of Defence","website":"https://www.mil.gov.ua/","contract":"Конституція ст. 17","tags":["cofog:02","defence","nato-candidate"],"orgTier":"ministry"}
{"path":"mof","name":"Міністерство фінансів","nameEn":"Ministry of Finance","website":"https://mof.gov.ua/","contract":"Конституція ст. 96","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"Міністерство юстиції","nameEn":"Ministry of Justice","website":"https://minjust.gov.ua/","contract":"Конституція ст. 124","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mvs","name":"Міністерство внутрішніх справ","nameEn":"Ministry of Internal Affairs","website":"https://mvs.gov.ua/","contract":"Конституція ст. 102","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"mon","name":"Міністерство освіти і науки","nameEn":"Ministry of Education and Science","website":"https://mon.gov.ua/","contract":"Конституція ст. 53","tags":["cofog:09","education","science"],"orgTier":"ministry"}
{"path":"moz","name":"Міністерство охорони здоров'я","nameEn":"Ministry of Health","website":"https://moz.gov.ua/","contract":"Конституція ст. 49","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mtot","name":"Міністерство з питань реінтеграції","nameEn":"Ministry of Reintegration of Temporarily Occupied Territories","website":"https://www.minre.gov.ua/","contract":"Конституція ст. 116","tags":["cofog:01","reintegration","occupied-territories"],"orgTier":"ministry"}
{"path":"mte","name":"Міністерство економіки","nameEn":"Ministry of Economy","website":"https://www.me.gov.ua/","contract":"Конституція ст. 116","tags":["cofog:04","economy","trade"],"orgTier":"ministry"}
{"path":"mep","name":"Міністерство захисту довкілля та природних ресурсів","nameEn":"Ministry of Environmental Protection and Natural Resources","website":"https://www.mepr.gov.ua/","contract":"Конституція ст. 50","tags":["cofog:05","environment","natural-resources"],"orgTier":"ministry"}
{"path":"verkhovna-rada","name":"Верховна Рада України","nameEn":"Verkhovna Rada (Parliament)","website":"https://rada.gov.ua/","contract":"Конституція ст. 75","tags":["cofog:01","legislature"],"orgTier":"agency"}
{"path":"constitutional-court","name":"Конституційний Суд України","nameEn":"Constitutional Court of Ukraine","website":"https://ccu.gov.ua/","contract":"Конституція ст. 147","tags":["cofog:03","judiciary","constitutional-court"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"oblast:kyivska","name":"Київська область","nameEn":"Kyiv Oblast","website":"https://kyiv-obl.gov.ua/","contract":"Конституція ст. 132 + Закон про місцеве самоврядування","tags":["cofog:01","oblast","capital-region"],"orgTier":"state"}
{"path":"city:kyiv","name":"Місто Київ","nameEn":"City of Kyiv (Capital)","website":"https://kyivcity.gov.ua/","contract":"Конституція ст. 133","tags":["cofog:01","capital","city-special"],"orgTier":"state"}
{"path":"oblast:lvivska","name":"Львівська область","nameEn":"Lviv Oblast","website":"https://loda.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","western"],"orgTier":"state"}
{"path":"oblast:kharkivska","name":"Харківська область","nameEn":"Kharkiv Oblast","website":"https://kharkivoda.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","eastern"],"orgTier":"state"}
{"path":"oblast:odeska","name":"Одеська область","nameEn":"Odesa Oblast","website":"https://oda.odessa.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","southern","port"],"orgTier":"state"}
{"path":"oblast:dnipropetrovska","name":"Дніпропетровська область","nameEn":"Dnipropetrovsk Oblast","website":"https://adm.dp.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","industrial"],"orgTier":"state"}
{"path":"oblast:zaporizka","name":"Запорізька область","nameEn":"Zaporizhzhia Oblast","website":"https://zoda.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","southern","war-affected"],"orgTier":"state"}
{"path":"oblast:mykolaivska","name":"Миколаївська область","nameEn":"Mykolaiv Oblast","website":"https://mk.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","southern"],"orgTier":"state"}
{"path":"oblast:khersonska","name":"Херсонська область","nameEn":"Kherson Oblast","website":"https://khoda.gov.ua/","contract":"Конституція ст. 132","tags":["cofog:01","oblast","southern","partially-occupied"],"orgTier":"state"}
"""
...
def task_gov_ukr_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_ukr_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_ukr_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_ukr_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_ukr_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_ukr_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_ukr_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_ukr_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_ukr_seed_orgs, seedLimit)
    register = await task_gov_ukr_register_dids(registerLimit)
    follow = await task_gov_ukr_follow_site_deps(followLimit)
    ingest = await task_gov_ukr_sync_wet_updates(ingestLimit)
    shinka = await task_gov_ukr_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govUkr.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ukr_heartbeat_tick)
