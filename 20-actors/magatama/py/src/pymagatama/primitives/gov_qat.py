"""QAT Government states actor primitives.

This module moves the `did:web:qat-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:qat-state.etzhayyim.com"
DOMAIN_CODE = "qat"
...
_MINISTRY_NDJSON = """\
{"path":"amiri-diwan","name":"الديوان الأميري","nameEn":"Amiri Diwan","website":"https://www.diwan.gov.qa","contract":"Constitution 2004","tags":["executive","royal"],"orgTier":"central"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defence","website":"https://www.mod.gov.qa","contract":"Constitution 2004","tags":["defence","military"],"orgTier":"central"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mof.gov.qa","contract":"Constitution 2004","tags":["finance","budget"],"orgTier":"central"}
{"path":"mofa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mofa.gov.qa","contract":"Constitution 2004","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.qa","contract":"Constitution 2004","tags":["justice","law"],"orgTier":"central"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.qa","contract":"Constitution 2004","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"وزارة التعليم والتعليم العالي","nameEn":"Ministry of Education and Higher Education","website":"https://www.edu.gov.qa","contract":"Constitution 2004","tags":["education","higher-education"],"orgTier":"central"}
{"path":"moph","name":"وزارة الصحة العامة","nameEn":"Ministry of Public Health","website":"https://www.moph.gov.qa","contract":"Constitution 2004","tags":["health","public-health"],"orgTier":"central"}
{"path":"mom","name":"وزارة البلدية","nameEn":"Ministry of Municipality","website":"https://www.mm.gov.qa","contract":"Constitution 2004","tags":["municipality","planning"],"orgTier":"central"}
{"path":"moci","name":"وزارة التجارة والصناعة","nameEn":"Ministry of Commerce and Industry","website":"https://www.moci.gov.qa","contract":"Constitution 2004","tags":["commerce","industry"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"al-dayen","name":"بلدية الريان","nameEn":"Al Rayyan Municipality","website":"https://www.al-rayyan.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
{"path":"al-khor","name":"بلدية الخور والذخيرة","nameEn":"Al Khor Municipality","website":"https://www.alkhor.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
{"path":"al-shamal","name":"بلدية الشمال","nameEn":"Al Shamal Municipality","website":"https://www.alshamal.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
{"path":"al-wakrah","name":"بلدية الوكرة","nameEn":"Al Wakrah Municipality","website":"https://www.alwakra.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
{"path":"ar-rayyan","name":"بلدية الريان","nameEn":"Ar Rayyan Municipality","website":"https://www.al-rayyan.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
{"path":"ash-shahaniya","name":"بلدية الشحانية","nameEn":"Ash Shahaniya Municipality","website":"https://www.ash-shahaniya.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
{"path":"doha","name":"بلدية الدوحة","nameEn":"Doha Municipality (Capital)","website":"https://www.doha.gov.qa","contract":"Constitution 2004","tags":["municipality","capital"],"orgTier":"subnational"}
{"path":"umm-slal","name":"بلدية أم صلال","nameEn":"Umm Slal Municipality","website":"https://www.umm-slal.gov.qa","contract":"Constitution 2004","tags":["municipality","baladiyah"],"orgTier":"subnational"}
"""
...
def task_gov_qat_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_qat_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_qat_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_qat_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_qat_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_qat_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_qat_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_qat_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_qat_seed_orgs, seedLimit)
    register = await task_gov_qat_register_dids(registerLimit)
    follow = await task_gov_qat_follow_site_deps(followLimit)
    ingest = await task_gov_qat_sync_wet_updates(ingestLimit)
    shinka = await task_gov_qat_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govQat.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_heartbeat_tick)
