...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govQat.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_qat_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govQat.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
