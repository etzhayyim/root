"""HRV Government states actor primitives.

This module moves the `did:web:hrv-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:hrv-state.etzhayyim.com"
DOMAIN_CODE = "hrv"
...
_MINISTRY_NDJSON = """\
{"path":"vlada","name":"Vlada Republike Hrvatske","nameEn":"Government of the Republic of Croatia","website":"https://gov.hr/","contract":"Ustav Art. 108","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"mvep","name":"Ministarstvo vanjskih i europskih poslova","nameEn":"Ministry of Foreign and European Affairs","website":"https://mvep.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:01.2","foreign-affairs","eu"],"orgTier":"ministry"}
{"path":"morh","name":"Ministarstvo obrane","nameEn":"Ministry of Defence","website":"https://www.morh.hr/","contract":"Ustav Art. 108","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mfin","name":"Ministarstvo financija","nameEn":"Ministry of Finance","website":"https://mfin.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"mup","name":"Ministarstvo unutarnjih poslova","nameEn":"Ministry of Interior","website":"https://mup.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"pravosudje","name":"Ministarstvo pravosuđa i uprave","nameEn":"Ministry of Justice and Administration","website":"https://pravosudje.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mzo","name":"Ministarstvo znanosti i obrazovanja","nameEn":"Ministry of Science and Education","website":"https://mzo.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:09","education","science"],"orgTier":"ministry"}
{"path":"miz","name":"Ministarstvo zdravstva","nameEn":"Ministry of Health","website":"https://zdravlje.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mrad","name":"Ministarstvo rada, mirovinskoga sustava, obitelji i socijalne politike","nameEn":"Ministry of Labour, Pension System, Family and Social Policy","website":"https://mrosp.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:04","labour","social"],"orgTier":"ministry"}
{"path":"mpgi","name":"Ministarstvo prostornoga uređenja, graditeljstva i državne imovine","nameEn":"Ministry of Spatial Planning, Construction and State Assets","website":"https://mgipu.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:06","construction","spatial-planning"],"orgTier":"ministry"}
{"path":"mmpi","name":"Ministarstvo mora, prometa i infrastrukture","nameEn":"Ministry of the Sea, Transport and Infrastructure","website":"https://mmpi.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:04.5","transport","maritime"],"orgTier":"ministry"}
{"path":"mps","name":"Ministarstvo poljoprivrede","nameEn":"Ministry of Agriculture","website":"https://poljoprivreda.gov.hr/","contract":"Ustav Art. 108","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"zupanija:bjelovar-bilogora","name":"Bjelovarsko-bilogorska županija","nameEn":"Bjelovar-Bilogora County","website":"https://www.bbz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:brod-posavina","name":"Brodsko-posavska županija","nameEn":"Brod-Posavina County","website":"https://www.bpz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:dubrovnik-neretva","name":"Dubrovačko-neretvanska županija","nameEn":"Dubrovnik-Neretva County","website":"https://www.dunz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:istria","name":"Istarska županija","nameEn":"Istria County","website":"https://www.istra-istria.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:karlovac","name":"Karlovačka županija","nameEn":"Karlovac County","website":"https://www.kazupanija.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:koprivnica-krizevci","name":"Koprivničko-križevačka županija","nameEn":"Koprivnica-Križevci County","website":"https://www.kckzz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:krapina-zagorje","name":"Krapinsko-zagorska županija","nameEn":"Krapina-Zagorje County","website":"https://www.kzz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:lika-senj","name":"Ličko-senjska županija","nameEn":"Lika-Senj County","website":"https://www.licko-senjska.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:medimurje","name":"Međimurska županija","nameEn":"Međimurje County","website":"https://www.medzimurska-zupanija.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:osijek-baranja","name":"Osječko-baranjska županija","nameEn":"Osijek-Baranja County","website":"https://www.obz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:pozega-slavonia","name":"Požeško-slavonska županija","nameEn":"Požega-Slavonia County","website":"https://www.pszupanija.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:primorje-gorski-kotar","name":"Primorsko-goranska županija","nameEn":"Primorje-Gorski Kotar County","website":"https://www.pgz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:sibenik-knin","name":"Šibensko-kninska županija","nameEn":"Šibenik-Knin County","website":"https://www.sibensko-kninska.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:sisak-moslavina","name":"Sisačko-moslavačka županija","nameEn":"Sisak-Moslavina County","website":"https://www.smz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:split-dalmatia","name":"Splitsko-dalmatinska županija","nameEn":"Split-Dalmatia County","website":"https://www.dalmacija.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:varazdin","name":"Varaždinska županija","nameEn":"Varaždin County","website":"https://www.vzz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:virovitica-podravina","name":"Virovitičko-podravska županija","nameEn":"Virovitica-Podravina County","website":"https://www.vpz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:vukovar-syrmia","name":"Vukovarsko-srijemska županija","nameEn":"Vukovar-Syrmia County","website":"https://www.vusz.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:zadar","name":"Zadarska županija","nameEn":"Zadar County","website":"https://www.zadarska-zupanija.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zupanija:zagreb-county","name":"Zagrebačka županija","nameEn":"Zagreb County","website":"https://www.zagrebacka-zupanija.hr/","contract":"Ustav Art. 133","tags":["cofog:01","zupanija","l5"],"orgTier":"state"}
{"path":"zagreb-city","name":"Grad Zagreb","nameEn":"City of Zagreb","website":"https://www.zagreb.hr/","contract":"Ustav Art. 133","tags":["cofog:01","capital","city-county"],"orgTier":"state"}
"""
...
def task_gov_hrv_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_hrv_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_hrv_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_hrv_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_hrv_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_hrv_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in rows_to_process:
        ...
        # R0: fetch wet chunks by domain and sort by crawled_at DESC in Python
...
async def task_gov_hrv_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_hrv_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_hrv_seed_orgs, seedLimit)
    register = await task_gov_hrv_register_dids(registerLimit)
    follow = await task_gov_hrv_follow_site_deps(followLimit)
    ingest = await task_gov_hrv_sync_wet_updates(ingestLimit)
    shinka = await task_gov_hrv_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govHrv.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_hrv_heartbeat_tick)
