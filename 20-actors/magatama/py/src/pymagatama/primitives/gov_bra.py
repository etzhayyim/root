"""BRA Government states actor primitives.

This module moves the `did:web:bra-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:bra-state.etzhayyim.com"
DOMAIN_CODE = "bra"
...
_MINISTRY_NDJSON = """\
{"path":"presidencia","name":"Presidência da República","nameEn":"Presidency of the Republic","website":"https://www.gov.br/planalto/","contract":"Constituição Federal Art. 76","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"md","name":"Ministério da Defesa","nameEn":"Ministry of Defence","website":"https://www.gov.br/defesa/","contract":"Lei 9.649/1998","tags":["cofog:02","defence","military"],"orgTier":"ministry"}
{"path":"mre","name":"Ministério das Relações Exteriores","nameEn":"Ministry of Foreign Affairs (Itamaraty)","website":"https://www.gov.br/mre/","contract":"Lei 9.649/1998","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"mf","name":"Ministério da Fazenda","nameEn":"Ministry of Finance","website":"https://www.gov.br/fazenda/","contract":"Lei 9.649/1998","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"mjsp","name":"Ministério da Justiça e Segurança Pública","nameEn":"Ministry of Justice and Public Security","website":"https://www.gov.br/mj/","contract":"Lei 9.649/1998","tags":["cofog:03","justice","police"],"orgTier":"ministry"}
{"path":"ms","name":"Ministério da Saúde","nameEn":"Ministry of Health","website":"https://www.gov.br/saude/","contract":"Lei 9.649/1998","tags":["cofog:07","health","sus"],"orgTier":"ministry"}
{"path":"mec","name":"Ministério da Educação","nameEn":"Ministry of Education","website":"https://www.gov.br/mec/","contract":"Lei 9.649/1998","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"mte","name":"Ministério do Trabalho e Emprego","nameEn":"Ministry of Labour and Employment","website":"https://www.gov.br/trabalho/","contract":"Lei 9.649/1998","tags":["cofog:04","labour","employment"],"orgTier":"ministry"}
{"path":"mma","name":"Ministério do Meio Ambiente","nameEn":"Ministry of Environment","website":"https://www.gov.br/mma/","contract":"Lei 9.649/1998","tags":["cofog:05","environment","climate","amazon"],"orgTier":"ministry"}
{"path":"mapa","name":"Ministério da Agricultura, Pecuária e Abastecimento","nameEn":"Ministry of Agriculture","website":"https://www.gov.br/agricultura/","contract":"Lei 9.649/1998","tags":["cofog:04.2","agriculture","livestock"],"orgTier":"ministry"}
{"path":"mti","name":"Ministério de Minas e Energia","nameEn":"Ministry of Mines and Energy","website":"https://www.gov.br/mme/","contract":"Lei 9.649/1998","tags":["cofog:04","energy","mining","oil"],"orgTier":"ministry"}
{"path":"mcid","name":"Ministério das Cidades","nameEn":"Ministry of Cities","website":"https://www.gov.br/cidades/","contract":"Lei 9.649/1998","tags":["cofog:06","cities","housing","urban"],"orgTier":"ministry"}
{"path":"camara","name":"Câmara dos Deputados","nameEn":"Chamber of Deputies","website":"https://www.camara.leg.br/","contract":"Constituição Federal Art. 45","tags":["cofog:01","legislature","lower-house"],"orgTier":"agency"}
{"path":"senado","name":"Senado Federal","nameEn":"Federal Senate","website":"https://www.senado.leg.br/","contract":"Constituição Federal Art. 46","tags":["cofog:01","legislature","upper-house"],"orgTier":"agency"}
{"path":"stf","name":"Supremo Tribunal Federal","nameEn":"Federal Supreme Court","website":"https://portal.stf.jus.br/","contract":"Constituição Federal Art. 102","tags":["cofog:03","judiciary","supreme-court"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"estado:ac","name":"Acre","nameEn":"Acre","website":"https://www.ac.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:al","name":"Alagoas","nameEn":"Alagoas","website":"https://www.al.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:ap","name":"Amapá","nameEn":"Amapá","website":"https://www.portal.ap.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:am","name":"Amazonas","nameEn":"Amazonas","website":"https://www.amazonas.am.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5","amazon"],"orgTier":"state"}
{"path":"estado:ba","name":"Bahia","nameEn":"Bahia","website":"https://www.ba.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:ce","name":"Ceará","nameEn":"Ceará","website":"https://www.ceara.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:df","name":"Distrito Federal","nameEn":"Federal District","website":"https://www.df.gov.br/","contract":"Constituição Federal Art. 32","tags":["cofog:01","federal-district","capital","brasilia"],"orgTier":"state"}
{"path":"estado:es","name":"Espírito Santo","nameEn":"Espírito Santo","website":"https://www.es.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:go","name":"Goiás","nameEn":"Goiás","website":"https://www.goias.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:ma","name":"Maranhão","nameEn":"Maranhão","website":"https://www.ma.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:mt","name":"Mato Grosso","nameEn":"Mato Grosso","website":"https://www.mt.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:ms","name":"Mato Grosso do Sul","nameEn":"Mato Grosso do Sul","website":"https://www.ms.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:mg","name":"Minas Gerais","nameEn":"Minas Gerais","website":"https://www.mg.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:pa","name":"Pará","nameEn":"Pará","website":"https://www.pa.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5","amazon"],"orgTier":"state"}
{"path":"estado:pb","name":"Paraíba","nameEn":"Paraíba","website":"https://paraiba.pb.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:pr","name":"Paraná","nameEn":"Paraná","website":"https://www.pr.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:pe","name":"Pernambuco","nameEn":"Pernambuco","website":"https://www.pe.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:pi","name":"Piauí","nameEn":"Piauí","website":"https://www.pi.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:rj","name":"Rio de Janeiro","nameEn":"Rio de Janeiro","website":"https://www.rj.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:rn","name":"Rio Grande do Norte","nameEn":"Rio Grande do Norte","website":"https://www.rn.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:rs","name":"Rio Grande do Sul","nameEn":"Rio Grande do Sul","website":"https://www.rs.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:ro","name":"Rondônia","nameEn":"Rondônia","website":"https://www.rondonia.ro.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:rr","name":"Roraima","nameEn":"Roraima","website":"https://www.rr.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:sc","name":"Santa Catarina","nameEn":"Santa Catarina","website":"https://www.sc.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:sp","name":"São Paulo","nameEn":"São Paulo","website":"https://www.saopaulo.sp.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5","largest"],"orgTier":"state"}
{"path":"estado:se","name":"Sergipe","nameEn":"Sergipe","website":"https://www.se.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
{"path":"estado:to","name":"Tocantins","nameEn":"Tocantins","website":"https://www.to.gov.br/","contract":"Constituição Federal Art. 18","tags":["cofog:01","state","l5"],"orgTier":"state"}
"""
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: using Python filter for domain_code and owner_did alongside vertex_id
    keys = [
...
def task_gov_bra_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: using Python filter for multiple predicates (domain_code, owner_did, name_en)
    rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE, columns=["path", "owner_did", "name_en"], limit=10000
    )
    existing = {
...
def task_gov_bra_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_bra_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: using Python filter for count and ordering/pagination (domain_code, owner_did, org_tier, name_en)
    ...
    filtered = []
    for r in all_rows:
        if r.get("owner_did") != PRIMARY_DID or not r.get("name_en"):
            continue
...
async def task_gov_bra_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    # R0: using Python filter and sort for un-registered dids
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
        columns=[
            "path", "name", "name_en", "website", "contract", "tags", "org_tier",
...
async def task_gov_bra_follow_site_deps(limit: int = 15) -> dict[str, Any]:
    limit = max(1, min(int(limit or 15), 50))
    followed = 0
    # R0: using Python filter and sort for unfollowed site deps
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
        columns=[
            "path", "name", "name_en", "website", "contract", "tags", "org_tier",
...
async def task_gov_bra_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    cutoff = (_dt.datetime.now(tz=_dt.UTC) - _dt.timedelta(days=7)).replace(microsecond=0)
    cutoff_iso = cutoff.isoformat().replace("+00:00", "Z")
    # R0: using Python filter and sort for wet updates
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
    ...
    for r in rows:
        ...
        # R0: fetch latest wet chunk using Python sort from select_where
        wet_rows = get_kotoba_client().select_where(
            "vertex_wet_chunk", "domain", slug,
...
async def task_gov_bra_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 1), 5))
    # R0: using Python filter and sort for shinka update
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
...
async def task_gov_bra_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_bra_seed_orgs, seedLimit)
    register = await task_gov_bra_register_dids(registerLimit)
    follow = await task_gov_bra_follow_site_deps(followLimit)
    ingest = await task_gov_bra_sync_wet_updates(ingestLimit)
    shinka = await task_gov_bra_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBra.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bra_heartbeat_tick)
