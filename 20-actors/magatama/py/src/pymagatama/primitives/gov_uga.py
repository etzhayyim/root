...
This module moves the `did:web:uga-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:uga-state.gftd.ai"
DOMAIN_CODE = "uga"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govUga.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_uga_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govUga.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
