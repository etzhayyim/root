"""PRT Government states actor primitives.

This module moves the `did:web:prt-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:prt-state.etzhayyim.com"
DOMAIN_CODE = "prt"
...
_MINISTRY_NDJSON = """\
{"path":"pcm","name":"Presidência do Conselho de Ministros","nameEn":"Presidency of the Council of Ministers","website":"https://www.portugal.gov.pt/","contract":"Constituição Art. 183","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mne","name":"Ministério dos Negócios Estrangeiros","nameEn":"Ministry of Foreign Affairs","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mne","contract":"Constituição Art. 188","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"mdn","name":"Ministério da Defesa Nacional","nameEn":"Ministry of National Defence","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mdn","contract":"Constituição Art. 275","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mf","name":"Ministério das Finanças","nameEn":"Ministry of Finance","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mf","contract":"Constituição Art. 105","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"mj","name":"Ministério da Justiça","nameEn":"Ministry of Justice","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mj","contract":"Constituição Art. 202","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mai","name":"Ministério da Administração Interna","nameEn":"Ministry of Internal Administration","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mai","contract":"Constituição Art. 237","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"me","name":"Ministério da Educação","nameEn":"Ministry of Education","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/me","contract":"Constituição Art. 73","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"ms","name":"Ministério da Saúde","nameEn":"Ministry of Health","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/ms","contract":"Constituição Art. 64","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mtsss","name":"Ministério do Trabalho, Solidariedade e Segurança Social","nameEn":"Ministry of Labour, Solidarity and Social Security","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mtsss","contract":"Constituição Art. 58","tags":["cofog:04","labour","social","solidarity"],"orgTier":"ministry"}
{"path":"madr","name":"Ministério da Agricultura e do Desenvolvimento Rural","nameEn":"Ministry of Agriculture and Rural Development","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/madr","contract":"Constituição Art. 93","tags":["cofog:04.2","agriculture","rural"],"orgTier":"ministry"}
{"path":"mia","name":"Ministério das Infraestruturas e Habitação","nameEn":"Ministry of Infrastructure and Housing","website":"https://www.portugal.gov.pt/pt/gc23/governo/ministerios/mih","contract":"Constituição Art. 65","tags":["cofog:04.5","infrastructure","housing","transport"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"distrito:aveiro","name":"Distrito de Aveiro","nameEn":"District of Aveiro","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district"],"orgTier":"state"}
{"path":"distrito:beja","name":"Distrito de Beja","nameEn":"District of Beja","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","alentejo"],"orgTier":"state"}
{"path":"distrito:braga","name":"Distrito de Braga","nameEn":"District of Braga","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","minho"],"orgTier":"state"}
{"path":"distrito:braganca","name":"Distrito de Bragança","nameEn":"District of Bragança","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","tras-os-montes"],"orgTier":"state"}
{"path":"distrito:castelo-branco","name":"Distrito de Castelo Branco","nameEn":"District of Castelo Branco","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","beira-interior"],"orgTier":"state"}
{"path":"distrito:coimbra","name":"Distrito de Coimbra","nameEn":"District of Coimbra","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","beira-litoral","university"],"orgTier":"state"}
{"path":"distrito:evora","name":"Distrito de Évora","nameEn":"District of Évora","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","alentejo","historic"],"orgTier":"state"}
{"path":"distrito:faro","name":"Distrito de Faro","nameEn":"District of Faro","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","algarve","tourism"],"orgTier":"state"}
{"path":"distrito:guarda","name":"Distrito da Guarda","nameEn":"District of Guarda","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","beira-interior"],"orgTier":"state"}
{"path":"distrito:leiria","name":"Distrito de Leiria","nameEn":"District of Leiria","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","estremadura"],"orgTier":"state"}
{"path":"distrito:lisboa","name":"Distrito de Lisboa","nameEn":"District of Lisboa","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","capital","largest"],"orgTier":"state"}
{"path":"distrito:portalegre","name":"Distrito de Portalegre","nameEn":"District of Portalegre","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","alentejo"],"orgTier":"state"}
{"path":"distrito:porto","name":"Distrito do Porto","nameEn":"District of Porto","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","douro","second-city"],"orgTier":"state"}
{"path":"distrito:santarem","name":"Distrito de Santarém","nameEn":"District of Santarém","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","ribatejo"],"orgTier":"state"}
{"path":"distrito:setubal","name":"Distrito de Setúbal","nameEn":"District of Setúbal","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","peninsula-setubal"],"orgTier":"state"}
{"path":"distrito:viana-do-castelo","name":"Distrito de Viana do Castelo","nameEn":"District of Viana do Castelo","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","minho"],"orgTier":"state"}
{"path":"distrito:vila-real","name":"Distrito de Vila Real","nameEn":"District of Vila Real","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","tras-os-montes"],"orgTier":"state"}
{"path":"distrito:viseu","name":"Distrito de Viseu","nameEn":"District of Viseu","website":"https://www.gov.pt/","contract":"Constituição Art. 236","tags":["cofog:01","district","beira-alta"],"orgTier":"state"}
{"path":"ra:acores","name":"Região Autónoma dos Açores","nameEn":"Autonomous Region of the Azores","website":"https://www.azores.gov.pt/","contract":"Constituição Art. 225-235","tags":["cofog:01","autonomous-region","atlantic","islands"],"orgTier":"state"}
{"path":"ra:madeira","name":"Região Autónoma da Madeira","nameEn":"Autonomous Region of Madeira","website":"https://www.madeira.gov.pt/","contract":"Constituição Art. 225-235","tags":["cofog:01","autonomous-region","atlantic","islands","tourism"],"orgTier":"state"}
"""
...
def task_gov_prt_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_prt_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_prt_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_prt_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_prt_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_prt_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in paginated:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: ORDER BY DESC emulated in Python
...
async def task_gov_prt_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_prt_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_prt_seed_orgs, seedLimit)
    register = await task_gov_prt_register_dids(registerLimit)
    follow = await task_gov_prt_follow_site_deps(followLimit)
    ingest = await task_gov_prt_sync_wet_updates(ingestLimit)
    shinka = await task_gov_prt_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govPrt.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_heartbeat_tick)
