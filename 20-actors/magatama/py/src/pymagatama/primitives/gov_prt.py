...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_prt_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govPrt.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
