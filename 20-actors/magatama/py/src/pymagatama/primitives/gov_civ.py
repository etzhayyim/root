...
This module moves the `did:web:civ-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:civ-state.gftd.ai"
DOMAIN_CODE = "civ"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_civ_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govCiv.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
