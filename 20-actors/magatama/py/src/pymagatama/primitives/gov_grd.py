...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govGrd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
