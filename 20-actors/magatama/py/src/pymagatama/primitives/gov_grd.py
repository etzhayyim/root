"""GRD Government states actor primitives.

This module moves the `did:web:grd-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:grd-state.etzhayyim.com"
DOMAIN_CODE = "grd"
...
_MINISTRY_NDJSON = """\
{"path":"prime-ministers-office","name":"Office of the Prime Minister","nameEn":"Office of the Prime Minister","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","executive","prime-minister","caricom"],"orgTier":"ministry"}
{"path":"national-security","name":"Ministry of National Security","nameEn":"Ministry of National Security","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:02","security"],"orgTier":"ministry"}
{"path":"finance-economic-development","name":"Ministry of Finance and Economic Development","nameEn":"Ministry of Finance and Economic Development","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs and International Business","nameEn":"Ministry of Foreign Affairs","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"legal-affairs","name":"Ministry of Legal Affairs","nameEn":"Ministry of Legal Affairs","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health-social-security","name":"Ministry of Health and Social Security","nameEn":"Ministry of Health and Social Security","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture","nameEn":"Ministry of Agriculture","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:04.2","agriculture","fisheries","nutmeg"],"orgTier":"ministry"}
{"path":"tourism","name":"Ministry of Tourism and Civil Aviation","nameEn":"Ministry of Tourism","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:04","tourism","aviation"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment and Climate Resilience","nameEn":"Ministry of Environment","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
{"path":"public-utilities","name":"Ministry of Public Utilities","nameEn":"Ministry of Public Utilities","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:04.4","utilities","energy"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"parish:saint-andrew","name":"Saint Andrew Parish","nameEn":"Saint Andrew Parish","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","parish","largest"],"orgTier":"state"}
{"path":"parish:saint-david","name":"Saint David Parish","nameEn":"Saint David Parish","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-george","name":"Saint George Parish","nameEn":"Saint George Parish (capital)","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","parish","capital"],"orgTier":"state"}
{"path":"parish:saint-john","name":"Saint John Parish","nameEn":"Saint John Parish","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-mark","name":"Saint Mark Parish","nameEn":"Saint Mark Parish","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:saint-patrick","name":"Saint Patrick Parish","nameEn":"Saint Patrick Parish","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","parish"],"orgTier":"state"}
{"path":"parish:carriacou-petite-martinique","name":"Carriacou and Petite Martinique","nameEn":"Carriacou and Petite Martinique","website":"https://www.gov.gd/","contract":"Constitution of Grenada 1973","tags":["cofog:01","island","grenadines"],"orgTier":"state"}
"""
...
def task_gov_grd_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_grd_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_grd_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_grd_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_grd_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_grd_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_grd_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_grd_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_grd_seed_orgs, seedLimit)
    register = await task_gov_grd_register_dids(registerLimit)
    follow = await task_gov_grd_follow_site_deps(followLimit)
    ingest = await task_gov_grd_sync_wet_updates(ingestLimit)
    shinka = await task_gov_grd_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govGrd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_grd_heartbeat_tick)
