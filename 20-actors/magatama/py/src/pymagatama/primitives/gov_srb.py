"""SRB Government states actor primitives.

This module moves the `did:web:srb-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:srb-state.etzhayyim.com"
DOMAIN_CODE = "srb"
...
_MINISTRY_NDJSON = """\
{"path":"vlada","name":"Влада Републике Србије","nameEn":"Government of the Republic of Serbia","website":"https://www.srbija.gov.rs/","contract":"Устав Србије 2006 чл. 122","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"mfa","name":"Министарство спољних послова","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.rs/","contract":"Устав чл. 116","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Министарство одбране","nameEn":"Ministry of Defence","website":"https://www.mod.gov.rs/","contract":"Устав чл. 139","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Министарство финансија","nameEn":"Ministry of Finance","website":"https://www.mfin.gov.rs/","contract":"Устав чл. 91","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"Министарство правде","nameEn":"Ministry of Justice","website":"https://www.mpravde.gov.rs/","contract":"Устав чл. 143","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moi","name":"Министарство унутрашњих послова","nameEn":"Ministry of Interior","website":"https://www.mup.gov.rs/","contract":"Устав чл. 141","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"Министарство просвете","nameEn":"Ministry of Education","website":"https://www.mpn.gov.rs/","contract":"Устав чл. 71","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"Министарство здравља","nameEn":"Ministry of Health","website":"https://www.zdravlje.gov.rs/","contract":"Устав чл. 68","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mol","name":"Министарство за рад","nameEn":"Ministry of Labour, Employment, Veteran and Social Policy","website":"https://www.minrzs.gov.rs/","contract":"Устав чл. 60","tags":["cofog:04","labour","social"],"orgTier":"ministry"}
{"path":"moecon","name":"Министарство привреде","nameEn":"Ministry of Economy","website":"https://privreda.gov.rs/","contract":"Устав чл. 94","tags":["cofog:04","economy"],"orgTier":"ministry"}
{"path":"moenv","name":"Министарство заштите животне средине","nameEn":"Ministry of Environmental Protection","website":"https://www.ekologija.gov.rs/","contract":"Устав чл. 74","tags":["cofog:05","environment"],"orgTier":"ministry"}
{"path":"narodna-skupstina","name":"Народна скупштина","nameEn":"National Assembly of Serbia","website":"https://www.parlament.gov.rs/","contract":"Устав чл. 98","tags":["cofog:01","legislature"],"orgTier":"agency"}
{"path":"ustavni-sud","name":"Уставни суд","nameEn":"Constitutional Court","website":"https://www.ustavni.sud.rs/","contract":"Устав чл. 166","tags":["cofog:03","judiciary","constitutional-court"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"okrug:belgrade","name":"Град Београд","nameEn":"City of Belgrade","website":"https://www.beograd.rs/","contract":"Устав чл. 189","tags":["cofog:01","okrug","capital","city"],"orgTier":"state"}
{"path":"ap:vojvodina","name":"Аутономна покрајина Војводина","nameEn":"Autonomous Province of Vojvodina","website":"https://www.vojvodina.gov.rs/","contract":"Устав чл. 182","tags":["cofog:01","autonomous-province","vojvodina"],"orgTier":"state"}
{"path":"okrug:sumadija","name":"Шумадијски управни округ","nameEn":"Šumadija Administrative District","website":"https://www.okrugkragujevac.rs/","contract":"Устав чл. 176","tags":["cofog:01","okrug"],"orgTier":"state"}
{"path":"okrug:nisava","name":"Нишавски управни округ","nameEn":"Nišava Administrative District","website":"https://www.okrugnis.rs/","contract":"Устав чл. 176","tags":["cofog:01","okrug"],"orgTier":"state"}
{"path":"okrug:southern-backa","name":"Јужнобачки управни округ","nameEn":"South Bačka Administrative District","website":"https://www.okrugns.rs/","contract":"Устав чл. 176","tags":["cofog:01","okrug"],"orgTier":"state"}
{"path":"okrug:moravica","name":"Моравички управни округ","nameEn":"Moravica Administrative District","website":"https://www.moravicki.okrug.gov.rs/","contract":"Устав чл. 176","tags":["cofog:01","okrug"],"orgTier":"state"}
"""
...
def task_gov_srb_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_srb_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_srb_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_srb_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_srb_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_srb_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_srb_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_srb_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_srb_seed_orgs, seedLimit)
    register = await task_gov_srb_register_dids(registerLimit)
    follow = await task_gov_srb_follow_site_deps(followLimit)
    ingest = await task_gov_srb_sync_wet_updates(ingestLimit)
    shinka = await task_gov_srb_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSrb.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_srb_heartbeat_tick)
