...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govNpl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
