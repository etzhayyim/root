"""NPL Government states actor primitives.

This module moves the `did:web:npl-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:npl-state.etzhayyim.com"
DOMAIN_CODE = "npl"
...
_MINISTRY_NDJSON = """\
{"path":"opmcm","name":"प्रधानमन्त्री तथा मन्त्रिपरिषद्को कार्यालय","nameEn":"Office of the Prime Minister and Council of Ministers","website":"https://opmcm.gov.np/","contract":"Nepal Constitution 2015 Art. 76","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mofa","name":"परराष्ट्र मन्त्रालय","nameEn":"Ministry of Foreign Affairs","website":"https://mofa.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"रक्षा मन्त्रालय","nameEn":"Ministry of Defence","website":"https://mod.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"अर्थ मन्त्रालय","nameEn":"Ministry of Finance","website":"https://mof.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"molgpa","name":"कानून न्याय तथा संसदीय मामिला मन्त्रालय","nameEn":"Ministry of Law, Justice and Parliamentary Affairs","website":"https://moljpa.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:03","justice","law"],"orgTier":"ministry"}
{"path":"moha","name":"गृह मन्त्रालय","nameEn":"Ministry of Home Affairs","website":"https://moha.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"शिक्षा, विज्ञान तथा प्रविधि मन्त्रालय","nameEn":"Ministry of Education, Science and Technology","website":"https://moe.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:09","education","science"],"orgTier":"ministry"}
{"path":"mohp","name":"स्वास्थ्य तथा जनसंख्या मन्त्रालय","nameEn":"Ministry of Health and Population","website":"https://mohp.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:07","health","population"],"orgTier":"ministry"}
{"path":"molss","name":"श्रम, रोजगार तथा सामाजिक सुरक्षा मन्त्रालय","nameEn":"Ministry of Labour, Employment and Social Security","website":"https://molss.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:04","labour","social"],"orgTier":"ministry"}
{"path":"mocs","name":"उद्योग, वाणिज्य तथा आपूर्ति मन्त्रालय","nameEn":"Ministry of Industry, Commerce and Supplies","website":"https://mocs.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:04","industry","trade"],"orgTier":"ministry"}
{"path":"moald","name":"कृषि तथा पशुपन्छी विकास मन्त्रालय","nameEn":"Ministry of Agriculture and Livestock Development","website":"https://moald.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:04.2","agriculture","livestock"],"orgTier":"ministry"}
{"path":"mofe","name":"वन तथा वातावरण मन्त्रालय","nameEn":"Ministry of Forests and Environment","website":"https://mofe.gov.np/","contract":"Nepal Constitution 2015","tags":["cofog:05","environment","forest"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:koshi","name":"कोशी प्रदेश","nameEn":"Koshi Province","website":"https://koshi.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:madhesh","name":"मधेश प्रदेश","nameEn":"Madhesh Province","website":"https://madhesh.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:bagmati","name":"बागमती प्रदेश","nameEn":"Bagmati Province","website":"https://bagmati.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province","capital-region"],"orgTier":"state"}
{"path":"prov:gandaki","name":"गण्डकी प्रदेश","nameEn":"Gandaki Province","website":"https://gandaki.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:lumbini","name":"लुम्बिनी प्रदेश","nameEn":"Lumbini Province","website":"https://lumbini.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province","birthplace-of-buddha"],"orgTier":"state"}
{"path":"prov:karnali","name":"कर्णाली प्रदेश","nameEn":"Karnali Province","website":"https://karnali.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:sudurpashchim","name":"सुदूरपश्चिम प्रदेश","nameEn":"Sudurpashchim Province","website":"https://sudurpashchim.gov.np/","contract":"Nepal Constitution 2015 Art. 56","tags":["cofog:01","province","far-western"],"orgTier":"state"}
"""
...
def task_gov_npl_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_npl_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_npl_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_npl_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_npl_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_npl_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_npl_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_npl_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_npl_seed_orgs, seedLimit)
    register = await task_gov_npl_register_dids(registerLimit)
    follow = await task_gov_npl_follow_site_deps(followLimit)
    ingest = await task_gov_npl_sync_wet_updates(ingestLimit)
    shinka = await task_gov_npl_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNpl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_npl_heartbeat_tick)
