"""KGZ Government states actor primitives.

This module moves the `did:web:kgz-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:kgz-state.etzhayyim.com"
DOMAIN_CODE = "kgz"
...
_MINISTRY_NDJSON = """\
{"path":"president","name":"Кыргыз Республикасынын Президентинин Администрациясы","nameEn":"Presidential Administration","website":"https://president.kg","contract":"Constitution 2021","tags":["executive","presidency"],"orgTier":"central"}
{"path":"mod","name":"Коргоо министрлиги","nameEn":"Ministry of Defence","website":"https://mod.gov.kg","contract":"Constitution 2021","tags":["defence","military"],"orgTier":"central"}
{"path":"minfin","name":"Финансы министрлиги","nameEn":"Ministry of Finance","website":"https://minfin.gov.kg","contract":"Constitution 2021","tags":["finance","budget"],"orgTier":"central"}
{"path":"mfa","name":"Тышкы иштер министрлиги","nameEn":"Ministry of Foreign Affairs","website":"https://mfa.gov.kg","contract":"Constitution 2021","tags":["foreign-affairs","diplomacy"],"orgTier":"central"}
{"path":"minjust","name":"Юстиция министрлиги","nameEn":"Ministry of Justice","website":"https://minjust.gov.kg","contract":"Constitution 2021","tags":["justice","law"],"orgTier":"central"}
{"path":"mia","name":"Ички иштер министрлиги","nameEn":"Ministry of Internal Affairs","website":"https://mvd.gov.kg","contract":"Constitution 2021","tags":["interior","police"],"orgTier":"central"}
{"path":"moe","name":"Билим берүү жана илим министрлиги","nameEn":"Ministry of Education and Science","website":"https://edu.gov.kg","contract":"Constitution 2021","tags":["education"],"orgTier":"central"}
{"path":"moh","name":"Саламаттык сактоо министрлиги","nameEn":"Ministry of Health","website":"https://med.gov.kg","contract":"Constitution 2021","tags":["health","public-health"],"orgTier":"central"}
{"path":"moa","name":"Айыл чарба, тамак-аш өнөр жайы жана мелиорация министрлиги","nameEn":"Ministry of Agriculture","website":"https://agri.gov.kg","contract":"Constitution 2021","tags":["agriculture"],"orgTier":"central"}
{"path":"mtc","name":"Санариптик өнүгүү министрлиги","nameEn":"Ministry of Digital Development","website":"https://dit.gov.kg","contract":"Constitution 2021","tags":["digital","innovation"],"orgTier":"central"}
"""

_STATE_NDJSON = """\
{"path":"batken","name":"Баткен облусу","nameEn":"Batken Region","website":"https://batken.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"chuy","name":"Чүй облусу","nameEn":"Chuy Region","website":"https://chuy.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"issyk-kul","name":"Ысык-Көл облусу","nameEn":"Issyk-Kul Region","website":"https://issykol.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"jalal-abad","name":"Жалал-Абад облусу","nameEn":"Jalal-Abad Region","website":"https://jalabad.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"naryn","name":"Нарын облусу","nameEn":"Naryn Region","website":"https://naryn.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"osh","name":"Ош облусу","nameEn":"Osh Region","website":"https://osh.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"talas","name":"Талас облусу","nameEn":"Талас облусу","website":"https://talas.gov.kg","contract":"Constitution 2021","tags":["region","oblast"],"orgTier":"subnational"}
{"path":"bishkek-city","name":"Бишкек шаары","nameEn":"Bishkek City (Capital)","website":"https://bishkek.gov.kg","contract":"Constitution 2021","tags":["city","capital"],"orgTier":"subnational"}
{"path":"osh-city","name":"Ош шаары","nameEn":"Osh City","website":"https://oshcity.gov.kg","contract":"Constitution 2021","tags":["city","metropolis"],"orgTier":"subnational"}
"""
...
def task_gov_kgz_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_kgz_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_kgz_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_kgz_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_kgz_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_kgz_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_kgz_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_kgz_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_kgz_seed_orgs, seedLimit)
    register = await task_gov_kgz_register_dids(registerLimit)
    follow = await task_gov_kgz_follow_site_deps(followLimit)
    ingest = await task_gov_kgz_sync_wet_updates(ingestLimit)
    shinka = await task_gov_kgz_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKgz.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kgz_heartbeat_tick)
