"""SSD Government states actor primitives.

This module moves the `did:web:ssd-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:ssd-state.etzhayyim.com"
DOMAIN_CODE = "ssd"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Office of the President","nameEn":"Office of the President","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defence","name":"Ministry of Defence and Veterans Affairs","nameEn":"Ministry of Defence and Veterans Affairs","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:02","defence","veterans"],"orgTier":"ministry"}
{"path":"finance","name":"Ministry of Finance and Planning","nameEn":"Ministry of Finance and Planning","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01.1","finance","planning"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs and International Cooperation","nameEn":"Ministry of Foreign Affairs","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justice","name":"Ministry of Justice and Constitutional Affairs","nameEn":"Ministry of Justice","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"interior","name":"Ministry of Interior","nameEn":"Ministry of Interior","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of General Education and Instruction","nameEn":"Ministry of Education","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture and Food Security","nameEn":"Ministry of Agriculture","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:04.2","agriculture","food-security"],"orgTier":"ministry"}
{"path":"petroleum","name":"Ministry of Petroleum","nameEn":"Ministry of Petroleum","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:04","petroleum","oil"],"orgTier":"ministry"}
{"path":"mining","name":"Ministry of Mining","nameEn":"Ministry of Mining","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:04","mining"],"orgTier":"ministry"}
{"path":"infrastructure","name":"Ministry of Roads and Bridges","nameEn":"Ministry of Infrastructure","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:04.5","infrastructure","roads"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"state:central-equatoria","name":"Central Equatoria State","nameEn":"Central Equatoria State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state","capital-state"],"orgTier":"state"}
{"path":"state:eastern-equatoria","name":"Eastern Equatoria State","nameEn":"Eastern Equatoria State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:jonglei","name":"Jonglei State","nameEn":"Jonglei State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:lakes","name":"Lakes State","nameEn":"Lakes State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:northern-bahr-el-ghazal","name":"Northern Bahr el Ghazal State","nameEn":"Northern Bahr el Ghazal State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:unity","name":"Unity State","nameEn":"Unity State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state","oil-producing"],"orgTier":"state"}
{"path":"state:upper-nile","name":"Upper Nile State","nameEn":"Upper Nile State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:warrap","name":"Warrap State","nameEn":"Warrap State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:western-bahr-el-ghazal","name":"Western Bahr el Ghazal State","nameEn":"Western Bahr el Ghazal State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:western-equatoria","name":"Western Equatoria State","nameEn":"Western Equatoria State","website":"https://www.goss.org/","contract":"Transitional Constitution 2011","tags":["cofog:01","state"],"orgTier":"state"}
"""
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: using vertex_id for primary lookup
...
def task_gov_ssd_seed_orgs(limit: int = 30) -> dict[str, Any]:
    ...
    written = 0
    for row in pending[:limit_val]:
        _upsert_gov_org(row)
        written += 1
    return {"ok": True, "seeded": written, "remaining": max(0, len(pending) - written)}


def task_gov_ssd_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_ssd_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit_val = max(1, min(int(limit or 50), 100))
    # R0: in-Python filter, sort, offset/limit and count
    ...
    page = filtered[offset : offset + limit_val]
    return {
        "orgs": [
            {
                "path": str(r.get("path", "")),
...
async def task_gov_ssd_register_dids(limit: int = 10) -> dict[str, Any]:
    limit_val = max(1, min(int(limit or 10), 50))
    # R0: in-Python filter and sort for register_dids
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [
        r for r in all_rows
...
async def task_gov_ssd_follow_site_deps(limit: int = 15) -> dict[str, Any]:
    limit_val = max(1, min(int(limit or 15), 50))
    followed = 0
    # R0: in-Python filter and sort for follow_site_deps
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [
        r for r in all_rows
        if r.get("owner_did") == PRIMARY_DID
...
async def task_gov_ssd_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit_val = max(1, min(int(limit or 10), 50))
    cutoff = (_dt.datetime.now(tz=_dt.UTC) - _dt.timedelta(days=7)).replace(microsecond=0)
    cutoff_iso = cutoff.isoformat().replace("+00:00", "Z")
    # R0: in-Python filter and sort for sync_wet_updates
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = []
    for r in all_rows:
    ...
    for r in page:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: select_where with limit and python sort
...
async def task_gov_ssd_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
    limit_val = max(1, min(int(limit or 1), 5))
...
async def task_gov_ssd_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_ssd_seed_orgs, seedLimit)
    register = await task_gov_ssd_register_dids(registerLimit)
    follow = await task_gov_ssd_follow_site_deps(followLimit)
    ingest = await task_gov_ssd_sync_wet_updates(ingestLimit)
    shinka = await task_gov_ssd_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSsd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_heartbeat_tick)
