...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_ssd_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govSsd.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
