...
def _vertex_id(kind: str, key: str) -> str:
    return f"at://{APP_DID}/ai.gftd.apps.oshikatsu.{kind}/{key}"


def _edge_id(kind: str, src: str, dst: str) -> str:
    return f"at://{APP_DID}/ai.gftd.apps.oshikatsu.edge/{kind}:{src}:{dst}"[:512]
...
def register(worker: Any, *, timeout_ms: int = 60_000) -> None:
    tasks = {
        "xrpc.ai.gftd.apps.oshikatsu.checkAccess": task_oshikatsu_check_access,
        "xrpc.ai.gftd.apps.oshikatsu.createCreatorProfile": task_oshikatsu_create_creator_profile,
        "xrpc.ai.gftd.apps.oshikatsu.creatorStats": task_oshikatsu_creator_stats,
        "xrpc.ai.gftd.apps.oshikatsu.getContent": task_oshikatsu_get_content,
        "xrpc.ai.gftd.apps.oshikatsu.getCreatorProfile": task_oshikatsu_get_creator_profile,
        "xrpc.ai.gftd.apps.oshikatsu.listContent": task_oshikatsu_list_content,
        "xrpc.ai.gftd.apps.oshikatsu.listCreators": task_oshikatsu_list_creators,
        "xrpc.ai.gftd.apps.oshikatsu.listSubscriptions": task_oshikatsu_list_subscriptions,
        "xrpc.ai.gftd.apps.oshikatsu.publishContent": task_oshikatsu_publish_content,
        "xrpc.ai.gftd.apps.oshikatsu.search": task_oshikatsu_search,
        "xrpc.ai.gftd.apps.oshikatsu.subscribe": task_oshikatsu_subscribe,
        "xrpc.ai.gftd.apps.oshikatsu.tip": task_oshikatsu_tip,
        "xrpc.ai.gftd.apps.oshikatsu.unsubscribe": task_oshikatsu_unsubscribe,
        "xrpc.ai.gftd.apps.oshikatsu.updateTiers": task_oshikatsu_update_tiers,
    }
