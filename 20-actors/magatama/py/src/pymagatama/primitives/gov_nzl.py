...
_MINISTRY_NDJSON = """\
{"path":"dpmc","name":"Department of the Prime Minister and Cabinet","nameEn":"Department of the Prime Minister and Cabinet","website":"https://www.dpmc.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"mfat","name":"Ministry of Foreign Affairs and Trade","nameEn":"Ministry of Foreign Affairs and Trade","website":"https://www.mfat.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:01.2","foreign-affairs","trade"],"orgTier":"ministry"}
{"path":"nzdf","name":"New Zealand Defence Force","nameEn":"New Zealand Defence Force","website":"https://www.nzdf.mil.nz/","contract":"Defence Act 1990","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"treasury","name":"The Treasury","nameEn":"The Treasury","website":"https://www.treasury.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:01.1","finance","treasury"],"orgTier":"ministry"}
{"path":"justice","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.justice.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"police","name":"New Zealand Police","nameEn":"New Zealand Police","website":"https://www.police.govt.nz/","contract":"Policing Act 2008","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://www.education.govt.nz/","contract":"Education and Training Act 2020","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.health.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mbie","name":"Ministry of Business Innovation and Employment","nameEn":"Ministry of Business Innovation and Employment","website":"https://www.mbie.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:04","business","labour","immigration"],"orgTier":"ministry"}
{"path":"mpi","name":"Ministry for Primary Industries","nameEn":"Ministry for Primary Industries","website":"https://www.mpi.govt.nz/","contract":"Constitution Act 1986","tags":["cofog:04.2","agriculture","fisheries","forestry"],"orgTier":"ministry"}
{"path":"mfe","name":"Ministry for the Environment","nameEn":"Ministry for the Environment","website":"https://www.mfe.govt.nz/","contract":"Resource Management Act 1991","tags":["cofog:05","environment"],"orgTier":"ministry"}
{"path":"tpk","name":"Te Puni Kōkiri","nameEn":"Ministry for Māori Development","website":"https://www.tpk.govt.nz/","contract":"Te Puni Kōkiri Act 1990","tags":["cofog:01","maori","indigenous"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:northland","name":"Northland Region","nameEn":"Northland Region","website":"https://www.northlandrc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:auckland","name":"Auckland Region","nameEn":"Auckland Region","website":"https://www.aucklandcouncil.govt.nz/","contract":"Local Government (Auckland Council) Act 2009","tags":["cofog:01","region","largest-city"],"orgTier":"state"}
{"path":"region:waikato","name":"Waikato Region","nameEn":"Waikato Region","website":"https://www.waikatoregion.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:bay-of-plenty","name":"Bay of Plenty Region","nameEn":"Bay of Plenty Region","website":"https://www.boprc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:gisborne","name":"Gisborne Region","nameEn":"Gisborne Region","website":"https://www.gdc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:hawkes-bay","name":"Hawke's Bay Region","nameEn":"Hawke's Bay Region","website":"https://www.hbrc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:taranaki","name":"Taranaki Region","nameEn":"Taranaki Region","website":"https://www.trc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:manawatu-whanganui","name":"Manawatū-Whanganui Region","nameEn":"Manawatū-Whanganui Region","website":"https://www.horizons.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:wellington","name":"Wellington Region","nameEn":"Wellington Region","website":"https://www.gw.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region","capital"],"orgTier":"state"}
{"path":"region:tasman","name":"Tasman Region","nameEn":"Tasman Region","website":"https://www.tasman.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:nelson","name":"Nelson Region","nameEn":"Nelson Region","website":"https://www.nelson.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:marlborough","name":"Marlborough Region","nameEn":"Marlborough Region","website":"https://www.marlborough.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:west-coast","name":"West Coast Region","nameEn":"West Coast Region","website":"https://www.wcrc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:canterbury","name":"Canterbury Region","nameEn":"Canterbury Region","website":"https://www.ecan.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:otago","name":"Otago Region","nameEn":"Otago Region","website":"https://www.orc.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:southland","name":"Southland Region","nameEn":"Southland Region","website":"https://www.es.govt.nz/","contract":"Local Government Act 2002","tags":["cofog:01","region"],"orgTier":"state"}
"""
...
def task_gov_nzl_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_nzl_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_nzl_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_nzl_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_nzl_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_nzl_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_nzl_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_nzl_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_nzl_seed_orgs, seedLimit)
    register = await task_gov_nzl_register_dids(registerLimit)
    follow = await task_gov_nzl_follow_site_deps(followLimit)
    ingest = await task_gov_nzl_sync_wet_updates(ingestLimit)
    shinka = await task_gov_nzl_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNzl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nzl_heartbeat_tick)
