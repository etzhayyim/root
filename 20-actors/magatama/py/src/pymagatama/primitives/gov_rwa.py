"""RWA Government states actor primitives.

This module moves the `did:web:rwa-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:rwa-state.etzhayyim.com"
DOMAIN_CODE = "rwa"
...
_MINISTRY_NDJSON = """\
{"path":"presidency","name":"Office of the President","nameEn":"Office of the President","website":"https://www.presidency.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"defence","name":"Ministry of Defence","nameEn":"Ministry of Defence","website":"https://www.mod.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"finance","name":"Ministry of Finance and Economic Planning","nameEn":"Ministry of Finance and Economic Planning","website":"https://www.minecofin.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01.1","finance","planning","economy"],"orgTier":"ministry"}
{"path":"foreign-affairs","name":"Ministry of Foreign Affairs and International Cooperation","nameEn":"Ministry of Foreign Affairs","website":"https://www.minaffet.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"justice","name":"Ministry of Justice","nameEn":"Ministry of Justice","website":"https://www.minijust.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"local-govt","name":"Ministry of Local Government","nameEn":"Ministry of Local Government","website":"https://www.minaloc.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","local-government","decentralization"],"orgTier":"ministry"}
{"path":"education","name":"Ministry of Education","nameEn":"Ministry of Education","website":"https://www.mineduc.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"health","name":"Ministry of Health","nameEn":"Ministry of Health","website":"https://www.moh.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"agriculture","name":"Ministry of Agriculture and Animal Resources","nameEn":"Ministry of Agriculture and Animal Resources","website":"https://www.minagri.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"ict-innovation","name":"Ministry of ICT and Innovation","nameEn":"Ministry of ICT and Innovation","website":"https://www.minict.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:04","ict","innovation","digital"],"orgTier":"ministry"}
{"path":"environment","name":"Ministry of Environment","nameEn":"Ministry of Environment","website":"https://www.environment.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:05","environment"],"orgTier":"ministry"}
{"path":"infrastructure","name":"Ministry of Infrastructure","nameEn":"Ministry of Infrastructure","website":"https://www.mininfra.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:04.5","infrastructure","transport","energy"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:eastern","name":"Intara y'Iburasirazuba","nameEn":"Eastern Province","website":"https://www.eastern.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","intara"],"orgTier":"state"}
{"path":"prov:kigali-city","name":"Umujyi wa Kigali","nameEn":"Kigali City Province","website":"https://www.kigalicity.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","intara","capital"],"orgTier":"state"}
{"path":"prov:northern","name":"Intara y'Amajyaruguru","nameEn":"Northern Province","website":"https://www.northern.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","intara"],"orgTier":"state"}
{"path":"prov:southern","name":"Intara y'Amajyepfo","nameEn":"Southern Province","website":"https://www.southern.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","intara"],"orgTier":"state"}
{"path":"prov:western","name":"Intara y'Iburengerazuba","nameEn":"Western Province","website":"https://www.western.gov.rw/","contract":"Constitution 2003 (amended 2015)","tags":["cofog:01","intara"],"orgTier":"state"}
"""
...
def task_gov_rwa_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_rwa_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_rwa_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_rwa_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_rwa_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_rwa_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_rwa_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_rwa_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_rwa_seed_orgs, seedLimit)
    register = await task_gov_rwa_register_dids(registerLimit)
    follow = await task_gov_rwa_follow_site_deps(followLimit)
    ingest = await task_gov_rwa_sync_wet_updates(ingestLimit)
    shinka = await task_gov_rwa_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govRwa.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_rwa_heartbeat_tick)
