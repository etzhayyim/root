...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govEst.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
