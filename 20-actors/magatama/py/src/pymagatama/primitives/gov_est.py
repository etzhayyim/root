"""EST Government states actor primitives.

This module moves the `did:web:est-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:est-state.etzhayyim.com"
DOMAIN_CODE = "est"
...
_MINISTRY_NDJSON = """\
{"path":"riigikantselei","name":"Riigikantselei","nameEn":"State Chancellery","website":"https://www.riigikantselei.ee/","contract":"Põhiseadus §86","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"vm","name":"Välisministeerium","nameEn":"Ministry of Foreign Affairs","website":"https://www.vm.ee/","contract":"Põhiseadus §86","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"kmin","name":"Kaitseministeerium","nameEn":"Ministry of Defence","website":"https://www.kaitseministeerium.ee/","contract":"Põhiseadus §86","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"rm","name":"Rahandusministeerium","nameEn":"Ministry of Finance","website":"https://www.rahandusministeerium.ee/","contract":"Põhiseadus §86","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"sisemin","name":"Siseministeerium","nameEn":"Ministry of Interior","website":"https://www.siseministeerium.ee/","contract":"Põhiseadus §86","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"jm","name":"Justiits- ja Digiministeerium","nameEn":"Ministry of Justice and Digital Affairs","website":"https://www.just.ee/","contract":"Põhiseadus §86","tags":["cofog:03","justice","digital"],"orgTier":"ministry"}
{"path":"htm","name":"Haridus- ja Teadusministeerium","nameEn":"Ministry of Education and Research","website":"https://www.hm.ee/","contract":"Põhiseadus §86","tags":["cofog:09","education","research"],"orgTier":"ministry"}
{"path":"shm","name":"Sotsiaalministeerium","nameEn":"Ministry of Social Affairs","website":"https://www.sm.ee/","contract":"Põhiseadus §86","tags":["cofog:07","health","social","labour"],"orgTier":"ministry"}
{"path":"mkm","name":"Majandus- ja Kommunikatsiooniministeerium","nameEn":"Ministry of Economic Affairs and Communications","website":"https://www.mkm.ee/","contract":"Põhiseadus §86","tags":["cofog:04","economy","transport","ict"],"orgTier":"ministry"}
{"path":"klim","name":"Kliimaministeerium","nameEn":"Ministry of Climate","website":"https://www.kliimaministeerium.ee/","contract":"Põhiseadus §86","tags":["cofog:04","climate","environment","energy"],"orgTier":"ministry"}
{"path":"mam","name":"Maaeluministeerium","nameEn":"Ministry of Regional Affairs and Agriculture","website":"https://www.agri.ee/","contract":"Põhiseadus §86","tags":["cofog:04.2","agriculture","rural"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"maakond:harju","name":"Harju maakond","nameEn":"Harju County","website":"https://www.harju.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5","capital"],"orgTier":"state"}
{"path":"maakond:hiiu","name":"Hiiu maakond","nameEn":"Hiiu County","website":"https://www.hiiumaa.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:ida-viru","name":"Ida-Viru maakond","nameEn":"Ida-Viru County","website":"https://www.ida-virumaa.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:jogeva","name":"Jõgeva maakond","nameEn":"Jõgeva County","website":"https://www.jogeva.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:jarva","name":"Järva maakond","nameEn":"Järva County","website":"https://www.jarva.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:laane","name":"Lääne maakond","nameEn":"Lääne County","website":"https://www.laane.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:laane-viru","name":"Lääne-Viru maakond","nameEn":"Lääne-Viru County","website":"https://www.laaneviru.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:polva","name":"Põlva maakond","nameEn":"Põlva County","website":"https://www.polva.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:parnu","name":"Pärnu maakond","nameEn":"Pärnu County","website":"https://www.parnu.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:rapla","name":"Rapla maakond","nameEn":"Rapla County","website":"https://www.rapla.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:saare","name":"Saare maakond","nameEn":"Saare County","website":"https://www.saaremaa.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:tartu","name":"Tartu maakond","nameEn":"Tartu County","website":"https://www.tartu.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:valga","name":"Valga maakond","nameEn":"Valga County","website":"https://www.valga.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:viljandi","name":"Viljandi maakond","nameEn":"Viljandi County","website":"https://www.viljandimaa.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
{"path":"maakond:voru","name":"Võru maakond","nameEn":"Võru County","website":"https://www.voru.ee/","contract":"Põhiseadus §158","tags":["cofog:01","maakond","l5"],"orgTier":"state"}
"""
...
def task_gov_est_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_est_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_est_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_est_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_est_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_est_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_est_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_est_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_est_seed_orgs, seedLimit)
    register = await task_gov_est_register_dids(registerLimit)
    follow = await task_gov_est_follow_site_deps(followLimit)
    ingest = await task_gov_est_sync_wet_updates(ingestLimit)
    shinka = await task_gov_est_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEst.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_est_heartbeat_tick)
