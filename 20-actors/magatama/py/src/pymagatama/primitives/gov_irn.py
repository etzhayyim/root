...
This module moves the `did:web:irn-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:irn-state.gftd.ai"
DOMAIN_CODE = "irn"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_irn_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govIrn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
