...
def _base(table_kind: str, rkey: str, label: str = "") -> dict[str, Any]:
    return {
        "vertex_id": f"at://{ISEKAI_DID}/app.etzhayyim.apps.isekai.{table_kind}/{rkey}",
        "created_date": _today(),
        "sensitivity_ord": 1,
...
def register(worker: Any, *, timeout_ms: int = 60_000) -> None:
    tasks = {
        "xrpc.app.etzhayyim.apps.isekai.analyze": task_isekai_analyze,
        "xrpc.app.etzhayyim.apps.isekai.browseWorlds": task_isekai_browse_worlds,
        "xrpc.app.etzhayyim.apps.isekai.cardHome": task_isekai_card_home,
        "xrpc.app.etzhayyim.apps.isekai.catchPokoa": task_isekai_catch_pokoa,
        "xrpc.app.etzhayyim.apps.isekai.craftItem": task_isekai_craft_item,
        "xrpc.app.etzhayyim.apps.isekai.createWorld": task_isekai_create_world,
        "xrpc.app.etzhayyim.apps.isekai.fleeBattle": task_isekai_flee_battle,
        "xrpc.app.etzhayyim.apps.isekai.getChunk": task_isekai_get_chunk,
        "xrpc.app.etzhayyim.apps.isekai.getCompliance": task_isekai_get_compliance,
        "xrpc.app.etzhayyim.apps.isekai.getInventory": task_isekai_get_inventory,
        "xrpc.app.etzhayyim.apps.isekai.getLegendaries": task_isekai_get_legendaries,
        "xrpc.app.etzhayyim.apps.isekai.getPortalState": task_isekai_get_portal_state,
        "xrpc.app.etzhayyim.apps.isekai.getRoster": task_isekai_get_roster,
        "xrpc.app.etzhayyim.apps.isekai.getWorld": task_isekai_get_world,
        "xrpc.app.etzhayyim.apps.isekai.healParty": task_isekai_heal_party,
        "xrpc.app.etzhayyim.apps.isekai.listRecipes": task_isekai_list_recipes,
        "xrpc.app.etzhayyim.apps.isekai.listScenes": task_isekai_list_scenes,
        "xrpc.app.etzhayyim.apps.isekai.mineBlock": task_isekai_mine_block,
        "xrpc.app.etzhayyim.apps.isekai.placeBlock": task_isekai_place_block,
        "xrpc.app.etzhayyim.apps.isekai.registerCompliance": task_isekai_register_compliance,
        "xrpc.app.etzhayyim.apps.isekai.rollBrainrot": task_isekai_roll_brainrot,
        "xrpc.app.etzhayyim.apps.isekai.rollEncounter": task_isekai_roll_encounter,
        "xrpc.app.etzhayyim.apps.isekai.startBattle": task_isekai_start_battle,
        "xrpc.app.etzhayyim.apps.isekai.startOhioRaid": task_isekai_start_ohio_raid,
        "xrpc.app.etzhayyim.apps.isekai.teleportBiome": task_isekai_teleport_biome,
        "xrpc.app.etzhayyim.apps.isekai.useMove": task_isekai_use_move,
    }
