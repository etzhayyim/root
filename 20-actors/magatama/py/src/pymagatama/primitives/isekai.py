...
def _base(table_kind: str, rkey: str, label: str = "") -> dict[str, Any]:
    return {
        "vertex_id": f"at://{ISEKAI_DID}/ai.gftd.apps.isekai.{table_kind}/{rkey}",
        "created_date": _today(),
        "sensitivity_ord": 1,
...
def register(worker: Any, *, timeout_ms: int = 60_000) -> None:
    tasks = {
        "xrpc.ai.gftd.apps.isekai.analyze": task_isekai_analyze,
        "xrpc.ai.gftd.apps.isekai.browseWorlds": task_isekai_browse_worlds,
        "xrpc.ai.gftd.apps.isekai.cardHome": task_isekai_card_home,
        "xrpc.ai.gftd.apps.isekai.catchPokoa": task_isekai_catch_pokoa,
        "xrpc.ai.gftd.apps.isekai.craftItem": task_isekai_craft_item,
        "xrpc.ai.gftd.apps.isekai.createWorld": task_isekai_create_world,
        "xrpc.ai.gftd.apps.isekai.fleeBattle": task_isekai_flee_battle,
        "xrpc.ai.gftd.apps.isekai.getChunk": task_isekai_get_chunk,
        "xrpc.ai.gftd.apps.isekai.getCompliance": task_isekai_get_compliance,
        "xrpc.ai.gftd.apps.isekai.getInventory": task_isekai_get_inventory,
        "xrpc.ai.gftd.apps.isekai.getLegendaries": task_isekai_get_legendaries,
        "xrpc.ai.gftd.apps.isekai.getPortalState": task_isekai_get_portal_state,
        "xrpc.ai.gftd.apps.isekai.getRoster": task_isekai_get_roster,
        "xrpc.ai.gftd.apps.isekai.getWorld": task_isekai_get_world,
        "xrpc.ai.gftd.apps.isekai.healParty": task_isekai_heal_party,
        "xrpc.ai.gftd.apps.isekai.listRecipes": task_isekai_list_recipes,
        "xrpc.ai.gftd.apps.isekai.listScenes": task_isekai_list_scenes,
        "xrpc.ai.gftd.apps.isekai.mineBlock": task_isekai_mine_block,
        "xrpc.ai.gftd.apps.isekai.placeBlock": task_isekai_place_block,
        "xrpc.ai.gftd.apps.isekai.registerCompliance": task_isekai_register_compliance,
        "xrpc.ai.gftd.apps.isekai.rollBrainrot": task_isekai_roll_brainrot,
        "xrpc.ai.gftd.apps.isekai.rollEncounter": task_isekai_roll_encounter,
        "xrpc.ai.gftd.apps.isekai.startBattle": task_isekai_start_battle,
        "xrpc.ai.gftd.apps.isekai.startOhioRaid": task_isekai_start_ohio_raid,
        "xrpc.ai.gftd.apps.isekai.teleportBiome": task_isekai_teleport_biome,
        "xrpc.ai.gftd.apps.isekai.useMove": task_isekai_use_move,
    }
