"""AUT Government states actor primitives.

This module moves the `did:web:aut-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:aut-state.etzhayyim.com"
DOMAIN_CODE = "aut"
...
_MINISTRY_NDJSON = """\
{"path":"bundeskanzleramt","name":"Bundeskanzleramt","nameEn":"Federal Chancellery","website":"https://www.bundeskanzleramt.gv.at/","contract":"B-VG Art. 69","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"bmeia","name":"Bundesministerium für europäische und internationale Angelegenheiten","nameEn":"Federal Ministry for European and International Affairs","website":"https://www.bmeia.gv.at/","contract":"B-VG Art. 69","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"bmi","name":"Bundesministerium für Inneres","nameEn":"Federal Ministry of the Interior","website":"https://www.bmi.gv.at/","contract":"B-VG Art. 69","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"bmlv","name":"Bundesministerium für Landesverteidigung","nameEn":"Federal Ministry of Defence","website":"https://www.bundesheer.at/","contract":"B-VG Art. 69","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"bmf","name":"Bundesministerium für Finanzen","nameEn":"Federal Ministry of Finance","website":"https://www.bmf.gv.at/","contract":"B-VG Art. 69","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"bmj","name":"Bundesministerium für Justiz","nameEn":"Federal Ministry of Justice","website":"https://www.bmj.gv.at/","contract":"B-VG Art. 69","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"bmbwf","name":"Bundesministerium für Bildung, Wissenschaft und Forschung","nameEn":"Federal Ministry of Education, Science and Research","website":"https://www.bmbwf.gv.at/","contract":"B-VG Art. 69","tags":["cofog:09","education","research"],"orgTier":"ministry"}
{"path":"bmsgpk","name":"Bundesministerium für Soziales, Gesundheit, Pflege und Konsumentenschutz","nameEn":"Federal Ministry of Social Affairs, Health, Care and Consumer Protection","website":"https://www.sozialministerium.at/","contract":"B-VG Art. 69","tags":["cofog:07","health","social"],"orgTier":"ministry"}
{"path":"bmaw","name":"Bundesministerium für Arbeit und Wirtschaft","nameEn":"Federal Ministry of Labour and Economy","website":"https://www.bmaw.gv.at/","contract":"B-VG Art. 69","tags":["cofog:04","labour","economy"],"orgTier":"ministry"}
{"path":"bml","name":"Bundesministerium für Land- und Forstwirtschaft, Regionen und Wasserwirtschaft","nameEn":"Federal Ministry of Agriculture, Forestry, Regions and Water Management","website":"https://www.bml.gv.at/","contract":"B-VG Art. 69","tags":["cofog:04.2","agriculture","forestry"],"orgTier":"ministry"}
{"path":"bmk","name":"Bundesministerium für Klimaschutz, Umwelt, Energie, Mobilität, Innovation und Technologie","nameEn":"Federal Ministry for Climate Action, Environment, Energy, Mobility, Innovation and Technology","website":"https://www.bmk.gv.at/","contract":"B-VG Art. 69","tags":["cofog:04","climate","energy","transport"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"land:burgenland","name":"Burgenland","nameEn":"Burgenland","website":"https://www.burgenland.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:carinthia","name":"Kärnten","nameEn":"Carinthia","website":"https://www.ktn.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:lower-austria","name":"Niederösterreich","nameEn":"Lower Austria","website":"https://www.noe.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:upper-austria","name":"Oberösterreich","nameEn":"Upper Austria","website":"https://www.land-oberoesterreich.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:salzburg","name":"Salzburg","nameEn":"Salzburg","website":"https://www.salzburg.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:styria","name":"Steiermark","nameEn":"Styria","website":"https://www.steiermark.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:tyrol","name":"Tirol","nameEn":"Tyrol","website":"https://www.tirol.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:vorarlberg","name":"Vorarlberg","nameEn":"Vorarlberg","website":"https://www.vorarlberg.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","l5"],"orgTier":"state"}
{"path":"land:vienna","name":"Wien","nameEn":"Vienna","website":"https://www.wien.gv.at/","contract":"B-VG Art. 15","tags":["cofog:01","bundesland","city-state","capital"],"orgTier":"state"}
"""
...
def task_gov_aut_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_aut_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_aut_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_aut_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_aut_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_aut_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_aut_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_aut_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_aut_seed_orgs, seedLimit)
    register = await task_gov_aut_register_dids(registerLimit)
    follow = await task_gov_aut_follow_site_deps(followLimit)
    ingest = await task_gov_aut_sync_wet_updates(ingestLimit)
    shinka = await task_gov_aut_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAut.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_aut_heartbeat_tick)
