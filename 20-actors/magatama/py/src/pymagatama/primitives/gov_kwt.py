"""KWT Government states actor primitives.

This module moves the `did:web:kwt-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:kwt-state.etzhayyim.com"
DOMAIN_CODE = "kwt"
...
_MINISTRY_NDJSON = """\
{"path":"diwan-amiri","name":"الديوان الأميري","nameEn":"Amiri Diwan","website":"https://www.da.gov.kw/","contract":"الدستور الكويتي المادة 55","tags":["cofog:01","executive","emir"],"orgTier":"ministry"}
{"path":"majlis-wuzara","name":"مجلس الوزراء","nameEn":"Council of Ministers","website":"https://www.csb.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:01","cabinet","prime-minister"],"orgTier":"ministry"}
{"path":"mfa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mofa.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defence","website":"https://www.mod.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mof.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moe","name":"وزارة التربية","nameEn":"Ministry of Education","website":"https://www.moe.edu.kw/","contract":"الدستور المادة 40","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"وزارة الصحة","nameEn":"Ministry of Health","website":"https://www.moh.gov.kw/","contract":"الدستور المادة 15","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"moict","name":"وزارة الإعلام والتكنولوجيا","nameEn":"Ministry of Information and Technology","website":"https://www.moci.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:04","information","ict"],"orgTier":"ministry"}
{"path":"mociav","name":"وزارة التجارة والصناعة","nameEn":"Ministry of Commerce and Industry","website":"https://www.moci.gov.kw/","contract":"الدستور المادة 56","tags":["cofog:04","commerce","industry"],"orgTier":"ministry"}
{"path":"majlis-umma","name":"مجلس الأمة","nameEn":"National Assembly","website":"https://www.kna.kw/","contract":"الدستور المادة 50","tags":["cofog:01","legislature","national-assembly"],"orgTier":"agency"}
{"path":"mahkama-dusturiyya","name":"المحكمة الدستورية","nameEn":"Constitutional Court","website":"https://www.constitutionalcourt.gov.kw/","contract":"الدستور المادة 173","tags":["cofog:03","judiciary","constitutional"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"muhafaza:asimah","name":"محافظة العاصمة","nameEn":"Al Asimah Governorate (Capital)","website":"https://www.asimah.gov.kw/","contract":"المرسوم الأميري رقم 5 لسنة 1967","tags":["cofog:01","muhafaza","capital","kuwait-city"],"orgTier":"state"}
{"path":"muhafaza:hawalli","name":"محافظة حولي","nameEn":"Hawalli Governorate","website":"https://www.hawalli.gov.kw/","contract":"المرسوم الأميري رقم 5 لسنة 1967","tags":["cofog:01","muhafaza","urban","residential"],"orgTier":"state"}
{"path":"muhafaza:farwaniyah","name":"محافظة الفروانية","nameEn":"Al Farwaniyah Governorate","website":"https://www.farwaniya.gov.kw/","contract":"المرسوم الأميري رقم 5 لسنة 1967","tags":["cofog:01","muhafaza","most-populated"],"orgTier":"state"}
{"path":"muhafaza:ahmadi","name":"محافظة الأحمدي","nameEn":"Ahmadi Governorate","website":"https://www.ahmadi.gov.kw/","contract":"المرسوم الأميري رقم 5 لسنة 1967","tags":["cofog:01","muhafaza","oil","industrial"],"orgTier":"state"}
{"path":"muhafaza:jahra","name":"محافظة الجهراء","nameEn":"Al Jahra Governorate","website":"https://www.jahra.gov.kw/","contract":"المرسوم الأميري رقم 5 لسنة 1967","tags":["cofog:01","muhafaza","northern","historic"],"orgTier":"state"}
{"path":"muhafaza:mubarak-al-kabeer","name":"محافظة مبارك الكبير","nameEn":"Mubarak Al-Kabeer Governorate","website":"https://www.mubarak.gov.kw/","contract":"المرسوم الأميري رقم 5 لسنة 1967","tags":["cofog:01","muhafaza","southern"],"orgTier":"state"}
"""
...
def task_gov_kwt_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_kwt_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_kwt_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_kwt_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_kwt_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_kwt_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_kwt_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_kwt_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_kwt_seed_orgs, seedLimit)
    register = await task_gov_kwt_register_dids(registerLimit)
    follow = await task_gov_kwt_follow_site_deps(followLimit)
    ingest = await task_gov_kwt_sync_wet_updates(ingestLimit)
    shinka = await task_gov_kwt_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKwt.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_kwt_heartbeat_tick)
