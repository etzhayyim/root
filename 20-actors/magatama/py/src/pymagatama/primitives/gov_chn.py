...
This module moves the `did:web:chn-state.gftd.ai` app actor off its
...
PRIMARY_DID = "did:web:chn-state.gftd.ai"
DOMAIN_CODE = "chn"
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govChn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_chn_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govChn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
