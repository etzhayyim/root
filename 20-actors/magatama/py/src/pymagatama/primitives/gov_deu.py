"""DEU Government states actor primitives.

This module moves the `did:web:deu-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:deu-state.etzhayyim.com"
DOMAIN_CODE = "deu"
...
_MINISTRY_NDJSON = """\
{"path":"bundeskanzleramt","name":"Bundeskanzleramt","nameEn":"Federal Chancellery","website":"https://www.bundesregierung.de/","contract":"Grundgesetz Art. 65","tags":["cofog:01","executive","chancellor"],"orgTier":"ministry"}
{"path":"bmvg","name":"Bundesministerium der Verteidigung","nameEn":"Federal Ministry of Defence","website":"https://www.bundeswehr.de/","contract":"Grundgesetz Art. 65a","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"aa","name":"Auswärtiges Amt","nameEn":"Federal Foreign Office","website":"https://www.auswaertiges-amt.de/","contract":"Grundgesetz Art. 32","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"bmf","name":"Bundesministerium der Finanzen","nameEn":"Federal Ministry of Finance","website":"https://www.bundesfinanzministerium.de/","contract":"Grundgesetz Art. 108-115","tags":["cofog:01.1","finance","taxation","budget"],"orgTier":"ministry"}
{"path":"bmj","name":"Bundesministerium der Justiz","nameEn":"Federal Ministry of Justice","website":"https://www.bmj.de/","contract":"Grundgesetz Art. 92","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"bmi","name":"Bundesministerium des Innern","nameEn":"Federal Ministry of the Interior","website":"https://www.bmi.bund.de/","contract":"Grundgesetz Art. 73","tags":["cofog:03","interior","police","cybersecurity"],"orgTier":"ministry"}
{"path":"bmas","name":"Bundesministerium für Arbeit und Soziales","nameEn":"Federal Ministry of Labour and Social Affairs","website":"https://www.bmas.de/","contract":"Grundgesetz Art. 74","tags":["cofog:04","labour","social"],"orgTier":"ministry"}
{"path":"bmbf","name":"Bundesministerium für Bildung und Forschung","nameEn":"Federal Ministry of Education and Research","website":"https://www.bmbf.de/","contract":"Grundgesetz Art. 91b","tags":["cofog:09","education","research"],"orgTier":"ministry"}
{"path":"bmg","name":"Bundesministerium für Gesundheit","nameEn":"Federal Ministry of Health","website":"https://www.bundesgesundheitsministerium.de/","contract":"Grundgesetz Art. 74","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"bmel","name":"Bundesministerium für Ernährung und Landwirtschaft","nameEn":"Federal Ministry of Food and Agriculture","website":"https://www.bmel.de/","contract":"Grundgesetz Art. 74","tags":["cofog:04.2","agriculture","food"],"orgTier":"ministry"}
{"path":"bmwk","name":"Bundesministerium für Wirtschaft und Klimaschutz","nameEn":"Federal Ministry for Economic Affairs and Climate Action","website":"https://www.bmwk.de/","contract":"Grundgesetz Art. 74","tags":["cofog:04","economy","energy","climate"],"orgTier":"ministry"}
{"path":"bmvbs","name":"Bundesministerium für Digitales und Verkehr","nameEn":"Federal Ministry for Digital and Transport","website":"https://www.bmdv.bund.de/","contract":"Grundgesetz Art. 74","tags":["cofog:04.5","transport","digital","infrastructure"],"orgTier":"ministry"}
{"path":"bmz","name":"Bundesministerium für wirtschaftliche Zusammenarbeit","nameEn":"Federal Ministry for Economic Cooperation and Development","website":"https://www.bmz.de/","contract":"Grundgesetz Art. 32","tags":["cofog:01.2","development-aid"],"orgTier":"ministry"}
{"path":"bundestag","name":"Deutscher Bundestag","nameEn":"German Bundestag","website":"https://www.bundestag.de/","contract":"Grundgesetz Art. 38-49","tags":["cofog:01","legislature"],"orgTier":"agency"}
{"path":"bundesrat","name":"Bundesrat","nameEn":"German Bundesrat","website":"https://www.bundesrat.de/","contract":"Grundgesetz Art. 50-53","tags":["cofog:01","legislature","states-chamber"],"orgTier":"agency"}
{"path":"bverfg","name":"Bundesverfassungsgericht","nameEn":"Federal Constitutional Court","website":"https://www.bundesverfassungsgericht.de/","contract":"Grundgesetz Art. 93-94","tags":["cofog:03","judiciary","constitutional-court"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"land:bw","name":"Baden-Württemberg","nameEn":"Baden-Württemberg","website":"https://www.landesregierung-bw.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:by","name":"Bayern","nameEn":"Bavaria","website":"https://www.bayern.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:be","name":"Berlin","nameEn":"Berlin","website":"https://www.berlin.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","city-state","capital"],"orgTier":"state"}
{"path":"land:bb","name":"Brandenburg","nameEn":"Brandenburg","website":"https://www.brandenburg.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:hb","name":"Bremen","nameEn":"Bremen","website":"https://www.bremen.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","city-state"],"orgTier":"state"}
{"path":"land:hh","name":"Hamburg","nameEn":"Hamburg","website":"https://www.hamburg.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","city-state","port"],"orgTier":"state"}
{"path":"land:he","name":"Hessen","nameEn":"Hesse","website":"https://www.hessen.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:mv","name":"Mecklenburg-Vorpommern","nameEn":"Mecklenburg-Vorpommern","website":"https://www.regierung-mv.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:ni","name":"Niedersachsen","nameEn":"Lower Saxony","website":"https://www.niedersachsen.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:nw","name":"Nordrhein-Westfalen","nameEn":"North Rhine-Westphalia","website":"https://www.nrw.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5","largest-state"],"orgTier":"state"}
{"path":"land:rp","name":"Rheinland-Pfalz","nameEn":"Rhineland-Palatinate","website":"https://www.rlp.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:sl","name":"Saarland","nameEn":"Saarland","website":"https://www.saarland.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:sn","name":"Sachsen","nameEn":"Saxony","website":"https://www.sachsen.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:st","name":"Sachsen-Anhalt","nameEn":"Saxony-Anhalt","website":"https://www.sachsen-anhalt.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:sh","name":"Schleswig-Holstein","nameEn":"Schleswig-Holstein","website":"https://www.schleswig-holstein.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
{"path":"land:th","name":"Thüringen","nameEn":"Thuringia","website":"https://www.thueringen.de/","contract":"Grundgesetz Art. 20/28/30","tags":["cofog:01","land","l5"],"orgTier":"state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str], owner_did: str = PRIMARY_DID) -> None:
    ...
    if not path or not updates:
        return
    actual_owner = owner_did or PRIMARY_DID
    row_dict = {
        "vertex_id": f"at://{actual_owner}/com.etzhayyim.apps.states.govOrg/{path}",
        **updates,
    }
    get_kotoba_client().insert_row("vertex_gov_org", row_dict)


def _get_org(path: str) -> dict[str, Any] | None:
    # R0: using select_first_where with vertex_id, no domain_code/owner_did predicates needed as vertex_id is unique
...
def task_gov_deu_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: fetch limit=10000 by domain_code and filter name_en != '' in Python
...
def task_gov_deu_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_deu_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))

    # R0: fetch limit=2000 by domain_code and apply filtering, ordering, pagination in Python
...
async def task_gov_deu_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    # R0: fetch limit=2000 by domain_code and filter/order/limit in Python
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
        columns=[
            "path", "name", "name_en", "website", "contract", "tags", "org_tier",
...
async def task_gov_deu_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_deu_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    all_rows = get_kotoba_client().select_where(
        "vertex_gov_org", "domain_code", DOMAIN_CODE,
        columns=["path", "name_en", "website", "site_domain_slug", "last_content_hash", "owner_did", "last_ingested_at"],
        limit=2000
    )
    filtered = []
    for r in all_rows:
        if not r.get("site_domain_slug"):
            continue
        l_hash = str(r.get("last_content_hash") or "")
        l_ing = str(r.get("last_ingested_at") or "")
        if not l_hash or not l_ing or l_ing < cutoff_iso:
            filtered.append(r)
    ...
    for r in rows:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: fetch wet chunks by domain, sort in Python
...
async def task_gov_deu_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_deu_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_deu_seed_orgs, seedLimit)
    register = await task_gov_deu_register_dids(registerLimit)
    follow = await task_gov_deu_follow_site_deps(followLimit)
    ingest = await task_gov_deu_sync_wet_updates(ingestLimit)
    shinka = await task_gov_deu_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_deu_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govDeu.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
