...
from pymagatama.primitives import hume_emotion
            ...
            if files:
                for part in files:
                    ...
                    try:
                        ...
                        if raw and is_audio:
                            from pymagatama.primitives.hume_audio_head import extract_wav_features
                            feats = extract_wav_features(raw)
                            if feats:
                                input_obj["audioFeatures"] = feats
                        elif raw and is_image:
                            from pymagatama.primitives.hume_image_head import extract_image_features
...
async def task_hume_distill_train_student_audio(
    ...
    from pymagatama.primitives.hume_audio_head import train_audio_centroid
