...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_alb_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAlb.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
