"""SEN Government states actor primitives.

This module moves the `did:web:sen-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:sen-state.etzhayyim.com"
DOMAIN_CODE = "sen"
...
_MINISTRY_NDJSON = """\
{"path":"presidence","name":"Présidence de la République","nameEn":"Presidency of the Republic","website":"https://www.presidence.sn/","contract":"Constitution sénégalaise 2001 Art. 42","tags":["cofog:01","executive","president"],"orgTier":"ministry"}
{"path":"pm","name":"Primature","nameEn":"Office of the Prime Minister","website":"https://www.primature.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:01","prime-minister"],"orgTier":"ministry"}
{"path":"mae","name":"Ministère des Affaires Étrangères","nameEn":"Ministry of Foreign Affairs","website":"https://www.diplomatie.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mdn","name":"Ministère des Forces Armées","nameEn":"Ministry of Armed Forces","website":"https://www.defense.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:02","defence","armed-forces"],"orgTier":"ministry"}
{"path":"mef","name":"Ministère des Finances et du Budget","nameEn":"Ministry of Finance and Budget","website":"https://www.finances.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"mjdh","name":"Ministère de la Justice","nameEn":"Ministry of Justice","website":"https://www.justice.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"mint","name":"Ministère de l'Intérieur","nameEn":"Ministry of Interior","website":"https://www.interieur.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:03","interior","security"],"orgTier":"ministry"}
{"path":"men","name":"Ministère de l'Éducation Nationale","nameEn":"Ministry of National Education","website":"https://www.education.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"msas","name":"Ministère de la Santé et de l'Action Sociale","nameEn":"Ministry of Health and Social Action","website":"https://www.sante.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:07","health","social-action"],"orgTier":"ministry"}
{"path":"mfptss","name":"Ministère de la Fonction Publique, du Travail et des Relations avec les Institutions","nameEn":"Ministry of Civil Service, Labour and Relations with Institutions","website":"https://www.fonctionpublique.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:04","civil-service","labour"],"orgTier":"ministry"}
{"path":"mcom","name":"Ministère du Commerce et de l'Industrie","nameEn":"Ministry of Commerce and Industry","website":"https://www.commerce.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:04","commerce","industry"],"orgTier":"ministry"}
{"path":"maer","name":"Ministère de l'Agriculture, de l'Équipement Rural et de la Souveraineté Alimentaire","nameEn":"Ministry of Agriculture, Rural Equipment and Food Sovereignty","website":"https://www.agriculture.gouv.sn/","contract":"Constitution sénégalaise 2001","tags":["cofog:04.2","agriculture","food","rural"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:dakar","name":"Région de Dakar","nameEn":"Dakar Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","capital"],"orgTier":"state"}
{"path":"region:thies","name":"Région de Thiès","nameEn":"Thiès Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:diourbel","name":"Région de Diourbel","nameEn":"Diourbel Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:fatick","name":"Région de Fatick","nameEn":"Fatick Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:kaolack","name":"Région de Kaolack","nameEn":"Kaolack Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:kaffrine","name":"Région de Kaffrine","nameEn":"Kaffrine Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:kolda","name":"Région de Kolda","nameEn":"Kolda Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","casamance"],"orgTier":"state"}
{"path":"region:louga","name":"Région de Louga","nameEn":"Louga Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region"],"orgTier":"state"}
{"path":"region:matam","name":"Région de Matam","nameEn":"Matam Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","north"],"orgTier":"state"}
{"path":"region:saint-louis","name":"Région de Saint-Louis","nameEn":"Saint-Louis Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","historic","north"],"orgTier":"state"}
{"path":"region:sedhiou","name":"Région de Sédhiou","nameEn":"Sédhiou Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","casamance"],"orgTier":"state"}
{"path":"region:tambacounda","name":"Région de Tambacounda","nameEn":"Tambacounda Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","largest"],"orgTier":"state"}
{"path":"region:ziguinchor","name":"Région de Ziguinchor","nameEn":"Ziguinchor Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","casamance"],"orgTier":"state"}
{"path":"region:kedougou","name":"Région de Kédougou","nameEn":"Kédougou Region","website":"https://www.gouv.sn/","contract":"Constitution sénégalaise 2001 Title XI","tags":["cofog:01","region","south-east","mining"],"orgTier":"state"}
"""
...
def task_gov_sen_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_sen_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_sen_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_sen_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_sen_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_sen_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_sen_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_sen_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_sen_seed_orgs, seedLimit)
    register = await task_gov_sen_register_dids(registerLimit)
    follow = await task_gov_sen_follow_site_deps(followLimit)
    ingest = await task_gov_sen_sync_wet_updates(ingestLimit)
    shinka = await task_gov_sen_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSen.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_heartbeat_tick)
