...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govSen.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sen_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govSen.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
