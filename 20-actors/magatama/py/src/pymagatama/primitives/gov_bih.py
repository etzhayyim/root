"""BIH Government states actor primitives.

This module moves the `did:web:bih-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:bih-state.etzhayyim.com"
DOMAIN_CODE = "bih"
...
_MINISTRY_NDJSON = """\
{"path":"vjece-ministara","name":"Vijeće ministara BiH","nameEn":"Council of Ministers of BiH","website":"https://www.vijeceministara.gov.ba/","contract":"Ustav BiH 1995 Art. V","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"mip","name":"Ministarstvo vanjskih poslova","nameEn":"Ministry of Foreign Affairs","website":"https://www.mvp.gov.ba/","contract":"Ustav BiH Art. III","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"Ministarstvo odbrane","nameEn":"Ministry of Defence","website":"https://www.mod.gov.ba/","contract":"Ustav BiH Art. V","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"Ministarstvo financija i trezora","nameEn":"Ministry of Finance and Treasury","website":"https://www.mft.gov.ba/","contract":"Ustav BiH Art. V","tags":["cofog:01.1","finance","treasury"],"orgTier":"ministry"}
{"path":"moj","name":"Ministarstvo pravde","nameEn":"Ministry of Justice","website":"https://www.mpr.gov.ba/","contract":"Ustav BiH Art. V","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moci","name":"Ministarstvo civilnih poslova","nameEn":"Ministry of Civil Affairs","website":"https://www.mcp.gov.ba/","contract":"Ustav BiH Art. V","tags":["cofog:01","civil-affairs"],"orgTier":"ministry"}
{"path":"mocr","name":"Ministarstvo komunikacija i prometa","nameEn":"Ministry of Communications and Transport","website":"https://www.mkt.gov.ba/","contract":"Ustav BiH Art. III","tags":["cofog:04.5","transport","communications"],"orgTier":"ministry"}
{"path":"mohr","name":"Ministarstvo za ljudska prava i izbjeglice","nameEn":"Ministry of Human Rights and Refugees","website":"https://www.mhrr.gov.ba/","contract":"Ustav BiH Annex 7","tags":["cofog:01","human-rights","refugees"],"orgTier":"ministry"}
{"path":"mote","name":"Ministarstvo vanjske trgovine i ekonomskih odnosa","nameEn":"Ministry of Foreign Trade and Economic Relations","website":"https://www.mvteo.gov.ba/","contract":"Ustav BiH Art. III","tags":["cofog:04","trade","economy"],"orgTier":"ministry"}
{"path":"predsjednistvo","name":"Predsjedništvo Bosne i Hercegovine","nameEn":"Presidency of Bosnia and Herzegovina","website":"https://predsjednistvo.ba/","contract":"Ustav BiH Art. V","tags":["cofog:01","presidency"],"orgTier":"agency"}
{"path":"parlamentarna-skupstina","name":"Parlamentarna skupština BiH","nameEn":"Parliamentary Assembly of BiH","website":"https://www.parlament.ba/","contract":"Ustav BiH Art. IV","tags":["cofog:01","legislature"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"rs","name":"Republika Srpska","nameEn":"Republika Srpska","website":"https://www.vladars.net/","contract":"Ustav RS + Dayton Annex 4","tags":["cofog:01","entity","republika-srpska"],"orgTier":"state"}
{"path":"fbih","name":"Federacija Bosne i Hercegovine","nameEn":"Federation of Bosnia and Herzegovina","website":"https://www.fbihvlada.gov.ba/","contract":"Ustav FBiH + Dayton Annex 4","tags":["cofog:01","entity","federation"],"orgTier":"state"}
{"path":"brcko","name":"Brčko Distrikt BiH","nameEn":"Brčko District of BiH","website":"https://www.bdcentral.net/","contract":"Statut Brčko Distrikta 1999","tags":["cofog:01","district","brcko","self-governing"],"orgTier":"state"}
"""
...
def task_gov_bih_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_bih_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_bih_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_bih_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_bih_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_bih_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_bih_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_bih_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_bih_seed_orgs, seedLimit)
    register = await task_gov_bih_register_dids(registerLimit)
    follow = await task_gov_bih_follow_site_deps(followLimit)
    ingest = await task_gov_bih_sync_wet_updates(ingestLimit)
    shinka = await task_gov_bih_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBih.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bih_heartbeat_tick)
