"""KHM Government states actor primitives.

This module moves the `did:web:khm-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:khm-state.etzhayyim.com"
DOMAIN_CODE = "khm"
...
_MINISTRY_NDJSON = """\
{"path":"council-of-ministers","name":"គណៈរដ្ឋមន្ត្រី","nameEn":"Council of Ministers","website":"https://www.pressocm.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 118","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mfa","name":"ក្រសួងការបរទេស និងសហប្រតិបត្តិការអន្តរជាតិ","nameEn":"Ministry of Foreign Affairs and International Cooperation","website":"https://www.mfaic.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mnd","name":"ក្រសួងការពារជាតិ","nameEn":"Ministry of National Defence","website":"https://www.mnd.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mef","name":"ក្រសួងសេដ្ឋកិច្ច និងហិរញ្ញវត្ថុ","nameEn":"Ministry of Economy and Finance","website":"https://www.mef.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:01.1","finance","economy"],"orgTier":"ministry"}
{"path":"moj","name":"ក្រសួងយុត្តិធម៌","nameEn":"Ministry of Justice","website":"https://www.moj.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moi","name":"ក្រសួងមហាផ្ទៃ","nameEn":"Ministry of Interior","website":"https://www.interior.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"ក្រសួងអប់រំ យុវវ័យ និងកីឡា","nameEn":"Ministry of Education, Youth and Sport","website":"https://www.moeys.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:09","education","youth","sport"],"orgTier":"ministry"}
{"path":"moh","name":"ក្រសួងសុខាភិបាល","nameEn":"Ministry of Health","website":"https://www.moh.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mlvt","name":"ក្រសួងការងារ និងការបណ្ដុះបណ្ដាលវិជ្ជាជីវៈ","nameEn":"Ministry of Labour and Vocational Training","website":"https://www.mlvt.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:04","labour","vocational"],"orgTier":"ministry"}
{"path":"moc","name":"ក្រសួងពាណិជ្ជកម្ម","nameEn":"Ministry of Commerce","website":"https://www.moc.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:04","trade","commerce"],"orgTier":"ministry"}
{"path":"maff","name":"ក្រសួងកសិកម្ម រុក្ខប្រមាញ់ និងនេសាទ","nameEn":"Ministry of Agriculture, Forestry and Fisheries","website":"https://www.maff.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:04.2","agriculture","forestry","fisheries"],"orgTier":"ministry"}
{"path":"moe-env","name":"ក្រសួងបរិស្ថាន","nameEn":"Ministry of Environment","website":"https://www.moe.gov.kh/","contract":"Constitution of Cambodia 1993","tags":["cofog:05","environment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"prov:phnom-penh","name":"ភ្នំពេញ","nameEn":"Phnom Penh","website":"https://phnompenh.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province","capital"],"orgTier":"state"}
{"path":"prov:siem-reap","name":"សៀមរាប","nameEn":"Siem Reap","website":"https://siemreap.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:battambang","name":"បាត់ដំបង","nameEn":"Battambang","website":"https://battambang.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:kampong-cham","name":"កំពង់ចាម","nameEn":"Kampong Cham","website":"https://kampongcham.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:kandal","name":"កណ្ដាល","nameEn":"Kandal","website":"https://kandal.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:takeo","name":"តាកែវ","nameEn":"Takeo","website":"https://takeo.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:kampot","name":"កំពត","nameEn":"Kampot","website":"https://kampot.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:prey-veng","name":"ព្រៃវែង","nameEn":"Prey Veng","website":"https://preyveng.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:svay-rieng","name":"ស្វាយរៀង","nameEn":"Svay Rieng","website":"https://svayrieng.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
{"path":"prov:kampong-speu","name":"កំពង់ស្ពឺ","nameEn":"Kampong Speu","website":"https://kampongspeu.gov.kh/","contract":"Constitution of Cambodia 1993 Art. 145","tags":["cofog:01","province"],"orgTier":"state"}
"""
...
def task_gov_khm_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_khm_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_khm_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_khm_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_khm_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_khm_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    for r in page_rows:
        ...
        # R0: in-Python sort wet chunks by crawled_at DESC, limit 1
        wet = None
        if wet_rows:
...
async def task_gov_khm_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_khm_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_khm_seed_orgs, seedLimit)
    register = await task_gov_khm_register_dids(registerLimit)
    follow = await task_gov_khm_follow_site_deps(followLimit)
    ingest = await task_gov_khm_sync_wet_updates(ingestLimit)
    shinka = await task_gov_khm_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govKhm.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_khm_heartbeat_tick)
