...
TRANSLATION_LINK_COLLECTION = "ai.gftd.apps.media_gamers.record.translationLink"
    ...
    *,
    ...
    return build_social_post_record(
        ...
        record_extra={
            ...
            "facets": facets,
            "tags": tags,
            "source": {"$type": "ai.gftd.apps.fukkou.dietSpeechRef", **source},
        },
    )
...
async def task_yoro_social_translate_post(
    ...
    translated_row = build_social_post_record(
        ...
        record_extra={
            ...
            "sourceLang": detected_source_lang,
            "source": {
                "$type": "ai.gftd.apps.yoro.translationSource",
                "sourceUri": postUri,
                "sourceLang": detected_source_lang,
