"""ETH Government states actor primitives.

This module moves the `did:web:eth-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:eth-state.etzhayyim.com"
DOMAIN_CODE = "eth"
...
_MINISTRY_NDJSON = """\
{"path":"pmo","name":"ጠቅላይ ሚኒስቴር ጽሕፈት ቤት","nameEn":"Office of the Prime Minister","website":"https://www.pmo.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 74","tags":["cofog:01","executive","prime-minister"],"orgTier":"ministry"}
{"path":"mfa","name":"የውጭ ጉዳይ ሚኒስቴር","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"የመከላከያ ሚኒስቴር","nameEn":"Ministry of National Defence","website":"https://www.mod.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 87","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"የፋይናንስ ሚኒስቴር","nameEn":"Ministry of Finance","website":"https://www.mof.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"የፍትህ ሚኒስቴር","nameEn":"Ministry of Justice","website":"https://www.moj.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moi","name":"የሰላምና ደህንነት ሚኒስቴር","nameEn":"Ministry of Peace (Interior)","website":"https://www.moi.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:03","interior","security"],"orgTier":"ministry"}
{"path":"moe","name":"የትምህርት ሚኒስቴር","nameEn":"Ministry of Education","website":"https://www.moe.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"የጤና ሚኒስቴር","nameEn":"Ministry of Health","website":"https://www.moh.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mol","name":"የሰራተኛ ሚኒስቴር","nameEn":"Ministry of Labour and Social Affairs","website":"https://www.molsa.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:04","labour","social"],"orgTier":"ministry"}
{"path":"moti","name":"የንግድና ኢንዱስትሪ ሚኒስቴር","nameEn":"Ministry of Trade and Industry","website":"https://www.moti.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:04","trade","industry"],"orgTier":"ministry"}
{"path":"moa","name":"የግብርና ሚኒስቴር","nameEn":"Ministry of Agriculture","website":"https://www.moa.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:04.2","agriculture"],"orgTier":"ministry"}
{"path":"menv","name":"የአካባቢ ጥበቃ ሚኒስቴር","nameEn":"Ministry of Environment, Forest and Climate Change","website":"https://www.mefcc.gov.et/","contract":"Constitution of Ethiopia 1995","tags":["cofog:05","environment","climate"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:oromia","name":"ኦሮሚያ ክልል","nameEn":"Oromia Regional State","website":"https://www.oromia.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state","largest"],"orgTier":"state"}
{"path":"region:amhara","name":"አማራ ክልል","nameEn":"Amhara Regional State","website":"https://www.amhara.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:tigray","name":"ትግራይ ክልል","nameEn":"Tigray Regional State","website":"https://www.tigrai.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:somali","name":"ሶማሌ ክልል","nameEn":"Somali Regional State","website":"https://www.somali.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:snnpr","name":"ደቡብ ብሔሮች፣ ብሔረሰቦችና ሕዝቦች ክልል","nameEn":"Southern Nations, Nationalities and Peoples Regional State","website":"https://www.snnpr.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:afar","name":"አፋር ክልል","nameEn":"Afar Regional State","website":"https://www.afar.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:benishangul","name":"ቤኒሻንጉል-ጉምዝ ክልል","nameEn":"Benishangul-Gumuz Regional State","website":"https://www.benishangulgumuz.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:gambella","name":"ጋምቤላ ክልል","nameEn":"Gambella Regional State","website":"https://www.gambella.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state"],"orgTier":"state"}
{"path":"region:harari","name":"ሐረሪ ክልል","nameEn":"Harari Regional State","website":"https://www.harari.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 47","tags":["cofog:01","regional-state","city-state"],"orgTier":"state"}
{"path":"region:addis-ababa","name":"አዲስ አበባ ከተማ አስተዳደር","nameEn":"Addis Ababa City Administration","website":"https://www.addisababa.gov.et/","contract":"Constitution of Ethiopia 1995 Art. 49","tags":["cofog:01","chartered-city","capital"],"orgTier":"state"}
"""
...
def task_gov_eth_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_eth_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_eth_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_eth_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_eth_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_eth_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_eth_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_eth_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_eth_seed_orgs, seedLimit)
    register = await task_gov_eth_register_dids(registerLimit)
    follow = await task_gov_eth_follow_site_deps(followLimit)
    ingest = await task_gov_eth_sync_wet_updates(ingestLimit)
    shinka = await task_gov_eth_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEth.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_heartbeat_tick)
