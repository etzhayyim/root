...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govEth.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_eth_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govEth.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
