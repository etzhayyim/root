"""EGY Government states actor primitives.

This module moves the `did:web:egy-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:egy-state.etzhayyim.com"
DOMAIN_CODE = "egy"
...
_MINISTRY_NDJSON = """\
{"path":"pm-office","name":"مجلس الوزراء","nameEn":"Cabinet of Egypt / Council of Ministers","website":"https://www.cabinet.gov.eg/","contract":"الدستور المصري Art. 163","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"mofa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.eg/","contract":"الدستور المصري","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"وزارة الدفاع والإنتاج الحربي","nameEn":"Ministry of Defence and Military Production","website":"https://www.mod.gov.eg/","contract":"الدستور المصري Art. 200","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mof.gov.eg/","contract":"الدستور المصري","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.eg/","contract":"الدستور المصري","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moiegypt.gov.eg/","contract":"الدستور المصري","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"وزارة التربية والتعليم","nameEn":"Ministry of Education","website":"https://moe.gov.eg/","contract":"الدستور المصري","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"وزارة الصحة والسكان","nameEn":"Ministry of Health and Population","website":"https://www.mohp.gov.eg/","contract":"الدستور المصري","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mol","name":"وزارة القوى العاملة","nameEn":"Ministry of Manpower","website":"https://www.manpower.gov.eg/","contract":"الدستور المصري","tags":["cofog:04","labour"],"orgTier":"ministry"}
{"path":"moic","name":"وزارة الاستثمار والتعاون الدولي","nameEn":"Ministry of Investment and International Cooperation","website":"https://www.miic.gov.eg/","contract":"الدستور المصري","tags":["cofog:04","investment"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"gov:cairo","name":"محافظة القاهرة","nameEn":"Cairo Governorate","website":"https://www.cairo.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate","capital"],"orgTier":"state"}
{"path":"gov:giza","name":"محافظة الجيزة","nameEn":"Giza Governorate","website":"https://www.giza.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate"],"orgTier":"state"}
{"path":"gov:alexandria","name":"محافظة الإسكندرية","nameEn":"Alexandria Governorate","website":"https://www.alexgov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate","port"],"orgTier":"state"}
{"path":"gov:aswan","name":"محافظة أسوان","nameEn":"Aswan Governorate","website":"https://www.aswan.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate"],"orgTier":"state"}
{"path":"gov:luxor","name":"محافظة الأقصر","nameEn":"Luxor Governorate","website":"https://www.luxor.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate"],"orgTier":"state"}
{"path":"gov:red-sea","name":"محافظة البحر الأحمر","nameEn":"Red Sea Governorate","website":"https://www.redsea.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate"],"orgTier":"state"}
{"path":"gov:south-sinai","name":"محافظة جنوب سيناء","nameEn":"South Sinai Governorate","website":"https://www.southsinai.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate"],"orgTier":"state"}
{"path":"gov:matrouh","name":"محافظة مطروح","nameEn":"Matrouh Governorate","website":"https://www.matrouh.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate"],"orgTier":"state"}
{"path":"gov:port-said","name":"محافظة بورسعيد","nameEn":"Port Said Governorate","website":"https://www.portsaid.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate","canal"],"orgTier":"state"}
{"path":"gov:suez","name":"محافظة السويس","nameEn":"Suez Governorate","website":"https://www.suez.gov.eg/","contract":"الدستور المصري Art. 179","tags":["cofog:01","governorate","canal"],"orgTier":"state"}
"""
...
def task_gov_egy_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_egy_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_egy_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_egy_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_egy_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_egy_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_egy_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_egy_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_egy_seed_orgs, seedLimit)
    register = await task_gov_egy_register_dids(registerLimit)
    follow = await task_gov_egy_follow_site_deps(followLimit)
    ingest = await task_gov_egy_sync_wet_updates(ingestLimit)
    shinka = await task_gov_egy_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govEgy.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_heartbeat_tick)
