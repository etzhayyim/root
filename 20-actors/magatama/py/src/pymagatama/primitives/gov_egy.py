...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_egy_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govEgy.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
