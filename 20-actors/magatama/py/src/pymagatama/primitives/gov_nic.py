"""NIC Government states actor primitives.

This module moves the `did:web:nic-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:nic-state.etzhayyim.com"
DOMAIN_CODE = "nic"
...
_MINISTRY_NDJSON = """\
{"path": "presidencia", "name": "Presidencia de la República", "nameEn": "Presidency of the Republic", "website": "https://www.presidencia.gob.ni/", "contract": "Constitución 1987 Art. 144-156", "tags": ["cofog:01", "executive"], "orgTier": "ministry"}
{"path": "defensa", "name": "Ejército de Nicaragua", "nameEn": "Army of Nicaragua", "website": "https://www.ejercito.mil.ni/", "contract": "Constitución 1987", "tags": ["cofog:02", "defense"], "orgTier": "ministry"}
{"path": "hacienda", "name": "Ministerio de Hacienda y Crédito Público", "nameEn": "Ministry of Finance and Public Credit", "website": "https://www.hacienda.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:01", "finance"], "orgTier": "ministry"}
{"path": "rree", "name": "Ministerio de Relaciones Exteriores", "nameEn": "Ministry of Foreign Affairs", "website": "https://www.cancilleria.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:01.2", "foreign-affairs"], "orgTier": "ministry"}
{"path": "gobernacion", "name": "Ministerio de Gobernación", "nameEn": "Ministry of Government", "website": "https://www.migob.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:01", "interior"], "orgTier": "ministry"}
{"path": "educacion", "name": "Ministerio de Educación", "nameEn": "Ministry of Education", "website": "https://www.mined.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
{"path": "salud", "name": "Ministerio de Salud", "nameEn": "Ministry of Health", "website": "https://www.minsa.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:07", "health"], "orgTier": "ministry"}
{"path": "agricultura", "name": "Ministerio Agropecuario", "nameEn": "Ministry of Agriculture", "website": "https://www.mag.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:04", "agriculture"], "orgTier": "ministry"}
{"path": "trabajo", "name": "Ministerio del Trabajo", "nameEn": "Ministry of Labour", "website": "https://www.mitrab.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:10", "labour"], "orgTier": "ministry"}
{"path": "fomento", "name": "Ministerio de Fomento, Industria y Comercio", "nameEn": "Ministry of Development, Industry and Commerce", "website": "https://www.mific.gob.ni/", "contract": "Constitución 1987", "tags": ["cofog:09", "education"], "orgTier": "ministry"}
"""

_STATE_NDJSON = """\
{"path": "dept:boaco", "name": "Departamento de Boaco", "nameEn": "Department of Boaco", "website": "https://www.boaco.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:carazo", "name": "Departamento de Carazo", "nameEn": "Department of Carazo", "website": "https://www.carazo.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:chinandega", "name": "Departamento de Chinandega", "nameEn": "Department of Chinandega", "website": "https://www.chinandega.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:chontales", "name": "Departamento de Chontales", "nameEn": "Department of Chontales", "website": "https://www.chontales.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:esteli", "name": "Departamento de Estelí", "nameEn": "Department of Estelí", "website": "https://www.esteli.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:granada", "name": "Departamento de Granada", "nameEn": "Department of Granada", "website": "https://www.granada.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:jinotega", "name": "Departamento de Jinotega", "nameEn": "Department of Jinotega", "website": "https://www.jinotega.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:leon", "name": "Departamento de León", "nameEn": "Department of León", "website": "https://www.leon.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:madriz", "name": "Departamento de Madriz", "nameEn": "Department of Madriz", "website": "https://www.madriz.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:managua", "name": "Departamento de Managua", "nameEn": "Department of Managua", "website": "https://www.managua.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:masaya", "name": "Departamento de Masaya", "nameEn": "Department of Masaya", "website": "https://www.masaya.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:matagalpa", "name": "Departamento de Matagalpa", "nameEn": "Department of Matagalpa", "website": "https://www.matagalpa.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:nueva-segovia", "name": "Departamento de Nueva Segovia", "nameEn": "Department of Nueva Segovia", "website": "https://www.nuevasegovia.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:rio-san-juan", "name": "Departamento de Río San Juan", "nameEn": "Department of Río San Juan", "website": "https://www.riosanjuan.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "dept:rivas", "name": "Departamento de Rivas", "nameEn": "Department of Rivas", "website": "https://www.rivas.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:raccn", "name": "Región Autónoma de la Costa Caribe Norte", "nameEn": "North Caribbean Coast Autonomous Region", "website": "https://www.raccn.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
{"path": "region:raccs", "name": "Región Autónoma de la Costa Caribe Sur", "nameEn": "South Caribbean Coast Autonomous Region", "website": "https://www.raccs.gob.ni/", "contract": "Constitución 1987 Art. 175-181 + Ley 28", "tags": ["cofog:01", "department"], "orgTier": "state"}
"""
...
def task_gov_nic_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_nic_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_nic_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_nic_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_nic_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_nic_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_nic_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_nic_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_nic_seed_orgs, seedLimit)
    register = await task_gov_nic_register_dids(registerLimit)
    follow = await task_gov_nic_follow_site_deps(followLimit)
    ingest = await task_gov_nic_sync_wet_updates(ingestLimit)
    shinka = await task_gov_nic_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govNic.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_nic_heartbeat_tick)
