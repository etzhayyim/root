"""BEL Government states actor primitives.

This module moves the `did:web:bel-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:bel-state.etzhayyim.com"
DOMAIN_CODE = "bel"
...
_MINISTRY_NDJSON = """\
{"path":"premier-ministre","name":"Premier Ministre / Eerste Minister","nameEn":"Prime Minister's Office","website":"https://www.premier.be/","contract":"Constitution belge Art. 99","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"spf-affaires-etrangeres","name":"SPF Affaires étrangères, Commerce extérieur et Coopération au Développement","nameEn":"FPS Foreign Affairs, Foreign Trade and Development Cooperation","website":"https://diplomatie.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:01.2","foreign-affairs","diplomacy"],"orgTier":"ministry"}
{"path":"spf-interieur","name":"SPF Intérieur / FOD Binnenlandse Zaken","nameEn":"FPS Interior","website":"https://www.interieur.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"spf-defense","name":"Ministère de la Défense / Ministerie van Defensie","nameEn":"Ministry of Defence","website":"https://www.mil.be/","contract":"Constitution belge Art. 107","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"spf-finances","name":"SPF Finances / FOD Financiën","nameEn":"FPS Finance","website":"https://finances.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:01.1","finance","taxation"],"orgTier":"ministry"}
{"path":"spf-justice","name":"SPF Justice / FOD Justitie","nameEn":"FPS Justice","website":"https://justice.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"spf-economie","name":"SPF Économie, PME, Classes moyennes et Énergie","nameEn":"FPS Economy, SMEs, Self-employed and Energy","website":"https://economie.fgov.be/","contract":"Constitution belge Art. 107","tags":["cofog:04","economy","energy","sme"],"orgTier":"ministry"}
{"path":"spf-emploi","name":"SPF Emploi, Travail et Concertation sociale","nameEn":"FPS Employment, Labour and Social Dialogue","website":"https://emploi.belgique.be/","contract":"Constitution belge Art. 107","tags":["cofog:04","labour","employment"],"orgTier":"ministry"}
{"path":"spf-sante-publique","name":"SPF Santé publique, Sécurité de la Chaîne alimentaire et Environnement","nameEn":"FPS Public Health, Food Chain Safety and Environment","website":"https://www.health.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:07","health","environment"],"orgTier":"ministry"}
{"path":"spf-securite-sociale","name":"SPF Sécurité sociale / FOD Sociale Zekerheid","nameEn":"FPS Social Security","website":"https://socialsecurity.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:07","social-security"],"orgTier":"ministry"}
{"path":"spf-mobilite","name":"SPF Mobilité et Transports / FOD Mobiliteit en Openbare Werken","nameEn":"FPS Mobility and Public Works","website":"https://mobilit.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:04.5","transport","mobility"],"orgTier":"ministry"}
{"path":"fedict","name":"SPF Stratégie et Appui / FOD BOSA","nameEn":"FPS Strategy and Support","website":"https://bosa.belgium.be/","contract":"Constitution belge Art. 107","tags":["cofog:01","ict","digital","public-service"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"region:flanders","name":"Vlaams Gewest","nameEn":"Flemish Region","website":"https://www.vlaanderen.be/","contract":"Constitution belge Art. 3","tags":["cofog:01","region","l5"],"orgTier":"state"}
{"path":"region:wallonia","name":"Région wallonne","nameEn":"Walloon Region","website":"https://www.wallonie.be/","contract":"Constitution belge Art. 3","tags":["cofog:01","region","l5"],"orgTier":"state"}
{"path":"region:brussels","name":"Région de Bruxelles-Capitale / Brussels Hoofdstedelijk Gewest","nameEn":"Brussels-Capital Region","website":"https://be.brussels/","contract":"Constitution belge Art. 3","tags":["cofog:01","region","capital"],"orgTier":"state"}
{"path":"community:flemish","name":"Vlaamse Gemeenschap","nameEn":"Flemish Community","website":"https://www.vlaanderen.be/","contract":"Constitution belge Art. 2","tags":["cofog:01","community","l5"],"orgTier":"state"}
{"path":"community:french","name":"Communauté française (Fédération Wallonie-Bruxelles)","nameEn":"French Community (Federation Wallonia-Brussels)","website":"https://www.federation-wallonie-bruxelles.be/","contract":"Constitution belge Art. 2","tags":["cofog:01","community","l5"],"orgTier":"state"}
{"path":"community:german","name":"Deutschsprachige Gemeinschaft","nameEn":"German-speaking Community","website":"https://www.dglive.be/","contract":"Constitution belge Art. 2","tags":["cofog:01","community","l5"],"orgTier":"state"}
"""
...
def task_gov_bel_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_bel_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_bel_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_bel_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_bel_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_bel_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_bel_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_bel_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_bel_seed_orgs, seedLimit)
    register = await task_gov_bel_register_dids(registerLimit)
    follow = await task_gov_bel_follow_site_deps(followLimit)
    ingest = await task_gov_bel_sync_wet_updates(ingestLimit)
    shinka = await task_gov_bel_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govBel.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_bel_heartbeat_tick)
