...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_cod_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govCod.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
