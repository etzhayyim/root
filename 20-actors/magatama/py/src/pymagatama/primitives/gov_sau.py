"""SAU Government states actor primitives.

This module moves the `did:web:sau-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:sau-state.etzhayyim.com"
DOMAIN_CODE = "sau"
...
_MINISTRY_NDJSON = """\
{"path":"diwan","name":"الديوان الملكي","nameEn":"Royal Court (Diwan)","website":"https://www.diwan.gov.sa/","contract":"النظام الأساسي للحكم المادة 55","tags":["cofog:01","executive","royal-court"],"orgTier":"ministry"}
{"path":"council-of-ministers","name":"مجلس الوزراء","nameEn":"Council of Ministers","website":"https://www.pmo.gov.sa/","contract":"النظام الأساسي للحكم المادة 56","tags":["cofog:01","executive","cabinet"],"orgTier":"ministry"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:03","interior","police","security"],"orgTier":"ministry"}
{"path":"mofa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mofa.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defense","website":"https://www.mod.gov.sa/","contract":"النظام الأساسي للحكم المادة 60","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mof.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.sa/","contract":"النظام الأساسي للحكم المادة 46","tags":["cofog:03","justice","sharia"],"orgTier":"ministry"}
{"path":"moh","name":"وزارة الصحة","nameEn":"Ministry of Health","website":"https://www.moh.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"moe","name":"وزارة التعليم","nameEn":"Ministry of Education","website":"https://www.moe.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moenergy","name":"وزارة الطاقة","nameEn":"Ministry of Energy","website":"https://www.energy.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04","energy","oil","gas"],"orgTier":"ministry"}
{"path":"mit","name":"وزارة الاستثمار","nameEn":"Ministry of Investment","website":"https://www.misa.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04","investment","fdi"],"orgTier":"ministry"}
{"path":"mcom","name":"وزارة التجارة","nameEn":"Ministry of Commerce","website":"https://www.mc.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04","commerce","trade"],"orgTier":"ministry"}
{"path":"mcit","name":"وزارة الاتصالات وتقنية المعلومات","nameEn":"Ministry of Communications and IT","website":"https://www.mcit.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04","communications","ict","digital"],"orgTier":"ministry"}
{"path":"momra","name":"وزارة الشؤون البلدية والقروية والإسكان","nameEn":"Ministry of Municipal and Rural Affairs and Housing","website":"https://www.momra.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:06","housing","urban","municipal"],"orgTier":"ministry"}
{"path":"mot","name":"وزارة النقل والخدمات اللوجستية","nameEn":"Ministry of Transport and Logistic Services","website":"https://www.mot.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04.5","transport","logistics"],"orgTier":"ministry"}
{"path":"mewa","name":"وزارة البيئة والمياه والزراعة","nameEn":"Ministry of Environment, Water and Agriculture","website":"https://www.mewa.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04.2","environment","water","agriculture"],"orgTier":"ministry"}
{"path":"hrsd","name":"وزارة الموارد البشرية والتنمية الاجتماعية","nameEn":"Ministry of Human Resources and Social Development","website":"https://www.hrsd.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:10","labour","social"],"orgTier":"ministry"}
{"path":"moc","name":"وزارة الثقافة","nameEn":"Ministry of Culture","website":"https://www.moc.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:08","culture"],"orgTier":"ministry"}
{"path":"mts","name":"وزارة السياحة","nameEn":"Ministry of Tourism","website":"https://www.mts.gov.sa/","contract":"النظام الأساسي للحكم","tags":["cofog:04","tourism"],"orgTier":"ministry"}
{"path":"shura","name":"مجلس الشورى","nameEn":"Shura Council","website":"https://www.shura.gov.sa/","contract":"نظام مجلس الشورى","tags":["cofog:01","legislature","consultative"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"mintaqah:riyadh","name":"منطقة الرياض","nameEn":"Riyadh Region","website":"https://www.riyadh.gov.sa/","contract":"نظام المناطق 1992 المادة 4","tags":["cofog:01","mintaqah","capital-region"],"orgTier":"state"}
{"path":"mintaqah:makkah","name":"منطقة مكة المكرمة","nameEn":"Makkah Al-Mukarramah Region","website":"https://www.makkah.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah","holy-city"],"orgTier":"state"}
{"path":"mintaqah:madinah","name":"منطقة المدينة المنورة","nameEn":"Al-Madinah Al-Munawwarah Region","website":"https://www.madinah.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah","holy-city"],"orgTier":"state"}
{"path":"mintaqah:qassim","name":"منطقة القصيم","nameEn":"Al-Qassim Region","website":"https://www.qassim.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:eastern","name":"المنطقة الشرقية","nameEn":"Eastern Province","website":"https://www.eastern.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah","oil-region"],"orgTier":"state"}
{"path":"mintaqah:asir","name":"منطقة عسير","nameEn":"Asir Region","website":"https://www.aseer.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:tabuk","name":"منطقة تبوك","nameEn":"Tabuk Region","website":"https://www.tabuk.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:hail","name":"منطقة حائل","nameEn":"Ha'il Region","website":"https://www.hail.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:northern-borders","name":"منطقة الحدود الشمالية","nameEn":"Northern Borders Region","website":"https://www.northernborders.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:jizan","name":"منطقة جازان","nameEn":"Jizan Region","website":"https://www.jazan.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:najran","name":"منطقة نجران","nameEn":"Najran Region","website":"https://www.najran.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:baha","name":"منطقة الباحة","nameEn":"Al-Bahah Region","website":"https://www.baha.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
{"path":"mintaqah:jouf","name":"منطقة الجوف","nameEn":"Al-Jawf Region","website":"https://www.jouf.gov.sa/","contract":"نظام المناطق 1992","tags":["cofog:01","mintaqah"],"orgTier":"state"}
"""
...
def _update_gov_org_fields(path: str, fields: dict[str, str]) -> None:
    ...
    if not path or not updates:
        return
    # R0: Fetch by vertex_id to apply partial update
    row = get_kotoba_client().select_first_where("vertex_gov_org", "vertex_id", _vertex_id(path))
    if not row or str(row.get("domain_code")) != DOMAIN_CODE or str(row.get("owner_did")) != PRIMARY_DID:
        return
...
def _get_org(path: str) -> dict[str, Any] | None:
    # R0: Fetch by vertex_id, then check domain_code and owner_did
    row = get_kotoba_client().select_first_where("vertex_gov_org", "vertex_id", _vertex_id(path))
    if not row or str(row.get("domain_code")) != DOMAIN_CODE or str(row.get("owner_did")) != PRIMARY_DID:
        return None
    keys = [
...
def task_gov_sau_seed_orgs(limit: int = 30) -> dict[str, Any]:
    limit = max(1, min(int(limit or 30), 100))
    # R0: Fetch broader set by domain_code, filter in Python
    rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=10000)
    existing = {
        str(r["path"]) for r in rows
        if str(r.get("owner_did")) == PRIMARY_DID and str(r.get("name_en") or "") != ""
    }
...
def task_gov_sau_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_sau_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit = max(1, min(int(limit or 50), 100))
    # R0: Fetch broader set by domain_code, filter, sort, and paginate in Python
    ...
    filtered = [
        ...
        and str(r.get("name_en") or "") != ""
        and (not org_tier or str(r.get("org_tier") or "") == org_tier)
    ]
    total = len(filtered)
...
async def task_gov_sau_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    # R0: Fetch broader set by domain_code, filter, sort, and cap in Python
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, limit=2000)
    filtered = [
        r for r in all_rows
        if str(r.get("owner_did")) == PRIMARY_DID
...
async def task_gov_sau_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_sau_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    ...
    filtered = [
        ...
        and (
            ...
            or str(r.get("last_ingested_at")) == ""
            or str(r.get("last_ingested_at")) < cutoff_iso
        )
    ]
    ...
    for r in rows:
        ...
        if not path or not slug:
            continue
        checked += 1
        # R0: Fetch broader set by domain, sort in Python
...
async def task_gov_sau_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_sau_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_sau_seed_orgs, seedLimit)
    register = await task_gov_sau_register_dids(registerLimit)
    follow = await task_gov_sau_follow_site_deps(followLimit)
    ingest = await task_gov_sau_sync_wet_updates(ingestLimit)
    shinka = await task_gov_sau_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSau.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sau_heartbeat_tick)
