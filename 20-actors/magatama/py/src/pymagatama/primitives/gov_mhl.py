...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_seed_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_register_dids)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_follow_site_deps)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_resolve_org_path)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_list_orgs)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_sync_wet_updates)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_shinka)
    worker.task(
        task_type="xrpc.ai.gftd.govMhl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
