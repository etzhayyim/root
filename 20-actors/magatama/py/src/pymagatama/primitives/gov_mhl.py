...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_mhl_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govMhl.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
