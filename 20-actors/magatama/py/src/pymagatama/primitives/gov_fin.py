"""FIN Government states actor primitives.

This module moves the `did:web:fin-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:fin-state.etzhayyim.com"
DOMAIN_CODE = "fin"
...
_MINISTRY_NDJSON = """\
{"path":"valtioneuvoston-kanslia","name":"Valtioneuvoston kanslia","nameEn":"Prime Minister's Office","website":"https://vnk.fi/","contract":"Perustuslaki §65","tags":["cofog:01","executive"],"orgTier":"ministry"}
{"path":"ulkoministerio","name":"Ulkoministeriö","nameEn":"Ministry for Foreign Affairs","website":"https://um.fi/","contract":"Perustuslaki §65","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"puolustusministerio","name":"Puolustusministeriö","nameEn":"Ministry of Defence","website":"https://defmin.fi/","contract":"Perustuslaki §65","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"valtiovarainministerio","name":"Valtiovarainministeriö","nameEn":"Ministry of Finance","website":"https://vm.fi/","contract":"Perustuslaki §65","tags":["cofog:01.1","finance"],"orgTier":"ministry"}
{"path":"oikeusministerio","name":"Oikeusministeriö","nameEn":"Ministry of Justice","website":"https://oikeusministerio.fi/","contract":"Perustuslaki §65","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"sisaministerio","name":"Sisäministeriö","nameEn":"Ministry of the Interior","website":"https://intermin.fi/","contract":"Perustuslaki §65","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"opetus-kulttuuriministerio","name":"Opetus- ja kulttuuriministeriö","nameEn":"Ministry of Education and Culture","website":"https://minedu.fi/","contract":"Perustuslaki §65","tags":["cofog:09","education","culture"],"orgTier":"ministry"}
{"path":"sosiaali-terveysministerio","name":"Sosiaali- ja terveysministeriö","nameEn":"Ministry of Social Affairs and Health","website":"https://stm.fi/","contract":"Perustuslaki §65","tags":["cofog:07","health","social"],"orgTier":"ministry"}
{"path":"tyo-elinkeinoministerio","name":"Työ- ja elinkeinoministeriö","nameEn":"Ministry of Economic Affairs and Employment","website":"https://tem.fi/","contract":"Perustuslaki §65","tags":["cofog:04","economy","employment"],"orgTier":"ministry"}
{"path":"ymparistoministerio","name":"Ympäristöministeriö","nameEn":"Ministry of the Environment","website":"https://ym.fi/","contract":"Perustuslaki §65","tags":["cofog:05","environment"],"orgTier":"ministry"}
{"path":"maa-metsatalousministerio","name":"Maa- ja metsätalousministeriö","nameEn":"Ministry of Agriculture and Forestry","website":"https://mmm.fi/","contract":"Perustuslaki §65","tags":["cofog:04.2","agriculture","forestry"],"orgTier":"ministry"}
{"path":"liikenne-viestintaministerio","name":"Liikenne- ja viestintäministeriö","nameEn":"Ministry of Transport and Communications","website":"https://lvm.fi/","contract":"Perustuslaki §65","tags":["cofog:04","transport","communications"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"maakunta:uusimaa","name":"Uusimaa","nameEn":"Uusimaa","website":"https://www.uusimaa.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5","capital"],"orgTier":"state"}
{"path":"maakunta:varsinais-suomi","name":"Varsinais-Suomi","nameEn":"Southwest Finland","website":"https://www.varsinais-suomi.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:satakunta","name":"Satakunta","nameEn":"Satakunta","website":"https://www.satakunta.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:kanta-hame","name":"Kanta-Häme","nameEn":"Tavastia Proper","website":"https://www.hame.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:pirkanmaa","name":"Pirkanmaa","nameEn":"Pirkanmaa","website":"https://www.pirkanmaa.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:paijat-hame","name":"Päijät-Häme","nameEn":"Päijänne Tavastia","website":"https://www.paijat-hame.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:kymenlaakso","name":"Kymenlaakso","nameEn":"Kymenlaakso","website":"https://www.kymenlaakso.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:etela-karjala","name":"Etelä-Karjala","nameEn":"South Karelia","website":"https://www.etelä-karjala.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:etela-savo","name":"Etelä-Savo","nameEn":"South Savo","website":"https://www.esavo.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:pohjois-savo","name":"Pohjois-Savo","nameEn":"North Savo","website":"https://www.pohjois-savo.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:pohjois-karjala","name":"Pohjois-Karjala","nameEn":"North Karelia","website":"https://www.pohjois-karjala.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:keski-suomi","name":"Keski-Suomi","nameEn":"Central Finland","website":"https://www.keskisuomi.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:etela-pohjanmaa","name":"Etelä-Pohjanmaa","nameEn":"South Ostrobothnia","website":"https://www.etela-pohjanmaa.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:pohjanmaa","name":"Pohjanmaa","nameEn":"Ostrobothnia","website":"https://www.osterbotten.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:keski-pohjanmaa","name":"Keski-Pohjanmaa","nameEn":"Central Ostrobothnia","website":"https://www.keski-pohjanmaa.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:pohjois-pohjanmaa","name":"Pohjois-Pohjanmaa","nameEn":"North Ostrobothnia","website":"https://www.pohjois-pohjanmaa.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:kainuu","name":"Kainuu","nameEn":"Kainuu","website":"https://www.kainuu.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
{"path":"maakunta:lappi","name":"Lappi","nameEn":"Lapland","website":"https://www.lappi.fi/","contract":"Perustuslaki §121","tags":["cofog:01","maakunta","l5"],"orgTier":"state"}
"""
...
def _get_org(path: str) -> dict[str, Any] | None:
    ...
    rows = get_kotoba_client().select_where("vertex_gov_org", "owner_did", PRIMARY_DID, columns=keys + ["domain_code"], limit=2000)
    # R0: filtered multi-predicate domain_code AND path in Python
    for row in rows:
        if row.get("domain_code") == DOMAIN_CODE and row.get("path") == path:
            return {k: row.get(k) for k in keys}
    return None


def task_gov_fin_seed_orgs(limit: int = 30) -> dict[str, Any]:
    ...
    # R0: filtered multi-predicate owner_did AND name_en != '' in Python
...
def task_gov_fin_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_fin_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
    org_tier = str(orgTier or "").strip()
    offset = max(0, int(offset or 0))
    limit_val = max(1, min(int(limit or 50), 100))
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, columns=["path", "name", "name_en", "website", "did_registered", "owner_did", "org_tier"], limit=10000)
    # R0: filtered multi-predicate in Python, ordered by path, paginated
    filtered = []
    for r in all_rows:
    ...
    total = len(filtered)
    page_rows = filtered[offset : offset + limit_val]
    return {
        "orgs": [
            {
...
async def task_gov_fin_register_dids(limit: int = 10) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    cols = [
        "path", "name", "name_en", "website", "contract", "tags", "org_tier",
        "site_domain_slug", "site_followed", "last_ingested_at",
        "last_content_hash", "last_kyumei_at", "last_shinka_at", "created_at",
        "domain_code", "owner_did", "did_registered"
    ]
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, columns=cols, limit=10000)
    # R0: filtered multi-predicate in Python, ordered by path, limited
    filtered = []
    for r in all_rows:
...
async def task_gov_fin_follow_site_deps(limit: int = 15) -> dict[str, Any]:
    ...
    cols = [
        ...
        "last_content_hash", "last_kyumei_at", "last_shinka_at", "created_at",
        "domain_code", "owner_did", "site_followed"
    ]
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, columns=cols, limit=10000)
    # R0: filtered multi-predicate in Python, ordered by path, limited
    filtered = []
...
async def task_gov_fin_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
    cutoff = (_dt.datetime.now(tz=_dt.UTC) - _dt.timedelta(days=7)).replace(microsecond=0)
    cutoff_iso = cutoff.isoformat().replace("+00:00", "Z")
    cols = ["path", "name_en", "website", "site_domain_slug", "last_content_hash", "last_ingested_at", "domain_code", "owner_did"]
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, columns=cols, limit=10000)
    # R0: filtered multi-predicate in Python, epoch-time math equivalent string compare, ordered
    filtered = []
    for r in all_rows:
    ...
    for r in page_rows:
        ...
        if not path or not slug:
            continue
        checked += 1
        wet_rows = get_kotoba_client().select_where("vertex_wet_chunk", "domain", slug, columns=["markdown", "content_hash", "crawled_at"], limit=200)
        # R0: sorted in Python to simulate ORDER BY DESC LIMIT 1
...
async def task_gov_fin_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 1), 5))
    cols = ["path", "name_en", "last_shinka_at", "domain_code", "owner_did", "did_registered"]
    all_rows = get_kotoba_client().select_where("vertex_gov_org", "domain_code", DOMAIN_CODE, columns=cols, limit=10000)
    # R0: filtered multi-predicate in Python, ordered by last_shinka_at
    filtered = []
    for r in all_rows:
...
async def task_gov_fin_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_fin_seed_orgs, seedLimit)
    register = await task_gov_fin_register_dids(registerLimit)
    follow = await task_gov_fin_follow_site_deps(followLimit)
    ingest = await task_gov_fin_sync_wet_updates(ingestLimit)
    shinka = await task_gov_fin_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govFin.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_heartbeat_tick)
