...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_fin_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govFin.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
