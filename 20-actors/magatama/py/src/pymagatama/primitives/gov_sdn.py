"""SDN Government states actor primitives.

This module moves the `did:web:sdn-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:sdn-state.etzhayyim.com"
DOMAIN_CODE = "sdn"
...
_MINISTRY_NDJSON = """\
{"path":"sovereignty-council","name":"مجلس السيادة","nameEn":"Sovereignty Council of Sudan","website":"https://www.sudan.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","executive","sovereignty"],"orgTier":"ministry"}
{"path":"council-ministers","name":"مجلس الوزراء","nameEn":"Council of Ministers","website":"https://www.sudan.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","cabinet"],"orgTier":"ministry"}
{"path":"mofa","name":"وزارة الخارجية","nameEn":"Ministry of Foreign Affairs","website":"https://www.mfa.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01.2","foreign-affairs"],"orgTier":"ministry"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defence","website":"https://www.mod.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"وزارة المالية والتخطيط الاقتصادي","nameEn":"Ministry of Finance and Economic Planning","website":"https://www.mof.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01.1","finance","planning"],"orgTier":"ministry"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"وزارة التربية والتعليم","nameEn":"Ministry of Education","website":"https://www.moe.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"moh","name":"وزارة الصحة","nameEn":"Ministry of Health","website":"https://www.moh.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"mol","name":"وزارة العمل والإصلاح الإداري","nameEn":"Ministry of Labour and Administrative Reform","website":"https://www.mol.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:04","labour"],"orgTier":"ministry"}
"""

_STATE_NDJSON = """\
{"path":"state:khartoum","name":"ولاية الخرطوم","nameEn":"Khartoum State","website":"https://www.khartoum.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state","capital"],"orgTier":"state"}
{"path":"state:north-khartoum","name":"ولاية الخرطوم الشمالية","nameEn":"North Khartoum State","website":"https://www.nkhartoum.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:omdurman","name":"ولاية أم درمان","nameEn":"Omdurman State","website":"https://www.omdurman.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:gezira","name":"ولاية الجزيرة","nameEn":"Gezira State","website":"https://www.gezira.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state","agricultural"],"orgTier":"state"}
{"path":"state:red-sea","name":"ولاية البحر الأحمر","nameEn":"Red Sea State","website":"https://www.redsea.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state","port-sudan"],"orgTier":"state"}
{"path":"state:north","name":"ولاية نهر النيل","nameEn":"River Nile State","website":"https://www.rnstate.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:kassala","name":"ولاية كسلا","nameEn":"Kassala State","website":"https://www.kassala.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state","east"],"orgTier":"state"}
{"path":"state:white-nile","name":"ولاية النيل الأبيض","nameEn":"White Nile State","website":"https://www.whitenile.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:sennar","name":"ولاية سنار","nameEn":"Sennar State","website":"https://www.sennar.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state"],"orgTier":"state"}
{"path":"state:south-kordofan","name":"ولاية جنوب كردفان","nameEn":"South Kordofan State","website":"https://www.skordofan.gov.sd/","contract":"Constitutional Document 2019","tags":["cofog:01","state"],"orgTier":"state"}
"""
...
def task_gov_sdn_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_sdn_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_sdn_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_sdn_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_sdn_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_sdn_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_sdn_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
...
async def task_gov_sdn_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_sdn_seed_orgs, seedLimit)
    register = await task_gov_sdn_register_dids(registerLimit)
    follow = await task_gov_sdn_follow_site_deps(followLimit)
    ingest = await task_gov_sdn_sync_wet_updates(ingestLimit)
    shinka = await task_gov_sdn_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govSdn.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_sdn_heartbeat_tick)
