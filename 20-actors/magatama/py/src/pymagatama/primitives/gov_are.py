"""ARE Government states actor primitives.

This module moves the `did:web:are-state.etzhayyim.com` app actor off its
...
PRIMARY_DID = "did:web:are-state.etzhayyim.com"
DOMAIN_CODE = "are"
...
_MINISTRY_NDJSON = """\
{"path":"mofaic","name":"وزارة الخارجية والتعاون الدولي","nameEn":"Ministry of Foreign Affairs and International Cooperation","website":"https://www.mofa.gov.ae/","contract":"UAE Constitution 1971 Art. 47","tags":["cofog:01.2","foreign-affairs","international-cooperation"],"orgTier":"ministry"}
{"path":"mod","name":"وزارة الدفاع","nameEn":"Ministry of Defence","website":"https://www.mod.gov.ae/","contract":"UAE Constitution Art. 142","tags":["cofog:02","defence"],"orgTier":"ministry"}
{"path":"mof","name":"وزارة المالية","nameEn":"Ministry of Finance","website":"https://www.mof.gov.ae/","contract":"UAE Constitution Art. 78","tags":["cofog:01.1","finance","budget"],"orgTier":"ministry"}
{"path":"moj","name":"وزارة العدل","nameEn":"Ministry of Justice","website":"https://www.moj.gov.ae/","contract":"UAE Constitution Art. 94","tags":["cofog:03","justice"],"orgTier":"ministry"}
{"path":"moi","name":"وزارة الداخلية","nameEn":"Ministry of Interior","website":"https://www.moi.gov.ae/","contract":"UAE Constitution Art. 47","tags":["cofog:03","interior","police"],"orgTier":"ministry"}
{"path":"moe","name":"وزارة التربية والتعليم","nameEn":"Ministry of Education","website":"https://www.moe.gov.ae/","contract":"UAE Constitution Art. 17","tags":["cofog:09","education"],"orgTier":"ministry"}
{"path":"mohap","name":"وزارة الصحة ووقاية المجتمع","nameEn":"Ministry of Health and Prevention","website":"https://www.mohap.gov.ae/","contract":"UAE Constitution Art. 19","tags":["cofog:07","health"],"orgTier":"ministry"}
{"path":"moei","name":"وزارة الطاقة والبنية التحتية","nameEn":"Ministry of Energy and Infrastructure","website":"https://www.moei.gov.ae/","contract":"UAE Constitution Art. 23","tags":["cofog:04.5","energy","infrastructure"],"orgTier":"ministry"}
{"path":"mocd","name":"وزارة الثقافة والشباب","nameEn":"Ministry of Culture and Youth","website":"https://www.mcy.gov.ae/","contract":"UAE Constitution Art. 17","tags":["cofog:08","culture","youth"],"orgTier":"ministry"}
{"path":"mohrsd","name":"وزارة الموارد البشرية والتوطين","nameEn":"Ministry of Human Resources and Emiratisation","website":"https://www.mohre.gov.ae/","contract":"UAE Constitution Art. 20","tags":["cofog:04","labour","emiratisation"],"orgTier":"ministry"}
{"path":"most","name":"وزارة دولة للتسامح والتعايش","nameEn":"Ministry of State for Tolerance and Coexistence","website":"https://www.tolerance.gov.ae/","contract":"UAE Constitution Art. 47","tags":["cofog:01","tolerance","coexistence"],"orgTier":"ministry"}
{"path":"fcsa","name":"الهيئة الاتحادية للتنافسية والإحصاء","nameEn":"Federal Competitiveness and Statistics Authority","website":"https://fcsa.gov.ae/","contract":"UAE Constitution Art. 120","tags":["cofog:01","statistics","competitiveness"],"orgTier":"agency"}
{"path":"fna","name":"المجلس الوطني الاتحادي","nameEn":"Federal National Council","website":"https://www.fnc.gov.ae/","contract":"UAE Constitution Art. 68","tags":["cofog:01","legislature","advisory"],"orgTier":"agency"}
"""

_STATE_NDJSON = """\
{"path":"emirate:abu-dhabi","name":"إمارة أبوظبي","nameEn":"Emirate of Abu Dhabi","website":"https://www.abudhabi.ae/","contract":"UAE Constitution Art. 121 + Abu Dhabi Law","tags":["cofog:01","emirate","capital","oil"],"orgTier":"state"}
{"path":"emirate:dubai","name":"إمارة دبي","nameEn":"Emirate of Dubai","website":"https://www.dubai.ae/","contract":"UAE Constitution Art. 121 + Dubai Law","tags":["cofog:01","emirate","financial-hub","tourism"],"orgTier":"state"}
{"path":"emirate:sharjah","name":"إمارة الشارقة","nameEn":"Emirate of Sharjah","website":"https://www.sharjah.ae/","contract":"UAE Constitution Art. 121","tags":["cofog:01","emirate","culture"],"orgTier":"state"}
{"path":"emirate:ajman","name":"إمارة عجمان","nameEn":"Emirate of Ajman","website":"https://www.ajman.ae/","contract":"UAE Constitution Art. 121","tags":["cofog:01","emirate","smallest"],"orgTier":"state"}
{"path":"emirate:umm-al-quwain","name":"إمارة أم القيوين","nameEn":"Emirate of Umm Al Quwain","website":"https://www.uaq.ae/","contract":"UAE Constitution Art. 121","tags":["cofog:01","emirate"],"orgTier":"state"}
{"path":"emirate:ras-al-khaimah","name":"إمارة رأس الخيمة","nameEn":"Emirate of Ras Al Khaimah","website":"https://www.rak.ae/","contract":"UAE Constitution Art. 121","tags":["cofog:01","emirate","northern"],"orgTier":"state"}
{"path":"emirate:fujairah","name":"إمارة الفجيرة","nameEn":"Emirate of Fujairah","website":"https://www.fujairah.ae/","contract":"UAE Constitution Art. 121","tags":["cofog:01","emirate","east-coast"],"orgTier":"state"}
"""
...
def task_gov_are_seed_orgs(limit: int = 30) -> dict[str, Any]:
...
def task_gov_are_resolve_org_path(path: str = "") -> dict[str, Any]:
...
def task_gov_are_list_orgs(orgTier: str = "", offset: int = 0, limit: int = 50) -> dict[str, Any]:
...
async def task_gov_are_register_dids(limit: int = 10) -> dict[str, Any]:
...
async def task_gov_are_follow_site_deps(limit: int = 15) -> dict[str, Any]:
...
async def task_gov_are_sync_wet_updates(limit: int = 10, postUpdates: bool = True) -> dict[str, Any]:
    limit = max(1, min(int(limit or 10), 50))
...
async def task_gov_are_shinka(limit: int = 1, postUpdates: bool = True) -> dict[str, Any]:
    ...
    return {"ok": True, "posted": posted, "touched": len(sliced)}


async def task_gov_are_heartbeat_tick(
    seedLimit: int = 30,
    ...
    seed = await asyncio.to_thread(task_gov_are_seed_orgs, seedLimit)
    register = await task_gov_are_register_dids(registerLimit)
    follow = await task_gov_are_follow_site_deps(followLimit)
    ingest = await task_gov_are_sync_wet_updates(ingestLimit)
    shinka = await task_gov_are_shinka(shinkaLimit)
    return {
        "ok": True,
...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_seed_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_register_dids)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_follow_site_deps)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_resolve_org_path)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_list_orgs)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_sync_wet_updates)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_shinka)
    worker.task(
        task_type="xrpc.com.etzhayyim.govAre.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_heartbeat_tick)
