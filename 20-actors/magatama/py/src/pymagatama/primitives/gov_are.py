...
def register(worker: Any, *, timeout_ms: int) -> None:
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.seedOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_seed_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.registerDIDs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_register_dids)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.followSiteDeps",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_follow_site_deps)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.resolveOrgPath",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_resolve_org_path)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.listOrgs",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_list_orgs)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.syncWetUpdates",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_sync_wet_updates)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.shinka",
        single_value=False,
        timeout_ms=timeout_ms,
    )(task_gov_are_shinka)
    worker.task(
        task_type="xrpc.app.etzhayyim.govAre.heartbeatTick",
        single_value=False,
        timeout_ms=timeout_ms,
