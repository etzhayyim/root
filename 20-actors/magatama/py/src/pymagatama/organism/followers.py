...
from pymagatama.organism.inbox import FollowerCurrentScore

logger = logging.getLogger("pymagatama.organism.followers")
...
class MstFollowerScoreProvider(Protocol):
    ...
    ``ai.gftd.apps.etzhayyim.joucho.score`` MST collection (ADR-2605240015
