...
from pymagatama.organism.post_sink import resolve_post_sink
from pymagatama.organism.unispsc_organism import UnispscOrganism

logger = logging.getLogger("pymagatama.organism.cell_main")
...
def _seed_self_inbox(organism: UnispscOrganism, now_ms: int) -> None:
    ...
    organism.inbox.add_commit(
        InboundCommit(
            collection="ai.gftd.apps.unispsc.invokeAgent",
