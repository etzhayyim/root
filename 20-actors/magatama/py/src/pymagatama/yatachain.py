"""pymagatama.yatachain — Python-side yatachain attestation primitives.

Mirror of the TypeScript surface in
``20-actors/etzhayyim-sdk/src/yatachain/attestation.ts`` so Murakumo
...
class WitnessRequest:
    """The body of a ``/yatachain/attest`` POST from the orchestrator."""
...
async def produce_attestation(
    *,
    ...
    :class:`pymagatama.substrate.Etzhayyim` (the cell-runner does this).
    """
