...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.analytics.listDashboards")
    ...
    @worker.task(task_type="ai.gftd.apps.analytics.getDashboard")
    ...
    @worker.task(task_type="ai.gftd.apps.analytics.listEvents")
    ...
    @worker.task(task_type="ai.gftd.apps.analytics.getMetrics")
    ...
    @worker.task(task_type="ai.gftd.apps.analytics.createReport")
    ...
    @worker.task(task_type="ai.gftd.apps.analytics.listReports")
