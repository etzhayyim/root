...
async def run_worker():
    ...
    @worker.task(task_type="ai.gftd.apps.fleamarket.listListings")
    ...
    @worker.task(task_type="ai.gftd.apps.fleamarket.getListing")
    ...
    @worker.task(task_type="ai.gftd.apps.fleamarket.listBids")
    ...
    @worker.task(task_type="ai.gftd.apps.fleamarket.closeListing")
    ...
    @worker.task(task_type="ai.gftd.apps.fleamarket.listTransactions")
