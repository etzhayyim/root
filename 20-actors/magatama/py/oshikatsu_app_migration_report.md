For src/pymagatama/primitives/oshikatsu_app.py:
...
- Cursor blocks converted:
  ...
  The primary conversion was replacing the import `from pymagatama.db_sync import sync_cursor` with `from pymagatama.kotoba_datomic import get_kotoba_client`.
