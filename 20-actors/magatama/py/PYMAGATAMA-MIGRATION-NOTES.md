...
# pymagatama RunPod-free migration — Step 8 cutover targets
...
1. Branch from main: `git checkout -b step8-pymagatama-runpod-free`
...
5. Run pytest 20-actors/magatama/py/tests/ → all green
