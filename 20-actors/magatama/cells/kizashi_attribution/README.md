# kizashi_attribution — kizashi (R0 scaffold)

emit a PROBABILISTIC, NON-DIAGNOSTIC cause-contribution report — candidate
contributing factors (never diseases) with calibrated confidence, a structural
"所見≠確定原因" disclaimer, and a consult recommendation. **kizashi senses;
mitate diagnoses.** The load-bearing cell.

Per ADR-2605312700. R0 scaffold — `cell.py` raises at import time until R1
(Council Lv6+ ≥3 + ≥1 licensed-MD on Council medical advisory + encrypted
backend live).
