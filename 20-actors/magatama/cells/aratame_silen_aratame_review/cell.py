"""AratameSilenAratameReviewCell — aratame R0 Pregel cell.
...
Purpose: quarterly Council audit; structural zero-counters (outOfScopeRepoCount / codeExecutionCount / plaintextSecretCount / vendorInferenceCount / writeToTargetCount) — any nonzero ⇒ cell halt + chigiri.disputeMediation.
...
gemma4-26b-a4b via judah LiteLLM 127.0.0.1:4000). Gates: G14 (silen review + Bonsai seed-tier prune).
Output Lexicon(s): com.etzhayyim.aratame.silenAratameReview.
...
#
# class AratameSilenAratameReviewCell(PregelCell):
#     process_step = "aratame_silen_aratame_review"
#     pregel_tier = "B"
...
__all__ = ["AratameSilenAratameReviewCell"]
