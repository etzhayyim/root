...
ADR-0087 (magatama MCP tool facade). Doctrine: ADR-2605302357.
...
MCP_FACADE_REGISTRY_DID: str | None = None  # magatama MCP facade registration target (ADR-0087)
...
if (
    ...
    raise RuntimeError(
        ...
        "pipeline ratify (Lv6+ >=3) + magatama MCP facade registry DID (ADR-0087). "
