...
- **Output Lexicon(s)**: app.etzhayyim.kurashimori.remedyDraft
- **Ceiling**: DRAFTING-ASSIST-ONLY / NO-作成代理 · lawful non-harassment language · draft only in app.etzhayyim.encrypted.* (ADR-2605181100) · MEMBER-CONFIRMS · Murakumo-only (ADR-2605215000)
