...
SILEN_PHARMA_BASELINE_REVIEW_CID: str | None = None  # app.etzhayyim.pharma.silenPharmaReview scope: wave-1c-cough-syrup-formulation-baseline | wave-1c-laxative-formulation-baseline
