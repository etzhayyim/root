...
- **Ceiling**: NEUTRAL signal only (no partisan framing/vote prompt) · CONSENT-GATED / OWN-DATA-ONLY · PII/opinion only in app.etzhayyim.encrypted.* (ADR-2605181100) · Murakumo-only (ADR-2605215000)
