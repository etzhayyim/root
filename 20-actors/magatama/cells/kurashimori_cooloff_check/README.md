...
- **Ceiling**: INFORMATIONAL-DATE-COMPUTATION / NOT-A-LEGAL-OPINION (borderline → chigiri+counsel) · verified 日数 only · contract detail only in app.etzhayyim.encrypted.* (ADR-2605181100) · Murakumo-only (ADR-2605215000)
