# moushibumi_target_registry — moushibumi (R0 scaffold)

maintain + resolve the coded democratic-participation target catalog (organ /
channel / 根拠法令 / 様式 / 期限 / 紹介議員-flag) and enforce the G14 gate.
