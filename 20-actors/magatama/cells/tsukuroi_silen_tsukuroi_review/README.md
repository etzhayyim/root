# tsukuroi_silen_tsukuroi_review — tsukuroi (R0 scaffold)

quarterly Council audit emitting structural zero-counters (autonomousMergeCount / exploitArtifactCount / outOfScopeWriteCount / platformHeldKeyCount); any nonzero ⇒ cell halt + chigiri.disputeMediation.
...
- **Gates**: G13 (silen review + Bonsai seed-tier prune on violation)
