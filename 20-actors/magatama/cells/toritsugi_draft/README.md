...
- **Output Lexicon(s)**: app.etzhayyim.toritsugi.applicationDraft
- **Ceiling**: INPUT-ASSIST-ONLY / NO-作成代理 (the only representable `assistMode` is "input-assist") · PII-ENCRYPTED (app.etzhayyim.encrypted.*, ADR-2605181100; never inline PII) · MEMBER-CONFIRMS (`memberConfirmed`) before any submission · Murakumo-only inference (ADR-2605215000)
