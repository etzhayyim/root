...
`20-actors/magatama/mcp/yorishiro-demo-fixture-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-demo-fixture": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/20-actors/magatama/mcp/yorishiro-demo-fixture-mcp/src/cli.ts"]
    }
  }
}
```
