...
Persists via `pymagatama.checkpointer.MstCheckpointSaver` (per [ADR-2605191559](../../../../90-docs/adr/2605191559-ameno-mst-checkpointer-stage-2-activation.md)).
...
magatama cell invoke --cell CharterAttestationRequestCell --input <request-uri>
...
ETZ_NETWORK=testnet magatama cell test --cell CharterAttestationRequestCell
```
