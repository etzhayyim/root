...
`20-actors/magatama/mcp/yorishiro-argparse-demo-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-argparse-demo": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/20-actors/magatama/mcp/yorishiro-argparse-demo-mcp/src/cli.ts"]
    }
  }
}
```
