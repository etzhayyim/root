...
- **Ceiling**: DRAFTING-ASSIST-ONLY / NO-作成代理 · draft only in app.etzhayyim.encrypted.* (ADR-2605181100; APPI special-care) · MEMBER-CONFIRMS before submission · Murakumo-only (ADR-2605215000)
