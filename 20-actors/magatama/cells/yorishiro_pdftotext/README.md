...
`20-actors/magatama/mcp/yorishiro-pdftotext-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-pdftotext": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/20-actors/magatama/mcp/yorishiro-pdftotext-mcp/src/cli.ts"]
    }
  }
}
```
