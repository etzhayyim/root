...
`20-actors/magatama/mcp/yorishiro-cobra-demo-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-cobra-demo": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/20-actors/magatama/mcp/yorishiro-cobra-demo-mcp/src/cli.ts"]
    }
  }
}
```
