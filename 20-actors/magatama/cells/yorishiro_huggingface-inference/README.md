...
`20-actors/magatama/mcp/yorishiro-huggingface-inference-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-huggingface-inference": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/20-actors/magatama/mcp/yorishiro-huggingface-inference-mcp/src/cli.ts"],
