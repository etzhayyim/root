...
`20-actors/magatama/mcp/yorishiro-fueleconomy-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-fueleconomy": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/20-actors/magatama/mcp/yorishiro-fueleconomy-mcp/src/cli.ts"],
