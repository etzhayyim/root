"""AratameSecretScanCell — aratame R0 Pregel cell.
...
Purpose: run OSS secret detection (gitleaks / trufflehog OSS); store any detected secret ONLY as an encrypted envelope ref (com.etzhayyim.encrypted.*, ADR-2605181100), never plaintext.
...
gemma4-26b-a4b via judah LiteLLM 127.0.0.1:4000). Gates: G3 (read-only) + G7 (secret-encryption).
Output Lexicon(s): com.etzhayyim.aratame.secretFinding.
...
#
# class AratameSecretScanCell(PregelCell):
#     process_step = "aratame_secret_scan"
#     pregel_tier = "B"
