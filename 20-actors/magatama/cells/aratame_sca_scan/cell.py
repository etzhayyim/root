"""AratameScaScanCell — aratame R0 Pregel cell.
...
Purpose: run OSS SCA (OSV-Scanner / Trivy) and reuse giemon purl_vuln_match (purl->CVE, ADR-2605312330) over the dependency manifests; emit dependencyFindings.
...
gemma4-26b-a4b via judah LiteLLM 127.0.0.1:4000). Gates: G3 (read-only) + G5 (OSS-tooling-only).
Output Lexicon(s): com.etzhayyim.aratame.dependencyFinding.
...
#
# class AratameScaScanCell(PregelCell):
#     process_step = "aratame_sca_scan"
#     pregel_tier = "B"
