...
- **Ceiling**: PII-ENCRYPTED (app.etzhayyim.encrypted.*, ADR-2605181100; never inline PII) · TRANSPARENT-FORCE / LAWFUL-APPEAL-ONLY (審査請求 via chigiri) · Murakumo-only inference (ADR-2605215000)
