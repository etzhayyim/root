...
//! Loaded inside a Web Worker via: `import init, { BrowserInferenceWorker } from 'magatama-inference'`
...
impl BrowserInferenceWorker {
    ...
    fn probe_capability(&self) -> BrowserCapability {
        BrowserCapability {
            ...
            gpu_tier: "g1".into(),
            cores: 1,
            user_agent: format!("magatama-inference-wasm/{}", env!("CARGO_PKG_VERSION")),
