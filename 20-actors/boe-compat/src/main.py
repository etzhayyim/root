"""
Py Kotodama WASM entrypoint for the Boe clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "boe-compat", "entities": ['Indicator', 'Observation', 'Country', 'Series', 'Report', 'ExchangeRate']}, 200
