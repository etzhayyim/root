"""
Contract test for the cloudflare-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "cloudflare.kotoba")
ENTITIES = ['Zone', 'DNSRecord', 'WorkerScript', 'Certificate', 'PageRule', 'LoadBalancer']
PLURALS = {'Zone': 'zones', 'DNSRecord': 'dnsrecords', 'WorkerScript': 'workerscripts', 'Certificate': 'certificates', 'PageRule': 'pagerules', 'LoadBalancer': 'loadbalancers'}
