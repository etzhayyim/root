"""
Py Kotodama WASM entrypoint for the Alpaca clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "alpaca-compat", "entities": ['Account', 'Card', 'Transaction', 'Order', 'Wallet', 'Ledger']}, 200
