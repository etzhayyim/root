"""
Py Kotodama WASM entrypoint for the Qnx clean-room actor.
...
def delete_process(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qnx.Process", "id": eid})
...
def delete_thread(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qnx.Thread", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_file_descriptor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qnx.FileDescriptor", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_syscall(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qnx.Syscall", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_memory_region(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qnx.MemoryRegion", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_signal(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qnx.Signal", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "qnx-compat", "entities": ['Process', 'Thread', 'FileDescriptor', 'Syscall', 'MemoryRegion', 'Signal']}, 200
