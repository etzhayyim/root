"""
Contract test for the procore_construction-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "procore_construction.kotoba")
ENTITIES = ['Project', 'Permit', 'Drawing', 'Inspection', 'Asset', 'ServiceRequest']
PLURALS = {'Project': 'projects', 'Permit': 'permits', 'Drawing': 'drawings', 'Inspection': 'inspections', 'Asset': 'assets', 'ServiceRequest': 'servicerequests'}


class ProcoreConstructionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
