"""
Py Kotodama WASM entrypoint for the Kong clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "kong-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
