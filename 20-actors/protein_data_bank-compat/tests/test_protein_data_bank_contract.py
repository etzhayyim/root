"""
Contract test for the protein_data_bank-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "protein_data_bank.kotoba")
...
class ProteinDataBankContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
