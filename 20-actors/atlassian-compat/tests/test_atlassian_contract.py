"""
Contract test for the atlassian-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "atlassian.kotoba")
ENTITIES = ['Project', 'IssueType', 'Status', 'StatusCategory', 'User', 'Comment']
PLURALS = {'Project': 'projects', 'IssueType': 'issuetypes', 'Status': 'statuses', 'StatusCategory': 'statuscategories', 'User': 'users', 'Comment': 'comments'}


class AtlassianContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['accountType', 'projectTypeKey', 'style']:
