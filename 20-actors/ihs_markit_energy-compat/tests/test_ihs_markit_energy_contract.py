"""
Contract test for the ihs_markit_energy-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ihs_markit_energy.kotoba")
...
class IhsMarkitEnergyContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
