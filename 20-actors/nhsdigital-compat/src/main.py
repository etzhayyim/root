"""
Py Kotodama WASM entrypoint for the Nhsdigital clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"nhsdigital.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nhsdigital.Filing", "id": eid})
...
def delete_citizen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nhsdigital.Citizen", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_service(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nhsdigital.Service", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_application(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nhsdigital.Application", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nhsdigital.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_identity(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nhsdigital.Identity", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "nhsdigital-compat", "entities": ['Filing', 'Citizen', 'Service', 'Application', 'Dataset', 'Identity']}, 200
