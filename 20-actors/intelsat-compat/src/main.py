"""
Py Kotodama WASM entrypoint for the Intelsat clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "intelsat-compat", "entities": ['Subscriber', 'Session', 'Message', 'Number', 'Terminal', 'UsageRecord']}, 200
