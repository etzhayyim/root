...
| 2 | global instrument seed (laws/institutions/doctrines/values) | ✅ 133 instruments · 92 jurisdictions · 4 kinds incl :value (iter 6) |
...
| 9 | EAVT datom emission (flagged :derived + :hypothesis) | ✅ 1963 datoms |
...
| 16b | continental region coverage (balance + gap detection) | ✅ `analyze/region-of` · 5 continents (iter 6) |
| 17 | tests green | ✅ 45 tests / 1887 assertions |
