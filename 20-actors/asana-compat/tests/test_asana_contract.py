"""
Contract test for the asana-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "asana.kotoba")
ENTITIES = ['Task', 'Project', 'Section', 'User', 'Tag', 'Workspace']
PLURALS = {'Task': 'tasks', 'Project': 'projects', 'Section': 'sections', 'User': 'users', 'Tag': 'tags', 'Workspace': 'workspaces'}


class AsanaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['approvalStatus', 'color', 'defaultView', 'resourceSubtype']:
