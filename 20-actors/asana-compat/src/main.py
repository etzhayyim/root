"""
Py Kotodama WASM entrypoint for the Asana clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "asana-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
