"""
Py Kotodama WASM entrypoint for the Kingdee clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"kingdee.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"kingdee.Account", "id": eid})
...
def delete_contact(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"kingdee.Contact", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_lead(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"kingdee.Lead", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_opportunity(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"kingdee.Opportunity", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_activity(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"kingdee.Activity", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_pipeline(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"kingdee.Pipeline", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "kingdee-compat", "entities": ['Account', 'Contact', 'Lead', 'Opportunity', 'Activity', 'Pipeline']}, 200
