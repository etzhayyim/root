"""
Contract test for the starlink_telemetry-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "starlink_telemetry.kotoba")
...
class StarlinkTelemetryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
