"""
Contract test for the gsma_opengateway-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "gsma_opengateway.kotoba")
...
class GsmaOpengatewayContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
