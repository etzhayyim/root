"""
Contract test for the siemens_teamcenter-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "siemens_teamcenter.kotoba")
ENTITIES = ['Part', 'BOM', 'ChangeOrder', 'WorkOrder', 'Robot', 'Program']
PLURALS = {'Part': 'parts', 'BOM': 'boms', 'ChangeOrder': 'changeorders', 'WorkOrder': 'workorders', 'Robot': 'robots', 'Program': 'programs'}


class SiemensTeamcenterContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
