"""
Py Kotodama WASM entrypoint for the Modbus_tcp clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "modbus_tcp-compat", "entities": ['Meter', 'Reading', 'Node', 'LoadForecast', 'MarketBid', 'Tag']}, 200
