"""
Py Kotodama WASM entrypoint for the Rapyd clean-room actor.
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rapyd.Account", "id": eid})
...
def delete_card(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rapyd.Card", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_transaction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rapyd.Transaction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_order(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rapyd.Order", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_wallet(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rapyd.Wallet", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_ledger(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rapyd.Ledger", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "rapyd-compat", "entities": ['Account', 'Card', 'Transaction', 'Order', 'Wallet', 'Ledger']}, 200
