"""
Contract test for the firebase_games-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "firebase_games.kotoba")
...
class FirebaseGamesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
