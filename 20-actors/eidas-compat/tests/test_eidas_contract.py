"""
Contract test for the eidas-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "eidas.kotoba")
ENTITIES = ['AuthenticationAssertion', 'EidasAttribute', 'TrustService', 'Subject']
PLURALS = {'AuthenticationAssertion': 'authenticationassertions', 'EidasAttribute': 'eidasattributes', 'TrustService': 'trustservices', 'Subject': 'subjects'}


class EidasContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['levelOfAssurance', 'nameFormat']:
