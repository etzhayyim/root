"""
Py Kotodama WASM entrypoint for the Eidas clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "eidas-compat", "entities": ['Filing', 'Citizen', 'Service', 'Application', 'Dataset', 'Identity']}, 200
