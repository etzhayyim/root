"""
Contract test for the halliburton_delfi-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "halliburton_delfi.kotoba")
...
class HalliburtonDelfiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
