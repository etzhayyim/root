...
Keeps keywords as ":ns/name" strings. Stdlib only. Used by triage/revision/analyze to read the
ontology + lexicons + seed without a dependency, mirroring the other actors' parsers for parity.
"""
