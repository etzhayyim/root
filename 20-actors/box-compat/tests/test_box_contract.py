"""
Contract test for the box-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "box.kotoba")
ENTITIES = ['File', 'Folder', 'User', 'Collaboration', 'SharedLink', 'Comment']
PLURALS = {'File': 'files', 'Folder': 'folders', 'User': 'users', 'Collaboration': 'collaborations', 'SharedLink': 'sharedlinks', 'Comment': 'comments'}


class BoxContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['access', 'itemStatus', 'role', 'status', 'syncState']:
