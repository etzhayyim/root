"""
Py Kotodama WASM entrypoint for the Box clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "box-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
