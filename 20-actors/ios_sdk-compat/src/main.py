"""
Py Kotodama WASM entrypoint for the Ios_sdk clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "ios_sdk-compat", "entities": ['Process', 'Thread', 'FileDescriptor', 'Syscall', 'MemoryRegion', 'Signal']}, 200
