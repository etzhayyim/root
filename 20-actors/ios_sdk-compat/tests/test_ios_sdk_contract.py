"""
Contract test for the ios_sdk-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ios_sdk.kotoba")
ENTITIES = ['Device', 'TraitCollection', 'Screen']
PLURALS = {'Device': 'devices', 'TraitCollection': 'traitcollections', 'Screen': 'screens'}


class IosSdkContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['batteryState', 'orientation', 'userInterfaceStyle']:
