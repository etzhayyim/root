"""
Contract test for the stripe-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "stripe.kotoba")
ENTITIES = ['Customer', 'PaymentIntent', 'Charge', 'Refund', 'Invoice', 'Subscription', 'Product', 'Price']
PLURALS = {'Customer': 'customers', 'PaymentIntent': 'paymentintents', 'Charge': 'charges', 'Refund': 'refunds', 'Invoice': 'invoices', 'Subscription': 'subscriptions', 'Product': 'products', 'Price': 'prices'}


class StripeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['reason', 'recurringInterval', 'status']:
