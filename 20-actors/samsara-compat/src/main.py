"""
Py Kotodama WASM entrypoint for the Samsara clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"samsara.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_device(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"samsara.Device", "id": eid})
...
def delete_telemetry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"samsara.Telemetry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_gateway(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"samsara.Gateway", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_command(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"samsara.Command", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_firmware(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"samsara.Firmware", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_alert(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"samsara.Alert", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "samsara-compat", "entities": ['Device', 'Telemetry', 'Gateway', 'Command', 'Firmware', 'Alert']}, 200
