"""
Contract test for the trello-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "trello.kotoba")
ENTITIES = ['Card', 'Board', 'List', 'Member', 'Label']
PLURALS = {'Card': 'cards', 'Board': 'boards', 'List': 'lists', 'Member': 'members', 'Label': 'labels'}


class TrelloContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['cardRole', 'color', 'memberType']:
