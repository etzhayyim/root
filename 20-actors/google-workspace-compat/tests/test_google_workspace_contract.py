"""
Contract test for the google-workspace-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "google-workspace.kotoba")
ENTITIES = ['User', 'Group', 'Member', 'OrgUnit', 'ChromeOsDevice']
PLURALS = {'User': 'users', 'Group': 'groups', 'Member': 'members', 'OrgUnit': 'orgunits', 'ChromeOsDevice': 'chromeosdevices'}


class GoogleWorkspaceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['chromeOsType', 'osVersionCompliance']:
