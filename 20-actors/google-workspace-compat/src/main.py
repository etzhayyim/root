"""
Py Kotodama WASM entrypoint for the Google-workspace clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "google-workspace-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
