"""
Contract test for the greenhouse-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "greenhouse.kotoba")
ENTITIES = ['Candidate', 'Application', 'Job', 'Offer', 'Scorecard', 'ScheduledInterview']
PLURALS = {'Candidate': 'candidates', 'Application': 'applications', 'Job': 'jobs', 'Offer': 'offers', 'Scorecard': 'scorecards', 'ScheduledInterview': 'scheduledinterviews'}


class GreenhouseContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
