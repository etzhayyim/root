"""
Py Kotodama WASM entrypoint for the Dailyco clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"dailyco.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_channel(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"dailyco.Channel", "id": eid})
...
def delete_message(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"dailyco.Message", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_user(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"dailyco.User", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_room(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"dailyco.Room", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_stream(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"dailyco.Stream", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_webhook(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"dailyco.Webhook", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "dailyco-compat", "entities": ['Channel', 'Message', 'User', 'Room', 'Stream', 'Webhook']}, 200
