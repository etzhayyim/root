"""
Contract test for the teledyne_marine-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "teledyne_marine.kotoba")
...
class TeledyneMarineContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
