"""
Contract test for the jenkins-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "jenkins.kotoba")
ENTITIES = ['Build', 'Job', 'QueueItem', 'Computer', 'View']
PLURALS = {'Build': 'builds', 'Job': 'jobs', 'QueueItem': 'queueitems', 'Computer': 'computers', 'View': 'views'}


class JenkinsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
