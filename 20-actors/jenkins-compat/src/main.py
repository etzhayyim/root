"""
Py Kotodama WASM entrypoint for the Jenkins clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "jenkins-compat", "entities": ['Repository', 'Pipeline', 'Build', 'Artifact', 'Deployment', 'Webhook']}, 200
