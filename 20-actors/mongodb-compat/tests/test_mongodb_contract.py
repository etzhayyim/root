"""
Contract test for the mongodb-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mongodb.kotoba")
ENTITIES = ['Cluster', 'DatabaseUser', 'Project', 'Backup', 'Organization', 'NetworkPeering']
PLURALS = {'Cluster': 'clusters', 'DatabaseUser': 'databaseusers', 'Project': 'projects', 'Backup': 'backups', 'Organization': 'organizations', 'NetworkPeering': 'networkpeerings'}


class MongodbContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['awsIAMType', 'clusterType', 'databaseName', 'frequencyType', 'localStatus', 'stateName']:
