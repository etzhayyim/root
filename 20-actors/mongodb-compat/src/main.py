"""
Py Kotodama WASM entrypoint for the Mongodb clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "mongodb-compat", "entities": ['Dataset', 'Query', 'Dashboard', 'Report', 'Connection', 'Metric']}, 200
