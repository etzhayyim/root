;; ported from /Users/junkawasaki/github/com-junkawasaki/orgs/etzhayyim/root/20-actors/hinagata/methods/coverage_report.py (unit_refactor stage 0)
;; hinagata 雛形 — legal-template-commons COVERAGE report (ADR-2606111954).
(ns root.hinagata.methods.coverage-report
  (:require [clojure.string :as str]
            [clojure.set :as set]
            [clojure.edn :as edn]))

(declare concept-denom report main)
...
;; TODO: port-failed unit report (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmp134doei7/scratch.clj:74:14: )
...
;; TODO: port-failed unit main (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmp1x7b9v_e/scratch.clj:3:15: w)
;; def main(argv):
