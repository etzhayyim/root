"""
Py Kotodama WASM entrypoint for the Bizzabo clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"bizzabo.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_event(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bizzabo.Event", "id": eid})
...
def delete_ticket(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bizzabo.Ticket", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_attendee(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bizzabo.Attendee", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_donor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bizzabo.Donor", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_donation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bizzabo.Donation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_membership(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bizzabo.Membership", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "bizzabo-compat", "entities": ['Event', 'Ticket', 'Attendee', 'Donor', 'Donation', 'Membership']}, 200
