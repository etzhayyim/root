...
2. **SHA / CHA coordinates are Tier 3** (`Preferences()`). Never write to `app.bsky.feed.post` or public `ai.gftd.apps.demining.*` AT Record until `landReleaseDecision` fires.
