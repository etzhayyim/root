"""
Py Kotodama WASM entrypoint for the M365 clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "m365-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
