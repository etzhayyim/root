"""
Py Kotodama WASM entrypoint for the Freee clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "freee-compat", "entities": ['Account', 'Contact', 'Lead', 'Opportunity', 'Activity', 'Pipeline']}, 200
