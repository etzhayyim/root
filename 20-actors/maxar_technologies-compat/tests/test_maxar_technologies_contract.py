"""
Contract test for the maxar_technologies-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "maxar_technologies.kotoba")
...
class MaxarTechnologiesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
