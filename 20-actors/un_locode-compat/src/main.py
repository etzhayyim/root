"""
Py Kotodama WASM entrypoint for the Un_locode clean-room actor.
...
def delete_code(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"un_locode.Code", "id": eid})
...
def delete_unit(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"un_locode.Unit", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_reference(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"un_locode.Reference", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_mapping(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"un_locode.Mapping", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_epoch(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"un_locode.Epoch", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "un_locode-compat", "entities": ['Code', 'Unit', 'Reference', 'Mapping', 'Location', 'Epoch']}, 200
