"""
Contract test for the un_locode-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "un_locode.kotoba")
ENTITIES = ['Location', 'FunctionClassifier', 'StatusCode']
PLURALS = {'Location': 'locations', 'FunctionClassifier': 'functionclassifiers', 'StatusCode': 'statuscodes'}


class UnLocodeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
