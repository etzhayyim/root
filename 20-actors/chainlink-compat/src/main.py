"""
Py Kotodama WASM entrypoint for the Chainlink clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "chainlink-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
