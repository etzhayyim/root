"""
Contract test for the omop_cdm-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "omop_cdm.kotoba")
ENTITIES = ['Person', 'Concept', 'ConditionOccurrence', 'DrugExposure', 'VisitOccurrence', 'Observation']
PLURALS = {'Person': 'persons', 'Concept': 'concepts', 'ConditionOccurrence': 'conditionoccurrences', 'DrugExposure': 'drugexposures', 'VisitOccurrence': 'visitoccurrences', 'Observation': 'observations'}


class OmopCdmContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['invalidReason', 'standardConcept']:
