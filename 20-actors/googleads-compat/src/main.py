"""
Py Kotodama WASM entrypoint for the Googleads clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"googleads.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def healthz(request):
    return {"status": "ok", "actor": "googleads-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
