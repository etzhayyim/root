"""
Contract test for the googleads-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "googleads.kotoba")
ENTITIES = ['Campaign', 'AdGroup']
PLURALS = {'Campaign': 'campaigns', 'AdGroup': 'adgroups'}


class GoogleadsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['servingStatus', 'status']:
