"""
Py Kotodama WASM entrypoint for the Oracle clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "oracle-compat", "entities": ['GLAccount', 'JournalEntry', 'Invoice', 'PurchaseOrder', 'Vendor', 'CostCenter']}, 200
