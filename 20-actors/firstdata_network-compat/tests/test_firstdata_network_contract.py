"""
Contract test for the firstdata_network-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "firstdata_network.kotoba")
...
class FirstdataNetworkContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
