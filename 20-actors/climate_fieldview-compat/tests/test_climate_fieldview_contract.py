"""
Contract test for the climate_fieldview-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "climate_fieldview.kotoba")
ENTITIES = ['Field', 'Operation', 'Reading', 'Machine', 'Lot', 'Imagery']
PLURALS = {'Field': 'fields', 'Operation': 'operations', 'Reading': 'readings', 'Machine': 'machines', 'Lot': 'lots', 'Imagery': 'imageries'}


class ClimateFieldviewContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
