"""
Py Kotodama WASM entrypoint for the Uniswap_v3 clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"uniswap_v3.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_block(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"uniswap_v3.Block", "id": eid})
...
def delete_transaction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"uniswap_v3.Transaction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_contract(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"uniswap_v3.Contract", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"uniswap_v3.Account", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_event(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"uniswap_v3.Event", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_token(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"uniswap_v3.Token", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "uniswap_v3-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
