"""
Py Kotodama WASM entrypoint for the Aftership clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "aftership-compat", "entities": ['ContentEntry', 'Product', 'Shipment', 'SearchIndex', 'Webhook', 'Order']}, 200
