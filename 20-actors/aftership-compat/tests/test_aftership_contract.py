"""
Contract test for the aftership-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "aftership.kotoba")
ENTITIES = ['Tracking', 'Checkpoint', 'Courier', 'Notification', 'EstimatedDeliveryDate']
PLURALS = {'Tracking': 'trackings', 'Checkpoint': 'checkpoints', 'Courier': 'couriers', 'Notification': 'notifications', 'EstimatedDeliveryDate': 'estimateddeliverydates'}


class AftershipContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
