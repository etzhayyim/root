"""
Py Kotodama WASM entrypoint for the Fivetran clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "fivetran-compat", "entities": ['Connector', 'Sync', 'Model', 'Stream', 'Schema', 'Test']}, 200
