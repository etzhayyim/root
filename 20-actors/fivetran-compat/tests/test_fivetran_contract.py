"""
Contract test for the fivetran-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "fivetran.kotoba")
ENTITIES = ['Connector', 'Destination', 'Group', 'User', 'Transformation']
PLURALS = {'Connector': 'connectors', 'Destination': 'destinations', 'Group': 'groups', 'User': 'users', 'Transformation': 'transformations'}


class FivetranContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['networkingMethod', 'scheduleType', 'setupState', 'setupStatus', 'status', 'syncState', 'type', 'updateState']:
