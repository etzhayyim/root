"""
Contract test for the sabre_airlines-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "sabre_airlines.kotoba")
...
class SabreAirlinesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
