...
| **SP Service Agreement** | `did:web:hc.gftd.ai:legal:sp-service-agreement` | OEM 製造者/工場 | 品質保証義務+瑕疵担保2年は SP 側, 不合格品費用 SP 負担, 納期遅延0.5%/日, PL法負担は SP, 監査権(3営業日通知), 競業避止2年, 秘密保持5年, 一方的解除権(30日), IP 改良は GFTD 帰属 |
| **Task Terms** | `did:web:hc.gftd.ai:legal:task-terms` | マイクロタスク個別 | reject 時報酬なし, auto-approve 期限後の黙示承認, 紛争裁定は GFTD 最終・拘束力あり・不服申立不可, 禁止行為違反で未払報酬没収 |
