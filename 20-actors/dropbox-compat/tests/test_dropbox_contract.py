"""
Contract test for the dropbox-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "dropbox.kotoba")
ENTITIES = ['FileMetadata', 'FolderMetadata', 'SharedLink', 'Account', 'SharedFolder']
PLURALS = {'FileMetadata': 'filemetadatas', 'FolderMetadata': 'foldermetadatas', 'SharedLink': 'sharedlinks', 'Account': 'accounts', 'SharedFolder': 'sharedfolders'}


class DropboxContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['accessType', 'requestedVisibility', 'visibility']:
