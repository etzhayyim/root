"""
Py Kotodama WASM entrypoint for the Dropbox clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "dropbox-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
