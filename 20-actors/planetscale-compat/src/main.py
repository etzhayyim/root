"""
Py Kotodama WASM entrypoint for the Planetscale clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "planetscale-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
