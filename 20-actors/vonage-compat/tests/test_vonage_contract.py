"""
Contract test for the vonage-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "vonage.kotoba")
ENTITIES = ['Call', 'Message', 'Number', 'Verification', 'Application']
PLURALS = {'Call': 'calls', 'Message': 'messages', 'Number': 'numbers', 'Verification': 'verifications', 'Application': 'applications'}


class VonageContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['channel', 'direction', 'messageType', 'status', 'type']:
