"""
Contract test for the elastic-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "elastic.kotoba")
ENTITIES = ['ClusterHealth', 'Index', 'Shard', 'Node', 'Alias', 'Document']
PLURALS = {'ClusterHealth': 'clusterhealths', 'Index': 'indexes', 'Shard': 'shards', 'Node': 'nodes', 'Alias': 'aliases', 'Document': 'documents'}


class ElasticContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['health', 'state', 'status']:
