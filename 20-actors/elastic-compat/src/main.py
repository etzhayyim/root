"""
Py Kotodama WASM entrypoint for the Elastic clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "elastic-compat", "entities": ['Service', 'Error', 'Trace', 'Metric', 'Alert', 'Incident']}, 200
