"""
Py Kotodama WASM entrypoint for the Comma_ai clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "comma_ai-compat", "entities": ['Vehicle', 'Signal', 'ChargeSession', 'Connector', 'Trip', 'Command']}, 200
