"""
Py Kotodama WASM entrypoint for the Rhino clean-room actor.
...
def delete_project(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rhino.Project", "id": eid})
...
def delete_file(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rhino.File", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_frame(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rhino.Frame", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_component(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rhino.Component", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_comment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rhino.Comment", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_export(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"rhino.Export", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "rhino-compat", "entities": ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']}, 200
