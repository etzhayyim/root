"""
Contract test for the toshiba_global_commerce-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "toshiba_global_commerce.kotoba")
ENTITIES = ['Product', 'Variant', 'Order', 'LineItem', 'Customer', 'Collection']
PLURALS = {'Product': 'products', 'Variant': 'variants', 'Order': 'orders', 'LineItem': 'lineitems', 'Customer': 'customers', 'Collection': 'collections'}


class ToshibaGlobalCommerceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
