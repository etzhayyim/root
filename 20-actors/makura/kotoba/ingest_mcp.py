#!/usr/bin/env python3
"""makura 枕 — ingest seed.edn into a live kotoba node via MCP.

ADR-2605261115, migration plan Phase 3. Flattens each seed entity map into
...
Usage:
    python3 ingest_mcp.py [--url http://127.0.0.1:8077] [--graph com.etzhayyim.makura] [--dry-run]
"""
...
def main() -> int:
    ...
    ap.add_argument("--graph", default="com.etzhayyim.makura")
