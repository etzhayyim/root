"""
Contract test for the lidoc_lufthansa-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "lidoc_lufthansa.kotoba")
...
class LidocLufthansaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
