"""
Contract test for the matrixx_software-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "matrixx_software.kotoba")
...
class MatrixxSoftwareContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
