"""
Contract test for the neuralink_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "neuralink_api.kotoba")
ENTITIES = ['Device', 'Session', 'Channel', 'Signal', 'Event', 'Calibration']
PLURALS = {'Device': 'devices', 'Session': 'sessions', 'Channel': 'channels', 'Signal': 'signals', 'Event': 'events', 'Calibration': 'calibrations'}


class NeuralinkApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
