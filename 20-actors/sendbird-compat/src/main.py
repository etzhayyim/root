"""
Py Kotodama WASM entrypoint for the Sendbird clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sendbird-compat", "entities": ['Channel', 'Message', 'User', 'Room', 'Stream', 'Webhook']}, 200
