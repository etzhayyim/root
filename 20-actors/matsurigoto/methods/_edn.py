...
Keeps keywords as ":ns/name" strings. Stdlib only. Used by standard.py to read the
COFOG e-gov standard without a dependency, mirroring the other actors' parsers for parity.
"""
