"""
Contract test for the duckcreek_rating-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "duckcreek_rating.kotoba")
...
class DuckcreekRatingContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
