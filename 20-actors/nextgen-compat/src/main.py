"""
Py Kotodama WASM entrypoint for the Nextgen clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"nextgen.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_patient(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nextgen.Patient", "id": eid})
...
def delete_encounter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nextgen.Encounter", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nextgen.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_medication(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nextgen.Medication", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_practitioner(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nextgen.Practitioner", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_appointment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nextgen.Appointment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "nextgen-compat", "entities": ['Patient', 'Encounter', 'Observation', 'Medication', 'Practitioner', 'Appointment']}, 200
