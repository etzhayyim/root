"""
Contract test for the bigcommerce-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bigcommerce.kotoba")
ENTITIES = ['Product', 'Order', 'Customer', 'Category', 'Brand', 'Cart']
PLURALS = {'Product': 'products', 'Order': 'orders', 'Customer': 'customers', 'Category': 'categories', 'Brand': 'brands', 'Cart': 'carts'}


class BigcommerceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['availability', 'condition', 'defaultProductSort', 'inventoryTracking', 'status', 'type']:
