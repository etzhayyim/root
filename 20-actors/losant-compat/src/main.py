"""
Py Kotodama WASM entrypoint for the Losant clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "losant-compat", "entities": ['Device', 'Telemetry', 'Gateway', 'Command', 'Firmware', 'Alert']}, 200
