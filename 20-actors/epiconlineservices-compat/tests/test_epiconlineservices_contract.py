"""
Contract test for the epiconlineservices-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "epiconlineservices.kotoba")
ENTITIES = ['Record', 'Matter', 'Contract', 'Course', 'Property', 'Document']
PLURALS = {'Record': 'records', 'Matter': 'matters', 'Contract': 'contracts', 'Course': 'courses', 'Property': 'properties', 'Document': 'documents'}
