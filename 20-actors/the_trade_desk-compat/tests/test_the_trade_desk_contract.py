"""
Contract test for the the_trade_desk-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "the_trade_desk.kotoba")
...
class TheTradeDeskContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
