"""
Py Kotodama WASM entrypoint for the The_trade_desk clean-room actor.
...
def _persist(entity, rec):
    ...
    for k, v in rec.items():
        facts[f"the_trade_desk.{entity}/{k}"] = v
    db.transact([facts])
    return rec
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"the_trade_desk.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_campaign(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"the_trade_desk.Campaign", "id": eid})
...
def delete_audience(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"the_trade_desk.Audience", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_event(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"the_trade_desk.Event", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_profile(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"the_trade_desk.Profile", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_message(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"the_trade_desk.Message", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_funnel(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"the_trade_desk.Funnel", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "the_trade_desk-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
