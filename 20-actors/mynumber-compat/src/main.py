"""
Py Kotodama WASM entrypoint for the Mynumber clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"mynumber.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mynumber.Filing", "id": eid})
...
def delete_corporation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mynumber.Corporation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_disclosure(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mynumber.Disclosure", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_citizen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mynumber.Citizen", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_application(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mynumber.Application", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mynumber.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "mynumber-compat", "entities": ['Filing', 'Corporation', 'Disclosure', 'Citizen', 'Application', 'Dataset']}, 200
