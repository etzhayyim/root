"""
Contract test for the tae_technologies-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "tae_technologies.kotoba")
...
class TaeTechnologiesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
