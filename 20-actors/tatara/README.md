...
# ── tatara: ALL suites green ──   (56 tests / 5,032 assertions)
...
| `methods/test_{analyze,kotoba,autorun,lexicons,crosscheck,maturity,seed-integrity,viz,compose,robustness}.cljc` | 56 tests / 5,032 assertions |
