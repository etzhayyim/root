...
# ── tatara: ALL suites green ──   (50 tests / 5,001 assertions)
...
| `methods/test_{analyze,kotoba,autorun,lexicons,crosscheck,maturity,seed-integrity,viz,compose}.cljc` | 50 tests / 5,001 assertions |
