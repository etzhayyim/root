...
# ── tatara: ALL suites green ──   (42 tests / 4,227 assertions)
...
| `methods/test_{analyze,kotoba,autorun,lexicons,crosscheck,maturity,seed-integrity}.cljc` | 42 tests / 4,227 assertions |
