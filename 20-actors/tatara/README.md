...
# ── tatara: ALL suites green ──   (51 tests / 5,007 assertions)
...
| `methods/test_{analyze,kotoba,autorun,lexicons,crosscheck,maturity,seed-integrity,viz,compose}.cljc` | 51 tests / 5,007 assertions |
