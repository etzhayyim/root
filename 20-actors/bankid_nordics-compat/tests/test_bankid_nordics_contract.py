"""
Contract test for the bankid_nordics-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bankid_nordics.kotoba")
ENTITIES = ['Identity', 'Credential', 'Consent', 'Transaction', 'Document', 'VerificationRequest']
PLURALS = {'Identity': 'identities', 'Credential': 'credentials', 'Consent': 'consents', 'Transaction': 'transactions', 'Document': 'documents', 'VerificationRequest': 'verificationrequests'}


class BankidNordicsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
