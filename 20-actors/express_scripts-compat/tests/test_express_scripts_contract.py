"""
Contract test for the express_scripts-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "express_scripts.kotoba")
...
class ExpressScriptsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
