"""
Py Kotodama WASM entrypoint for the Bubble clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"bubble.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_flow(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bubble.Flow", "id": eid})
...
def delete_step(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bubble.Step", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_connection(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bubble.Connection", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_run(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bubble.Run", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_app(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bubble.App", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_webhook(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bubble.Webhook", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "bubble-compat", "entities": ['Flow', 'Step', 'Connection', 'Run', 'App', 'Webhook']}, 200
