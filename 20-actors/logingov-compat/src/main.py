"""
Py Kotodama WASM entrypoint for the Logingov clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "logingov-compat", "entities": ['Filing', 'Entity', 'Dataset', 'Application', 'PublicRecord', 'Notice']}, 200
