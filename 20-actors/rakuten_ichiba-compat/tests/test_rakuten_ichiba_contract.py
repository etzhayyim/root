"""
Contract test for the rakuten_ichiba-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "rakuten_ichiba.kotoba")
...
class RakutenIchibaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
