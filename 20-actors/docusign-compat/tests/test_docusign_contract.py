"""
Contract test for the docusign-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "docusign.kotoba")
ENTITIES = ['Envelope', 'Signer', 'Document', 'SignHereTab', 'EnvelopeTemplate']
PLURALS = {'Envelope': 'envelopes', 'Signer': 'signers', 'Document': 'documents', 'SignHereTab': 'signheretabs', 'EnvelopeTemplate': 'envelopetemplates'}


class DocusignContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
