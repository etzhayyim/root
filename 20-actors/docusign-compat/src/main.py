"""
Py Kotodama WASM entrypoint for the Docusign clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "docusign-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
