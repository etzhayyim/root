"""
Contract test for the bluefin_robotics-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bluefin_robotics.kotoba")
...
class BluefinRoboticsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
