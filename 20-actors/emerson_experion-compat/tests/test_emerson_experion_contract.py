"""
Contract test for the emerson_experion-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "emerson_experion.kotoba")
...
class EmersonExperionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
