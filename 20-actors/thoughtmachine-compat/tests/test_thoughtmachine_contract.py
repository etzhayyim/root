"""
Contract test for the thoughtmachine-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "thoughtmachine.kotoba")
...
class ThoughtmachineContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
