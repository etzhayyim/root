"""
Py Kotodama WASM entrypoint for the Telegram_api clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "telegram_api-compat", "entities": ['Channel', 'Message', 'User', 'Room', 'Stream', 'Webhook']}, 200
