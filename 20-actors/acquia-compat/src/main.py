"""
Py Kotodama WASM entrypoint for the Acquia clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "acquia-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
