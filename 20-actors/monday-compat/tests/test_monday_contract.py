"""
Contract test for the monday-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "monday.kotoba")
ENTITIES = ['Board', 'Item', 'Column', 'Group', 'User', 'Update']
PLURALS = {'Board': 'boards', 'Item': 'items', 'Column': 'columns', 'Group': 'groups', 'User': 'users', 'Update': 'updates'}


class MondayContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['boardKind', 'state', 'type']:
