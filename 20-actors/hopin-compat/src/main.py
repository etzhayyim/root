"""
Py Kotodama WASM entrypoint for the Hopin clean-room actor.
...
def delete_event(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hopin.Event", "id": eid})
...
def delete_ticket(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hopin.Ticket", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_attendee(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hopin.Attendee", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_donor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hopin.Donor", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_donation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hopin.Donation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_membership(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"hopin.Membership", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "hopin-compat", "entities": ['Event', 'Ticket', 'Attendee', 'Donor', 'Donation', 'Membership']}, 200
