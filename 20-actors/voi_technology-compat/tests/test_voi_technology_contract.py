"""
Contract test for the voi_technology-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "voi_technology.kotoba")
ENTITIES = ['Driver', 'Rider', 'Trip', 'Vehicle', 'Fare', 'Rating']
PLURALS = {'Driver': 'drivers', 'Rider': 'riders', 'Trip': 'trips', 'Vehicle': 'vehicles', 'Fare': 'fares', 'Rating': 'ratings'}


class VoiTechnologyContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
