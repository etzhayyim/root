"""
Py Kotodama WASM entrypoint for the Apigee clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "apigee-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
