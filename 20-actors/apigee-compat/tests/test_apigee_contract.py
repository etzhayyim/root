"""
Contract test for the apigee-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "apigee.kotoba")
ENTITIES = ['Organization', 'Environment', 'ApiProxy', 'Deployment', 'DataCollector']
PLURALS = {'Organization': 'organizations', 'Environment': 'environments', 'ApiProxy': 'apiproxies', 'Deployment': 'deployments', 'DataCollector': 'datacollectors'}


class ApigeeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['apiProxyType', 'deploymentType', 'proxyDeploymentType', 'runtimeType', 'state', 'subscriptionType', 'type']:
