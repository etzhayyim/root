"""
Contract test for the airtable-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "airtable.kotoba")
ENTITIES = ['Base', 'Table', 'Field', 'Record', 'View', 'Comment']
PLURALS = {'Base': 'bases', 'Table': 'tables', 'Field': 'fields', 'Record': 'records', 'View': 'views', 'Comment': 'comments'}


class AirtableContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['permissionLevel', 'type']:
