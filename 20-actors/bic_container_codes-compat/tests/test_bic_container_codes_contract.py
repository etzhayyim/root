"""
Contract test for the bic_container_codes-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bic_container_codes.kotoba")
...
class BicContainerCodesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
