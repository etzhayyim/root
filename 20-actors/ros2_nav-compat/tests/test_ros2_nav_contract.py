"""
Contract test for the ros2_nav-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ros2_nav.kotoba")
ENTITIES = ['GoalStatus', 'NavSatFix', 'BatteryState', 'Odometry']
PLURALS = {'GoalStatus': 'goalstatuses', 'NavSatFix': 'navsatfixes', 'BatteryState': 'batterystates', 'Odometry': 'odometries'}


class Ros2NavContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['positionCovarianceType', 'powerSupplyHealth', 'powerSupplyStatus', 'status']:
