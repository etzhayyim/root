"""
Contract test for the relativity_ediscovery-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "relativity_ediscovery.kotoba")
...
class RelativityEdiscoveryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
