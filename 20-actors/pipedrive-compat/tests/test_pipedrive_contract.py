"""
Contract test for the pipedrive-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "pipedrive.kotoba")
ENTITIES = ['Deal', 'Person', 'Organization', 'Pipeline', 'Stage', 'Activity']
PLURALS = {'Deal': 'deals', 'Person': 'persons', 'Organization': 'organizations', 'Pipeline': 'pipelines', 'Stage': 'stages', 'Activity': 'activities'}


class PipedriveContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['marketingStatus', 'status']:
