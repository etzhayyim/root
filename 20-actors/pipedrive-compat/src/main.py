"""
Py Kotodama WASM entrypoint for the Pipedrive clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "pipedrive-compat", "entities": ['Account', 'Contact', 'Lead', 'Opportunity', 'Activity', 'Pipeline']}, 200
