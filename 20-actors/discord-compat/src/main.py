"""
Py Kotodama WASM entrypoint for the Discord clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "discord-compat", "entities": ['Channel', 'Message', 'User', 'Room', 'Stream', 'Webhook']}, 200
