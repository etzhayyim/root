"""
Py Kotodama WASM entrypoint for the Eurostat clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"eurostat.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def healthz(request):
    return {"status": "ok", "actor": "eurostat-compat", "entities": ['Filing', 'Citizen', 'Service', 'Application', 'Dataset', 'Identity']}, 200
