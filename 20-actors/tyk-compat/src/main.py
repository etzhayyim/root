"""
Py Kotodama WASM entrypoint for the Tyk clean-room actor.
...
def delete_service(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"tyk.Service", "id": eid})
...
def delete_deployment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"tyk.Deployment", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_secret(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"tyk.Secret", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_api_proxy(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"tyk.ApiProxy", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_database(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"tyk.Database", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_function(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"tyk.Function", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "tyk-compat", "entities": ['Service', 'Deployment', 'Secret', 'ApiProxy', 'Database', 'Function']}, 200
