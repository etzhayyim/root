"""
Contract test for the tokopedia-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "tokopedia.kotoba")
ENTITIES = ['User', 'Wallet', 'Merchant', 'RideOrder', 'FoodOrder', 'Payment']
PLURALS = {'User': 'users', 'Wallet': 'wallets', 'Merchant': 'merchants', 'RideOrder': 'rideorders', 'FoodOrder': 'foodorders', 'Payment': 'payments'}


class TokopediaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
