"""
Contract test for the gloriafoods-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "gloriafoods.kotoba")
ENTITIES = ['Order', 'Courier', 'Delivery', 'Merchant', 'Route', 'Tracking']
PLURALS = {'Order': 'orders', 'Courier': 'couriers', 'Delivery': 'deliveries', 'Merchant': 'merchants', 'Route': 'routes', 'Tracking': 'trackings'}


class GloriafoodsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
