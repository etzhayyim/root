"""
Py Kotodama WASM entrypoint for the Isic_codes clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"isic_codes.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_code(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"isic_codes.Code", "id": eid})
...
def delete_unit(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"isic_codes.Unit", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_reference(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"isic_codes.Reference", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_mapping(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"isic_codes.Mapping", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_location(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"isic_codes.Location", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_epoch(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"isic_codes.Epoch", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "isic_codes-compat", "entities": ['Code', 'Unit', 'Reference', 'Mapping', 'Location', 'Epoch']}, 200
