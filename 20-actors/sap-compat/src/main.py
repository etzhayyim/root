"""
Py Kotodama WASM entrypoint for the Sap clean-room actor.
...
def delete_g_l_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sap.GLAccount", "id": eid})
...
def delete_journal_entry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sap.JournalEntry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_invoice(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sap.Invoice", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_purchase_order(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sap.PurchaseOrder", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_vendor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sap.Vendor", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_cost_center(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sap.CostCenter", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "sap-compat", "entities": ['GLAccount', 'JournalEntry', 'Invoice', 'PurchaseOrder', 'Vendor', 'CostCenter']}, 200
