"""
Py Kotodama WASM entrypoint for the Redis clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "redis-compat", "entities": ['Dataset', 'Query', 'Dashboard', 'Report', 'Connection', 'Metric']}, 200
