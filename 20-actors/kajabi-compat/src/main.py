"""
Py Kotodama WASM entrypoint for the Kajabi clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "kajabi-compat", "entities": ['Event', 'Ticket', 'Attendee', 'Donor', 'Donation', 'Membership']}, 200
