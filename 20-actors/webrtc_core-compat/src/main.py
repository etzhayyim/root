"""
Py Kotodama WASM entrypoint for the Webrtc_core clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "webrtc_core-compat", "entities": ['Prefix', 'Route', 'Peer', 'Zone', 'Record', 'Tunnel']}, 200
