"""
Py Kotodama WASM entrypoint for the Entsoe clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"entsoe.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_meter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"entsoe.Meter", "id": eid})
...
def delete_reading(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"entsoe.Reading", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_node(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"entsoe.Node", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_load_forecast(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"entsoe.LoadForecast", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_market_bid(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"entsoe.MarketBid", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_tag(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"entsoe.Tag", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "entsoe-compat", "entities": ['Meter', 'Reading', 'Node', 'LoadForecast', 'MarketBid', 'Tag']}, 200
