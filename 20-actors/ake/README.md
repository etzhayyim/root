...
**93 tests green** — `./run_tests.sh` (incl. an 8-test G9 contributor-trajectory suite, a 5-test
genesis bridge over the REAL actor-profile SSoT, and a 9-test SSoT drift-lock).
