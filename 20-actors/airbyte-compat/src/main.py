"""
Py Kotodama WASM entrypoint for the Airbyte clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "airbyte-compat", "entities": ['Connector', 'Sync', 'Model', 'Stream', 'Schema', 'Test']}, 200
