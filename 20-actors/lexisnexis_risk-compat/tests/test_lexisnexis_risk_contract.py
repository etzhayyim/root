"""
Contract test for the lexisnexis_risk-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "lexisnexis_risk.kotoba")
...
class LexisnexisRiskContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
