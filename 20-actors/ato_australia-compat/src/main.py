"""
Py Kotodama WASM entrypoint for the Ato_australia clean-room actor.
...
def _persist(entity, rec):
    ...
    for k, v in rec.items():
        facts[f"ato_australia.{entity}/{k}"] = v
    db.transact([facts])
    return rec
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"ato_australia.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ato_australia.Filing", "id": eid})
...
def delete_corporation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ato_australia.Corporation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_disclosure(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ato_australia.Disclosure", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_citizen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ato_australia.Citizen", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_application(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ato_australia.Application", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ato_australia.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "ato_australia-compat", "entities": ['Filing', 'Corporation', 'Disclosure', 'Citizen', 'Application', 'Dataset']}, 200
