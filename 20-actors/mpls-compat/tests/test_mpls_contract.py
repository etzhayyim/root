"""
Contract test for the mpls-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mpls.kotoba")
ENTITIES = ['LabelStackEntry', 'MplsHeader', 'ReservedLabel', 'NhlfeOperation', 'MplsForwardingState']
PLURALS = {'LabelStackEntry': 'labelstackentries', 'MplsHeader': 'mplsheaders', 'ReservedLabel': 'reservedlabels', 'NhlfeOperation': 'nhlfeoperations', 'MplsForwardingState': 'mplsforwardingstates'}


class MplsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['operationType', 'tc', 'trafficClass', 'value']:
