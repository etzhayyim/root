"""
Py Kotodama WASM entrypoint for the Sentinelone clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sentinelone-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
