"""
Contract test for the datadog-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "datadog.kotoba")
ENTITIES = ['Monitor', 'Dashboard', 'TimeSeries', 'Event', 'Downtime', 'Incident']
PLURALS = {'Monitor': 'monitors', 'Dashboard': 'dashboards', 'TimeSeries': 'timeserieses', 'Event': 'events', 'Downtime': 'downtimes', 'Incident': 'incidents'}


class DatadogContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['alertType', 'layoutType', 'overallState', 'priority', 'severity', 'status', 'type']:
