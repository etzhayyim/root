"""
Contract test for the iers_earth_rotation-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "iers_earth_rotation.kotoba")
ENTITIES = ['EopRecord', 'BulletinBValues']
PLURALS = {'EopRecord': 'eoprecords', 'BulletinBValues': 'bulletinbvalueses'}


class IersEarthRotationContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['nutationFlag', 'polarMotionFlag', 'ut1Flag']:
