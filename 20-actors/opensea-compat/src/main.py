"""
Py Kotodama WASM entrypoint for the Opensea clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "opensea-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
