"""
Contract test for the nmea2000_marine-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "nmea2000_marine.kotoba")
...
class Nmea2000MarineContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
