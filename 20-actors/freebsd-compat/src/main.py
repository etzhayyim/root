"""
Py Kotodama WASM entrypoint for the Freebsd clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "freebsd-compat", "entities": ['Process', 'Thread', 'FileDescriptor', 'Syscall', 'MemoryRegion', 'Signal']}, 200
