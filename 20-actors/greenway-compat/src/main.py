"""
Py Kotodama WASM entrypoint for the Greenway clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"greenway.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_patient(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"greenway.Patient", "id": eid})
...
def delete_encounter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"greenway.Encounter", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"greenway.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_medication(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"greenway.Medication", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_practitioner(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"greenway.Practitioner", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_appointment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"greenway.Appointment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "greenway-compat", "entities": ['Patient', 'Encounter', 'Observation', 'Medication', 'Practitioner', 'Appointment']}, 200
