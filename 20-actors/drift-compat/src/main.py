"""
Py Kotodama WASM entrypoint for the Drift clean-room actor.
...
def delete_ticket(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drift.Ticket", "id": eid})
...
def delete_survey(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drift.Survey", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_response(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drift.Response", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drift.Account", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_conversation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drift.Conversation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_contact(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drift.Contact", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "drift-compat", "entities": ['Ticket', 'Survey', 'Response', 'Account', 'Conversation', 'Contact']}, 200
