"""
Contract test for the autodesk_bim360-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "autodesk_bim360.kotoba")
...
class AutodeskBim360Contract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
