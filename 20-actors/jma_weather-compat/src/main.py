"""
Py Kotodama WASM entrypoint for the Jma_weather clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "jma_weather-compat", "entities": ['Filing', 'Corporation', 'Disclosure', 'Citizen', 'Application', 'Dataset']}, 200
