"""
Contract test for the salesforce-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "salesforce.kotoba")
ENTITIES = ['Account', 'Contact', 'Lead', 'Opportunity', 'Case', 'Campaign', 'Task']
PLURALS = {'Account': 'accounts', 'Contact': 'contacts', 'Lead': 'leads', 'Opportunity': 'opportunities', 'Case': 'cases', 'Campaign': 'campaigns', 'Task': 'tasks'}


class SalesforceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
