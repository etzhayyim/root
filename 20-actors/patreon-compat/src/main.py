"""
Py Kotodama WASM entrypoint for the Patreon clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "patreon-compat", "entities": ['Event', 'Ticket', 'Attendee', 'Donor', 'Donation', 'Membership']}, 200
