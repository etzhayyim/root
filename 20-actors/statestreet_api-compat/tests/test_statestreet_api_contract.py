"""
Contract test for the statestreet_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "statestreet_api.kotoba")
...
class StatestreetApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
