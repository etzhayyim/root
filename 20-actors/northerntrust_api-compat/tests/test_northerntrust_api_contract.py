"""
Contract test for the northerntrust_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "northerntrust_api.kotoba")
...
class NortherntrustApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
