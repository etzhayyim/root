"""
Py Kotodama WASM entrypoint for the Ipv6_routing clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "ipv6_routing-compat", "entities": ['Prefix', 'Route', 'Peer', 'Zone', 'Record', 'Tunnel']}, 200
