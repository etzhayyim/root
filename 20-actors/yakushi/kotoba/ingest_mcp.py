#!/usr/bin/env python3
"""yakushi 薬師 — ingest seed.edn into a live kotoba node via MCP.

ADR-2605250500, migration plan Phase 3. Flattens each seed entity map into
...
Usage:
    python3 ingest_mcp.py [--url http://127.0.0.1:8077] [--graph com.etzhayyim.yakushi] [--dry-run]
"""
...
def main() -> int:
    ...
    ap.add_argument("--graph", default="com.etzhayyim.yakushi")
