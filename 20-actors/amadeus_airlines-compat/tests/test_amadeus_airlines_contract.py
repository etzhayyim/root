"""
Contract test for the amadeus_airlines-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "amadeus_airlines.kotoba")
...
class AmadeusAirlinesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
