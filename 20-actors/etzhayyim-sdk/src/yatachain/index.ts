/**
 * @etzhayyim/sdk/yatachain
 *
 * yatachain — Holochain-isomorphic substrate composition primitives.
 * Per ADR-2605231400 + [`10-protocol/yatachain/SPEC.md`](../../../../10-protocol/yatachain/SPEC.md).
 *
