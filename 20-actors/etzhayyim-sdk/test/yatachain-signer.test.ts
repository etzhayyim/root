/**
 * Tests for the yatachain production Ed25519 signer + verifier.
 *
 * Includes a cross-language interop assertion: a signature produced by
 * the Python `pymagatama.yatachain.make_ed25519_signer` over the same
...
} from "../src/yatachain/index.js";
import type { MembraneRule } from "../src/yatachain/index.js";
...
describe("cross-language Ed25519 interop", () => {
   ...
   * side produces the same (verified by `test_yatachain.py` →
