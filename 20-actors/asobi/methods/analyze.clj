;; ported from /Users/junkawasaki/github/com-junkawasaki/orgs/etzhayyim/root/20-actors/asobi/methods/analyze.py (unit_refactor stage 0)
;; asobi 遊び — edge-primary participation/enclosure analyzer over the freed-time graph.
(ns root.asobi.methods.analyze
  (:require [clojure.string :as str]
            [clojure.set :as set]
            [clojure.edn :as edn]))

(declare tok tokens atom end parse read-edn access-weight load analyze rank report-md main)
...
;; TODO: port-failed unit _atom (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmplozul3pg/scratch.clj:21:1: e)
;; def _atom(t: str):
;;     if t.startswith('"'):
...
;; TODO: port-failed unit _parse (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmp6jpyka67/scratch.clj:5:13: e)
;; def _parse(it):
;;     t = next(it)
;;     if t == '[':
;;         out = []
...
;; TODO: port-failed unit ACCESS_WEIGHT (bb-compile unmapped)
...
(def access-weight nil) ;; TODO: port-failed const

;; TODO: port-failed unit load (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmpmyvnp70g/scratch.clj:2:1: wa)
...
;; TODO: port-failed unit analyze (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmppmj276kz/scratch.clj:31:1: e)
...
;; TODO: port-failed unit report_md (asher: timed out)
