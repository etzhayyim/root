"""
Py Kotodama WASM entrypoint for the Mitre_attck clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "mitre_attck-compat", "entities": ['Indicator', 'Vulnerability', 'ThreatActor', 'Campaign', 'Host', 'Technique']}, 200
