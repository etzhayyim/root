"""
Contract test for the dji_onboard_sdk-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "dji_onboard_sdk.kotoba")
ENTITIES = ['Status', 'Battery', 'GlobalPosition', 'GPSDetail', 'FlightAnomaly']
PLURALS = {'Status': 'statuses', 'Battery': 'batteries', 'GlobalPosition': 'globalpositions', 'GPSDetail': 'gpsdetails', 'FlightAnomaly': 'flightanomalies'}


class DjiOnboardSdkContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
