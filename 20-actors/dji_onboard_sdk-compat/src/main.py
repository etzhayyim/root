"""
Py Kotodama WASM entrypoint for the Dji_onboard_sdk clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "dji_onboard_sdk-compat", "entities": ['Drone', 'Mission', 'Waypoint', 'Telemetry', 'Payload', 'Swarm']}, 200
