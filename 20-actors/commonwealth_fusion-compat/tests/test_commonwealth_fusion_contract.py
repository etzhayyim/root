"""
Contract test for the commonwealth_fusion-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "commonwealth_fusion.kotoba")
ENTITIES = ['Shot', 'Diagnostic', 'Coil', 'PlasmaState', 'Pulse', 'Sample']
PLURALS = {'Shot': 'shots', 'Diagnostic': 'diagnostics', 'Coil': 'coils', 'PlasmaState': 'plasmastates', 'Pulse': 'pulses', 'Sample': 'samples'}


class CommonwealthFusionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
