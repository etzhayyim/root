"""
Py Kotodama WASM entrypoint for the Nasa_dsn clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"nasa_dsn.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_object(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nasa_dsn.Object", "id": eid})
...
def delete_position(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nasa_dsn.Position", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nasa_dsn.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_scene(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nasa_dsn.Scene", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_float(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nasa_dsn.Float", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_station(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"nasa_dsn.Station", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "nasa_dsn-compat", "entities": ['Object', 'Position', 'Observation', 'Scene', 'Float', 'Station']}, 200
