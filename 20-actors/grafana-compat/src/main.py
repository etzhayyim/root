"""
Py Kotodama WASM entrypoint for the Grafana clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "grafana-compat", "entities": ['Service', 'Error', 'Trace', 'Metric', 'Alert', 'Incident']}, 200
