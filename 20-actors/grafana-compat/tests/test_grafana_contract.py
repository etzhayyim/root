"""
Contract test for the grafana-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "grafana.kotoba")
ENTITIES = ['Dashboard', 'DataSource', 'Folder', 'AlertRule', 'User', 'Organization']
PLURALS = {'Dashboard': 'dashboards', 'DataSource': 'datasources', 'Folder': 'folders', 'AlertRule': 'alertrules', 'User': 'users', 'Organization': 'organizations'}


class GrafanaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
