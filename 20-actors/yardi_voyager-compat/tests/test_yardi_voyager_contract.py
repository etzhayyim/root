"""
Contract test for the yardi_voyager-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "yardi_voyager.kotoba")
ENTITIES = ['Listing', 'Property', 'Agent', 'Transaction', 'Lease', 'Tenant']
PLURALS = {'Listing': 'listings', 'Property': 'properties', 'Agent': 'agents', 'Transaction': 'transactions', 'Lease': 'leases', 'Tenant': 'tenants'}


class YardiVoyagerContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
