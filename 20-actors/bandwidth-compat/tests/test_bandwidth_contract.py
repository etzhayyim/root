"""
Contract test for the bandwidth-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bandwidth.kotoba")
ENTITIES = ['Message', 'Call', 'Conference', 'Recording']
PLURALS = {'Message': 'messages', 'Call': 'calls', 'Conference': 'conferences', 'Recording': 'recordings'}


class BandwidthContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['direction', 'fileFormat']:
