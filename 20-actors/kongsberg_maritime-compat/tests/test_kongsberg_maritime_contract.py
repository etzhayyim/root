"""
Contract test for the kongsberg_maritime-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "kongsberg_maritime.kotoba")
...
class KongsbergMaritimeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
