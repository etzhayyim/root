"""
Contract test for the terraform-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "terraform.kotoba")
ENTITIES = ['Run', 'Plan', 'Apply', 'Workspace', 'StateVersion', 'ConfigurationVersion']
PLURALS = {'Run': 'runs', 'Plan': 'plans', 'Apply': 'applies', 'Workspace': 'workspaces', 'StateVersion': 'stateversions', 'ConfigurationVersion': 'configurationversions'}


class TerraformContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['executionMode', 'status']:
