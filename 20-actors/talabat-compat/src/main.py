"""
Py Kotodama WASM entrypoint for the Talabat clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"talabat.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"talabat.Account", "id": eid})
...
def delete_contact(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"talabat.Contact", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_lead(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"talabat.Lead", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_opportunity(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"talabat.Opportunity", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_activity(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"talabat.Activity", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_pipeline(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"talabat.Pipeline", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "talabat-compat", "entities": ['Account', 'Contact', 'Lead', 'Opportunity', 'Activity', 'Pipeline']}, 200
