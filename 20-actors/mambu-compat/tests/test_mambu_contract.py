"""
Contract test for the mambu-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mambu.kotoba")
ENTITIES = ['LoanAccount', 'DepositAccount', 'Client', 'Group', 'LoanTransaction']
PLURALS = {'LoanAccount': 'loanaccounts', 'DepositAccount': 'depositaccounts', 'Client': 'clients', 'Group': 'groups', 'LoanTransaction': 'loantransactions'}


class MambuContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['accountHolderType', 'accountState', 'accountSubState', 'state', 'type']:
