"""
Py Kotodama WASM entrypoint for the Mambu clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "mambu-compat", "entities": ['Account', 'Loan', 'Policy', 'Claim', 'Transaction', 'Customer']}, 200
