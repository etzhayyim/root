"""
Contract test for the viewpoint_spectrum-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "viewpoint_spectrum.kotoba")
...
class ViewpointSpectrumContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
