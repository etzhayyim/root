"""
Contract test for the tokamak_energy-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "tokamak_energy.kotoba")
...
class TokamakEnergyContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
