"""
Contract test for the pingidentity-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "pingidentity.kotoba")
ENTITIES = ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']
PLURALS = {'Identity': 'identities', 'Policy': 'policies', 'Detection': 'detections', 'Incident': 'incidents', 'Asset': 'assets', 'Session': 'sessions'}


class PingidentityContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
