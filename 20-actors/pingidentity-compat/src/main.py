"""
Py Kotodama WASM entrypoint for the Pingidentity clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "pingidentity-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
