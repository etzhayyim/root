"""
Py Kotodama WASM entrypoint for the Fca_uk clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "fca_uk-compat", "entities": ['Filing', 'Citizen', 'Service', 'Application', 'Dataset', 'Identity']}, 200
