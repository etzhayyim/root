"""
Contract test for the siemens_simatic-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "siemens_simatic.kotoba")
...
class SiemensSimaticContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
