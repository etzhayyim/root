"""
Contract test for the mastercard_banknet-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mastercard_banknet.kotoba")
...
class MastercardBanknetContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
