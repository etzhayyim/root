"""
Contract test for the duckcreek_policy-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "duckcreek_policy.kotoba")
...
class DuckcreekPolicyContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
