"""
Py Kotodama WASM entrypoint for the Pinecone clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "pinecone-compat", "entities": ['Model', 'Completion', 'Embedding', 'FineTune', 'Dataset', 'File']}, 200
