"""
Contract test for the epic_online_services-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "epic_online_services.kotoba")
ENTITIES = ['Player', 'Session', 'Match', 'Leaderboard', 'Inventory', 'Achievement']
PLURALS = {'Player': 'players', 'Session': 'sessions', 'Match': 'matches', 'Leaderboard': 'leaderboards', 'Inventory': 'inventories', 'Achievement': 'achievements'}


class EpicOnlineServicesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
