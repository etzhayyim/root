"""
Contract test for the jpo_patents-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "jpo_patents.kotoba")
ENTITIES = ['Application', 'Grant', 'Surveillance', 'Measurement', 'Patent', 'Trial']
PLURALS = {'Application': 'applications', 'Grant': 'grants', 'Surveillance': 'surveillances', 'Measurement': 'measurements', 'Patent': 'patents', 'Trial': 'trials'}


class JpoPatentsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
