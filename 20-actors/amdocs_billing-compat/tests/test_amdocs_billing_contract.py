"""
Contract test for the amdocs_billing-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "amdocs_billing.kotoba")
...
class AmdocsBillingContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
