"""
Contract test for the mailchimp-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mailchimp.kotoba")
ENTITIES = ['List', 'ListMember', 'Campaign', 'Template', 'Segment', 'Automation']
PLURALS = {'List': 'lists', 'ListMember': 'listmembers', 'Campaign': 'campaigns', 'Template': 'templates', 'Segment': 'segments', 'Automation': 'automations'}


class MailchimpContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['contentType', 'emailType', 'status', 'type']:
