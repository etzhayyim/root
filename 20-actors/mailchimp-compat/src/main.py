"""
Py Kotodama WASM entrypoint for the Mailchimp clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "mailchimp-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
