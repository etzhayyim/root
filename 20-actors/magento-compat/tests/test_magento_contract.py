"""
Contract test for the magento-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "magento.kotoba")
ENTITIES = ['Order', 'Product', 'Customer', 'Category', 'Invoice', 'Shipment']
PLURALS = {'Order': 'orders', 'Product': 'products', 'Customer': 'customers', 'Category': 'categories', 'Invoice': 'invoices', 'Shipment': 'shipments'}


class MagentoContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['state', 'status', 'visibility']:
