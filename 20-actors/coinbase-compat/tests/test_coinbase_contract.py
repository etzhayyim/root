"""
Contract test for the coinbase-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "coinbase.kotoba")
ENTITIES = ['Order', 'Fill', 'Account', 'Product', 'Portfolio', 'PortfolioPosition']
PLURALS = {'Order': 'orders', 'Fill': 'fills', 'Account': 'accounts', 'Product': 'products', 'Portfolio': 'portfolios', 'PortfolioPosition': 'portfoliopositions'}


class CoinbaseContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
