"""
Py Kotodama WASM entrypoint for the Coinbase clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "coinbase-compat", "entities": ['Account', 'Card', 'Transaction', 'Order', 'Wallet', 'Ledger']}, 200
