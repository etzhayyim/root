"""
Contract test for the aws_braket-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "aws_braket.kotoba")
ENTITIES = ['ExecutionWindow', 'DeviceServiceProperties', 'TaskMetadata']
PLURALS = {'ExecutionWindow': 'executionwindows', 'DeviceServiceProperties': 'deviceservicepropertieses', 'TaskMetadata': 'taskmetadatas'}


class AwsBraketContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
