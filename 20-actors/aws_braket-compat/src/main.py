"""
Py Kotodama WASM entrypoint for the Aws_braket clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "aws_braket-compat", "entities": ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']}, 200
