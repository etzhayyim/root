...
ENTITIES = ['Entry', 'Asset', 'ContentType', 'Space', 'Environment', 'Locale']
PLURALS = {'Entry': 'entries', 'Asset': 'assets', 'ContentType': 'contenttypes', 'Space': 'spaces', 'Environment': 'environments', 'Locale': 'locales'}
