"""
Contract test for the niantic_lightship-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "niantic_lightship.kotoba")
...
class NianticLightshipContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
