"""
Py Kotodama WASM entrypoint for the Niantic_lightship clean-room actor.
...
def _persist(entity, rec):
    ...
    for k, v in rec.items():
        facts[f"niantic_lightship.{entity}/{k}"] = v
    db.transact([facts])
    return rec
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"niantic_lightship.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_anchor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"niantic_lightship.Anchor", "id": eid})
...
def delete_scene(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"niantic_lightship.Scene", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_mesh(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"niantic_lightship.Mesh", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_session(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"niantic_lightship.Session", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_asset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"niantic_lightship.Asset", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_device(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"niantic_lightship.Device", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "niantic_lightship-compat", "entities": ['Anchor', 'Scene', 'Mesh', 'Session', 'Asset', 'Device']}, 200
