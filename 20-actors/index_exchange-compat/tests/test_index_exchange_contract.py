"""
Contract test for the index_exchange-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "index_exchange.kotoba")
...
class IndexExchangeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
