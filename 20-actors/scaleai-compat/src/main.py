"""
Py Kotodama WASM entrypoint for the Scaleai clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"scaleai.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_model(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"scaleai.Model", "id": eid})
...
def delete_completion(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"scaleai.Completion", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_embedding(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"scaleai.Embedding", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_fine_tune(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"scaleai.FineTune", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"scaleai.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_file(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"scaleai.File", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "scaleai-compat", "entities": ['Model', 'Completion', 'Embedding', 'FineTune', 'Dataset', 'File']}, 200
