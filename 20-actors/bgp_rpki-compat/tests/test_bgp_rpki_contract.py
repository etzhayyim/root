"""
Contract test for the bgp_rpki-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bgp_rpki.kotoba")
ENTITIES = ['RouteOriginAuthorization', 'ValidationResult', 'RpkiToRouterPdu', 'PrefixPdu']
PLURALS = {'RouteOriginAuthorization': 'routeoriginauthorizations', 'ValidationResult': 'validationresults', 'RpkiToRouterPdu': 'rpkitorouterpdus', 'PrefixPdu': 'prefixpdus'}


class BgpRpkiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['pduType', 'validationState']:
