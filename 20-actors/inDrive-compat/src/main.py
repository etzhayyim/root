"""
Py Kotodama WASM entrypoint for the Indrive clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"indrive.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_driver(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"indrive.Driver", "id": eid})
...
def delete_rider(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"indrive.Rider", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_trip(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"indrive.Trip", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_vehicle(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"indrive.Vehicle", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_fare(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"indrive.Fare", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_rating(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"indrive.Rating", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "inDrive-compat", "entities": ['Driver', 'Rider', 'Trip', 'Vehicle', 'Fare', 'Rating']}, 200
