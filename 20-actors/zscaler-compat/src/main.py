"""
Py Kotodama WASM entrypoint for the Zscaler clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "zscaler-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
