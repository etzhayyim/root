"""
Py Kotodama WASM entrypoint for the Cftc clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "cftc-compat", "entities": ['Account', 'Consent', 'Transaction', 'PaymentInitiation', 'Institution', 'Filing']}, 200
