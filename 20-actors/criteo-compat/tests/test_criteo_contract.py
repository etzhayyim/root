"""
Contract test for the criteo-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "criteo.kotoba")
ENTITIES = ['Ad', 'Campaign', 'AdSet']
PLURALS = {'Ad': 'ads', 'Campaign': 'campaigns', 'AdSet': 'adsets'}


class CriteoContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['deliveryStatus', 'frequency', 'goal', 'inventoryType']:
