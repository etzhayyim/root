"""
Py Kotodama WASM entrypoint for the Criteo clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "criteo-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
