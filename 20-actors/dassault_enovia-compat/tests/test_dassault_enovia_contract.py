"""
Contract test for the dassault_enovia-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "dassault_enovia.kotoba")
...
class DassaultEnoviaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
