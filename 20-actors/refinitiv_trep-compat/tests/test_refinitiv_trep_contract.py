"""
Contract test for the refinitiv_trep-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "refinitiv_trep.kotoba")
ENTITIES = ['Instrument', 'Quote', 'Order', 'Execution', 'MarketData', 'Position']
PLURALS = {'Instrument': 'instruments', 'Quote': 'quotes', 'Order': 'orders', 'Execution': 'executions', 'MarketData': 'marketdatas', 'Position': 'positions'}


class RefinitivTrepContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
