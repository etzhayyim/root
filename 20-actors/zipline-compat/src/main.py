"""
Py Kotodama WASM entrypoint for the Zipline clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"zipline.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_drone(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zipline.Drone", "id": eid})
...
def delete_mission(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zipline.Mission", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_waypoint(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zipline.Waypoint", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_telemetry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zipline.Telemetry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_payload(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zipline.Payload", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_swarm(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zipline.Swarm", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "zipline-compat", "entities": ['Drone', 'Mission', 'Waypoint', 'Telemetry', 'Payload', 'Swarm']}, 200
