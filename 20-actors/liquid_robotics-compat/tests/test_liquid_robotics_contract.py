"""
Contract test for the liquid_robotics-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "liquid_robotics.kotoba")
...
class LiquidRoboticsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
