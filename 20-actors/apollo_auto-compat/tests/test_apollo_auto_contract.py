"""
Contract test for the apollo_auto-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "apollo_auto.kotoba")
ENTITIES = ['Chassis', 'PerceptionObstacle', 'ADCTrajectory', 'LocalizationStatus']
PLURALS = {'Chassis': 'chassises', 'PerceptionObstacle': 'perceptionobstacles', 'ADCTrajectory': 'adctrajectories', 'LocalizationStatus': 'localizationstatuses'}


class ApolloAutoContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['drivingMode', 'frontBumperEvent', 'fusionStatus', 'rightOfWayStatus']:
