"""
Contract test for the imo_dangerous_goods-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "imo_dangerous_goods.kotoba")
...
class ImoDangerousGoodsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
