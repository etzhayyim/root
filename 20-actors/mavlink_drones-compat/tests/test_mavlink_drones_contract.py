"""
Contract test for the mavlink_drones-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mavlink_drones.kotoba")
...
class MavlinkDronesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
