"""
Contract test for the shippo-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "shippo.kotoba")
ENTITIES = ['Address', 'Parcel', 'Shipment', 'Rate', 'Transaction', 'TrackingStatus']
PLURALS = {'Address': 'addresses', 'Parcel': 'parcels', 'Shipment': 'shipments', 'Rate': 'rates', 'Transaction': 'transactions', 'TrackingStatus': 'trackingstatuses'}


class ShippoContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['distanceUnit', 'massUnit', 'objectState', 'status']:
