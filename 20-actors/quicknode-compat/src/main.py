"""
Py Kotodama WASM entrypoint for the Quicknode clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"quicknode.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_block(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"quicknode.Block", "id": eid})
...
def delete_transaction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"quicknode.Transaction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_contract(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"quicknode.Contract", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"quicknode.Account", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_event(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"quicknode.Event", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_token(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"quicknode.Token", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "quicknode-compat", "entities": ['Block', 'Transaction', 'Contract', 'Account', 'Event', 'Token']}, 200
