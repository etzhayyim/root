"""
Contract test for the csg_international-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "csg_international.kotoba")
ENTITIES = ['Subscriber', 'Session', 'Message', 'Number', 'Terminal', 'UsageRecord']
PLURALS = {'Subscriber': 'subscribers', 'Session': 'sessions', 'Message': 'messages', 'Number': 'numbers', 'Terminal': 'terminals', 'UsageRecord': 'usagerecords'}


class CsgInternationalContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
