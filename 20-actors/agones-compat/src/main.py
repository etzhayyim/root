"""
Py Kotodama WASM entrypoint for the Agones clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "agones-compat", "entities": ['Player', 'Session', 'Match', 'Leaderboard', 'Inventory', 'Achievement']}, 200
