...
ENTITIES = ['GameServer', 'GameServerPort', 'Fleet', 'SdkServer']
PLURALS = {'GameServer': 'gameservers', 'GameServerPort': 'gameserverports', 'Fleet': 'fleets', 'SdkServer': 'sdkservers'}
...
class AgonesContract(unittest.TestCase):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['logLevel', 'portPolicy', 'state']:
