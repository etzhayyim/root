"""
Contract test for the ads_b_aviation-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ads_b_aviation.kotoba")
...
class AdsBAviationContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
