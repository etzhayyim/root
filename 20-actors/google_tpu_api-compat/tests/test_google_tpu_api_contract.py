"""
Contract test for the google_tpu_api-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "google_tpu_api.kotoba")
...
class GoogleTpuApiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
