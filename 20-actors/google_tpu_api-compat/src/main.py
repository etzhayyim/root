"""
Py Kotodama WASM entrypoint for the Google_tpu_api clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "google_tpu_api-compat", "entities": ['Device', 'Kernel', 'MemoryAlloc', 'InferenceJob', 'Engine', 'Utilization']}, 200
