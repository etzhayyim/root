"""
Contract test for the argo_ocean_floats-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "argo_ocean_floats.kotoba")
ENTITIES = ['Profile', 'Measurement', 'Calibration']
PLURALS = {'Profile': 'profiles', 'Measurement': 'measurements', 'Calibration': 'calibrations'}


class ArgoOceanFloatsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['dataMode', 'direction', 'positionQc', 'presQc', 'psalQc', 'tempQc']:
