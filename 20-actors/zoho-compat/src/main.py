"""
Py Kotodama WASM entrypoint for the Zoho clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "zoho-compat", "entities": ['Account', 'Contact', 'Lead', 'Opportunity', 'Activity', 'Pipeline']}, 200
