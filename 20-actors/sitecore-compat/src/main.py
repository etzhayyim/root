"""
Py Kotodama WASM entrypoint for the Sitecore clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"sitecore.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_asset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sitecore.Asset", "id": eid})
...
def delete_rendition(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sitecore.Rendition", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_channel(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sitecore.Channel", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_playlist(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sitecore.Playlist", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_content_entry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sitecore.ContentEntry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_experiment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sitecore.Experiment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "sitecore-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
