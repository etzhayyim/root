"""
Contract test for the palantir_gotham-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "palantir_gotham.kotoba")
...
class PalantirGothamContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
