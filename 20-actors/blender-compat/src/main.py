"""
Py Kotodama WASM entrypoint for the Blender clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "blender-compat", "entities": ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']}, 200
