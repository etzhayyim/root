"""
Py Kotodama WASM entrypoint for the Mavlink_swarm clean-room actor.
...
def delete_drone(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mavlink_swarm.Drone", "id": eid})
...
def delete_mission(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mavlink_swarm.Mission", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_waypoint(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mavlink_swarm.Waypoint", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_telemetry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mavlink_swarm.Telemetry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_payload(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mavlink_swarm.Payload", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_swarm(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mavlink_swarm.Swarm", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "mavlink_swarm-compat", "entities": ['Drone', 'Mission', 'Waypoint', 'Telemetry', 'Payload', 'Swarm']}, 200
