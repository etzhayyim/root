"""
Py Kotodama WASM entrypoint for the Ebi clean-room actor.
...
def delete_patient(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ebi.Patient", "id": eid})
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ebi.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_condition(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ebi.Condition", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_diagnostic_report(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ebi.DiagnosticReport", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_sequence(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ebi.Sequence", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_specimen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"ebi.Specimen", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "ebi-compat", "entities": ['Patient', 'Observation', 'Condition', 'DiagnosticReport', 'Sequence', 'Specimen']}, 200
