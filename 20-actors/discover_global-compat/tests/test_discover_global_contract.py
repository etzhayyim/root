"""
Contract test for the discover_global-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "discover_global.kotoba")
...
class DiscoverGlobalContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
