#!/usr/bin/env python3
"""kasa 嵩 — minimal EDN-subset reader (stdlib only).
...
Sufficient for reading data/seed-compute-capacity.kotoba.edn and the generated
*.kotoba.edn outputs.
...
its own substrate without a third-party EDN dependency. ADR-2606072000.
"""
