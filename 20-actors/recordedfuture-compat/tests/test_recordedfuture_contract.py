"""
Contract test for the recordedfuture-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "recordedfuture.kotoba")
...
class RecordedfutureContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
