"""
Py Kotodama WASM entrypoint for the Clearwater clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "clearwater-compat", "entities": ['Account', 'Loan', 'Policy', 'Claim', 'Transaction', 'Customer']}, 200
