"""
Contract test for the huggingface-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "huggingface.kotoba")
ENTITIES = ['ModelInfo', 'DatasetInfo', 'SpaceInfo', 'TransformersInfo']
PLURALS = {'ModelInfo': 'modelinfos', 'DatasetInfo': 'datasetinfos', 'SpaceInfo': 'spaceinfos', 'TransformersInfo': 'transformersinfos'}


class HuggingfaceContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
