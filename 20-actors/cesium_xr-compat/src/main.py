"""
Py Kotodama WASM entrypoint for the Cesium_xr clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "cesium_xr-compat", "entities": ['Anchor', 'Scene', 'Mesh', 'Session', 'Asset', 'Device']}, 200
