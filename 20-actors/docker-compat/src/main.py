"""
Py Kotodama WASM entrypoint for the Docker clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "docker-compat", "entities": ['Repository', 'Pipeline', 'Build', 'Artifact', 'Deployment', 'Webhook']}, 200
