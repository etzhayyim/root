...
// imports.go — WIT canonical ABI import declarations for magatama:{core,auth,messaging,storage,agent,workflow,observability,forms}@1.0.0.
//
// The import names use the full WIT interface path (magatama:{domain}/{iface}).
// wasm-tools component embed maps these to the WIT interfaces in magatama.wit.
//
...
//go:wasmimport magatama:core/log@1.0.0 append
//go:noescape
...
//go:wasmimport magatama:core/outbound-http@1.0.0 send
//go:noescape
...
func (t *wasmOutboundTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	if req.Body != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("magatama: read body: %w", err)
		}
		req.Body.Close()
	}
	...
	if readI32(ret[:], 0) != 0 { // err
		return nil, fmt.Errorf("magatama: outbound-http: %s", readString(ret[:], 4))
	}
	...
	if errStr := readString(ret[:], 24); errStr != "" {
		return nil, fmt.Errorf("magatama: outbound-http response: %s", errStr)
	}
...
//go:wasmimport magatama:core/cypher@1.0.0 query
//go:noescape
...
// ── magatama:core/cypher batch-exec ────────────────────────────────────

//go:wasmimport magatama:core/cypher@1.0.0 batch-exec
//go:noescape
...
// ── magatama:core/config ───────────────────────────────────────────────

//go:wasmimport magatama:core/config@1.0.0 get
//go:noescape
...
//go:wasmimport magatama:auth/authn@1.0.0 verify-token
//go:noescape
func wasm_authn_verify_token(tokenPtr, tokenLen, retPtr int32)

//go:wasmimport magatama:auth/authn@1.0.0 resolve-context
//go:noescape
...
//go:wasmimport magatama:auth/authn@1.0.0 ensure-active-session
//go:noescape
...
//go:wasmimport magatama:auth/authz@1.0.0 enforce
//go:noescape
...
//go:wasmimport magatama:storage/cdn@1.0.0 upload-image
//go:noescape
...
//go:wasmimport magatama:storage/static-site@1.0.0 put
//go:noescape
func wasm_static_site_put(pathPtr, pathLen, dataPtr, dataLen, ctPtr, ctLen, retPtr int32)

//go:wasmimport magatama:storage/static-site@1.0.0 delete
//go:noescape
func wasm_static_site_delete(pathPtr, pathLen, retPtr int32)

//go:wasmimport magatama:storage/static-site@1.0.0 list-files
//go:noescape
...
//go:wasmimport magatama:storage/ipfs@1.0.0 publish
//go:noescape
func wasm_ipfs_publish(dataPtr, dataLen, ctPtr, ctLen, retPtr int32)

//go:wasmimport magatama:storage/ipfs@1.0.0 publish-url
//go:noescape
func wasm_ipfs_publish_url(dataPtr, dataLen, ctPtr, ctLen, retPtr int32)

//go:wasmimport magatama:storage/ipfs@1.0.0 gateway-url
//go:noescape
...
// ── magatama:messaging/signal-session ──────────────────────────────────────
//
...
//go:wasmimport magatama:messaging/signal-session@1.0.0 group-get-or-create
//go:noescape
...
//go:wasmimport magatama:messaging/signal-session@1.0.0 group-encrypt
//go:noescape
func wasm_signal_session_group_encrypt(groupIDPtr, groupIDLen, plaintextPtr, plaintextLen, retPtr int32)

//go:wasmimport magatama:messaging/signal-session@1.0.0 group-decrypt
//go:noescape
...
//go:wasmimport magatama:messaging/signal-session@1.0.0 group-add-member
//go:noescape
...
//go:wasmimport magatama:agent/agent@1.0.0 register-tools
//go:noescape
func wasm_agent_register_tools(toolsPtr, toolsLen int32)

//go:wasmimport magatama:agent/agent@1.0.0 chat
//go:noescape
func wasm_agent_chat(msgPtr, msgLen, ctxTag, ctxPtr, ctxLen, retPtr int32)

//go:wasmimport magatama:agent/agent@1.0.0 invoke-tool
//go:noescape
...
//go:wasmimport magatama:workflow/workflow@1.0.0 get
//go:noescape
func wasm_workflow_get(wfIdPtr, wfIdLen, retPtr int32)

//go:wasmimport magatama:workflow/workflow@1.0.0 pause
//go:noescape
func wasm_workflow_pause(wfIdPtr, wfIdLen, retPtr int32)

//go:wasmimport magatama:workflow/workflow@1.0.0 resume
//go:noescape
func wasm_workflow_resume(wfIdPtr, wfIdLen, retPtr int32)

//go:wasmimport magatama:workflow/workflow@1.0.0 terminate
//go:noescape
func wasm_workflow_terminate(wfIdPtr, wfIdLen, retPtr int32)

//go:wasmimport magatama:workflow/workflow@1.0.0 purge
//go:noescape
func wasm_workflow_purge(wfIdPtr, wfIdLen, retPtr int32)

//go:wasmimport magatama:workflow/workflow@1.0.0 raise-event
//go:noescape
func wasm_workflow_raise_event(wfIdPtr, wfIdLen, evtNamePtr, evtNameLen, payloadPtr, payloadLen, retPtr int32)

//go:wasmimport magatama:workflow/workflow@1.0.0 create-timer
//go:noescape
...
// ── magatama:workflow/reminder (v1.0.0) ────────────────────────

//go:wasmimport magatama:workflow/reminder@1.0.0 get
//go:noescape
...
// ── magatama:workflow/timer ──────────────────────────────────────────────

//go:wasmimport magatama:workflow/timer@1.0.0 register
//go:noescape
...
//go:wasmimport magatama:workflow/timer@1.0.0 unregister
//go:noescape
...
// ── magatama:agent/governance@1.0.0 ─────────────────────────────────────

//go:wasmimport magatama:agent/governance@1.0.0 register-manifest
//go:noescape
func wasm_governance_register_manifest(jsonPtr, jsonLen, retPtr int32)

//go:wasmimport magatama:agent/governance@1.0.0 check-policy
//go:noescape
...
// ── magatama:auth/crypto@1.0.0 ────────────────────────────────────────

//go:wasmimport magatama:auth/crypto@1.0.0 sha256
//go:noescape
func wasm_crypto_sha256(dataPtr, dataLen, retPtr int32)

//go:wasmimport magatama:auth/crypto@1.0.0 sha256-hex
//go:noescape
...
// ── magatama:agent/agent (v1.0.0 route) ────────────────────────────────
...
func AgentRoute(input string) ([]RouteMatch, string) {
	...
	resp, err := http.Post(
		"http://magatama.internal/agent/route",
		"application/json",
...
// ── magatama:agent/agent (v1.0.0 react) ────────────────────────────────
...
func AgentReact(task string, options ReactOptions) (ReactResult, string) {
	...
	resp, err := http.Post(
		"http://magatama.internal/agent/react",
		"application/json",
		bytes.NewReader(reqBody),
	)
	if err != nil {
...
// ── magatama:workflow/activity-parallel ───────────────────────────────────
...
func ActivitySpawnParallel(items []ActivityParallelItem) (string, string) {
	...
	resp, err := http.Post(
		"http://magatama.internal/activity/spawn-parallel",
		"application/json",
		bytes.NewReader(reqBody),
	)
	if err != nil {
...
func ActivityAwaitAll(batchID string, timeoutMs uint64) ([]ParallelActivityResult, string) {
	...
	resp, err := http.Post(
		"http://magatama.internal/activity/await-all",
		"application/json",
		bytes.NewReader(reqBody),
	)
	if err != nil {
...
// ── magatama:agent/agent (v1.0.0 converse) ────────────────────────────

//go:wasmimport magatama:agent/agent@1.0.0 converse
//go:noescape
...
// Routes through outbound-http to magatama.internal/agent/converse (host intercepts).
func AgentConverse(messages []Message, options ChatOptions) (ChatResponse, string) {
	...
	resp, err := http.Post(
		"http://magatama.internal/agent/converse",
		"application/json",
		bytes.NewReader(reqBody),
	)
	if err != nil {
...
//go:wasmimport magatama:messaging/smtp@1.0.0 connect
//go:noescape
...
// ── magatama:observability/telemetry ──────────────────────────────────────────

//go:wasmimport magatama:observability/telemetry@1.0.0 counter-add
//go:noescape
func wasm_telemetry_counter_add(namePtr, nameLen int32, value uint64, attrsPtr, attrsLen int32)

//go:wasmimport magatama:observability/telemetry@1.0.0 gauge-set
//go:noescape
func wasm_telemetry_gauge_set(namePtr, nameLen int32, value uint64, attrsPtr, attrsLen int32)

//go:wasmimport magatama:observability/telemetry@1.0.0 histogram-record
//go:noescape
...
// ── magatama:observability/access-log ────────────────────────────────────────

//go:wasmimport magatama:observability/access-log@1.0.0 list-entries
//go:noescape
func wasm_access_log_list_entries(offset, limit, retPtr int32)

//go:wasmimport magatama:observability/access-log@1.0.0 page-views
//go:noescape
func wasm_access_log_page_views(sinceMs, untilMs uint64, retPtr int32)

//go:wasmimport magatama:observability/access-log@1.0.0 list-query-stats
//go:noescape
func wasm_access_log_list_query_stats(offset, limit, retPtr int32)

//go:wasmimport magatama:observability/access-log@1.0.0 list-ips
//go:noescape
func wasm_access_log_list_ips(offset, limit, retPtr int32)

//go:wasmimport magatama:observability/access-log@1.0.0 total-requests
//go:noescape
...
// ── magatama:observability/secrets ──────────────────────────────────────────────

//go:wasmimport magatama:observability/secrets@1.0.0 get
//go:noescape
func wasm_secrets_get(storePtr, storeLen, namePtr, nameLen, retPtr int32)

//go:wasmimport magatama:observability/secrets@1.0.0 set
//go:noescape
func wasm_secrets_set(storePtr, storeLen, namePtr, nameLen, valPtr, valLen, retPtr int32)

//go:wasmimport magatama:observability/secrets@1.0.0 delete
//go:noescape
func wasm_secrets_delete(storePtr, storeLen, namePtr, nameLen, retPtr int32)

//go:wasmimport magatama:observability/secrets@1.0.0 list-names
//go:noescape
...
// ── magatama:workflow/lock ─────────────────────────────────────────────────

//go:wasmimport magatama:workflow/lock@1.0.0 try-lock
//go:noescape
func wasm_lock_try_lock(namePtr, nameLen, ownerPtr, ownerLen int32, ttlMsLo, ttlMsHi, retPtr int32)

//go:wasmimport magatama:workflow/lock@1.0.0 unlock
//go:noescape
func wasm_lock_unlock(namePtr, nameLen, tokenPtr, tokenLen, retPtr int32)

//go:wasmimport magatama:workflow/lock@1.0.0 renew
//go:noescape
...
// ── magatama:workflow/virtual-actor ────────────────────────────────────────

//go:wasmimport magatama:workflow/virtual-actor@1.0.0 register-actor-type
//go:noescape
func wasm_va_register(typePtr, typeLen, methodsPtr, methodsLen int32, idleMsLo, idleMsHi, reentrancy, maxQueue, retPtr int32)

//go:wasmimport magatama:workflow/virtual-actor@1.0.0 invoke
//go:noescape
func wasm_va_invoke(typePtr, typeLen, idPtr, idLen, methodPtr, methodLen, payloadPtr, payloadLen, retPtr int32)

//go:wasmimport magatama:workflow/virtual-actor@1.0.0 list-active
//go:noescape
func wasm_va_list_active(typePtr, typeLen, retPtr int32)

//go:wasmimport magatama:workflow/virtual-actor@1.0.0 deactivate
//go:noescape
func wasm_va_deactivate(typePtr, typeLen, idPtr, idLen, retPtr int32)

//go:wasmimport magatama:workflow/virtual-actor@1.0.0 schedule-method
//go:noescape
...
//go:wasmimport magatama:workflow/virtual-actor@1.0.0 cancel-schedule
//go:noescape
...
// ── magatama:messaging/conversation ──────────────────────────────────────────

//go:wasmimport magatama:messaging/conversation@1.0.0 create-session
//go:noescape
func wasm_conversation_create_session(topicPtr, topicLen, participantsPtr, participantsLen, retPtr int32)

//go:wasmimport magatama:messaging/conversation@1.0.0 send-message
//go:noescape
...
//go:wasmimport magatama:messaging/conversation@1.0.0 get-history
//go:noescape
func wasm_conversation_get_history(sessionPtr, sessionLen, offset, limit, retPtr int32)

//go:wasmimport magatama:messaging/conversation@1.0.0 get-session
//go:noescape
func wasm_conversation_get_session(sessionPtr, sessionLen, retPtr int32)

//go:wasmimport magatama:messaging/conversation@1.0.0 list-sessions
//go:noescape
func wasm_conversation_list_sessions(offset, limit, retPtr int32)

//go:wasmimport magatama:messaging/conversation@1.0.0 close-session
//go:noescape
...
// ── magatama:agent/identity ──────────────────────────────────────────────

//go:wasmimport magatama:agent/identity@1.0.0 register
//go:noescape
func wasm_identity_register(cardJsonPtr, cardJsonLen, retPtr int32)

//go:wasmimport magatama:agent/identity@1.0.0 resolve
//go:noescape
func wasm_identity_resolve(nanoidPtr, nanoidLen, retPtr int32)

//go:wasmimport magatama:agent/identity@1.0.0 resolve-address
//go:noescape
func wasm_identity_resolve_address(addrPtr, addrLen, retPtr int32)

//go:wasmimport magatama:agent/identity@1.0.0 list-actors
//go:noescape
...
// ── magatama:agent/capability ───────────────────────────────────────────

//go:wasmimport magatama:agent/capability@1.0.0 declare
//go:noescape
func wasm_capability_declare(capJsonPtr, capJsonLen, retPtr int32)

//go:wasmimport magatama:agent/capability@1.0.0 revoke
//go:noescape
func wasm_capability_revoke(idPtr, idLen, retPtr int32)

//go:wasmimport magatama:agent/capability@1.0.0 list-own
//go:noescape
func wasm_capability_list_own(retPtr int32)

//go:wasmimport magatama:agent/capability@1.0.0 discover
//go:noescape
