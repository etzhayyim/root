// Package magatama provides WIT Component Model bindings for magatama:{core,auth,messaging,storage,agent,workflow,observability,forms}@1.0.0.
...
// JSON fields match Rust IdentityClaims serialization in magatama-engine.
...
// API mirrors magatama:core/http-handler#handle (WIT Component Model).
//
...
// Called by the magatama host for each commit matching the configured collections.
//
//	func init() {
//	    magatama.HandleWCommit(func(c magatama.WCommit) error {
//	        // process commit
//	        return nil
//	    })
//	}
...
// In TinyGo WASM mode: routes through magatama:core/outbound-http WIT import
