...
def delete_asset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"vimeo.Asset", "id": eid})
...
def delete_rendition(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"vimeo.Rendition", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_playlist(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"vimeo.Playlist", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_content_entry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"vimeo.ContentEntry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_experiment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"vimeo.Experiment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "vimeo-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
