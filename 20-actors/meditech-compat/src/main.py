"""
Py Kotodama WASM entrypoint for the Meditech clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"meditech.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_patient(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"meditech.Patient", "id": eid})
...
def delete_encounter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"meditech.Encounter", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"meditech.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_medication(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"meditech.Medication", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_practitioner(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"meditech.Practitioner", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_appointment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"meditech.Appointment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "meditech-compat", "entities": ['Patient', 'Encounter', 'Observation', 'Medication', 'Practitioner', 'Appointment']}, 200
