...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (90 procs; :civil 36 + :labor 23 + :housing 10 + :enforcement 8 + :insolvency 6 + :family 7 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**)
...
python3 tests/test_terms.py && python3 tests/test_respond.py \
  && python3 tests/test_coverage.py  # 84 green
```
