...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (37 procs; :civil 27 + :labor 3 解雇 + :housing 4 立退き + :enforcement 3 差押え防御 jp/us/de)
...
python3 tests/test_terms.py && python3 tests/test_respond.py \
  && python3 tests/test_coverage.py  # 54 green
```
