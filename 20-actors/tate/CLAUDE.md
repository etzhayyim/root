...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (115 procs; :civil 36 + :labor 29 + :housing 17 + :enforcement 14 + :insolvency 9 + :family 10 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**)
...
python3 tests/test_terms.py && python3 tests/test_respond.py \
  && python3 tests/test_coverage.py  # 102 green
```
