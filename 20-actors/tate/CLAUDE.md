...
**Jurisdictions (R1)**: `:jp :us :eu :uk :de :kr :fr :au :ca :it :es :nl :br` — representative 13 of ~193
...
│   ├── clause-patterns.edn        # jurisdiction-keyed clause registry (38 shapes, 13 juris)
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (19 procs)
