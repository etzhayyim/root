...
│   ├── clause-patterns.edn        # jurisdiction-keyed clause registry (126 shapes, 30 juris — 25 法域が ≥4 patterns、:uk 3、:eu 2(メタ); :clause/source-url 一次ソース URL を verified entry に記録, coverage が provenance gap を可視化)
