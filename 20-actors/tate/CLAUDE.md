...
**Jurisdictions (R1)**: `:jp :us :eu :uk :de :kr :fr :au :ca :it :es :nl :br :tw :sg :in :cn :pl :se :at :pt :ie :ch` — representative 23 of ~193, plus `us-states.edn` (10/50 州: CA/NY/TX/FL/WA/IL/PA/OH/GA/NC — :us 通知に州が分かれば州規則を開示追記、州不明は honest degrade)
...
│   ├── clause-patterns.edn        # jurisdiction-keyed clause registry (58 shapes, 23 juris)
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (42 procs; :civil 29 + :labor 3 解雇 + :housing 4 立退き + :enforcement 3 差押え防御 + :insolvency 3 債権者側倒産対応)
...
python3 tests/test_terms.py && python3 tests/test_respond.py \
  && python3 tests/test_coverage.py  # 56 green
```
