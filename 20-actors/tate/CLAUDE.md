...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (181 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 29 + :insolvency 29 + :family 29 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**; :dl/source-url 一次ソース URL を verified deadline-rule に記録 — proc-level provenance 74/181 (rule-level 97)、:jp + :de + :uk + :fr + :kr + :it + :es + :nl + :au + :ca 完備 (10 法域)、:pl は ISAP (Kodeks pracy WDU19740240141 / KPC WDU19640430296) で裏取り開始 (残 ustawa o ochronie praw lokatorów/Prawo upadłościowe)、法令単位で back-fill 継続)
