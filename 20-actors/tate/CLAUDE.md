...
│   ├── clause-patterns.edn        # jurisdiction-keyed clause registry (92 shapes, 30 juris; :clause/source-url 一次ソース URL を verified entry に記録, coverage が provenance gap を可視化)
