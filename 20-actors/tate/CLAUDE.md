...
**Jurisdictions (R1)**: `:jp :us :eu :uk :de :kr :fr :au :ca :it :es :nl :br :tw :sg :in :cn :pl :se :at :pt :ie :ch :dk :fi :no :mx :be :ar` — representative 29 of ~193, plus `us-states.edn` (15/50 州: CA/NY/TX/FL/WA/IL/PA/OH/GA/NC/NJ/VA/MA/CO/MN — :us 通知に州が分かれば州規則を開示追記、州不明は honest degrade)
...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (63 procs; :civil 35 + :labor 6 + :housing 6 + :enforcement 5 + :insolvency 5 + :family 5 — track×juris matrix in coverage report)
...
python3 tests/test_terms.py && python3 tests/test_respond.py \
  && python3 tests/test_coverage.py  # 65 green
```
