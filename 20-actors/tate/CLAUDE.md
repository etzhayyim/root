...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (181 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 29 + :insolvency 29 + :family 29 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**; :dl/source-url 一次ソース URL を verified deadline-rule に記録 — proc-level provenance 34/181 (rule-level 47)、:jp + :de + :uk + :fr の anchor 付き全 rule が公式 (e-Gov / gesetze-im-internet.de / legislation.gov.uk / justice.gov.uk / Légifrance) で裏取り完備、次は他法域を法令単位で back-fill)
