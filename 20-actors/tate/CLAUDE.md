...
│   ├── clause-patterns.edn        # jurisdiction-keyed clause registry (127 shapes, 30 juris — 実 R1 法域は :us(3) 以外すべて ≥4、:eu 2(越境 instruments メタ); :clause/source-url 一次ソース URL を verified entry に記録, coverage が provenance gap を可視化)
