...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (34 procs; :civil 27 + :labor 3 解雇 + :housing 4 立退き jp/de/uk/us)
...
python3 tests/test_terms.py && python3 tests/test_respond.py \
  && python3 tests/test_coverage.py  # 52 green
```
