...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (181 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 29 + :insolvency 29 + :family 29 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**; :dl/source-url 一次ソース URL を verified deadline-rule に記録 — proc-level provenance 114/181 (rule-level 141、63%)、:jp + :de + :uk + :fr + :kr + :it + :es + :nl + :au + :ca + :pl + :at + :ch 完備 (13 法域) + :in/:tw/:sg/:be/:cn/:se/:fi/:no 進行、:nz は NZ Legislation (Employment Relations Act 2000/0024 / Residential Tenancies Act 1986/0120) で裏取り開始 (残 Disputes Tribunal Act/Companies Act/Care of Children Act/District Court Act)、法令単位で back-fill 継続)
