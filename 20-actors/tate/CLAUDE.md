...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (175 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 27 + :insolvency 26 + :family 28 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**)
