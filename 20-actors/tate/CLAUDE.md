...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (181 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 29 + :insolvency 29 + :family 29 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**; :dl/source-url 一次ソース URL を verified deadline-rule に記録 — proc-level provenance 16/181 (rule-level 22)、:jp anchor 付き全 proc が e-Gov 公式で裏取り済み (民訴法・労基法・行審法・行訴法・借地借家法・民事執行法・破産法・家事事件手続法)、次は他法域を法令単位で back-fill)
