...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (181 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 29 + :insolvency 29 + :family 29 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**; :dl/source-url 一次ソース URL を verified deadline-rule に記録 — proc-level provenance 84/181 (rule-level 108)、:jp + :de + :uk + :fr + :kr + :it + :es + :nl + :au + :ca + :pl + :at 完備 (12 法域)、:ie は Irish Statute Book (UDA 1977 No.10 / RTA 2004 No.27 / Companies Act 2014 No.38) で裏取り開始 (残 District/Circuit Court Rules・Enforcement of Court Orders Act 1926)、法令単位で back-fill 継続)
