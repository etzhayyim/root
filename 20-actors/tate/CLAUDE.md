...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (181 procs; :civil 36 + :labor 29 + :housing 29 + :enforcement 29 + :insolvency 29 + :family 29 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**; :dl/source-url 一次ソース URL を verified deadline-rule に記録 — proc-level provenance 101/181 (rule-level 126、56%)、:jp + :de + :uk + :fr + :kr + :it + :es + :nl + :au + :ca + :pl + :at + :ch 完備 (13 法域) + :in/:tw 進行、:sg は Singapore Statutes Online (ECA2016 / WC1961) で裏取り開始 (残 IRDA 2018/Small Claims Tribunals Act/Conveyancing Act/SCJA)、法令単位で back-fill 継続)
