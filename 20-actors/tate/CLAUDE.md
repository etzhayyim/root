...
**Jurisdictions (R1)**: `:jp :us :eu :uk :de :kr :fr :au :ca :it :es :nl :br :tw :sg :in` — representative 16 of ~193
...
│   ├── clause-patterns.edn        # jurisdiction-keyed clause registry (44 shapes, 16 juris)
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (22 procs)
