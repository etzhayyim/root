...
│   ├── procedure-registry.edn     # jurisdiction-keyed procedure registry (152 procs; :civil 36 + :labor 29 + :housing 20 + :enforcement 20 + :insolvency 26 + :family 21 — track×juris matrix; fake-guard 語彙 registry 自動導出; :dl/critical 期限先頭表示; **非civil全手続きに protective 選択肢必在**)
