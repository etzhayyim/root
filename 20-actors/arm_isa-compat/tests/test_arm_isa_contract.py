"""
Contract test for the arm_isa-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "arm_isa.kotoba")
ENTITIES = ['ConditionCode', 'ExceptionLevel', 'PrivilegeModel']
PLURALS = {'ConditionCode': 'conditioncodes', 'ExceptionLevel': 'exceptionlevels', 'PrivilegeModel': 'privilegemodels'}


class ArmIsaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
