"""
Py Kotodama WASM entrypoint for the Arm_isa clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "arm_isa-compat", "entities": ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']}, 200
