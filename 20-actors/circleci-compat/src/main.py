"""
Py Kotodama WASM entrypoint for the Circleci clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "circleci-compat", "entities": ['Repository', 'Pipeline', 'Build', 'Artifact', 'Deployment', 'Webhook']}, 200
