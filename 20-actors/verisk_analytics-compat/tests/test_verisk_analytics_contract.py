"""
Contract test for the verisk_analytics-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "verisk_analytics.kotoba")
...
class VeriskAnalyticsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
