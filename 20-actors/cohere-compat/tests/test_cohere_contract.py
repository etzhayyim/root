"""
Contract test for the cohere-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "cohere.kotoba")
ENTITIES = ['Dataset', 'DatasetPart', 'Model']
PLURALS = {'Dataset': 'datasets', 'DatasetPart': 'datasetparts', 'Model': 'models'}


class CohereContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['datasetType', 'validationStatus']:
