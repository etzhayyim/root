"""
Contract test for the rockwell_factorytalk-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "rockwell_factorytalk.kotoba")
...
class RockwellFactorytalkContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
