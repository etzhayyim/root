"""
Contract test for the invision-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "invision.kotoba")
ENTITIES = ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']
PLURALS = {'Project': 'projects', 'File': 'files', 'Frame': 'frames', 'Component': 'components', 'Comment': 'comments', 'Export': 'exports'}


class InvisionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
