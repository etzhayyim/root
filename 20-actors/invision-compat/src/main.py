"""
Py Kotodama WASM entrypoint for the Invision clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"invision.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_project(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"invision.Project", "id": eid})
...
def delete_file(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"invision.File", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_frame(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"invision.Frame", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_component(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"invision.Component", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_comment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"invision.Comment", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_export(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"invision.Export", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "invision-compat", "entities": ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']}, 200
