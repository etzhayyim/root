"""
Py Kotodama WASM entrypoint for the Sbb_swiss clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"sbb_swiss.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_stop(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sbb_swiss.Stop", "id": eid})
...
def delete_route(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sbb_swiss.Route", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_trip(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sbb_swiss.Trip", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_vehicle(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sbb_swiss.Vehicle", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_service_alert(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sbb_swiss.ServiceAlert", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_fare(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"sbb_swiss.Fare", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "sbb_swiss-compat", "entities": ['Stop', 'Route', 'Trip', 'Vehicle', 'ServiceAlert', 'Fare']}, 200
