"""
Contract test for the brightcove-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "brightcove.kotoba")
ENTITIES = ['Video', 'IngestJobStatus', 'Playlist', 'AudioTrack']
PLURALS = {'Video': 'videos', 'IngestJobStatus': 'ingestjobstatuses', 'Playlist': 'playlists', 'AudioTrack': 'audiotracks'}


class BrightcoveContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['deliveryType', 'economics', 'state', 'type', 'variant']:
