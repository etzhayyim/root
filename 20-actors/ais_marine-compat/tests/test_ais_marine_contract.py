"""
Contract test for the ais_marine-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ais_marine.kotoba")
ENTITIES = ['Message', 'PositionReport', 'BaseStationReport', 'StaticVoyageData', 'AidToNavigationReport']
PLURALS = {'Message': 'messages', 'PositionReport': 'positionreports', 'BaseStationReport': 'basestationreports', 'StaticVoyageData': 'staticvoyagedatas', 'AidToNavigationReport': 'aidtonavigationreports'}


class AisMarineContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['maneuverIndicator', 'messageType', 'navigationStatus', 'typeOfAid', 'typeOfEpfd']:
