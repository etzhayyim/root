"""
Contract test for the diebold_nixdorf-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "diebold_nixdorf.kotoba")
...
class DieboldNixdorfContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
