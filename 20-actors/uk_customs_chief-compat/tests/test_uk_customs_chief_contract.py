"""
Contract test for the uk_customs_chief-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "uk_customs_chief.kotoba")
ENTITIES = ['Declaration', 'Shipment', 'Manifest', 'Tariff', 'Permit', 'Party']
PLURALS = {'Declaration': 'declarations', 'Shipment': 'shipments', 'Manifest': 'manifests', 'Tariff': 'tariffs', 'Permit': 'permits', 'Party': 'parties'}


class UkCustomsChiefContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
