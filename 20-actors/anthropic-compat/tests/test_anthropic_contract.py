"""
Contract test for the anthropic-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "anthropic.kotoba")
ENTITIES = ['Model', 'Message', 'Conversation', 'Tool', 'ToolUse', 'Batch', 'File']
PLURALS = {'Model': 'models', 'Message': 'messages', 'Conversation': 'conversations', 'Tool': 'tools', 'ToolUse': 'tooluses', 'Batch': 'batches', 'File': 'files'}


class AnthropicContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
