"""
Py Kotodama WASM entrypoint for the Mas_singapore clean-room actor.
...
def _persist(entity, rec):
    ...
    for k, v in rec.items():
        facts[f"mas_singapore.{entity}/{k}"] = v
    db.transact([facts])
    return rec
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"mas_singapore.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mas_singapore.Account", "id": eid})
...
def delete_consent(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mas_singapore.Consent", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_transaction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mas_singapore.Transaction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_payment_initiation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mas_singapore.PaymentInitiation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_institution(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mas_singapore.Institution", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"mas_singapore.Filing", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "mas_singapore-compat", "entities": ['Account', 'Consent', 'Transaction', 'PaymentInitiation', 'Institution', 'Filing']}, 200
