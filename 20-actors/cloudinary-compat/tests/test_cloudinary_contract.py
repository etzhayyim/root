"""
Contract test for the cloudinary-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "cloudinary.kotoba")
ENTITIES = ['Resource', 'Folder', 'Transformation', 'UploadPreset', 'Tag']
PLURALS = {'Resource': 'resources', 'Folder': 'folders', 'Transformation': 'transformations', 'UploadPreset': 'uploadpresets', 'Tag': 'tags'}


class CloudinaryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['resourceType', 'type']:
