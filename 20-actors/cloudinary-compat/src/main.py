"""
Py Kotodama WASM entrypoint for the Cloudinary clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "cloudinary-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
