"""
Py Kotodama WASM entrypoint for the Metagpt clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"metagpt.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_agent(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"metagpt.Agent", "id": eid})
...
def delete_task(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"metagpt.Task", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_message(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"metagpt.Message", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_tool(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"metagpt.Tool", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_memory(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"metagpt.Memory", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_plan(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"metagpt.Plan", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "metagpt-compat", "entities": ['Agent', 'Task', 'Message', 'Tool', 'Memory', 'Plan']}, 200
