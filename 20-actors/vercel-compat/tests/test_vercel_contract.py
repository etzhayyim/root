"""
Contract test for the vercel-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "vercel.kotoba")
ENTITIES = ['Deployment', 'Project', 'Domain', 'Alias', 'Team']
PLURALS = {'Deployment': 'deployments', 'Project': 'projects', 'Domain': 'domains', 'Alias': 'aliases', 'Team': 'teams'}


class VercelContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['readyState', 'redirectStatusCode', 'serviceType', 'target']:
