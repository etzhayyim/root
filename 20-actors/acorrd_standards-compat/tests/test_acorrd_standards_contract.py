"""
Contract test for the acorrd_standards-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "acorrd_standards.kotoba")
...
class AcorrdStandardsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
