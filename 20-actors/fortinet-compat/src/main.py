"""
Py Kotodama WASM entrypoint for the Fortinet clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "fortinet-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
