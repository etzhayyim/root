"""
Contract test for the dbt-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "dbt.kotoba")
ENTITIES = ['Node', 'Source', 'RunResult']
PLURALS = {'Node': 'nodes', 'Source': 'sources', 'RunResult': 'runresults'}


class DbtContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
