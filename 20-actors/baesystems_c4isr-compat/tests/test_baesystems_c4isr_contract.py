"""
Contract test for the baesystems_c4isr-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "baesystems_c4isr.kotoba")
ENTITIES = ['Case', 'Party', 'Document', 'Incident', 'Watchlist', 'Sanction']
PLURALS = {'Case': 'cases', 'Party': 'parties', 'Document': 'documents', 'Incident': 'incidents', 'Watchlist': 'watchlists', 'Sanction': 'sanctions'}


class BaesystemsC4isrContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
