"""
Py Kotodama WASM entrypoint for the Eclinicalworks clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "eclinicalworks-compat", "entities": ['Patient', 'Encounter', 'Observation', 'Medication', 'Practitioner', 'Appointment']}, 200
