"""
Contract test for the qualcomm_snapdragon_spaces-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "qualcomm_snapdragon_spaces.kotoba")
ENTITIES = ['Anchor', 'Scene', 'Mesh', 'Session', 'Asset', 'Device']
PLURALS = {'Anchor': 'anchors', 'Scene': 'scenes', 'Mesh': 'meshes', 'Session': 'sessions', 'Asset': 'assets', 'Device': 'devices'}


class QualcommSnapdragonSpacesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
