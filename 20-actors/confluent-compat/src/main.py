"""
Py Kotodama WASM entrypoint for the Confluent clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"confluent.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_connector(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"confluent.Connector", "id": eid})
...
def delete_sync(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"confluent.Sync", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_model(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"confluent.Model", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_stream(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"confluent.Stream", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_schema(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"confluent.Schema", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_test(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"confluent.Test", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "confluent-compat", "entities": ['Connector', 'Sync', 'Model', 'Stream', 'Schema', 'Test']}, 200
