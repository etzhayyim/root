"""
Contract test for the autoware-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "autoware.kotoba")
ENTITIES = ['OperationModeState', 'RouteState', 'LocalizationInitializationState', 'MotionState', 'Gear']
PLURALS = {'OperationModeState': 'operationmodestates', 'RouteState': 'routestates', 'LocalizationInitializationState': 'localizationinitializationstates', 'MotionState': 'motionstates', 'Gear': 'gears'}


class AutowareContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['mode', 'state', 'status']:
