"""
Contract test for the secgov_edgar-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "secgov_edgar.kotoba")
ENTITIES = ['Filing', 'Entity', 'Dataset', 'Application', 'PublicRecord', 'Notice']
PLURALS = {'Filing': 'filings', 'Entity': 'entities', 'Dataset': 'datasets', 'Application': 'applications', 'PublicRecord': 'publicrecords', 'Notice': 'notices'}


class SecgovEdgarContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
