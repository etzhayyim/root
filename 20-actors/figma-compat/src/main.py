"""
Py Kotodama WASM entrypoint for the Figma clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "figma-compat", "entities": ['Project', 'File', 'Frame', 'Component', 'Comment', 'Export']}, 200
