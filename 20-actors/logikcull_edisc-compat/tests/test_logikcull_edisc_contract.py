"""
Contract test for the logikcull_edisc-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "logikcull_edisc.kotoba")
...
class LogikcullEdiscContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
