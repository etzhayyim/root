"""
Py Kotodama WASM entrypoint for the Onnx_runtime clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "onnx_runtime-compat", "entities": ['Device', 'Kernel', 'MemoryAlloc', 'InferenceJob', 'Engine', 'Utilization']}, 200
