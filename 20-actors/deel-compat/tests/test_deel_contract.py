"""
Contract test for the deel-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "deel.kotoba")
ENTITIES = ['Contract', 'Worker', 'Milestone', 'Timesheet', 'Payment']
PLURALS = {'Contract': 'contracts', 'Worker': 'workers', 'Milestone': 'milestones', 'Timesheet': 'timesheets', 'Payment': 'payments'}


class DeelContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['entityType', 'status', 'type']:
