"""
Contract test for the materials_project-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "materials_project.kotoba")
ENTITIES = ['Substance', 'Compound', 'Structure', 'Material', 'Standard', 'Property']
PLURALS = {'Substance': 'substances', 'Compound': 'compounds', 'Structure': 'structures', 'Material': 'materials', 'Standard': 'standards', 'Property': 'properties'}


class MaterialsProjectContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
