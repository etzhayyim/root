...
def delete_encounter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drchrono.Encounter", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_observation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drchrono.Observation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_medication(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drchrono.Medication", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_practitioner(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"drchrono.Practitioner", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def healthz(request):
    return {"status": "ok", "actor": "drchrono-compat", "entities": ['Patient', 'Encounter', 'Observation', 'Medication', 'Practitioner', 'Appointment']}, 200
