"""
Contract test for the bentley_projectwise-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "bentley_projectwise.kotoba")
...
class BentleyProjectwiseContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
