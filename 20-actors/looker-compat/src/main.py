"""
Py Kotodama WASM entrypoint for the Looker clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "looker-compat", "entities": ['Dataset', 'Query', 'Dashboard', 'Report', 'Connection', 'Metric']}, 200
