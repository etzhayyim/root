"""
Contract test for the universal_robots-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "universal_robots.kotoba")
...
class UniversalRobotsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
