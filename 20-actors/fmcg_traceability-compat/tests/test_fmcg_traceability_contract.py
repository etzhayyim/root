"""
Contract test for the fmcg_traceability-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "fmcg_traceability.kotoba")
...
class FmcgTraceabilityContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
