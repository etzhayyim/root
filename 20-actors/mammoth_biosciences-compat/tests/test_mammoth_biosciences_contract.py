"""
Contract test for the mammoth_biosciences-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mammoth_biosciences.kotoba")
ENTITIES = ['Strain', 'Construct', 'Sequence', 'Assay', 'Sample', 'Workflow']
PLURALS = {'Strain': 'strains', 'Construct': 'constructs', 'Sequence': 'sequences', 'Assay': 'assays', 'Sample': 'samples', 'Workflow': 'workflows'}


class MammothBiosciencesContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
