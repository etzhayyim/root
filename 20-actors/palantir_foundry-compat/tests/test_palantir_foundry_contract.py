"""
Contract test for the palantir_foundry-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "palantir_foundry.kotoba")
...
class PalantirFoundryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
