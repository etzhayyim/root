"""
Contract test for the ntp_time-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "ntp_time.kotoba")
ENTITIES = ['Packet', 'Header', 'KissCode']
PLURALS = {'Packet': 'packets', 'Header': 'headers', 'KissCode': 'kisscodes'}


class NtpTimeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['leapIndicator', 'mode', 'version']:
