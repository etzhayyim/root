"""
Py Kotodama WASM entrypoint for the Posix clean-room actor.
...
def delete_process(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"posix.Process", "id": eid})
...
def delete_thread(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"posix.Thread", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_file_descriptor(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"posix.FileDescriptor", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_syscall(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"posix.Syscall", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_memory_region(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"posix.MemoryRegion", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_signal(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"posix.Signal", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "posix-compat", "entities": ['Process', 'Thread', 'FileDescriptor', 'Syscall', 'MemoryRegion', 'Signal']}, 200
