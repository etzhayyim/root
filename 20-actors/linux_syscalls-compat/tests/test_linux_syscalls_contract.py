"""
Contract test for the linux_syscalls-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "linux_syscalls.kotoba")
...
class LinuxSyscallsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
