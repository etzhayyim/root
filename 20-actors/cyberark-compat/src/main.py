"""
Py Kotodama WASM entrypoint for the Cyberark clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "cyberark-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
