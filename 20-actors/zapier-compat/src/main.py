"""
Py Kotodama WASM entrypoint for the Zapier clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"zapier.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_flow(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zapier.Flow", "id": eid})
...
def delete_step(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zapier.Step", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_connection(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zapier.Connection", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_run(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zapier.Run", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_app(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zapier.App", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_webhook(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"zapier.Webhook", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "zapier-compat", "entities": ['Flow', 'Step', 'Connection', 'Run', 'App', 'Webhook']}, 200
