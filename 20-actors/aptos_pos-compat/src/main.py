"""
Py Kotodama WASM entrypoint for the Aptos_pos clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "aptos_pos-compat", "entities": ['Product', 'Variant', 'Order', 'LineItem', 'Customer', 'Collection']}, 200
