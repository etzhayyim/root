"""
Contract test for the apple_visionos-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "apple_visionos.kotoba")
...
class AppleVisionosContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
