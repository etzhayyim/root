"""
Py Kotodama WASM entrypoint for the Apple_visionos clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "apple_visionos-compat", "entities": ['Anchor', 'Scene', 'Mesh', 'Session', 'Asset', 'Device']}, 200
