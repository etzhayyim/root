"""
Py Kotodama WASM entrypoint for the Wing_delivery clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "wing_delivery-compat", "entities": ['Drone', 'Mission', 'Waypoint', 'Telemetry', 'Payload', 'Swarm']}, 200
