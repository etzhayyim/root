"""
Contract test for the planview_innotas-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "planview_innotas.kotoba")
...
class PlanviewInnotasContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
