"""
Contract test for the first_light_fusion-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "first_light_fusion.kotoba")
...
class FirstLightFusionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
