"""
Contract test for the smart_meter_dms-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "smart_meter_dms.kotoba")
...
class SmartMeterDmsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
