"""
Py Kotodama WASM entrypoint for the Lattice clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "lattice-compat", "entities": ['Employee', 'Candidate', 'JobReq', 'PayrollRun', 'TimeOff', 'Review']}, 200
