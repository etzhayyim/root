"""
Contract test for the guidewire_rating-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "guidewire_rating.kotoba")
...
class GuidewireRatingContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
