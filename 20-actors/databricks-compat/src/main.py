"""
Py Kotodama WASM entrypoint for the Databricks clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "databricks-compat", "entities": ['Dataset', 'Query', 'Dashboard', 'Report', 'Connection', 'Metric']}, 200
