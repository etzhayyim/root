"""
Contract test for the databricks-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "databricks.kotoba")
ENTITIES = ['Cluster', 'Job', 'Run', 'Warehouse', 'ObjectInfo']
PLURALS = {'Cluster': 'clusters', 'Job': 'jobs', 'Run': 'runs', 'Warehouse': 'warehouses', 'ObjectInfo': 'objectinfos'}


class DatabricksContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['language', 'objectType', 'state', 'warehouseType']:
