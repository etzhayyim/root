"""
Contract test for the synopsys_eda-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "synopsys_eda.kotoba")
ENTITIES = ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']
PLURALS = {'Register': 'registers', 'Instruction': 'instructions', 'Qubit': 'qubits', 'Circuit': 'circuits', 'Gate': 'gates', 'Job': 'jobs'}


class SynopsysEdaContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
