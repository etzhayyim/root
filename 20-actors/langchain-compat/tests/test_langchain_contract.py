"""
Contract test for the langchain-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "langchain.kotoba")
ENTITIES = ['BaseMessage', 'AIMessage', 'ToolMessage', 'ToolCall', 'UsageMetadata', 'LogEntry']
PLURALS = {'BaseMessage': 'basemessages', 'AIMessage': 'aimessages', 'ToolMessage': 'toolmessages', 'ToolCall': 'toolcalls', 'UsageMetadata': 'usagemetadatas', 'LogEntry': 'logentries'}


class LangchainContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
