"""
Py Kotodama WASM entrypoint for the Langchain clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "langchain-compat", "entities": ['Agent', 'Task', 'Message', 'Tool', 'Memory', 'Plan']}, 200
