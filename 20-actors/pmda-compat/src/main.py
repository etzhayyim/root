"""
Py Kotodama WASM entrypoint for the Pmda clean-room actor.
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pmda.Filing", "id": eid})
...
def delete_corporation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pmda.Corporation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_disclosure(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pmda.Disclosure", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_citizen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pmda.Citizen", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_application(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pmda.Application", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"pmda.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "pmda-compat", "entities": ['Filing', 'Corporation', 'Disclosure', 'Citizen', 'Application', 'Dataset']}, 200
