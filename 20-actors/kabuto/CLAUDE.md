...
Bounded illustrative seed of **1,586 real public companies** (incl. delisted retained as history) + **341 disclosed supplier edges** across
**15 sectors** and **100 countries** (growing each `/loop` iteration toward full global coverage) — **not** exhaustive coverage. HQ coordinates rounded to the campus/city. Supplier edges
