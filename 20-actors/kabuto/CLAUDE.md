...
Bounded illustrative seed of **252 real public companies** + **107 disclosed supplier edges** across
**15 sectors** and **41 countries** (growing each `/loop` iteration toward full global coverage) — **not** exhaustive coverage. HQ coordinates rounded to the campus/city. Supplier edges
