...
├── data/
│   ├── seed-public-companies.kotoba.edn  # 1,718 companies · 361 supply edges · 229 HQ · 127 contacts · 205 market caps · 2 BPMN seeds (:representative; grows each /loop)
...
- **1,718** public companies · **361** disclosed supply edges · **15** sectors · **115** countries · **229** HQ addresses · **205** market caps
  (growing each `/loop` iteration toward full global coverage — all 15 sectors balanced; 115 countries
...
- **Market-cap concentration** (8th metric): across the **205** caps publicly known (~$47T `:representative`),
  sector cap-HHI ≈ **0.15** — listed value concentrates in **software ~29% / semiconductors ~14% / consumer ~12%**.
