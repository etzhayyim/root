"""
Py Kotodama WASM entrypoint for the Sailpoint clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sailpoint-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
