"""
Contract test for the pulumi-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "pulumi.kotoba")
ENTITIES = ['Update', 'Stack', 'Policy', 'Deployment', 'Organization']
PLURALS = {'Update': 'updates', 'Stack': 'stacks', 'Policy': 'policies', 'Deployment': 'deployments', 'Organization': 'organizations'}


class PulumiContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['enforcementLevel', 'kind', 'result', 'severity', 'status']:
