"""
Py Kotodama WASM entrypoint for the Powerbi clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "powerbi-compat", "entities": ['Dataset', 'Query', 'Dashboard', 'Report', 'Connection', 'Metric']}, 200
