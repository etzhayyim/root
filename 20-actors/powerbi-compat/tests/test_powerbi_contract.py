"""
Contract test for the powerbi-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "powerbi.kotoba")
ENTITIES = ['Dataset', 'Report', 'Dashboard', 'Group', 'Tile', 'Gateway']
PLURALS = {'Dataset': 'datasets', 'Report': 'reports', 'Dashboard': 'dashboards', 'Group': 'groups', 'Tile': 'tiles', 'Gateway': 'gateways'}
...
class PowerbiContract(unittest.TestCase):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['contentProviderType', 'defaultDatasetStorageFormat', 'reportType']:
