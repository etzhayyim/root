...
SUITES=( "test_revenue_ledger.clj" "test_ingest.clj" "test_discrepancy.clj" "test_taxes.clj" "test_org_actor.clj" "test_coverage.clj" "test_registry_coverage.clj" "test_kotoba_bridge.clj" "test_budget_ledger.clj" "test_kotoba.clj" "test_autorun.clj" )
