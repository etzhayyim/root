...
SUITES=( "test_revenue_ledger.clj" "test_ingest.clj" "test_discrepancy.clj" "test_taxes.clj" "test_transfers.clj" "test_org_actor.clj" "test_coverage.clj" "test_lexicon.clj" "test_maturity.clj" "test_cofog_xcheck.clj" "test_autorun.clj" "test_freshness.clj" "test_honesty_adversarial.clj" "test_kotoba_bridge.clj" )
