...
(225 checks, green under `bb` and `clojure`). Coverage: **FY2022–2024 · 17 国税 + 12 地方税 · 9 組織-actor (+国→地方移転)**.
...
```bash
# tests (bb / clojure)  225 checks (ledger 25 + ingest 27 + discrepancy 21 + taxes 26 + transfers 20
#                                   + org-actor 25 + coverage 15 + lexicon 18 + maturity 15 + cofog-xcheck 6 + autorun 7 + bridge 20)
