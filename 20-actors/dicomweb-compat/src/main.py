"""
Py Kotodama WASM entrypoint for the Dicomweb clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "dicomweb-compat", "entities": ['Patient', 'Observation', 'Condition', 'DiagnosticReport', 'Sequence', 'Specimen']}, 200
