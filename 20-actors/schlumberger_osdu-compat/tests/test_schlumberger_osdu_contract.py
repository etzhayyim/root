"""
Contract test for the schlumberger_osdu-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "schlumberger_osdu.kotoba")
...
class SchlumbergerOsduContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
