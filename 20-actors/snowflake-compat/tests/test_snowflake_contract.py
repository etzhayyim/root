"""
Contract test for the snowflake-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "snowflake.kotoba")
ENTITIES = ['Warehouse', 'Database', 'Schema', 'Table', 'Task', 'Role']
PLURALS = {'Warehouse': 'warehouses', 'Database': 'databases', 'Schema': 'schemas', 'Table': 'tables', 'Task': 'tasks', 'Role': 'roles'}


class SnowflakeContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['kind', 'scalingPolicy', 'state', 'warehouseSize', 'warehouseType']:
