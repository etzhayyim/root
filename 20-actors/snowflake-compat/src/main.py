"""
Py Kotodama WASM entrypoint for the Snowflake clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "snowflake-compat", "entities": ['Dataset', 'Query', 'Dashboard', 'Report', 'Connection', 'Metric']}, 200
