"""
Py Kotodama WASM entrypoint for the Playfab clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"playfab.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_player(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"playfab.Player", "id": eid})
...
def delete_session(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"playfab.Session", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_match(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"playfab.Match", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_leaderboard(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"playfab.Leaderboard", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_inventory(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"playfab.Inventory", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_achievement(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"playfab.Achievement", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "playfab-compat", "entities": ['Player', 'Session', 'Match', 'Leaderboard', 'Inventory', 'Achievement']}, 200
