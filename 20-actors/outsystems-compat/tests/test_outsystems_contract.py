"""
Contract test for the outsystems-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "outsystems.kotoba")
ENTITIES = ['Flow', 'Step', 'Connection', 'Run', 'App', 'Webhook']
PLURALS = {'Flow': 'flows', 'Step': 'steps', 'Connection': 'connections', 'Run': 'runs', 'App': 'apps', 'Webhook': 'webhooks'}


class OutsystemsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
