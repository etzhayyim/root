"""
Py Kotodama WASM entrypoint for the Riscv_isa clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"riscv_isa.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_register(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"riscv_isa.Register", "id": eid})
...
def delete_instruction(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"riscv_isa.Instruction", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_qubit(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"riscv_isa.Qubit", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_circuit(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"riscv_isa.Circuit", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_gate(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"riscv_isa.Gate", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_job(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"riscv_isa.Job", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "riscv_isa-compat", "entities": ['Register', 'Instruction', 'Qubit', 'Circuit', 'Gate', 'Job']}, 200
