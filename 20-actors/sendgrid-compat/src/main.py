"""
Py Kotodama WASM entrypoint for the Sendgrid clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sendgrid-compat", "entities": ['Campaign', 'Audience', 'Event', 'Profile', 'Message', 'Funnel']}, 200
