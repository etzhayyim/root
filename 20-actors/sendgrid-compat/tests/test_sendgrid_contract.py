"""
Contract test for the sendgrid-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "sendgrid.kotoba")
ENTITIES = ['Contact', 'Template', 'SingleSend', 'Bounce', 'UnsubscribeGroup', 'Sender']
PLURALS = {'Contact': 'contacts', 'Template': 'templates', 'SingleSend': 'singlesends', 'Bounce': 'bounces', 'UnsubscribeGroup': 'unsubscribegroups', 'Sender': 'senders'}


class SendgridContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
