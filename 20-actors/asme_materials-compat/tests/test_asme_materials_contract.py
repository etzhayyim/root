"""
Contract test for the asme_materials-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "asme_materials.kotoba")
...
class AsmeMaterialsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
