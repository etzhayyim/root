"""
Contract test for the subcom_telemetry-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "subcom_telemetry.kotoba")
...
class SubcomTelemetryContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
