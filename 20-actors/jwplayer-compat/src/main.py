"""
Py Kotodama WASM entrypoint for the Jwplayer clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"jwplayer.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_asset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"jwplayer.Asset", "id": eid})
...
def delete_rendition(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"jwplayer.Rendition", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_channel(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"jwplayer.Channel", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_playlist(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"jwplayer.Playlist", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_content_entry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"jwplayer.ContentEntry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_experiment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"jwplayer.Experiment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "jwplayer-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
