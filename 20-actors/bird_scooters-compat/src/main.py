"""
Py Kotodama WASM entrypoint for the Bird_scooters clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "bird_scooters-compat", "entities": ['Driver', 'Rider', 'Trip', 'Vehicle', 'Fare', 'Rating']}, 200
