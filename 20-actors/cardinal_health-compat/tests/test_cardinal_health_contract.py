"""
Contract test for the cardinal_health-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "cardinal_health.kotoba")
...
class CardinalHealthContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
