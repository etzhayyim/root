;; ported from /Users/junkawasaki/github/com-junkawasaki/orgs/etzhayyim/root/20-actors/hoshimori/methods/coverage_report.py (unit_refactor stage 0)
;; hoshimori 星守 — orbital COVERAGE report (ADR-2606073600).
(ns root.hoshimori.methods.coverage-report
...
;; TODO: port-failed unit DENOMINATORS (judah: timed out)
;; DENOMINATORS = [
...
(def denominators nil) ;; TODO: port-failed const

;; TODO: port-failed unit report (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmpkt0csbm9/scratch.clj:3:8: er)
...
;; TODO: port-failed unit main (/var/folders/31/st4xq0g12v3cn1b9yg5zcrsm0000gn/T/tmpzbrxak8x/scratch.clj:3:15: w)
;; def main(argv):
