"""
Py Kotodama WASM entrypoint for the Macos_darwin clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "macos_darwin-compat", "entities": ['Process', 'Thread', 'FileDescriptor', 'Syscall', 'MemoryRegion', 'Signal']}, 200
