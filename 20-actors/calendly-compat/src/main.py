"""
Py Kotodama WASM entrypoint for the Calendly clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"calendly.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_workspace(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"calendly.Workspace", "id": eid})
...
def delete_document(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"calendly.Document", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_folder(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"calendly.Folder", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_comment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"calendly.Comment", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_permission(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"calendly.Permission", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_user(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"calendly.User", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "calendly-compat", "entities": ['Workspace', 'Document', 'Folder', 'Comment', 'Permission', 'User']}, 200
