"""
Contract test for the guidewire_claimcenter-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "guidewire_claimcenter.kotoba")
ENTITIES = ['Account', 'Loan', 'Policy', 'Claim', 'Transaction', 'Customer']
PLURALS = {'Account': 'accounts', 'Loan': 'loans', 'Policy': 'policies', 'Claim': 'claims', 'Transaction': 'transactions', 'Customer': 'customers'}


class GuidewireClaimcenterContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
