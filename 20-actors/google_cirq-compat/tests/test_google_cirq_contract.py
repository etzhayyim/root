"""
Contract test for the google_cirq-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "google_cirq.kotoba")
ENTITIES = ['QuantumJob', 'ExecutionStatus', 'QuantumProcessor', 'QuantumProgram', 'QuantumTimeSlot']
PLURALS = {'QuantumJob': 'quantumjobs', 'ExecutionStatus': 'executionstatuses', 'QuantumProcessor': 'quantumprocessors', 'QuantumProgram': 'quantumprograms', 'QuantumTimeSlot': 'quantumtimeslots'}


class GoogleCirqContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['health', 'state', 'timeSlotType']:
