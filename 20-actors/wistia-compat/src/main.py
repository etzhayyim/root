"""
Py Kotodama WASM entrypoint for the Wistia clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"wistia.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_asset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"wistia.Asset", "id": eid})
...
def delete_rendition(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"wistia.Rendition", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_channel(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"wistia.Channel", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_playlist(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"wistia.Playlist", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_content_entry(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"wistia.ContentEntry", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_experiment(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"wistia.Experiment", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "wistia-compat", "entities": ['Asset', 'Rendition', 'Channel', 'Playlist', 'ContentEntry', 'Experiment']}, 200
