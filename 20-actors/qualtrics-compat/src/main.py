"""
Py Kotodama WASM entrypoint for the Qualtrics clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"qualtrics.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_ticket(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qualtrics.Ticket", "id": eid})
...
def delete_survey(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qualtrics.Survey", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_response(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qualtrics.Response", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_account(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qualtrics.Account", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_conversation(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qualtrics.Conversation", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_contact(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"qualtrics.Contact", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "qualtrics-compat", "entities": ['Ticket', 'Survey', 'Response', 'Account', 'Conversation', 'Contact']}, 200
