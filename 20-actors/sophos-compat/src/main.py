"""
Py Kotodama WASM entrypoint for the Sophos clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "sophos-compat", "entities": ['Identity', 'Policy', 'Detection', 'Incident', 'Asset', 'Session']}, 200
