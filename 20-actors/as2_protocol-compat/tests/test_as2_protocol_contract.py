"""
Contract test for the as2_protocol-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "as2_protocol.kotoba")
ENTITIES = ['As2Message', 'Mdn', 'DispositionNotification']
PLURALS = {'As2Message': 'as2messages', 'Mdn': 'mdns', 'DispositionNotification': 'dispositionnotifications'}


class As2ProtocolContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['actionMode', 'dispositionModifier', 'dispositionType', 'sendingMode']:
