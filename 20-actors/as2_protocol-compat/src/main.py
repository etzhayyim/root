"""
Py Kotodama WASM entrypoint for the As2_protocol clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "as2_protocol-compat", "entities": ['TradeItem', 'Event', 'Document', 'Container', 'Party', 'Shipment']}, 200
