"""
Py Kotodama WASM entrypoint for the Edifact clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "edifact-compat", "entities": ['TradeItem', 'Event', 'Document', 'Container', 'Party', 'Shipment']}, 200
