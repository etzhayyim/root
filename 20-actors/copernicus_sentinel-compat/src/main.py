"""
Py Kotodama WASM entrypoint for the Copernicus_sentinel clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "copernicus_sentinel-compat", "entities": ['Object', 'Position', 'Observation', 'Scene', 'Float', 'Station']}, 200
