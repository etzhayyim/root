"""
Contract test for the copernicus_sentinel-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "copernicus_sentinel.kotoba")
ENTITIES = ['Object', 'Position', 'Observation', 'Scene', 'Float', 'Station']
PLURALS = {'Object': 'objects', 'Position': 'positions', 'Observation': 'observations', 'Scene': 'scenes', 'Float': 'floats', 'Station': 'stations'}


class CopernicusSentinelContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
