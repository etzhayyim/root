"""
Contract test for the berkeley_lights-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "berkeley_lights.kotoba")
...
class BerkeleyLightsContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
