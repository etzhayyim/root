"""
Contract test for the mux-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "mux.kotoba")
ENTITIES = ['Asset', 'PlaybackId', 'Track', 'Upload', 'LiveStream']
PLURALS = {'Asset': 'assets', 'PlaybackId': 'playbackids', 'Track': 'tracks', 'Upload': 'uploads', 'LiveStream': 'livestreams'}


class MuxContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['policy', 'resolutionTier', 'status', 'type', 'videoQuality']:
