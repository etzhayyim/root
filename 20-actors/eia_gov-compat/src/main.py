"""
Py Kotodama WASM entrypoint for the Eia_gov clean-room actor.
...
def _query(entity, eid=None):
    ...
    pattern = {"entity": f"eia_gov.{entity}"}
    if eid is not None:
        pattern["id"] = eid
...
def delete_meter(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"eia_gov.Meter", "id": eid})
...
def delete_reading(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"eia_gov.Reading", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_node(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"eia_gov.Node", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_load_forecast(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"eia_gov.LoadForecast", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_market_bid(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"eia_gov.MarketBid", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_tag(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"eia_gov.Tag", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "eia_gov-compat", "entities": ['Meter', 'Reading', 'Node', 'LoadForecast', 'MarketBid', 'Tag']}, 200
