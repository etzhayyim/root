...
`20-actors/magatama/cells/chigiri_*/` and will be import-time
...
Sensors: `pymagatama.organism.sensors.legal.*` (W1+ activation).
...
- `/20-actors/magatama/py/src/pymagatama/organism/sensors/legal/` (sensor stubs)
