"""
Py Kotodama WASM entrypoint for the Helium clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "helium-compat", "entities": ['Device', 'Telemetry', 'Gateway', 'Command', 'Firmware', 'Alert']}, 200
