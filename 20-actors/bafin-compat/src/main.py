"""
Py Kotodama WASM entrypoint for the Bafin clean-room actor.
...
def delete_filing(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bafin.Filing", "id": eid})
...
def delete_citizen(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bafin.Citizen", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_service(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bafin.Service", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_application(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bafin.Application", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_dataset(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bafin.Dataset", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_identity(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"bafin.Identity", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "bafin-compat", "entities": ['Filing', 'Citizen', 'Service', 'Application', 'Dataset', 'Identity']}, 200
