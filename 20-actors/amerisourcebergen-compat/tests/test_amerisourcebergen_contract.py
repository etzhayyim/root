"""
Contract test for the amerisourcebergen-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "amerisourcebergen.kotoba")
ENTITIES = ['Prescription', 'Claim', 'Pharmacy', 'Drug', 'Member', 'PriorAuth']
PLURALS = {'Prescription': 'prescriptions', 'Claim': 'claims', 'Pharmacy': 'pharmacies', 'Drug': 'drugs', 'Member': 'members', 'PriorAuth': 'priorauths'}


class AmerisourcebergenContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
