"""
Py Kotodama WASM entrypoint for the Glide clean-room actor.
...
def delete_flow(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"glide.Flow", "id": eid})
...
def delete_step(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"glide.Step", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_connection(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"glide.Connection", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_run(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"glide.Run", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_app(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"glide.App", "id": eid})
    return {"id": eid, "deleted": True}, 200
...
def delete_webhook(request, eid):
    ...
    if not rows:
        return {"error": {"message": "Not found"}}, 404
    db.retract({"entity": f"glide.Webhook", "id": eid})
    return {"id": eid, "deleted": True}, 200

@app.route("/healthz", methods=["GET"])
def healthz(request):
    return {"status": "ok", "actor": "glide-compat", "entities": ['Flow', 'Step', 'Connection', 'Run', 'App', 'Webhook']}, 200
