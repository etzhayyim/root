"""
Contract test for the can_bus-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "can_bus.kotoba")
ENTITIES = ['CanFrame', 'CanFdFrame', 'ErrorFrame', 'RemoteFrame', 'OverloadFrame']
PLURALS = {'CanFrame': 'canframes', 'CanFdFrame': 'canfdframes', 'ErrorFrame': 'errorframes', 'RemoteFrame': 'remoteframes', 'OverloadFrame': 'overloadframes'}


class CanBusContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verified_enums_enforced(self):
        ...
        for field in ['errorFlag', 'errorType', 'format', 'frameType', 'nodeState']:
