"""
Py Kotodama WASM entrypoint for the Can_bus clean-room actor.
...
def healthz(request):
    return {"status": "ok", "actor": "can_bus-compat", "entities": ['Vehicle', 'Signal', 'ChargeSession', 'Connector', 'Trip', 'Command']}, 200
