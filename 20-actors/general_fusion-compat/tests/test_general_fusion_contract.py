"""
Contract test for the general_fusion-compat L4 actor.
...
SCHEMA = os.path.join(ACTOR, "schema", "general_fusion.kotoba")
...
class GeneralFusionContract(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
