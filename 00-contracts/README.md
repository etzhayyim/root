...
- `magatama-host-contract/` — 12 行の TS binding stub は `magatama-host-sdk/src/types.ts` に inline 済み。package は `_archive/00-contracts/magatama-host-contract-260413/` にアーカイブ
