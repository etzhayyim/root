...
test_internal_service_register_firearm if {
  arms.allow with input as {
    ...
    "route": {"nsid": "ai.gftd.apps.arms.registerFirearm"},
...
test_public_authenticate_holder if {
  arms.allow with input as {
    ...
    "route": {"nsid": "ai.gftd.apps.arms.authenticateHolder"},
    "permission_sets": [],
    "params": {}
  }
}
...
test_holder_checkout_with_session if {
  arms.allow with input as {
    "auth": {"method": "did-session", "scopes": ["rpc?lxm=ai.gftd.apps.arms.checkOutFirearm"], "holderAuthSessionPassed": true},
    "route": {"nsid": "ai.gftd.apps.arms.checkOutFirearm"},
...
test_holder_checkout_without_session if {
  not arms.allow with input as {
    "auth": {"method": "did-session", "scopes": ["rpc?lxm=ai.gftd.apps.arms.checkOutFirearm"], "holderAuthSessionPassed": false},
    "route": {"nsid": "ai.gftd.apps.arms.checkOutFirearm"},
    "permission_sets": ["arms:holder"],
    "params": {}
  }
...
test_audit_log_authority_allowed if {
  arms.allow with input as {
    "auth": {"method": "did-session", "scopes": ["rpc?lxm=ai.gftd.apps.arms.getAuditLog"]},
    "route": {"nsid": "ai.gftd.apps.arms.getAuditLog"},
...
test_transfer_custody_restricted_jurisdiction_denied if {
  not arms.allow with input as {
    "auth": {"method": "did-session", "scopes": ["rpc?lxm=ai.gftd.apps.arms.transferCustody"], "holderAuthSessionPassed": true},
    "route": {"nsid": "ai.gftd.apps.arms.transferCustody"},
    "permission_sets": ["arms:authority"],
...
test_transfer_custody_allowed_jurisdiction if {
  arms.allow with input as {
    "auth": {"method": "service-jwt", "scopes": ["rpc?lxm=ai.gftd.apps.arms.transferCustody"], "holderAuthSessionPassed": true},
    "route": {"nsid": "ai.gftd.apps.arms.transferCustody"},
    "permission_sets": ["arms:authority"],
...
test_getfirearm_unauthenticated_obligation if {
  "return_401" in arms.deny_obligations with input as {
    "auth": {"method": "public", "scopes": []},
    "route": {"nsid": "ai.gftd.apps.arms.getFirearm"},
    "permission_sets": [],
    "params": {}
  }
}
