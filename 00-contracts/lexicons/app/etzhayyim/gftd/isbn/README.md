# `app.etzhayyim.isbn.*` — ISBN — International Standard Book Number lookup
...
To be defined. Naming convention: `app.etzhayyim.isbn.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
