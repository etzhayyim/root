# `app.etzhayyim.omatsuri.*` — お祭り — festival event spec
...
To be defined. Naming convention: `app.etzhayyim.omatsuri.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
