# `app.etzhayyim.rareEarth.*` — Rare earth element resource registry
...
To be defined. Naming convention: `app.etzhayyim.rareEarth.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
