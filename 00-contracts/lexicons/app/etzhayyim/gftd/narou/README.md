# `app.etzhayyim.narou.*` — なろう — long-form serialized fiction spec
...
To be defined. Naming convention: `app.etzhayyim.narou.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
