# `app.etzhayyim.ipAddress.*` — IP address allocation / RIR (ARIN / RIPE / APNIC / LACNIC / AFRINIC) reference
...
To be defined. Naming convention: `app.etzhayyim.ipAddress.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
