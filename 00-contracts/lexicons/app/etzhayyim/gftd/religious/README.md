# `app.etzhayyim.religious.*` — Religious practice — open ritual / liturgy / oath records
...
To be defined. Naming convention: `app.etzhayyim.religious.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
