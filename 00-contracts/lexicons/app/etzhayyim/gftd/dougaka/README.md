# `app.etzhayyim.dougaka.*` — Dougaka — animator / inbetweener spec
...
To be defined. Naming convention: `app.etzhayyim.dougaka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
