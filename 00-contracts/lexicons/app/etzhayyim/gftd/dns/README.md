# `app.etzhayyim.dns.*` — DNS — open zone / record lookup spec
...
To be defined. Naming convention: `app.etzhayyim.dns.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
