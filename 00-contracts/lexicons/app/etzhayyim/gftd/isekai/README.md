# `app.etzhayyim.isekai.*` — Isekai — alternate-world setting record
...
To be defined. Naming convention: `app.etzhayyim.isekai.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
