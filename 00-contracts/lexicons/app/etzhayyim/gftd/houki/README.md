# `app.etzhayyim.houki.*` — 法規 — open Japanese law / regulation reference
...
To be defined. Naming convention: `app.etzhayyim.houki.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
