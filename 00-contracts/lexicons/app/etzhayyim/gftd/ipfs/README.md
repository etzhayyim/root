# `app.etzhayyim.ipfs.*` — IPFS — content addressing, pinning, CAR exchange
...
To be defined. Naming convention: `app.etzhayyim.ipfs.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
