# `app.etzhayyim.legalEntity.*` — Legal entity open registry (LEI / corporate number cross-ref)
...
To be defined. Naming convention: `app.etzhayyim.legalEntity.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
