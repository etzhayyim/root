# `app.etzhayyim.treaty.*` — Treaty — international treaty open registry
...
To be defined. Naming convention: `app.etzhayyim.treaty.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
