# `app.etzhayyim.sbom.*` — SBOM — Software Bill of Materials (SPDX / CycloneDX)
...
To be defined. Naming convention: `app.etzhayyim.sbom.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
