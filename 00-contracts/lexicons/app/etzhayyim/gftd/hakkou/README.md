# `app.etzhayyim.hakkou.*` — 発光 — bioluminescence / radiance cultural reference
...
To be defined. Naming convention: `app.etzhayyim.hakkou.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
