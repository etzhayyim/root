# `app.etzhayyim.colorByNumber.*` — Color-by-number — open paint-by-number puzzle spec
...
To be defined. Naming convention: `app.etzhayyim.colorByNumber.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
