# `app.etzhayyim.manga.*` — Manga — open page / panel / balloon record
...
To be defined. Naming convention: `app.etzhayyim.manga.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
