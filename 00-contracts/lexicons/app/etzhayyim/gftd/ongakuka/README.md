# `app.etzhayyim.ongakuka.*` — Ongakuka — musicalization pipeline spec
...
To be defined. Naming convention: `app.etzhayyim.ongakuka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
