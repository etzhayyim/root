# `app.etzhayyim.arxiv.*` — arXiv — open scholarly preprint metadata
...
To be defined. Naming convention: `app.etzhayyim.arxiv.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
