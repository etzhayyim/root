# `app.etzhayyim.commonCrawl.*` — Common Crawl — web archive index
...
To be defined. Naming convention: `app.etzhayyim.commonCrawl.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
