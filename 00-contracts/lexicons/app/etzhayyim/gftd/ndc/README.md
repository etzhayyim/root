# `app.etzhayyim.ndc.*` — NDC — Nippon Decimal Classification (library classification)
...
To be defined. Naming convention: `app.etzhayyim.ndc.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
