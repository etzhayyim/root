# `app.etzhayyim.images.*` — Images — open multi-image collection record
...
To be defined. Naming convention: `app.etzhayyim.images.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
