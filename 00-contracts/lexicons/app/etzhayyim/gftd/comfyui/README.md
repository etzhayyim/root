# `app.etzhayyim.comfyui.*` — ComfyUI — open node graph / inference workflow spec
...
To be defined. Naming convention: `app.etzhayyim.comfyui.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
