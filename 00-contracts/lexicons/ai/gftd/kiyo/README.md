# `app.etzhayyim.kiyo.*` — 清 — purity / clarity cultural concept
...
To be defined. Naming convention: `app.etzhayyim.kiyo.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
