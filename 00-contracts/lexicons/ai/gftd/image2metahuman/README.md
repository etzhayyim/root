# `app.etzhayyim.image2metahuman.*` — Image → MetaHuman conversion spec
...
To be defined. Naming convention: `app.etzhayyim.image2metahuman.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
