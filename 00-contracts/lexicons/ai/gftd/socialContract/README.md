# `app.etzhayyim.socialContract.*` — Social contract — open community-rule record
...
To be defined. Naming convention: `app.etzhayyim.socialContract.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
