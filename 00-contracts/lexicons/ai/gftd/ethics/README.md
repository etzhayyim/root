# `app.etzhayyim.ethics.*` — Ethics — open ethical reasoning record
...
To be defined. Naming convention: `app.etzhayyim.ethics.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
