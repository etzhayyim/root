# `app.etzhayyim.canvas.*` — Canvas — open 2D canvas annotation record
...
To be defined. Naming convention: `app.etzhayyim.canvas.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
