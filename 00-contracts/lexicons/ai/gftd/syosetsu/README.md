# `app.etzhayyim.syosetsu.*` — 小説 — open novel / fiction record
...
To be defined. Naming convention: `app.etzhayyim.syosetsu.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
