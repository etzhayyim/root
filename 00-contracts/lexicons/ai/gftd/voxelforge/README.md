# `app.etzhayyim.voxelforge.*` — Voxelforge — open voxel modeling spec
...
To be defined. Naming convention: `app.etzhayyim.voxelforge.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
