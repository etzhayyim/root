# `app.etzhayyim.tradition.*` — Tradition — open cultural-practice transmission record
...
To be defined. Naming convention: `app.etzhayyim.tradition.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
