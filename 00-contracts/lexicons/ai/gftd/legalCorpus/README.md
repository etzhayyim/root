# `app.etzhayyim.legalCorpus.*` — Legal corpus — open legal text reference
...
To be defined. Naming convention: `app.etzhayyim.legalCorpus.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
