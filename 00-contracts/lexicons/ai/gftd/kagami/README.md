# `app.etzhayyim.kagami.*` — 鏡 — mirror / reflection concept reference
...
To be defined. Naming convention: `app.etzhayyim.kagami.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
