# `app.etzhayyim.isin.*` — ISIN — International Securities Identification Number lookup
...
To be defined. Naming convention: `app.etzhayyim.isin.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
