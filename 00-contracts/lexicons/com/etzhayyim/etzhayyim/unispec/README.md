# `com.etzhayyim.unispec.*` — UniSpec — unified specification reference
...
To be defined. Naming convention: `com.etzhayyim.unispec.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
