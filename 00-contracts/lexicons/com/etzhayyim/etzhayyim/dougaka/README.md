# `com.etzhayyim.dougaka.*` — Dougaka — animator / inbetweener spec
...
To be defined. Naming convention: `com.etzhayyim.dougaka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
