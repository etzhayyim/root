# `com.etzhayyim.anima.*` — Anima — animation primitive / rig / pose spec
...
To be defined. Naming convention: `com.etzhayyim.anima.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
