# `com.etzhayyim.ethics.*` — Ethics — open ethical reasoning record
...
To be defined. Naming convention: `com.etzhayyim.ethics.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
