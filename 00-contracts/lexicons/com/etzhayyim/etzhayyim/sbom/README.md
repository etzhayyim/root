# `com.etzhayyim.sbom.*` — SBOM — Software Bill of Materials (SPDX / CycloneDX)
...
To be defined. Naming convention: `com.etzhayyim.sbom.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
