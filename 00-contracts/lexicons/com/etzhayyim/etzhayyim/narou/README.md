# `com.etzhayyim.narou.*` — なろう — long-form serialized fiction spec
...
To be defined. Naming convention: `com.etzhayyim.narou.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
