# `com.etzhayyim.omikuji.*` — おみくじ — fortune slip protocol
...
To be defined. Naming convention: `com.etzhayyim.omikuji.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
