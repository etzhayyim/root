# `com.etzhayyim.drama.*` — Drama — open script / scene / cue record
...
To be defined. Naming convention: `com.etzhayyim.drama.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
