# `com.etzhayyim.gazo.*` — 画像 — open image annotation record
...
To be defined. Naming convention: `com.etzhayyim.gazo.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
