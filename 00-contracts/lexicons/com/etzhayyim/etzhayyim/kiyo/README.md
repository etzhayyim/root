# `com.etzhayyim.kiyo.*` — 清 — purity / clarity cultural concept
...
To be defined. Naming convention: `com.etzhayyim.kiyo.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
