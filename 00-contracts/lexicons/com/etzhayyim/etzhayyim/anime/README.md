# `com.etzhayyim.anime.*` — Anime — open cut / scene / asset record
...
To be defined. Naming convention: `com.etzhayyim.anime.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
