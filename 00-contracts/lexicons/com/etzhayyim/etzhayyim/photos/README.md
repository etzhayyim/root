# `com.etzhayyim.photos.*` — Photos — open photo album / EXIF record
...
To be defined. Naming convention: `com.etzhayyim.photos.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
