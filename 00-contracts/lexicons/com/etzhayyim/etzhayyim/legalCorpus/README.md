# `com.etzhayyim.legalCorpus.*` — Legal corpus — open legal text reference
...
To be defined. Naming convention: `com.etzhayyim.legalCorpus.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
