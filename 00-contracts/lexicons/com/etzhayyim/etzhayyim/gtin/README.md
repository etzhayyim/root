# `com.etzhayyim.gtin.*` — GTIN (Global Trade Item Number) — GS1 product identifier lookup
...
To be defined. Naming convention: `com.etzhayyim.gtin.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
