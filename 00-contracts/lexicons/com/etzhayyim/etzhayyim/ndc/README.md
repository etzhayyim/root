# `com.etzhayyim.ndc.*` — NDC — Nippon Decimal Classification (library classification)
...
To be defined. Naming convention: `com.etzhayyim.ndc.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
