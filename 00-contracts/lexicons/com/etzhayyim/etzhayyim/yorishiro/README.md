# `com.etzhayyim.yorishiro.*` — 依代 — religious vessel / sacred object spec
...
To be defined. Naming convention: `com.etzhayyim.yorishiro.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
