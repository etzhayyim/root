# `com.etzhayyim.img2pptx.*` — Image → PPTX conversion spec
...
To be defined. Naming convention: `com.etzhayyim.img2pptx.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
