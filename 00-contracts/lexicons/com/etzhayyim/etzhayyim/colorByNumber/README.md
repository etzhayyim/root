# `com.etzhayyim.colorByNumber.*` — Color-by-number — open paint-by-number puzzle spec
...
To be defined. Naming convention: `com.etzhayyim.colorByNumber.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
