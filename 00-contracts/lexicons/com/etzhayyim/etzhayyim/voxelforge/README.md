# `com.etzhayyim.voxelforge.*` — Voxelforge — open voxel modeling spec
...
To be defined. Naming convention: `com.etzhayyim.voxelforge.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
