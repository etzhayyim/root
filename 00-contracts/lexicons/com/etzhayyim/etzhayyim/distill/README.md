# `com.etzhayyim.distill.*` — Distill — research distillation
...
To be defined. Naming convention: `com.etzhayyim.distill.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
