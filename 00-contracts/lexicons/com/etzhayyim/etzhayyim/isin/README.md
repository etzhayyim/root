# `com.etzhayyim.isin.*` — ISIN — International Securities Identification Number lookup
...
To be defined. Naming convention: `com.etzhayyim.isin.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
