# `com.etzhayyim.gyotaku.*` — 魚拓 — fish-impression art record
...
To be defined. Naming convention: `com.etzhayyim.gyotaku.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
