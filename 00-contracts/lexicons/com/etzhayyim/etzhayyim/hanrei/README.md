# `com.etzhayyim.hanrei.*` — 判例 — open Japanese case law reference
...
To be defined. Naming convention: `com.etzhayyim.hanrei.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
