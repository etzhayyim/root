# `com.etzhayyim.ki.*` — 気 — life force / vital energy concept reference
...
To be defined. Naming convention: `com.etzhayyim.ki.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
