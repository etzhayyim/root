# `com.etzhayyim.rareEarthCoverage.*` — Rare earth supply-chain coverage data
...
To be defined. Naming convention: `com.etzhayyim.rareEarthCoverage.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
