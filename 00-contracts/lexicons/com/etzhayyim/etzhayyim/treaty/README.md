# `com.etzhayyim.treaty.*` — Treaty — international treaty open registry
...
To be defined. Naming convention: `com.etzhayyim.treaty.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
