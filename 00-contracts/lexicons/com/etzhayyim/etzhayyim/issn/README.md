# `com.etzhayyim.issn.*` — ISSN — International Standard Serial Number lookup
...
To be defined. Naming convention: `com.etzhayyim.issn.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
