# `com.etzhayyim.syosetsu.*` — 小説 — open novel / fiction record
...
To be defined. Naming convention: `com.etzhayyim.syosetsu.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
