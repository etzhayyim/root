# `com.etzhayyim.ipAddress.*` — IP address allocation / RIR (ARIN / RIPE / APNIC / LACNIC / AFRINIC) reference
...
To be defined. Naming convention: `com.etzhayyim.ipAddress.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
