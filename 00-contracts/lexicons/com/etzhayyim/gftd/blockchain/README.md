# `com.etzhayyim.blockchain.*` — Blockchain primitives — block / transaction / log / receipt schemas, multi-chain reference
...
To be defined. Naming convention: `com.etzhayyim.blockchain.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
