# `com.etzhayyim.tradition.*` — Tradition — open cultural-practice transmission record
...
To be defined. Naming convention: `com.etzhayyim.tradition.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
