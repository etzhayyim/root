# `com.etzhayyim.ongakuka.*` — Ongakuka — musicalization pipeline spec
...
To be defined. Naming convention: `com.etzhayyim.ongakuka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
