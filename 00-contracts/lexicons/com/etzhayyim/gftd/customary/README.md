# `app.etzhayyim.customary.*` — Customary law — open reference
...
To be defined. Naming convention: `app.etzhayyim.customary.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
