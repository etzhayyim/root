# `com.etzhayyim.customary.*` — Customary law — open reference
...
To be defined. Naming convention: `com.etzhayyim.customary.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
