# `com.etzhayyim.sense.*` — Sense — open sensory / qualia annotation
...
To be defined. Naming convention: `com.etzhayyim.sense.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
