# `app.etzhayyim.scap.*` — SCAP — Security Content Automation Protocol (CVE / CPE / CWE / OVAL)
...
To be defined. Naming convention: `app.etzhayyim.scap.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
