# `com.etzhayyim.canvas.*` — Canvas — open 2D canvas annotation record
...
To be defined. Naming convention: `com.etzhayyim.canvas.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
