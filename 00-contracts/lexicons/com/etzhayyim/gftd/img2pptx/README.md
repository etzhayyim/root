# `app.etzhayyim.img2pptx.*` — Image → PPTX conversion spec
...
To be defined. Naming convention: `app.etzhayyim.img2pptx.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
