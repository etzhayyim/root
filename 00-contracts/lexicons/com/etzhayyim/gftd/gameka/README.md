# `com.etzhayyim.gameka.*` — Gameka — game creation pipeline spec
...
To be defined. Naming convention: `com.etzhayyim.gameka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
