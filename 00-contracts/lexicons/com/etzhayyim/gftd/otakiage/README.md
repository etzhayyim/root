# `app.etzhayyim.otakiage.*` — お焚き上げ — religious burning ceremony record
...
To be defined. Naming convention: `app.etzhayyim.otakiage.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
