# `com.etzhayyim.isekai.*` — Isekai — alternate-world setting record
...
To be defined. Naming convention: `com.etzhayyim.isekai.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
