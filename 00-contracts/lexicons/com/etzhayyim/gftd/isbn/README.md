# `com.etzhayyim.isbn.*` — ISBN — International Standard Book Number lookup
...
To be defined. Naming convention: `com.etzhayyim.isbn.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
