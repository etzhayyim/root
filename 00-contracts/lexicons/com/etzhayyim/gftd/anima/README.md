# `app.etzhayyim.anima.*` — Anima — animation primitive / rig / pose spec
...
To be defined. Naming convention: `app.etzhayyim.anima.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
