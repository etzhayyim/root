# `com.etzhayyim.mangaka.*` — Mangaka — manga author / Genko document spec
...
To be defined. Naming convention: `com.etzhayyim.mangaka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
