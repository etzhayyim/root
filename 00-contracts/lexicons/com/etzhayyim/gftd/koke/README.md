# `com.etzhayyim.koke.*` — 苔 — moss / patina / aging cultural reference
...
To be defined. Naming convention: `com.etzhayyim.koke.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
