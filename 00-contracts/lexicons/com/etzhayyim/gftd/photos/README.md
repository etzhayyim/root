# `app.etzhayyim.photos.*` — Photos — open photo album / EXIF record
...
To be defined. Naming convention: `app.etzhayyim.photos.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
