# `app.etzhayyim.omikuji.*` — おみくじ — fortune slip protocol
...
To be defined. Naming convention: `app.etzhayyim.omikuji.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
