# `app.etzhayyim.unispec.*` — UniSpec — unified specification reference
...
To be defined. Naming convention: `app.etzhayyim.unispec.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
