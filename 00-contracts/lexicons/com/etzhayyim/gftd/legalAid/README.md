# `com.etzhayyim.legalAid.*` — Legal aid — public service open spec
...
To be defined. Naming convention: `com.etzhayyim.legalAid.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
