# `app.etzhayyim.legalAid.*` — Legal aid — public service open spec
...
To be defined. Naming convention: `app.etzhayyim.legalAid.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
