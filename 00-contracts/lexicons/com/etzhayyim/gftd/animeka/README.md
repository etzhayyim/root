# `app.etzhayyim.animeka.*` — Animeka — team-based anime creation pipeline spec
...
To be defined. Naming convention: `app.etzhayyim.animeka.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
