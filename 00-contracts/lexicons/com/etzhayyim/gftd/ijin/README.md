# `app.etzhayyim.ijin.*` — 偉人 — biographical record of great persons
...
To be defined. Naming convention: `app.etzhayyim.ijin.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
