# `com.etzhayyim.arxiv.*` — arXiv — open scholarly preprint metadata
...
To be defined. Naming convention: `com.etzhayyim.arxiv.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
