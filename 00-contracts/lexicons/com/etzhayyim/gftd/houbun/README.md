# `com.etzhayyim.houbun.*` — 法文 — open Japanese statute text reference
...
To be defined. Naming convention: `com.etzhayyim.houbun.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
