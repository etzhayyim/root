# `com.etzhayyim.image2vrm.*` — Image → VRM conversion spec
...
To be defined. Naming convention: `com.etzhayyim.image2vrm.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
