# `com.etzhayyim.kareyanagi.*` — 枯柳 — poetic / contemplative cultural record
...
To be defined. Naming convention: `com.etzhayyim.kareyanagi.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
