# `com.etzhayyim.commonCrawl.*` — Common Crawl — web archive index
...
To be defined. Naming convention: `com.etzhayyim.commonCrawl.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
