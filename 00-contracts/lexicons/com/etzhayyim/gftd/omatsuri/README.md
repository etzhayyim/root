# `com.etzhayyim.omatsuri.*` — お祭り — festival event spec
...
To be defined. Naming convention: `com.etzhayyim.omatsuri.<methodOrRecord>` (camelCase per CLAUDE.md Identifier rule).
