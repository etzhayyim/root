...
1. **Lexicon** at `00-contracts/lexicons/ai/etzhayyim/yorishiro/openalex/*.json` (XRPC + magatama-host-sdk consumers)
2. **Pregel cell** at `20-actors/magatama/cells/yorishiro_openalex/cell.py` (in-cluster Murakumo runtime)
3. **MCP server** at `20-actors/magatama/mcp/yorishiro-openalex-mcp/` (stdio + Streamable HTTP)
