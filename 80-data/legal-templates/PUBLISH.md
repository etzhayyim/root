...
|---|:--:|:--:|---:|---:|---|
| Independent Consulting Services Agreement | en | INTL | 8 | 21 | `bafkreibrgfp6maghc…` |
| 特定商取引 契約書 (クーリングオフ条項付) | ja | JP | 3 | 12 | `bafkreihys3qeu6dhb…` |
...
| Employment Agreement (ILO core-conventions aligned) | en | INTL | 6 | 19 | `bafkreiejd4n7repjk…` |
