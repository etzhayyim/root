...
### 2. Franchise grant, system & pre-contractual disclosure  (ip-license, mandatory)
_Rests on:_ UNIDROIT Model Franchise Disclosure Law 2002, Art. 3 (UNIDROIT Model Franchise Disclosure Law); 16 CFR Part 436 (FTC Franchise Rule (US))

### 3. Apache-2.0 copyright & patent license grant  (ip-license, mandatory)
