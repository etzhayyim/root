export const bannerStyleClasses = `
  ...
  data-[style=color-chip]:[--color-chip-color:currentColor] data-[style=color-chip]:border-[calc(2/16*1rem)] data-[style=color-chip]:!pl-6 data-[style=color-chip]:shadow-[insetCalc(8/16*1rem)_0_0_0_var(--color-chip-color)]
  data-[style=color-chip]:desktop:!pl-10 data-[style=color-chip]:desktop:shadow-[insetCalc(16/16*1rem)_0_0_0_var(--color-chip-color)]
`;
