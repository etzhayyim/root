...
<summary
  class={cn(
    ...
    "focus-visible:rounded-4 focus-visible:bg-yellow-300 focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-[calc(2/16*1rem)] focus-visible:outline-black focus-visible:ring-[calc(2/16*1rem)] focus-visible:ring-yellow-300",
...
>
  <svg
    ...
    fill='none'
  >
    <circle class='fill-white forced-colors:fill-[Canvas]' cx='12' cy='12' r='10' />
    <g class='group-hover/summary:hidden'>
      <path
    ...
    <g class='hidden group-hover/summary:inline'>
      <path
