...
Gftd エコシステム向けのデザインシステムライブラリです。Svelte 5 (Runes) と Tailwind CSS をベースに、アクセシビリティと高い再利用性を考慮して構築されています。
...
```svelte
<script>
  import { Button } from '@gftdcojp/ai-gftd-performer-sys-design-system-nfv0g01u';
</script>
