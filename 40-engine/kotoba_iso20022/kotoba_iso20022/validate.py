...
# ISO 13616 fixed national IBAN lengths (registry-published). A subset that
# covers the R1 kawase-yui corridor jurisdictions + the common SEPA reach;
# extend from the official IBAN Registry as corridors open. An unknown
# country code is structure-checked but length-skipped (recorded as a soft
# pass) so the codec never hard-rejects a valid-but-unlisted country.
IBAN_LENGTHS: dict[str, int] = {
    "AD": 24, "AT": 20, "BE": 16, "CH": 21, "CY": 28, "CZ": 24, "DE": 22,
    "DK": 18, "EE": 20, "ES": 24, "FI": 18, "FR": 27, "GB": 22, "GR": 27,
    "IE": 22, "IT": 27, "LU": 20, "NL": 18, "NO": 15, "PL": 28, "PT": 25,
    "SE": 24, "SI": 19, "SK": 24, "JP": 0,  # JP has no IBAN; recorded as N/A
}
